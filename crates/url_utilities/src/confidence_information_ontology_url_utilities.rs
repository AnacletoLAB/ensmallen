...
pub fn is_valid_confidence_information_ontology_node_name(node_name: &str) -> bool {
    is_valid_node_name_from_seeds(node_name, Some(&["CIO"]), None, Some(":"), None, None, None)
        .is_ok()
}
...
///
pub(crate) unsafe fn format_confidence_information_ontology_url_from_node_name(
    node_name: &str,
) -> String {
