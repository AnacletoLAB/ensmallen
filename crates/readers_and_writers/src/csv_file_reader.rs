...
use shared::get_loading_bar::get_loading_bar;
use shared::types::Result;
use shared::iters_wrapper::ItersWrapper;
use shared::parallel_lines_reader::ParallelLines;
...
pub struct CSVFileReader {
    ...
    pub separator_was_set: bool,

    /// The number of lines to read in order to automatically detect the
    /// separator to be used.
    pub number_of_lines_to_automatically_detect_separator: usize,
    ...
    pub may_have_duplicates: Option<bool>,
