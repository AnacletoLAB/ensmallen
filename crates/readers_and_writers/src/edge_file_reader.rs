...
use crate::csv_file_reader::CSVFileReader;
use shared::types::*;
use shared::parse_weight;
use shared::ItersWrapper;

/// Structure that saves the reader specific to writing and reading a nodes csv file.
#[derive(Clone)]
pub struct EdgeFileReader {
    pub reader: CSVFileReader,
    pub edge_ids_column_number: Option<usize>,
    pub sources_column_number: usize,
    pub destinations_column_number: usize,
    ...
    pub numeric_edge_type_ids: bool,
    pub numeric_node_ids: bool,
    pub skip_weights_if_unavailable: bool,
    pub skip_edge_types_if_unavailable: bool,
...
impl EdgeFileReader {
    ...
    ///
    pub fn set_graph_name(mut self, graph_name: String) -> EdgeFileReader {
