...
The undirected graph Marssonina brunnea has 6334 nodes and 495870 weighted edges,
of which none are self-loops. The graph is dense as it has a density of 0.02472 and
has 13 connected components, where the component with most nodes has 6306 nodes and
the component with the least nodes has 2 nodes. The graph median node degree is 97,
the mean node degree is 156.57, and the node degree mode is 1. The top 5 most central
nodes are 698440.XP_007295578.1 (degree 1527), 698440.XP_007293386.1 (degree 1213),
698440.XP_007292950.1 (degree 1128), 698440.XP_007288699.1 (degree 1079) and 698440.XP_007296484.1
(degree 1058).
