...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import NocardiaSp.348mftsu51

    # Then load the graph
    graph = NocardiaSp.348mftsu51()
