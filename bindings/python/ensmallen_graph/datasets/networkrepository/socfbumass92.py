"""
This file offers the methods to automatically retrieve the graph SocfbUmass92.
...
def SocfbUmass92(
    ...
    **additional_graph_kwargs: Dict
    ...
    """Return new instance of the SocfbUmass92 graph.
