...
The undirected graph web-google has 1299 nodes and 2773 unweighted edges, of which none are self-loops. The graph is sparse as it has a density of 0.00329 and is connected, as it has a single component. The graph median node degree is 2, the mean node degree is 4.27, and the node degree mode is 1. The top 5 most central nodes are 66 (degree 59), 245 (degree 47), 1106 (degree 45), 466 (degree 44) and 135 (degree 37).
