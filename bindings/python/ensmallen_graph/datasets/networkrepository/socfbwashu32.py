"""
This file offers the methods to automatically retrieve the graph SocfbWashu32.
...
def SocfbWashu32(
    ...
    **additional_graph_kwargs: Dict
    ...
    """Return new instance of the SocfbWashu32 graph.
