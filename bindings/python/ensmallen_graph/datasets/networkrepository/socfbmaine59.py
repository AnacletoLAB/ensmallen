...
which none are self-loops. The graph is sparse as it has a density of 0.00592 and
has 3 connected components, where the component with most nodes has 9065 nodes and
the component with the least nodes has 2 nodes. The graph median node degree is 42,
the mean node degree is 53.64, and the node degree mode is 1. The top 5 most central
nodes are 7891 (degree 1011), 975 (degree 589), 76 (degree 566), 980 (degree 423)
and 1729 (degree 405).
