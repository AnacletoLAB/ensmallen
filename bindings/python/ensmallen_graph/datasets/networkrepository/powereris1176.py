...
which 1176 are self-loops. The graph is dense as it has a density of 0.01341 and
has 2 connected components, where the component with most nodes has 1174 nodes and
the component with the least nodes has 2 nodes. The graph median node degree is 4,
the mean node degree is 15.78, and the node degree mode is 3. The top 5 most central
