...
The undirected graph road-asia-osm has 11950757 nodes and 12711603 unweighted edges, of which none are self-loops. The graph is extremely sparse as it has a density of 0.00000 and is connected, as it has a single component. The graph median node degree is 2, the mean node degree is 2.13, and the node degree mode is 2. The top 5 most central nodes are 4626417 (degree 9), 4570555 (degree 9), 153176 (degree 9), 91823 (degree 9) and 91820 (degree 9).
