...
The undirected graph aff-github-user2project has 120867 nodes, of which 2 are singletons
(all have self-loops), and 439930 weighted edges, of which 72 are self-loops. The
graph is extremely sparse as it has a density of 0.00006 and has 3 connected components,
where the component with most nodes has 120865 nodes and the component with the least
nodes has a single node. The graph median node degree is 2, the mean node degree
is 7.28, and the node degree mode is 1. The top 5 most central nodes are 17 (degree
3692), 299 (degree 1950), 645 (degree 1644), 76 (degree 1597) and 298 (degree 1492).
