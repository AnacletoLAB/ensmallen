...
The undirected graph rt-retweet has 96 nodes and 117 unweighted edges, of which none are self-loops. The graph is dense as it has a density of 0.02566 and is connected, as it has a single component. The graph median node degree is 1, the mean node degree is 2.44, and the node degree mode is 1. The top 5 most central nodes are 54 (degree 17), 45 (degree 11), 72 (degree 9), 89 (degree 9) and 93 (degree 8).
