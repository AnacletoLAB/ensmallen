"""
This file offers the methods to automatically retrieve the graph SocfbIndiana.
...
def SocfbIndiana(
    ...
    **additional_graph_kwargs: Dict
    ...
    """Return new instance of the SocfbIndiana graph.
