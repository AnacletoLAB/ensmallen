"""
This file offers the methods to automatically retrieve the graph TechInternetAs.
...
def TechInternetAs(
    ...
    **additional_graph_kwargs: Dict
    ...
    """Return new instance of the TechInternetAs graph.
    ...
    Returns
    -----------------------
    Instace of TechInternetAs graph.
