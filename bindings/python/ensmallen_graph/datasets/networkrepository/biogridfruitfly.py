...
The undirected graph bio-grid-fruitfly has 7274 nodes and 24894 unweighted edges, of which none are self-loops. The graph is quite sparse as it has a density of 0.00094 and has 53 connected components, where the component with most nodes has 7163 nodes and the component with the least nodes has 2 nodes. The graph median node degree is 3, the mean node degree is 6.84 and the node degree mode is 1. The top 5 most central nodes are 147 (degree 176), 4505 (degree 141), 4753 (degree 119), 6257 (degree 116) and 5085 (degree 110).
