...
The undirected graph bio-CE-LC has 1387 nodes and 1648 weighted edges, of which none are self-loops. The graph is sparse as it has a density of 0.00171 and has 89 connected components, where the component with most nodes has 993 nodes and the component with the least nodes has 2 nodes. The graph median node degree is 1, the mean node degree is 2.38 and the node degree mode is 1. The top 5 most central nodes are 14 (degree 131), 16 (degree 68), 61 (degree 48), 122 (degree 42) and 210 (degree 29).
