...
The undirected graph socfb-Colgate88 has 3482 nodes and 155043 unweighted edges, of which none are self-loops. The graph is dense as it has a density of 0.02558 and is connected, as it has a single component. The graph median node degree is 78, the mean node degree is 89.05, and the node degree mode is 1. The top 5 most central nodes are 282 (degree 773), 1808 (degree 447), 1029 (degree 428), 3331 (degree 406) and 2250 (degree 398).
