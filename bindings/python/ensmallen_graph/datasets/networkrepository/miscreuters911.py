...
which none are self-loops. The graph is sparse as it has a density of 0.00167 and
has 4 connected components, where the component with most nodes has 13308 nodes and
the component with the least nodes has 2 nodes. The graph median node degree is 5,
the mean node degree is 22.24, and the node degree mode is 2. The top 5 most central
