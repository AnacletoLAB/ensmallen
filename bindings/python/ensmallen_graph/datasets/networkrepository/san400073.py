...
The undirected graph san400-0-7-3 has 400 nodes and 55860 unweighted edges, of which none are self-loops. The graph is extremely dense as it has a density of 0.70000 and is connected, as it has a single component. The graph median node degree is 280, the mean node degree is 279.30 and the node degree mode is 284. The top 5 most central nodes are 399 (degree 307), 116 (degree 305), 264 (degree 301), 304 (degree 300) and 250 (degree 300).
