...
The undirected graph soc-digg has 770799 nodes and 5907132 unweighted edges, of which none are self-loops. The graph is extremely sparse as it has a density of 0.00002 and is connected, as it has a single component. The graph median node degree is 2, the mean node degree is 15.33, and the node degree mode is 1. The top 5 most central nodes are 117150 (degree 17643), 117441 (degree 10602), 117149 (degree 10597), 116859 (degree 7870) and 117151 (degree 7767).
