"""
This file offers the methods to automatically retrieve the graph SocDelicious.
...
def SocDelicious(
    ...
    **additional_graph_kwargs: Dict
    ...
    """Return new instance of the SocDelicious graph.
