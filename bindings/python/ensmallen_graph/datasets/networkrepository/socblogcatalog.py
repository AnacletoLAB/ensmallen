"""
This file offers the methods to automatically retrieve the graph SocBlogcatalog.
...
def SocBlogcatalog(
    ...
    **additional_graph_kwargs: Dict
    ...
    """Return new instance of the SocBlogcatalog graph.
    ...
    Returns
    -----------------------
    Instace of SocBlogcatalog graph.
