"""
This file offers the methods to automatically retrieve the graph InfRoadnetCa.
...
def InfRoadnetCa(
    ...
    **additional_graph_kwargs: Dict
    ...
    """Return new instance of the InfRoadnetCa graph.
