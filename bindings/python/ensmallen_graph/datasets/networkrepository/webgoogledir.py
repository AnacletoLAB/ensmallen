...
The undirected graph web-google-dir has 875713 nodes and 4322051 weighted edges, of which none are self-loops. The graph is extremely sparse as it has a density of 0.00001 and has 2746 connected components, where the component with most nodes has 855802 nodes and the component with the least nodes has 2 nodes. The graph median node degree is 5, the mean node degree is 9.87, and the node degree mode is 1. The top 5 most central nodes are 3179 (degree 6332), 116 (degree 5356), 1182 (degree 5273), 13084 (degree 5192) and 3151 (degree 5100).
