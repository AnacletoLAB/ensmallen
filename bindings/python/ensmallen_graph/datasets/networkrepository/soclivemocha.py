...
The undirected graph soc-LiveMocha has 104103 nodes and 2193083 unweighted edges, of which none are self-loops. The graph is quite sparse as it has a density of 0.00040 and is connected, as it has a single component. The graph median node degree is 13, the mean node degree is 42.13, and the node degree mode is 1. The top 5 most central nodes are 106 (degree 2980), 557 (degree 2972), 1846 (degree 2924), 523 (degree 2632) and 663 (degree 2595).
