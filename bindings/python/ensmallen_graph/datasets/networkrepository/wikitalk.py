...
and has 2555 connected components, where the component with most nodes has 2388953
nodes and the component with the least nodes has 2 nodes. The graph median node degree
is 1, the mean node degree is 3.89, and the node degree mode is 1. The top 5 most
central nodes are 137042 (degree 100029), 16896 (degree 32392), 146624 (degree 22679),
