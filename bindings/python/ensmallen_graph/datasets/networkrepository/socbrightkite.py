"""
This file offers the methods to automatically retrieve the graph SocBrightkite.
...
def SocBrightkite(
    ...
    **additional_graph_kwargs: Dict
    ...
    """Return new instance of the SocBrightkite graph.
    ...
    Returns
    -----------------------
    Instace of SocBrightkite graph.
