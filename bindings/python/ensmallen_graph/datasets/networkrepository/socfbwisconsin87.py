...
The undirected graph socfb-Wisconsin87 has 23831 nodes and 835946 unweighted edges, of which none are self-loops. The graph is sparse as it has a density of 0.00294 and is connected, as it has a single component. The graph median node degree is 54, the mean node degree is 70.16, and the node degree mode is 1. The top 5 most central nodes are 5489 (degree 3484), 12649 (degree 3263), 7352 (degree 2292), 1540 (degree 1594) and 17317 (degree 1450).
