...
The undirected graph bcspwr10 has 5300 nodes and 13571 unweighted edges, of which
5300 are self-loops. The graph is quite sparse as it has a density of 0.00078 and
is connected, as it has a single component. The graph median node degree is 4, the
mean node degree is 4.12, and the node degree mode is 3. The top 5 most central nodes
are 4892 (degree 14), 5233 (degree 14), 4877 (degree 13), 4491 (degree 12) and 5239
(degree 12).
