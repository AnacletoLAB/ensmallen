"""
This file offers the methods to automatically retrieve the graph eco-kg.
...
def EcoKG(
    ...
    version: str = "20211102",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the eco-kg graph.
