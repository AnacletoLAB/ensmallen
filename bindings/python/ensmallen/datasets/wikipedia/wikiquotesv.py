"""
This file offers the methods to automatically retrieve the graph WikiQuoteSV.
...
def WikiQuoteSV(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "svwikiquote-latest-pages-articles-multistream.xml.bz2",
