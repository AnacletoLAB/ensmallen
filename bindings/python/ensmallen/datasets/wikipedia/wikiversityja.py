"""
This file offers the methods to automatically retrieve the graph WikiversityJA.
...
def WikiversityJA(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityJA graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "jawikiversity-latest-pages-articles-multistream.xml.bz2",
