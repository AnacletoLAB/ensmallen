"""
This file offers the methods to automatically retrieve the graph WikiSourceCS.
...
def WikiSourceCS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cswikisource-latest-pages-articles-multistream.xml.bz2",
