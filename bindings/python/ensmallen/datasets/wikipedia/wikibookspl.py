"""
This file offers the methods to automatically retrieve the graph WikiBooksPL.
...
def WikiBooksPL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "plwikibooks-latest-pages-articles-multistream.xml.bz2",
