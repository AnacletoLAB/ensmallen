"""
This file offers the methods to automatically retrieve the graph WikiQuoteKN.
...
def WikiQuoteKN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "knwikiquote-latest-pages-articles-multistream.xml.bz2",
