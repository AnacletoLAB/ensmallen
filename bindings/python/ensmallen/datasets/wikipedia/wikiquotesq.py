"""
This file offers the methods to automatically retrieve the graph WikiQuoteSQ.
...
def WikiQuoteSQ(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "sqwikiquote-latest-pages-articles-multistream.xml.bz2",
