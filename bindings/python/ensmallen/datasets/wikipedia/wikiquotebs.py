"""
This file offers the methods to automatically retrieve the graph WikiQuoteBS.
...
def WikiQuoteBS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bswikiquote-latest-pages-articles-multistream.xml.bz2",
