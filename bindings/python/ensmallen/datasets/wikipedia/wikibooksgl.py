"""
This file offers the methods to automatically retrieve the graph WikiBooksGL.
...
def WikiBooksGL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "glwikibooks-latest-pages-articles-multistream.xml.bz2",
