"""
This file offers the methods to automatically retrieve the graph WikiQuoteBM.
...
def WikiQuoteBM(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bmwikiquote-latest-pages-articles-multistream.xml.bz2",
