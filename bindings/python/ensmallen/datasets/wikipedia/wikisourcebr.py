"""
This file offers the methods to automatically retrieve the graph WikiSourceBR.
...
def WikiSourceBR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "brwikisource-latest-pages-articles-multistream.xml.bz2",
