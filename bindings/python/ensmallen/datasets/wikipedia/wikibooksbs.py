"""
This file offers the methods to automatically retrieve the graph WikiBooksBS.
...
def WikiBooksBS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bswikibooks-latest-pages-articles-multistream.xml.bz2",
