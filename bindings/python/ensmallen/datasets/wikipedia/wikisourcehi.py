"""
This file offers the methods to automatically retrieve the graph WikiSourceHI.
...
def WikiSourceHI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hiwikisource-latest-pages-articles-multistream.xml.bz2",
