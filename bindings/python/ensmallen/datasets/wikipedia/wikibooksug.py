"""
This file offers the methods to automatically retrieve the graph WikiBooksUG.
...
def WikiBooksUG(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ugwikibooks-latest-pages-articles-multistream.xml.bz2",
