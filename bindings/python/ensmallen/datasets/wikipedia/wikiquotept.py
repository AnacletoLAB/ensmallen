"""
This file offers the methods to automatically retrieve the graph WikiQuotePT.
...
def WikiQuotePT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ptwikiquote-latest-pages-articles-multistream.xml.bz2",
