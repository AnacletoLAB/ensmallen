"""
This file offers the methods to automatically retrieve the graph WikiBooksAY.
...
def WikiBooksAY(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "aywikibooks-latest-pages-articles-multistream.xml.bz2",
