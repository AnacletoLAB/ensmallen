"""
This file offers the methods to automatically retrieve the graph WikiSourceIT.
...
def WikiSourceIT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "itwikisource-latest-pages-articles-multistream.xml.bz2",
