"""
This file offers the methods to automatically retrieve the graph WikiQuoteLA.
...
def WikiQuoteLA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "lawikiquote-latest-pages-articles-multistream.xml.bz2",
