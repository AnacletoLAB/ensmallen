"""
This file offers the methods to automatically retrieve the graph WikiQuoteZH.
...
def WikiQuoteZH(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "zhwikiquote-latest-pages-articles-multistream.xml.bz2",
