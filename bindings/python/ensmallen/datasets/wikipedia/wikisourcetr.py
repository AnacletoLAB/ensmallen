"""
This file offers the methods to automatically retrieve the graph WikiSourceTR.
...
def WikiSourceTR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "trwikisource-latest-pages-articles-multistream.xml.bz2",
