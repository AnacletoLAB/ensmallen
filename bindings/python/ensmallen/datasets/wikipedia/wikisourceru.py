"""
This file offers the methods to automatically retrieve the graph WikiSourceRU.
...
def WikiSourceRU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ruwikisource-latest-pages-articles-multistream.xml.bz2",
