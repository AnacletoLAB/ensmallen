"""
This file offers the methods to automatically retrieve the graph WikiQuoteVO.
...
def WikiQuoteVO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "vowikiquote-latest-pages-articles-multistream.xml.bz2",
