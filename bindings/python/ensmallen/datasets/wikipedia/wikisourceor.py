"""
This file offers the methods to automatically retrieve the graph WikiSourceOR.
...
def WikiSourceOR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "orwikisource-latest-pages-articles-multistream.xml.bz2",
