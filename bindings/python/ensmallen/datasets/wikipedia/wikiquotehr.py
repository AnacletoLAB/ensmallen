"""
This file offers the methods to automatically retrieve the graph WikiQuoteHR.
...
def WikiQuoteHR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hrwikiquote-latest-pages-articles-multistream.xml.bz2",
