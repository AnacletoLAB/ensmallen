"""
This file offers the methods to automatically retrieve the graph WikiBooksMY.
...
def WikiBooksMY(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "mywikibooks-latest-pages-articles-multistream.xml.bz2",
