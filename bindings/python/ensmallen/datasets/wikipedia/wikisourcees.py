"""
This file offers the methods to automatically retrieve the graph WikiSourceES.
...
def WikiSourceES(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "eswikisource-latest-pages-articles-multistream.xml.bz2",
