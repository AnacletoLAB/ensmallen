"""
This file offers the methods to automatically retrieve the graph WikiVoyageRO.
...
def WikiVoyageRO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "rowikivoyage-latest-pages-articles-multistream.xml.bz2",
