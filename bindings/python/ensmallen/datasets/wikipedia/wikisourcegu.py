"""
This file offers the methods to automatically retrieve the graph WikiSourceGU.
...
def WikiSourceGU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "guwikisource-latest-pages-articles-multistream.xml.bz2",
