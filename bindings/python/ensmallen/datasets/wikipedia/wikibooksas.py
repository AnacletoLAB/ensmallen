"""
This file offers the methods to automatically retrieve the graph WikiBooksAS.
...
def WikiBooksAS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "aswikibooks-latest-pages-articles-multistream.xml.bz2",
