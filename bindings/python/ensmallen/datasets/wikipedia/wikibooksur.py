"""
This file offers the methods to automatically retrieve the graph WikiBooksUR.
...
def WikiBooksUR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "urwikibooks-latest-pages-articles-multistream.xml.bz2",
