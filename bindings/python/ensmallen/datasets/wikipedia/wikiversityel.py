"""
This file offers the methods to automatically retrieve the graph WikiversityEL.
...
def WikiversityEL(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityEL graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "elwikiversity-latest-pages-articles-multistream.xml.bz2",
