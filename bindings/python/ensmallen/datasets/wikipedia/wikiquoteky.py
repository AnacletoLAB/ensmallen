"""
This file offers the methods to automatically retrieve the graph WikiQuoteKY.
...
def WikiQuoteKY(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kywikiquote-latest-pages-articles-multistream.xml.bz2",
