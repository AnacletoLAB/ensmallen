"""
This file offers the methods to automatically retrieve the graph WikiVoyageFI.
...
def WikiVoyageFI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "fiwikivoyage-latest-pages-articles-multistream.xml.bz2",
