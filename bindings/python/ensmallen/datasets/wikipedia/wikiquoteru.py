"""
This file offers the methods to automatically retrieve the graph WikiQuoteRU.
...
def WikiQuoteRU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ruwikiquote-latest-pages-articles-multistream.xml.bz2",
