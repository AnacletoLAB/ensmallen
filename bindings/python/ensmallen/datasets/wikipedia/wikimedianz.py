"""
This file offers the methods to automatically retrieve the graph WikiMediaNZ.
...
def WikiMediaNZ(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "nzwikimedia-latest-pages-articles-multistream.xml.bz2",
