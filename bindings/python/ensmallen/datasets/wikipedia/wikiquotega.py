"""
This file offers the methods to automatically retrieve the graph WikiQuoteGA.
...
def WikiQuoteGA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "gawikiquote-latest-pages-articles-multistream.xml.bz2",
