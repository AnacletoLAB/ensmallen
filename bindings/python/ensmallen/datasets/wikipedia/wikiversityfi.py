"""
This file offers the methods to automatically retrieve the graph WikiversityFI.
...
def WikiversityFI(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityFI graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "fiwikiversity-latest-pages-articles-multistream.xml.bz2",
