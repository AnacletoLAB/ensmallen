"""
This file offers the methods to automatically retrieve the graph WikiBooksNE.
...
def WikiBooksNE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "newikibooks-latest-pages-articles-multistream.xml.bz2",
