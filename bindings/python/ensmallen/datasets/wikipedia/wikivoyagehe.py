"""
This file offers the methods to automatically retrieve the graph WikiVoyageHE.
...
def WikiVoyageHE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hewikivoyage-latest-pages-articles-multistream.xml.bz2",
