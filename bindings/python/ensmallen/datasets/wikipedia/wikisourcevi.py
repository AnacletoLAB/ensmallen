"""
This file offers the methods to automatically retrieve the graph WikiSourceVI.
...
def WikiSourceVI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "viwikisource-latest-pages-articles-multistream.xml.bz2",
