"""
This file offers the methods to automatically retrieve the graph WikiNewsFA.
...
def WikiNewsFA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "fawikinews-latest-pages-articles-multistream.xml.bz2",
