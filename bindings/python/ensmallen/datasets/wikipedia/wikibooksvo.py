"""
This file offers the methods to automatically retrieve the graph WikiBooksVO.
...
def WikiBooksVO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "vowikibooks-latest-pages-articles-multistream.xml.bz2",
