"""
This file offers the methods to automatically retrieve the graph WikiBooksTE.
...
def WikiBooksTE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "tewikibooks-latest-pages-articles-multistream.xml.bz2",
