"""
This file offers the methods to automatically retrieve the graph WikiBooksBN.
...
def WikiBooksBN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bnwikibooks-latest-pages-articles-multistream.xml.bz2",
