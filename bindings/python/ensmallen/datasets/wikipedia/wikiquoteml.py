"""
This file offers the methods to automatically retrieve the graph WikiQuoteML.
...
def WikiQuoteML(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "mlwikiquote-latest-pages-articles-multistream.xml.bz2",
