"""
This file offers the methods to automatically retrieve the graph WikiQuoteEU.
...
def WikiQuoteEU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "euwikiquote-latest-pages-articles-multistream.xml.bz2",
