"""
This file offers the methods to automatically retrieve the graph WikiQuoteVI.
...
def WikiQuoteVI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "viwikiquote-latest-pages-articles-multistream.xml.bz2",
