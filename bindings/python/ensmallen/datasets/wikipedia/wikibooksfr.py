"""
This file offers the methods to automatically retrieve the graph WikiBooksFR.
...
def WikiBooksFR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "frwikibooks-latest-pages-articles-multistream.xml.bz2",
