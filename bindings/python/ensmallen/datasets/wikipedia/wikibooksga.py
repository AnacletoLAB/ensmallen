"""
This file offers the methods to automatically retrieve the graph WikiBooksGA.
...
def WikiBooksGA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "gawikibooks-latest-pages-articles-multistream.xml.bz2",
