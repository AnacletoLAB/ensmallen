"""
This file offers the methods to automatically retrieve the graph WikiBooksKA.
...
def WikiBooksKA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kawikibooks-latest-pages-articles-multistream.xml.bz2",
