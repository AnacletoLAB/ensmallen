"""
This file offers the methods to automatically retrieve the graph WikiversityRU.
...
def WikiversityRU(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityRU graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ruwikiversity-latest-pages-articles-multistream.xml.bz2",
