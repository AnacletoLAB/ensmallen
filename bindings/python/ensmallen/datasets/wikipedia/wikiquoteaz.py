"""
This file offers the methods to automatically retrieve the graph WikiQuoteAZ.
...
def WikiQuoteAZ(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "azwikiquote-latest-pages-articles-multistream.xml.bz2",
