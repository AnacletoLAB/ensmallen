"""
This file offers the methods to automatically retrieve the graph WikiQuoteID.
...
def WikiQuoteID(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "idwikiquote-latest-pages-articles-multistream.xml.bz2",
