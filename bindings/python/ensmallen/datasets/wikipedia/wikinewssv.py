"""
This file offers the methods to automatically retrieve the graph WikiNewsSV.
...
def WikiNewsSV(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "svwikinews-latest-pages-articles-multistream.xml.bz2",
