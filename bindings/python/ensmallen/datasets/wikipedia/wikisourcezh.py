"""
This file offers the methods to automatically retrieve the graph WikiSourceZH.
...
def WikiSourceZH(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "zhwikisource-latest-pages-articles-multistream.xml.bz2",
