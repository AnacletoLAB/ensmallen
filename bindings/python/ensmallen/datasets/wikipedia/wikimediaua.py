"""
This file offers the methods to automatically retrieve the graph WikiMediaUA.
...
def WikiMediaUA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "uawikimedia-latest-pages-articles-multistream.xml.bz2",
