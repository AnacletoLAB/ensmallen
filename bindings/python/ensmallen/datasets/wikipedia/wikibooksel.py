"""
This file offers the methods to automatically retrieve the graph WikiBooksEL.
...
def WikiBooksEL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "elwikibooks-latest-pages-articles-multistream.xml.bz2",
