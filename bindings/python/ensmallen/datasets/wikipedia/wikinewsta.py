"""
This file offers the methods to automatically retrieve the graph WikiNewsTA.
...
def WikiNewsTA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "tawikinews-latest-pages-articles-multistream.xml.bz2",
