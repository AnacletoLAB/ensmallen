"""
This file offers the methods to automatically retrieve the graph WikiNewsFR.
...
def WikiNewsFR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "frwikinews-latest-pages-articles-multistream.xml.bz2",
