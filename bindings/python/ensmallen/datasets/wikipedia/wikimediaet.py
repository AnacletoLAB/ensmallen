"""
This file offers the methods to automatically retrieve the graph WikiMediaET.
...
def WikiMediaET(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "etwikimedia-latest-pages-articles-multistream.xml.bz2",
