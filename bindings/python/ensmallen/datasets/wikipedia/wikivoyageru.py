"""
This file offers the methods to automatically retrieve the graph WikiVoyageRU.
...
def WikiVoyageRU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ruwikivoyage-latest-pages-articles-multistream.xml.bz2",
