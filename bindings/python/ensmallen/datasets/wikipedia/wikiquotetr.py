"""
This file offers the methods to automatically retrieve the graph WikiQuoteTR.
...
def WikiQuoteTR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "trwikiquote-latest-pages-articles-multistream.xml.bz2",
