"""
This file offers the methods to automatically retrieve the graph WikiBooksHI.
...
def WikiBooksHI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hiwikibooks-latest-pages-articles-multistream.xml.bz2",
