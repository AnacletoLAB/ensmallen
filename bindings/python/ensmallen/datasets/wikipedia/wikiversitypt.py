"""
This file offers the methods to automatically retrieve the graph WikiversityPT.
...
def WikiversityPT(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityPT graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ptwikiversity-latest-pages-articles-multistream.xml.bz2",
