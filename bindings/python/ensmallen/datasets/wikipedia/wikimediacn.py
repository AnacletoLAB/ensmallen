"""
This file offers the methods to automatically retrieve the graph WikiMediaCN.
...
def WikiMediaCN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cnwikimedia-latest-pages-articles-multistream.xml.bz2",
