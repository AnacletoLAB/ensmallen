"""
This file offers the methods to automatically retrieve the graph WikiQuoteWO.
...
def WikiQuoteWO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "wowikiquote-latest-pages-articles-multistream.xml.bz2",
