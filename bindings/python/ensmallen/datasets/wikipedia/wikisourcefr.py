"""
This file offers the methods to automatically retrieve the graph WikiSourceFR.
...
def WikiSourceFR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "frwikisource-latest-pages-articles-multistream.xml.bz2",
