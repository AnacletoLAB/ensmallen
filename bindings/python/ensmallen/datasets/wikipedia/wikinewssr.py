"""
This file offers the methods to automatically retrieve the graph WikiNewsSR.
...
def WikiNewsSR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "srwikinews-latest-pages-articles-multistream.xml.bz2",
