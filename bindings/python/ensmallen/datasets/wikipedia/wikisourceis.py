"""
This file offers the methods to automatically retrieve the graph WikiSourceIS.
...
def WikiSourceIS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "iswikisource-latest-pages-articles-multistream.xml.bz2",
