"""
This file offers the methods to automatically retrieve the graph WikiVoyageZH.
...
def WikiVoyageZH(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "zhwikivoyage-latest-pages-articles-multistream.xml.bz2",
