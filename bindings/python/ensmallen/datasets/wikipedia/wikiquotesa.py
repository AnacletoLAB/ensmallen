"""
This file offers the methods to automatically retrieve the graph WikiQuoteSA.
...
def WikiQuoteSA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "sawikiquote-latest-pages-articles-multistream.xml.bz2",
