"""
This file offers the methods to automatically retrieve the graph WikiQuoteDA.
...
def WikiQuoteDA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "dawikiquote-latest-pages-articles-multistream.xml.bz2",
