"""
This file offers the methods to automatically retrieve the graph WikiSourceCA.
...
def WikiSourceCA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cawikisource-latest-pages-articles-multistream.xml.bz2",
