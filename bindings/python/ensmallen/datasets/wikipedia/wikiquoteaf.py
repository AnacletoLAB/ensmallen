"""
This file offers the methods to automatically retrieve the graph WikiQuoteAF.
...
def WikiQuoteAF(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "afwikiquote-latest-pages-articles-multistream.xml.bz2",
