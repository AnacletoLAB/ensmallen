"""
This file offers the methods to automatically retrieve the graph WikiBooksTT.
...
def WikiBooksTT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ttwikibooks-latest-pages-articles-multistream.xml.bz2",
