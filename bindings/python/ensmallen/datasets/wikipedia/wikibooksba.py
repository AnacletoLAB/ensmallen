"""
This file offers the methods to automatically retrieve the graph WikiBooksBA.
...
def WikiBooksBA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bawikibooks-latest-pages-articles-multistream.xml.bz2",
