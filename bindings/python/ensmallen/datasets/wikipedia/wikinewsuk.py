"""
This file offers the methods to automatically retrieve the graph WikiNewsUK.
...
def WikiNewsUK(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ukwikinews-latest-pages-articles-multistream.xml.bz2",
