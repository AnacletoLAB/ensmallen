"""
This file offers the methods to automatically retrieve the graph WikiSourceMR.
...
def WikiSourceMR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "mrwikisource-latest-pages-articles-multistream.xml.bz2",
