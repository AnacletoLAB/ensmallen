"""
This file offers the methods to automatically retrieve the graph WikiQuoteTE.
...
def WikiQuoteTE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "tewikiquote-latest-pages-articles-multistream.xml.bz2",
