"""
This file offers the methods to automatically retrieve the graph WikiversityIT.
...
def WikiversityIT(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityIT graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "itwikiversity-latest-pages-articles-multistream.xml.bz2",
