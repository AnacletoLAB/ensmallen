"""
This file offers the methods to automatically retrieve the graph WikiMediaWB.
...
def WikiMediaWB(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "wbwikimedia-latest-pages-articles-multistream.xml.bz2",
