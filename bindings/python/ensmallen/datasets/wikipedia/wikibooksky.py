"""
This file offers the methods to automatically retrieve the graph WikiBooksKY.
...
def WikiBooksKY(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kywikibooks-latest-pages-articles-multistream.xml.bz2",
