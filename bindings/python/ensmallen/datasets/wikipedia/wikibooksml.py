"""
This file offers the methods to automatically retrieve the graph WikiBooksML.
...
def WikiBooksML(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "mlwikibooks-latest-pages-articles-multistream.xml.bz2",
