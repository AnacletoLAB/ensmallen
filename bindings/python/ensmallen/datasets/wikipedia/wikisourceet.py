"""
This file offers the methods to automatically retrieve the graph WikiSourceET.
...
def WikiSourceET(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "etwikisource-latest-pages-articles-multistream.xml.bz2",
