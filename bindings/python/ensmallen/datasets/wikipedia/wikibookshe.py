"""
This file offers the methods to automatically retrieve the graph WikiBooksHE.
...
def WikiBooksHE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hewikibooks-latest-pages-articles-multistream.xml.bz2",
