"""
This file offers the methods to automatically retrieve the graph WikiQuoteCR.
...
def WikiQuoteCR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "crwikiquote-latest-pages-articles-multistream.xml.bz2",
