"""
This file offers the methods to automatically retrieve the graph WikiNewsES.
...
def WikiNewsES(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "eswikinews-latest-pages-articles-multistream.xml.bz2",
