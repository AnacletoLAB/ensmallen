"""
This file offers the methods to automatically retrieve the graph WikiQuoteTK.
...
def WikiQuoteTK(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "tkwikiquote-latest-pages-articles-multistream.xml.bz2",
