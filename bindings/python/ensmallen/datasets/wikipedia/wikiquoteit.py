"""
This file offers the methods to automatically retrieve the graph WikiQuoteIT.
...
def WikiQuoteIT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "itwikiquote-latest-pages-articles-multistream.xml.bz2",
