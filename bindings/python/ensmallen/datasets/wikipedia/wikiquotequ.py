"""
This file offers the methods to automatically retrieve the graph WikiQuoteQU.
...
def WikiQuoteQU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "quwikiquote-latest-pages-articles-multistream.xml.bz2",
