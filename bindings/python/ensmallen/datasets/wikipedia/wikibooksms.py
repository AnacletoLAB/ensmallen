"""
This file offers the methods to automatically retrieve the graph WikiBooksMS.
...
def WikiBooksMS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "mswikibooks-latest-pages-articles-multistream.xml.bz2",
