"""
This file offers the methods to automatically retrieve the graph WikiBooksLA.
...
def WikiBooksLA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "lawikibooks-latest-pages-articles-multistream.xml.bz2",
