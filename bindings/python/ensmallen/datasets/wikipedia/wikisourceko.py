"""
This file offers the methods to automatically retrieve the graph WikiSourceKO.
...
def WikiSourceKO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kowikisource-latest-pages-articles-multistream.xml.bz2",
