"""
This file offers the methods to automatically retrieve the graph WikiNewsBG.
...
def WikiNewsBG(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bgwikinews-latest-pages-articles-multistream.xml.bz2",
