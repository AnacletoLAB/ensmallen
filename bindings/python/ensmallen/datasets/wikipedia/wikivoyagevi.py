"""
This file offers the methods to automatically retrieve the graph WikiVoyageVI.
...
def WikiVoyageVI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "viwikivoyage-latest-pages-articles-multistream.xml.bz2",
