"""
This file offers the methods to automatically retrieve the graph WikiBooksVI.
...
def WikiBooksVI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "viwikibooks-latest-pages-articles-multistream.xml.bz2",
