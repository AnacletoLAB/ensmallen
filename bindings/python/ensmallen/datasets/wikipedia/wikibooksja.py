"""
This file offers the methods to automatically retrieve the graph WikiBooksJA.
...
def WikiBooksJA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "jawikibooks-latest-pages-articles-multistream.xml.bz2",
