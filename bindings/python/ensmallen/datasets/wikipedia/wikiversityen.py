"""
This file offers the methods to automatically retrieve the graph WikiversityEN.
...
def WikiversityEN(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityEN graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "enwikiversity-latest-pages-articles-multistream.xml.bz2",
