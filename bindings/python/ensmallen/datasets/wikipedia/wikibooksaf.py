"""
This file offers the methods to automatically retrieve the graph WikiBooksAF.
...
def WikiBooksAF(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "afwikibooks-latest-pages-articles-multistream.xml.bz2",
