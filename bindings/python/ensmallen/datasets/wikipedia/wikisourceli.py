"""
This file offers the methods to automatically retrieve the graph WikiSourceLI.
...
def WikiSourceLI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "liwikisource-latest-pages-articles-multistream.xml.bz2",
