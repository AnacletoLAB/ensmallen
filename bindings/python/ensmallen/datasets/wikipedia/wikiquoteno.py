"""
This file offers the methods to automatically retrieve the graph WikiQuoteNO.
...
def WikiQuoteNO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "nowikiquote-latest-pages-articles-multistream.xml.bz2",
