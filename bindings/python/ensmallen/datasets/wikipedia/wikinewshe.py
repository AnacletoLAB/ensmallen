"""
This file offers the methods to automatically retrieve the graph WikiNewsHE.
...
def WikiNewsHE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hewikinews-latest-pages-articles-multistream.xml.bz2",
