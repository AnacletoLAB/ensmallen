"""
This file offers the methods to automatically retrieve the graph WikiSourceMK.
...
def WikiSourceMK(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "mkwikisource-latest-pages-articles-multistream.xml.bz2",
