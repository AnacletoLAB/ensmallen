"""
This file offers the methods to automatically retrieve the graph WikiBooksTG.
...
def WikiBooksTG(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "tgwikibooks-latest-pages-articles-multistream.xml.bz2",
