"""
This file offers the methods to automatically retrieve the graph WikiBooksIT.
...
def WikiBooksIT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "itwikibooks-latest-pages-articles-multistream.xml.bz2",
