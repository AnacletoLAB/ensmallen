"""
This file offers the methods to automatically retrieve the graph WikiBooksCS.
...
def WikiBooksCS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cswikibooks-latest-pages-articles-multistream.xml.bz2",
