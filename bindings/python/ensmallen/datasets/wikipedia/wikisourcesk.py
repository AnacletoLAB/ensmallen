"""
This file offers the methods to automatically retrieve the graph WikiSourceSK.
...
def WikiSourceSK(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "skwikisource-latest-pages-articles-multistream.xml.bz2",
