"""
This file offers the methods to automatically retrieve the graph WikiSourceNL.
...
def WikiSourceNL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "nlwikisource-latest-pages-articles-multistream.xml.bz2",
