"""
This file offers the methods to automatically retrieve the graph WikiversityZH.
...
def WikiversityZH(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityZH graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "zhwikiversity-latest-pages-articles-multistream.xml.bz2",
