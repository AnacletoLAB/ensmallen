"""
This file offers the methods to automatically retrieve the graph WikiNewsHU.
...
def WikiNewsHU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "huwikinews-latest-pages-articles-multistream.xml.bz2",
