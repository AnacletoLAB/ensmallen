"""
This file offers the methods to automatically retrieve the graph WikiBooksKK.
...
def WikiBooksKK(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kkwikibooks-latest-pages-articles-multistream.xml.bz2",
