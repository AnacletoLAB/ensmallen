"""
This file offers the methods to automatically retrieve the graph WikiBooksRU.
...
def WikiBooksRU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ruwikibooks-latest-pages-articles-multistream.xml.bz2",
