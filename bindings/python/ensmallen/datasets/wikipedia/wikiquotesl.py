"""
This file offers the methods to automatically retrieve the graph WikiQuoteSL.
...
def WikiQuoteSL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "slwikiquote-latest-pages-articles-multistream.xml.bz2",
