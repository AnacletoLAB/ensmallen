"""
This file offers the methods to automatically retrieve the graph WikiBooksUZ.
...
def WikiBooksUZ(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "uzwikibooks-latest-pages-articles-multistream.xml.bz2",
