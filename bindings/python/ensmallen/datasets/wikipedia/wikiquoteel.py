"""
This file offers the methods to automatically retrieve the graph WikiQuoteEL.
...
def WikiQuoteEL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "elwikiquote-latest-pages-articles-multistream.xml.bz2",
