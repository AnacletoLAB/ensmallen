"""
This file offers the methods to automatically retrieve the graph WikiBooksSW.
...
def WikiBooksSW(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "swwikibooks-latest-pages-articles-multistream.xml.bz2",
