"""
This file offers the methods to automatically retrieve the graph WikiVoyagePS.
...
def WikiVoyagePS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "pswikivoyage-latest-pages-articles-multistream.xml.bz2",
