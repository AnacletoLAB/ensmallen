"""
This file offers the methods to automatically retrieve the graph WikiVoyageDE.
...
def WikiVoyageDE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "dewikivoyage-latest-pages-articles-multistream.xml.bz2",
