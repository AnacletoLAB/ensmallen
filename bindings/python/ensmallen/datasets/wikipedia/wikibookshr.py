"""
This file offers the methods to automatically retrieve the graph WikiBooksHR.
...
def WikiBooksHR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hrwikibooks-latest-pages-articles-multistream.xml.bz2",
