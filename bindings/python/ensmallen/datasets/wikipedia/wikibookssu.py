"""
This file offers the methods to automatically retrieve the graph WikiBooksSU.
...
def WikiBooksSU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "suwikibooks-latest-pages-articles-multistream.xml.bz2",
