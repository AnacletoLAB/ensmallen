"""
This file offers the methods to automatically retrieve the graph WikiMediaAR.
...
def WikiMediaAR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "arwikimedia-latest-pages-articles-multistream.xml.bz2",
