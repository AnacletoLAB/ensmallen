"""
This file offers the methods to automatically retrieve the graph WikiSourceJA.
...
def WikiSourceJA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "jawikisource-latest-pages-articles-multistream.xml.bz2",
