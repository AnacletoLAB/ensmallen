"""
This file offers the methods to automatically retrieve the graph WikiQuoteEN.
...
def WikiQuoteEN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "enwikiquote-latest-pages-articles-multistream.xml.bz2",
