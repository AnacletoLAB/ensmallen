"""
This file offers the methods to automatically retrieve the graph WikiBooksFY.
...
def WikiBooksFY(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "fywikibooks-latest-pages-articles-multistream.xml.bz2",
