"""
This file offers the methods to automatically retrieve the graph WikiVoyageTR.
...
def WikiVoyageTR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "trwikivoyage-latest-pages-articles-multistream.xml.bz2",
