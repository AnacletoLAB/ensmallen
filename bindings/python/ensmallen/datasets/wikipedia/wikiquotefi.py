"""
This file offers the methods to automatically retrieve the graph WikiQuoteFI.
...
def WikiQuoteFI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "fiwikiquote-latest-pages-articles-multistream.xml.bz2",
