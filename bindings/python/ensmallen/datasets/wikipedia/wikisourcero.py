"""
This file offers the methods to automatically retrieve the graph WikiSourceRO.
...
def WikiSourceRO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "rowikisource-latest-pages-articles-multistream.xml.bz2",
