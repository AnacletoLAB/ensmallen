"""
This file offers the methods to automatically retrieve the graph WikiQuoteKA.
...
def WikiQuoteKA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kawikiquote-latest-pages-articles-multistream.xml.bz2",
