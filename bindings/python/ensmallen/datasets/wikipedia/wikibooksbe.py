"""
This file offers the methods to automatically retrieve the graph WikiBooksBE.
...
def WikiBooksBE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bewikibooks-latest-pages-articles-multistream.xml.bz2",
