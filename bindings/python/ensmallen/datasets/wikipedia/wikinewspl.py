"""
This file offers the methods to automatically retrieve the graph WikiNewsPL.
...
def WikiNewsPL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "plwikinews-latest-pages-articles-multistream.xml.bz2",
