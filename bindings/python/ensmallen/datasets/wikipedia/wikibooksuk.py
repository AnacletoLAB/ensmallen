"""
This file offers the methods to automatically retrieve the graph WikiBooksUK.
...
def WikiBooksUK(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ukwikibooks-latest-pages-articles-multistream.xml.bz2",
