"""
This file offers the methods to automatically retrieve the graph WikiversitySL.
...
def WikiversitySL(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversitySL graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "slwikiversity-latest-pages-articles-multistream.xml.bz2",
