"""
This file offers the methods to automatically retrieve the graph WikiversitySV.
...
def WikiversitySV(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversitySV graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "svwikiversity-latest-pages-articles-multistream.xml.bz2",
