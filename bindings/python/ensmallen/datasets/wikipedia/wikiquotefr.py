"""
This file offers the methods to automatically retrieve the graph WikiQuoteFR.
...
def WikiQuoteFR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "frwikiquote-latest-pages-articles-multistream.xml.bz2",
