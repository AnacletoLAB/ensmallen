"""
This file offers the methods to automatically retrieve the graph WikiSourceHR.
...
def WikiSourceHR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hrwikisource-latest-pages-articles-multistream.xml.bz2",
