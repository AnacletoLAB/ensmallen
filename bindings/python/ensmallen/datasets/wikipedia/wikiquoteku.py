"""
This file offers the methods to automatically retrieve the graph WikiQuoteKU.
...
def WikiQuoteKU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kuwikiquote-latest-pages-articles-multistream.xml.bz2",
