"""
This file offers the methods to automatically retrieve the graph WikiMediaBR.
...
def WikiMediaBR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "brwikimedia-latest-pages-articles-multistream.xml.bz2",
