"""
This file offers the methods to automatically retrieve the graph WikiQuoteAR.
...
def WikiQuoteAR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "arwikiquote-latest-pages-articles-multistream.xml.bz2",
