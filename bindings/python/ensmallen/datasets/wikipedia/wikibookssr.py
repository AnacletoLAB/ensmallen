"""
This file offers the methods to automatically retrieve the graph WikiBooksSR.
...
def WikiBooksSR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "srwikibooks-latest-pages-articles-multistream.xml.bz2",
