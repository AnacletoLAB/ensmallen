"""
This file offers the methods to automatically retrieve the graph WikiBooksLT.
...
def WikiBooksLT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ltwikibooks-latest-pages-articles-multistream.xml.bz2",
