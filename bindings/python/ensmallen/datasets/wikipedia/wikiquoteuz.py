"""
This file offers the methods to automatically retrieve the graph WikiQuoteUZ.
...
def WikiQuoteUZ(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "uzwikiquote-latest-pages-articles-multistream.xml.bz2",
