"""
This file offers the methods to automatically retrieve the graph WikiNewsZH.
...
def WikiNewsZH(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "zhwikinews-latest-pages-articles-multistream.xml.bz2",
