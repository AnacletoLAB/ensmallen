"""
This file offers the methods to automatically retrieve the graph WikiBooksMI.
...
def WikiBooksMI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "miwikibooks-latest-pages-articles-multistream.xml.bz2",
