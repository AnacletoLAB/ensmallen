"""
This file offers the methods to automatically retrieve the graph WikiQuoteKO.
...
def WikiQuoteKO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kowikiquote-latest-pages-articles-multistream.xml.bz2",
