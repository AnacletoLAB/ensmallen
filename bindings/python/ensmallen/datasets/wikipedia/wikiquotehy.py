"""
This file offers the methods to automatically retrieve the graph WikiQuoteHY.
...
def WikiQuoteHY(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hywikiquote-latest-pages-articles-multistream.xml.bz2",
