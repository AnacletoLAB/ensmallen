"""
This file offers the methods to automatically retrieve the graph WikiQuoteAM.
...
def WikiQuoteAM(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "amwikiquote-latest-pages-articles-multistream.xml.bz2",
