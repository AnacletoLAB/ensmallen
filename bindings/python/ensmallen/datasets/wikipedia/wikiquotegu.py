"""
This file offers the methods to automatically retrieve the graph WikiQuoteGU.
...
def WikiQuoteGU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "guwikiquote-latest-pages-articles-multistream.xml.bz2",
