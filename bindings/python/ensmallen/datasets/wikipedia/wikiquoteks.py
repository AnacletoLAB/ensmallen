"""
This file offers the methods to automatically retrieve the graph WikiQuoteKS.
...
def WikiQuoteKS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kswikiquote-latest-pages-articles-multistream.xml.bz2",
