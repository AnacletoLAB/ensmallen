"""
This file offers the methods to automatically retrieve the graph WikiSourcePL.
...
def WikiSourcePL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "plwikisource-latest-pages-articles-multistream.xml.bz2",
