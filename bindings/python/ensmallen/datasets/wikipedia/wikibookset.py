"""
This file offers the methods to automatically retrieve the graph WikiBooksET.
...
def WikiBooksET(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "etwikibooks-latest-pages-articles-multistream.xml.bz2",
