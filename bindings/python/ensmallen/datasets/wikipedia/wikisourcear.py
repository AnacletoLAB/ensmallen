"""
This file offers the methods to automatically retrieve the graph WikiSourceAR.
...
def WikiSourceAR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "arwikisource-latest-pages-articles-multistream.xml.bz2",
