"""
This file offers the methods to automatically retrieve the graph WikiversityHI.
...
def WikiversityHI(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityHI graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hiwikiversity-latest-pages-articles-multistream.xml.bz2",
