"""
This file offers the methods to automatically retrieve the graph WikiMediaCO.
...
def WikiMediaCO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cowikimedia-latest-pages-articles-multistream.xml.bz2",
