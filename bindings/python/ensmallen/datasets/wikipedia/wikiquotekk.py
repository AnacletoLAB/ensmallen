"""
This file offers the methods to automatically retrieve the graph WikiQuoteKK.
...
def WikiQuoteKK(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kkwikiquote-latest-pages-articles-multistream.xml.bz2",
