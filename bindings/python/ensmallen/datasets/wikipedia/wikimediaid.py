"""
This file offers the methods to automatically retrieve the graph WikiMediaID.
...
def WikiMediaID(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "idwikimedia-latest-pages-articles-multistream.xml.bz2",
