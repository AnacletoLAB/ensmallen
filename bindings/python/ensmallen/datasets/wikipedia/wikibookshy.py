"""
This file offers the methods to automatically retrieve the graph WikiBooksHY.
...
def WikiBooksHY(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hywikibooks-latest-pages-articles-multistream.xml.bz2",
