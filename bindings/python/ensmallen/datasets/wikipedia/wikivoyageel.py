"""
This file offers the methods to automatically retrieve the graph WikiVoyageEL.
...
def WikiVoyageEL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "elwikivoyage-latest-pages-articles-multistream.xml.bz2",
