"""
This file offers the methods to automatically retrieve the graph WikiBooksAR.
...
def WikiBooksAR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "arwikibooks-latest-pages-articles-multistream.xml.bz2",
