"""
This file offers the methods to automatically retrieve the graph WikiversityKO.
...
def WikiversityKO(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityKO graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kowikiversity-latest-pages-articles-multistream.xml.bz2",
