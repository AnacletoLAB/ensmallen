"""
This file offers the methods to automatically retrieve the graph WikiQuoteHE.
...
def WikiQuoteHE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hewikiquote-latest-pages-articles-multistream.xml.bz2",
