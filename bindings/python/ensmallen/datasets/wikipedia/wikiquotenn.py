"""
This file offers the methods to automatically retrieve the graph WikiQuoteNN.
...
def WikiQuoteNN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "nnwikiquote-latest-pages-articles-multistream.xml.bz2",
