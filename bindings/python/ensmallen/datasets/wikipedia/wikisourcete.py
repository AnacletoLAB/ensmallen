"""
This file offers the methods to automatically retrieve the graph WikiSourceTE.
...
def WikiSourceTE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "tewikisource-latest-pages-articles-multistream.xml.bz2",
