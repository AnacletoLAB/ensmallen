"""
This file offers the methods to automatically retrieve the graph WikiVoyageFR.
...
def WikiVoyageFR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "frwikivoyage-latest-pages-articles-multistream.xml.bz2",
