"""
This file offers the methods to automatically retrieve the graph WikiBooksFI.
...
def WikiBooksFI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "fiwikibooks-latest-pages-articles-multistream.xml.bz2",
