"""
This file offers the methods to automatically retrieve the graph WikiBooksTL.
...
def WikiBooksTL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "tlwikibooks-latest-pages-articles-multistream.xml.bz2",
