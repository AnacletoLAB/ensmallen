"""
This file offers the methods to automatically retrieve the graph WikiQuoteTA.
...
def WikiQuoteTA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "tawikiquote-latest-pages-articles-multistream.xml.bz2",
