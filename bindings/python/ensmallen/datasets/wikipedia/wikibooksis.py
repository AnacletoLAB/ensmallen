"""
This file offers the methods to automatically retrieve the graph WikiBooksIS.
...
def WikiBooksIS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "iswikibooks-latest-pages-articles-multistream.xml.bz2",
