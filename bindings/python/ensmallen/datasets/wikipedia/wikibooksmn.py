"""
This file offers the methods to automatically retrieve the graph WikiBooksMN.
...
def WikiBooksMN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "mnwikibooks-latest-pages-articles-multistream.xml.bz2",
