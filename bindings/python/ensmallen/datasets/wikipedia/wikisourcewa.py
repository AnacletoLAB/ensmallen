"""
This file offers the methods to automatically retrieve the graph WikiSourceWA.
...
def WikiSourceWA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "wawikisource-latest-pages-articles-multistream.xml.bz2",
