"""
This file offers the methods to automatically retrieve the graph WikiBooksXH.
...
def WikiBooksXH(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "xhwikibooks-latest-pages-articles-multistream.xml.bz2",
