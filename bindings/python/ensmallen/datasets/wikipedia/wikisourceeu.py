"""
This file offers the methods to automatically retrieve the graph WikiSourceEU.
...
def WikiSourceEU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "euwikisource-latest-pages-articles-multistream.xml.bz2",
