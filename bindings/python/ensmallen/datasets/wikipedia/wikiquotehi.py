"""
This file offers the methods to automatically retrieve the graph WikiQuoteHI.
...
def WikiQuoteHI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hiwikiquote-latest-pages-articles-multistream.xml.bz2",
