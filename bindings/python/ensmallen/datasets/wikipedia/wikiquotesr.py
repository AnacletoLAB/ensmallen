"""
This file offers the methods to automatically retrieve the graph WikiQuoteSR.
...
def WikiQuoteSR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "srwikiquote-latest-pages-articles-multistream.xml.bz2",
