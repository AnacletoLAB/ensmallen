"""
This file offers the methods to automatically retrieve the graph WikiMediaTR.
...
def WikiMediaTR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "trwikimedia-latest-pages-articles-multistream.xml.bz2",
