"""
This file offers the methods to automatically retrieve the graph WikiVoyageES.
...
def WikiVoyageES(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "eswikivoyage-latest-pages-articles-multistream.xml.bz2",
