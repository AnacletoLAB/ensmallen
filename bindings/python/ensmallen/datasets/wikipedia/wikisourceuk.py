"""
This file offers the methods to automatically retrieve the graph WikiSourceUK.
...
def WikiSourceUK(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ukwikisource-latest-pages-articles-multistream.xml.bz2",
