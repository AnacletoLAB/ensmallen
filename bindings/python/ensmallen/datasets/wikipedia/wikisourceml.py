"""
This file offers the methods to automatically retrieve the graph WikiSourceML.
...
def WikiSourceML(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "mlwikisource-latest-pages-articles-multistream.xml.bz2",
