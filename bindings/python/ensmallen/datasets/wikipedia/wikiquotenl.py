"""
This file offers the methods to automatically retrieve the graph WikiQuoteNL.
...
def WikiQuoteNL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "nlwikiquote-latest-pages-articles-multistream.xml.bz2",
