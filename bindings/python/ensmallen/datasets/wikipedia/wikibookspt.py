"""
This file offers the methods to automatically retrieve the graph WikiBooksPT.
...
def WikiBooksPT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ptwikibooks-latest-pages-articles-multistream.xml.bz2",
