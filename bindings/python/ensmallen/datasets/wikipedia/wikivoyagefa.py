"""
This file offers the methods to automatically retrieve the graph WikiVoyageFA.
...
def WikiVoyageFA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "fawikivoyage-latest-pages-articles-multistream.xml.bz2",
