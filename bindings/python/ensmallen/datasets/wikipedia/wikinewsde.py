"""
This file offers the methods to automatically retrieve the graph WikiNewsDE.
...
def WikiNewsDE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "dewikinews-latest-pages-articles-multistream.xml.bz2",
