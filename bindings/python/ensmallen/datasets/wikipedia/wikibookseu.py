"""
This file offers the methods to automatically retrieve the graph WikiBooksEU.
...
def WikiBooksEU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "euwikibooks-latest-pages-articles-multistream.xml.bz2",
