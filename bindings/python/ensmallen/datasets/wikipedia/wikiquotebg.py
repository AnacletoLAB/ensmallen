"""
This file offers the methods to automatically retrieve the graph WikiQuoteBG.
...
def WikiQuoteBG(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bgwikiquote-latest-pages-articles-multistream.xml.bz2",
