"""
This file offers the methods to automatically retrieve the graph WikiVoyageSV.
...
def WikiVoyageSV(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "svwikivoyage-latest-pages-articles-multistream.xml.bz2",
