"""
This file offers the methods to automatically retrieve the graph WikiMediaBD.
...
def WikiMediaBD(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bdwikimedia-latest-pages-articles-multistream.xml.bz2",
