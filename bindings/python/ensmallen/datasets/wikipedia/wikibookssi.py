"""
This file offers the methods to automatically retrieve the graph WikiBooksSI.
...
def WikiBooksSI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "siwikibooks-latest-pages-articles-multistream.xml.bz2",
