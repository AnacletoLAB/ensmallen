"""
This file offers the methods to automatically retrieve the graph WikiQuoteBE.
...
def WikiQuoteBE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bewikiquote-latest-pages-articles-multistream.xml.bz2",
