"""
This file offers the methods to automatically retrieve the graph WikiQuoteUK.
...
def WikiQuoteUK(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ukwikiquote-latest-pages-articles-multistream.xml.bz2",
