"""
This file offers the methods to automatically retrieve the graph WikiBooksES.
...
def WikiBooksES(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "eswikibooks-latest-pages-articles-multistream.xml.bz2",
