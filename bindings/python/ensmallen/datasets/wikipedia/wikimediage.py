"""
This file offers the methods to automatically retrieve the graph WikiMediaGE.
...
def WikiMediaGE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "gewikimedia-latest-pages-articles-multistream.xml.bz2",
