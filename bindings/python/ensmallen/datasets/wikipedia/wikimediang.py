"""
This file offers the methods to automatically retrieve the graph WikiMediaNG.
...
def WikiMediaNG(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ngwikimedia-latest-pages-articles-multistream.xml.bz2",
