"""
This file offers the methods to automatically retrieve the graph WikiSourceKN.
...
def WikiSourceKN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "knwikisource-latest-pages-articles-multistream.xml.bz2",
