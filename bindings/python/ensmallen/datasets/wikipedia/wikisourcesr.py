"""
This file offers the methods to automatically retrieve the graph WikiSourceSR.
...
def WikiSourceSR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "srwikisource-latest-pages-articles-multistream.xml.bz2",
