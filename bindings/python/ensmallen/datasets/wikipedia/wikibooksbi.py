"""
This file offers the methods to automatically retrieve the graph WikiBooksBI.
...
def WikiBooksBI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "biwikibooks-latest-pages-articles-multistream.xml.bz2",
