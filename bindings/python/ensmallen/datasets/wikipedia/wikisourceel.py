"""
This file offers the methods to automatically retrieve the graph WikiSourceEL.
...
def WikiSourceEL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "elwikisource-latest-pages-articles-multistream.xml.bz2",
