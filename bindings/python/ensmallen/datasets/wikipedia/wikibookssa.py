"""
This file offers the methods to automatically retrieve the graph WikiBooksSA.
...
def WikiBooksSA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "sawikibooks-latest-pages-articles-multistream.xml.bz2",
