"""
This file offers the methods to automatically retrieve the graph WikiBooksBG.
...
def WikiBooksBG(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bgwikibooks-latest-pages-articles-multistream.xml.bz2",
