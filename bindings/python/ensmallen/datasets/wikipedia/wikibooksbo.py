"""
This file offers the methods to automatically retrieve the graph WikiBooksBO.
...
def WikiBooksBO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bowikibooks-latest-pages-articles-multistream.xml.bz2",
