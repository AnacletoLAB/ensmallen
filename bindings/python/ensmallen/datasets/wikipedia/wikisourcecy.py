"""
This file offers the methods to automatically retrieve the graph WikiSourceCY.
...
def WikiSourceCY(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cywikisource-latest-pages-articles-multistream.xml.bz2",
