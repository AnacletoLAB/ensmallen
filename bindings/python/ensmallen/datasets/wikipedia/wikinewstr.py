"""
This file offers the methods to automatically retrieve the graph WikiNewsTR.
...
def WikiNewsTR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "trwikinews-latest-pages-articles-multistream.xml.bz2",
