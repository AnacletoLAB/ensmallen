"""
This file offers the methods to automatically retrieve the graph WikiMediaBE.
...
def WikiMediaBE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bewikimedia-latest-pages-articles-multistream.xml.bz2",
