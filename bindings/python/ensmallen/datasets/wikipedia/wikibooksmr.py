"""
This file offers the methods to automatically retrieve the graph WikiBooksMR.
...
def WikiBooksMR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "mrwikibooks-latest-pages-articles-multistream.xml.bz2",
