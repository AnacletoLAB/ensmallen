"""
This file offers the methods to automatically retrieve the graph WikiSourceSL.
...
def WikiSourceSL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "slwikisource-latest-pages-articles-multistream.xml.bz2",
