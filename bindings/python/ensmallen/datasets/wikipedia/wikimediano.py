"""
This file offers the methods to automatically retrieve the graph WikiMediaNO.
...
def WikiMediaNO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "nowikimedia-latest-pages-articles-multistream.xml.bz2",
