"""
This file offers the methods to automatically retrieve the graph WikiversityES.
...
def WikiversityES(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityES graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "eswikiversity-latest-pages-articles-multistream.xml.bz2",
