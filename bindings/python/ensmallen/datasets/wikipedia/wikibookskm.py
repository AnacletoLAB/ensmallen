"""
This file offers the methods to automatically retrieve the graph WikiBooksKM.
...
def WikiBooksKM(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kmwikibooks-latest-pages-articles-multistream.xml.bz2",
