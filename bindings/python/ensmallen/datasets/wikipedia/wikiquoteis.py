"""
This file offers the methods to automatically retrieve the graph WikiQuoteIS.
...
def WikiQuoteIS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "iswikiquote-latest-pages-articles-multistream.xml.bz2",
