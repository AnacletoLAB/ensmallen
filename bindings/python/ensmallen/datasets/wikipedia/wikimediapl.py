"""
This file offers the methods to automatically retrieve the graph WikiMediaPL.
...
def WikiMediaPL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "plwikimedia-latest-pages-articles-multistream.xml.bz2",
