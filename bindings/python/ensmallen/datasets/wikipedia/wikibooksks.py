"""
This file offers the methods to automatically retrieve the graph WikiBooksKS.
...
def WikiBooksKS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kswikibooks-latest-pages-articles-multistream.xml.bz2",
