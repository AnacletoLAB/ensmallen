"""
This file offers the methods to automatically retrieve the graph WikiSourcePT.
...
def WikiSourcePT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ptwikisource-latest-pages-articles-multistream.xml.bz2",
