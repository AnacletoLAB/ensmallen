"""
This file offers the methods to automatically retrieve the graph WikiBooksRO.
...
def WikiBooksRO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "rowikibooks-latest-pages-articles-multistream.xml.bz2",
