"""
This file offers the methods to automatically retrieve the graph WikiBooksDA.
...
def WikiBooksDA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "dawikibooks-latest-pages-articles-multistream.xml.bz2",
