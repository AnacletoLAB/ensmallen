"""
This file offers the methods to automatically retrieve the graph WikiNewsEL.
...
def WikiNewsEL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "elwikinews-latest-pages-articles-multistream.xml.bz2",
