"""
This file offers the methods to automatically retrieve the graph WikiNewsCA.
...
def WikiNewsCA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cawikinews-latest-pages-articles-multistream.xml.bz2",
