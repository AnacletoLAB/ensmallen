"""
This file offers the methods to automatically retrieve the graph WikiBooksGU.
...
def WikiBooksGU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "guwikibooks-latest-pages-articles-multistream.xml.bz2",
