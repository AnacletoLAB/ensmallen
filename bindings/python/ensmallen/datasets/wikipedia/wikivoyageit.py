"""
This file offers the methods to automatically retrieve the graph WikiVoyageIT.
...
def WikiVoyageIT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "itwikivoyage-latest-pages-articles-multistream.xml.bz2",
