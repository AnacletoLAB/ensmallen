"""
This file offers the methods to automatically retrieve the graph WikiversityCS.
...
def WikiversityCS(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityCS graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cswikiversity-latest-pages-articles-multistream.xml.bz2",
