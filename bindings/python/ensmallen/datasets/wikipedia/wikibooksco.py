"""
This file offers the methods to automatically retrieve the graph WikiBooksCO.
...
def WikiBooksCO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cowikibooks-latest-pages-articles-multistream.xml.bz2",
