"""
This file offers the methods to automatically retrieve the graph WikiNewsCS.
...
def WikiNewsCS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cswikinews-latest-pages-articles-multistream.xml.bz2",
