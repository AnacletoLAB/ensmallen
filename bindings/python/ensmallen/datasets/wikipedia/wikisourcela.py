"""
This file offers the methods to automatically retrieve the graph WikiSourceLA.
...
def WikiSourceLA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "lawikisource-latest-pages-articles-multistream.xml.bz2",
