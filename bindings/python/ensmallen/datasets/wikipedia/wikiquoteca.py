"""
This file offers the methods to automatically retrieve the graph WikiQuoteCA.
...
def WikiQuoteCA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cawikiquote-latest-pages-articles-multistream.xml.bz2",
