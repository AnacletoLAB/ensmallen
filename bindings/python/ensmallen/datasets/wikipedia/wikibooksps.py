"""
This file offers the methods to automatically retrieve the graph WikiBooksPS.
...
def WikiBooksPS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "pswikibooks-latest-pages-articles-multistream.xml.bz2",
