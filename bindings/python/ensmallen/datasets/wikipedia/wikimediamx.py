"""
This file offers the methods to automatically retrieve the graph WikiMediaMX.
...
def WikiMediaMX(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "mxwikimedia-latest-pages-articles-multistream.xml.bz2",
