"""
This file offers the methods to automatically retrieve the graph WikiBooksCY.
...
def WikiBooksCY(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cywikibooks-latest-pages-articles-multistream.xml.bz2",
