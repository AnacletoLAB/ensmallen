"""
This file offers the methods to automatically retrieve the graph WikiSourceFO.
...
def WikiSourceFO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "fowikisource-latest-pages-articles-multistream.xml.bz2",
