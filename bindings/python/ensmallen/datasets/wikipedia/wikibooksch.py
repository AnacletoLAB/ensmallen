"""
This file offers the methods to automatically retrieve the graph WikiBooksCH.
...
def WikiBooksCH(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "chwikibooks-latest-pages-articles-multistream.xml.bz2",
