"""
This file offers the methods to automatically retrieve the graph WikiQuoteZA.
...
def WikiQuoteZA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "zawikiquote-latest-pages-articles-multistream.xml.bz2",
