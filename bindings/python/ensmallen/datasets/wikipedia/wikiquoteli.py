"""
This file offers the methods to automatically retrieve the graph WikiQuoteLI.
...
def WikiQuoteLI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "liwikiquote-latest-pages-articles-multistream.xml.bz2",
