"""
This file offers the methods to automatically retrieve the graph WikiBooksWA.
...
def WikiBooksWA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "wawikibooks-latest-pages-articles-multistream.xml.bz2",
