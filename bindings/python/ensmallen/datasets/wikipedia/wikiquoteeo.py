"""
This file offers the methods to automatically retrieve the graph WikiQuoteEO.
...
def WikiQuoteEO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "eowikiquote-latest-pages-articles-multistream.xml.bz2",
