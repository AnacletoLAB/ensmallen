"""
This file offers the methods to automatically retrieve the graph WikiVoyageHI.
...
def WikiVoyageHI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hiwikivoyage-latest-pages-articles-multistream.xml.bz2",
