"""
This file offers the methods to automatically retrieve the graph WikiNewsEO.
...
def WikiNewsEO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "eowikinews-latest-pages-articles-multistream.xml.bz2",
