"""
This file offers the methods to automatically retrieve the graph WikiSourceBE.
...
def WikiSourceBE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bewikisource-latest-pages-articles-multistream.xml.bz2",
