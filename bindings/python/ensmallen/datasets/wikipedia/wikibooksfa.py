"""
This file offers the methods to automatically retrieve the graph WikiBooksFA.
...
def WikiBooksFA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "fawikibooks-latest-pages-articles-multistream.xml.bz2",
