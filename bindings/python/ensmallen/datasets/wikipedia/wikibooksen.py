"""
This file offers the methods to automatically retrieve the graph WikiBooksEN.
...
def WikiBooksEN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "enwikibooks-latest-pages-articles-multistream.xml.bz2",
