"""
This file offers the methods to automatically retrieve the graph WikiVoyageEO.
...
def WikiVoyageEO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "eowikivoyage-latest-pages-articles-multistream.xml.bz2",
