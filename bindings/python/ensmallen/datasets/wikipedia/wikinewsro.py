"""
This file offers the methods to automatically retrieve the graph WikiNewsRO.
...
def WikiNewsRO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "rowikinews-latest-pages-articles-multistream.xml.bz2",
