"""
This file offers the methods to automatically retrieve the graph WikiSourceHY.
...
def WikiSourceHY(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hywikisource-latest-pages-articles-multistream.xml.bz2",
