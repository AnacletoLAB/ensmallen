"""
This file offers the methods to automatically retrieve the graph WikiBooksCA.
...
def WikiBooksCA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cawikibooks-latest-pages-articles-multistream.xml.bz2",
