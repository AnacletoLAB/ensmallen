"""
This file offers the methods to automatically retrieve the graph WikiVoyagePL.
...
def WikiVoyagePL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "plwikivoyage-latest-pages-articles-multistream.xml.bz2",
