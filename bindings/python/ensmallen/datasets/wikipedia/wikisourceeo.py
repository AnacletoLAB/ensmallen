"""
This file offers the methods to automatically retrieve the graph WikiSourceEO.
...
def WikiSourceEO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "eowikisource-latest-pages-articles-multistream.xml.bz2",
