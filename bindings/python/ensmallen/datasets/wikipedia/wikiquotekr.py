"""
This file offers the methods to automatically retrieve the graph WikiQuoteKR.
...
def WikiQuoteKR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "krwikiquote-latest-pages-articles-multistream.xml.bz2",
