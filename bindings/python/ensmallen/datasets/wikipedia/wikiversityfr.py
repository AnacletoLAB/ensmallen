"""
This file offers the methods to automatically retrieve the graph WikiversityFR.
...
def WikiversityFR(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityFR graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "frwikiversity-latest-pages-articles-multistream.xml.bz2",
