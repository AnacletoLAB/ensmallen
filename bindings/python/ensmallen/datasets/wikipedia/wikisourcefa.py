"""
This file offers the methods to automatically retrieve the graph WikiSourceFA.
...
def WikiSourceFA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "fawikisource-latest-pages-articles-multistream.xml.bz2",
