"""
This file offers the methods to automatically retrieve the graph WikiNewsKO.
...
def WikiNewsKO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kowikinews-latest-pages-articles-multistream.xml.bz2",
