"""
This file offers the methods to automatically retrieve the graph WikiQuoteFA.
...
def WikiQuoteFA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "fawikiquote-latest-pages-articles-multistream.xml.bz2",
