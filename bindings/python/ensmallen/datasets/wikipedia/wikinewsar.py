"""
This file offers the methods to automatically retrieve the graph WikiNewsAR.
...
def WikiNewsAR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "arwikinews-latest-pages-articles-multistream.xml.bz2",
