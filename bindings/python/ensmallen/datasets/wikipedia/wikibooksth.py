"""
This file offers the methods to automatically retrieve the graph WikiBooksTH.
...
def WikiBooksTH(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "thwikibooks-latest-pages-articles-multistream.xml.bz2",
