"""
This file offers the methods to automatically retrieve the graph WikiNewsTH.
...
def WikiNewsTH(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "thwikinews-latest-pages-articles-multistream.xml.bz2",
