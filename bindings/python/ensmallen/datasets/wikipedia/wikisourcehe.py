"""
This file offers the methods to automatically retrieve the graph WikiSourceHE.
...
def WikiSourceHE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hewikisource-latest-pages-articles-multistream.xml.bz2",
