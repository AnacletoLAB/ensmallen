"""
This file offers the methods to automatically retrieve the graph WikiQuoteES.
...
def WikiQuoteES(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "eswikiquote-latest-pages-articles-multistream.xml.bz2",
