"""
This file offers the methods to automatically retrieve the graph WikiMediaRS.
...
def WikiMediaRS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "rswikimedia-latest-pages-articles-multistream.xml.bz2",
