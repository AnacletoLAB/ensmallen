"""
This file offers the methods to automatically retrieve the graph WikiBooksNL.
...
def WikiBooksNL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "nlwikibooks-latest-pages-articles-multistream.xml.bz2",
