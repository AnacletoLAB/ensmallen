"""
This file offers the methods to automatically retrieve the graph WikiNewsFI.
...
def WikiNewsFI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "fiwikinews-latest-pages-articles-multistream.xml.bz2",
