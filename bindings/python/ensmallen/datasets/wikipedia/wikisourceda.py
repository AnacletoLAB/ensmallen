"""
This file offers the methods to automatically retrieve the graph WikiSourceDA.
...
def WikiSourceDA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "dawikisource-latest-pages-articles-multistream.xml.bz2",
