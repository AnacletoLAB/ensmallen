"""
This file offers the methods to automatically retrieve the graph WikiQuoteNA.
...
def WikiQuoteNA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "nawikiquote-latest-pages-articles-multistream.xml.bz2",
