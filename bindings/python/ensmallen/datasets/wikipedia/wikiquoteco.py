"""
This file offers the methods to automatically retrieve the graph WikiQuoteCO.
...
def WikiQuoteCO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cowikiquote-latest-pages-articles-multistream.xml.bz2",
