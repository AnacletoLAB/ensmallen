"""
This file offers the methods to automatically retrieve the graph WikiQuoteGL.
...
def WikiQuoteGL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "glwikiquote-latest-pages-articles-multistream.xml.bz2",
