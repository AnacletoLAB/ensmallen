"""
This file offers the methods to automatically retrieve the graph WikiMediaAM.
...
def WikiMediaAM(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "amwikimedia-latest-pages-articles-multistream.xml.bz2",
