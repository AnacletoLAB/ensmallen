"""
This file offers the methods to automatically retrieve the graph WikiBooksKO.
...
def WikiBooksKO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kowikibooks-latest-pages-articles-multistream.xml.bz2",
