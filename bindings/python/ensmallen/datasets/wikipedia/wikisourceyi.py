"""
This file offers the methods to automatically retrieve the graph WikiSourceYI.
...
def WikiSourceYI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "yiwikisource-latest-pages-articles-multistream.xml.bz2",
