"""
This file offers the methods to automatically retrieve the graph WikiBooksHU.
...
def WikiBooksHU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "huwikibooks-latest-pages-articles-multistream.xml.bz2",
