"""
This file offers the methods to automatically retrieve the graph WikiSourceTA.
...
def WikiSourceTA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "tawikisource-latest-pages-articles-multistream.xml.bz2",
