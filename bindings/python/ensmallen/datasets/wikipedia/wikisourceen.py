"""
This file offers the methods to automatically retrieve the graph WikiSourceEN.
...
def WikiSourceEN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "enwikisource-latest-pages-articles-multistream.xml.bz2",
