"""
This file offers the methods to automatically retrieve the graph WikiSourceTH.
...
def WikiSourceTH(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "thwikisource-latest-pages-articles-multistream.xml.bz2",
