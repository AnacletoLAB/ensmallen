"""
This file offers the methods to automatically retrieve the graph WikiQuoteTT.
...
def WikiQuoteTT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ttwikiquote-latest-pages-articles-multistream.xml.bz2",
