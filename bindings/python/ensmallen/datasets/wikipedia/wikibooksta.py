"""
This file offers the methods to automatically retrieve the graph WikiBooksTA.
...
def WikiBooksTA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "tawikibooks-latest-pages-articles-multistream.xml.bz2",
