"""
This file offers the methods to automatically retrieve the graph WikiBooksBM.
...
def WikiBooksBM(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bmwikibooks-latest-pages-articles-multistream.xml.bz2",
