"""
This file offers the methods to automatically retrieve the graph WikiMediaSE.
...
def WikiMediaSE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "sewikimedia-latest-pages-articles-multistream.xml.bz2",
