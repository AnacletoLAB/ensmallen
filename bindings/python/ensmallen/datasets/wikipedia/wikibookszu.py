"""
This file offers the methods to automatically retrieve the graph WikiBooksZU.
...
def WikiBooksZU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "zuwikibooks-latest-pages-articles-multistream.xml.bz2",
