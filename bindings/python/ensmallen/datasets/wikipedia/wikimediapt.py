"""
This file offers the methods to automatically retrieve the graph WikiMediaPT.
...
def WikiMediaPT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ptwikimedia-latest-pages-articles-multistream.xml.bz2",
