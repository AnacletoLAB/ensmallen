"""
This file offers the methods to automatically retrieve the graph WikiMediaMK.
...
def WikiMediaMK(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "mkwikimedia-latest-pages-articles-multistream.xml.bz2",
