"""
This file offers the methods to automatically retrieve the graph WikiBooksNO.
...
def WikiBooksNO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "nowikibooks-latest-pages-articles-multistream.xml.bz2",
