"""
This file offers the methods to automatically retrieve the graph WikiBooksKU.
...
def WikiBooksKU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kuwikibooks-latest-pages-articles-multistream.xml.bz2",
