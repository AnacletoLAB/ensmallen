"""
This file offers the methods to automatically retrieve the graph WikiSourceBN.
...
def WikiSourceBN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bnwikisource-latest-pages-articles-multistream.xml.bz2",
