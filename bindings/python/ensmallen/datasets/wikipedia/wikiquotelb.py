"""
This file offers the methods to automatically retrieve the graph WikiQuoteLB.
...
def WikiQuoteLB(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "lbwikiquote-latest-pages-articles-multistream.xml.bz2",
