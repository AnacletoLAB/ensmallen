"""
This file offers the methods to automatically retrieve the graph WikiSourceBS.
...
def WikiSourceBS(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bswikisource-latest-pages-articles-multistream.xml.bz2",
