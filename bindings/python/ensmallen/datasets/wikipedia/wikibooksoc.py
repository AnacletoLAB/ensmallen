"""
This file offers the methods to automatically retrieve the graph WikiBooksOC.
...
def WikiBooksOC(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ocwikibooks-latest-pages-articles-multistream.xml.bz2",
