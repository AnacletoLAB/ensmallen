"""
This file offers the methods to automatically retrieve the graph WikiBooksYO.
...
def WikiBooksYO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "yowikibooks-latest-pages-articles-multistream.xml.bz2",
