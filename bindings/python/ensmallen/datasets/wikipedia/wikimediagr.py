"""
This file offers the methods to automatically retrieve the graph WikiMediaGR.
...
def WikiMediaGR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "grwikimedia-latest-pages-articles-multistream.xml.bz2",
