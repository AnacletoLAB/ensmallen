"""
This file offers the methods to automatically retrieve the graph WikiSourceHU.
...
def WikiSourceHU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "huwikisource-latest-pages-articles-multistream.xml.bz2",
