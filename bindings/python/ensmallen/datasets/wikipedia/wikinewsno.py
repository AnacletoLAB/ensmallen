"""
This file offers the methods to automatically retrieve the graph WikiNewsNO.
...
def WikiNewsNO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "nowikinews-latest-pages-articles-multistream.xml.bz2",
