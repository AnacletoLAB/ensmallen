"""
This file offers the methods to automatically retrieve the graph WikiBooksZA.
...
def WikiBooksZA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "zawikibooks-latest-pages-articles-multistream.xml.bz2",
