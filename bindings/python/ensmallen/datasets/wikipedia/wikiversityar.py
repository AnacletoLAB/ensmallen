"""
This file offers the methods to automatically retrieve the graph WikiversityAR.
...
def WikiversityAR(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityAR graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "arwikiversity-latest-pages-articles-multistream.xml.bz2",
