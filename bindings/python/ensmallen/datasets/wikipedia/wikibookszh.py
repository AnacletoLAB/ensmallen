"""
This file offers the methods to automatically retrieve the graph WikiBooksZH.
...
def WikiBooksZH(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "zhwikibooks-latest-pages-articles-multistream.xml.bz2",
