"""
This file offers the methods to automatically retrieve the graph WikiQuoteLT.
...
def WikiQuoteLT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ltwikiquote-latest-pages-articles-multistream.xml.bz2",
