"""
This file offers the methods to automatically retrieve the graph WikiMediaFI.
...
def WikiMediaFI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "fiwikimedia-latest-pages-articles-multistream.xml.bz2",
