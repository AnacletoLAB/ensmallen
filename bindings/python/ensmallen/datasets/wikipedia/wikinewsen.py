"""
This file offers the methods to automatically retrieve the graph WikiNewsEN.
...
def WikiNewsEN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "enwikinews-latest-pages-articles-multistream.xml.bz2",
