"""
This file offers the methods to automatically retrieve the graph WikiSourceGL.
...
def WikiSourceGL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "glwikisource-latest-pages-articles-multistream.xml.bz2",
