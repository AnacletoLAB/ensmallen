"""
This file offers the methods to automatically retrieve the graph WikiSourceSA.
...
def WikiSourceSA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "sawikisource-latest-pages-articles-multistream.xml.bz2",
