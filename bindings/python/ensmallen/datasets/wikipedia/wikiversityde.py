"""
This file offers the methods to automatically retrieve the graph WikiversityDE.
...
def WikiversityDE(
    ...
    **additional_graph_kwargs: Dict
    ...
    Returns
    -----------------------
    Instace of WikiversityDE graph.
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "dewikiversity-latest-pages-articles-multistream.xml.bz2",
