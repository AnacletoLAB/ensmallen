"""
This file offers the methods to automatically retrieve the graph WikiNewsSQ.
...
def WikiNewsSQ(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "sqwikinews-latest-pages-articles-multistream.xml.bz2",
