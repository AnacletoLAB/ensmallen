"""
This file offers the methods to automatically retrieve the graph WikiMediaCA.
...
def WikiMediaCA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cawikimedia-latest-pages-articles-multistream.xml.bz2",
