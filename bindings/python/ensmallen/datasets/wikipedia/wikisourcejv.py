"""
This file offers the methods to automatically retrieve the graph WikiSourceJV.
...
def WikiSourceJV(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "jvwikisource-latest-pages-articles-multistream.xml.bz2",
