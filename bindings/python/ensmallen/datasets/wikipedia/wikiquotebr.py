"""
This file offers the methods to automatically retrieve the graph WikiQuoteBR.
...
def WikiQuoteBR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "brwikiquote-latest-pages-articles-multistream.xml.bz2",
