"""
This file offers the methods to automatically retrieve the graph WikiSourceSV.
...
def WikiSourceSV(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "svwikisource-latest-pages-articles-multistream.xml.bz2",
