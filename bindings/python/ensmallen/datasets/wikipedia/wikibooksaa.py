"""
This file offers the methods to automatically retrieve the graph WikiBooksAA.
...
def WikiBooksAA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "aawikibooks-latest-pages-articles-multistream.xml.bz2",
