"""
This file offers the methods to automatically retrieve the graph WikiBooksAK.
...
def WikiBooksAK(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "akwikibooks-latest-pages-articles-multistream.xml.bz2",
