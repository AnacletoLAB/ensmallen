"""
This file offers the methods to automatically retrieve the graph WikiSourceLT.
...
def WikiSourceLT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ltwikisource-latest-pages-articles-multistream.xml.bz2",
