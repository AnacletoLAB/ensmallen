"""
This file offers the methods to automatically retrieve the graph WikiNewsNL.
...
def WikiNewsNL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "nlwikinews-latest-pages-articles-multistream.xml.bz2",
