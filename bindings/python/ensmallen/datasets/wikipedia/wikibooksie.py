"""
This file offers the methods to automatically retrieve the graph WikiBooksIE.
...
def WikiBooksIE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "iewikibooks-latest-pages-articles-multistream.xml.bz2",
