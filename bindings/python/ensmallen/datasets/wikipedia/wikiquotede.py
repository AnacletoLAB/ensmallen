"""
This file offers the methods to automatically retrieve the graph WikiQuoteDE.
...
def WikiQuoteDE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "dewikiquote-latest-pages-articles-multistream.xml.bz2",
