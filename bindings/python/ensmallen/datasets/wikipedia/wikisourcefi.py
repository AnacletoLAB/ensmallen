"""
This file offers the methods to automatically retrieve the graph WikiSourceFI.
...
def WikiSourceFI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "fiwikisource-latest-pages-articles-multistream.xml.bz2",
