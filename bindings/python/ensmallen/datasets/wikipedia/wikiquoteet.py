"""
This file offers the methods to automatically retrieve the graph WikiQuoteET.
...
def WikiQuoteET(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "etwikiquote-latest-pages-articles-multistream.xml.bz2",
