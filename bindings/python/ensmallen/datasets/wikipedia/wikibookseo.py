"""
This file offers the methods to automatically retrieve the graph WikiBooksEO.
...
def WikiBooksEO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "eowikibooks-latest-pages-articles-multistream.xml.bz2",
