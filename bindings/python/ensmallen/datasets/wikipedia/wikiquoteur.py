"""
This file offers the methods to automatically retrieve the graph WikiQuoteUR.
...
def WikiQuoteUR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "urwikiquote-latest-pages-articles-multistream.xml.bz2",
