"""
This file offers the methods to automatically retrieve the graph WikiNewsPT.
...
def WikiNewsPT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ptwikinews-latest-pages-articles-multistream.xml.bz2",
