"""
This file offers the methods to automatically retrieve the graph WikiSourceBG.
...
def WikiSourceBG(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bgwikisource-latest-pages-articles-multistream.xml.bz2",
