"""
This file offers the methods to automatically retrieve the graph WikiBooksGN.
...
def WikiBooksGN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "gnwikibooks-latest-pages-articles-multistream.xml.bz2",
