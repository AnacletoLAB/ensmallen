"""
This file offers the methods to automatically retrieve the graph WikiMediaNL.
...
def WikiMediaNL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "nlwikimedia-latest-pages-articles-multistream.xml.bz2",
