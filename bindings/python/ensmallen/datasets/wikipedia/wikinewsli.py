"""
This file offers the methods to automatically retrieve the graph WikiNewsLI.
...
def WikiNewsLI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "liwikinews-latest-pages-articles-multistream.xml.bz2",
