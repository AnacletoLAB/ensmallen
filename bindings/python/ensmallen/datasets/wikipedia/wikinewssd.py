"""
This file offers the methods to automatically retrieve the graph WikiNewsSD.
...
def WikiNewsSD(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "sdwikinews-latest-pages-articles-multistream.xml.bz2",
