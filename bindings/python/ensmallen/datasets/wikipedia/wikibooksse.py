"""
This file offers the methods to automatically retrieve the graph WikiBooksSE.
...
def WikiBooksSE(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "sewikibooks-latest-pages-articles-multistream.xml.bz2",
