"""
This file offers the methods to automatically retrieve the graph WikiBooksIA.
...
def WikiBooksIA(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "iawikibooks-latest-pages-articles-multistream.xml.bz2",
