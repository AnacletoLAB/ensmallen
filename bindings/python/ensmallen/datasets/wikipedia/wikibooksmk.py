"""
This file offers the methods to automatically retrieve the graph WikiBooksMK.
...
def WikiBooksMK(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "mkwikibooks-latest-pages-articles-multistream.xml.bz2",
