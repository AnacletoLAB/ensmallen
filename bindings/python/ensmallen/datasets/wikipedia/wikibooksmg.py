"""
This file offers the methods to automatically retrieve the graph WikiBooksMG.
...
def WikiBooksMG(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "mgwikibooks-latest-pages-articles-multistream.xml.bz2",
