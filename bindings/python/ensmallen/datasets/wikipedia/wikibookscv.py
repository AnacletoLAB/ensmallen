"""
This file offers the methods to automatically retrieve the graph WikiBooksCV.
...
def WikiBooksCV(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cvwikibooks-latest-pages-articles-multistream.xml.bz2",
