"""
This file offers the methods to automatically retrieve the graph WikiBooksLV.
...
def WikiBooksLV(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "lvwikibooks-latest-pages-articles-multistream.xml.bz2",
