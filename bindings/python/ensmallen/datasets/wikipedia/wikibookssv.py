"""
This file offers the methods to automatically retrieve the graph WikiBooksSV.
...
def WikiBooksSV(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "svwikibooks-latest-pages-articles-multistream.xml.bz2",
