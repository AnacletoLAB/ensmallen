"""
This file offers the methods to automatically retrieve the graph WikiSourceAZ.
...
def WikiSourceAZ(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "azwikisource-latest-pages-articles-multistream.xml.bz2",
