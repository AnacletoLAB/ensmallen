"""
This file offers the methods to automatically retrieve the graph WikiVoyageBN.
...
def WikiVoyageBN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "bnwikivoyage-latest-pages-articles-multistream.xml.bz2",
