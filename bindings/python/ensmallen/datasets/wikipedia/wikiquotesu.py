"""
This file offers the methods to automatically retrieve the graph WikiQuoteSU.
...
def WikiQuoteSU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "suwikiquote-latest-pages-articles-multistream.xml.bz2",
