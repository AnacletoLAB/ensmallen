"""
This file offers the methods to automatically retrieve the graph WikiBooksLB.
...
def WikiBooksLB(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "lbwikibooks-latest-pages-articles-multistream.xml.bz2",
