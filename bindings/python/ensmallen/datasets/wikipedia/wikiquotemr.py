"""
This file offers the methods to automatically retrieve the graph WikiQuoteMR.
...
def WikiQuoteMR(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "mrwikiquote-latest-pages-articles-multistream.xml.bz2",
