"""
This file offers the methods to automatically retrieve the graph WikiVoyagePT.
...
def WikiVoyagePT(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "ptwikivoyage-latest-pages-articles-multistream.xml.bz2",
