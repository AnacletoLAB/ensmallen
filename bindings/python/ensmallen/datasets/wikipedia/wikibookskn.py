"""
This file offers the methods to automatically retrieve the graph WikiBooksKN.
...
def WikiBooksKN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "knwikibooks-latest-pages-articles-multistream.xml.bz2",
