"""
This file offers the methods to automatically retrieve the graph WikiQuoteCY.
...
def WikiQuoteCY(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "cywikiquote-latest-pages-articles-multistream.xml.bz2",
