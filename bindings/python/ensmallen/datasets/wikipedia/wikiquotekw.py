"""
This file offers the methods to automatically retrieve the graph WikiQuoteKW.
...
def WikiQuoteKW(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "kwwikiquote-latest-pages-articles-multistream.xml.bz2",
