"""
This file offers the methods to automatically retrieve the graph WikiBooksLI.
...
def WikiBooksLI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "liwikibooks-latest-pages-articles-multistream.xml.bz2",
