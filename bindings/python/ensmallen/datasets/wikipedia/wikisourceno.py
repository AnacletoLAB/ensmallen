"""
This file offers the methods to automatically retrieve the graph WikiSourceNO.
...
def WikiSourceNO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "nowikisource-latest-pages-articles-multistream.xml.bz2",
