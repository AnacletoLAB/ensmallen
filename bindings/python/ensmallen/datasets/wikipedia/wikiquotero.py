"""
This file offers the methods to automatically retrieve the graph WikiQuoteRO.
...
def WikiQuoteRO(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "rowikiquote-latest-pages-articles-multistream.xml.bz2",
