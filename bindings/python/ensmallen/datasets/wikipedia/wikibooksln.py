"""
This file offers the methods to automatically retrieve the graph WikiBooksLN.
...
def WikiBooksLN(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "lnwikibooks-latest-pages-articles-multistream.xml.bz2",
