"""
This file offers the methods to automatically retrieve the graph WikiMediaDK.
...
def WikiMediaDK(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "dkwikimedia-latest-pages-articles-multistream.xml.bz2",
