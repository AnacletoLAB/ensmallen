"""
This file offers the methods to automatically retrieve the graph WikiBooksSL.
...
def WikiBooksSL(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "slwikibooks-latest-pages-articles-multistream.xml.bz2",
