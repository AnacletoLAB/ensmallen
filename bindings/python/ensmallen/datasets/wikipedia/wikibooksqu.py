"""
This file offers the methods to automatically retrieve the graph WikiBooksQU.
...
def WikiBooksQU(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "quwikibooks-latest-pages-articles-multistream.xml.bz2",
