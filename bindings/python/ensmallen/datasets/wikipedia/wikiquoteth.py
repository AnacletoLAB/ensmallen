"""
This file offers the methods to automatically retrieve the graph WikiQuoteTH.
...
def WikiQuoteTH(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "thwikiquote-latest-pages-articles-multistream.xml.bz2",
