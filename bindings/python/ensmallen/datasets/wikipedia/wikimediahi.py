"""
This file offers the methods to automatically retrieve the graph WikiMediaHI.
...
def WikiMediaHI(
    ...
    **additional_graph_kwargs: Dict
    ...
    return AutomaticallyRetrievedGraph(
		...
		callbacks_arguments=[
		    {
		        "source": "hiwikimedia-latest-pages-articles-multistream.xml.bz2",
