"""
This file offers the methods to automatically retrieve the graph MMUSDV.
...
def MMUSDV(
    ...
    version: str = "2020-03-10",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the MMUSDV graph.
