"""
This file offers the methods to automatically retrieve the graph GECKO.
...
def GECKO(
    ...
    version: str = "2021-01-18",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the GECKO graph.
