"""
This file offers the methods to automatically retrieve the graph ONTONEO.
...
def ONTONEO(
    ...
    version: str = "2021-04-29",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the ONTONEO graph.
