"""
This file offers the methods to automatically retrieve the graph ORNASEQ.
...
def ORNASEQ(
    ...
    version: str = "2019-07-08",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the ORNASEQ graph.
