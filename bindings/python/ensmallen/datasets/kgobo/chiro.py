"""
This file offers the methods to automatically retrieve the graph CHIRO.
...
def CHIRO(
    ...
    version: str = "2015-11-23",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the CHIRO graph.
