"""
This file offers the methods to automatically retrieve the graph PLANP.
...
def PLANP(
    ...
    version: str = "2020-03-28",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the PLANP graph.
