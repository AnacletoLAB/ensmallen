"""
This file offers the methods to automatically retrieve the graph PR.
...
def PR(
    ...
    version: str = "10%3A05%3A2021%2012%3A03",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the PR graph.
