"""
This file offers the methods to automatically retrieve the graph OOSTT.
...
def OOSTT(
    ...
    version: str = "2021-01-08",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the OOSTT graph.
