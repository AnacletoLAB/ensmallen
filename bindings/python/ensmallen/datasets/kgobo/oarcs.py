"""
This file offers the methods to automatically retrieve the graph OARCS.
...
def OARCS(
    ...
    version: str = "2019-04-18",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the OARCS graph.
