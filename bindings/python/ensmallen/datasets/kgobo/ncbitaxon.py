"""
This file offers the methods to automatically retrieve the graph NCBITAXON.
...
def NCBITAXON(
    ...
    version: str = "2021-06-10",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the NCBITAXON graph.
