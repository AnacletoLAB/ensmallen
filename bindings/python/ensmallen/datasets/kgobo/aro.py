"""
This file offers the methods to automatically retrieve the graph ARO.
...
def ARO(
    ...
    version: str = "05%3A07%3A2021%2015%3A21",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the ARO graph.
	...
	The available versions are:
			- 05%3A07%3A2021%2015%3A21
    additional_graph_kwargs: Dict
        Additional graph kwargs.

    Returns
    -----------------------
    Instace of ARO graph.
