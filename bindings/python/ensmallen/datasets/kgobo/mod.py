"""
This file offers the methods to automatically retrieve the graph MOD.
...
def MOD(
    ...
    version: str = "10%3A03%3A2021%2014%3A36",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the MOD graph.
	...
	The available versions are:
			- 10%3A03%3A2021%2014%3A36
    additional_graph_kwargs: Dict
        Additional graph kwargs.

    Returns
    -----------------------
    Instace of MOD graph.
