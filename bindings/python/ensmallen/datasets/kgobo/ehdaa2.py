"""
This file offers the methods to automatically retrieve the graph EHDAA2.
...
def EHDAA2(
    ...
    version: str = "2013-07-04",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the EHDAA2 graph.
