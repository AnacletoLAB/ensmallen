"""
This file offers the methods to automatically retrieve the graph OMRSE.
...
def OMRSE(
    ...
    version: str = "2021-08-30",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the OMRSE graph.
