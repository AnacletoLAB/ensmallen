"""
This file offers the methods to automatically retrieve the graph HANCESTRO.
...
def HANCESTRO(
    ...
    version: str = "2020-12-18",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the HANCESTRO graph.
