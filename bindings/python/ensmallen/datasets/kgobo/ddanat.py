"""
This file offers the methods to automatically retrieve the graph DDANAT.
...
def DDANAT(
    ...
    version: str = "2020-04-13",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the DDANAT graph.
