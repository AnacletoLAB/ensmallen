"""
This file offers the methods to automatically retrieve the graph TAXRANK.
...
def TAXRANK(
    ...
    version: str = "2016-04-15",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the TAXRANK graph.
