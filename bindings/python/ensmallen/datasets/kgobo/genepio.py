"""
This file offers the methods to automatically retrieve the graph GENEPIO.
...
def GENEPIO(
    ...
    version: str = "2021-05-24",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the GENEPIO graph.
