"""
This file offers the methods to automatically retrieve the graph CTENO.
...
def CTENO(
    ...
    version: str = "2016-10-19",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the CTENO graph.
