"""
This file offers the methods to automatically retrieve the graph DDPHENO.
...
def DDPHENO(
    ...
    version: str = "2020-06-19",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the DDPHENO graph.
