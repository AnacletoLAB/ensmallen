"""
This file offers the methods to automatically retrieve the graph PHIPO.
...
def PHIPO(
    ...
    version: str = "2021-07-14",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the PHIPO graph.
