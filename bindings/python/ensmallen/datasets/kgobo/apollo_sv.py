"""
This file offers the methods to automatically retrieve the graph APOLLO_SV.
...
def APOLLO_SV(
    ...
    **additional_graph_kwargs: Dict
    ...
    """Return new instance of the APOLLO_SV graph.
