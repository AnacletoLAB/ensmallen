"""
This file offers the methods to automatically retrieve the graph IDOMAL.
...
def IDOMAL(
    ...
    version: str = "2015-03-16",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the IDOMAL graph.
