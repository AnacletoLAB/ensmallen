"""
This file offers the methods to automatically retrieve the graph MPATH.
...
def MPATH(
    ...
    version: str = "2020-05-19",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the MPATH graph.
