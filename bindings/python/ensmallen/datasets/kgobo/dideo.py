"""
This file offers the methods to automatically retrieve the graph DIDEO.
...
def DIDEO(
    ...
    version: str = "2021-06-11",
    **additional_graph_kwargs: Dict
) -> Graph:
    """Return new instance of the DIDEO graph.
