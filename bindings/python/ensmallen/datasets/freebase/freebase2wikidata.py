"""
This file offers the methods to automatically retrieve the graph FreeBase2WikiData.
...
def FreeBase2WikiData(
    ...
    **additional_graph_kwargs: Dict
    ...
    """Return new instance of the FreeBase2WikiData graph.
    ...
    Returns
    -----------------------
    Instace of FreeBase2WikiData graph.
