...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("graph", 0.6295366),
        ("laplacian", 0.8841279),
        ("normalized", 0.92938703),
        ("random", 0.6295366),
        ("transformed", 0.8841279),
        ("walk", 0.9899821),
    ],
    &[
        ("get", 0.08900087),
        ("graph", 0.8102565),
        ("laplacian", 1.1379328),
        ("normalized", 1.1961843),
        ("symmetric", 1.2741743),
        ("transformed", 1.1379328),
    ],
    &[
        ("get", 0.11839198),
        ("graph", 1.0778307),
        ("normalized", 1.5912049),
        ("symmetric", 1.6949499),
        ("transformed", 1.5137167),
    ],
    &[
        ("connected", 0.9204537),
        ("from", 0.25106248),
    ...
    &[
        ("disconnected", 0.8841279),
        ("from", 0.19506544),
        ("id", 0.29661107),
        ("is", 0.6614),
        ("node", 0.20387703),
        ("unchecked", 0.36696866),
    ],
    &[
        ("from", 0.25106248),
        ("id", 0.3817586),
    ...
    &[
        ...
        ("node", 0.08720227),
        ("selfloops", 0.558682),
        ("singleton", 0.42586243),
        ("unchecked", 0.29282573),
        ("with", 0.4679658),
    ],
    &[
        ("from", 0.19506544),
        ...
        ("is", 0.6614),
        ("node", 0.10928173),
        ("selfloops", 0.70013934),
        ("singleton", 0.53369004),
        ("with", 0.5864539),
    ],
    &[
        ("from", 0.25106248),
    ...
    &[("components", 4.743721), ("remove", 2.695003)],
    &[("overlaps", 9.48036)],
    &[("contains", 8.674299)],
    &[
        ("bipartite", 3.428071),
    ...
    &[("edge", 1.2317098), ("encode", 5.805262)],
    &[("decode", 5.805262), ("edge", 1.2317098)],
    &[
        ("edge", 0.3930374),
        ("encodable", 1.8524535),
        ("get", 0.11839198),
    ...
    &[
        ...
        ("must", 1.6616446),
        ("node", 0.25935894),
        ("ontologies", 2.0125375),
    ],
    &[
        ("be", 3.0615234),
        ("must", 2.4244149),
        ("undirected", 2.9363837),
    ],
    &[
        ("have", 1.5137167),
        ("must", 1.1987096),
    ...
    &[
        ("be", 3.0615234),
        ("multigraph", 3.2182448),
        ("must", 2.4244149),
    ],
    &[
        ("be", 2.0983057),
        ("multigraph", 2.2057195),
        ("must", 1.6616446),
        ("not", 1.9411376),
    ],
    &[
    ...
    &[
        ("inplace", 1.0615989),
        ("isomorphic", 1.0461792),
        ("node", 0.18710142),
        ("remove", 0.85997283),
        ("types", 0.6206268),
    ],
    &[
        ("isomorphic", 1.4502077),
        ("node", 0.25935894),
        ("remove", 1.1920896),
        ("types", 0.8603095),
    ],
    ...
    &[("circles", 5.805262), ("get", 0.3710196)],
    &[
        ("get", 0.23945023),
        ("memory", 2.4244149),
        ("stats", 3.7466254),
    ...
    &[("get", 0.3710196), ("transitivity", 5.805262)],
    &[
        ("get", 0.08900087),
        ("node", 0.14065301),
        ("number", 0.577495),
    ...
    &[
        ("clustering", 1.5912049),
        ("coefficient", 1.4003357),
        ("get", 0.11839198),
        ("node", 0.18710142),
        ("per", 1.6949499),
    ],
    &[
        ("clustering", 3.2182448),
        ("coefficient", 2.832208),
        ("get", 0.23945023),
    ],
    &[
        ("average", 2.5678606),
        ("clustering", 2.2057195),
        ("coefficient", 1.9411376),
        ("get", 0.16411431),
    ],
    &[
        ("are", 3.7466254),
        ("nodes", 1.6325836),
        ("remappable", 3.7466254),
    ],
    &[
        ("from", 0.33397183),
        ("ids", 0.50005484),
    ...
    &[("connected", 3.8371124), ("holdout", 4.129193)],
    &[("holdout", 4.129193), ("random", 3.377731)],
    &[
        ("get", 0.11839198),
        ("holdout", 1.3176214),
        ("indices", 1.8524535),
    ...
    &[
        ("and", 0.2963617),
        ("distant", 0.45127583),
        ("eccentricity", 0.3728356),
        ("from", 0.0889191),
        ("get", 0.031521548),
        ("id", 0.26181847),
        ("most", 0.403023),
        ("node", 0.096462935),
        ("unchecked", 0.16727987),
    ],
    &[
        ("eccentricity", 0.8179046),
        ("from", 0.19506544),
        ("get", 0.0691501),
        ("id", 0.29661107),
        ("node", 0.10928173),
    ...
    &[("diameter", 5.3116736), ("get", 0.3710196)],
    &[
        ("breadth", 0.7495625),
        ("first", 0.7495625),
        ("from", 0.19506544),
    ...
    &[("density", 5.805262), ("get", 0.3710196)],
    &[
        ("get", 0.16411431),
        ("nodes", 1.1189395),
        ("rate", 1.9411376),
    ...
    &[
        ...
        ("get", 0.16411431),
        ("number", 1.0648793),
        ("undirected", 2.0125375),
    ],
    &[
        ("edges", 1.0040686),
        ("get", 0.11839198),
        ("number", 0.7682034),
        ("undirected", 1.4518436),
        ("unique", 1.2244188),
    ],
    &[
        ("edges", 2.0307496),
    ...
    &[
        ("destination", 1.8264794),
        ("get", 0.16411431),
        ("ids", 0.69317317),
        ("node", 0.25935894),
    ],
    &[
        ("destination", 1.3176214),
        ("directed", 0.9912196),
        ("get", 0.11839198),
        ("ids", 0.50005484),
        ("node", 0.18710142),
    ...
    &[("directed", 3.1063073), ("to", 3.8371124)],
    &[
        ("to", 2.4764123),
        ("triangular", 3.428071),
        ("upper", 3.7466254),
    ...
    &[("bidiagonal", 5.805262), ("to", 3.8371124)],
    &[("arrowhead", 5.805262), ("to", 3.8371124)],
    &[("to", 3.8371124), ("transposed", 5.805262)],
    &[("complementary", 5.805262), ("to", 3.8371124)],
    &[
        ("approximated", 2.5331428),
        ("cliques", 3.428071),
        ("get", 0.23945023),
    ],
    &[
    ...
    &[("report", 4.549822), ("textual", 5.3116736)],
    &[
        ("connected", 1.6972824),
        ("generate", 1.6972824),
        ("graph", 1.4940828),
    ...
    &[("remove", 2.695003), ("tendrils", 5.3116736)],
    &[
        ("dendritic", 3.428071),
        ("remove", 1.7393128),
        ("trees", 3.428071),
    ...
    &[
        ("disconnected", 3.0615234),
        ("nodes", 1.6325836),
        ("remove", 1.7393128),
    ],
    &[("remove", 2.695003), ("selfloops", 3.7565444)],
    &[
        ("edges", 2.0307496),
        ("parallel", 2.9363837),
        ("remove", 1.7393128),
    ...
    &[
        ("arborescence", 2.34953),
        ("kruskal", 2.34953),
        ("random", 1.4940828),
        ("spanning", 2.2057195),
    ],
    &[
        ("arborescence", 3.428071),
        ("kruskal", 3.428071),
        ("spanning", 3.2182448),
    ],
    &[
    ...
    &[("enable", 9.48036)],
    &[("all", 4.129193), ("disable", 5.805262)],
    &[
        ("compatible", 2.0983057),
        ("has", 1.0093969),
        ("node", 0.25935894),
        ("vocabularies", 2.2057195),
    ],
    &[
        ("compatible", 1.5137167),
        ("has", 0.72817844),
        ("node", 0.18710142),
        ("types", 0.6206268),
        ("vocabularies", 1.5912049),
    ],
    &[
        ("compatible", 1.5137167),
        ("edge", 0.3930374),
    ...
    &[("compatible", 4.743721), ("is", 3.5486915)],
    &[
        ("adjacency", 2.2057195),
        ("has", 1.0093969),
        ("matrix", 1.9411376),
    ...
    &[("has", 2.2819827), ("nodes", 2.52963)],
    &[("edges", 3.1465738), ("has", 2.2819827)],
    &[("has", 1.4727559), ("nodes", 1.6325836), ("trap", 2.832208)],
    &[("directed", 3.1063073), ("is", 3.5486915)],
    &[
        ("edge", 0.7949263),
        ("has", 1.4727559),
        ("weights", 2.2512817),
    ...
    &[
        ("edge", 0.3930374),
        ("has", 0.72817844),
        ("probabilities", 1.8524535),
        ("representing", 1.8524535),
        ("weights", 1.113107),
    ],
    &[
        ("has", 1.0093969),
    ...
    &[("has", 2.2819827), ("selfloops", 3.7565444)],
    &[
        ("disconnected", 3.0615234),
        ("has", 1.4727559),
        ("nodes", 1.6325836),
    ...
    &[("connected", 3.8371124), ("is", 3.5486915)],
    &[
        ("has", 1.4727559),
        ("node", 0.37841648),
        ("types", 1.2552305),
    ...
    &[("is", 3.5486915), ("multigraph", 4.9865556)],
    &[
        ("has", 1.4727559),
        ("node", 0.37841648),
        ("ontologies", 2.9363837),
    ...
    &[("get", 0.3710196), ("tendrils", 5.3116736)],
    &[
        ("degree", 0.76488537),
        ("distribution", 1.3925772),
        ("geometric", 1.3925772),
        ("get", 0.08900087),
        ("node", 0.14065301),
        ("threshold", 1.3925772),
    ...
    &[("add", 5.805262), ("selfloops", 3.7565444)],
    &[
        ("centrality", 2.1799347),
        ("degree", 2.057867),
        ("get", 0.23945023),
    ],
    &[
        ("centrality", 1.4940828),
        ("degree", 1.4104202),
        ("get", 0.16411431),
        ("weighted", 1.1698816),
    ],
    &[
        ("centrality", 0.6295366),
        ("closeness", 0.8841279),
        ("from", 0.19506544),
        ("get", 0.0691501),
        ("id", 0.29661107),
    ...
    &[
        ("centrality", 0.5023441),
        ("closeness", 0.70549726),
        ("from", 0.1556541),
        ("get", 0.0551789),
        ("id", 0.2366833),
        ("node", 0.08720227),
    ...
    &[
        ("betweenness", 2.9363837),
        ("centrality", 2.1799347),
        ("get", 0.23945023),
    ],
    &[
        ("approximated", 0.73153853),
        ("betweenness", 0.8479892),
        ("centrality", 0.6295366),
        ("from", 0.19506544),
        ("get", 0.0691501),
        ("id", 0.29661107),
    ...
    &[
        ("approximated", 0.5837373),
        ("betweenness", 0.6766601),
        ("centrality", 0.5023441),
        ("from", 0.1556541),
        ("get", 0.0551789),
        ("id", 0.2366833),
    ...
    &[("dot", 5.805262), ("to", 3.8371124)],
    &[("get", 0.3710196), ("stars", 5.805262)],
    &[
        ("community", 1.5912049),
        ("detection", 1.8524535),
        ("get", 0.11839198),
    ...
    &[
        ("community", 0.92938703),
        ("directed", 0.5789491),
        ("from", 0.19506544),
        ("get", 0.0691501),
        ("memberships", 0.9899821),
        ("modularity", 0.9899821),
        ("node", 0.10928173),
    ],
    &[
        ("community", 0.92938703),
        ...
        ("modularity", 0.9899821),
        ("node", 0.10928173),
        ("undirected", 0.8479892),
    ],
    &[
        ("attachment", 1.2524682),
        ("get", 0.11839198),
        ("minimum", 1.3562131),
        ("preferential", 1.2524682),
        ("unchecked", 0.6282876),
    ],
    &[
        ("attachment", 1.2524682),
    ...
    &[
        ("attachment", 0.9415398),
        ("get", 0.08900087),
        ("minimum", 1.0195298),
        ("preferential", 0.9415398),
        ("unchecked", 0.4723136),
        ("weighted", 0.6344388),
    ],
    &[
    ...
    &[
        ("attachment", 0.73153853),
        ("from", 0.19506544),
        ("get", 0.0691501),
        ("ids", 0.29207078),
        ("node", 0.10928173),
        ("preferential", 0.73153853),
        ("unchecked", 0.36696866),
    ],
    &[
        ("attachment", 0.9415398),
    ...
    &[
        ("attachment", 0.5837373),
        ("from", 0.1556541),
        ("get", 0.0551789),
        ("ids", 0.23306033),
        ("node", 0.08720227),
        ("preferential", 0.5837373),
        ("unchecked", 0.29282573),
        ("weighted", 0.39334035),
    ],
    &[
