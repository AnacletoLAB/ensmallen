...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("graph", 0.65303564),
        ("laplacian", 0.8752725),
        ("normalized", 0.92043185),
        ("random", 0.6916895),
        ("transformed", 0.8752725),
        ("walk", 0.9808934),
    ],
    &[
        ("get", 0.08900839),
        ("graph", 0.84060204),
        ("laplacian", 1.1266704),
        ("normalized", 1.1848005),
        ("symmetric", 1.2626278),
        ("transformed", 1.1266704),
    ],
    &[
        ("get", 0.1184208),
        ("graph", 1.1183751),
        ("normalized", 1.5763123),
        ("symmetric", 1.6798574),
        ("transformed", 1.4989733),
    ],
    &[
        ("connected", 0.9096447),
        ("from", 0.24617352),
    ...
    &[
        ("disconnected", 0.8752725),
        ("from", 0.19124398),
        ("id", 0.29527462),
        ("is", 0.65303564),
        ("node", 0.19977178),
        ("unchecked", 0.36616546),
    ],
    &[
        ("from", 0.24617352),
        ("id", 0.38008407),
    ...
    &[
        ...
        ("is", 0.52104676),
        ("node", 0.085425764),
        ("selfloops", 0.55188805),
        ("singleton", 0.41937357),
        ("unchecked", 0.2921576),
        ("with", 0.47413298),
    ],
    &[
    ...
    &[("has", 1.515382), ("name", 1.4801238), ("node", 0.37103954)],
    &[
        ("has", 1.0382937),
        ("id", 0.7011247),
        ("node", 0.254225),
    ...
    &[("components", 4.7020335), ("remove", 2.6552963)],
    &[("overlaps", 9.415994)],
    &[("contains", 8.61025)],
    &[
        ("bipartite", 3.3993266),
    ...
    &[("edge", 1.2638676), ("encode", 5.7625484)],
    &[("decode", 5.7625484), ("edge", 1.2638676)],
    &[
        ("edge", 0.4029116),
        ("encodable", 1.8370576),
        ("get", 0.1184208),
    ...
    &[
        ...
        ("must", 1.6424054),
        ("node", 0.254225),
        ("ontologies", 1.9926988),
    ],
    &[
        ("be", 3.0332932),
        ("must", 2.3970788),
        ("undirected", 2.9083292),
    ],
    &[
        ("have", 1.4989733),
        ("must", 1.1845728),
    ...
    &[
        ("be", 3.0332932),
        ("multigraph", 3.1897948),
        ("must", 2.3970788),
    ],
    &[
        ("be", 2.0783203),
        ("multigraph", 2.1855505),
        ("must", 1.6424054),
        ("not", 1.9214206),
    ],
    &[
    ...
    &[("circles", 5.7625484), ("get", 0.37146664)],
    &[
        ("get", 0.23963404),
        ("memory", 2.3970788),
        ("stats", 3.717434),
    ...
    &[("get", 0.37146664), ("transitivity", 5.7625484)],
    &[
        ("get", 0.08900839),
        ("node", 0.13781695),
        ("number", 0.567401),
    ...
    &[
        ("clustering", 1.5763123),
        ("coefficient", 1.3858106),
        ("get", 0.1184208),
        ("node", 0.18335792),
        ("per", 1.6798574),
    ],
    &[
        ("clustering", 3.1897948),
        ("coefficient", 2.8042994),
        ("get", 0.23963404),
    ],
    &[
        ("average", 2.5470726),
        ("clustering", 2.1855505),
        ("coefficient", 1.9214206),
        ("get", 0.16418995),
    ],
    &[
        ("are", 3.717434),
    ...
    &[("negatives", 5.7625484), ("sample", 5.7625484)],
    &[("connected", 3.7963011), ("holdout", 4.0880995)],
    &[("holdout", 4.0880995), ("random", 3.715811)],
    &[
        ("get", 0.1184208),
        ("holdout", 1.3032557),
        ("indices", 1.8370576),
    ...
    &[("chains", 5.7625484), ("get", 0.37146664)],
    &[
        ("breadth", 0.4004367),
        ("first", 0.4004367),
        ("from", 0.1033478),
        ...
        ("node", 0.057857886),
        ("parallel", 0.45350903),
        ("predecessors", 0.57967645),
        ("search", 0.4004367),
        ("unchecked", 0.19787496),
    ],
    &[
        ("breadth", 0.4004367),
        ("distances", 0.49739927),
        ("first", 0.4004367),
        ("from", 0.1033478),
        ("get", 0.03736723),
        ("ids", 0.1578695),
    ...
    &[
        ("and", 0.30306017),
        ("distant", 0.447009),
        ("eccentricity", 0.36876333),
        ("from", 0.08715298),
        ("get", 0.0315117),
        ("id", 0.26058716),
        ("most", 0.39887586),
        ("node", 0.09448786),
        ("unchecked", 0.16686752),
    ],
    &[
        ("eccentricity", 0.80919516),
        ("from", 0.19124398),
        ("get", 0.06914765),
        ("id", 0.29527462),
        ("node", 0.10706538),
    ...
    &[("diameter", 5.2694373), ("get", 0.37146664)],
    &[
        ("breadth", 0.74100375),
        ("first", 0.74100375),
        ("from", 0.19124398),
    ...
    &[("density", 5.7625484), ("get", 0.37146664)],
    &[
        ("get", 0.16418995),
        ("nodes", 1.1202488),
        ("rate", 1.9214206),
    ...
    &[
        ...
        ("get", 0.16418995),
        ("number", 1.0466602),
        ("undirected", 1.9926988),
    ],
    &[
        ("edges", 0.9903069),
        ("get", 0.1184208),
        ("number", 0.75489604),
        ("undirected", 1.4372194),
        ("unique", 1.238228),
    ],
    &[
        ("edges", 2.0039659),
    ...
    &[
        ("destination", 1.8603629),
        ("get", 0.16418995),
        ("ids", 0.69367164),
        ("node", 0.254225),
    ],
    &[
        ("destination", 1.341773),
        ("directed", 1.0323364),
        ("get", 0.1184208),
        ("ids", 0.5003056),
        ("node", 0.18335792),
    ...
    &[("directed", 3.2382698), ("to", 3.7963011)],
    &[
        ("to", 2.449003),
        ("triangular", 3.3993266),
        ("upper", 3.717434),
    ],
    &[
        ("lower", 3.717434),
    ...
    &[("bidiagonal", 5.7625484), ("to", 3.7963011)],
    &[("arrowhead", 5.7625484), ("to", 3.7963011)],
    &[("to", 3.7963011), ("transposed", 5.7625484)],
    &[("complementary", 5.7625484), ("to", 3.7963011)],
    &[
        ("approximated", 2.505654),
        ("cliques", 3.3993266),
        ("get", 0.23963404),
    ],
    &[
    ...
    &[("report", 4.508322), ("textual", 5.2694373)],
    &[
        ("connected", 1.6779824),
        ("generate", 1.6779824),
        ("graph", 1.5506223),
    ...
    &[("remove", 2.6552963), ("tendrils", 5.2694373)],
    &[
        ("dendritic", 3.3993266),
        ("remove", 1.7129381),
        ("trees", 3.3993266),
    ...
    &[
        ("disconnected", 3.0332932),
        ("nodes", 1.634995),
        ("remove", 1.7129381),
    ],
    &[("remove", 2.6552963), ("selfloops", 3.715811)],
    &[
        ("edges", 2.0039659),
        ("parallel", 2.9083292),
        ("remove", 1.7129381),
    ...
    &[
        ("arborescence", 2.3291152),
        ("kruskal", 2.3291152),
        ("random", 1.6424054),
        ("spanning", 2.1855505),
    ],
    &[
        ("arborescence", 3.3993266),
        ("kruskal", 3.3993266),
        ("spanning", 3.1897948),
    ],
    &[
    ...
    &[("enable", 9.415994)],
    &[("all", 4.0880995), ("disable", 5.7625484)],
    &[
        ("compatible", 2.0783203),
        ("has", 1.0382937),
        ("node", 0.254225),
        ("vocabularies", 2.1855505),
    ],
    &[
        ("compatible", 1.4989733),
        ("has", 0.74886173),
        ("node", 0.18335792),
        ("types", 0.61524975),
        ("vocabularies", 1.5763123),
    ],
    &[
        ("compatible", 1.4989733),
        ("edge", 0.4029116),
    ...
    &[("compatible", 4.7020335), ("is", 3.5081594)],
    &[
        ("adjacency", 2.1855505),
        ("has", 1.0382937),
        ("matrix", 1.9214206),
    ...
    &[("has", 2.3490567), ("nodes", 2.5344734)],
    &[("edges", 3.1064305), ("has", 2.3490567)],
    &[("has", 1.515382), ("nodes", 1.634995), ("trap", 2.8042994)],
    &[("directed", 3.2382698), ("is", 3.5081594)],
    &[
        ("edge", 0.81532407),
        ("has", 1.515382),
        ("weights", 2.2241886),
    ...
    &[
        ("edge", 0.4029116),
        ("has", 0.74886173),
        ("probabilities", 1.8370576),
        ("representing", 1.8370576),
        ("weights", 1.0991352),
    ],
    &[
        ("has", 1.0382937),
    ...
    &[("has", 2.3490567), ("selfloops", 3.715811)],
    &[
        ("disconnected", 3.0332932),
        ("has", 1.515382),
        ("nodes", 1.634995),
    ...
    &[("connected", 3.7963011), ("is", 3.5081594)],
    &[
        ("has", 1.515382),
        ("node", 0.37103954),
        ("types", 1.2450074),
    ...
    &[("is", 3.5081594), ("multigraph", 4.944633)],
    &[
        ("has", 1.515382),
        ("node", 0.37103954),
        ("ontologies", 2.9083292),
    ...
    &[("get", 0.37146664), ("tendrils", 5.2694373)],
    &[
        ("degree", 0.7544007),
        ("distribution", 1.3807839),
        ("geometric", 1.3807839),
        ("get", 0.08900839),
        ("node", 0.13781695),
        ("threshold", 1.3807839),
    ...
    &[("add", 5.7625484), ("selfloops", 3.715811)],
    &[
        ("centrality", 2.1529417),
        ("degree", 2.0310452),
        ("get", 0.23963404),
    ],
    &[
        ("centrality", 1.4751302),
        ("degree", 1.3916104),
        ("get", 0.16418995),
        ("weighted", 1.151483),
    ],
    &[
        ("centrality", 0.6212425),
        ("closeness", 0.8752725),
        ("from", 0.19124398),
        ("get", 0.06914765),
        ("id", 0.29527462),
    ...
    &[
        ("centrality", 0.49567953),
        ("closeness", 0.69836605),
        ("from", 0.15259053),
        ("get", 0.055171806),
        ("id", 0.23559491),
        ("node", 0.085425764),
    ...
    &[
        ("betweenness", 2.9083292),
        ("centrality", 2.1529417),
        ("get", 0.23963404),
    ],
    &[
        ("approximated", 0.72301954),
        ("betweenness", 0.8392135),
        ("centrality", 0.6212425),
        ("from", 0.19124398),
        ("get", 0.06914765),
        ("id", 0.29527462),
    ...
    &[
        ("approximated", 0.57688576),
        ("betweenness", 0.6695951),
        ("centrality", 0.49567953),
        ("from", 0.15259053),
        ("get", 0.055171806),
        ("id", 0.23559491),
    ...
    &[
        ("centrality", 2.1529417),
        ("eigenvector", 3.3993266),
        ("get", 0.23963404),
    ],
    &[
        ("centrality", 1.4751302),
        ("eigenvector", 2.3291152),
        ("get", 0.16418995),
        ("weighted", 1.151483),
    ],
    &[("dot", 5.7625484), ("to", 3.7963011)],
    &[("get", 0.37146664), ("stars", 5.7625484)],
    &[
        ("community", 1.5763123),
        ("detection", 1.8370576),
        ("get", 0.1184208),
    ...
    &[
        ("community", 0.92043185),
        ("directed", 0.6027963),
        ("from", 0.19124398),
        ("get", 0.06914765),
        ("memberships", 0.9808934),
        ("modularity", 0.9808934),
        ("node", 0.10706538),
    ],
    &[
        ("community", 0.92043185),
        ...
        ("modularity", 0.9808934),
        ("node", 0.10706538),
        ("undirected", 0.8392135),
    ],
    &[
        ("attachment", 1.238228),
        ("get", 0.1184208),
        ("minimum", 1.341773),
        ("preferential", 1.238228),
        ("unchecked", 0.62708724),
    ],
    &[
        ("attachment", 1.238228),
    ...
    &[
        ("attachment", 0.9306869),
        ("get", 0.08900839),
        ("minimum", 1.0085143),
        ("preferential", 0.9306869),
        ("unchecked", 0.47133633),
        ("weighted", 0.62422615),
    ],
    &[
    ...
    &[
        ("attachment", 0.72301954),
        ("from", 0.19124398),
        ("get", 0.06914765),
        ("ids", 0.29213578),
        ("node", 0.10706538),
        ("preferential", 0.72301954),
        ("unchecked", 0.36616546),
    ],
    &[
        ("attachment", 0.9306869),
    ...
    &[
        ("attachment", 0.57688576),
        ("from", 0.15259053),
        ("get", 0.055171806),
        ("ids", 0.23309049),
        ("node", 0.085425764),
        ("preferential", 0.57688576),
        ("unchecked", 0.2921576),
        ("weighted", 0.38692623),
    ],
    &[
