...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("get", 0.06811533),
        ("graph", 0.6381886),
        ("laplacian", 0.88282084),
        ("normalized", 0.9280889),
        ("random", 0.6281791),
        ("transformed", 0.88282084),
        ("walk", 0.98869604),
    ],
    &[
        ("get", 0.08766812),
        ("graph", 0.8213833),
        ("laplacian", 1.1362382),
        ("normalized", 1.1945007),
        ("symmetric", 1.2725054),
        ("transformed", 1.1362382),
    ],
    &[
        ("get", 0.116617434),
        ("graph", 1.0926162),
        ("normalized", 1.5889425),
        ("symmetric", 1.6927055),
        ("transformed", 1.511441),
    ],
    &[
        ("connected", 0.91871834),
        ("from", 0.25032693),
        ("id", 0.37992218),
        ("is", 0.8495184),
        ("node", 0.14017001),
        ("unchecked", 0.47049418),
    ],
    &[
        ("connected", 1.2220927),
        ("from", 0.33298862),
    ...
    &[
        ("disconnected", 0.88282084),
        ("from", 0.19449605),
        ("id", 0.2951874),
        ("is", 0.6600487),
        ("node", 0.20317638),
        ("unchecked", 0.36555895),
    ],
    &[
        ("from", 0.25032693),
        ("id", 0.37992218),
    ...
    &[
        ...
        ("node", 0.086904466),
        ("selfloops", 0.5576145),
        ("singleton", 0.42476743),
        ("unchecked", 0.29170325),
        ("with", 0.46687955),
    ],
    &[
        ("from", 0.19449605),
    ...
    &[
        ...
        ("node", 0.058868013),
        ("type", 0.16379197),
        ("unchecked", 0.19759616),
    ],
    &[
        ("components", 3.0567768),
        ("connected", 2.4715915),
        ("strongly", 3.7419653),
    ],
    &[
    ...
    &[("components", 4.73618), ("remove", 2.6872835)],
    &[("overlaps", 9.46771)],
    &[("contains", 8.661619)],
    &[
        ("bipartite", 3.4233708),
    ...
    &[("edge", 1.2238634), ("encode", 5.797813)],
    &[("decode", 5.797813), ("edge", 1.2238634)],
    &[
        ("edge", 0.39056736),
        ("encodable", 1.8502364),
        ("get", 0.116617434),
    ...
    &[
        ...
        ("must", 1.6583816),
        ("node", 0.2584595),
        ("ontologies", 2.0093286),
    ],
    &[
        ("be", 3.0567768),
        ("must", 2.4195879),
        ("undirected", 2.9316213),
    ],
    &[
        ("have", 1.511441),
        ("must", 1.1963792),
    ...
    &[
        ("inplace", 1.0592448),
        ("isomorphic", 1.0438223),
        ("node", 0.18645622),
        ("remove", 0.85758376),
        ("types", 0.6181962),
    ],
    &[
        ("isomorphic", 1.4469123),
        ("node", 0.2584595),
        ("remove", 1.1887544),
        ("types", 0.8569233),
    ],
    ...
    &[("circles", 5.797813), ("get", 0.36542684)],
    &[
        ("get", 0.23585008),
        ("memory", 2.4195879),
        ("stats", 3.7419653),
    ...
    &[("get", 0.36542684), ("transitivity", 5.797813)],
    &[
        ("get", 0.08766812),
        ("node", 0.14017001),
        ("number", 0.5756953),
    ...
    &[
        ("clustering", 1.5889425),
        ("coefficient", 1.3980402),
        ("get", 0.116617434),
        ("node", 0.18645622),
        ("per", 1.6927055),
    ],
    &[
        ("clustering", 3.213518),
        ("coefficient", 2.8274322),
        ("get", 0.23585008),
    ],
    &[
        ("average", 2.564737),
        ("clustering", 2.20254),
        ("coefficient", 1.9379175),
        ("get", 0.16165127),
    ],
    &[
        ("are", 3.7419653),
        ("nodes", 1.6276565),
        ("remappable", 3.7419653),
    ],
    &[
        ("from", 0.33298862),
        ("ids", 0.50017315),
    ...
    &[("connected", 3.8294916), ("holdout", 4.1215982)],
    &[("holdout", 4.1215982), ("random", 3.3700707)],
    &[
        ("get", 0.116617434),
        ("holdout", 1.3153117),
        ("indices", 1.8502364),
    ...
    &[("chains", 5.797813), ("get", 0.36542684)],
    &[
        ("breadth", 0.40444127),
        ("first", 0.40444127),
        ("from", 0.10513126),
        ...
        ("node", 0.058868013),
        ("parallel", 0.4576546),
        ("predecessors", 0.58415717),
        ("search", 0.40444127),
        ("unchecked", 0.19759616),
    ],
    &[
        ("breadth", 0.40444127),
        ("distances", 0.50166136),
        ("first", 0.40444127),
        ("from", 0.10513126),
        ("get", 0.03681849),
        ("ids", 0.15791482),
    ...
    &[
        ("and", 0.29575214),
        ("distant", 0.45070088),
        ("eccentricity", 0.37224308),
        ("from", 0.08866176),
        ("get", 0.031050634),
        ("id", 0.26056647),
        ("most", 0.40243727),
        ("node", 0.09613443),
        ("unchecked", 0.16664144),
    ],
    &[
        ("eccentricity", 0.81658435),
        ("from", 0.19449605),
        ("get", 0.06811533),
        ("id", 0.2951874),
        ("node", 0.10890762),
    ...
    &[("diameter", 5.3041816), ("get", 0.36542684)],
    &[
        ("breadth", 0.7482287),
        ("first", 0.7482287),
        ("from", 0.19449605),
    ...
    &[("density", 5.797813), ("get", 0.36542684)],
    &[
        ("get", 0.16165127),
        ("nodes", 1.1155932),
        ("rate", 1.9379175),
    ...
    &[
        ...
        ("get", 0.16165127),
        ("number", 1.0615246),
        ("undirected", 2.0093286),
    ],
    &[
        ("edges", 1.0017045),
        ("get", 0.116617434),
        ("number", 0.7657984),
        ("undirected", 1.4495572),
        ("unique", 1.2220927),
    ],
    &[
        ("edges", 2.0258727),
    ...
    &[
        ("destination", 1.823242),
        ("get", 0.16165127),
        ("ids", 0.6933237),
        ("node", 0.2584595),
    ],
    &[
        ("destination", 1.3153117),
        ("directed", 0.9888532),
        ("get", 0.116617434),
        ("ids", 0.50017315),
        ("node", 0.18645622),
    ...
    &[("get", 0.23585008), ("ids", 1.011563), ("node", 0.37709382)],
    &[
        ("edge", 0.5413917),
        ("get", 0.16165127),
        ("ids", 0.6933237),
    ...
    &[("directed", 3.0986235), ("to", 3.8294916)],
    &[
        ("to", 2.4715915),
        ("triangular", 3.4233708),
        ("upper", 3.7419653),
    ],
    &[
        ("lower", 3.7419653),
    ...
    &[("bidiagonal", 5.797813), ("to", 3.8294916)],
    &[("arrowhead", 5.797813), ("to", 3.8294916)],
    &[("to", 3.8294916), ("transposed", 5.797813)],
    &[("complementary", 5.797813), ("to", 3.8294916)],
    &[
        ("approximated", 2.5283294),
        ("cliques", 3.4233708),
        ("get", 0.23585008),
    ],
    &[
    ...
    &[("report", 4.5422635), ("textual", 5.3041816)],
    &[
        ("connected", 1.6940249),
        ("generate", 1.6940249),
        ("graph", 1.5145488),
    ...
    &[("remove", 2.6872835), ("tendrils", 5.3041816)],
    &[
        ("dendritic", 3.4233708),
        ("remove", 1.7343992),
        ("trees", 3.4233708),
    ...
    &[
        ("disconnected", 3.0567768),
        ("nodes", 1.6276565),
        ("remove", 1.7343992),
    ],
    &[("remove", 2.6872835), ("selfloops", 3.7489169)],
    &[
        ("edges", 2.0258727),
        ("parallel", 2.9316213),
        ("remove", 1.7343992),
    ...
    &[
        ("arborescence", 2.3463728),
        ("kruskal", 2.3463728),
        ("random", 1.4907942),
        ("spanning", 2.20254),
    ],
    &[
        ("arborescence", 3.4233708),
        ("kruskal", 3.4233708),
        ("spanning", 3.213518),
    ],
    &[
    ...
    &[("enable", 9.46771)],
    &[("all", 4.1215982), ("disable", 5.797813)],
    &[
        ("compatible", 2.09511),
        ("has", 1.0368559),
        ("node", 0.2584595),
        ("vocabularies", 2.20254),
    ],
    &[
        ("compatible", 1.511441),
        ("has", 0.748002),
    ...
    &[("compatible", 4.73618), ("is", 3.541046)],
    &[
        ("adjacency", 2.20254),
        ("has", 1.0368559),
        ("matrix", 1.9379175),
    ...
    &[("has", 2.3439035), ("nodes", 2.5218961)],
    &[("edges", 3.1388936), ("has", 2.3439035)],
    &[
        ("has", 1.5127784),
        ("nodes", 1.6276565),
        ("trap", 2.8274322),
    ],
    &[("directed", 3.0986235), ("is", 3.541046)],
    &[
        ("edge", 0.78989345),
        ("has", 1.5127784),
        ("weights", 2.2464328),
    ...
    &[
        ("edge", 0.39056736),
        ("has", 0.748002),
        ("probabilities", 1.8502364),
        ("representing", 1.8502364),
        ("weights", 1.1107618),
    ],
    &[
        ("has", 1.0368559),
    ...
    &[("has", 2.3439035), ("selfloops", 3.7489169)],
    &[
        ("disconnected", 3.0567768),
        ("has", 1.5127784),
        ("nodes", 1.6276565),
    ...
    &[("connected", 3.8294916), ("is", 3.541046)],
    &[
        ("has", 1.5127784),
        ("node", 0.37709382),
        ("types", 1.2502557),
    ...
    &[("is", 3.541046), ("multigraph", 4.9790344)],
    &[
        ("has", 1.5127784),
        ("node", 0.37709382),
        ("ontologies", 2.9316213),
    ...
    &[("get", 0.36542684), ("tendrils", 5.3041816)],
    &[
        ("degree", 0.76312083),
        ("distribution", 1.3909305),
        ("geometric", 1.3909305),
        ("get", 0.08766812),
        ("node", 0.14017001),
        ("threshold", 1.3909305),
    ...
    &[("add", 5.797813), ("selfloops", 3.7489169)],
    &[
        ("centrality", 2.1750767),
        ("degree", 2.0529938),
        ("get", 0.23585008),
    ],
    &[
        ("centrality", 1.4907942),
        ("degree", 1.4071187),
        ("get", 0.16165127),
        ("weighted", 1.1665431),
    ],
    &[
        ("centrality", 0.6281791),
        ("closeness", 0.88282084),
        ("from", 0.19449605),
        ("get", 0.06811533),
        ("id", 0.2951874),
        ("node", 0.10890762),
    ...
    &[
        ("centrality", 0.50126487),
        ("closeness", 0.70446014),
        ("from", 0.15520103),
        ("get", 0.05435365),
        ("id", 0.23554921),
        ("node", 0.086904466),
    ...
    &[
        ("betweenness", 2.9316213),
        ("centrality", 2.1750767),
        ("get", 0.23585008),
    ],
    &[
        ("approximated", 0.7302011),
        ("betweenness", 0.84667504),
        ("centrality", 0.6281791),
        ("from", 0.19449605),
        ("get", 0.06811533),
        ("id", 0.2951874),
    ...
    &[
        ("approximated", 0.5826749),
        ("betweenness", 0.675617),
        ("centrality", 0.50126487),
        ("from", 0.15520103),
        ("get", 0.05435365),
        ("id", 0.23554921),
    ...
    &[
        ("centrality", 2.1750767),
        ("eigenvector", 3.4233708),
        ("get", 0.23585008),
    ],
    &[
        ("centrality", 1.4907942),
        ("eigenvector", 2.3463728),
        ("get", 0.16165127),
        ("weighted", 1.1665431),
    ],
    &[("dot", 5.797813), ("to", 3.8294916)],
    &[("get", 0.36542684), ("stars", 5.797813)],
    &[
        ("community", 1.5889425),
        ("detection", 1.8502364),
        ("get", 0.116617434),
    ...
    &[
        ...
        ("from", 0.19449605),
        ("get", 0.06811533),
        ("memberships", 0.98869604),
        ("modularity", 0.98869604),
        ("node", 0.10890762),
    ],
    &[
        ("community", 0.9280889),
        ...
        ("modularity", 0.98869604),
        ("node", 0.10890762),
        ("undirected", 0.84667504),
    ],
    &[
        ("attachment", 1.250147),
        ("get", 0.116617434),
        ("minimum", 1.3539101),
        ("preferential", 1.250147),
        ("unchecked", 0.6258583),
    ],
    &[
        ("attachment", 1.250147),
    ...
    &[
        ("attachment", 0.93980837),
        ("get", 0.08766812),
        ("minimum", 1.0178131),
        ("preferential", 0.93980837),
        ("unchecked", 0.47049418),
        ("weighted", 0.6326498),
    ],
    &[
    ...
    &[
        ("attachment", 0.7302011),
        ("from", 0.19449605),
        ("get", 0.06811533),
        ("ids", 0.29214725),
        ("node", 0.10890762),
        ("preferential", 0.7302011),
        ("unchecked", 0.36555895),
    ],
    &[
        ("attachment", 0.93980837),
    ...
    &[
        ("attachment", 0.5826749),
        ("from", 0.15520103),
        ("get", 0.05435365),
        ("ids", 0.23312326),
        ("node", 0.086904466),
        ("preferential", 0.5826749),
        ("unchecked", 0.29170325),
        ("weighted", 0.39223865),
    ],
    &[
