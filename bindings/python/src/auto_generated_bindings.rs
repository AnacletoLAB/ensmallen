...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("transformed", 0.85498416),
        ("graph", 0.6341996),
        ("get", 0.06614118),
        ("random", 0.6726009),
        ("normalized", 0.8998483),
        ("walk", 0.9599147),
        ("laplacian", 0.85498416),
    ],
    &[
        ("laplacian", 1.1009452),
        ("get", 0.085168615),
        ("graph", 0.8166456),
        ("transformed", 1.1009452),
        ("symmetric", 1.2360622),
        ("normalized", 1.1587158),
    ],
    &[
        ("transformed", 1.4654368),
        ("graph", 1.0870137),
        ("symmetric", 1.645287),
        ("normalized", 1.5423336),
        ("get", 0.113365516),
    ],
    &[
        ("from", 0.25360715),
        ("unchecked", 0.45885932),
        ("is", 0.83197623),
        ("connected", 0.90617347),
        ("node", 0.14452736),
        ("id", 0.37360832),
    ],
    &[
    ...
    &[
        ("id", 0.23143506),
        ("unchecked", 0.28424457),
        ("from", 0.15709923),
        ("is", 0.5153752),
        ("selfloops", 0.5365099),
        ("node", 0.089528784),
        ("with", 0.45928422),
        ("singleton", 0.40489766),
    ],
    &[
        ("id", 0.29014087),
        ("from", 0.19694902),
    ...
    &[("node", 0.38989386), ("name", 1.508596), ("has", 1.5631483)],
    &[
        ("type", 0.76377296),
        ("id", 0.6899477),
        ("node", 0.2669007),
    ...
    &[
        ...
        ("degree", 0.7309773),
        ("sort", 1.1009452),
        ("increasing", 1.2360622),
    ],
    &[
        ("decreasing", 1.2360622),
        ("outbound", 1.1009452),
        ("node", 0.14452736),
        ("degree", 0.7309773),
        ("by", 0.98351973),
    ...
    &[("components", 4.6099586), ("remove", 3.1045613)],
    &[("overlaps", 9.276341)],
    &[("contains", 8.471547)],
    &[
        ("edges", 2.0296981),
    ...
    &[("star", 3.125887), ("get", 0.2297608), ("edges", 2.0296981)],
    &[
        ("star", 2.1398168),
        ("names", 0.8898685),
        ("get", 0.15728207),
    ...
    &[("edge", 1.2908883), ("encode", 5.667423)],
    &[("decode", 5.667423), ("edge", 1.2908883)],
    &[
        ("encodable", 1.8015889),
        ("max", 1.8015889),
        ("edge", 0.41035408),
    ...
    &[("get", 0.35662428), ("circles", 5.667423)],
    &[
        ("stats", 3.6513262),
        ("get", 0.2297608),
        ("memory", 2.3364766),
    ...
    &[("transitivity", 5.667423), ("get", 0.35662428)],
    &[
        ("per", 1.2360622),
        ("get", 0.085168615),
        ("number", 0.56910074),
    ...
    &[
        ("node", 0.19237624),
        ("get", 0.113365516),
        ("clustering", 1.5423336),
        ("per", 1.645287),
        ("coefficient", 1.3529209),
    ],
    &[
        ("coefficient", 2.7419991),
        ("get", 0.2297608),
        ("clustering", 3.125887),
    ],
    &[
        ("average", 2.4995046),
        ("coefficient", 1.8770275),
        ("get", 0.15728207),
        ("clustering", 2.1398168),
    ],
    &[
        ("remappable", 3.6513262),
        ("nodes", 1.6229668),
        ("are", 3.6513262),
    ],
    &[
    ...
    &[("sample", 5.667423), ("negatives", 5.667423)],
    &[("holdout", 3.9977908), ("connected", 3.7943962)],
    &[("holdout", 3.9977908), ("random", 3.626573)],
    &[
        ("node", 0.19237624),
        ("indices", 1.8015889),
        ("holdout", 1.2708378),
    ...
    &[("chains", 5.667423), ("get", 0.35662428)],
    &[
        ("get", 0.03571853),
        ("unchecked", 0.19243921),
        ("id", 0.15668613),
        ("search", 0.38968518),
        ("first", 0.38968518),
        ("parallel", 0.44237524),
    ...
    &[
        ...
        ("id", 0.25590658),
        ("most", 0.3893112),
        ("unchecked", 0.16225971),
        ("and", 0.29419962),
        ("node", 0.09899539),
        ("eccentricity", 0.35941994),
        ("from", 0.08967939),
        ("get", 0.030116934),
    ],
    &[
        ("eccentricity", 0.7893386),
        ("get", 0.06614118),
        ("from", 0.19694902),
        ("id", 0.29014087),
        ("unchecked", 0.356346),
    ...
    &[
        ("id", 0.37360832),
        ("weighted", 0.5958604),
        ("eccentricity", 1.0164149),
        ("from", 0.25360715),
        ("get", 0.085168615),
        ("node", 0.14452736),
    ],
    &[
        ("eccentricity", 1.3529209),
        ("get", 0.113365516),
        ("node", 0.19237624),
        ("from", 0.33756924),
        ("name", 0.7443513),
    ...
    &[("get", 0.35662428), ("diameter", 4.85186)],
    &[
        ("get", 0.15728207),
        ("diameter", 2.1398168),
        ("weighted", 1.1003838),
    ...
    &[("density", 5.667423), ("get", 0.35662428)],
    &[
        ("rate", 1.8770275),
        ("get", 0.15728207),
        ("trap", 1.8770275),
    ...
    &[
        ("ids", 0.68598026),
        ("destination", 1.8162796),
        ("node", 0.2669007),
        ("get", 0.15728207),
    ],
    &[
        ("get", 0.113365516),
        ("destination", 1.3091351),
        ("directed", 1.2061816),
        ("node", 0.19237624),
        ("ids", 0.49443975),
    ],
    &[
        ("destination", 2.6532574),
        ("names", 1.2999377),
        ("get", 0.2297608),
    ],
    &[
    ...
    &[
        ("ontologies", 3.6513262),
        ("get", 0.2297608),
        ("node", 0.38989386),
    ],
    &[("node", 0.38989386), ("ids", 1.0020937), ("get", 0.2297608)],
    &[
        ("type", 0.76377296),
        ("get", 0.15728207),
        ("edge", 0.56932074),
    ...
    &[("directed", 3.7943962), ("to", 3.7068317)],
    &[
        ("to", 2.3881845),
        ("upper", 3.6513262),
        ("triangular", 3.3345454),
    ],
    &[
        ("lower", 3.6513262),
        ("triangular", 3.3345454),
    ...
    &[("to", 3.7068317), ("bidiagonal", 5.667423)],
    &[("arrowhead", 5.667423), ("to", 3.7068317)],
    &[("transposed", 5.667423), ("to", 3.7068317)],
    &[("to", 3.7068317), ("complementary", 5.667423)],
    &[("report", 7.2293496)],
    &[
        ("textual", 3.3345454),
        ("overlap", 3.6513262),
    ...
    &[("report", 4.416804), ("textual", 5.17573)],
    &[
        ("connected", 1.6734432),
        ("generate", 1.6348246),
        ("random", 1.5994282),
    ...
    &[("drop", 3.7943962), ("tendrils", 5.17573)],
    &[
        ("dendritic", 3.3345454),
        ("drop", 2.4445992),
        ("trees", 3.3345454),
    ...
    &[
        ("nodes", 1.6229668),
        ("drop", 2.4445992),
        ("disconnected", 2.9700384),
    ],
    &[("drop", 3.7943962), ("selfloops", 3.626573)],
    &[
        ("parallel", 2.8455954),
        ("drop", 2.4445992),
        ("edges", 2.0296981),
    ...
    &[
        ("kruskal", 2.282653),
        ("arborescence", 2.282653),
        ("spanning", 2.1398168),
        ("random", 1.5994282),
    ],
    &[
        ("kruskal", 3.3345454),
        ("arborescence", 3.3345454),
        ("spanning", 3.125887),
    ],
    &[
        ("connected", 2.4445992),
    ...
    &[("enable", 9.276341)],
    &[("compatible", 5.667423), ("is", 3.483712)],
    &[
        ("adjacency", 2.1398168),
        ("has", 1.0700486),
        ("same", 2.4995046),
    ...
    &[("nodes", 2.5190952), ("has", 2.4262478)],
    &[("has", 2.4262478), ("edges", 3.1504054)],
    &[
        ("nodes", 1.6229668),
        ("has", 1.5631483),
        ("trap", 2.7419991),
    ],
    &[("directed", 3.7943962), ("is", 3.483712)],
    &[
        ("edge", 0.8316751),
        ("has", 1.5631483),
        ("weights", 2.2444363),
    ...
    &[
        ...
        ("weights", 1.1074198),
        ("has", 0.77126783),
        ("representing", 1.8015889),
        ("probabilities", 1.8015889),
    ],
    &[
        ("has", 1.0700486),
        ("singleton", 1.2070696),
    ...
    &[("has", 2.4262478), ("selfloops", 3.626573)],
    &[
        ("disconnected", 2.9700384),
        ("has", 1.5631483),
        ("nodes", 1.6229668),
    ...
    &[("is", 3.483712), ("connected", 3.7943962)],
    &[
        ("has", 1.5631483),
        ("types", 1.2549806),
        ("node", 0.38989386),
    ...
    &[("is", 3.483712), ("multigraph", 4.85186)],
    &[
        ("has", 0.35893553),
        ("outbound", 0.6819905),
        ("by", 0.6092502),
        ("sorted", 0.717777),
        ("node", 0.089528784),
        ("decreasing", 0.76568985),
        ("nodes", 0.37267125),
        ("degree", 0.4528105),
    ],
    &[
        ("sorted", 1.1587158),
        ("lexicographic", 1.2360622),
        ("has", 0.57943386),
        ("by", 0.98351973),
        ("order", 1.2360622),
        ("nodes", 0.60160756),
    ...
    &[("get", 0.35662428), ("tendrils", 5.17573)],
    &[
        ("threshold", 1.3534877),
        ("distribution", 1.3534877),
        ("degree", 0.7309773),
        ("node", 0.14452736),
        ("get", 0.085168615),
        ("geometric", 1.3534877),
    ...
    &[("add", 5.667423), ("selfloops", 3.626573)],
    &[
        ("degree", 1.9719696),
        ("centrality", 2.0933576),
        ("get", 0.2297608),
    ],
    &[
        ("degree", 1.349906),
        ("centrality", 1.4330018),
        ("weighted", 1.1003838),
        ("get", 0.15728207),
    ],
    &[
        ...
        ("id", 0.29014087),
        ("get", 0.06614118),
        ("closeness", 0.85498416),
        ("centrality", 0.6026143),
        ("unchecked", 0.356346),
        ("from", 0.19694902),
    ],
    &[
        ("centrality", 0.48068404),
        ("get", 0.05275847),
        ("id", 0.23143506),
        ("unchecked", 0.28424457),
        ("from", 0.15709923),
    ...
    &[
        ...
        ("get", 0.06614118),
        ("node", 0.112238646),
        ("approximated", 0.8191608),
        ("centrality", 0.6026143),
        ("betweenness", 0.8191608),
    ],
    &[
        ("centrality", 0.6026143),
        ("from", 0.19694902),
    ...
    &[
        ("id", 0.23143506),
        ("approximated", 0.6534155),
        ("from", 0.15709923),
        ("betweenness", 0.6534155),
        ("weighted", 0.36911112),
        ("node", 0.089528784),
        ("get", 0.05275847),
        ("centrality", 0.48068404),
    ...
    &[
        ("eigenvector", 3.3345454),
        ("centrality", 2.0933576),
        ("get", 0.2297608),
    ],
    &[
        ("eigenvector", 2.282653),
        ("get", 0.15728207),
        ("weighted", 1.1003838),
        ("centrality", 1.4330018),
    ],
    &[("dot", 5.667423), ("to", 3.7068317)],
    &[("stars", 5.667423), ("get", 0.35662428)],
    &[
        ("community", 1.5423336),
        ("undirected", 1.4040358),
        ("louvain", 1.8015889),
    ...
    &[
        ("memberships", 0.9599147),
        ("directed", 0.7037262),
        ("community", 0.8998483),
        ("from", 0.19694902),
        ("modularity", 0.9599147),
        ("node", 0.112238646),
        ("get", 0.06614118),
    ],
    &[
        ...
        ("from", 0.19694902),
        ("node", 0.112238646),
        ("undirected", 0.8191608),
        ("memberships", 0.9599147),
        ("modularity", 0.9599147),
        ("community", 0.8998483),
    ],
    &[
        ("attachment", 1.2061816),
        ("unchecked", 0.6107746),
        ("minimum", 1.3091351),
        ("preferential", 1.2061816),
        ("get", 0.113365516),
    ],
    &[
        ("unchecked", 0.6107746),
    ...
    &[
        ("get", 0.085168615),
        ("attachment", 0.90617347),
        ("unchecked", 0.45885932),
        ("preferential", 0.90617347),
        ("minimum", 0.98351973),
        ("weighted", 0.5958604),
    ],
    &[
    ...
    &[
        ("node", 0.112238646),
        ("unchecked", 0.356346),
        ("attachment", 0.7037262),
        ("from", 0.19694902),
        ("ids", 0.28847244),
        ("get", 0.06614118),
        ("preferential", 0.7037262),
    ],
    &[
        ("get", 0.085168615),
        ("node", 0.14452736),
    ...
    &[
        ...
        ("unchecked", 0.28424457),
        ("node", 0.089528784),
        ("preferential", 0.56133735),
        ("attachment", 0.56133735),
    ],
    &[
        ("get", 0.06614118),
        ("from", 0.19694902),
    ...
    &[
        ...
        ("from", 0.12809102),
        ("unchecked", 0.23175907),
        ("allocation", 0.5133673),
        ("get", 0.04301667),
        ("node", 0.07299738),
    ],
    &[
        ("allocation", 0.7893386),
        ("get", 0.06614118),
        ("ids", 0.28847244),
        ("from", 0.19694902),
        ("index", 0.7215929),
