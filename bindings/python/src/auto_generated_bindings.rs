...
impl Graph {
    ...
    #[automatically_generated_binding]
    #[pyo3(text_signature = "($self, precision)")]
    ...
    pub fn get_approximated_closeness_centrality(
        ...
        Ok({
            ...
            to_ndarray_1d!(
                gil,
                pe!(self.inner.get_approximated_closeness_centrality(precision))?,
                f32
            )
        })
    }
    ...
    pub fn get_approximated_harmonic_centrality(
        ...
        Ok({
            ...
            to_ndarray_1d!(
                gil,
                pe!(self.inner.get_approximated_harmonic_centrality(precision))?,
                f32
            )
        })
    }
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[("remove", 2.8429103), ("tendrils", 5.481155)],
    &[
        ("dendritic", 3.550688),
        ("remove", 1.841635),
        ("trees", 3.550688),
    ...
    &[
        ...
        ("remove", 0.91466874),
        ("selfloops", 1.1915963),
        ("singleton", 0.96931875),
        ("with", 1.0611537),
    ],
    &[
        ("disconnected", 3.1797352),
        ("nodes", 1.7336233),
        ("remove", 1.841635),
    ],
    &[("remove", 2.8429103), ("selfloops", 3.7036374)],
    &[
        ("edges", 2.136574),
        ("parallel", 3.0530918),
        ("remove", 1.841635),
    ],
    &[("chains", 5.978813), ("get", 0.36426958)],
    &[("circles", 5.978813), ("get", 0.36426958)],
    &[
        ("approximated", 2.5875924),
        ("cliques", 3.550688),
        ("get", 0.23597355),
    ],
    &[
    ...
    &[
        ("get", 0.11719892),
        ("graph", 0.9595228),
        ("intersection", 1.6580242),
        ("neighbours", 1.6580242),
        ("size", 1.5163524),
    ],
    &[
        ("ancestors", 1.1020589),
    ...
    &[("edges", 2.136574), ("get", 0.23597355), ("star", 3.33834)],
    &[
        ("edge", 0.5722076),
        ("get", 0.16215715),
        ("names", 0.8786978),
    ...
    &[
        ...
        ("node", 0.057919547),
        ("parallel", 0.48081654),
        ("predecessors", 0.60995096),
        ("search", 0.42649612),
        ("unchecked", 0.20928545),
    ],
    &[
        ("breadth", 0.42649612),
        ("distances", 0.5257389),
    ...
    &[
        ("and", 0.31354222),
        ("distant", 0.47178194),
        ("eccentricity", 0.3916578),
        ("from", 0.085114986),
        ("get", 0.03135394),
        ("id", 0.27621523),
        ("most", 0.42249322),
        ("node", 0.09456193),
        ("unchecked", 0.17657463),
    ],
    &[
        ("eccentricity", 0.8571415),
        ("from", 0.1862738),
        ("get", 0.06861797),
        ("id", 0.31238595),
        ("node", 0.10694492),
        ("unchecked", 0.38643286),
        ("weighted", 0.53069335),
    ],
    &[
        ("and", 0.3716266),
        ("distant", 0.5591805),
        ("eccentricity", 0.46421322),
        ("from", 0.10088272),
        ("get", 0.037162323),
        ("id", 0.3254282),
        ("most", 0.500761),
    ...
    &[("diameter", 5.481155), ("get", 0.36426958)],
    &[
        ("breadth", 0.7874991),
        ("first", 0.7874991),
        ("from", 0.1862738),
    ...
    &[
        ("approximated", 0.60089666),
        ("get", 0.054798316),
        ("groups", 0.5886766),
        ("isomorphic", 0.49616012),
        ("node", 0.08540622),
        ("number", 0.37287742),
        ("of", 0.38117525),
        ("type", 0.24603638),
    ...
    &[("get", 0.36426958), ("transitivity", 5.978813)],
    &[
        ("get", 0.088224694),
        ("node", 0.13750309),
        ("number", 0.60032856),
    ...
    &[
        ("clustering", 1.6580242),
        ("coefficient", 1.4191364),
        ("get", 0.11719892),
        ("node", 0.18266103),
        ("per", 1.6580242),
    ],
    &[
        ("clustering", 3.33834),
        ("coefficient", 2.8573527),
        ("get", 0.23597355),
    ],
    &[
        ("average", 2.6615105),
        ("clustering", 2.2940526),
        ("coefficient", 1.9635259),
        ("get", 0.16215715),
    ],
    &[
        ("edge", 0.4511503),
    ...
    &[
        ...
        ("from", 0.1862738),
        ("get", 0.06861797),
        ("memberships", 1.0324928),
        ("modularity", 1.0324928),
        ("node", 0.10694492),
    ],
    &[
        ("community", 0.9707449),
    ...
    &[
        ("get", 0.23597355),
        ("nodes", 1.7336233),
        ("subsampled", 3.8730705),
    ],
    &[
        ("compatible", 2.185062),
        ("has", 1.0877752),
        ("node", 0.25273094),
        ("vocabularies", 2.2940526),
    ],
    &[
        ("compatible", 1.5792513),
        ("has", 0.7861885),
        ("node", 0.18266103),
        ("types", 0.6563365),
        ("vocabularies", 1.6580242),
    ],
    &[
        ("compatible", 1.5792513),
        ("edge", 0.4135625),
    ...
    &[("compatible", 4.9085197), ("is", 3.6427286)],
    &[
        ("adjacency", 2.6615105),
        ("has", 1.0877752),
        ("matrix", 1.74199),
    ...
    &[
        ...
        ("must", 1.6776229),
        ("node", 0.25273094),
        ("ontologies", 2.0980346),
    ],
    &[
        ("be", 3.0530918),
        ("must", 2.4413023),
        ("undirected", 2.7783623),
    ],
    &[
        ("acyclic", 2.4399745),
        ("be", 2.0980346),
    ...
    &[
        ("be", 3.0530918),
        ("multigraph", 3.0530918),
        ("must", 2.4413023),
    ],
    &[
        ("be", 2.0980346),
        ("multigraph", 2.0980346),
        ("must", 1.6776229),
        ("not", 2.0255864),
    ],
    &[
    ...
    &[
        ...
        ("node", 0.25273094),
        ("share", 2.6615105),
        ("vocabulary", 2.6615105),
    ],
    &[
        ("components", 1.5792513),
        ("connected", 1.285157),
        ("get", 0.11719892),
        ("number", 0.79748493),
        ("of", 0.81523174),
    ...
    &[("density", 5.978813), ("get", 0.36426958)],
    &[
        ("get", 0.16215715),
        ("nodes", 1.1913174),
        ("rate", 2.0255864),
    ...
    &[
        ("destination", 1.9092449),
        ("get", 0.16215715),
        ("ids", 0.6745694),
        ("node", 0.25273094),
    ],
    &[
        ("destination", 1.3799049),
        ("directed", 1.0006891),
        ("get", 0.11719892),
        ("ids", 0.4875444),
        ("node", 0.18266103),
    ...
    &[("components", 4.9085197), ("remove", 2.8429103)],
    &[("add", 4.410862), ("selfloops", 3.7036374)],
    &[("name", 2.3145657), ("set", 4.7130218)],
    &[
        ("all", 1.285157),
        ("edge", 0.4135625),
        ("inplace", 1.0355521),
    ...
    &[
        ("components", 3.1797352),
        ("connected", 2.5875924),
        ("strongly", 3.8730705),
    ],
    &[("get", 0.36426958), ("tendrils", 5.481155)],
    &[
        ("edges", 0.7988124),
        ("features", 1.4480455),
        ("from", 0.2394992),
    ...
    &[("directed", 3.1102731), ("to", 3.8382266)],
    &[
        ("to", 2.4864001),
        ("triangular", 3.550688),
        ("upper", 3.8730705),
    ...
    &[("bidiagonal", 5.978813), ("to", 3.8382266)],
    &[("arrowhead", 5.978813), ("to", 3.8382266)],
    &[("to", 3.8382266), ("transposed", 5.978813)],
    &[("to", 3.8382266), ("undirected", 4.288925)],
    &[("complementary", 5.978813), ("to", 3.8382266)],
    &[
        ("graph", 0.9595228),
        ("multi", 1.923604),
        ("similarity", 1.923604),
        ("structural", 1.7634891),
        ("to", 1.2348986),
    ],
    &[("dot", 5.978813), ("to", 3.8382266)],
    &[("enable", 9.716376)],
    &[("all", 3.994436), ("disable", 5.978813)],
    &[("report", 7.6592946)],
    &[
        ("overlap", 3.8730705),
        ("report", 3.0530918),
    ...
    &[("report", 4.7130218), ("textual", 5.481155)],
    &[
        ("16", 0.9707449),
        ("base", 0.7524375),
        ("from", 0.1862738),
    ...
    &[
        ("attachment", 0.7524375),
        ("from", 0.1862738),
        ("get", 0.06861797),
        ("ids", 0.2854489),
        ("node", 0.10694492),
        ("preferential", 0.7524375),
        ("unchecked", 0.38643286),
    ],
    &[
        ("attachment", 0.967437),
    ...
    &[
        ("attachment", 0.60089666),
        ("from", 0.14875828),
        ("get", 0.054798316),
        ("ids", 0.22795954),
        ("node", 0.08540622),
        ("preferential", 0.60089666),
        ("unchecked", 0.3086053),
        ("weighted", 0.42381176),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.054798316),
        ("ids", 0.22795954),
        ("intersection", 0.77523696),
        ("neighbours", 0.77523696),
        ("node", 0.08540622),
        ("size", 0.70899594),
        ("unchecked", 0.3086053),
    ],
    &[
        ("coefficient", 0.83088017),
        ("from", 0.1862738),
        ("get", 0.06861797),
        ("ids", 0.2854489),
        ("jaccard", 0.76913226),
    ...
    &[
        ("attachment", 1.778151),
        ("get", 0.16215715),
        ("preferential", 1.778151),
        ("scores", 2.185062),
    ],
    &[
        ("allocation", 1.4191364),
        ("get", 0.11719892),
        ("index", 1.3136715),
        ("resource", 1.4191364),
        ("scores", 1.5792513),
    ...
    &[
        ("arborescence", 2.4399745),
        ("kruskal", 2.4399745),
        ("random", 1.5491377),
        ("spanning", 2.185062),
    ],
    &[
        ("arborescence", 3.550688),
        ("kruskal", 3.550688),
        ("spanning", 3.1797352),
    ],
    &[
    ...
    &[
        ("centrality", 0.51617604),
        ("closeness", 0.70899594),
        ("from", 0.14875828),
        ("get", 0.054798316),
        ("id", 0.24947144),
        ("node", 0.08540622),
    ...
    &[
        ("betweenness", 3.0530918),
        ("centrality", 2.222767),
        ("get", 0.23597355),
    ],
    &[
        ("approximated", 0.7524375),
        ("betweenness", 0.8877985),
        ("centrality", 0.6463511),
        ("from", 0.1862738),
        ("get", 0.06861797),
        ("id", 0.31238595),
    ...
    &[
        ("centrality", 2.222767),
        ("eigenvector", 3.550688),
        ("get", 0.23597355),
    ],
    &[
        ("centrality", 1.527449),
        ("eigenvector", 2.4399745),
        ("get", 0.16215715),
        ("weighted", 1.2541281),
    ],
    &[("overlaps", 9.716376)],
    ...
    &[("connected", 3.994436), ("holdout", 4.288925)],
    &[("holdout", 4.288925), ("random", 3.4799807)],
    &[
        ("get", 0.11719892),
        ("holdout", 1.3799049),
        ("indices", 1.923604),
    ...
    &[("has", 2.4435768), ("nodes", 2.676174)],
    &[("edges", 3.2982044), ("has", 2.4435768)],
    &[
        ("has", 1.5829471),
        ("nodes", 1.7336233),
        ("trap", 2.8573527),
    ],
    &[("directed", 3.1102731), ("is", 3.6427286)],
    &[
        ("acyclic", 3.550688),
        ("directed", 2.0148325),
        ("is", 2.3597567),
    ...
    &[
        ("edge", 0.4135625),
        ("has", 0.7861885),
        ("probabilities", 1.923604),
        ("representing", 1.923604),
        ("weights", 1.1535566),
    ],
    &[
        ("has", 1.0877752),
    ...
    &[("has", 2.4435768), ("selfloops", 3.7036374)],
    &[
        ("disconnected", 3.1797352),
        ("has", 1.5829471),
        ("nodes", 1.7336233),
    ...
    &[("connected", 3.994436), ("is", 3.6427286)],
    &[
        ("has", 1.5829471),
        ("node", 0.36777788),
        ("types", 1.3214972),
    ...
    &[("is", 3.6427286), ("multigraph", 4.7130218)],
    &[
        ("has", 1.5829471),
        ("node", 0.36777788),
        ("ontologies", 3.0530918),
