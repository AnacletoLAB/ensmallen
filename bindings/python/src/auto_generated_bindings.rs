...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("laplacian", 0.94077563),
        ("normalized", 0.9907161),
        ("get", 0.07587435),
        ("symmetric", 1.0575788),
        ("graph", 0.7082625),
        ("transformed", 0.94077563),
    ],
    &[
        ("symmetric", 1.4222955),
        ("graph", 0.95251393),
        ("get", 0.10204038),
        ("normalized", 1.3323745),
        ("transformed", 1.2652115),
    ],
    &[
        ("unchecked", 0.5336909),
        ("is", 0.95251393),
    ...
    &[
        ("is", 0.7082625),
        ("unchecked", 0.39683753),
        ("node", 0.44515082),
        ("node_id", 0.44153768),
        ("disconnected", 0.94077563),
        ("from", 0.21967608),
    ],
    &[
        ("from", 0.29543355),
    ...
    &[("has", 2.2327309), ("node_name", 2.7642682)],
    &[("node_type_id", 3.4869978), ("has", 2.2327309)],
    &[("node_type_name", 3.4869978), ("has", 2.2327309)],
    &[("has", 2.2327309), ("edge_type_id", 2.8867908)],
    &[("edge_type_name", 3.3305848), ("has", 2.2327309)],
    &[
        ("edge", 0.85659647),
        ("has", 0.93607205),
        ("node_ids", 0.7199481),
    ...
    &[
        ...
        ("node_name", 1.158919),
        ("has", 0.93607205),
        ("node_type_name", 1.4619232),
    ],
    &[
        ("has", 0.93607205),
        ("from", 0.41577974),
        ("node_names", 0.9450275),
        ("edge", 0.85659647),
    ],
    &[
        ("from", 0.21967608),
        ("node_names", 0.49930263),
        ("edge", 0.45258036),
        ("edge_type_name", 0.7377561),
        ("and", 0.7082625),
        ("has", 0.49457106),
    ],
    &[
    ...
    &[
        ...
        ("sort", 1.2652115),
        ("order", 1.4222955),
        ("lexicographic", 1.4222955),
    ],
    &[
        ("sorting", 0.9907161),
        ("topological", 0.9907161),
        ("get", 0.07587435),
        ("from", 0.21967608),
        ("node_id", 0.44153768),
        ("bfs", 0.9907161),
    ...
    &[("components", 4.2471123), ("remove", 2.9316554)],
    &[("overlaps", 8.923186)],
    &[("contains", 8.141719)],
    &[
        ("get", 0.21413687),
    ...
    &[("edge", 2.0431647), ("encode", 5.2326818)],
    &[("edge", 2.0431647), ("decode", 5.2326818)],
    &[
        ("get", 0.10204038),
        ("number", 0.7132256),
        ("max", 1.5588119),
    ...
    &[("validate", 3.6765642), ("node_id", 1.9933128)],
    &[("node_ids", 1.7172294), ("validate", 3.6765642)],
    &[("validate", 3.6765642), ("edge_id", 2.5912137)],
    &[("edge_ids", 3.5767832), ("validate", 3.6765642)],
    &[
        ("unknown", 0.88740677),
        ("must", 1.0144621),
        ("node_types", 0.7132256),
        ("contain", 1.2652115),
        ("not", 1.1669383),
    ],
    &[
        ...
        ("unknown", 0.88740677),
        ("not", 1.1669383),
        ("edge_types", 0.7287225),
    ],
    &[("node_type_id", 3.4869978), ("validate", 3.6765642)],
    &[("validate", 3.6765642), ("node_type_ids", 3.4869978)],
    &[("edge_type_id", 2.8867908), ("validate", 3.6765642)],
    &[("validate", 3.6765642), ("edge_type_ids", 3.9172246)],
    &[
        ("be", 2.65511),
        ("undirected", 2.5425675),
        ("must", 2.1288996),
    ],
    &[
        ("must", 1.0144621),
    ...
    &[
        ("be", 2.65511),
        ("must", 2.1288996),
        ("multigraph", 2.7960546),
    ],
    &[
        ("be", 1.780601),
        ("must", 1.4277078),
        ("not", 1.6422957),
        ("multigraph", 1.8751231),
    ],
    &[
        ("contain", 1.780601),
        ("identity", 2.001674),
    ...
    &[
        ("all", 1.588474),
        ("set", 1.7051266),
        ("edge_types", 1.0255709),
        ("inplace", 1.3405248),
    ],
    &[
        ("edge_types", 1.5292608),
        ("set", 2.5425675),
        ("all", 2.3686233),
    ],
    &[
        ("all", 1.588474),
        ("set", 1.7051266),
        ("node_types", 1.0037613),
        ("inplace", 1.3405248),
    ],
    &[
        ("set", 2.5425675),
        ("node_types", 1.4967397),
        ("all", 2.3686233),
    ],
    &[
        ("remove", 1.8327434),
        ("inplace", 1.9988984),
        ("node_type_ids", 2.1799195),
    ],
    &[
        ("inplace", 1.3405248),
        ("remove", 1.229096),
    ...
    &[
        ("node_type_name", 2.1799195),
        ("inplace", 1.9988984),
        ("remove", 1.8327434),
    ],
    &[("remove", 2.9316554), ("node_type_id", 3.4869978)],
    &[
        ("node_types", 1.4967397),
        ("singleton", 1.5637842),
        ("remove", 1.8327434),
    ],
    &[("node_type_name", 3.4869978), ("remove", 2.9316554)],
    &[
        ("inplace", 1.9988984),
        ("remove", 1.8327434),
        ("edge_type_name", 2.0821366),
    ],
    &[("remove", 2.9316554), ("edge_type_id", 2.8867908)],
    &[
        ("singleton", 1.5637842),
        ("remove", 1.8327434),
        ("edge_types", 1.5292608),
    ],
    &[("edge_type_name", 3.3305848), ("remove", 2.9316554)],
    &[
        ("remove", 1.8327434),
        ("inplace", 1.9988984),
        ("node_types", 1.4967397),
    ],
    &[("node_types", 2.394184), ("remove", 2.9316554)],
    &[
        ("remove", 1.8327434),
        ("edge_types", 1.5292608),
        ("inplace", 1.9988984),
    ],
    &[("remove", 2.9316554), ("edge_types", 2.4462047)],
    &[
        ("inplace", 1.3405248),
        ("weights", 1.3405248),
        ("remove", 1.229096),
    ...
    &[("get", 0.3425332), ("circles", 5.2326818)],
    &[
        ("memory", 2.0821366),
        ("get", 0.21413687),
        ("stats", 3.271245),
    ...
    &[
        ...
        ("human", 0.69426376),
        ("readable", 0.69426376),
        ("node_types", 0.40869403),
        ("requirements", 0.6686814),
        ("memory", 0.5685403),
        ("total", 0.5685403),
    ],
    &[
    ...
    &[("transitivity", 5.2326818), ("get", 0.3425332)],
    &[
        ("number", 0.5303345),
        ("get", 0.07587435),
        ("triangles", 1.0575788),
    ...
    &[
        ("get", 0.10204038),
        ("clustering", 1.3323745),
        ("coefficient", 1.1669383),
        ("per", 1.4222955),
        ("node", 0.59866554),
    ],
    &[
        ("coefficient", 2.4488785),
        ("clustering", 2.7960546),
        ("get", 0.21413687),
    ],
    &[
        ("average", 2.193801),
        ("clustering", 1.8751231),
        ("coefficient", 1.6422957),
        ("get", 0.14360699),
    ],
    &[
        ("remappable", 3.271245),
    ...
    &[("sample", 5.2326818), ("negatives", 5.2326818)],
    &[("connected", 3.4869978), ("holdout", 3.6765642)],
    &[("holdout", 3.6765642), ("random", 3.3305848)],
    &[
        ("indices", 1.5588119),
        ("node", 0.59866554),
        ("get", 0.10204038),
    ...
    &[("chains", 5.2326818), ("get", 0.3425332)],
    &[
        ("get", 0.037626617),
        ("unchecked", 0.19679448),
        ("from", 0.10893889),
        ("breadth", 0.3929028),
        ("search", 0.3929028),
        ("predecessors", 0.5748001),
        ("parallel", 0.446762),
        ("first", 0.3929028),
        ("node_id", 0.2189616),
    ],
    ...
    &[
        ...
        ("unchecked", 0.39683753),
        ("from", 0.21967608),
        ("eccentricity", 0.8677024),
        ("get", 0.07587435),
    ],
    &[
        ("eccentricity", 0.5302288),
        ("and", 0.4327995),
        ("distant", 0.646257),
        ("node_id", 0.51462626),
        ("from", 0.13423793),
    ...
    &[("diameter", 4.4725676), ("get", 0.3425332)],
    &[
        ("diameter", 1.8751231),
        ("get", 0.14360699),
        ("naive", 2.001674),
    ...
    &[
        ...
        ("singleton", 0.7451736),
        ("get", 0.10204038),
        ("node_names", 0.67149216),
    ],
    &[("density", 5.2326818), ("get", 0.3425332)],
    &[
        ("trap", 1.6422957),
        ("rate", 1.6422957),
        ("nodes", 1.014508),
    ...
    &[
        ("number", 1.0037613),
        ("undirected", 1.7051266),
        ("get", 0.14360699),
        ("edges", 1.2697963),
    ],
    &[
        ("undirected", 1.2115829),
        ("unique", 1.038774),
        ("number", 0.7132256),
        ("edges", 0.90225756),
        ("get", 0.10204038),
    ...
    &[("source_names", 5.2326818), ("get", 0.3425332)],
    &[
        ("node_ids", 1.0735371),
        ("get", 0.21413687),
        ("destination", 2.4488785),
    ],
    &[
        ("node_ids", 0.7199481),
        ("directed", 1.4619232),
        ("destination", 1.6422957),
        ("get", 0.14360699),
    ],
    &[("get", 0.3425332), ("destination_names", 5.2326818)],
    &[("node_names", 2.2540915), ("get", 0.3425332)],
    &[("node", 1.2563297), ("get", 0.21413687), ("urls", 3.271245)],
    &[
        ("get", 0.21413687),
        ("ontologies", 3.271245),
        ("node", 1.2563297),
    ],
    &[("node_ids", 1.7172294), ("get", 0.3425332)],
    &[("get", 0.3425332), ("edge_type_ids", 3.9172246)],
    &[
        ("unique", 2.1799195),
        ("edge_type_ids", 2.4488785),
        ("get", 0.21413687),
    ],
    &[("edge_type_names", 4.0670896), ("get", 0.3425332)],
    &[
        ("get", 0.21413687),
        ("edge_type_names", 2.5425675),
        ("unique", 2.1799195),
    ],
    &[
        ("get", 0.21413687),
    ...
    &[("node_type_ids", 3.4869978), ("get", 0.3425332)],
    &[
        ("get", 0.14360699),
        ("known", 1.2919267),
        ("mask", 1.6422957),
    ...
    &[("get", 0.3425332), ("node_type_names", 3.4869978)],
    &[
        ("unique", 2.1799195),
        ("node_type_ids", 2.1799195),
        ("get", 0.21413687),
    ...
    &[
        ("get", 0.14360699),
        ("counts", 1.780601),
        ("edge_type_id", 1.2102865),
        ("hashmap", 1.780601),
    ],
    &[
        ("edge_type_names", 1.7051266),
        ("get", 0.14360699),
        ("counts", 1.780601),
        ("hashmap", 1.780601),
    ],
    ...
    &[("to", 3.4053867), ("directed", 3.4869978)],
    &[
        ("triangular", 2.9847584),
        ("to", 2.1288996),
        ("upper", 3.271245),
    ],
    &[
    ...
    &[("to", 3.4053867), ("bidiagonal", 5.2326818)],
    &[("to", 3.4053867), ("arrowhead", 5.2326818)],
    &[("to", 3.4053867), ("transposed", 5.2326818)],
    &[("to", 3.4053867), ("complementary", 5.2326818)],
    &[("report", 6.935526)],
    &[
        ("report", 2.5425675),
        ("overlap", 3.271245),
    ...
    &[("report", 4.0670896), ("textual", 4.774418)],
    &[
        ("connected", 1.4619232),
        ("graph", 1.3405248),
        ("generate", 1.4277078),
    ...
    &[("replace", 8.923186)],
    &[("from_ids", 5.2326818), ("filter", 4.774418)],
    &[("filter", 4.774418), ("from_names", 5.2326818)],
    &[
        ("unknown", 1.8622677),
        ("drop", 2.3686233),
        ("node_types", 1.4967397),
    ...
    &[
        ("nodes", 1.5127645),
        ("drop", 2.3686233),
        ("disconnected", 2.65511),
    ],
    &[("selfloops", 3.3305848), ("drop", 3.7888484)],
    &[
        ("edges", 1.8934329),
        ("drop", 2.3686233),
        ("parallel", 2.5425675),
    ...
    &[
        ("spanning", 1.8751231),
        ("kruskal", 2.001674),
        ("arborescence", 2.001674),
        ("random", 1.396347),
    ],
    &[
        ("kruskal", 2.9847584),
        ("spanning", 2.7960546),
        ("arborescence", 2.9847584),
    ],
    &[
        ("get", 0.21413687),
        ("connected", 2.1799195),
    ...
    &[("enable", 8.923186)],
    &[("is", 3.1974368), ("compatible", 5.2326818)],
    &[
        ("has", 0.93607205),
        ("matrix", 1.6422957),
        ("same", 2.193801),
    ...
    &[("has", 2.2327309), ("nodes", 2.4198172)],
    &[("edges", 3.0287342), ("has", 2.2327309)],
    &[
        ("trap", 2.4488785),
        ("nodes", 1.5127645),
        ("has", 1.3958063),
    ],
    &[("is", 3.1974368), ("directed", 3.4869978)],
    &[
        ("edge", 1.2772977),
        ("has", 1.3958063),
        ("weights", 1.9988984),
    ...
    &[
        ("probabilities", 1.5588119),
        ("has", 0.6651288),
        ("edge", 0.60865724),
        ("representing", 1.5588119),
        ("weights", 0.95251393),
    ],
    &[
        ("has", 0.93607205),
    ...
    &[("edge_types", 2.4462047), ("has", 2.2327309)],
    &[("selfloops", 3.3305848), ("has", 2.2327309)],
    &[
        ("disconnected", 2.65511),
        ("nodes", 1.5127645),
        ("has", 1.3958063),
    ...
    &[("connected", 3.4869978), ("is", 3.1974368)],
    &[("node_types", 2.394184), ("has", 2.2327309)],
    &[
        ("has", 1.3958063),
        ("multilabel", 2.9847584),
        ("node_types", 1.4967397),
    ],
    &[
        ("node_types", 1.4967397),
    ...
    &[("multigraph", 4.4725676), ("is", 3.1974368)],
    &[
        ("has", 0.3022186),
        ("outbound", 0.5748818),
        ("degree", 0.37944698),
    ...
    &[
        ("edge_type_name", 0.9921787),
        ("unchecked", 0.5336909),
        ("edge_type_id", 0.8599728),
        ("from", 0.29543355),
        ("get", 0.10204038),
    ],
    &[
    ...
    &[
        ("node_ids", 0.15603833),
        ("unchecked", 0.16278838),
        ("from", 0.09011424),
        ("get", 0.031124735),
        ("weight", 0.30943498),
        ("edge_type_id", 0.26231208),
        ("and", 0.56272995),
        ("edge_id", 0.23545408),
        ("edge", 0.18565488),
    ],
    ...
    &[
        ...
        ("node", 0.34304857),
        ("unchecked", 0.30581668),
        ("comulative", 0.81500673),
    ],
    &[
        ("comulative", 1.0575788),
        ("degree", 0.62095284),
        ("node", 0.44515082),
        ("from", 0.21967608),
        ("get", 0.07587435),
    ...
    &[("add", 5.2326818), ("selfloops", 3.3305848)],
    &[
        ("degree", 1.752488),
        ("get", 0.21413687),
        ("centrality", 1.8622677),
    ],
    &[
        ("degree", 1.1752743),
        ("get", 0.14360699),
        ("centrality", 1.2488959),
        ("weighted", 0.95420134),
    ],
    &[
        ("get", 0.07587435),
        ("node_id", 0.44153768),
        ("centrality", 0.65985066),
        ("closeness", 0.94077563),
        ("from", 0.21967608),
        ("unchecked", 0.39683753),
    ],
    &[
    ...
    &[
        ("betweenness", 2.5425675),
        ("centrality", 1.8622677),
        ("get", 0.21413687),
    ],
    &[
        ("node_id", 0.44153768),
        ("betweenness", 0.90089893),
        ("from", 0.21967608),
        ("approximated", 0.90089893),
        ("get", 0.07587435),
        ("centrality", 0.65985066),
    ],
    &[
    ...
    &[
        ("get", 0.058471393),
        ("betweenness", 0.69426376),
        ("from", 0.16928996),
        ("centrality", 0.5085037),
        ("weighted", 0.38851508),
        ("approximated", 0.69426376),
        ("node_id", 0.34026417),
    ],
    &[
        ("node_name", 0.47186846),
        ("centrality", 0.5085037),
        ("weighted", 0.38851508),
        ("get", 0.058471393),
        ("betweenness", 0.69426376),
    ...
    &[
        ("get", 0.21413687),
        ("eigenvector", 2.9847584),
        ("centrality", 1.8622677),
    ],
    &[
        ("weighted", 0.95420134),
        ("get", 0.14360699),
        ("eigenvector", 2.001674),
        ("centrality", 1.2488959),
    ],
    &[("to", 3.4053867), ("dot", 5.2326818)],
    &[("stars", 5.2326818), ("get", 0.3425332)],
    &[
        ("louvain", 1.5588119),
        ("detection", 1.5588119),
        ("get", 0.10204038),
    ...
    &[
        ("memberships", 0.81500673),
        ("directed", 0.5952404),
        ("get", 0.058471393),
        ("from", 0.16928996),
        ("node", 0.34304857),
        ("community", 0.76348),
        ("modularity", 0.81500673),
    ],
    &[
        ("community", 0.76348),
        ("node", 0.34304857),
    ...
    &[
        ("unchecked", 0.39683753),
        ("preferential", 0.77240306),
        ("attachment", 0.77240306),
        ("weighted", 0.5041496),
        ("minimum", 0.8392658),
        ("get", 0.07587435),
    ],
    ...
    &[
        ...
        ("from", 0.16928996),
        ("node_ids", 0.2931359),
        ("preferential", 0.5952404),
        ("get", 0.058471393),
        ("weighted", 0.38851508),
        ("attachment", 0.5952404),
    ],
    &[
        ("weighted", 0.5041496),
        ("from", 0.21967608),
    ...
    &[
        ...
        ("from", 0.13423793),
        ("unchecked", 0.24249636),
        ("allocation", 0.5302288),
        ("weighted", 0.3080718),
        ("get", 0.046364702),
    ],
    &[
        ("get", 0.07587435),
        ("allocation", 0.8677024),
        ("index", 0.7922914),
        ("node_ids", 0.38038257),
        ("resource", 0.8677024),
        ("from", 0.21967608),
