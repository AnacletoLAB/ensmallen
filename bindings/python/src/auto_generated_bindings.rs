...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("destination", 1.8873718),
        ("get", 0.16866784),
        ("ids", 0.68756),
        ("node", 0.26308316),
    ],
    &[
        ("destination", 1.3634808),
        ("directed", 1.0084752),
        ("get", 0.12184952),
        ("ids", 0.4967092),
        ("node", 0.19005734),
    ...
    &[("connected", 3.9523752), ("holdout", 4.246286)],
    &[("holdout", 4.246286), ("random", 3.544147)],
    &[
        ("get", 0.12184952),
        ("holdout", 1.3634808),
        ("indices", 1.9050381),
