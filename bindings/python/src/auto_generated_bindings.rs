...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    &[("get", 0.35822925), ("circles", 5.688431)],
    &[("encode", 5.688431), ("edge", 1.3038591)],
    &[("decode", 5.688431), ("edge", 1.3038591)],
    &[
        ("max", 1.6523886),
        ("number", 0.7445602),
        ("encodable", 1.8087796),
    ...
    &[("has", 2.403045), ("nodes", 2.539199)],
    &[("has", 2.403045), ("edges", 3.1706908)],
    &[
        ("trap", 2.7556286),
        ("nodes", 1.6361302),
        ("has", 1.5483994),
    ],
    &[("directed", 3.8148663), ("is", 3.5040932)],
    &[
        ("has", 1.5483994),
        ("weights", 2.2578585),
        ("edge", 0.84014016),
    ...
    &[
        ("probabilities", 1.8087796),
        ("representing", 1.8087796),
        ("edge", 0.41459477),
        ("has", 0.7641086),
        ("weights", 1.1142145),
    ],
    ...
    &[("has", 2.403045), ("selfloops", 3.646995)],
    &[
        ("has", 1.5483994),
        ("disconnected", 2.9837627),
        ("nodes", 1.6361302),
    ],
    &[
        ("has", 1.5483994),
    ...
    &[("connected", 3.8148663), ("is", 3.5040932)],
    &[
        ("has", 1.5483994),
        ("types", 1.2508756),
        ("node", 0.3897738),
    ...
    &[("multigraph", 4.872634), ("is", 3.5040932)],
    &[
        ("nodes", 0.3757929),
        ("sorted", 0.72113335),
        ("by", 0.6125327),
        ("decreasing", 0.76907873),
        ("outbound", 0.68532246),
        ("node", 0.0895248),
        ("has", 0.35564253),
        ("degree", 0.45598662),
    ...
    &[
        ...
        ("weights", 0.83712006),
        ("total", 0.871259),
        ("requirements", 1.0216725),
        ("get", 0.08558017),
        ("edge", 0.31148905),
    ],
    &[
        ("edge", 0.19296674),
        ("requirements", 0.6329237),
        ("readable", 0.656728),
        ("human", 0.656728),
        ("get", 0.05301672),
        ("weights", 0.5185939),
    ...
    &[
        ...
        ("id", 0.23446068),
        ("unchecked", 0.28538045),
        ("comulative", 0.76907873),
        ("degree", 0.45598662),
        ("get", 0.05301672),
    ],
    &[
        ("comulative", 0.9641369),
        ("node", 0.20949216),
        ("degree", 0.57163656),
        ("id", 0.29392594),
        ("from", 0.1977124),
    ...
    &[("report", 4.437453), ("textual", 5.196597)],
    &[("tendrils", 5.196597), ("get", 0.35822925)],
    &[
        ("get", 0.11390799),
        ("unchecked", 0.6131484),
        ("attachment", 1.2130326),
        ("minimum", 1.3160447),
        ("preferential", 1.2130326),
    ],
    &[
        ("preferential", 1.2130326),
        ("maximum", 1.2777256),
    ...
    &[
        ("unchecked", 0.46066427),
        ("attachment", 0.91136307),
        ("minimum", 0.988757),
        ("preferential", 0.91136307),
        ("weighted", 0.60085833),
        ("get", 0.08558017),
    ],
    &[
    ...
    &[
        ("node", 0.112230584),
        ("from", 0.1977124),
        ("preferential", 0.70778114),
        ("ids", 0.28733957),
        ("attachment", 0.70778114),
        ("get", 0.06646312),
        ("unchecked", 0.35776025),
    ],
    &[
    ...
    &[
        ("attachment", 0.5645873),
        ("node", 0.0895248),
        ("get", 0.05301672),
        ("from", 0.15771247),
        ("weighted", 0.37223035),
        ("preferential", 0.5645873),
        ("ids", 0.22920683),
        ("unchecked", 0.28538045),
    ],
    &[
    ...
    &[("transitivity", 5.688431), ("get", 0.35822925)],
    &[
        ("per", 1.2414554),
        ("triangles", 1.2414554),
        ("get", 0.08558017),
    ...
    &[
        ("coefficient", 1.3598555),
        ("get", 0.11390799),
        ("node", 0.19234669),
        ("clustering", 1.5493764),
        ("per", 1.6523886),
    ],
    &[
        ("get", 0.23082462),
        ("clustering", 3.1396763),
        ("coefficient", 2.7556286),
    ],
    &[
        ("average", 2.5093203),
        ("clustering", 2.1494503),
        ("get", 0.1580246),
        ("coefficient", 1.8865279),
    ],
    &[
        ("propagation", 1.2414554),
        ("node", 0.14451191),
        ("bm25", 1.2414554),
        ("feature", 1.3589535),
        ("okapi", 1.2414554),
    ...
    &[("to", 3.7272766), ("directed", 3.8148663)],
    &[
        ("upper", 3.6653342),
        ("to", 2.4016666),
        ("triangular", 3.3484216),
    ],
    &[
        ("lower", 3.6653342),
        ("to", 2.4016666),
    ...
    &[("bidiagonal", 5.688431), ("to", 3.7272766)],
    &[("to", 3.7272766), ("arrowhead", 5.688431)],
    &[("to", 3.7272766), ("transposed", 5.688431)],
    &[("complementary", 5.688431), ("to", 3.7272766)],
    &[
        ("arborescence", 2.292359),
        ("kruskal", 2.292359),
        ("spanning", 2.1494503),
        ("random", 1.6087879),
    ],
    &[
        ("kruskal", 3.3484216),
        ("spanning", 3.1396763),
        ("arborescence", 3.3484216),
    ],
    &[
        ("connected", 2.4581048),
        ("components", 2.9837627),
        ("get", 0.23082462),
    ],
    &[
        ("outbound", 1.106255),
        ("sort", 1.106255),
        ("node", 0.14451191),
        ("increasing", 1.2414554),
        ("degree", 0.73605865),
        ("by", 0.988757),
    ],
    &[
        ("decreasing", 1.2414554),
        ("node", 0.14451191),
        ("outbound", 1.106255),
        ("sort", 1.106255),
        ("by", 0.988757),
    ...
    &[
        ...
        ("bfs", 0.9040313),
        ("from", 0.1977124),
        ("topological", 0.9040313),
    ],
    &[
        ("bfs", 0.72113335),
        ("from", 0.15771247),
        ("topological", 0.72113335),
        ("reversed", 0.8418685),
        ("sorting", 0.72113335),
        ("get", 0.05301672),
        ("id", 0.23446068),
    ...
    &[("tendrils", 5.196597), ("drop", 3.8148663)],
    &[
        ("dendritic", 3.3484216),
        ("drop", 2.4581048),
        ("trees", 3.3484216),
    ...
    &[("selfloops", 3.646995), ("drop", 3.8148663)],
    &[
        ("edges", 2.0430312),
        ("drop", 2.4581048),
        ("parallel", 2.859268),
    ...
    &[
        ("get", 0.23082462),
        ("degree", 1.9852784),
        ("centrality", 2.1067169),
    ],
    &[
        ("centrality", 1.4422772),
        ("degree", 1.3591392),
        ("get", 0.1580246),
        ("weighted", 1.1094905),
    ],
    &[
        ...
        ("from", 0.1977124),
        ("node", 0.112230584),
        ("closeness", 0.85913783),
        ("centrality", 0.6066033),
        ("id", 0.29392594),
        ("unchecked", 0.35776025),
    ],
    &[
        ("unchecked", 0.28538045),
        ("closeness", 0.68532246),
        ("get", 0.05301672),
        ("centrality", 0.48387912),
        ("weighted", 0.37223035),
        ("node", 0.0895248),
        ("from", 0.15771247),
        ("id", 0.23446068),
    ...
    &[
        ("get", 0.23082462),
        ("betweenness", 2.859268),
        ("centrality", 2.1067169),
    ],
    &[
        ("betweenness", 0.8232911),
        ("centrality", 0.6066033),
        ("get", 0.06646312),
        ("approximated", 0.70778114),
        ("node", 0.112230584),
        ("id", 0.29392594),
        ("from", 0.1977124),
    ],
    ...
    &[
        ("get", 0.05301672),
        ("approximated", 0.5645873),
        ("betweenness", 0.656728),
        ("node", 0.0895248),
        ("centrality", 0.48387912),
        ("from", 0.15771247),
        ("weighted", 0.37223035),
    ...
    &[
        ("get", 0.23082462),
        ("eigenvector", 3.3484216),
        ("centrality", 2.1067169),
    ],
    &[
        ("get", 0.1580246),
        ("weighted", 1.1094905),
        ("eigenvector", 2.292359),
        ("centrality", 1.4422772),
    ],
    &[
        ("transformed", 2.0427105),
        ("graph", 1.5174245),
        ("laplacian", 2.0427105),
        ("get", 0.1580246),
    ],
    ...
    &[
        ("transformed", 0.85913783),
        ("random", 0.6766356),
        ("laplacian", 0.85913783),
        ("normalized", 0.9040313),
        ("walk", 0.9641369),
        ("graph", 0.6382093),
        ("get", 0.06646312),
    ],
    &[
        ("normalized", 1.1640614),
        ("symmetric", 1.2414554),
        ("get", 0.08558017),
        ("laplacian", 1.106255),
        ("graph", 0.82177997),
        ("transformed", 1.106255),
    ],
    &[
        ("symmetric", 1.6523886),
        ("get", 0.11390799),
        ("graph", 1.0937967),
        ("transformed", 1.4724357),
        ("normalized", 1.5493764),
    ],
    &[
        ("features", 1.3589535),
        ("node", 0.14451191),
    ...
    &[
        ("set", 1.8865279),
        ("vertex", 2.5093203),
        ("approximated", 1.6828405),
        ("cover", 2.5093203),
    ],
    &[("to", 3.7272766), ("dot", 5.688431)],
    &[
        ("tuples", 3.6653342),
        ("node", 0.3897738),
        ("get", 0.23082462),
    ...
    &[("components", 4.630663), ("remove", 3.1248333)],
    &[
        ("connected", 0.91136307),
        ("from", 0.2545812),
        ("node", 0.14451191),
        ("id", 0.37846902),
        ("is", 0.83712006),
    ...
    &[
        ("unchecked", 0.28538045),
        ("selfloops", 0.53974295),
        ("node", 0.0895248),
        ("singleton", 0.40804124),
        ("id", 0.23446068),
        ("is", 0.5185939),
        ("with", 0.46246475),
        ("from", 0.15771247),
    ...
    &[("name", 1.5087863), ("has", 1.5483994), ("node", 0.3897738)],
    &[
        ("type", 0.758706),
        ("id", 0.6988466),
        ("has", 1.060048),
    ...
    &[("get", 0.35822925), ("density", 5.688431)],
    &[
        ("get", 0.1580246),
        ("rate", 1.8865279),
        ("trap", 1.8865279),
    ...
    &[
        ...
        ("ids", 0.4924577),
        ("node", 0.19234669),
        ("destination", 1.3160447),
    ],
    &[
        ("destination", 2.6668499),
        ("names", 1.2945832),
        ("get", 0.23082462),
    ],
    &[
    ...
    &[
        ("get", 0.23082462),
        ("node", 0.3897738),
        ("ontologies", 3.6653342),
    ],
    &[("ids", 0.9979226), ("node", 0.3897738), ("get", 0.23082462)],
    &[
        ("type", 0.758706),
        ("ids", 0.68318665),
        ("edge", 0.5751674),
    ...
    &[("from", 1.0656492), ("csv", 5.688431)],
    &[("chains", 5.688431), ("get", 0.35822925)],
    &[
        ("approximated", 2.4581048),
        ("cliques", 3.3484216),
        ("get", 0.23082462),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.06646312),
        ("directed", 0.70778114),
        ("memberships", 0.9641369),
        ("community", 0.9040313),
        ("from", 0.1977124),
        ("modularity", 0.9641369),
    ],
    &[
        ("undirected", 0.8232911),
        ("memberships", 0.9641369),
        ("from", 0.1977124),
        ("node", 0.112230584),
        ("modularity", 0.9641369),
    ...
    &[("is", 3.5040932), ("compatible", 5.688431)],
    &[
        ("same", 2.5093203),
        ("has", 1.060048),
        ("matrix", 1.8865279),
    ...
    &[("enable", 9.309148)],
    &[("disable", 5.688431), ("all", 4.018319)],
    &[("negatives", 5.688431), ("sample", 5.688431)],
    &[("holdout", 4.018319), ("connected", 3.8148663)],
    &[("holdout", 4.018319), ("random", 3.646995)],
    &[
        ("label", 1.2436736),
        ("holdout", 1.2777256),
        ("get", 0.11390799),
    ...
    &[
        ("be", 2.9837627),
        ("multigraph", 3.1396763),
        ("must", 2.4016666),
    ],
    &[
        ("multigraph", 2.1494503),
        ("must", 1.6442024),
        ("not", 1.8865279),
        ("be", 2.0427105),
    ],
    ...
    &[("selfloops", 3.646995), ("add", 5.688431)],
    &[("name", 2.3415673), ("set", 4.2766094)],
    &[
        ("all", 1.2777256),
        ("types", 0.61728567),
        ("inplace", 1.0937967),
    ...
    &[
        ...
        ("first", 0.39190745),
        ("node", 0.060612448),
        ("predecessors", 0.56998414),
    ],
    &[
        ("get", 0.03589478),
        ("distances", 0.48824078),
        ("ids", 0.15518367),
        ("search", 0.39190745),
        ("unchecked", 0.19321583),
        ("parallel", 0.4446354),
    ...
    &[("diameter", 4.872634), ("get", 0.35822925)],
    &[
        ("diameter", 2.1494503),
        ("naive", 2.292359),
        ("get", 0.1580246),
