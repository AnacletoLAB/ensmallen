...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("graph", 0.577987),
        ("laplacian", 0.8998167),
        ("normalized", 0.94543284),
        ("random", 0.64321697),
        ("transformed", 0.8998167),
        ("walk", 1.006506),
    ],
    &[
        ("get", 0.09587129),
        ("graph", 0.7435894),
        ("laplacian", 1.1576284),
        ("normalized", 1.2163143),
        ("symmetric", 1.2948858),
        ("transformed", 1.1576284),
    ],
    &[
        ("get", 0.1274588),
        ("graph", 0.988586),
        ("normalized", 1.6170635),
        ("symmetric", 1.7215226),
        ("transformed", 1.5390419),
    ],
    &[
        ("connected", 0.93852776),
        ("from", 0.24359141),
        ("id", 0.3860848),
        ("is", 0.8688249),
        ("node", 0.13663794),
        ("unchecked", 0.48704624),
    ],
    &[
        ("connected", 1.2477523),
        ("from", 0.3238495),
    ...
    &[
        ("disconnected", 0.8998167),
        ("from", 0.18934195),
        ("id", 0.30010107),
        ("is", 0.6753317),
        ("node", 0.19803716),
        ("unchecked", 0.37857774),
    ],
    &[
        ("from", 0.24359141),
        ("id", 0.3860848),
    ...
    &[
        ...
        ("is", 0.53906614),
        ("node", 0.08477759),
        ("selfloops", 0.57023275),
        ("singleton", 0.43632075),
        ("unchecked", 0.30218992),
        ("with", 0.47877043),
    ],
    &[
        ("from", 0.18934195),
    ...
    &[("has", 1.488784), ("name", 1.4579551), ("node", 0.366719)],
    &[
        ("has", 1.0214986),
        ("id", 0.7109693),
        ("node", 0.25161672),
    ...
    &[("components", 4.8065877), ("remove", 2.750822)],
    &[("overlaps", 9.56951)],
    &[("contains", 8.76232)],
    &[
        ("bipartite", 2.8764658),
    ...
    &[("edge", 1.221877), ("encode", 5.8717804)],
    &[("decode", 5.8717804), ("edge", 1.221877)],
    &[
        ("edge", 0.39123803),
        ("encodable", 1.8801105),
        ("get", 0.1274588),
    ...
    &[
        ("be", 3.1069288),
        ("multigraph", 3.2644343),
        ("must", 2.4183993),
    ],
    &[
        ("be", 2.1317554),
        ("multigraph", 2.2398245),
        ("must", 1.6593349),
        ("not", 1.9736279),
    ],
    &[
    ...
    &[("have", 3.1069288), ("must", 2.4183993), ("nodes", 1.67084)],
    &[
        ("be", 3.1069288),
        ("connected", 2.5188901),
        ("must", 2.4183993),
    ...
    &[
        ("inplace", 1.000528),
        ("isomorphic", 1.0682857),
        ("node", 0.18165717),
        ("remove", 0.8807975),
        ("types", 0.6285814),
    ],
    &[
        ("isomorphic", 1.4797024),
        ("node", 0.25161672),
        ("remove", 1.220009),
        ("types", 0.8706597),
    ],
    ...
    &[("circles", 5.8717804), ("get", 0.39806706)],
    &[
        ("get", 0.25730646),
        ("memory", 2.4666328),
        ("stats", 3.7954583),
    ...
    &[("get", 0.39806706), ("transitivity", 5.8717804)],
    &[
        ("get", 0.09587129),
        ("node", 0.13663794),
        ("number", 0.5930118),
    ...
    &[
        ("clustering", 1.6170635),
        ("coefficient", 1.380454),
        ("get", 0.1274588),
        ("node", 0.18165717),
        ("per", 1.7215226),
    ],
    &[
        ("clustering", 3.2644343),
        ("coefficient", 2.7867808),
        ("get", 0.25730646),
    ],
    &[
        ("average", 2.6041758),
        ("clustering", 2.2398245),
        ("coefficient", 1.9120923),
        ("get", 0.17654555),
    ],
    &[
        ("are", 3.7954583),
        ("nodes", 1.67084),
        ("remappable", 3.7954583),
    ],
    &[
        ("from", 0.3238495),
        ("ids", 0.50087154),
    ...
    &[("connected", 3.89686), ("holdout", 4.1899457)],
    &[("holdout", 4.1899457), ("random", 3.4358985)],
    &[
        ("get", 0.1274588),
        ("holdout", 1.3415966),
        ("indices", 1.8801105),
    ...
    &[("chains", 5.8717804), ("get", 0.39806706)],
    &[
        ("breadth", 0.41339645),
        ("first", 0.41339645),
        ("from", 0.102426514),
    ...
    &[
        ("and", 0.30297223),
        ("distant", 0.45926332),
        ("eccentricity", 0.38012582),
        ("from", 0.086395726),
        ("get", 0.034003127),
        ("id", 0.26508704),
        ("most", 0.4105816),
        ("node", 0.093816034),
        ("unchecked", 0.17274301),
    ],
    &[
        ("eccentricity", 0.8330709),
        ("from", 0.18934195),
        ("get", 0.0745201),
        ("id", 0.30010107),
        ("node", 0.106207736),
    ...
    &[("diameter", 5.376494), ("get", 0.39806706)],
    &[
        ("breadth", 0.7641897),
        ("first", 0.7641897),
        ("from", 0.18934195),
    ...
    &[("density", 5.8717804), ("get", 0.39806706)],
    &[
        ("get", 0.17654555),
        ("nodes", 1.1464125),
        ("rate", 1.9736279),
    ...
    &[
        ...
        ("get", 0.17654555),
        ("number", 1.0920223),
        ("undirected", 2.0454638),
    ],
    &[
        ("edges", 1.0258852),
        ("get", 0.1274588),
        ("number", 0.78839636),
        ("undirected", 1.4767429),
        ("unique", 1.2477523),
    ],
    &[
        ("edges", 2.070998),
    ...
    &[
        ("destination", 1.8582703),
        ("get", 0.17654555),
        ("ids", 0.6937664),
        ("node", 0.25161672),
    ],
    &[
        ("destination", 1.3415966),
        ("directed", 1.0129479),
        ("get", 0.1274588),
        ("ids", 0.50087154),
        ("node", 0.18165717),
    ...
    &[("get", 0.25730646), ("node", 0.366719), ("urls", 3.7954583)],
    &[
        ("get", 0.25730646),
        ("node", 0.366719),
        ("ontologies", 2.981163),
    ...
    &[("get", 0.25730646), ("ids", 1.0111306), ("node", 0.366719)],
    &[
        ("edge", 0.54191107),
        ("get", 0.17654555),
        ("ids", 0.6937664),
    ...
    &[("directed", 3.1635413), ("to", 3.89686)],
    &[
        ("to", 2.5188901),
        ("triangular", 3.4753103),
        ("upper", 3.7954583),
    ],
    &[
        ("lower", 3.7954583),
    ...
    &[("bidiagonal", 5.8717804), ("to", 3.89686)],
    &[("arrowhead", 5.8717804), ("to", 3.89686)],
    &[("to", 3.89686), ("transposed", 5.8717804)],
    &[("complementary", 5.8717804), ("to", 3.89686)],
    &[
        ("approximated", 2.5759048),
        ("cliques", 3.4753103),
        ("get", 0.25730646),
    ],
    &[
    ...
    &[("report", 4.612021), ("textual", 5.376494)],
    &[
        ("connected", 1.7282848),
        ("generate", 1.7282848),
        ("graph", 1.3693088),
    ...
    &[("remove", 2.750822), ("tendrils", 5.376494)],
    &[
        ("dendritic", 3.4753103),
        ("remove", 1.7781031),
        ("trees", 3.4753103),
    ...
    &[
        ("disconnected", 3.1069288),
        ("nodes", 1.67084),
        ("remove", 1.7781031),
    ],
    &[("remove", 2.750822), ("selfloops", 3.8160148)],
    &[
        ("edges", 2.070998),
        ("parallel", 2.981163),
        ("remove", 1.7781031),
    ...
    &[
        ("arborescence", 2.3845127),
        ("kruskal", 2.3845127),
        ("random", 1.5238451),
        ("spanning", 2.2398245),
    ],
    &[
        ("arborescence", 3.4753103),
        ("kruskal", 3.4753103),
        ("spanning", 3.2644343),
    ],
    &[
    ...
    &[("enable", 9.56951)],
    &[("all", 4.0821033), ("disable", 5.8717804)],
    &[
        ("compatible", 2.1317554),
        ("has", 1.0214986),
        ("node", 0.25161672),
        ("vocabularies", 2.2398245),
    ],
    &[
        ("compatible", 1.5390419),
        ("has", 0.737481),
        ("node", 0.18165717),
        ("types", 0.6285814),
        ("vocabularies", 1.6170635),
    ],
    &[
        ("compatible", 1.5390419),
        ("edge", 0.39123803),
    ...
    &[("compatible", 4.8065877), ("is", 3.607447)],
    &[
        ("adjacency", 2.2398245),
        ("has", 1.0214986),
        ("matrix", 1.9736279),
    ...
    &[("has", 2.3032296), ("nodes", 2.58488)],
    &[("edges", 3.203946), ("has", 2.3032296)],
    &[("has", 1.488784), ("nodes", 1.67084), ("trap", 2.8764658)],
    &[("directed", 3.1635413), ("is", 3.607447)],
    &[
        ("edge", 0.78980875),
        ("has", 1.488784),
        ("weights", 2.2926335),
    ...
    &[
        ("edge", 0.39123803),
        ("has", 0.737481),
        ("probabilities", 1.8801105),
        ("representing", 1.8801105),
        ("weights", 1.1356742),
    ],
    &[
        ("has", 1.0214986),
    ...
    &[("has", 2.3032296), ("selfloops", 3.8160148)],
    &[
        ("disconnected", 3.1069288),
        ("has", 1.488784),
        ("nodes", 1.67084),
    ...
    &[("connected", 3.89686), ("is", 3.607447)],
    &[("has", 1.488784), ("node", 0.366719), ("types", 1.2689438)],
    &[
        ("has", 1.0214986),
        ("multilabel", 2.3845127),
        ("node", 0.25161672),
    ...
    &[("is", 3.607447), ("multigraph", 5.050257)],
    &[
        ("has", 1.488784),
        ("node", 0.366719),
        ("ontologies", 2.981163),
    ...
    &[("get", 0.39806706), ("tendrils", 5.376494)],
    &[
        ("degree", 0.78179944),
        ("distribution", 1.4141716),
        ("geometric", 1.4141716),
        ("get", 0.09587129),
        ("node", 0.13663794),
        ("threshold", 1.4141716),
    ...
    &[("add", 4.311301), ("selfloops", 3.8160148)],
    &[
        ("centrality", 2.2209294),
        ("degree", 2.098251),
        ("get", 0.25730646),
    ],
    &[
        ("centrality", 1.5238451),
        ("degree", 1.4396719),
        ("get", 0.17654555),
        ("weighted", 1.1976655),
    ],
    &[
        ("centrality", 0.64321697),
        ("closeness", 0.8998167),
        ("from", 0.18934195),
        ("get", 0.0745201),
        ("id", 0.30010107),
    ...
    &[
        ("betweenness", 2.981163),
        ("centrality", 2.2209294),
        ("get", 0.25730646),
    ],
    &[
        ("approximated", 0.74602354),
        ("betweenness", 0.8633929),
        ("centrality", 0.64321697),
        ("from", 0.18934195),
        ("get", 0.0745201),
        ("id", 0.30010107),
    ...
    &[
        ("approximated", 0.5954941),
        ("betweenness", 0.68918115),
        ("centrality", 0.51343143),
        ("from", 0.15113734),
        ("get", 0.05948375),
        ("id", 0.23954797),
    ...
    &[
        ("centrality", 2.2209294),
        ("eigenvector", 3.4753103),
        ("get", 0.25730646),
    ],
    &[
        ("centrality", 1.5238451),
        ("eigenvector", 2.3845127),
        ("get", 0.17654555),
        ("weighted", 1.1976655),
    ],
    &[("dot", 5.8717804), ("to", 3.89686)],
    &[("get", 0.39806706), ("stars", 5.8717804)],
    &[
        ("community", 1.6170635),
        ("detection", 1.8801105),
        ("get", 0.1274588),
    ...
    &[
        ("community", 0.94543284),
        ("directed", 0.5922304),
        ("from", 0.18934195),
        ("get", 0.0745201),
        ("memberships", 1.006506),
        ("modularity", 1.006506),
        ("node", 0.106207736),
    ],
    &[
        ...
        ("modularity", 1.006506),
        ("node", 0.106207736),
        ("undirected", 0.8633929),
    ],
    &[
        ("attachment", 1.2477523),
        ("get", 0.1274588),
        ("minimum", 1.380454),
        ("preferential", 1.2477523),
        ("unchecked", 0.64751744),
    ],
    &[
        ("attachment", 1.2477523),
    ...
    &[
        ("attachment", 0.93852776),
        ("get", 0.09587129),
        ("minimum", 1.0383426),
        ("preferential", 0.93852776),
        ("unchecked", 0.48704624),
        ("weighted", 0.65038025),
    ],
    &[
    ...
    &[
        ("attachment", 0.7295112),
        ("from", 0.18934195),
        ("get", 0.0745201),
        ("ids", 0.2928397),
        ("node", 0.106207736),
        ("preferential", 0.7295112),
        ("unchecked", 0.37857774),
    ],
    &[
        ("attachment", 0.93852776),
    ...
    &[
        ("attachment", 0.58231354),
        ("from", 0.15113734),
        ("get", 0.05948375),
        ("ids", 0.23375176),
        ("node", 0.08477759),
        ("preferential", 0.58231354),
        ("unchecked", 0.30218992),
        ("weighted", 0.4035312),
    ],
    &[
    ...
    &[
        ("attachment", 1.7282848),
        ("get", 0.17654555),
        ("preferential", 1.7282848),
        ("scores", 2.1317554),
    ],
    &[
        ("allocation", 1.380454),
