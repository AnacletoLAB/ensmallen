...
impl EnsmallenGraph {
    ...
    pub fn remap(&self, other: &EnsmallenGraph, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.remap(&other.graph, verbose))?})
    }
...
Ok(())
    ...
    pub fn set_all_edge_types(&self, edge_type: String, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.set_all_edge_types(edge_type, verbose))?})
    }
...
Ok(())
    ...
    pub fn set_all_node_types(&self, node_type: String) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.set_all_node_types(node_type))?})
    }
    ...
    pub fn remove_inplace_node_type_ids(& mut self, node_type_ids_to_remove: Vec<NodeTypeT>) -> PyResult<()> {
        pe!(self.graph.remove_inplace_node_type_ids(node_type_ids_to_remove))?;
Ok(())
    }
...
Ok(())
    ...
    pub fn remove_inplace_edge_type_ids(& mut self, edge_type_ids_to_remove: Vec<EdgeTypeT>) -> PyResult<()> {
        pe!(self.graph.remove_inplace_edge_type_ids(edge_type_ids_to_remove))?;
Ok(())
    }
...
Ok(())
    ...
    pub fn remove_node_type_id(&self, node_type_id: NodeTypeT) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.remove_node_type_id(node_type_id))?})
    }
    ...
    pub fn remove_node_type_name(&self, node_type_name: &str) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.remove_node_type_name(node_type_name))?})
    }
...
Ok(())
    ...
    pub fn remove_edge_type_id(&self, edge_type_id: EdgeTypeT) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.remove_edge_type_id(edge_type_id))?})
    }
    ...
    pub fn remove_edge_type_name(&self, edge_type_name: &str) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.remove_edge_type_name(edge_type_name))?})
    }
...
Ok(())
    ...
    pub fn remove_node_types(&self) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.remove_node_types())?})
    }
...
Ok(())
    ...
    pub fn remove_edge_types(&self, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.remove_edge_types(verbose))?})
    }
...
Ok(())
    ...
    pub fn remove_edge_weights(&self) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.remove_edge_weights())?})
    }
    ...
    /// 
    pub fn add_selfloops(&self, edge_type_name: Option<&str>, weight: Option<WeightT>, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.add_selfloops(edge_type_name, weight, verbose))?})
    }
...
to_ndarray_1d!(gil, self.graph.get_singleton_node_ids(), NodeT)
    ...
    pub fn get_singleton_with_selfloops_node_ids(&self) -> Py<PyArray1<NodeT>> {
        let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.graph.get_singleton_with_selfloops_node_ids(), NodeT)
    }
    ...
    pub fn get_weighted_max_node_degree(&self) -> PyResult<f64> {
        pe!(self.graph.get_weighted_max_node_degree())
    }
    ...
    pub fn get_weighted_min_node_degree(&self) -> PyResult<f64> {
        pe!(self.graph.get_weighted_min_node_degree())
    }
...
to_ndarray_1d!(gil, self.graph.get_node_ids(), NodeT)
    ...
    pub fn get_unique_edge_type_ids(&self) -> PyResult<Py<PyArray1<EdgeTypeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_unique_edge_type_ids())?, EdgeTypeT))
    }
...
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_edge_weights())?, WeightT))
    ...
    ///     If the graph does not contain edge weights.
    /// 
    pub fn get_min_edge_weight(&self) -> PyResult<WeightT> {
    ...
    ///     If the graph does not contain edge weights.
    /// 
    pub fn get_max_edge_weight(&self) -> PyResult<WeightT> {
    ...
    pub fn get_one_hot_encoded_node_types(&self) -> PyResult<Py<PyArray2<bool>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_2d!(gil, pe!(self.graph.get_one_hot_encoded_node_types())?, bool))
    }
    ...
    pub fn get_one_hot_encoded_known_node_types(&self) -> PyResult<Py<PyArray2<bool>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_2d!(gil, pe!(self.graph.get_one_hot_encoded_known_node_types())?, bool))
    }
    ...
    pub fn get_one_hot_encoded_edge_types(&self) -> PyResult<Py<PyArray2<bool>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_2d!(gil, pe!(self.graph.get_one_hot_encoded_edge_types())?, bool))
    }
    ...
    pub fn get_one_hot_encoded_known_edge_types(&self) -> PyResult<Py<PyArray2<bool>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_2d!(gil, pe!(self.graph.get_one_hot_encoded_known_edge_types())?, bool))
    }
    ...
    pub fn get_unique_node_type_ids(&self) -> PyResult<Py<PyArray1<NodeTypeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_unique_node_type_ids())?, NodeTypeT))
    }
...
to_ndarray_2d!(gil, self.graph.get_edge_node_ids(directed), NodeT)
    ...
    pub fn get_singleton_node_type_ids(&self) -> PyResult<Py<PyArray1<NodeTypeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_singleton_node_type_ids())?, NodeTypeT))
    }
    ...
    pub fn get_edge_ids_with_unknown_edge_types(&self) -> PyResult<Py<PyArray1<EdgeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_edge_ids_with_unknown_edge_types())?, EdgeT))
    }
    ...
    pub fn get_edge_ids_with_known_edge_types(&self) -> PyResult<Py<PyArray1<EdgeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_edge_ids_with_known_edge_types())?, EdgeT))
    }
    ...
    pub fn get_edge_ids_with_unknown_edge_types_mask(&self) -> PyResult<Py<PyArray1<bool>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_edge_ids_with_unknown_edge_types_mask())?, bool))
    }
    ...
    pub fn get_edge_ids_with_known_edge_types_mask(&self) -> PyResult<Py<PyArray1<bool>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_edge_ids_with_known_edge_types_mask())?, bool))
    }
    ...
    pub fn get_node_ids_with_unknown_node_types(&self) -> PyResult<Py<PyArray1<NodeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_node_ids_with_unknown_node_types())?, NodeT))
    }
...
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_node_ids_with_known_node_types())?, NodeT))
    ...
    pub fn get_node_ids_with_unknown_node_types_mask(&self) -> PyResult<Py<PyArray1<bool>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_node_ids_with_unknown_node_types_mask())?, bool))
    }
    ...
    pub fn get_node_ids_with_known_node_types_mask(&self) -> PyResult<Py<PyArray1<bool>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_node_ids_with_known_node_types_mask())?, bool))
    }
    ...
    pub fn get_singleton_edge_type_ids(&self) -> PyResult<Py<PyArray1<EdgeTypeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_singleton_edge_type_ids())?, EdgeTypeT))
    }
    ...
    pub fn get_node_connected_component_ids(&self, verbose: Option<bool>) -> Py<PyArray1<NodeT>> {
        let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.graph.get_node_connected_component_ids(verbose), NodeT)
    }
...
to_ndarray_1d!(gil, self.graph.get_unweighted_node_degrees(), NodeT)
    ...
    pub fn get_weighted_node_degrees(&self) -> PyResult<Py<PyArray1<f64>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_weighted_node_degrees())?, f64))
    }
...
to_ndarray_1d!(gil, self.graph.get_cumulative_node_degrees(), EdgeT)
    ...
    pub fn has_node_name_and_node_type_name(&self, node_name: &str, node_type_name: Option<Vec<String>>) -> bool {
        self.graph.has_node_name_and_node_type_name(node_name, node_type_name)
    }
    ...
    /// 
    pub fn replace(&self, node_name_mapping: Option<HashMap<String, String>>, node_type_name_mapping: Option<HashMap<String, String>>, node_type_names_mapping: Option<HashMap<Option<Vec<String>>, Option<Vec<String>>>>, edge_type_name_mapping: Option<HashMap<Option<String>, Option<String>>>, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
    ...
    ///     Whether to show a loading bar.
    /// 
    pub fn replace_unknown_node_types_with_node_type_name(&self, node_type_names: Vec<String>, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
    ...
    ///     Whether to show a loading bar.
    /// 
    pub fn replace_unknown_edge_types_with_edge_type_name(&self, edge_type_name: String, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
    ...
    ///     Whether to show the loading bar.
    /// 
    pub fn remove_components(&self, node_names: Option<Vec<String>>, node_types: Option<Vec<Option<String>>>, edge_types: Option<Vec<Option<String>>>, minimum_component_size: Option<NodeT>, top_k_components: Option<NodeT>, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.remove_components(node_names, node_types, edge_types, minimum_component_size, top_k_components, verbose))?})
    }
    ...
    ///     Whether to show a loading bar or not.
    /// 
    pub fn random_spanning_arborescence_kruskal(&self, random_state: Option<EdgeT>, undesired_edge_types: Option<HashSet<Option<EdgeTypeT>>>, verbose: Option<bool>) -> (HashSet<(NodeT, NodeT)>, Vec<NodeT>, NodeT, NodeT, NodeT) {
    ...
    ///     Whether to show a loading bar or not.
    /// 
    pub fn spanning_arborescence_kruskal(&self, verbose: Option<bool>) -> (HashSet<(NodeT, NodeT)>, Vec<NodeT>, NodeT, NodeT, NodeT) {
    ...
    /// 
    pub fn connected_components(&self, verbose: Option<bool>) -> PyResult<(Vec<NodeT>, NodeT, NodeT, NodeT)> {
    ...
    pub fn validate_node_ids(&self, node_ids: Vec<NodeT>) -> PyResult<Py<PyArray1<NodeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.validate_node_ids(node_ids))?, NodeT))
    }
    ...
    pub fn validate_edge_ids(&self, edge_ids: Vec<EdgeT>) -> PyResult<Py<PyArray1<EdgeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.validate_edge_ids(edge_ids))?, EdgeT))
    }
    ...
    /// 
    pub fn overlap_textual_report(&self, other: &EnsmallenGraph, verbose: Option<bool>) -> PyResult<String> {
    ...
    /// 
    pub fn textual_report(&self, verbose: Option<bool>) -> PyResult<String> {
...
to_ndarray_2d!(gil, self.graph.get_dense_binary_adjacency_matrix(), bool)
    ...
    ///     If the graph does not have edge weights.
    /// 
    pub fn get_dense_weighted_adjacency_matrix(&self, weight: Option<WeightT>) -> PyResult<Py<PyArray2<WeightT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_2d!(gil, pe!(self.graph.get_dense_weighted_adjacency_matrix(weight))?, WeightT))
    }
    ...
    /// 
    pub fn generate_new_edges_from_node_features(&self, features: Vec<Vec<f64>>, neighbours_number: Option<NodeT>, max_degree: Option<NodeT>, distance_name: Option<&str>, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.generate_new_edges_from_node_features(features, neighbours_number, max_degree, distance_name, verbose))?})
    }
    ...
    /// 
    pub fn get_top_k_central_node_ids(&self, k: NodeT) -> Py<PyArray1<NodeT>> {
        let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.graph.get_top_k_central_node_ids(k), NodeT)
    }
    ...
    pub unsafe fn get_unchecked_unweighted_node_degree_from_node_id(&self, node_id: NodeT) -> NodeT {
        self.graph.get_unchecked_unweighted_node_degree_from_node_id(node_id)
    }
    ...
    pub unsafe fn get_unchecked_weighted_node_degree_from_node_id(&self, node_id: NodeT) -> f64 {
        self.graph.get_unchecked_weighted_node_degree_from_node_id(node_id)
    }
    ...
    pub unsafe fn get_unchecked_node_type_id_from_node_id(&self, node_id: NodeT) -> Option<Vec<NodeTypeT>> {
    ...
    ///     node whose node type is to be returned.
    /// 
    pub fn get_node_type_id_from_node_id(&self, node_id: NodeT) -> PyResult<Option<Vec<NodeTypeT>>> {
    ...
    pub unsafe fn get_unchecked_node_type_names_from_node_id(&self, node_id: NodeT) -> Option<Vec<String>> {
        self.graph.get_unchecked_node_type_names_from_node_id(node_id)
    }
    ...
    pub fn get_node_ids_from_node_names(&self, node_names: Vec<&str>) -> PyResult<Py<PyArray1<NodeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_node_ids_from_node_names(node_names))?, NodeT))
    }
    ...
    ///     When any of the given node name does not exists in the current graph.
    /// 
    pub fn get_edge_node_ids_from_edge_node_names(&self, edge_node_names: Vec<(&str, &str)>) -> PyResult<Vec<(NodeT, NodeT)>> {
    ...
    ///     Name of the node.
    /// 
    pub fn get_node_type_id_from_node_name(&self, node_name: &str) -> PyResult<Option<Vec<NodeTypeT>>> {
    ...
    pub fn get_neighbour_node_ids_from_node_id(&self, node_id: NodeT) -> PyResult<Py<PyArray1<NodeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_neighbour_node_ids_from_node_id(node_id))?, NodeT))
    }
    ...
    pub fn get_neighbour_node_ids_from_node_name(&self, node_name: &str) -> PyResult<Py<PyArray1<NodeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_neighbour_node_ids_from_node_name(node_name))?, NodeT))
    }
    ...
    pub unsafe fn get_unchecked_node_type_names_from_node_type_ids(&self, node_type_ids: Vec<NodeTypeT>) -> Vec<String> {
        self.graph.get_unchecked_node_type_names_from_node_type_ids(node_type_ids)
    }
    ...
    pub fn get_unweighted_degree_centrality(&self) -> PyResult<Py<PyArray1<f64>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_unweighted_degree_centrality())?, f64))
    }
    ...
    pub fn get_weighted_degree_centrality(&self) -> PyResult<Py<PyArray1<f64>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_weighted_degree_centrality())?, f64))
    }
    ...
    pub unsafe fn get_unchecked_unweighted_closeness_centrality_from_node_id(&self, node_id: NodeT) -> f64 {
        self.graph.get_unchecked_unweighted_closeness_centrality_from_node_id(node_id)
    }
    ...
    /// ------
    /// If the given node ID does not exist in the graph the method will panic.
    pub unsafe fn get_unchecked_weighted_closeness_centrality_from_node_id(&self, node_id: NodeT, use_edge_weights_as_probabilities: bool) -> f64 {
        self.graph.get_unchecked_weighted_closeness_centrality_from_node_id(node_id, use_edge_weights_as_probabilities)
    }
    ...
    pub fn get_unweighted_closeness_centrality(&self, verbose: Option<bool>) -> Py<PyArray1<f64>> {
        let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.graph.get_unweighted_closeness_centrality(verbose), f64)
    }
    ...
    /// 
    pub fn get_weighted_closeness_centrality(&self, use_edge_weights_as_probabilities: Option<bool>, verbose: Option<bool>) -> PyResult<Py<PyArray1<f64>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_weighted_closeness_centrality(use_edge_weights_as_probabilities, verbose))?, f64))
    }
    ...
    pub unsafe fn get_unchecked_unweighted_harmonic_centrality_from_node_id(&self, node_id: NodeT) -> f64 {
        self.graph.get_unchecked_unweighted_harmonic_centrality_from_node_id(node_id)
    }
    ...
    /// ------
    /// If the given node ID does not exist in the graph the method will panic.
    pub unsafe fn get_unchecked_weighted_harmonic_centrality_from_node_id(&self, node_id: NodeT, use_edge_weights_as_probabilities: bool) -> f64 {
        self.graph.get_unchecked_weighted_harmonic_centrality_from_node_id(node_id, use_edge_weights_as_probabilities)
    }
    ...
    pub fn get_unweighted_harmonic_centrality(&self, verbose: Option<bool>) -> Py<PyArray1<f64>> {
        let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.graph.get_unweighted_harmonic_centrality(verbose), f64)
    }
    ...
    ///     Whether to show an indicative progress bar.
    /// 
    pub fn get_weighted_harmonic_centrality(&self, use_edge_weights_as_probabilities: Option<bool>, verbose: Option<bool>) -> PyResult<Py<PyArray1<f64>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_weighted_harmonic_centrality(use_edge_weights_as_probabilities, verbose))?, f64))
    }
    ...
    /// 
    pub fn get_stress_centrality(&self, normalize: Option<bool>, verbose: Option<bool>) -> Py<PyArray1<f64>> {
        let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.graph.get_stress_centrality(normalize, verbose), f64)
    }
    ...
    ///     Whether to show a loading bar. By default, it is true.
    /// 
    pub fn get_betweenness_centrality(&self, normalize: Option<bool>, verbose: Option<bool>) -> Py<PyArray1<f64>> {
        let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.graph.get_betweenness_centrality(normalize, verbose), f64)
    }
    ...
    /// 
    pub fn get_unweighted_eigenvector_centrality(&self, maximum_iterations_number: Option<usize>, tollerance: Option<f64>) -> PyResult<Py<PyArray1<f64>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_unweighted_eigenvector_centrality(maximum_iterations_number, tollerance))?, f64))
    }
    ...
    ///     The maximum error tollerance for convergence.
    /// 
    pub fn get_weighted_eigenvector_centrality(&self, maximum_iterations_number: Option<usize>, tollerance: Option<f64>) -> PyResult<Py<PyArray1<f64>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_weighted_eigenvector_centrality(maximum_iterations_number, tollerance))?, f64))
    }
    ...
    /// 
    pub unsafe fn get_unchecked_unweighted_minimum_path_node_ids_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, maximal_depth: Option<NodeT>) -> PyResult<Py<PyArray1<NodeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_unchecked_unweighted_minimum_path_node_ids_from_node_ids(src_node_id, dst_node_id, maximal_depth))?, NodeT))
    }
    ...
    /// ------
    /// If any of the given node IDs does not exist in the graph the method will panic.
    pub unsafe fn get_unchecked_unweighted_minimum_path_node_names_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, maximal_depth: Option<NodeT>) -> PyResult<Vec<String>> {
        pe!(self.graph.get_unchecked_unweighted_minimum_path_node_names_from_node_ids(src_node_id, dst_node_id, maximal_depth))
    }
    ...
    /// 
    pub fn get_unweighted_minimum_path_node_ids_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, maximal_depth: Option<NodeT>) -> PyResult<Py<PyArray1<NodeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_unweighted_minimum_path_node_ids_from_node_ids(src_node_id, dst_node_id, maximal_depth))?, NodeT))
    }
    ...
    /// 
    pub fn get_unweighted_minimum_path_node_ids_from_node_names(&self, src_node_name: &str, dst_node_name: &str, maximal_depth: Option<NodeT>) -> PyResult<Py<PyArray1<NodeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_unweighted_minimum_path_node_ids_from_node_names(src_node_name, dst_node_name, maximal_depth))?, NodeT))
    }
    ...
    ///     If any of the given node names do not exist in the current graph.
    /// 
    pub fn get_unweighted_minimum_path_node_names_from_node_names(&self, src_node_name: &str, dst_node_name: &str, maximal_depth: Option<NodeT>) -> PyResult<Vec<String>> {
        pe!(self.graph.get_unweighted_minimum_path_node_names_from_node_names(src_node_name, dst_node_name, maximal_depth))
    }
    ...
    /// ------
    /// If any of the given node IDs does not exist in the graph the method will panic.
    pub unsafe fn get_unchecked_unweighted_k_shortest_path_node_ids_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, k: usize) -> Vec<Vec<NodeT>> {
        self.graph.get_unchecked_unweighted_k_shortest_path_node_ids_from_node_ids(src_node_id, dst_node_id, k)
    }
    ...
    /// 
    pub fn get_unweighted_k_shortest_path_node_ids_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, k: usize) -> PyResult<Vec<Vec<NodeT>>> {
        pe!(self.graph.get_unweighted_k_shortest_path_node_ids_from_node_ids(src_node_id, dst_node_id, k))
    }
    ...
    /// 
    pub fn get_unweighted_k_shortest_path_node_ids_from_node_names(&self, src_node_name: &str, dst_node_name: &str, k: usize) -> PyResult<Vec<Vec<NodeT>>> {
        pe!(self.graph.get_unweighted_k_shortest_path_node_ids_from_node_names(src_node_name, dst_node_name, k))
    }
    ...
    ///     If any of the given node names does not exist in the graph.
    /// 
    pub fn get_unweighted_k_shortest_path_node_names_from_node_names(&self, src_node_name: &str, dst_node_name: &str, k: usize) -> PyResult<Vec<Vec<String>>> {
        pe!(self.graph.get_unweighted_k_shortest_path_node_names_from_node_names(src_node_name, dst_node_name, k))
    }
    ...
    pub unsafe fn get_unchecked_unweighted_eccentricity_from_node_id(&self, node_id: NodeT) -> NodeT {
        self.graph.get_unchecked_unweighted_eccentricity_from_node_id(node_id)
    }
    ...
    ///     If the graph contains negative weights.
    /// 
    pub fn get_weighted_eccentricity_from_node_id(&self, node_id: NodeT, use_edge_weights_as_probabilities: Option<bool>) -> PyResult<f64> {
        pe!(self.graph.get_weighted_eccentricity_from_node_id(node_id, use_edge_weights_as_probabilities))
    }
    ...
    pub fn get_unweighted_eccentricity_from_node_name(&self, node_name: &str) -> PyResult<NodeT> {
        pe!(self.graph.get_unweighted_eccentricity_from_node_name(node_name))
    }
    ...
    ///     If the graph contains negative weights.
    /// 
    pub fn get_weighted_eccentricity_from_node_name(&self, node_name: &str, use_edge_weights_as_probabilities: Option<bool>) -> PyResult<f64> {
        pe!(self.graph.get_weighted_eccentricity_from_node_name(node_name, use_edge_weights_as_probabilities))
    }
    ...
    /// ------
    /// If any of the given node IDs does not exist in the graph the method will panic.
    pub unsafe fn get_unchecked_weighted_minimum_path_node_ids_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, use_edge_weights_as_probabilities: Option<bool>, maximal_depth: Option<NodeT>) -> (f64, Vec<NodeT>) {
        self.graph.get_unchecked_weighted_minimum_path_node_ids_from_node_ids(src_node_id, dst_node_id, use_edge_weights_as_probabilities, maximal_depth)
    }
    ...
    /// ------
    /// If any of the given node IDs does not exist in the graph the method will panic.
    pub unsafe fn get_unchecked_weighted_minimum_path_node_names_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, use_edge_weights_as_probabilities: Option<bool>, maximal_depth: Option<NodeT>) -> (f64, Vec<String>) {
        self.graph.get_unchecked_weighted_minimum_path_node_names_from_node_ids(src_node_id, dst_node_id, use_edge_weights_as_probabilities, maximal_depth)
    }
    ...
    ///     If any of the given node IDs do not exist in the current graph.
    /// 
    pub fn get_weighted_minimum_path_node_ids_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, use_edge_weights_as_probabilities: Option<bool>, maximal_depth: Option<NodeT>) -> PyResult<(f64, Vec<NodeT>)> {
        pe!(self.graph.get_weighted_minimum_path_node_ids_from_node_ids(src_node_id, dst_node_id, use_edge_weights_as_probabilities, maximal_depth))
    }
    ...
    ///     If any of the given node names do not exist in the current graph.
    /// 
    pub fn get_weighted_minimum_path_node_ids_from_node_names(&self, src_node_name: &str, dst_node_name: &str, use_edge_weights_as_probabilities: Option<bool>, maximal_depth: Option<NodeT>) -> PyResult<(f64, Vec<NodeT>)> {
        pe!(self.graph.get_weighted_minimum_path_node_ids_from_node_names(src_node_name, dst_node_name, use_edge_weights_as_probabilities, maximal_depth))
    }
    ...
    ///     If any of the given node names do not exist in the current graph.
    /// 
    pub fn get_weighted_minimum_path_node_names_from_node_names(&self, src_node_name: &str, dst_node_name: &str, use_edge_weights_as_probabilities: Option<bool>, maximal_depth: Option<NodeT>) -> PyResult<(f64, Vec<String>)> {
        pe!(self.graph.get_weighted_minimum_path_node_names_from_node_names(src_node_name, dst_node_name, use_edge_weights_as_probabilities, maximal_depth))
    }
    ...
    /// 
    pub fn get_unweighted_diameter(&self, ignore_infinity: Option<bool>, verbose: Option<bool>) -> PyResult<f64> {
    ...
    ///     If the user has asked for the weights to be treated as probabilities but the weights are not between 0 and 1.
    /// 
    pub fn get_weighted_diameter(&self, ignore_infinity: Option<bool>, use_edge_weights_as_probabilities: Option<bool>, verbose: Option<bool>) -> PyResult<f64> {
        pe!(self.graph.get_weighted_diameter(ignore_infinity, use_edge_weights_as_probabilities, verbose))
    }
    ...
    pub fn get_bipartite_edges(&self, removed_existing_edges: Option<bool>, first_nodes_set: Option<HashSet<String>>, second_nodes_set: Option<HashSet<String>>, first_node_types_set: Option<HashSet<String>>, second_node_types_set: Option<HashSet<String>>) -> PyResult<Py<PyArray2<NodeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_2d!(gil, pe!(self.graph.get_bipartite_edges(removed_existing_edges, first_nodes_set, second_nodes_set, first_node_types_set, second_node_types_set))?, NodeT))
    }
    ...
    pub fn get_star_edges(&self, central_node: String, removed_existing_edges: Option<bool>, star_points_nodes_set: Option<HashSet<String>>, star_points_node_types_set: Option<HashSet<String>>) -> PyResult<Py<PyArray2<NodeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_2d!(gil, pe!(self.graph.get_star_edges(central_node, removed_existing_edges, star_points_nodes_set, star_points_node_types_set))?, NodeT))
    }
    ...
    pub fn get_clique_edges(&self, directed: Option<bool>, allow_selfloops: Option<bool>, removed_existing_edges: Option<bool>, allow_node_type_set: Option<HashSet<String>>, allow_node_set: Option<HashSet<String>>) -> Py<PyArray2<NodeT>> {
        let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, self.graph.get_clique_edges(directed, allow_selfloops, removed_existing_edges, allow_node_type_set, allow_node_set), NodeT)
    }
    ...
    pub fn get_okapi_bm25_node_feature_propagation(&self, features: Vec<Vec<f64>>, iterations: Option<usize>, maximal_distance: Option<usize>, k1: Option<f64>, b: Option<f64>, include_central_node: Option<bool>, verbose: Option<bool>) -> PyResult<Py<PyArray2<f64>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_2d!(gil, pe!(self.graph.get_okapi_bm25_node_feature_propagation(features, iterations, maximal_distance, k1, b, include_central_node, verbose))?, f64))
    }
    ...
    pub fn get_okapi_bm25_node_label_propagation(&self, iterations: Option<usize>, maximal_distance: Option<usize>, k1: Option<f64>, b: Option<f64>, verbose: Option<bool>) -> PyResult<Py<PyArray2<f64>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_2d!(gil, pe!(self.graph.get_okapi_bm25_node_label_propagation(iterations, maximal_distance, k1, b, verbose))?, f64))
    }
    ...
    pub fn to_directed(&self) -> EnsmallenGraph {
        EnsmallenGraph{graph: self.graph.to_directed()}
    }
    ...
    pub fn to_upper_triangular(&self, verbose: Option<bool>) -> EnsmallenGraph {
        EnsmallenGraph{graph: self.graph.to_upper_triangular(verbose)}
    }
    ...
    pub fn to_lower_triangular(&self, verbose: Option<bool>) -> EnsmallenGraph {
        EnsmallenGraph{graph: self.graph.to_lower_triangular(verbose)}
    }
    ...
    pub fn to_main_diagonal(&self, verbose: Option<bool>) -> EnsmallenGraph {
        EnsmallenGraph{graph: self.graph.to_main_diagonal(verbose)}
    }
    ...
    pub fn to_anti_diagonal(&self, verbose: Option<bool>) -> EnsmallenGraph {
        EnsmallenGraph{graph: self.graph.to_anti_diagonal(verbose)}
    }
    ...
    pub fn to_bidiagonal(&self, verbose: Option<bool>) -> EnsmallenGraph {
        EnsmallenGraph{graph: self.graph.to_bidiagonal(verbose)}
    }
    ...
    pub fn to_arrowhead(&self, verbose: Option<bool>) -> EnsmallenGraph {
        EnsmallenGraph{graph: self.graph.to_arrowhead(verbose)}
    }
    ...
    pub fn to_transposed(&self, verbose: Option<bool>) -> EnsmallenGraph {
        EnsmallenGraph{graph: self.graph.to_transposed(verbose)}
    }
    ...
    pub fn to_complementary(&self, verbose: Option<bool>) -> EnsmallenGraph {
        EnsmallenGraph{graph: self.graph.to_complementary(verbose)}
    }
...
to_ndarray_1d!(gil, self.graph.get_clustering_coefficient_per_node(verbose), f64)
    ...
    ///     Whether to show the loading bar.
    /// 
    pub fn sample_negatives(&self, negatives_number: EdgeT, random_state: Option<EdgeT>, seed_graph: Option<&EnsmallenGraph>, only_from_same_component: Option<bool>, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.sample_negatives(negatives_number, random_state, seed_graph.map(|sg| &sg.graph), only_from_same_component, verbose))?})
    }
    ...
    /// 
    pub fn connected_holdout(&self, train_size: f64, random_state: Option<EdgeT>, edge_types: Option<Vec<Option<String>>>, include_all_edge_types: Option<bool>, verbose: Option<bool>) -> PyResult<(EnsmallenGraph, EnsmallenGraph)> {
        let (g1, g2) = pe!(self.graph.connected_holdout(train_size, random_state, edge_types, include_all_edge_types, verbose))?; Ok((EnsmallenGraph{graph: g1}, EnsmallenGraph{graph: g2}))
    }
    ...
    /// 
    pub fn random_holdout(&self, train_size: f64, random_state: Option<EdgeT>, include_all_edge_types: Option<bool>, edge_types: Option<Vec<Option<String>>>, min_number_overlaps: Option<EdgeT>, verbose: Option<bool>) -> PyResult<(EnsmallenGraph, EnsmallenGraph)> {
        let (g1, g2) = pe!(self.graph.random_holdout(train_size, random_state, include_all_edge_types, edge_types, min_number_overlaps, verbose))?; Ok((EnsmallenGraph{graph: g1}, EnsmallenGraph{graph: g2}))
    }
    ...
    /// 
    pub fn node_label_holdout(&self, train_size: f64, use_stratification: Option<bool>, random_state: Option<EdgeT>) -> PyResult<(EnsmallenGraph, EnsmallenGraph)> {
        let (g1, g2) = pe!(self.graph.node_label_holdout(train_size, use_stratification, random_state))?; Ok((EnsmallenGraph{graph: g1}, EnsmallenGraph{graph: g2}))
    }
    ...
    /// 
    pub fn edge_label_holdout(&self, train_size: f64, use_stratification: Option<bool>, random_state: Option<EdgeT>) -> PyResult<(EnsmallenGraph, EnsmallenGraph)> {
        let (g1, g2) = pe!(self.graph.edge_label_holdout(train_size, use_stratification, random_state))?; Ok((EnsmallenGraph{graph: g1}, EnsmallenGraph{graph: g2}))
    }
    ...
    /// 
    pub fn random_subgraph(&self, nodes_number: NodeT, random_state: Option<usize>, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.random_subgraph(nodes_number, random_state, verbose))?})
    }
    ...
    /// 
    pub fn kfold(&self, k: EdgeT, k_index: u64, edge_types: Option<Vec<Option<String>>>, random_state: Option<EdgeT>, verbose: Option<bool>) -> PyResult<(EnsmallenGraph, EnsmallenGraph)> {
        let (g1, g2) = pe!(self.graph.kfold(k, k_index, edge_types, random_state, verbose))?; Ok((EnsmallenGraph{graph: g1}, EnsmallenGraph{graph: g2}))
    }
    ...
    /// 
    pub fn get_unweighted_laplacian_transformed_graph(&self, verbose: Option<bool>) -> EnsmallenGraph {
        EnsmallenGraph{graph: self.graph.get_unweighted_laplacian_transformed_graph(verbose)}
    }
    ...
    ///     Whether to show a loading bar while building the graph.
    /// 
    pub fn get_unweighted_random_walk_normalized_laplacian_transformed_graph(&self, verbose: Option<bool>) -> EnsmallenGraph {
        EnsmallenGraph{graph: self.graph.get_unweighted_random_walk_normalized_laplacian_transformed_graph(verbose)}
    }
    ...
    /// 
    pub fn get_unweighted_symmetric_normalized_laplacian_transformed_graph(&self, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.get_unweighted_symmetric_normalized_laplacian_transformed_graph(verbose))?})
    }
    ...
    ///     The graph must be undirected, as we do not currently support this transformation for directed graphs.
    /// 
    pub fn get_unweighted_symmetric_normalized_transformed_graph(&self, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.get_unweighted_symmetric_normalized_transformed_graph(verbose))?})
    }
    ...
    /// 
    pub fn get_weighted_laplacian_transformed_graph(&self, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.get_weighted_laplacian_transformed_graph(verbose))?})
    }
    ...
    ///     If the graph is not weighted it is not possible to compute the weighted laplacian transformation.
    /// 
    pub fn get_weighted_symmetric_normalized_laplacian_transformed_graph(&self, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.get_weighted_symmetric_normalized_laplacian_transformed_graph(verbose))?})
    }
    ...
    ///     If the graph is not weighted it is not possible to compute the weighted laplacian transformation.
    /// 
    pub fn get_weighted_symmetric_normalized_transformed_graph(&self, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.get_weighted_symmetric_normalized_transformed_graph(verbose))?})
    }
    ...
    /// 
    pub fn get_weighted_random_walk_normalized_laplacian_transformed_graph(&self, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.get_weighted_random_walk_normalized_laplacian_transformed_graph(verbose))?})
    }
    ...
    ///     Whether to show a loading bar while building the graph.
    /// 
    pub fn get_transitive_closure(&self, iterations: Option<NodeT>, verbose: Option<bool>) -> EnsmallenGraph {
        EnsmallenGraph{graph: self.graph.get_transitive_closure(iterations, verbose)}
    }
    ...
    ///     Whether to show a loading bar while building the graph.
    /// 
    pub fn get_unweighted_all_shortest_paths(&self, iterations: Option<NodeT>, verbose: Option<bool>) -> EnsmallenGraph {
        EnsmallenGraph{graph: self.graph.get_unweighted_all_shortest_paths(iterations, verbose)}
    }
    ...
    ///     If the user has asked for the weights to be treated as probabilities but the weights are not between 0 and 1.
    /// 
    pub fn get_weighted_all_shortest_paths(&self, iterations: Option<NodeT>, use_edge_weights_as_probabilities: Option<bool>, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.get_weighted_all_shortest_paths(iterations, use_edge_weights_as_probabilities, verbose))?})
    }
    ...
    ///     Whether to show loading bar while building the graphs.
    /// 
    pub fn filter_from_names(&self, node_names_to_keep: Option<Vec<&str>>, node_names_to_filter: Option<Vec<&str>>, node_type_names_to_keep: Option<Vec<Option<Vec<&str>>>>, node_type_names_to_filter: Option<Vec<Option<Vec<&str>>>>, node_type_name_to_keep: Option<Vec<Option<String>>>, node_type_name_to_filter: Option<Vec<Option<String>>>, edge_node_names_to_keep: Option<Vec<(&str, &str)>>, edge_node_names_to_filter: Option<Vec<(&str, &str)>>, edge_type_names_to_keep: Option<Vec<Option<String>>>, edge_type_names_to_filter: Option<Vec<Option<String>>>, min_edge_weight: Option<WeightT>, max_edge_weight: Option<WeightT>, filter_singleton_nodes: Option<bool>, filter_singleton_nodes_with_selfloop: Option<bool>, filter_selfloops: Option<bool>, filter_parallel_edges: Option<bool>, verbose: Option<bool>) -> PyResult<EnsmallenGraph> {
        Ok(EnsmallenGraph{graph: pe!(self.graph.filter_from_names(node_names_to_keep, node_names_to_filter, node_type_names_to_keep, node_type_names_to_filter, node_type_name_to_keep, node_type_name_to_filter, edge_node_names_to_keep, edge_node_names_to_filter, edge_type_names_to_keep, edge_type_names_to_filter, min_edge_weight, max_edge_weight, filter_singleton_nodes, filter_singleton_nodes_with_selfloop, filter_selfloops, filter_parallel_edges, verbose))?})
    }
    ...
    pub fn drop_selfloops(&self, verbose: Option<bool>) -> EnsmallenGraph {
        EnsmallenGraph{graph: self.graph.drop_selfloops(verbose)}
    }
