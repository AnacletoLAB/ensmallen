...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("has", 1.0296979),
        ("node", 0.25316986),
        ("vocabularies", 2.2490556),
    ],
    &[
        ("compatible", 1.5458078),
        ("has", 0.74348116),
        ("node", 0.1827983),
        ("types", 0.6272082),
        ("vocabularies", 1.6239039),
    ],
    &[
        ("compatible", 1.5458078),
        ("edge", 0.39013332),
    ...
    &[("compatible", 4.8254128), ("is", 3.6257)],
    &[
        ("adjacency", 2.2490556),
        ("has", 1.0296979),
        ("matrix", 1.8671781),
    ...
    &[("get", 0.3922016), ("stars", 5.8911138)],
    &[("chains", 5.8911138), ("get", 0.3922016)],
    &[
        ("arborescence", 2.3938663),
        ("kruskal", 2.3938663),
        ("random", 1.556386),
        ("spanning", 2.2490556),
    ],
    &[
        ("arborescence", 3.4884105),
        ("kruskal", 3.4884105),
        ("spanning", 3.277388),
    ],
    &[
        ("components", 3.1197734),
        ("connected", 2.5313263),
        ("get", 0.25357005),
    ],
    &[("overlaps", 9.598305)],
    ...
    &[
        ("disconnected", 0.9038984),
        ("from", 0.19024435),
        ("id", 0.30352622),
        ("is", 0.6791677),
        ("node", 0.1992942),
        ("unchecked", 0.37981737),
    ],
    &[
        ("from", 0.24473771),
        ("id", 0.39046788),
    ...
    &[
        ...
        ("ids", 0.28926724),
        ("node", 0.1068898),
        ("structural", 1.0107044),
        ("unchecked", 0.37981737),
    ],
    &[
        ("attachment", 1.2542399),
        ("get", 0.12564072),
        ("minimum", 1.3870685),
        ("preferential", 1.2542399),
        ("unchecked", 0.6495472),
    ],
    &[
        ("attachment", 1.2542399),
    ...
    &[
        ("attachment", 0.94348246),
        ("get", 0.094511285),
        ("minimum", 1.0434008),
        ("preferential", 0.94348246),
        ("unchecked", 0.4886118),
        ("weighted", 0.6550368),
    ],
    &[
    ...
    &[
        ("attachment", 0.7334064),
        ("from", 0.19024435),
        ("get", 0.073467374),
        ("ids", 0.28926724),
        ("node", 0.1068898),
        ("preferential", 0.7334064),
        ("unchecked", 0.37981737),
    ],
    &[
        ("attachment", 0.94348246),
    ...
    &[
        ("attachment", 0.5854502),
        ("from", 0.15186475),
        ("get", 0.058646183),
        ("ids", 0.23091093),
        ("node", 0.085326016),
        ("preferential", 0.5854502),
        ("unchecked", 0.3031936),
        ("weighted", 0.40646374),
    ],
    &[
    ...
    &[
        ...
        ("node", 0.06961207),
        ("resource", 0.5282145),
        ("unchecked", 0.24735638),
        ("weighted", 0.33160794),
    ],
    &[
        ("allocation", 0.8110769),
        ("from", 0.19024435),
        ("get", 0.073467374),
        ("ids", 0.28926724),
        ("index", 0.7499369),
    ...
    &[
        ("attachment", 1.7370826),
        ("get", 0.17400841),
        ("preferential", 1.7370826),
        ("scores", 2.140895),
    ],
    &[
        ("allocation", 1.3870685),
        ("get", 0.12564072),
        ("index", 1.2825094),
        ("resource", 1.3870685),
        ("scores", 1.5458078),
    ...
    &[("enable", 9.598305)],
    &[("all", 3.9152505), ("disable", 5.8911138)],
    &[
        ("get", 0.25357005),
        ("node", 0.36892635),
        ("tuples", 3.808781),
    ...
    &[("get", 0.3922016), ("transitivity", 5.8911138)],
    &[
        ("get", 0.094511285),
        ("node", 0.13750719),
        ("number", 0.5976091),
    ...
    &[
        ("clustering", 1.6239039),
        ("coefficient", 1.3870685),
        ("get", 0.12564072),
        ("node", 0.1827983),
        ("per", 1.7284628),
    ],
    &[
        ("clustering", 3.277388),
        ("coefficient", 2.7994032),
        ("get", 0.25357005),
    ],
    &[
        ("average", 2.6137154),
        ("clustering", 2.2490556),
        ("coefficient", 1.921046),
        ("get", 0.17400841),
    ],
    &[
    ...
    &[
        ("and", 0.30475923),
        ("distant", 0.46124315),
        ("eccentricity", 0.38200808),
        ("from", 0.08681956),
        ("get", 0.033527434),
        ("id", 0.26813918),
        ("most", 0.4125014),
        ("node", 0.0944279),
        ("unchecked", 0.17333275),
    ],
    &[
        ("eccentricity", 0.8370796),
        ("from", 0.19024435),
        ("get", 0.073467374),
        ("id", 0.30352622),
        ("node", 0.1068898),
    ...
    &[("diameter", 5.395591), ("get", 0.3922016)],
    &[
        ("breadth", 0.7681229),
        ("first", 0.7681229),
        ("from", 0.19024435),
    ...
    &[("remove", 2.768666), ("tendrils", 5.395591)],
    &[
        ("dendritic", 3.4884105),
        ("remove", 1.7900252),
        ("trees", 3.4884105),
    ...
    &[
        ("disconnected", 3.1197734),
        ("nodes", 1.6826875),
        ("remove", 1.7900252),
    ],
    &[("remove", 2.768666), ("selfloops", 3.834367)],
    &[
        ("edges", 2.0831232),
        ("parallel", 2.9939206),
        ("remove", 1.7900252),
    ...
    &[("components", 4.8254128), ("remove", 2.768666)],
    &[
        ("centrality", 2.233159),
        ("degree", 2.1103954),
        ("get", 0.25357005),
    ...
    &[
        ("centrality", 0.51648945),
        ("closeness", 0.72154737),
        ("from", 0.15186475),
        ("get", 0.058646183),
        ("id", 0.24229331),
        ("node", 0.085326016),
    ...
    &[
        ("betweenness", 2.9939206),
        ("centrality", 2.233159),
        ("get", 0.25357005),
    ],
    &[
        ("approximated", 0.7499369),
        ("betweenness", 0.8674348),
        ("centrality", 0.64701784),
        ("from", 0.19024435),
        ("get", 0.073467374),
        ("id", 0.30352622),
    ...
    &[
        ("approximated", 0.59864575),
        ("betweenness", 0.69243985),
        ("centrality", 0.51648945),
        ("from", 0.15186475),
        ("get", 0.058646183),
        ("id", 0.24229331),
    ...
    &[
        ("centrality", 2.233159),
        ("eigenvector", 3.4884105),
        ("get", 0.25357005),
    ],
    &[
        ("centrality", 1.53247),
        ("eigenvector", 2.3938663),
        ("get", 0.17400841),
        ("weighted", 1.2060139),
    ],
    &[("circles", 5.8911138), ("get", 0.3922016)],
    &[("name", 2.2731435), ("set", 4.4687037)],
    &[
        ("all", 1.2542399),
        ("edge", 0.39013332),
        ("inplace", 1.0067796),
    ...
    &[
        ("inplace", 1.0067796),
        ("isomorphic", 1.0746019),
        ("node", 0.1827983),
        ("remove", 0.88693464),
        ("types", 0.6272082),
    ],
    &[
        ("isomorphic", 1.4882897),
        ("node", 0.25316986),
        ("remove", 1.2283764),
        ("types", 0.8686635),
    ],
    ...
    &[
        ...
        ("must", 1.6680744),
        ("node", 0.25316986),
        ("ontologies", 2.0545304),
    ],
    &[
        ("be", 3.1197734),
        ("must", 2.4307656),
        ("undirected", 2.9939206),
    ],
    &[
        ("have", 1.5458078),
        ("must", 1.2044134),
    ...
    &[
        ...
        ("node", 0.25316986),
        ("share", 2.6137154),
        ("vocabulary", 2.6137154),
    ],
    &[("edge", 1.217845), ("encode", 5.8911138)],
    &[("decode", 5.8911138), ("edge", 1.217845)],
    &[
        ("edge", 0.39013332),
        ("encodable", 1.8872024),
        ("get", 0.12564072),
    ...
    &[("report", 4.6307535), ("textual", 5.395591)],
    &[
        ("components", 2.140895),
        ("connected", 1.7370826),
        ("get", 0.17400841),
    ...
    &[("density", 5.8911138), ("get", 0.3922016)],
    &[
        ("get", 0.17400841),
        ("nodes", 1.1547177),
        ("rate", 1.9826336),
    ...
    &[
        ...
        ("get", 0.17400841),
        ("number", 1.1002815),
        ("undirected", 2.0545304),
    ],
    &[
        ("edges", 1.032161),
        ("get", 0.12564072),
        ("number", 0.7944452),
        ("undirected", 1.4834493),
        ("unique", 1.2542399),
    ],
    &[
        ("edges", 2.0831232),
    ...
    &[
        ("destination", 1.8671781),
        ("get", 0.17400841),
        ("ids", 0.68513316),
        ("node", 0.25316986),
    ],
    &[
        ("destination", 1.3481739),
        ("directed", 1.0192112),
        ("get", 0.12564072),
        ("ids", 0.4946923),
        ("node", 0.1827983),
    ...
    &[("get", 0.3922016), ("tendrils", 5.395591)],
    &[
        ("coo", 2.2490556),
        ("get", 0.17400841),
        ("jaccard", 2.0545304),
    ...
    &[
        ("get", 0.12564072),
        ("graph", 0.97221607),
        ("normalized", 1.5458078),
        ("symmetric", 1.7284628),
        ("transformed", 1.4834493),
    ],
    &[
        ("community", 1.6239039),
        ("detection", 1.8872024),
    ...
    &[
        ("community", 0.94956446),
        ("directed", 0.59597534),
        ("from", 0.19024435),
        ("get", 0.073467374),
        ("memberships", 1.0107044),
        ("modularity", 1.0107044),
        ("node", 0.1068898),
    ],
    &[
        ("community", 0.94956446),
    ...
    &[("has", 2.32086), ("nodes", 2.602645)],
    &[("edges", 3.2220063), ("has", 2.32086)],
    &[
        ("has", 1.5005052),
        ("nodes", 1.6826875),
        ("trap", 2.8891504),
    ],
    &[("directed", 3.181582), ("is", 3.6257)],
    &[
        ("edge", 0.7873731),
        ("has", 1.5005052),
        ("weights", 2.3049128),
    ...
    &[
        ("edge", 0.39013332),
        ("has", 0.74348116),
        ("probabilities", 1.8872024),
        ("representing", 1.8872024),
        ("weights", 1.1420548),
    ],
    &[
        ("has", 1.0296979),
    ...
    &[("has", 2.32086), ("selfloops", 3.834367)],
    &[
        ("disconnected", 3.1197734),
        ("has", 1.5005052),
        ("nodes", 1.6826875),
    ...
    &[
        ...
        ("enabled", 1.16281),
        ("has", 0.55927217),
        ("reciprocal", 1.1159017),
        ("sqrt", 1.1159017),
        ("tradeoff", 1.16281),
    ],
    &[("csv", 5.8911138), ("from", 1.0156091)],
    &[
        ("edges", 0.7764271),
        ("features", 1.4196186),
        ("from", 0.24473771),
    ...
    &[("add", 4.3298903), ("selfloops", 3.834367)],
    &[
        ("directed", 2.0569878),
        ("inplace", 2.031898),
        ("to", 2.4790328),
    ],
    &[("directed", 3.181582), ("to", 3.834367)],
    &[
        ("to", 2.4790328),
        ("triangular", 3.4884105),
        ("upper", 3.808781),
    ],
    &[
        ("lower", 3.808781),
    ...
    &[("bidiagonal", 5.8911138), ("to", 3.834367)],
    &[("arrowhead", 5.8911138), ("to", 3.834367)],
    &[("to", 3.834367), ("transposed", 5.8911138)],
    &[("complementary", 5.8911138), ("to", 3.834367)],
    &[
        ("graph", 0.97221607),
        ("multi", 1.8872024),
        ("similarity", 1.8872024),
        ("structural", 1.7284628),
        ("to", 1.2283291),
    ],
    &[
        ("graph", 1.9621415),
    ...
    &[("connected", 3.9152505), ("holdout", 4.208476)],
    &[("holdout", 4.208476), ("random", 3.5079746)],
    &[
        ("get", 0.12564072),
        ("holdout", 1.3481739),
        ("indices", 1.8872024),
