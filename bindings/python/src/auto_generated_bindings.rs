...
impl Graph {
    ...
    ///     The number of neighbours to consider for the hash. By default 10.
    ///
    pub fn get_isomorphic_edge_names_groups(
        &self,
        minimum_node_degree: Option<NodeT>,
        number_of_neighbours_for_hash: Option<usize>,
        ...
        Ok(pe!(self
            .inner
            .get_isomorphic_edge_names_groups(minimum_node_degree, number_of_neighbours_for_hash))?
        .into_iter()
        .map(|x| {
            x.into_iter()
...
pub const GRAPH_METHODS_NAMES: &[&str] = &[
    ...
    "get_isomorphic_edge_names_groups",
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("and", 0.31367812),
        ("distant", 0.4719864),
        ("eccentricity", 0.39182755),
        ("from", 0.08515187),
        ("get", 0.03136753),
        ("id", 0.27633107),
        ("most", 0.42267635),
        ("node", 0.09460158),
        ("unchecked", 0.17665116),
    ],
    &[
        ("eccentricity", 0.85747075),
        ("from", 0.18634535),
        ("get", 0.06864433),
        ("id", 0.31250593),
        ("node", 0.106986),
    ...
    &[("diameter", 5.482067), ("get", 0.3643302)],
    &[
        ("breadth", 0.7878016),
        ("first", 0.7878016),
        ("from", 0.18634535),
    ...
    &[("chains", 5.9798083), ("get", 0.3643302)],
    &[("circles", 5.9798083), ("get", 0.3643302)],
    &[
        ("approximated", 2.7088242),
        ("cliques", 3.5515487),
        ("get", 0.23603076),
    ],
    &[
    ...
    &[
        ("coo", 1.0128844),
        ("get", 0.088256694),
        ("intersection", 1.2485758),
        ("matrix", 0.94810665),
        ("neighbours", 1.2485758),
        ("size", 1.1418898),
    ],
    &[
        ("get", 0.11723814),
        ("graph", 0.95984393),
        ("intersection", 1.6585791),
        ("neighbours", 1.6585791),
        ("size", 1.5168599),
    ],
    &[
        ("ancestors", 1.1024587),
    ...
    &[("csv", 5.9798083), ("from", 0.9890291)],
    &[
        ("edge", 0.41033843),
        ("get", 0.11723814),
        ("groups", 1.2129061),
        ("ids", 0.48557457),
        ("isomorphic", 1.0358987),
    ],
    &[
        ("edge", 0.41033843),
        ("get", 0.11723814),
    ...
    &[
        ("approximated", 0.62914884),
        ("get", 0.05482027),
        ("groups", 0.5671519),
        ("isomorphic", 0.4843837),
        ("node", 0.085440435),
        ("number", 0.37302682),
        ("of", 0.38132796),
        ("type", 0.24613495),
    ...
    &[("get", 0.3643302), ("transitivity", 5.9798083)],
    &[
        ("get", 0.088256694),
        ("node", 0.13755296),
        ("number", 0.60054636),
    ...
    &[
        ("clustering", 1.6585791),
        ("coefficient", 1.4196113),
        ("get", 0.11723814),
        ("node", 0.18272217),
        ("per", 1.6585791),
    ],
    &[
        ("clustering", 3.3391495),
        ("coefficient", 2.8580456),
        ("get", 0.23603076),
    ],
    &[
        ("average", 2.6622992),
        ("clustering", 2.2947323),
        ("coefficient", 1.9641078),
        ("get", 0.1622052),
    ],
    &[
        ("edge", 0.44764358),
    ...
    &[
        ...
        ("from", 0.18634535),
        ("get", 0.06864433),
        ("memberships", 1.0328895),
        ("modularity", 1.0328895),
        ("node", 0.106986),
    ],
    &[
        ("community", 0.9711178),
    ...
    &[
        ("get", 0.23603076),
        ("nodes", 1.7340436),
        ("subsampled", 3.8740094),
    ],
    &[
        ("compatible", 2.1857092),
        ("has", 1.0880976),
        ("node", 0.25280583),
        ("vocabularies", 2.2947323),
    ],
    &[
        ("compatible", 1.5797799),
        ("has", 0.78645164),
        ("node", 0.18272217),
        ("types", 0.6565561),
        ("vocabularies", 1.6585791),
    ],
    &[
        ("compatible", 1.5797799),
        ("edge", 0.41033843),
    ...
    &[("compatible", 4.9093366), ("is", 3.6433349)],
    &[
        ("adjacency", 2.6622992),
        ("has", 1.0880976),
        ("matrix", 1.7425061),
    ...
    &[
        ...
        ("must", 1.67812),
        ("node", 0.25280583),
        ("ontologies", 2.0986562),
    ],
    &[
        ("be", 3.053832),
        ("must", 2.4418943),
        ("undirected", 2.7790358),
    ],
    &[
        ("acyclic", 2.4406974),
        ("be", 2.0986562),
    ...
    &[("remove", 2.8433833), ("tendrils", 5.482067)],
    &[
        ("dendritic", 3.5515487),
        ("remove", 1.8420815),
        ("trees", 3.5515487),
    ...
    &[
        ("disconnected", 3.1805062),
        ("nodes", 1.7340436),
        ("remove", 1.8420815),
    ],
    &[("remove", 2.8433833), ("selfloops", 3.7042537)],
    &[
        ("edges", 2.137092),
        ("parallel", 3.053832),
        ("remove", 1.8420815),
    ...
    &[("density", 5.9798083), ("get", 0.3643302)],
    &[
        ("get", 0.1622052),
        ("nodes", 1.1916705),
        ("rate", 2.0261865),
    ...
    &[
        ("destination", 1.9098107),
        ("get", 0.1622052),
        ("ids", 0.67181826),
        ("node", 0.25280583),
    ],
    &[
        ("destination", 1.3803667),
        ("directed", 1.0010241),
        ("get", 0.11723814),
        ("ids", 0.48557457),
        ("node", 0.18272217),
    ...
    &[("components", 4.9093366), ("remove", 2.8433833)],
    &[("add", 4.411596), ("selfloops", 3.7042537)],
    &[("name", 2.314951), ("set", 4.713806)],
    &[
        ("all", 1.2855871),
        ("edge", 0.41033843),
        ("inplace", 1.0358987),
    ...
    &[
        ("components", 3.1805062),
        ("connected", 2.58822),
        ("strongly", 3.8740094),
    ],
    &[("get", 0.3643302), ("tendrils", 5.482067)],
    &[
        ("edges", 0.7991022),
        ("features", 1.4485708),
        ("from", 0.23958607),
    ...
    &[("directed", 3.1107907), ("to", 3.8388653)],
    &[
        ("to", 2.4870028),
        ("triangular", 3.5515487),
        ("upper", 3.8740094),
    ],
    &[
        ("lower", 3.8740094),
    ...
    &[("bidiagonal", 5.9798083), ("to", 3.8388653)],
    &[("arrowhead", 5.9798083), ("to", 3.8388653)],
    &[("to", 3.8388653), ("transposed", 5.9798083)],
    &[("to", 3.8388653), ("undirected", 4.2896385)],
    &[("complementary", 5.9798083), ("to", 3.8388653)],
    &[
        ("graph", 0.95984393),
        ("multi", 1.9242479),
        ("similarity", 1.9242479),
        ("structural", 1.7640793),
        ("to", 1.2353119),
    ],
    &[("dot", 5.9798083), ("to", 3.8388653)],
    &[("enable", 9.717033)],
    &[("all", 3.9951007), ("disable", 5.9798083)],
    &[("report", 7.659813)],
    &[
        ("overlap", 3.8740094),
        ("report", 3.053832),
    ...
    &[("report", 4.713806), ("textual", 5.482067)],
    &[
        ("16", 0.9711178),
        ("base", 0.7527265),
        ("from", 0.18634535),
    ...
    &[
        ...
        ("ids", 0.2843097),
        ("node", 0.106986),
        ("structural", 1.0328895),
        ("unchecked", 0.3865813),
    ],
    &[
        ("attachment", 1.2855871),
        ("get", 0.11723814),
        ("minimum", 1.4196113),
        ("preferential", 1.2855871),
        ("unchecked", 0.660245),
    ],
    &[
        ("attachment", 1.2855871),
    ...
    &[
        ("attachment", 0.7527265),
        ("from", 0.18634535),
        ("get", 0.06864433),
        ("ids", 0.2843097),
        ("node", 0.106986),
        ("preferential", 0.7527265),
        ("unchecked", 0.3865813),
    ],
    &[
        ("attachment", 0.967788),
    ...
    &[
        ("attachment", 0.60113734),
        ("from", 0.14881787),
        ("get", 0.05482027),
        ("ids", 0.2270535),
        ("node", 0.085440435),
        ("preferential", 0.60113734),
        ("unchecked", 0.30872896),
        ("weighted", 0.42398155),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.05482027),
        ("ids", 0.2270535),
        ("intersection", 0.77554756),
        ("neighbours", 0.77554756),
        ("node", 0.085440435),
        ("size", 0.70927995),
        ("unchecked", 0.30872896),
    ],
    &[
        ("coefficient", 0.83119935),
        ("from", 0.18634535),
        ("get", 0.06864433),
        ("ids", 0.2843097),
        ("jaccard", 0.7694277),
    ...
    &[
        ("attachment", 1.7786779),
        ("get", 0.1622052),
        ("preferential", 1.7786779),
        ("scores", 2.1857092),
    ],
    &[
        ("allocation", 1.4196113),
        ("get", 0.11723814),
        ("index", 1.3141111),
        ("resource", 1.4196113),
        ("scores", 1.5797799),
    ...
    &[
        ("arborescence", 2.4406974),
        ("kruskal", 2.4406974),
        ("random", 1.5495967),
        ("spanning", 2.1857092),
    ],
    &[
        ("arborescence", 3.5515487),
        ("kruskal", 3.5515487),
        ("spanning", 3.1805062),
    ],
    &[
    ...
    &[
        ("centrality", 1.5724341),
        ("degree", 1.4332209),
        ("get", 0.1622052),
        ("weighted", 1.2544997),
    ],
    &[
        ("centrality", 0.66544527),
        ("closeness", 0.92497987),
        ("from", 0.18634535),
        ("get", 0.06864433),
        ("id", 0.31250593),
        ("node", 0.106986),
    ...
    &[
        ("centrality", 0.5314334),
        ("closeness", 0.73870116),
        ("from", 0.14881787),
        ("get", 0.05482027),
        ("id", 0.24957138),
        ("node", 0.085440435),
    ...
    &[
        ("betweenness", 3.053832),
        ("centrality", 2.288107),
        ("get", 0.23603076),
    ],
    &[
        ("approximated", 0.7878016),
        ("betweenness", 0.8881395),
        ("centrality", 0.66544527),
        ("from", 0.18634535),
        ("get", 0.06864433),
        ("id", 0.31250593),
    ...
    &[
        ("centrality", 2.288107),
        ("eigenvector", 3.5515487),
        ("get", 0.23603076),
    ],
    &[
        ("centrality", 1.5724341),
        ("eigenvector", 2.4406974),
        ("get", 0.1622052),
        ("weighted", 1.2544997),
    ],
    &[("overlaps", 9.717033)],
    ...
    &[("connected", 3.9951007), ("holdout", 4.2896385)],
    &[("holdout", 4.2896385), ("random", 3.4805598)],
    &[
        ("get", 0.11723814),
        ("holdout", 1.3803667),
        ("indices", 1.9242479),
    ...
    &[("has", 2.4439833), ("nodes", 2.6766193)],
    &[("edges", 3.2987533), ("has", 2.4439833)],
    &[
        ("has", 1.5833309),
        ("nodes", 1.7340436),
        ("trap", 2.8580456),
    ],
    &[("directed", 3.1107907), ("is", 3.6433349)],
    &[
        ("acyclic", 3.5515487),
        ("directed", 2.0153208),
        ("is", 2.360329),
    ...
    &[
        ("edge", 0.41033843),
        ("has", 0.78645164),
        ("probabilities", 1.9242479),
        ("representing", 1.9242479),
        ("weights", 1.1539426),
    ],
    &[
        ("has", 1.0880976),
    ...
    &[("has", 2.4439833), ("selfloops", 3.7042537)],
    &[
        ("disconnected", 3.1805062),
        ("has", 1.5833309),
        ("nodes", 1.7340436),
    ...
    &[("connected", 3.9951007), ("is", 3.6433349)],
    &[
        ("has", 1.5833309),
        ("node", 0.36786705),
        ("types", 1.3218176),
    ...
    &[("is", 3.6433349), ("multigraph", 4.713806)],
    &[
        ("has", 1.5833309),
        ("node", 0.36786705),
        ("ontologies", 3.053832),
