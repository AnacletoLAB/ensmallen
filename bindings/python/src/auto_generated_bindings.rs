...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("get", 0.05913832),
        ("laplacian", 0.7245856),
        ("transformed", 0.7245856),
        ("random", 0.56929135),
        ("normalized", 0.7627862),
        ("graph", 0.54673105),
        ("walk", 0.81393105),
    ],
    &[
        ...
        ("get", 0.07676631),
        ("symmetric", 1.0565481),
        ("transformed", 0.9405706),
        ("normalized", 0.9901581),
        ("laplacian", 0.9405706),
    ],
    &[
        ("symmetric", 1.4215734),
        ("transformed", 1.2655269),
        ("get", 0.10328819),
        ("graph", 0.9548945),
        ("normalized", 1.3322462),
    ],
    &[
        ("unchecked", 0.5388377),
        ("node_id", 0.59855604),
    ...
    &[
        ("unchecked", 0.40047738),
        ("disconnected", 0.9405706),
        ("from", 0.22456823),
        ("node_id", 0.44486156),
        ("is", 0.709701),
        ("node", 0.44133803),
    ...
    &[
        ("from", 0.17300022),
        ("node_id", 0.34270716),
        ("singleton", 0.42880106),
        ("is", 0.54673105),
        ("unchecked", 0.308515),
        ("with", 0.48685634),
        ("selfloops", 0.56929135),
    ],
    &[
        ("singleton", 0.5566184),
        ("from", 0.22456823),
    ...
    &[("has", 2.2331953), ("node_name", 2.7836313)],
    &[("node_type_id", 3.593255), ("has", 2.2331953)],
    &[("has", 2.2331953), ("node_type_name", 3.503789)],
    &[("has", 2.2331953), ("edge_type_id", 2.9057176)],
    &[("has", 2.2331953), ("edge_type_name", 3.3479326)],
    &[
        ("has", 0.93401676),
        ("from", 0.42551678),
        ("edge", 0.86370945),
    ...
    &[
        ("has", 0.93401676),
        ("node_names", 0.9427119),
        ("from", 0.42551678),
        ("edge", 0.86370945),
    ],
    &[
        ("has", 0.4929312),
        ("node_names", 0.4975201),
        ("from", 0.22456823),
        ("and", 0.709701),
        ("edge_type_name", 0.73898613),
        ("edge", 0.45582622),
    ],
    &[
        ("strongly", 3.2731233),
        ("connected", 2.187252),
        ("components", 2.6600676),
    ],
    &[
        ("outbound", 0.9405706),
        ("degree", 0.62300855),
        ("increasing", 1.0565481),
        ("by", 0.83977836),
        ("sort", 0.9405706),
        ("node", 0.44133803),
    ],
    ...
    &[("components", 4.261199), ("remove", 2.8631423)],
    &[("overlaps", 8.9595175)],
    &[("contains", 8.179237)],
    &[
        ("bipartite", 2.9880686),
    ...
    &[("edge", 2.0650935), ("encode", 5.2432613)],
    &[("decode", 5.2432613), ("edge", 2.0650935)],
    &[
        ("max", 1.5571882),
        ("number", 0.702636),
        ("encodable", 1.5571882),
    ...
    &[("validate", 3.6926808), ("node_id", 2.0154185)],
    &[("validate", 3.6926808), ("node_ids", 1.7285554)],
    &[("edge_id", 2.6111922), ("validate", 3.6926808)],
    &[("validate", 3.6926808), ("edge_ids", 3.593255)],
    &[
        ("unknown", 0.89021736),
        ("node_types", 0.6956493),
        ("contain", 1.2655269),
        ("must", 1.0164336),
        ("not", 1.1679027),
    ],
    &[
        ("contain", 1.2655269),
        ("unknown", 0.89021736),
        ("edge_types", 0.73258114),
        ("must", 1.0164336),
        ("not", 1.1679027),
    ],
    &[("validate", 3.6926808), ("node_type_id", 3.593255)],
    &[("validate", 3.6926808), ("node_type_ids", 3.3479326)],
    &[("edge_type_id", 2.9057176), ("validate", 3.6926808)],
    &[("validate", 3.6926808), ("edge_type_ids", 3.932485)],
    &[
        ("be", 2.6600676),
        ("undirected", 2.5480876),
        ("must", 2.1364872),
    ],
    &[
        ("nodes", 0.7098117),
    ...
    &[
        ("all", 2.3051684),
        ("edge_types", 1.5398451),
        ("set", 2.5480876),
    ],
    &[
        ("node_types", 0.9796676),
        ("set", 1.7071885),
        ("inplace", 1.319823),
        ("all", 1.5444354),
    ],
    &[
        ("set", 2.5480876),
        ("all", 2.3051684),
        ("node_types", 1.4622164),
    ],
    &[
        ("inplace", 1.9699199),
        ("node_type_ids", 2.089958),
        ("remove", 1.7873261),
    ],
    &[
        ("inplace", 1.319823),
    ...
    &[
        ("node_types", 0.9796676),
        ("homogeneous", 1.5912303),
        ("remove", 1.1974872),
        ("inplace", 1.319823),
    ],
    &[
        ("remove", 1.7873261),
        ("edge_type_ids", 2.454867),
        ("inplace", 1.9699199),
    ],
    &[
        ("edge_types", 1.031678),
    ...
    &[
        ("node_type_name", 2.187252),
        ("remove", 1.7873261),
        ("inplace", 1.9699199),
    ],
    &[("remove", 2.8631423), ("node_type_id", 3.593255)],
    &[
        ("node_types", 1.4622164),
        ("remove", 1.7873261),
        ("singleton", 1.5741961),
    ...
    &[
        ("remove", 1.7873261),
        ("node_types", 1.4622164),
        ("homogeneous", 2.3750126),
    ],
    &[("node_type_name", 3.503789), ("remove", 2.8631423)],
    &[
        ("remove", 1.7873261),
        ("inplace", 1.9699199),
        ("edge_type_name", 2.089958),
    ],
    &[("remove", 2.8631423), ("edge_type_id", 2.9057176)],
    &[
        ("remove", 1.7873261),
        ("edge_types", 1.5398451),
        ("singleton", 1.5741961),
    ],
    &[("remove", 2.8631423), ("edge_type_name", 3.3479326)],
    &[
        ("remove", 1.7873261),
        ("inplace", 1.9699199),
        ("node_types", 1.4622164),
    ],
    &[("node_types", 2.3423445), ("remove", 2.8631423)],
    &[
        ("inplace", 1.9699199),
        ("edge_types", 1.5398451),
        ("remove", 1.7873261),
    ],
    &[("edge_types", 2.4666991), ("remove", 2.8631423)],
    &[
        ("inplace", 1.319823),
        ("weights", 1.344757),
        ("edge", 0.86370945),
    ...
    &[("get", 0.3477852), ("circles", 5.2432613)],
    &[
        ("get", 0.21710606),
        ("stats", 3.2731233),
        ("memory", 2.089958),
    ...
    &[
        ...
        ("human", 0.5502254),
        ("memory", 0.4512984),
        ("requirements", 0.5300956),
    ],
    &[
        ("memory", 0.9942973),
        ("requirements", 1.1679027),
        ("get", 0.10328819),
        ("node_types", 0.6956493),
        ("total", 0.9942973),
    ],
    &[
        ("requirements", 0.6686902),
        ("get", 0.05913832),
        ("node_types", 0.3982985),
        ("readable", 0.694083),
        ("total", 0.56929135),
        ("human", 0.694083),
        ("memory", 0.56929135),
    ...
    &[("get", 0.3477852), ("transitivity", 5.2432613)],
    &[
        ("triangles", 1.0565481),
        ("get", 0.07676631),
        ("number", 0.5222163),
    ...
    &[
        ("get", 0.10328819),
        ("coefficient", 1.1679027),
        ("node", 0.5938152),
        ("clustering", 1.3322462),
        ("per", 1.4215734),
    ],
    &[
        ("get", 0.21710606),
        ("clustering", 2.800308),
        ("coefficient", 2.454867),
    ],
    &[
        ("coefficient", 1.6447316),
        ("get", 0.14545849),
        ("average", 2.1929538),
        ("clustering", 1.8761731),
    ],
    &[
        ("remappable", 3.2731233),
        ("nodes", 1.4919848),
        ("are", 3.2731233),
    ],
    &[
    ...
    &[("negatives", 5.2432613), ("sample", 5.2432613)],
    &[("connected", 3.503789), ("holdout", 3.6926808)],
    &[("random", 3.3479326), ("holdout", 3.6926808)],
    &[
        ("holdout", 1.0966836),
        ("indices", 1.5571882),
        ("get", 0.10328819),
    ...
    &[("chains", 5.2432613), ("get", 0.3477852)],
    &[
        ("first", 0.39299992),
        ("search", 0.39299992),
        ("unchecked", 0.19843708),
        ("from", 0.11127386),
        ("predecessors", 0.57346374),
        ("node_id", 0.2204295),
        ("breadth", 0.39299992),
        ("parallel", 0.4464347),
        ("get", 0.03803781),
    ...
    &[
        ...
        ("weighted", 0.50703096),
        ("node_id", 0.44486156),
        ("eccentricity", 0.8680139),
    ],
    &[
        ("get", 0.04688114),
        ("and", 0.43341398),
        ("eccentricity", 0.5300956),
        ("most", 0.5744059),
        ("distant", 0.64523333),
        ("from", 0.13714369),
        ("node_id", 0.5183683),
    ...
    &[("diameter", 4.485852), ("get", 0.3477852)],
    &[
        ("get", 0.14545849),
        ("naive", 2.0019705),
        ("diameter", 1.8761731),
    ...
    &[
        ...
        ("get", 0.10328819),
        ("with", 0.8503202),
        ("node_names", 0.66940755),
        ("singleton", 0.7489236),
    ],
    &[("get", 0.3477852), ("density", 5.2432613)],
    &[
        ("trap", 1.6447316),
        ("nodes", 0.99961215),
        ("get", 0.14545849),
    ...
    &[
        ("number", 0.98950684),
        ("get", 0.14545849),
        ("undirected", 1.7071885),
        ("edges", 1.2744495),
    ],
    &[
        ("undirected", 1.2122525),
        ("get", 0.10328819),
        ("unique", 1.0405849),
        ("edges", 0.9049701),
        ("number", 0.702636),
    ...
    &[("get", 0.3477852), ("source_names", 5.2432613)],
    &[
        ("node_ids", 1.0790565),
        ("get", 0.21710606),
        ("destination", 2.454867),
    ],
    &[
        ("node_ids", 0.72295505),
        ("get", 0.14545849),
        ("directed", 1.4654329),
        ("destination", 1.6447316),
    ],
    &[("get", 0.3477852), ("destination_names", 5.2432613)],
    &[("get", 0.3477852), ("node_names", 2.253985)],
    &[
        ("node", 1.2481668),
        ("urls", 3.2731233),
        ("get", 0.21710606),
    ...
    &[
        ("node", 1.2481668),
        ("ontologies", 3.2731233),
        ("get", 0.21710606),
    ],
    &[("get", 0.3477852), ("node_ids", 1.7285554)],
    &[("edge_type_ids", 3.932485), ("get", 0.3477852)],
    &[
        ("edge_type_ids", 2.454867),
        ("get", 0.21710606),
        ("unique", 2.187252),
    ],
    &[("get", 0.3477852), ("edge_type_names", 4.0818167)],
    &[
        ("get", 0.21710606),
        ("edge_type_names", 2.5480876),
        ("unique", 2.187252),
    ],
    &[
        ("edge", 1.2891414),
    ...
    &[("get", 0.3477852), ("node_type_ids", 3.3479326)],
    &[
        ("node_types", 0.9796676),
        ("mask", 1.6447316),
        ("known", 1.2964483),
    ...
    &[("node_type_names", 3.4224684), ("get", 0.3477852)],
    &[
        ("unique", 2.187252),
        ("get", 0.21710606),
        ("node_type_ids", 2.089958),
    ...
    &[
        ...
        ("node", 0.8362569),
        ("get", 0.14545849),
        ("cumulative", 2.1929538),
    ],
    &[
        ("sqrt", 1.7822136),
        ("degrees", 1.4654329),
        ("reciprocal", 1.7822136),
        ("get", 0.14545849),
    ],
    &[
        ("source", 1.0405849),
    ...
    &[
        ("edge_type_id", 1.2152941),
        ("get", 0.14545849),
        ("hashmap", 1.7822136),
        ("counts", 1.7822136),
    ],
    &[
        ("edge_type_names", 1.7071885),
        ("hashmap", 1.7822136),
        ("get", 0.14545849),
        ("counts", 1.7822136),
    ],
    ...
    &[("directed", 3.503789), ("to", 3.4224684)],
    &[
        ("triangular", 2.9880686),
        ("upper", 3.2731233),
        ("to", 2.1364872),
    ],
    &[
    ...
    &[("to", 3.4224684), ("bidiagonal", 5.2432613)],
    &[("to", 3.4224684), ("arrowhead", 5.2432613)],
    &[("transposed", 5.2432613), ("to", 3.4224684)],
    &[("complementary", 5.2432613), ("to", 3.4224684)],
    &[("report", 6.974878)],
    &[
        ("textual", 2.9880686),
        ("report", 2.5480876),
    ...
    &[("report", 4.0818167), ("textual", 4.7866282)],
    &[
        ("connected", 1.4654329),
        ("generate", 1.431421),
        ("random", 1.400247),
    ...
    &[("replace", 8.9595175)],
    &[("filter", 4.7866282), ("from_ids", 5.2432613)],
    &[("from_names", 5.2432613), ("filter", 4.7866282)],
    &[
        ("drop", 2.187252),
        ("node_types", 1.4622164),
        ("unknown", 1.8711877),
    ...
    &[("drop", 3.503789), ("tendrils", 4.7866282)],
    &[
        ("trees", 2.9880686),
        ("drop", 2.187252),
        ("dendritic", 2.9880686),
    ...
    &[
        ("nodes", 1.4919848),
        ("drop", 2.187252),
        ("disconnected", 2.6600676),
    ],
    &[("selfloops", 3.3479326), ("drop", 3.503789)],
    &[
        ("parallel", 2.5480876),
        ("drop", 2.187252),
        ("edges", 1.9021971),
    ...
    &[
        ...
        ("spanning", 1.8761731),
        ("kruskal", 2.0019705),
        ("arborescence", 2.0019705),
    ],
    &[
        ("kruskal", 2.9880686),
        ("arborescence", 2.9880686),
        ("spanning", 2.800308),
    ],
    &[
        ("components", 2.6600676),
    ...
    &[("enable", 8.9595175)],
    &[("all", 3.6926808), ("disable", 5.2432613)],
    &[("compatible", 5.2432613), ("is", 3.215258)],
    &[
        ("has", 0.93401676),
        ("adjacency", 1.8761731),
        ("same", 2.1929538),
    ...
    &[
        ("graph_name", 3.2731233),
        ("default", 3.2731233),
        ("has", 1.3940796),
    ],
    &[("nodes", 2.390031), ("has", 2.2331953)],
    &[("has", 2.2331953), ("edges", 3.0471559)],
    &[("trap", 2.454867), ("has", 1.3940796), ("nodes", 1.4919848)],
    &[("directed", 3.503789), ("is", 3.215258)],
    &[
        ("weights", 2.0071354),
        ("edge", 1.2891414),
        ("has", 1.3940796),
    ...
    &[
        ("probabilities", 1.5571882),
        ("weights", 0.9548945),
        ("representing", 1.5571882),
        ("has", 0.6632332),
        ("edge", 0.6133089),
    ],
    &[
    ...
    &[("edge_types", 2.4666991), ("has", 2.2331953)],
    &[("has", 2.2331953), ("selfloops", 3.3479326)],
    &[
        ("disconnected", 2.6600676),
        ("has", 1.3940796),
        ("nodes", 1.4919848),
    ...
    &[("is", 3.215258), ("connected", 3.503789)],
    &[("has", 2.2331953), ("node_types", 2.3423445)],
    &[
        ("multilabel", 2.9880686),
        ("has", 1.3940796),
        ("node_types", 1.4622164),
    ],
    &[
    ...
    &[("multigraph", 4.485852), ("is", 3.215258)],
    &[
        ("sorted", 0.60468894),
        ("outbound", 0.5744059),
        ("node", 0.26952487),
    ...
    &[
        ("edge_type_id", 0.86296463),
        ("from", 0.30215397),
        ("get", 0.10328819),
        ("unchecked", 0.5388377),
        ("edge_type_name", 0.9942973),
    ],
    &[
        ("edge_type_id", 0.86296463),
        ("unchecked", 0.5388377),
    ...
    &[
        ("unchecked", 0.5388377),
        ("node_id", 0.59855604),
        ("node_type_ids", 0.9942973),
        ("from", 0.30215397),
        ("get", 0.10328819),
    ],
    &[
        ("node_type_ids", 1.400247),
        ("node_id", 0.84293336),
        ("get", 0.14545849),
        ("from", 0.42551678),
    ],
    ...
    &[
        ("from", 0.30215397),
        ("count", 1.1679027),
        ("node_type_id", 1.0671552),
        ("get", 0.10328819),
        ("node", 0.5938152),
    ],
    &[
        ("node_type_name", 1.0405849),
        ("count", 1.1679027),
        ("get", 0.10328819),
        ("node", 0.5938152),
        ("from", 0.30215397),
    ...
    &[("tendrils", 4.7866282), ("get", 0.3477852)],
    &[
        ("degree", 0.62300855),
        ("node", 0.44133803),
        ("geometric", 1.1573404),
        ("get", 0.07676631),
        ("distribution", 1.1573404),
        ("threshold", 1.1573404),
    ],
    &[
        ("sparse", 1.5571882),
    ...
    &[("selfloops", 3.3479326), ("add", 5.2432613)],
    &[
        ("get", 0.21710606),
        ("centrality", 1.8711877),
        ("degree", 1.7619568),
    ],
    &[
        ("get", 0.14545849),
        ("weighted", 0.9607333),
        ("centrality", 1.2536736),
        ("degree", 1.1804901),
    ],
    &[
        ("unchecked", 0.40047738),
    ...
    &[
        ("from", 0.22456823),
        ("node_id", 0.44486156),
        ("betweenness", 0.90097576),
        ("centrality", 0.66163135),
        ("get", 0.07676631),
        ("approximated", 0.90097576),
    ],
    &[
        ("node_name", 0.6144284),
        ("from", 0.22456823),
    ...
    &[
        ("betweenness", 0.694083),
        ("from", 0.17300022),
        ("weighted", 0.39060047),
        ("get", 0.05913832),
        ("centrality", 0.5096997),
        ("approximated", 0.694083),
        ("node_id", 0.34270716),
    ],
    &[
        ("get", 0.05913832),
        ("node_name", 0.47333607),
        ("approximated", 0.694083),
        ("from", 0.17300022),
        ("betweenness", 0.694083),
        ("weighted", 0.39060047),
    ...
    &[
        ("eigenvector", 2.9880686),
        ("centrality", 1.8711877),
        ("get", 0.21710606),
    ],
    &[
        ("get", 0.14545849),
        ("eigenvector", 2.0019705),
        ("weighted", 0.9607333),
        ("centrality", 1.2536736),
    ],
    &[("dot", 5.2432613), ("to", 3.4224684)],
    &[("stars", 5.2432613), ("get", 0.3477852)],
    &[
        ("detection", 1.5571882),
        ("louvain", 1.5571882),
        ("undirected", 1.2122525),
    ...
    &[
        ("memberships", 0.81393105),
        ("modularity", 0.81393105),
        ("from", 0.17300022),
        ("community", 0.7627862),
        ("node", 0.33999273),
        ("directed", 0.5957936),
    ...
    &[
        ("get", 0.10328819),
        ("attachment", 1.0405849),
        ("preferential", 1.0405849),
        ("minimum", 1.129912),
        ("unchecked", 0.5388377),
    ],
    &[
    ...
    &[
        ("get", 0.07676631),
        ("preferential", 0.7733882),
        ("weighted", 0.50703096),
        ("minimum", 0.83977836),
        ("attachment", 0.7733882),
        ("unchecked", 0.40047738),
    ],
    &[
        ("get", 0.07676631),
    ...
    &[
        ...
        ("node_ids", 0.29392818),
        ("get", 0.05913832),
        ("attachment", 0.5957936),
        ("unchecked", 0.308515),
        ("preferential", 0.5957936),
    ],
    &[
        ("weighted", 0.50703096),
        ("attachment", 0.7733882),
    ...
    &[
        ...
        ("from", 0.13714369),
        ("unchecked", 0.2445713),
        ("allocation", 0.5300956),
    ],
    &[
        ("allocation", 0.8680139),
        ("index", 0.79313594),
        ("node_ids", 0.3815425),
        ("get", 0.07676631),
        ("from", 0.22456823),
