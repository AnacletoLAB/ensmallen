...
impl Graph {
    ...
    pub fn get_isomorphic_node_ids(
        ...
        Ok(pe!(self
            .inner
            .get_isomorphic_node_ids(minimum_node_degree, number_of_neighbours_for_hash))?
        .into_iter()
        .map(|x| {
            x.into_iter()
                .map(|x| {
    ...
    pub fn get_isomorphic_node_names(
        ...
        Ok(pe!(self
            .inner
            .get_isomorphic_node_names(minimum_node_degree, number_of_neighbours_for_hash))?
        .into_iter()
        .map(|x| {
            x.into_iter()
    ...
    pub fn get_isomorphic_edge_node_ids(
        ...
        Ok(pe!(self
            .inner
            .get_isomorphic_edge_node_ids(minimum_node_degree, number_of_neighbours_for_hash))?
        .into_iter()
        .map(|x| {
            x.into_iter()
                .map(|x| {
    ...
    pub fn get_isomorphic_edge_node_names(
        ...
        Ok(pe!(self
            .inner
            .get_isomorphic_edge_node_names(minimum_node_degree, number_of_neighbours_for_hash))?
        .into_iter()
        .map(|x| {
            x.into_iter()
                .map(|x| x.into_iter().cloned().map(|x| x.into()).collect::<Vec<_>>())
    ...
    pub fn get_isomorphic_tuple_node_ids(
        ...
        Ok(pe!(self
            .inner
            .get_isomorphic_tuple_node_ids(minimum_node_degree, number_of_neighbours_for_hash))?
        .into_iter()
        .map(|x| {
            x.into_iter()
                .map(|x| {
    ...
    pub fn get_isomorphic_tuple_node_names(
        ...
        Ok(pe!(self
            .inner
            .get_isomorphic_tuple_node_names(minimum_node_degree, number_of_neighbours_for_hash))?
        .into_iter()
        .map(|x| {
            x.into_iter()
                .map(|x| x.into_iter().cloned().map(|x| x.into()).collect::<Vec<_>>())
    ...
    pub fn get_isomorphic_triple_node_ids(
        ...
        Ok(pe!(self
            .inner
            .get_isomorphic_triple_node_ids(minimum_node_degree, number_of_neighbours_for_hash))?
        .into_iter()
        .map(|x| {
            x.into_iter()
                .map(|x| {
    ...
    pub fn get_isomorphic_triple_node_names(
        ...
        Ok(pe!(self
            .inner
            .get_isomorphic_triple_node_names(minimum_node_degree, number_of_neighbours_for_hash))?
        .into_iter()
        .map(|x| {
            x.into_iter()
                .map(|x| x.into_iter().cloned().map(|x| x.into()).collect::<Vec<_>>())
    ...
    pub fn get_isomorphic_triads_node_ids(
        ...
        Ok(pe!(self
            .inner
            .get_isomorphic_triads_node_ids(minimum_node_degree, number_of_neighbours_for_hash))?
        .into_iter()
        .map(|x| {
            x.into_iter()
                .map(|x| {
    ...
    pub fn get_isomorphic_triads_node_names(
        ...
        Ok(pe!(self
            .inner
            .get_isomorphic_triads_node_names(minimum_node_degree, number_of_neighbours_for_hash))?
        .into_iter()
        .map(|x| {
            x.into_iter()
                .map(|x| x.into_iter().cloned().map(|x| x.into()).collect::<Vec<_>>())
...
pub const GRAPH_METHODS_NAMES: &[&str] = &[
    ...
    "get_isomorphic_triple_node_ids",
    "get_isomorphic_triple_node_names",
    "get_isomorphic_triads_node_ids",
    "get_isomorphic_triads_node_names",
];
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    &[
        ...
        ("node", 0.05681088),
        ("parallel", 0.48116776),
        ("predecessors", 0.61020505),
        ("search", 0.4268882),
        ("unchecked", 0.20984097),
    ],
    &[
        ("breadth", 0.4268882),
        ("distances", 0.52605635),
        ("first", 0.4268882),
        ("from", 0.10151977),
        ("get", 0.036812786),
        ("ids", 0.15251563),
    ...
    &[
        ("and", 0.3139029),
        ("distant", 0.4720211),
        ("eccentricity", 0.39195848),
        ("from", 0.08565112),
        ("get", 0.031058546),
        ("id", 0.277174),
        ("most", 0.42277026),
        ("node", 0.092752725),
        ("unchecked", 0.17704053),
    ],
    &[
        ("eccentricity", 0.85787463),
        ("from", 0.18746355),
        ("get", 0.06797745),
        ("id", 0.31348988),
        ("node", 0.10490537),
    ...
    &[("diameter", 5.4865294), ("get", 0.3610085)],
    &[
        ("breadth", 0.7882797),
        ("first", 0.7882797),
        ("from", 0.18746355),
    ...
    &[("chains", 5.9840407), ("get", 0.3610085)],
    &[("circles", 5.9840407), ("get", 0.3610085)],
    &[
        ("approximated", 2.7115314),
        ("cliques", 3.5536892),
        ("get", 0.23382944),
    ],
    &[
    ...
    &[
        ("coo", 1.0135589),
        ("get", 0.087404445),
        ("intersection", 1.2490133),
        ("matrix", 0.9488462),
        ("neighbours", 1.2490133),
        ("size", 1.1424346),
    ],
    &[
        ("get", 0.11611506),
        ("graph", 0.9612023),
        ("intersection", 1.6592894),
        ("neighbours", 1.6592894),
        ("size", 1.5177015),
    ],
    &[
        ("ancestors", 1.103043),
    ...
    &[
        ("approximated", 0.6295017),
        ("get", 0.054285202),
        ("groups", 0.6295017),
        ("isomorphic", 0.4586754),
        ("node", 0.08377497),
        ("number", 0.37637618),
        ("of", 0.38482767),
        ("type", 0.24691305),
    ...
    &[("get", 0.3610085), ("transitivity", 5.9840407)],
    &[
        ("get", 0.087404445),
        ("node", 0.13488583),
        ("number", 0.6060022),
    ...
    &[
        ("clustering", 1.6592894),
        ("coefficient", 1.4205432),
        ("get", 0.11611506),
        ("node", 0.17919314),
        ("per", 1.6592894),
    ],
    &[
        ("clustering", 3.3414328),
        ("coefficient", 2.8606524),
        ("get", 0.23382944),
    ],
    &[
        ("average", 2.6632237),
        ("clustering", 2.2959588),
        ("coefficient", 1.9656059),
        ("get", 0.16066843),
    ],
    &[
        ("edge", 0.44965285),
    ...
    &[
        ...
        ("from", 0.18746355),
        ("get", 0.06797745),
        ("memberships", 1.0331067),
        ("modularity", 1.0331067),
        ("node", 0.10490537),
    ],
    &[
        ("community", 0.9714008),
    ...
    &[
        ("get", 0.23382944),
        ("nodes", 1.7374063),
        ("subsampled", 3.8759332),
    ],
    &[
        ("compatible", 2.1870255),
        ("has", 1.0903153),
        ("node", 0.24794957),
        ("vocabularies", 2.2959588),
    ],
    &[
        ("compatible", 1.5805632),
        ("has", 0.78797084),
        ("node", 0.17919314),
        ("types", 0.65819585),
        ("vocabularies", 1.6592894),
    ],
    &[
        ("compatible", 1.5805632),
        ("edge", 0.4122066),
    ...
    &[("compatible", 4.914063), ("is", 3.6486454)],
    &[
        ("adjacency", 2.6632237),
        ("has", 1.0903153),
        ("matrix", 1.7441863),
    ...
    &[
        ...
        ("must", 1.6798531),
        ("node", 0.24794957),
        ("ontologies", 2.1000438),
    ],
    &[
        ("be", 3.0563073),
        ("must", 2.4447808),
        ("undirected", 2.7816958),
    ],
    &[
        ("acyclic", 2.4418042),
        ("be", 2.1000438),
    ...
    &[
        ("be", 3.0563073),
        ("multigraph", 3.0563073),
        ("must", 2.4447808),
    ],
    &[
        ("be", 2.1000438),
        ("multigraph", 2.1000438),
        ("must", 1.6798531),
        ("not", 2.0276334),
    ],
    &[
    ...
    &[("remove", 2.8490632), ("tendrils", 5.4865294)],
    &[
        ("dendritic", 3.5536892),
        ("remove", 1.8453715),
        ("trees", 3.5536892),
    ...
    &[
        ...
        ("remove", 0.91637486),
        ("selfloops", 1.1931381),
        ("singleton", 0.97099245),
        ("with", 1.0627729),
    ],
    &[
        ("disconnected", 3.1828961),
        ("nodes", 1.7374063),
        ("remove", 1.8453715),
    ],
    &[("remove", 2.8490632), ("selfloops", 3.709536)],
    &[
        ("edges", 2.1401837),
        ("parallel", 3.0563073),
        ("remove", 1.8453715),
    ...
    &[("density", 5.9840407), ("get", 0.3610085)],
    &[
        ("get", 0.16066843),
        ("nodes", 1.1938032),
        ("rate", 2.0276334),
    ...
    &[
        ("destination", 1.9113533),
        ("get", 0.16066843),
        ("ids", 0.6656504),
        ("node", 0.24794957),
    ],
    &[
        ("destination", 1.381335),
        ("directed", 1.0023443),
        ("get", 0.11611506),
        ("ids", 0.4810655),
        ("node", 0.17919314),
    ...
    &[("components", 4.914063), ("remove", 2.8490632)],
    &[("add", 4.416552), ("selfloops", 3.709536)],
    &[("name", 2.3208745), ("set", 4.7186227)],
    &[
        ("all", 1.2866433),
        ("edge", 0.4122066),
        ("inplace", 1.0371865),
    ...
    &[
        ("components", 3.1828961),
        ("connected", 2.5910082),
        ("strongly", 3.8759332),
    ],
    &[("get", 0.3610085), ("tendrils", 5.4865294)],
    &[
        ("edges", 0.79999155),
        ("features", 1.4488072),
        ("from", 0.24103796),
    ...
    &[("directed", 3.116347), ("to", 3.8440857)],
    &[
        ("to", 2.4898593),
        ("triangular", 3.5536892),
        ("upper", 3.8759332),
    ],
    &[
        ("lower", 3.8759332),
    ...
    &[("bidiagonal", 5.9840407), ("to", 3.8440857)],
    &[("arrowhead", 5.9840407), ("to", 3.8440857)],
    &[("to", 3.8440857), ("transposed", 5.9840407)],
    &[("to", 3.8440857), ("undirected", 4.294651)],
    &[("complementary", 5.9840407), ("to", 3.8440857)],
    &[
        ("graph", 0.9612023),
        ("multi", 1.9247116),
        ("similarity", 1.9247116),
        ("structural", 1.7646917),
        ("to", 1.2364148),
    ],
    &[("dot", 5.9840407), ("to", 3.8440857)],
    &[("enable", 9.726576)],
    &[("all", 4.000249), ("disable", 5.9840407)],
    &[("report", 7.6697407)],
    &[
        ("overlap", 3.8759332),
        ("report", 3.0563073),
    ...
    &[("report", 4.7186227), ("textual", 5.4865294)],
    &[
        ("16", 0.9714008),
        ("base", 0.7532419),
        ("from", 0.18746355),
    ...
    &[
        ...
        ("ids", 0.28163108),
        ("node", 0.10490537),
        ("structural", 1.0331067),
        ("unchecked", 0.3874864),
    ],
    &[
        ("attachment", 1.2866433),
        ("get", 0.11611506),
        ("minimum", 1.4205432),
        ("preferential", 1.2866433),
        ("unchecked", 0.6618813),
    ],
    &[
        ("attachment", 1.2866433),
    ...
    &[
        ("attachment", 0.96850777),
        ("get", 0.087404445),
        ("minimum", 1.0692996),
        ("preferential", 0.96850777),
        ("unchecked", 0.49822453),
        ("weighted", 0.68358636),
    ],
    &[
    ...
    &[
        ("attachment", 0.7532419),
        ("from", 0.18746355),
        ("get", 0.06797745),
        ("ids", 0.28163108),
        ("node", 0.10490537),
        ("preferential", 0.7532419),
        ("unchecked", 0.3874864),
    ],
    &[
        ("attachment", 0.96850777),
    ...
    &[
        ("attachment", 0.6015213),
        ("from", 0.149704),
        ("get", 0.054285202),
        ("ids", 0.22490397),
        ("node", 0.08377497),
        ("preferential", 0.6015213),
        ("unchecked", 0.30943757),
        ("weighted", 0.42456222),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.054285202),
        ("ids", 0.22490397),
        ("intersection", 0.7757379),
        ("neighbours", 0.7757379),
        ("node", 0.08377497),
        ("size", 0.7095439),
        ("unchecked", 0.30943757),
    ],
    &[
        ("coefficient", 0.83163124),
        ("from", 0.18746355),
        ("get", 0.06797745),
        ("ids", 0.28163108),
        ("jaccard", 0.76992536),
    ...
    &[
        ("attachment", 1.7803284),
        ("get", 0.16066843),
        ("preferential", 1.7803284),
        ("scores", 2.1870255),
    ],
    &[
        ("allocation", 1.4205432),
        ("get", 0.11611506),
        ("index", 1.3151408),
        ("resource", 1.4205432),
        ("scores", 1.5805632),
    ...
    &[
        ("arborescence", 2.4418042),
        ("kruskal", 2.4418042),
        ("random", 1.5514354),
        ("spanning", 2.1870255),
    ],
    &[
        ("arborescence", 3.5536892),
        ("kruskal", 3.5536892),
        ("spanning", 3.1828961),
    ],
    &[
    ...
    &[
        ("betweenness", 3.0563073),
        ("centrality", 2.291097),
        ("get", 0.23382944),
    ],
    &[
        ("approximated", 0.7882797),
        ("betweenness", 0.8885108),
        ("centrality", 0.6660536),
        ("from", 0.18746355),
        ("get", 0.06797745),
        ("id", 0.31348988),
    ...
    &[
        ("centrality", 2.291097),
        ("eigenvector", 3.5536892),
        ("get", 0.23382944),
    ],
    &[
        ("centrality", 1.574254),
        ("eigenvector", 2.4418042),
        ("get", 0.16066843),
        ("weighted", 1.2565808),
    ],
    &[("overlaps", 9.726576)],
    ...
    &[("connected", 4.000249), ("holdout", 4.294651)],
    &[("holdout", 4.294651), ("random", 3.4859455)],
    &[
        ("get", 0.11611506),
        ("holdout", 1.381335),
        ("indices", 1.9247116),
    ...
    &[("has", 2.4498475), ("nodes", 2.682376)],
    &[("edges", 3.3042228), ("has", 2.4498475)],
    &[
        ("has", 1.5867949),
        ("nodes", 1.7374063),
        ("trap", 2.8606524),
    ],
    &[("directed", 3.116347), ("is", 3.6486454)],
    &[
        ("acyclic", 3.5536892),
        ("directed", 2.0184944),
        ("is", 2.3632703),
    ...
    &[
        ("edge", 0.4122066),
        ("has", 0.78797084),
        ("probabilities", 1.9247116),
        ("representing", 1.9247116),
        ("weights", 1.155121),
    ],
    &[
        ("has", 1.0903153),
    ...
    &[("has", 2.4498475), ("selfloops", 3.709536)],
    &[
        ("disconnected", 3.1828961),
        ("has", 1.5867949),
        ("nodes", 1.7374063),
    ...
    &[("connected", 4.000249), ("is", 3.6486454)],
    &[
        ("has", 1.5867949),
        ("node", 0.3608544),
        ("types", 1.3254575),
    ...
    &[("is", 3.6486454), ("multigraph", 4.7186227)],
    &[
        ("has", 1.5867949),
        ("node", 0.3608544),
        ("ontologies", 3.0563073),
    ...
    &[("has", 1.5867949), ("name", 1.5032575), ("node", 0.3608544)],
    &[
        ("has", 1.0903153),
        ("id", 0.7409504),
        ("node", 0.24794957),
