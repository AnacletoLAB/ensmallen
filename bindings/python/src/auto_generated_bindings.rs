...
impl Graph {
    ...
    ///     Minimum node degree for the topological synonims. By default equal to 2.
    ///
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("coo", 1.1663768),
        ("number", 0.49042624),
        ("laplacian", 0.94874674),
        ("matrix", 0.8759021),
    ],
    &[
        ("normalized", 0.76938474),
        ("walk", 0.8207425),
        ("get", 0.057782706),
        ("laplacian", 0.73102516),
        ("random", 0.57508457),
        ("transformed", 0.73102516),
        ("graph", 0.55243033),
    ],
    &[
        ("transformed", 0.94874674),
        ("normalized", 0.9985309),
        ("laplacian", 0.94874674),
        ("get", 0.07499216),
        ("graph", 0.71696097),
        ("symmetric", 1.0651846),
    ...
    &[
        ("transformed", 1.2761954),
        ("graph", 0.96441156),
        ("normalized", 1.3431621),
        ("get", 0.10087481),
        ("symmetric", 1.4328204),
    ],
    &[
    ...
    &[
        ...
        ("node", 0.44753295),
        ("from", 0.22301191),
        ("disconnected", 0.94874674),
        ("node_id", 0.45107046),
        ("unchecked", 0.40089002),
    ],
    &[
        ("is", 0.96441156),
        ("node_id", 0.6067521),
    ...
    &[
        ("singleton", 0.43400955),
        ("is", 0.55243033),
        ("unchecked", 0.30889243),
        ("from", 0.1718344),
        ("node_id", 0.3475573),
        ("with", 0.49230647),
        ("selfloops", 0.57508457),
    ],
    &[
        ("selfloops", 0.74636227),
        ("singleton", 0.5632708),
        ("is", 0.71696097),
        ("from", 0.22301191),
        ("node_id", 0.45107046),
    ...
    &[("has", 2.257739), ("node_name", 2.8092723)],
    &[("has", 2.257739), ("node_type_id", 3.4493833)],
    &[("node_type_name", 3.4493833), ("has", 2.257739)],
    &[("has", 2.257739), ("edge_type_id", 2.8482218)],
    &[("edge_type_name", 3.3057654), ("has", 2.257739)],
    &[
        ("has", 0.94555074),
        ("edge", 0.87500846),
        ("from", 0.4223033),
    ...
    &[
        ...
        ("has", 0.94555074),
        ("from", 0.4223033),
        ("node_names", 0.9542749),
    ],
    &[
        ("node_names", 0.50393796),
        ("from", 0.22301191),
        ("has", 0.49933088),
        ("edge", 0.4620786),
        ("edge_type_name", 0.73111665),
        ("and", 0.71696097),
    ],
    &[
        ("strongly", 3.294849),
    ...
    &[
        ("by", 0.8475545),
        ("sort", 0.94874674),
        ("decreasing", 1.0651846),
        ("node", 0.44753295),
        ("outbound", 0.94874674),
        ("degree", 0.6299244),
    ],
    &[
        ("lexicographic", 1.4328204),
        ("by", 1.140078),
        ("sort", 1.2761954),
        ("node", 0.6019937),
        ("order", 1.4328204),
    ...
    &[("remove", 2.888942), ("components", 4.289786)],
    &[("overlaps", 9.001431)],
    &[("contains", 8.220488)],
    &[
        ("get", 0.21184221),
    ...
    &[("edge", 2.0893018), ("encode", 5.2738066)],
    &[("decode", 5.2738066), ("edge", 2.0893018)],
    &[
        ("encodable", 1.568938),
        ("get", 0.10087481),
        ("max", 1.568938),
    ...
    &[("node_id", 2.0395281), ("validate", 3.7201347)],
    &[("node_ids", 1.7520932), ("validate", 3.7201347)],
    &[("edge_id", 2.6364896), ("validate", 3.7201347)],
    &[("edge_ids", 3.6205106), ("validate", 3.7201347)],
    &[
        ("contain", 1.2761954),
        ("unknown", 0.89949465),
        ("node_types", 0.7042052),
        ("not", 1.1782094),
        ("must", 1.0261787),
    ],
    &[
        ("contain", 1.2761954),
        ("edge_types", 0.74127406),
        ("not", 1.1782094),
        ("must", 1.0261787),
        ("unknown", 0.89949465),
    ],
    &[("validate", 3.7201347), ("node_type_id", 3.4493833)],
    &[("node_type_ids", 3.3057654), ("validate", 3.7201347)],
    &[("edge_type_id", 2.8482218), ("validate", 3.7201347)],
    &[("edge_type_ids", 3.8322425), ("validate", 3.7201347)],
    &[
        ("undirected", 2.5677812),
        ("be", 2.680075),
        ("must", 2.1550272),
    ],
    &[
    ...
    &[
        ("multigraph", 2.8207083),
        ("must", 2.1550272),
        ("be", 2.680075),
    ],
    &[
        ("multigraph", 1.8908536),
        ("not", 1.6586394),
        ("must", 1.4446163),
        ("be", 1.7965806),
    ],
    ...
    &[
        ...
        ("all", 1.5580082),
        ("set", 1.7213049),
        ("node_types", 0.9913539),
    ],
    &[
        ("set", 2.5677812),
        ("all", 2.324181),
        ("node_types", 1.4788665),
    ],
    &[
        ("remove", 1.8048875),
        ("inplace", 1.987993),
        ("node_type_ids", 2.0653007),
    ],
    &[
        ("inplace", 1.3326454),
        ("node_types", 0.9913539),
    ...
    &[
        ("node_type_name", 2.1550272),
        ("remove", 1.8048875),
        ("inplace", 1.987993),
    ],
    &[("remove", 2.888942), ("node_type_id", 3.4493833)],
    &[
        ("remove", 1.8048875),
        ("singleton", 1.5911602),
        ("node_types", 1.4788665),
    ...
    &[
        ("remove", 1.8048875),
        ("homogeneous", 2.3942213),
        ("node_types", 1.4788665),
    ],
    &[("node_type_name", 3.4493833), ("remove", 2.888942)],
    &[
        ("inplace", 1.987993),
        ("edge_type_name", 2.0653007),
        ("remove", 1.8048875),
    ],
    &[("edge_type_id", 2.8482218), ("remove", 2.888942)],
    &[
        ("remove", 1.8048875),
        ("singleton", 1.5911602),
        ("edge_types", 1.556713),
    ],
    &[("edge_type_name", 3.3057654), ("remove", 2.888942)],
    &[
        ("node_types", 1.4788665),
        ("remove", 1.8048875),
        ("inplace", 1.987993),
    ],
    &[("node_types", 2.3671057), ("remove", 2.888942)],
    &[
        ("edge_types", 1.556713),
        ("remove", 1.8048875),
        ("inplace", 1.987993),
    ],
    &[("edge_types", 2.4917085), ("remove", 2.888942)],
    &[
        ("inplace", 1.3326454),
        ("edge", 0.87500846),
        ("remove", 1.2099012),
    ...
    &[("get", 0.33907923), ("circles", 5.2738066)],
    &[
        ("memory", 2.1083674),
        ("get", 0.21184221),
        ("stats", 3.294849),
    ...
    &[
        ...
        ("nodes", 0.6973724),
        ("memory", 1.0039604),
        ("requirement", 1.2761954),
    ],
    &[
        ("nodes", 0.39946607),
        ("requirement", 0.73102516),
        ("human", 0.70039564),
        ("get", 0.057782706),
        ("total", 0.57508457),
        ("memory", 0.57508457),
    ...
    &[
        ...
        ("memory", 1.0039604),
        ("node_types", 0.7042052),
        ("requirements", 1.1782094),
        ("total", 1.0039604),
    ],
    &[
        ("memory", 0.57508457),
        ("requirements", 0.6748972),
        ("total", 0.57508457),
        ("readable", 0.70039564),
        ("node_types", 0.40338),
        ("get", 0.057782706),
    ...
    &[("get", 0.33907923), ("transitivity", 5.2738066)],
    &[
        ("per", 1.0651846),
        ("get", 0.07499216),
        ("of", 0.8227603),
    ...
    &[
        ("coefficient", 1.1782094),
        ("per", 1.4328204),
        ("node", 0.6019937),
        ("get", 0.10087481),
        ("clustering", 1.3431621),
    ],
    &[
        ("get", 0.21184221),
        ("coefficient", 2.4742992),
        ("clustering", 2.8207083),
    ],
    &[
        ("coefficient", 1.6586394),
        ("get", 0.14200781),
        ("average", 2.2086926),
        ("clustering", 1.8908536),
    ],
    &[
        ("nodes", 1.4645172),
        ("remappable", 3.294849),
    ...
    &[
        ("remap", 2.680075),
        ("from", 0.629977),
        ("node_names", 1.4235533),
    ],
    &[("remap", 2.680075), ("graph", 2.025313), ("from", 0.629977)],
    &[("sample", 5.2738066), ("negatives", 5.2738066)],
    &[("connected", 3.5308661), ("holdout", 3.7201347)],
    &[("random", 3.3746989), ("holdout", 3.7201347)],
    &[
        ("label", 1.0770885),
        ("get", 0.10087481),
        ("node", 0.6019937),
    ...
    &[("get", 0.33907923), ("chains", 5.2738066)],
    &[
        ("parallel", 0.4506136),
        ("get", 0.037175667),
        ("from", 0.110553116),
        ("first", 0.3969423),
        ("node_id", 0.22360797),
        ("unchecked", 0.19873215),
        ("breadth", 0.3969423),
        ("predecessors", 0.57820493),
        ("search", 0.3969423),
    ],
    &[
        ("from", 0.110553116),
    ...
    &[
        ...
        ("from", 0.1718344),
        ("shortest", 0.53270805),
        ("node_names", 0.73189956),
        ("get", 0.057782706),
        ("path", 0.55243033),
    ],
    &[
        ("from", 0.110553116),
        ("eccentricity", 0.43420866),
        ("unchecked", 0.19873215),
        ("distant", 0.5280412),
        ("and", 0.35541716),
        ("most", 0.47031972),
    ...
    &[("diameter", 4.514887), ("get", 0.33907923)],
    &[
        ("naive", 2.0170715),
        ("get", 0.14200781),
        ("diameter", 1.8908536),
    ...
    &[
        ("node_names", 0.6778662),
        ("singleton", 0.7576771),
        ("get", 0.10087481),
        ("selfloops", 1.0039604),
        ("with", 0.85944957),
    ],
    &[("density", 5.2738066), ("get", 0.33907923)],
    &[
        ("trap", 1.6586394),
        ("rate", 1.6586394),
        ("get", 0.14200781),
    ...
    &[
        ("get", 0.14200781),
        ("undirected", 1.7213049),
        ("edges", 1.2277675),
        ("number", 0.9286886),
    ],
    &[
        ("number", 0.6596911),
        ("undirected", 1.2227236),
        ("unique", 1.0504196),
        ("edges", 0.87214077),
        ("get", 0.10087481),
    ],
    ...
    &[("get", 0.33907923), ("source_names", 5.2738066)],
    &[
        ("node_ids", 1.0946329),
        ("destination", 2.4742992),
        ("get", 0.21184221),
    ],
    &[
        ("directed", 1.4787418),
        ("get", 0.14200781),
        ("node_ids", 0.733784),
        ("destination", 1.6586394),
    ],
    &[("get", 0.33907923), ("destination_names", 5.2738066)],
    &[("get", 0.33907923), ("node_names", 2.2785704)],
    &[("node", 1.2642171), ("get", 0.21184221), ("urls", 3.294849)],
    &[
        ("ontologies", 3.294849),
        ("node", 1.2642171),
        ("get", 0.21184221),
    ],
    &[("node_ids", 1.7520932), ("get", 0.33907923)],
    &[("get", 0.33907923), ("edge_type_ids", 3.8322425)],
    &[
        ("edge_type_ids", 2.3942213),
        ("get", 0.21184221),
        ("unique", 2.2059343),
    ],
    &[("edge_type_names", 3.960417), ("get", 0.33907923)],
    &[
        ("get", 0.21184221),
        ("unique", 2.2059343),
        ("edge_type_names", 2.4742992),
    ],
    &[
        ("edge", 1.3053064),
        ("get", 0.21184221),
    ...
    &[("node_type_ids", 3.3057654), ("get", 0.33907923)],
    &[
        ("node_types", 0.9913539),
        ("known", 1.3091928),
        ("mask", 1.6586394),
    ...
    &[
        ("one", 0.94874674),
        ("encoded", 0.94874674),
        ("edge_types", 0.55107653),
        ("known", 0.6913647),
        ("get", 0.07499216),
        ("hot", 0.94874674),
    ],
    &[("get", 0.33907923), ("node_type_names", 3.3746989)],
    &[
        ("node_type_ids", 2.0653007),
        ("get", 0.21184221),
        ("unique", 2.2059343),
    ...
    &[
        ("hashmap", 1.7965806),
        ("edge_type_id", 1.1928474),
        ("counts", 1.7965806),
        ("get", 0.14200781),
    ],
    &[
        ("edge_type_names", 1.6586394),
        ("hashmap", 1.7965806),
        ("get", 0.14200781),
        ("counts", 1.7965806),
    ],
    ...
    &[("to", 3.4493833), ("directed", 3.5308661)],
    &[
        ("to", 2.1550272),
        ("triangular", 3.0089953),
        ("upper", 3.294849),
    ],
    &[
        ("triangular", 3.0089953),
    ...
    &[("to", 3.4493833), ("bidiagonal", 5.2738066)],
    &[("arrowhead", 5.2738066), ("to", 3.4493833)],
    &[("to", 3.4493833), ("transposed", 5.2738066)],
    &[("to", 3.4493833), ("complementary", 5.2738066)],
    &[("report", 7.015104)],
    &[
        ("report", 2.5677812),
        ("overlap", 3.294849),
    ...
    &[("report", 4.1100464), ("textual", 4.816263)],
    &[
        ("graph", 1.3576628),
        ("connected", 1.4787418),
        ("generate", 1.4446163),
    ...
    &[("replace", 9.001431)],
    &[("filter", 4.816263), ("from_ids", 5.2738066)],
    &[("filter", 4.816263), ("from_names", 5.2738066)],
    &[
        ("node_types", 1.4788665),
        ("unknown", 1.8889841),
        ("drop", 2.2059343),
    ...
    &[("tendrils", 4.816263), ("drop", 3.5308661)],
    &[
        ("drop", 2.2059343),
        ("dendritic", 3.0089953),
        ("trees", 3.0089953),
    ...
    &[
        ("nodes", 1.4645172),
        ("drop", 2.2059343),
        ("disconnected", 2.680075),
    ],
    &[("selfloops", 3.3746989), ("drop", 3.5308661)],
    &[
        ("parallel", 2.5677812),
        ("edges", 1.8315396),
        ("drop", 2.2059343),
    ...
    &[("enable", 9.001431)],
    &[("disable", 5.2738066), ("all", 3.7201347)],
    &[("is", 3.2417598), ("compatible", 5.2738066)],
    &[
        ("has", 0.94555074),
        ("same", 2.2086926),
        ("adjacency", 1.8908536),
    ...
    &[("nodes", 2.3441381), ("has", 2.257739)],
    &[("has", 2.257739), ("edges", 2.9316022)],
    &[
        ("has", 1.4105389),
        ("trap", 2.4742992),
        ("nodes", 1.4645172),
    ],
    &[("is", 3.2417598), ("directed", 3.5308661)],
    &[
        ("has", 1.4105389),
        ("weights", 2.025313),
        ("edge", 1.3053064),
    ...
    &[
        ("representing", 1.568938),
        ("probabilities", 1.568938),
        ("weights", 0.96441156),
        ("edge", 0.62155956),
        ("has", 0.671669),
    ],
    ...
    &[("has", 2.257739), ("edge_types", 2.4917085)],
    &[("selfloops", 3.3746989), ("has", 2.257739)],
    &[
        ("disconnected", 2.680075),
        ("nodes", 1.4645172),
        ("has", 1.4105389),
    ...
    &[("connected", 3.5308661), ("is", 3.2417598)],
    &[("node_types", 2.3671057), ("has", 2.257739)],
    &[
        ("has", 1.4105389),
        ("node_types", 1.4788665),
        ("multilabel", 3.0089953),
    ],
    &[
        ("has", 1.4105389),
        ("node_types", 1.4788665),
    ...
    &[("multigraph", 4.514887), ("is", 3.2417598)],
    &[
        ("has", 0.30504483),
        ("degree", 0.38482538),
        ("outbound", 0.5795962),
        ("decreasing", 0.65072894),
        ("nodes", 0.31671825),
        ("by", 0.51777714),
        ("node", 0.2734011),
        ("sorted", 0.61000973),
    ...
    &[
        ("from", 0.29998183),
        ("edge_type_id", 0.8473354),
        ("edge_type_name", 0.9834529),
        ("unchecked", 0.53925246),
        ("get", 0.10087481),
    ],
    &[
    ...
    &[
        ...
        ("node_id", 0.6067521),
        ("get", 0.10087481),
        ("destination", 1.1782094),
        ("edge_id", 0.7843459),
    ],
    &[
        ("get", 0.07499216),
        ("from", 0.22301191),
        ("node_name", 0.62131023),
        ("edge_id", 0.5830969),
        ("unchecked", 0.40089002),
        ("source", 0.7809009),
    ],
    ...
    &[
        ...
        ("edge_id", 0.23909032),
        ("and", 0.5694567),
        ("unchecked", 0.16437906),
        ("from", 0.09144276),
        ("edge_type_id", 0.25829124),
        ("weight", 0.31280765),
    ],
    &[
        ("edge", 0.22906502),
    ...
    &[
        ...
        ("degree", 0.48536727),
        ("node_id", 0.3475573),
        ("comulative", 0.8207425),
        ("node", 0.34483162),
        ("from", 0.1718344),
    ],
    &[
        ("comulative", 1.0651846),
        ("from", 0.22301191),
        ("get", 0.07499216),
        ("degree", 0.6299244),
        ("node_id", 0.45107046),
    ...
    &[
        ("get", 0.10087481),
        ("node_type_ids", 0.9834529),
        ("node_id", 0.6067521),
        ("unchecked", 0.53925246),
        ("from", 0.29998183),
    ],
    &[
        ("node_type_ids", 1.3844686),
        ("from", 0.4223033),
        ("get", 0.14200781),
        ("node_id", 0.85416305),
    ],
    ...
    &[("tendrils", 4.816263), ("get", 0.33907923)],
    &[
        ("geometric", 1.1663768),
        ("threshold", 1.1663768),
        ("distribution", 1.1663768),
        ("degree", 0.6299244),
        ("node", 0.44753295),
        ("get", 0.07499216),
    ],
    ...
    &[("selfloops", 3.3746989), ("add", 5.2738066)],
    &[
        ("get", 0.21184221),
        ("degree", 1.7794472),
        ("centrality", 1.8889841),
    ],
    &[
        ("degree", 1.1928474),
        ("weighted", 0.9723565),
        ("get", 0.14200781),
        ("centrality", 1.2662752),
    ],
    &[
        ("unchecked", 0.40089002),
        ("get", 0.07499216),
        ("centrality", 0.6687005),
        ("from", 0.22301191),
        ("node_id", 0.45107046),
        ("closeness", 0.94874674),
    ],
    &[
        ("from", 0.1718344),
        ("node_id", 0.3475573),
        ("unchecked", 0.30889243),
        ("weighted", 0.39564997),
        ("centrality", 0.5152449),
        ("get", 0.057782706),
        ("closeness", 0.73102516),
    ],
    &[
        ("centrality", 1.8889841),
        ("get", 0.21184221),
    ...
    &[
        ...
        ("centrality", 0.6687005),
        ("from", 0.22301191),
        ("betweenness", 0.9089948),
        ("get", 0.07499216),
        ("approximated", 0.9089948),
    ],
    &[
        ("get", 0.07499216),
        ("centrality", 0.6687005),
    ...
    &[
        ("get", 0.057782706),
        ("node_id", 0.3475573),
        ("betweenness", 0.70039564),
        ("weighted", 0.39564997),
        ("approximated", 0.70039564),
        ("from", 0.1718344),
        ("centrality", 0.5152449),
    ],
    &[
        ...
        ("betweenness", 0.70039564),
        ("get", 0.057782706),
        ("node_name", 0.47872987),
        ("approximated", 0.70039564),
    ],
    &[
        ("centrality", 1.8889841),
        ("get", 0.21184221),
        ("eigenvector", 3.0089953),
    ],
    &[
        ("get", 0.14200781),
        ("weighted", 0.9723565),
        ("centrality", 1.2662752),
        ("eigenvector", 2.0170715),
    ],
    &[("dot", 5.2738066), ("to", 3.4493833)],
    &[("stars", 5.2738066), ("get", 0.33907923)],
    &[
        ("detection", 1.568938),
        ("get", 0.10087481),
        ("undirected", 1.2227236),
    ...
    &[
        ("from", 0.1718344),
        ("memberships", 0.8207425),
        ("node", 0.34483162),
        ("directed", 0.60169715),
        ("community", 0.76938474),
        ("get", 0.057782706),
        ("modularity", 0.8207425),
    ],
    &[
        ("undirected", 0.70039564),
        ("modularity", 0.8207425),
        ("from", 0.1718344),
        ("get", 0.057782706),
        ("memberships", 0.8207425),
    ...
    &[
        ("unchecked", 0.53925246),
        ("minimum", 1.140078),
        ("preferential", 1.0504196),
        ("attachment", 1.0504196),
        ("get", 0.10087481),
    ],
    &[
        ("maximum", 1.1067263),
    ...
    &[
        ("get", 0.07499216),
        ("attachment", 0.7809009),
        ("preferential", 0.7809009),
        ("weighted", 0.51348656),
        ("unchecked", 0.40089002),
        ("minimum", 0.8475545),
    ],
    ...
    &[
        ("from", 0.1718344),
        ("get", 0.057782706),
        ("attachment", 0.60169715),
        ("weighted", 0.39564997),
        ("preferential", 0.60169715),
        ("unchecked", 0.30889243),
        ("node_ids", 0.2985753),
    ],
    &[
...
pub const SHORTESTPATHSDJKSTRA_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[("eccentricity", 1.8113003), ("get", 0.13327588)],
    &[
        ("most", 0.76631933),
        ("node", 0.76631933),
        ("distant", 0.76631933),
...
pub const SHORTESTPATHSRESULTBFS_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[("get", 0.09465378), ("eccentricity", 2.0685964)],
    &[
        ("get", 0.039721824),
        ("most", 0.6755088),
        ("node", 0.6755088),
    ...
    &[("distances", 2.0685964), ("get", 0.09465378)],
    ...
    fn __getattr__(&self, name: String) -> PyResult<()> {
        ...
        let mut doc_scores = DENDRITICTREE_TFIDF_FREQUENCIES
            ...
            .map(|(id, frequencies_doc)| {
                (
                    id,
                    (jaro_winkler(&name, DENDRITICTREE_METHODS_NAMES[id]).exp() - 1.0)
                        * frequencies_doc
                            .iter()
                            .map(|(term, weight)| {
                                match tokens_expanded.iter().find(|(token, _)| token == term) {
