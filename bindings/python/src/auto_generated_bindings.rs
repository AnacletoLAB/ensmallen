...
pub fn register_ensmallen(_py: Python, _m: &PyModule) -> PyResult<()> {
    ...
    env_logger::init();
    let submod = PyModule::new(_py, "data_structures")?;
    register_data_structures(_py, submod)?;
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    &[
        ("connected", 0.95567966),
        ("from", 0.24655636),
        ("id", 0.3992757),
        ("is", 0.87077296),
        ("node", 0.1396166),
        ("unchecked", 0.49511746),
    ],
    &[
        ("connected", 1.2698566),
        ("from", 0.32761103),
    ...
    &[
        ("disconnected", 0.91475),
        ("from", 0.19172625),
        ("id", 0.3104833),
        ("is", 0.6771273),
        ("node", 0.20233452),
        ("unchecked", 0.38501143),
    ],
    &[
        ("from", 0.24655636),
        ("id", 0.3992757),
    ...
    &[
        ...
        ("node", 0.086689755),
        ("selfloops", 0.5812174),
        ("singleton", 0.44624558),
        ("unchecked", 0.30742484),
        ("with", 0.48903123),
    ],
    &[
        ("from", 0.19172625),
        ...
        ("is", 0.6771273),
        ("node", 0.10856815),
        ("selfloops", 0.72790265),
        ("singleton", 0.55886716),
        ("with", 0.6124509),
    ],
    &[
        ("from", 0.24655636),
    ...
    &[
        ...
        ("node", 0.05877748),
        ("type", 0.16258974),
        ("unchecked", 0.20844053),
    ],
    &[
        ("components", 3.1497478),
        ("connected", 2.558887),
        ("strongly", 3.841582),
    ],
    &[
    ...
    &[
        ("coo", 1.0006139),
        ("get", 0.090921186),
        ("intersection", 1.2354579),
        ("matrix", 0.93606913),
        ("neighbours", 1.2354579),
        ("size", 1.1291555),
    ],
    &[
        ("get", 0.12081126),
        ("graph", 0.9451942),
        ("intersection", 1.6416111),
        ("neighbours", 1.6416111),
        ("size", 1.500362),
    ],
    &[
        ("ancestors", 1.089866),
    ...
    &[("components", 4.8655353), ("remove", 2.802996)],
    &[("overlaps", 9.652453)],
    &[("contains", 8.844181)],
    &[
        ("bipartite", 2.9181788),
    ...
    &[("edges", 2.108845), ("get", 0.2434467), ("star", 3.3080094)],
    &[
        ("edge", 0.5548262),
        ("get", 0.16721232),
        ("names", 0.8848123),
    ...
    &[
        ...
        ("must", 1.6573193),
        ("node", 0.2567676),
        ("ontologies", 2.0766196),
    ],
    &[
        ("be", 3.0233786),
        ("must", 2.4129136),
        ("undirected", 2.7492437),
    ],
    &[
        ("acyclic", 2.4176557),
        ("be", 2.0766196),
    ...
    &[
        ("be", 3.0233786),
        ("multigraph", 3.0233786),
        ("must", 2.4129136),
    ],
    &[
        ("be", 2.0766196),
        ("multigraph", 2.0766196),
        ("must", 1.6573193),
        ("not", 2.0043626),
    ],
    &[
    ...
    &[
        ("inplace", 1.0209966),
        ("isomorphic", 1.0892026),
        ("node", 0.18551515),
        ("remove", 0.90047395),
        ("types", 0.64291257),
    ],
    &[
        ("isomorphic", 1.5075424),
        ("node", 0.2567676),
        ("remove", 1.246327),
        ("types", 0.8898418),
    ],
    ...
    &[("circles", 5.934238), ("get", 0.37606138)],
    &[
        ("get", 0.2434467),
        ("memory", 2.5063787),
        ("stats", 3.841582),
    ...
    &[("get", 0.37606138), ("transitivity", 5.934238)],
    &[
        ("get", 0.090921186),
        ("node", 0.1396166),
        ("number", 0.61239034),
    ...
    &[
        ("clustering", 1.6416111),
        ("coefficient", 1.4034362),
        ("get", 0.12081126),
        ("node", 0.18551515),
        ("per", 1.7467613),
    ],
    &[
        ("clustering", 3.3080094),
        ("coefficient", 2.8280632),
        ("get", 0.2434467),
    ],
    &[
        ("average", 2.6386058),
        ("clustering", 2.2721195),
        ("coefficient", 1.9424665),
        ("get", 0.16721232),
    ],
    &[
        ("are", 3.841582),
    ...
    &[("connected", 3.95281), ("holdout", 4.2468615)],
    &[("holdout", 4.2468615), ("random", 3.49033)],
    &[
        ("get", 0.12081126),
        ("holdout", 1.3643217),
        ("indices", 1.9063984),
    ...
    &[("chains", 5.934238), ("get", 0.37606138)],
    &[
        ("breadth", 0.42125052),
        ("first", 0.42125052),
        ("from", 0.10379827),
    ...
    &[
        ("and", 0.30926716),
        ("distant", 0.46689597),
        ("eccentricity", 0.38708112),
        ("from", 0.08756793),
        ("get", 0.03229193),
        ("id", 0.27444673),
        ("most", 0.41779757),
        ("node", 0.09596707),
        ("unchecked", 0.17584787),
    ],
    &[
        ("eccentricity", 0.84749764),
        ("from", 0.19172625),
        ("get", 0.0707018),
        ("id", 0.3104833),
        ("node", 0.10856815),
    ...
    &[("four", 3.841582), ("get", 0.2434467), ("sweep", 3.841582)],
    &[
        ("diameter", 3.5198975),
        ("get", 0.2434467),
        ("naive", 3.841582),
    ],
    &[("diameter", 5.4373198), ("get", 0.37606138)],
    &[
        ("breadth", 0.77809376),
        ("first", 0.77809376),
        ("from", 0.19172625),
    ...
    &[("density", 5.934238), ("get", 0.37606138)],
    &[
        ("get", 0.16721232),
        ("nodes", 1.1722994),
        ("rate", 2.0043626),
    ...
    &[
        ("destination", 1.888329),
        ("get", 0.16721232),
        ("ids", 0.67500514),
        ("node", 0.2567676),
    ],
    &[
        ("destination", 1.3643217),
        ("directed", 0.9862377),
        ("get", 0.12081126),
        ("ids", 0.48769262),
        ("node", 0.18551515),
    ...
    &[("get", 0.2434467), ("node", 0.37383145), ("urls", 3.841582)],
    &[
        ("get", 0.2434467),
        ("node", 0.37383145),
        ("ontologies", 3.0233786),
    ],
    &[
        ("from", 0.24655636),
        ("get", 0.090921186),
    ...
    &[("get", 0.2434467), ("ids", 0.9827491), ("node", 0.37383145)],
    &[
        ("directed", 0.9862377),
        ("edge", 0.4008631),
        ("get", 0.12081126),
    ...
    &[("directed", 3.0699613), ("to", 3.7968328)],
    &[
        ("to", 2.4579136),
        ("triangular", 3.5198975),
        ("upper", 3.841582),
    ],
    &[
        ("lower", 3.841582),
    ...
    &[("bidiagonal", 5.934238), ("to", 3.7968328)],
    &[("arrowhead", 5.934238), ("to", 3.7968328)],
    &[("to", 3.7968328), ("transposed", 5.934238)],
    &[("to", 3.7968328), ("undirected", 4.2468615)],
    &[("complementary", 5.934238), ("to", 3.7968328)],
    &[
        ("graph", 0.9451942),
        ("multi", 1.9063984),
        ("similarity", 1.9063984),
        ("structural", 1.7467613),
        ("to", 1.2197481),
    ],
    &[
        ("approximated", 2.6161752),
        ("cliques", 3.5198975),
        ("get", 0.2434467),
    ],
    &[("clique", 2.8280632), ("get", 0.2434467), ("max", 3.841582)],
    &[
        ("approximated", 1.298286),
        ("cliques", 1.7467613),
        ("get", 0.12081126),
        ("number", 0.8137119),
        ("of", 0.83325),
    ...
    &[("report", 4.6703277), ("textual", 5.4373198)],
    &[
        ("connected", 1.7575817),
        ("generate", 1.7575817),
        ("graph", 1.3082234),
    ...
    &[("remove", 2.802996), ("tendrils", 5.4373198)],
    &[
        ("dendritic", 3.5198975),
        ("remove", 1.8145444),
        ("trees", 3.5198975),
    ...
    &[
        ("disconnected", 3.1497478),
        ("nodes", 1.7067666),
        ("remove", 1.8145444),
    ],
    &[("remove", 2.802996), ("selfloops", 3.8716984)],
    &[
        ("edges", 2.108845),
        ("parallel", 3.0233786),
        ("remove", 1.8145444),
    ...
    &[
        ("arborescence", 2.4176557),
        ("kruskal", 2.4176557),
        ("random", 1.551944),
        ("spanning", 2.2721195),
    ],
    &[
        ("arborescence", 3.5198975),
        ("kruskal", 3.5198975),
        ("spanning", 3.3080094),
    ],
    &[
    ...
    &[("enable", 9.652453)],
    &[("all", 3.95281), ("disable", 5.934238)],
    &[
        ("compatible", 2.1634169),
        ("has", 1.0690308),
        ("node", 0.2567676),
        ("vocabularies", 2.2721195),
    ],
    &[
        ("compatible", 1.5630733),
        ("has", 0.772377),
        ("node", 0.18551515),
        ("types", 0.64291257),
        ("vocabularies", 1.6416111),
    ],
    &[
        ("compatible", 1.5630733),
        ("edge", 0.4008631),
    ...
    &[("compatible", 4.8655353), ("is", 3.6016254)],
    &[
        ("adjacency", 2.6386058),
        ("has", 1.0690308),
        ("matrix", 1.7215161),
    ...
    &[("has", 2.4042556), ("nodes", 2.6365073)],
    &[("edges", 3.257613), ("has", 2.4042556)],
    &[
        ("has", 1.5564164),
        ("nodes", 1.7067666),
        ("trap", 2.8280632),
    ],
    &[("directed", 3.0699613), ("is", 3.6016254)],
    &[
        ("acyclic", 3.5198975),
        ("directed", 1.9873669),
        ("is", 2.3315444),
    ...
    &[
        ("edge", 0.4008631),
        ("has", 0.772377),
        ("probabilities", 1.9063984),
        ("representing", 1.9063984),
        ("weights", 1.1386489),
    ],
    &[
        ("has", 1.0690308),
    ...
    &[("has", 2.4042556), ("selfloops", 3.8716984)],
    &[
        ("disconnected", 3.1497478),
        ("has", 1.5564164),
        ("nodes", 1.7067666),
    ...
    &[("connected", 3.95281), ("is", 3.6016254)],
    &[
        ("has", 1.5564164),
        ("node", 0.37383145),
        ("types", 1.2955327),
    ...
    &[("is", 3.6016254), ("multigraph", 4.6703277)],
    &[
        ("has", 1.5564164),
        ("node", 0.37383145),
        ("ontologies", 3.0233786),
    ...
    &[("get", 0.37606138), ("tendrils", 5.4373198)],
    &[
        ("degree", 0.7978276),
        ("distribution", 1.4347339),
        ("geometric", 1.4347339),
        ("get", 0.090921186),
        ("node", 0.1396166),
        ("threshold", 1.4347339),
    ...
    &[("add", 4.368617), ("selfloops", 3.8716984)],
    &[
        ("centrality", 2.2594962),
        ("degree", 2.136229),
        ("get", 0.2434467),
    ],
    &[
    ...
    &[
        ("betweenness", 3.0233786),
        ("centrality", 2.2594962),
        ("get", 0.2434467),
    ],
    &[
        ("approximated", 0.75978976),
        ("betweenness", 0.8780498),
        ("centrality", 0.65620303),
        ("from", 0.19172625),
        ("get", 0.0707018),
        ("id", 0.3104833),
    ...
    &[
        ("approximated", 0.6066787),
        ("betweenness", 0.70110726),
        ("centrality", 0.52396655),
        ("from", 0.15309003),
        ("get", 0.05645414),
        ("id", 0.24791545),
    ...
    &[
        ("centrality", 2.2594962),
        ("eigenvector", 3.5198975),
        ("get", 0.2434467),
    ],
    &[
        ("centrality", 1.551944),
        ("eigenvector", 2.4176557),
        ("get", 0.16721232),
        ("weighted", 1.234944),
    ],
    &[("dot", 5.934238), ("to", 3.7968328)],
    &[("get", 0.37606138), ("stars", 5.934238)],
    &[
        ("community", 1.6416111),
        ("detection", 1.9063984),
        ("get", 0.12081126),
    ...
    &[
        ...
        ("from", 0.19172625),
        ("get", 0.0707018),
        ("memberships", 1.0222489),
        ("modularity", 1.0222489),
        ("node", 0.10856815),
    ],
    &[
        ("community", 0.9607123),
    ...
    &[
        ...
        ("ids", 0.28541005),
        ("node", 0.10856815),
        ("structural", 1.0222489),
        ("unchecked", 0.38501143),
    ],
    &[
        ("attachment", 1.2698566),
        ("get", 0.12081126),
        ("minimum", 1.4034362),
        ("preferential", 1.2698566),
        ("unchecked", 0.65788585),
    ],
    &[
        ("attachment", 1.2698566),
    ...
    &[
        ("attachment", 0.95567966),
        ("get", 0.090921186),
        ("minimum", 1.0562102),
        ("preferential", 0.95567966),
        ("unchecked", 0.49511746),
        ("weighted", 0.671497),
    ],
    &[
    ...
    &[
        ("attachment", 0.74315214),
        ("from", 0.19172625),
        ("get", 0.0707018),
        ("ids", 0.28541005),
        ("node", 0.10856815),
        ("preferential", 0.74315214),
        ("unchecked", 0.38501143),
    ],
    &[
        ("attachment", 0.95567966),
    ...
    &[
        ("attachment", 0.59339386),
        ("from", 0.15309003),
        ("get", 0.05645414),
        ("ids", 0.22789489),
        ("node", 0.086689755),
        ("preferential", 0.59339386),
        ("unchecked", 0.30742484),
        ("weighted", 0.41694117),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.05645414),
        ("ids", 0.22789489),
        ("intersection", 0.76711184),
        ("neighbours", 0.76711184),
        ("node", 0.086689755),
        ("size", 0.70110726),
        ("unchecked", 0.30742484),
    ],
    &[
        ("coefficient", 0.8213263),
        ("from", 0.19172625),
        ("get", 0.0707018),
        ("ids", 0.28541005),
        ("jaccard", 0.75978976),
    ...
    &[
        ("attachment", 1.7575817),
        ("get", 0.16721232),
        ("preferential", 1.7575817),
        ("scores", 2.1634169),
    ],
    &[
        ("allocation", 1.4034362),
        ("get", 0.12081126),
        ("index", 1.298286),
        ("resource", 1.4034362),
        ("scores", 1.5630733),
...
pub fn register_data_structures(_py: Python, _m: &PyModule) -> PyResult<()> {
    Ok(())
}
