...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[("remove", 2.843955), ("tendrils", 5.481868)],
    &[
        ("dendritic", 3.550945),
        ("remove", 1.8422056),
        ("trees", 3.550945),
    ...
    &[
        ("disconnected", 3.1800604),
        ("nodes", 1.7342137),
        ("remove", 1.8422056),
    ],
    &[("remove", 2.843955), ("selfloops", 3.7045736)],
    &[
        ("edges", 2.1370904),
        ("parallel", 3.05344),
        ("remove", 1.8422056),
    ],
    &[("chains", 5.979463), ("get", 0.36358845)],
    &[("circles", 5.979463), ("get", 0.36358845)],
    &[
        ("approximated", 2.5354137),
        ("cliques", 3.550945),
        ("get", 0.23551874),
    ],
    &[
    ...
    &[
        ("coo", 1.012579),
        ("get", 0.08804665),
        ("intersection", 1.2481202),
        ("matrix", 0.94784254),
        ("neighbours", 1.2481202),
        ("size", 1.1415023),
    ],
    &[
        ("get", 0.1169649),
        ("graph", 0.9597312),
        ("intersection", 1.6580558),
        ("neighbours", 1.6580558),
        ("size", 1.51642),
    ],
    &[
        ("ancestors", 1.1020962),
    ...
    &[
        ...
        ("node", 0.05804403),
        ("parallel", 0.48080534),
        ("predecessors", 0.6098983),
        ("search", 0.42650235),
        ("unchecked", 0.20936137),
    ],
    &[
        ("breadth", 0.42650235),
        ("distances", 0.5007434),
    ...
    &[
        ("and", 0.3135602),
        ("distant", 0.47174808),
        ("eccentricity", 0.39165017),
        ("from", 0.085207805),
        ("get", 0.031289),
        ("id", 0.27636126),
        ("most", 0.42247555),
        ("node", 0.09476553),
        ("unchecked", 0.17663749),
    ],
    &[
        ("eccentricity", 0.8571568),
        ("from", 0.1864839),
        ("get", 0.068478405),
        ("id", 0.31255946),
        ("node", 0.107178055),
        ("unchecked", 0.38658488),
        ("weighted", 0.5308035),
    ],
    &[
        ("and", 0.3716504),
        ("distant", 0.5591442),
        ("eccentricity", 0.46420732),
        ("from", 0.10099342),
        ("get", 0.037085604),
        ("id", 0.32560295),
        ("most", 0.5007434),
    ...
    &[("diameter", 5.481868), ("get", 0.36358845)],
    &[
        ("breadth", 0.7875348),
        ("first", 0.7875348),
        ("from", 0.1864839),
    ...
    &[
        ("approximated", 0.58870924),
        ("get", 0.05468617),
        ("groups", 0.58870924),
        ("isomorphic", 0.4962208),
        ("node", 0.08559132),
        ("number", 0.37297544),
        ("of", 0.38127074),
        ("type", 0.24617283),
    ...
    &[("get", 0.36358845), ("transitivity", 5.979463)],
    &[
        ("get", 0.08804665),
        ("node", 0.13780503),
        ("number", 0.6005035),
    ...
    &[
        ("clustering", 1.6580558),
        ("coefficient", 1.4192286),
        ("get", 0.1169649),
        ("node", 0.18306604),
        ("per", 1.6580558),
    ],
    &[
        ("clustering", 3.338636),
        ("coefficient", 2.857737),
        ("get", 0.23551874),
    ],
    &[
        ("average", 2.6615381),
        ("clustering", 2.2941625),
        ("coefficient", 1.9637101),
        ("get", 0.16183802),
    ],
    &[
        ("edge", 0.45152056),
    ...
    &[
        ("community", 0.97072726),
        ("directed", 0.5859806),
        ("from", 0.1864839),
        ("get", 0.068478405),
        ("memberships", 1.0324574),
        ("modularity", 1.0324574),
        ("node", 0.107178055),
    ],
    &[
        ("community", 0.97072726),
    ...
    &[
        ("get", 0.23551874),
        ("nodes", 1.7342137),
        ("subsampled", 3.8732684),
    ],
    &[
        ("compatible", 2.1851964),
        ("has", 1.0881557),
        ("node", 0.2532986),
        ("vocabularies", 2.2941625),
    ],
    &[
        ("compatible", 1.579303),
        ("has", 0.78644073),
    ...
    &[("compatible", 4.9093046), ("is", 3.6436725)],
    &[
        ("adjacency", 2.6615381),
        ("has", 1.0881557),
        ("matrix", 1.7422239),
    ...
    &[("id", 1.07499), ("node", 0.368619), ("validate", 2.778761)],
    &[
        ("ids", 0.9823721),
        ("node", 0.368619),
        ("validate", 2.778761),
    ],
    &[("edge", 0.833441), ("id", 1.07499), ("validate", 2.778761)],
    &[
        ("edge", 0.833441),
        ("ids", 0.9823721),
        ("validate", 2.778761),
    ...
    &[("be", 3.05344), ("multigraph", 3.05344), ("must", 2.441763)],
    &[
        ("be", 2.0981886),
        ("multigraph", 2.0981886),
        ("must", 1.6778711),
        ("not", 2.0257564),
    ],
    &[
    ...
    &[("density", 5.979463), ("get", 0.36358845)],
    &[
        ("get", 0.16183802),
        ("nodes", 1.1916747),
        ("rate", 2.0257564),
    ...
    &[
        ("destination", 1.9094412),
        ("get", 0.16183802),
        ("ids", 0.6750425),
        ("node", 0.2532986),
    ],
    &[
        ("destination", 1.380007),
        ("directed", 1.0008873),
        ("get", 0.1169649),
        ("ids", 0.48787224),
        ("node", 0.18306604),
    ...
    &[("get", 0.23551874), ("node", 0.368619), ("urls", 3.8732684)],
    &[
        ("get", 0.23551874),
        ("node", 0.368619),
        ("ontologies", 3.05344),
    ...
    &[("get", 0.23551874), ("ids", 0.9823721), ("node", 0.368619)],
    &[
        ("directed", 1.0008873),
        ("edge", 0.41390908),
        ("get", 0.1169649),
    ...
    &[("components", 4.9093046), ("remove", 2.843955)],
    &[("add", 4.4117093), ("selfloops", 3.7045736)],
    &[("name", 2.3156767), ("set", 4.713831)],
    &[
        ("all", 1.285283),
        ("edge", 0.41390908),
        ("inplace", 1.0357413),
    ...
    &[
        ("components", 3.1800604),
        ("connected", 2.5880263),
        ("strongly", 3.8732684),
    ],
    &[("get", 0.36358845), ("tendrils", 5.481868)],
    &[
        ("edges", 0.79893285),
        ("features", 1.447988),
        ("from", 0.23977315),
    ...
    &[("directed", 3.1112843), ("to", 3.839146)],
    &[
        ("to", 2.4868524),
        ("triangular", 3.550945),
        ("upper", 3.8732684),
    ...
    &[("bidiagonal", 5.979463), ("to", 3.839146)],
    &[("arrowhead", 5.979463), ("to", 3.839146)],
    &[("to", 3.839146), ("transposed", 5.979463)],
    &[("to", 3.839146), ("undirected", 4.289788)],
    &[("complementary", 5.979463), ("to", 3.839146)],
    &[
        ("graph", 0.9597312),
        ("multi", 1.9235686),
        ("similarity", 1.9235686),
        ("structural", 1.7634943),
        ("to", 1.2350373),
    ],
    &[("dot", 5.979463), ("to", 3.839146)],
    &[("enable", 9.718159)],
    &[("all", 3.9953358), ("disable", 5.979463)],
    &[("report", 7.661183)],
    &[
        ("overlap", 3.8732684),
        ("report", 3.05344),
    ...
    &[("report", 4.713831), ("textual", 5.481868)],
    &[
        ("16", 0.97072726),
        ("base", 0.7524833),
        ("from", 0.1864839),
    ...
    &[
        ("attachment", 0.9675113),
        ("get", 0.08804665),
        ("minimum", 1.0683403),
        ("preferential", 0.9675113),
        ("unchecked", 0.49705455),
        ("weighted", 0.68248475),
    ],
    &[
    ...
    &[
        ("attachment", 0.7524833),
        ("from", 0.1864839),
        ("get", 0.068478405),
        ("ids", 0.28563026),
        ("node", 0.107178055),
        ("preferential", 0.7524833),
        ("unchecked", 0.38658488),
    ],
    &[
        ("attachment", 0.9675113),
    ...
    &[
        ("attachment", 0.6009256),
        ("from", 0.14892417),
        ("get", 0.05468617),
        ("ids", 0.22810146),
        ("node", 0.08559132),
        ("preferential", 0.6009256),
        ("unchecked", 0.3087228),
        ("weighted", 0.42389435),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.05468617),
        ("ids", 0.22810146),
        ("intersection", 0.77521306),
        ("neighbours", 0.77521306),
        ("node", 0.08559132),
        ("size", 0.7089922),
        ("unchecked", 0.3087228),
    ],
    &[
        ("coefficient", 0.83090323),
        ("from", 0.1864839),
        ("get", 0.068478405),
        ("ids", 0.28563026),
        ("jaccard", 0.76917315),
    ...
    &[
        ("attachment", 1.7783768),
        ("get", 0.16183802),
        ("preferential", 1.7783768),
        ("scores", 2.1851964),
    ],
    &[
        ("allocation", 1.4192286),
        ("get", 0.1169649),
        ("index", 1.3137902),
        ("resource", 1.4192286),
        ("scores", 1.579303),
    ...
    &[
        ("arborescence", 2.4400518),
        ("kruskal", 2.4400518),
        ("random", 1.5494146),
        ("spanning", 2.1851964),
    ],
    &[
        ("arborescence", 3.550945),
        ("kruskal", 3.550945),
        ("spanning", 3.1800604),
    ],
    &[
    ...
    &[
        ("centrality", 0.64642763),
        ("closeness", 0.88780504),
        ("from", 0.1864839),
        ("get", 0.068478405),
        ("id", 0.31255946),
        ("node", 0.107178055),
    ...
    &[
        ("centrality", 2.2232676),
        ("eigenvector", 3.550945),
        ("get", 0.23551874),
    ],
    &[
        ("centrality", 1.527731),
        ("eigenvector", 2.4400518),
        ("get", 0.16183802),
        ("weighted", 1.2544712),
    ],
    &[("overlaps", 9.718159)],
    ...
    &[("connected", 3.9953358), ("holdout", 4.289788)],
    &[("holdout", 4.289788), ("random", 3.4809449)],
    &[
        ("get", 0.1169649),
        ("holdout", 1.380007),
        ("indices", 1.9235686),
    ...
    &[("has", 1.5835651), ("name", 1.5000072), ("node", 0.368619)],
    &[
        ("has", 1.0881557),
        ("id", 0.7386855),
        ("node", 0.2532986),
    ...
    &[("has", 2.4446716), ("nodes", 2.6772394)],
    &[("edges", 3.2991915), ("has", 2.4446716)],
    &[("has", 1.5835651), ("nodes", 1.7342137), ("trap", 2.857737)],
    &[("directed", 3.1112843), ("is", 3.6436725)],
    &[
        ("acyclic", 3.550945),
        ("directed", 2.0153713),
        ("is", 2.360232),
    ...
    &[
        ("edge", 0.41390908),
        ("has", 0.78644073),
        ("probabilities", 1.9235686),
        ("representing", 1.9235686),
        ("weights", 1.1537158),
    ],
    &[
        ("has", 1.0881557),
    ...
    &[("edge", 0.833441), ("has", 1.5835651), ("types", 1.3221633)],
    &[("has", 2.4446716), ("selfloops", 3.7045736)],
    &[
        ("disconnected", 3.1800604),
        ("has", 1.5835651),
        ("nodes", 1.7342137),
    ...
    &[("connected", 3.9953358), ("is", 3.6436725)],
    &[("has", 1.5835651), ("node", 0.368619), ("types", 1.3221633)],
    &[
        ("has", 1.0881557),
        ("multilabel", 2.4400518),
        ("node", 0.2532986),
    ...
    &[("is", 3.6436725), ("multigraph", 4.713831)],
    &[
        ("has", 1.5835651),
        ("node", 0.368619),
        ("ontologies", 3.05344),
