...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("graph", 0.6431965),
        ("laplacian", 0.8645193),
        ("normalized", 0.9094928),
        ("random", 0.6816914),
        ("transformed", 0.8645193),
        ("walk", 0.96970564),
    ],
    &[
        ("get", 0.0858857),
        ("graph", 0.82812184),
        ("laplacian", 1.113077),
        ("normalized", 1.1709809),
        ("symmetric", 1.2485056),
        ("transformed", 1.113077),
    ],
    &[
        ("get", 0.114300065),
        ("graph", 1.102097),
        ("normalized", 1.5583874),
        ("symmetric", 1.6615603),
        ("transformed", 1.4813267),
    ],
    &[
        ("connected", 0.91785616),
        ("from", 0.25008112),
        ("id", 0.37556767),
        ("is", 0.8434878),
        ("node", 0.14050886),
    ...
    &[
        ...
        ("is", 0.5226281),
        ("node", 0.0870598),
        ("selfloops", 0.54381645),
        ("singleton", 0.41186997),
        ("unchecked", 0.28519922),
        ("with", 0.46639466),
    ],
    &[
        ("from", 0.19423628),
    ...
    &[("components", 4.6550174), ("remove", 3.1480067)],
    &[("overlaps", 9.34603)],
    &[("contains", 8.540883)],
    &[
        ("bipartite", 3.365587),
    ...
    &[("edge", 1.2989293), ("encode", 5.7136145)],
    &[("decode", 5.7136145), ("edge", 1.2989293)],
    &[
        ("edge", 0.41334727),
        ("encodable", 1.8181952),
        ("get", 0.114300065),
    ...
    &[
        ...
        ("must", 1.6201624),
        ("node", 0.25937244),
        ("ontologies", 1.9693375),
    ],
    &[
        ("be", 3.0005136),
        ("must", 2.3659673),
        ("undirected", 2.8758771),
    ],
    &[
        ("have", 1.4813267),
        ("must", 1.1680568),
    ...
    &[
        ("be", 3.0005136),
        ("multigraph", 3.1566043),
        ("must", 2.3659673),
    ],
    &[
        ("be", 2.0546856),
        ("multigraph", 2.1615732),
        ("must", 1.6201624),
        ("not", 1.8982868),
    ],
    &[
    ...
    &[("circles", 5.7136145), ("get", 0.35918394)],
    &[
        ("get", 0.23152143),
        ("memory", 2.3659673),
        ("stats", 3.6828601),
    ...
    &[("get", 0.35918394), ("transitivity", 5.7136145)],
    &[
        ("get", 0.0858857),
        ("node", 0.14050886),
        ("number", 0.5652944),
    ...
    &[
        ("clustering", 1.5583874),
        ("coefficient", 1.3685709),
        ("get", 0.114300065),
        ("node", 0.1869947),
        ("per", 1.6615603),
    ],
    &[
        ("clustering", 3.1566043),
        ("coefficient", 2.77212),
        ("get", 0.23152143),
    ],
    &[
        ("average", 2.5219417),
        ("clustering", 2.1615732),
        ("coefficient", 1.8982868),
        ("get", 0.15854079),
    ],
    &[
        ("are", 3.6828601),
        ("nodes", 1.6513485),
        ("remappable", 3.6828601),
    ],
    &[
        ("from", 0.33281776),
        ("ids", 0.48891664),
    ...
    &[("negatives", 5.7136145), ("sample", 5.7136145)],
    &[("connected", 3.8385806), ("holdout", 4.0421934)],
    &[("holdout", 4.0421934), ("random", 3.6705778)],
    &[
        ("get", 0.114300065),
        ("holdout", 1.2863129),
        ("indices", 1.8181952),
    ...
    &[("chains", 5.7136145), ("get", 0.35918394)],
    &[
        ("breadth", 0.39475718),
        ("first", 0.39475718),
        ("from", 0.104920454),
        ...
        ("node", 0.058949884),
        ("parallel", 0.44758883),
        ("predecessors", 0.57318413),
        ("search", 0.39475718),
        ("unchecked", 0.19311394),
    ],
    &[
        ("breadth", 0.39475718),
        ("distances", 0.49128),
    ...
    &[
        ("and", 0.29840004),
        ("distant", 0.44168285),
        ("eccentricity", 0.3637992),
        ("from", 0.088471),
        ("get", 0.03038372),
        ("id", 0.25733832),
        ("most", 0.39377242),
        ("node", 0.096276425),
        ("unchecked", 0.16283749),
    ],
    &[
        ("eccentricity", 0.7987137),
        ("from", 0.19423628),
        ("get", 0.06670683),
        ("id", 0.2917008),
        ("node", 0.10913226),
    ...
    &[("diameter", 4.8971777), ("get", 0.35918394)],
    &[
        ("diameter", 2.1615732),
        ("get", 0.15854079),
        ("naive", 2.3046799),
    ...
    &[("density", 5.7136145), ("get", 0.35918394)],
    &[
        ("get", 0.15854079),
        ("nodes", 1.130807),
        ("rate", 1.8982868),
    ...
    &[
        ...
        ("get", 0.15854079),
        ("number", 1.0435057),
        ("undirected", 1.9693375),
    ],
    &[
        ("edges", 1.0163677),
        ("get", 0.114300065),
        ("number", 0.75231594),
        ("undirected", 1.4197949),
        ("unique", 1.221519),
    ],
    &[
        ("edges", 2.058712),
    ...
    &[
        ("destination", 1.8374239),
        ("get", 0.15854079),
        ("ids", 0.6781556),
        ("node", 0.25937244),
    ],
    &[
        ("destination", 1.3246918),
        ("directed", 1.1680568),
        ("get", 0.114300065),
        ("ids", 0.48891664),
        ("node", 0.1869947),
    ...
    &[("directed", 3.6705778), ("to", 3.7509224)],
    &[
        ("to", 2.4177554),
        ("triangular", 3.365587),
        ("upper", 3.6828601),
    ...
    &[("bidiagonal", 5.7136145), ("to", 3.7509224)],
    &[("arrowhead", 5.7136145), ("to", 3.7509224)],
    &[("to", 3.7509224), ("transposed", 5.7136145)],
    &[("complementary", 5.7136145), ("to", 3.7509224)],
    &[
        ("approximated", 2.474258),
        ("cliques", 3.365587),
        ("get", 0.23152143),
    ],
    &[
    ...
    &[("report", 4.4616556), ("textual", 5.221395)],
    &[
        ("connected", 1.6943173),
        ("generate", 1.6556257),
        ("graph", 1.5286722),
    ...
    &[("drop", 3.8385806), ("tendrils", 5.221395)],
    &[
        ("dendritic", 3.365587),
        ("drop", 2.474258),
        ("trees", 3.365587),
    ...
    &[
        ("disconnected", 3.0005136),
        ("drop", 2.474258),
        ("nodes", 1.6513485),
    ],
    &[("drop", 3.8385806), ("selfloops", 3.6705778)],
    &[
        ("drop", 2.474258),
        ("edges", 2.058712),
        ("parallel", 2.8758771),
    ...
    &[
        ("arborescence", 2.3046799),
        ("kruskal", 2.3046799),
        ("random", 1.6201624),
        ("spanning", 2.1615732),
    ],
    &[
        ("arborescence", 3.365587),
        ("kruskal", 3.365587),
        ("spanning", 3.1566043),
    ],
    &[
    ...
    &[("enable", 9.34603)],
    &[("all", 4.0421934), ("disable", 5.7136145)],
    &[("compatible", 5.7136145), ("is", 3.5275636)],
    &[
        ("adjacency", 2.1615732),
        ("has", 1.0435057),
        ("matrix", 1.8982868),
    ...
    &[("has", 2.3641264), ("nodes", 2.5619133)],
    &[("edges", 3.1938999), ("has", 2.3641264)],
    &[("has", 1.5238597), ("nodes", 1.6513485), ("trap", 2.77212)],
    &[("directed", 3.6705778), ("is", 3.5275636)],
    &[
        ("edge", 0.837259),
        ("has", 1.5238597),
        ("weights", 2.2737837),
    ...
    &[
        ("edge", 0.41334727),
        ("has", 0.75231594),
        ("probabilities", 1.8181952),
        ("representing", 1.8181952),
        ("weights", 1.1225467),
    ],
    &[
        ("has", 1.0435057),
    ...
    &[("edge", 0.837259), ("has", 1.5238597), ("types", 1.2656555)],
    &[("has", 2.3641264), ("selfloops", 3.6705778)],
    &[
        ("disconnected", 3.0005136),
        ("has", 1.5238597),
        ("nodes", 1.6513485),
    ...
    &[("connected", 3.8385806), ("is", 3.5275636)],
    &[
        ("has", 1.5238597),
        ("node", 0.37876865),
        ("types", 1.2656555),
    ...
    &[("is", 3.5275636), ("multigraph", 4.8971777)],
    &[
        ("has", 1.5238597),
        ("node", 0.37876865),
        ("ontologies", 2.8758771),
    ...
    &[("get", 0.35918394), ("tendrils", 5.221395)],
    &[
        ("degree", 0.7422559),
        ("distribution", 1.3662019),
        ("geometric", 1.3662019),
        ("get", 0.0858857),
        ("node", 0.14050886),
        ("threshold", 1.3662019),
    ...
    &[("add", 5.7136145), ("selfloops", 3.6705778)],
    &[
        ("centrality", 2.1224704),
        ("degree", 2.0008936),
        ("get", 0.23152143),
    ],
    &[
    ...
    &[
        ("betweenness", 2.8758771),
        ("centrality", 2.1224704),
        ("get", 0.23152143),
    ],
    &[
        ("approximated", 0.71289253),
        ("betweenness", 0.82860863),
        ("centrality", 0.6115342),
        ("from", 0.19423628),
        ("get", 0.06670683),
        ("id", 0.2917008),
    ...
    &[
        ("approximated", 0.56870705),
        ("betweenness", 0.661019),
        ("centrality", 0.48784882),
        ("from", 0.15495117),
        ("get", 0.053215094),
        ("id", 0.2327031),
    ...
    &[
        ("centrality", 2.1224704),
        ("eigenvector", 3.365587),
        ("get", 0.23152143),
    ],
    &[
        ("centrality", 1.453421),
        ("eigenvector", 2.3046799),
        ("get", 0.15854079),
        ("weighted", 1.1201737),
    ],
    &[("dot", 5.7136145), ("to", 3.7509224)],
    &[("get", 0.35918394), ("stars", 5.7136145)],
    &[
        ("community", 1.5583874),
        ("detection", 1.8181952),
        ("get", 0.114300065),
    ...
    &[
        ...
        ("from", 0.19423628),
        ("get", 0.06670683),
        ("memberships", 0.96970564),
        ("modularity", 0.96970564),
        ("node", 0.10913226),
    ],
    &[
        ("community", 0.9094928),
        ...
        ("modularity", 0.96970564),
        ("node", 0.10913226),
        ("undirected", 0.82860863),
    ],
    &[
        ("attachment", 1.221519),
        ("get", 0.114300065),
        ("minimum", 1.3246918),
        ("preferential", 1.221519),
        ("unchecked", 0.612576),
    ],
    &[
        ("attachment", 1.221519),
    ...
    &[
        ("attachment", 0.91785616),
        ("get", 0.0858857),
        ("minimum", 0.99538076),
        ("preferential", 0.91785616),
        ("unchecked", 0.460293),
        ("weighted", 0.60682744),
    ],
    &[
    ...
    &[
        ("attachment", 0.71289253),
        ("from", 0.19423628),
        ("get", 0.06670683),
        ("ids", 0.28533736),
        ("node", 0.10913226),
        ("preferential", 0.71289253),
        ("unchecked", 0.3575064),
    ],
    &[
        ("attachment", 0.91785616),
    ...
    &[
        ("attachment", 0.56870705),
        ("from", 0.15495117),
        ("get", 0.053215094),
        ("ids", 0.22762668),
        ("node", 0.0870598),
        ("preferential", 0.56870705),
        ("unchecked", 0.28519922),
        ("weighted", 0.3759925),
    ],
    &[
