...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[("tendrils", 5.1942205), ("drop", 3.811726)],
    &[
        ("dendritic", 3.347723),
        ("trees", 3.347723),
        ("drop", 2.4566925),
    ...
    &[("get", 0.35571262), ("transitivity", 5.6863265)],
    &[
        ("triangles", 1.2416774),
        ("get", 0.08503304),
        ("of", 0.9598546),
    ...
    &[("to", 3.724088), ("bidiagonal", 5.6863265)],
    ...
    &[("holdout", 4.015291), ("connected", 3.811726)],
    ...
    &[("circles", 5.6863265), ("get", 0.35571262)],
    &[("get", 0.35571262), ("tendrils", 5.1942205)],
    &[
        ("community", 1.5494101),
        ("undirected", 1.410881),
        ("get", 0.11316957),
