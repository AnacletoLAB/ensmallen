...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("disconnected", 0.9140179),
        ("from", 0.1941407),
        ("id", 0.31041506),
        ("is", 0.68807787),
        ("node", 0.20727487),
        ("unchecked", 0.38486132),
    ],
    &[
        ("from", 0.24967639),
        ("id", 0.39921206),
    ...
    &[
        ...
        ("node", 0.08879559),
        ("selfloops", 0.5807693),
        ("singleton", 0.44595215),
        ("unchecked", 0.30729043),
        ("with", 0.48868874),
    ],
    &[
        ("from", 0.1941407),
    ...
    &[
        ("coo", 0.93544817),
        ("get", 0.09169522),
        ("intersection", 1.2345262),
        ("matrix", 0.8849087),
        ("neighbours", 1.2345262),
        ("size", 1.1283342),
    ],
    &[
        ("get", 0.12184952),
        ("graph", 0.9171892),
        ("intersection", 1.6405045),
        ("neighbours", 1.6405045),
        ("size", 1.499391),
    ],
    &[
        ("ancestors", 1.1754808),
    ...
    &[
        ("coo", 1.7207006),
        ("cooccurrence", 2.003307),
        ("get", 0.16866784),
        ("matrix", 1.6277362),
    ],
    &[
        ("cooccurrence", 2.91709),
        ("get", 0.24560349),
        ("graph", 1.8487135),
    ],
    &[
        ("coo", 1.2430737),
        ("cooccurrence", 1.4472352),
        ("get", 0.12184952),
        ("matrix", 1.1759142),
        ("normalized", 1.2975084),
    ],
    &[
        ("cooccurrence", 2.003307),
        ("get", 0.16866784),
        ("graph", 1.2696012),
        ("normalized", 1.7960507),
    ],
    &[
        ("coo", 0.93544817),
        ("cooccurrence", 1.0890855),
        ("get", 0.09169522),
        ("log", 1.3135788),
        ("matrix", 0.8849087),
        ("normalized", 0.97641176),
    ],
    &[
        ("cooccurrence", 1.4472352),
        ("get", 0.12184952),
    ...
    &[("components", 4.864665), ("remove", 2.8031101)],
    &[("overlaps", 9.652942)],
    &[("contains", 8.844827)],
    &[
        ("bipartite", 2.91709),
    ...
    &[("edge", 1.2330647), ("encode", 5.932857)],
    &[("decode", 5.932857), ("edge", 1.2330647)],
    &[
        ("edge", 0.39593655),
        ("encodable", 1.9050381),
        ("get", 0.12184952),
    ...
    &[
        ("be", 3.148498),
        ("multigraph", 3.0222166),
        ("must", 2.4571447),
    ],
    &[
        ("be", 2.1622264),
        ("multigraph", 2.0755026),
        ("must", 1.6874404),
        ("not", 2.003307),
    ],
    &[
    ...
    &[
        ("inplace", 1.0204847),
        ("isomorphic", 1.0886253),
        ("node", 0.19005734),
        ("remove", 0.9000775),
        ("types", 0.6391325),
    ],
    &[
        ("isomorphic", 1.5069084),
        ("node", 0.26308316),
        ("remove", 1.2459148),
        ("types", 0.88470674),
    ],
    ...
    &[("circles", 5.932857), ("get", 0.3794758)],
    &[
        ("get", 0.24560349),
        ("memory", 2.505576),
        ("stats", 3.839851),
    ...
    &[("get", 0.3794758), ("transitivity", 5.932857)],
    &[
        ("get", 0.09169522),
        ("node", 0.14302352),
        ("number", 0.6074064),
    ...
    &[
        ("clustering", 1.6405045),
        ("coefficient", 1.402558),
        ("get", 0.12184952),
        ("node", 0.19005734),
        ("per", 1.7455541),
    ],
    &[
        ("clustering", 3.3066492),
        ("coefficient", 2.827037),
        ("get", 0.24560349),
    ],
    &[
        ("average", 2.637012),
        ("clustering", 2.2708364),
        ("coefficient", 1.9414635),
        ("get", 0.16866784),
    ],
    &[
        ("are", 3.839851),
    ...
    &[("connected", 3.9523752), ("holdout", 4.2462864)],
    &[("holdout", 4.2462864), ("random", 3.544147)],
    &[
        ("get", 0.12184952),
        ("holdout", 1.3634809),
        ("indices", 1.9050381),
    ...
    &[
        ("and", 0.30900854),
        ("distant", 0.46644208),
        ("eccentricity", 0.38672614),
        ("from", 0.08865822),
        ("get", 0.03256029),
        ("id", 0.2743588),
        ("most", 0.4174045),
        ("node", 0.098293036),
        ("unchecked", 0.17575459),
    ],
    &[
        ("eccentricity", 0.8468395),
        ("from", 0.1941407),
        ("get", 0.07129939),
        ("id", 0.31041506),
        ("node", 0.11121071),
    ...
    &[("diameter", 5.4361763), ("get", 0.3794758)],
    &[
        ("breadth", 0.7775117),
        ("first", 0.7775117),
        ("from", 0.1941407),
    ...
    &[("density", 5.932857), ("get", 0.3794758)],
    &[
        ("get", 0.16866784),
        ("nodes", 1.17195),
        ("rate", 2.003307),
    ...
    &[
        ("destination", 1.887372),
        ("get", 0.16866784),
        ("ids", 0.68756),
        ("node", 0.26308316),
    ],
    &[
        ("destination", 1.3634809),
        ("directed", 1.0084752),
        ("get", 0.12184952),
        ("ids", 0.4967092),
        ("node", 0.19005734),
    ...
    &[("directed", 3.1406927), ("to", 3.8713026)],
    &[
        ("to", 2.505576),
        ("triangular", 3.5183902),
        ("upper", 3.839851),
    ],
    &[
        ("lower", 3.839851),
    ...
    &[("bidiagonal", 5.932857), ("to", 3.8713026)],
    &[("arrowhead", 5.932857), ("to", 3.8713026)],
    &[("to", 3.8713026), ("transposed", 5.932857)],
    &[("complementary", 5.932857), ("to", 3.8713026)],
    &[
        ("graph", 0.9171892),
        ("multi", 1.9050381),
        ("similarity", 1.9050381),
        ("structural", 1.7455541),
        ("to", 1.2430737),
    ],
    &[
        ("approximated", 2.615296),
        ("cliques", 3.5183902),
        ("get", 0.24560349),
    ],
    &[
    ...
    &[("report", 4.669551), ("textual", 5.4361763)],
    &[
        ("connected", 1.7567354),
        ("generate", 1.7567354),
        ("graph", 1.2696012),
    ...
    &[("remove", 2.8031101), ("tendrils", 5.4361763)],
    &[
        ("dendritic", 3.5183902),
        ("remove", 1.8142228),
        ("trees", 3.5183902),
    ...
    &[
        ("disconnected", 3.148498),
        ("nodes", 1.7065198),
        ("remove", 1.8142228),
    ],
    &[("remove", 2.8031101), ("selfloops", 3.8713026)],
    &[
        ("edges", 2.1083188),
        ("parallel", 3.0222166),
        ("remove", 1.8142228),
    ...
    &[
        ("arborescence", 2.4162493),
        ("kruskal", 2.4162493),
        ("random", 1.5752878),
        ("spanning", 2.2708364),
    ],
    &[
        ("arborescence", 3.5183902),
        ("kruskal", 3.5183902),
        ("spanning", 3.3066492),
    ],
    &[
    ...
    &[("enable", 9.652942)],
    &[("all", 3.9523752), ("disable", 5.932857)],
    &[
        ("compatible", 2.1622264),
        ("has", 1.0464104),
        ("node", 0.26308316),
        ("vocabularies", 2.2708364),
    ],
    &[
        ("compatible", 1.562042),
        ("has", 0.75595105),
    ...
    &[("compatible", 4.864665), ("is", 3.6621475)],
    &[
        ("adjacency", 2.637012),
        ("has", 1.0464104),
        ("matrix", 1.6277362),
    ...
    &[("has", 2.354257), ("nodes", 2.636701)],
    &[("edges", 3.2575104), ("has", 2.354257)],
    &[("has", 1.5237172), ("nodes", 1.7065198), ("trap", 2.91709)],
    &[("directed", 3.1406927), ("is", 3.6621475)],
    &[
        ("edge", 0.7980614),
        ("has", 1.5237172),
        ("weights", 2.2938352),
    ...
    &[
        ("edge", 0.39593655),
        ("has", 0.75595105),
        ("probabilities", 1.9050381),
        ("representing", 1.9050381),
        ("weights", 1.1380242),
    ],
    &[
        ("has", 1.0464104),
    ...
    &[("has", 2.354257), ("selfloops", 3.8713026)],
    &[
        ("disconnected", 3.148498),
        ("has", 1.5237172),
        ("nodes", 1.7065198),
    ...
    &[("connected", 3.9523752), ("is", 3.6621475)],
    &[
        ("has", 1.5237172),
        ("node", 0.38308516),
        ("types", 1.2882544),
    ...
    &[("is", 3.6621475), ("multigraph", 4.669551)],
    &[
        ("has", 1.5237172),
        ("node", 0.38308516),
        ("ontologies", 3.0222166),
    ...
    &[
        ...
        ("get", 0.056928612),
        ("ids", 0.23206462),
        ("multigraph", 0.70052177),
        ("node", 0.08879559),
        ("number", 0.3771058),
        ("of", 0.38914278),
    ],
    &[("get", 0.3794758), ("tendrils", 5.4361763)],
    &[
        ("degree", 0.79735017),
        ("distribution", 1.4335951),
        ("geometric", 1.4335951),
        ("get", 0.09169522),
        ("node", 0.14302352),
        ("threshold", 1.4335951),
    ...
    &[("add", 4.367984), ("selfloops", 3.8713026)],
    &[
        ("centrality", 2.2588654),
        ("degree", 2.1356838),
        ("get", 0.24560349),
    ],
    &[
        ("centrality", 1.5512724),
        ("degree", 1.4666777),
        ("get", 0.16866784),
        ("weighted", 1.2345413),
    ],
    ...
    &[
        ("betweenness", 3.0222166),
        ("centrality", 2.2588654),
        ("get", 0.24560349),
    ],
    &[
        ("approximated", 0.7592279),
        ("betweenness", 0.877358),
        ("centrality", 0.655755),
        ("from", 0.1941407),
        ("get", 0.07129939),
        ("id", 0.31041506),
    ...
    &[
        ("approximated", 0.60620135),
        ("betweenness", 0.70052177),
        ("centrality", 0.523584),
        ("from", 0.1550106),
        ("get", 0.056928612),
        ("id", 0.24784921),
    ...
    &[
        ("centrality", 2.2588654),
        ("eigenvector", 3.5183902),
        ("get", 0.24560349),
    ],
    &[
        ("centrality", 1.5512724),
        ("eigenvector", 2.4162493),
        ("get", 0.16866784),
        ("weighted", 1.2345413),
    ],
    &[("dot", 5.932857), ("to", 3.8713026)],
    &[("get", 0.3794758), ("stars", 5.932857)],
    &[
        ("community", 1.6405045),
        ("detection", 1.9050381),
        ("get", 0.12184952),
    ...
    &[
        ("community", 0.95992965),
        ("directed", 0.59010214),
        ("from", 0.1941407),
        ("get", 0.07129939),
        ("memberships", 1.0213987),
        ("modularity", 1.0213987),
        ("node", 0.11121071),
    ],
    &[
        ("community", 0.95992965),
    ...
    &[
        ...
        ("ids", 0.29064587),
        ("node", 0.11121071),
        ("structural", 1.0213987),
        ("unchecked", 0.38486132),
    ],
    &[
        ("attachment", 1.2691061),
        ("get", 0.12184952),
        ("minimum", 1.402558),
        ("preferential", 1.2691061),
        ("unchecked", 0.6577219),
    ],
    &[
        ("attachment", 1.2691061),
    ...
    &[
        ("attachment", 0.9550383),
        ("get", 0.09169522),
        ("minimum", 1.0554645),
        ("preferential", 0.9550383),
        ("unchecked", 0.49495435),
        ("weighted", 0.6711507),
    ],
    &[
    ...
    &[
        ("attachment", 0.7426085),
        ("from", 0.1941407),
        ("get", 0.07129939),
        ("ids", 0.29064587),
        ("node", 0.11121071),
        ("preferential", 0.7426085),
        ("unchecked", 0.38486132),
    ],
    &[
        ("attachment", 0.9550383),
    ...
    &[
        ("attachment", 0.59293175),
        ("from", 0.1550106),
        ("get", 0.056928612),
        ("ids", 0.23206462),
        ("node", 0.08879559),
        ("preferential", 0.59293175),
        ("unchecked", 0.30729043),
        ("weighted", 0.41668123),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.056928612),
        ("ids", 0.23206462),
        ("intersection", 0.7664506),
        ("neighbours", 0.7664506),
        ("node", 0.08879559),
        ("size", 0.70052177),
        ("unchecked", 0.30729043),
    ],
    &[
        ("coefficient", 0.8206969),
        ("from", 0.1941407),
        ("get", 0.07129939),
        ("ids", 0.29064587),
        ("jaccard", 0.79783124),
    ...
    &[
        ("attachment", 1.7567354),
        ("get", 0.16866784),
        ("preferential", 1.7567354),
        ("scores", 2.1622264),
    ],
    &[
        ("allocation", 1.402558),
