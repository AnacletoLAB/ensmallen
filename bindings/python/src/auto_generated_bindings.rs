...
pub const DENDRITICTREE_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[("tree", 1.4629596), ("is", 0.6956208)],
    &[("tendril", 1.4629596), ("is", 0.6956208)],
    &[
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    &[("encode", 5.6856165), ("edge", 1.3086478)],
    &[("edge", 1.3086478), ("decode", 5.6856165)],
    &[
        ("encodable", 1.8075492),
        ("edge", 0.41604024),
        ("number", 0.75010335),
    ...
    &[
        ("degree", 1.9836131),
        ("centrality", 2.1050186),
        ("get", 0.23126933),
    ],
    &[
        ("weighted", 1.1083529),
        ("centrality", 1.4410292),
        ("get", 0.15831968),
        ("degree", 1.3579189),
    ],
    &[
        ("centrality", 0.60602057),
        ("get", 0.06658087),
        ("unchecked", 0.35728377),
        ("node", 0.111858904),
        ("id", 0.29347667),
        ("closeness", 0.85844725),
        ("from", 0.19730422),
    ],
    &[
        ("from", 0.15738405),
        ...
        ("node", 0.089226715),
        ("id", 0.23409814),
        ("unchecked", 0.28499526),
        ("get", 0.053109698),
        ("weighted", 0.37180653),
        ("centrality", 0.48340565),
    ],
    &[
        ("closeness", 2.9818254),
        ("get", 0.23126933),
    ...
    &[
        ("get", 0.23126933),
        ("centrality", 2.1050186),
        ("betweenness", 2.8573644),
    ],
    &[
        ("id", 0.29347667),
        ("approximated", 0.7071552),
        ("get", 0.06658087),
        ("centrality", 0.60602057),
        ("node", 0.111858904),
        ("betweenness", 0.82261586),
        ("from", 0.19730422),
    ],
    &[
        ("approximated", 0.7071552),
    ...
    &[
        ("from", 0.15738405),
        ("id", 0.23409814),
        ("approximated", 0.5640779),
        ("centrality", 0.48340565),
        ("weighted", 0.37180653),
        ("get", 0.053109698),
        ("node", 0.089226715),
        ("betweenness", 0.65617764),
    ],
    &[
        ("weighted", 0.37180653),
        ("betweenness", 0.65617764),
    ...
    &[
        ("get", 0.23126933),
        ("eigenvector", 3.3463848),
        ("centrality", 2.1050186),
    ],
    &[
        ("get", 0.15831968),
        ("weighted", 1.1083529),
        ("eigenvector", 2.2908292),
        ("centrality", 1.4410292),
    ],
    &[
        ("adjacency", 1.548243),
    ...
    &[("tendrils", 5.193875), ("drop", 3.812404)],
    &[
        ("dendritic", 3.3463848),
        ("trees", 3.3463848),
        ("drop", 2.4563107),
    ...
    &[
        ...
        ("nodes", 0.8065458),
        ("with", 0.99269336),
        ("singleton", 0.87580645),
    ],
    &[
        ("disconnected", 2.9818254),
        ("drop", 2.4563107),
        ("nodes", 1.63456),
    ],
    &[("drop", 3.812404), ("selfloops", 3.6445644)],
    &[
        ("parallel", 2.8573644),
        ("edges", 2.04135),
        ("drop", 2.4563107),
    ...
    &[("star", 3.1376967), ("get", 0.23126933), ("edges", 2.04135)],
    &[
        ("edge", 0.57719696),
        ("get", 0.15831968),
        ("star", 2.147968),
    ...
    &[
        ("minimum", 1.3149983),
        ("get", 0.114115916),
        ("preferential", 1.2120247),
        ("attachment", 1.2120247),
        ("unchecked", 0.61236453),
    ],
    &[
        ("attachment", 1.2120247),
        ("unchecked", 0.61236453),
    ...
    &[
        ("ids", 0.28689313),
        ("attachment", 0.7071552),
        ("get", 0.06658087),
        ("node", 0.111858904),
        ("preferential", 0.7071552),
        ("from", 0.19730422),
        ("unchecked", 0.35728377),
    ],
    &[
    ...
    &[
        ("node", 0.089226715),
        ("preferential", 0.5640779),
        ("attachment", 0.5640779),
        ("from", 0.15738405),
        ("weighted", 0.37180653),
        ("unchecked", 0.28499526),
        ("ids", 0.22884661),
    ...
    &[("nodes", 2.5369766), ("has", 2.400848)],
    &[("has", 2.400848), ("edges", 3.1683495)],
    &[("trap", 2.7537537), ("has", 1.546853), ("nodes", 1.63456)],
    &[("is", 3.5016892), ("directed", 3.812404)],
    &[
        ("has", 1.546853),
        ("edge", 0.8431545),
        ("weights", 2.2561188),
    ...
    &[
        ("weights", 1.1132435),
        ("probabilities", 1.8075492),
        ("edge", 0.41604024),
        ("has", 0.7632683),
        ("representing", 1.8075492),
    ],
    &[
        ("weighted", 1.1083529),
        ("has", 1.0589267),
    ...
    &[("edge", 0.8431545), ("types", 1.2494102), ("has", 1.546853)],
    &[("has", 2.400848), ("selfloops", 3.6445644)],
    &[
        ("has", 1.546853),
        ("nodes", 1.63456),
        ("disconnected", 2.9818254),
    ...
    &[("connected", 3.812404), ("is", 3.5016892)],
    &[("types", 1.2494102), ("node", 0.388543), ("has", 1.546853)],
    &[
        ("multilabel", 2.2908292),
        ("node", 0.26598427),
        ("types", 0.85530674),
        ("has", 1.0589267),
    ],
    ...
    &[("is", 3.5016892), ("multigraph", 4.869973)],
    &[
        ("has", 0.35522607),
        ("decreasing", 0.76847845),
        ("outbound", 0.6847594),
        ("sorted", 0.72055435),
        ("by", 0.61200196),
        ("nodes", 0.3753675),
    ...
    &[("report", 4.4348736), ("textual", 5.193875)],
    &[
        ("total", 1.6074848),
        ("edge", 0.57719696),
        ("get", 0.15831968),
    ...
    &[("have", 3.1376967), ("must", 2.3998878), ("edges", 2.04135)],
    &[("have", 3.1376967), ("must", 2.3998878), ("nodes", 1.63456)],
    &[
        ("connected", 2.4563107),
        ("be", 2.9818254),
        ("must", 2.3998878),
    ],
    &[("selfloops", 3.6445644), ("add", 5.6856165)],
    &[
        ("features", 1.3579876),
        ("edges", 0.7567481),
        ("new", 1.3579876),
    ...
    &[
        ...
        ("node", 0.16883454),
        ("id", 0.23409814),
        ("comulative", 0.76847845),
        ("unchecked", 0.28499526),
        ("get", 0.053109698),
        ("from", 0.15738405),
    ],
    &[
        ("comulative", 0.9634015),
        ("id", 0.29347667),
        ("degree", 0.57106876),
        ("node", 0.2088043),
        ("from", 0.19730422),
    ...
    &[("get", 0.35894975), ("transitivity", 5.6856165)],
    &[
        ("triangles", 1.240537),
        ("node", 0.14403664),
        ("get", 0.085733764),
    ...
    &[
        ("clustering", 3.1376967),
        ("coefficient", 2.7537537),
        ("get", 0.23126933),
    ],
    &[
        ("clustering", 2.147968),
        ("get", 0.15831968),
        ("coefficient", 1.8851328),
        ("average", 2.5077186),
    ],
    &[("compatible", 5.6856165), ("is", 3.5016892)],
    &[
        ("has", 1.0589267),
        ("matrix", 1.8851328),
        ("same", 2.5077186),
    ...
    &[("remove", 3.122501), ("components", 4.6280475)],
    &[
        ("components", 2.0412633),
        ("connected", 1.6815127),
        ("number", 1.0406622),
        ("get", 0.15831968),
    ],
    ...
    &[("density", 5.6856165), ("get", 0.35894975)],
    &[
        ("get", 0.15831968),
        ("rate", 1.8851328),
        ("nodes", 1.1189681),
    ...
    &[
        ("destination", 1.8243741),
        ("ids", 0.6821903),
        ("node", 0.26598427),
        ("get", 0.15831968),
    ],
    &[
        ("destination", 1.3149983),
        ("node", 0.19171995),
        ("ids", 0.49171886),
        ("get", 0.114115916),
        ("directed", 1.2120247),
    ...
    &[("urls", 3.663211), ("node", 0.388543), ("get", 0.23126933)],
    &[
        ("node", 0.388543),
        ("ontologies", 3.663211),
        ("get", 0.23126933),
    ],
    &[("node", 0.388543), ("get", 0.23126933), ("ids", 0.9965261)],
    &[
        ("type", 0.7576846),
        ("edge", 0.57719696),
        ("ids", 0.6821903),
    ...
    &[("to", 3.7248309), ("directed", 3.812404)],
    &[
        ("to", 2.3998878),
        ("triangular", 3.3463848),
        ("upper", 3.663211),
    ],
    &[
        ("to", 2.3998878),
    ...
    &[("to", 3.7248309), ("bidiagonal", 5.6856165)],
    &[("arrowhead", 5.6856165), ("to", 3.7248309)],
    &[("transposed", 5.6856165), ("to", 3.7248309)],
    &[("to", 3.7248309), ("complementary", 5.6856165)],
    &[("from", 1.0637034), ("csv", 5.6856165)],
    &[
        ("id", 0.15849122),
        ("first", 0.39154816),
        ("node", 0.060409077),
    ...
    &[
        ...
        ("id", 0.37789923),
        ("from", 0.25406146),
        ("eccentricity", 1.020843),
        ("get", 0.085733764),
    ],
    &[
        ("name", 0.74372727),
        ("node", 0.19171995),
        ("eccentricity", 1.3587929),
        ("from", 0.33816847),
        ("get", 0.114115916),
    ],
    &[
    ...
    &[("get", 0.35894975), ("diameter", 4.869973)],
    &[
        ("diameter", 2.147968),
        ("weighted", 1.1083529),
        ("get", 0.15831968),
    ...
    &[("negatives", 5.6856165), ("sample", 5.6856165)],
    &[("holdout", 4.0158186), ("connected", 3.812404)],
    &[("random", 3.6445644), ("holdout", 4.0158186)],
    &[
        ("node", 0.19171995),
        ("get", 0.114115916),
        ("label", 1.2426542),
    ...
    &[("to", 3.7248309), ("dot", 5.6856165)],
    &[("circles", 5.6856165), ("get", 0.35894975)],
    &[("get", 0.35894975), ("tendrils", 5.193875)],
    &[
        ("community", 1.548243),
        ("louvain", 1.8075492),
        ("get", 0.114115916),
    ...
    &[
        ("modularity", 0.9634015),
        ("directed", 0.7071552),
        ("get", 0.06658087),
        ("memberships", 0.9634015),
        ("from", 0.19730422),
        ("node", 0.111858904),
        ("community", 0.9033216),
    ],
    ...
    &[("enable", 9.305574)],
    &[("disable", 5.6856165), ("all", 4.0158186)],
    &[
        ("random", 2.3481727),
        ("get", 0.23126933),
        ("node", 0.388543),
    ...
    &[("get", 0.35894975), ("chains", 5.6856165)],
    &[
        ("dendritic", 3.3463848),
        ("get", 0.23126933),
        ("trees", 3.3463848),
    ],
    &[("get", 0.35894975), ("stars", 5.6856165)],
    &[("name", 2.339382), ("set", 4.2740607)],
    &[
        ("set", 1.3587929),
        ("types", 0.6165002),
        ("inplace", 1.0928333),
    ...
    &[
        ...
        ("node", 0.111858904),
        ("with", 0.57918644),
        ("selfloops", 0.67602295),
        ("singleton", 0.51098883),
    ],
    &[
        ("is", 0.836365),
        ("from", 0.25406146),
    ...
    &[("name", 1.5072508), ("has", 1.546853), ("node", 0.388543)],
    &[
        ("id", 0.69784504),
        ("node", 0.26598427),
        ("type", 0.7576846),
    ...
    &[
        ("normalized", 0.9033216),
        ("graph", 0.637613),
        ("get", 0.06658087),
        ("random", 0.67602295),
        ("walk", 0.9634015),
        ("laplacian", 0.85844725),
        ("transformed", 0.85844725),
    ],
    &[
        ("laplacian", 1.1053913),
        ("transformed", 1.1053913),
        ("normalized", 1.1631744),
        ("get", 0.085733764),
        ("graph", 0.8210311),
        ("symmetric", 1.240537),
    ],
    ...
    &[
        ...
        ("from", 0.19730422),
        ("sorting", 0.9033216),
        ("topological", 0.9033216),
    ],
    &[
        ("sorting", 0.72055435),
        ("topological", 0.72055435),
        ("node", 0.089226715),
        ("from", 0.15738405),
        ("bfs", 0.72055435),
        ("reversed", 0.8412358),
    ...
    &[
        ("random", 1.6074848),
        ("arborescence", 2.2908292),
        ("spanning", 2.147968),
        ("kruskal", 2.2908292),
    ],
    &[
        ("spanning", 3.1376967),
        ("arborescence", 3.3463848),
        ("kruskal", 3.3463848),
    ],
    &[
        ("connected", 2.4563107),
