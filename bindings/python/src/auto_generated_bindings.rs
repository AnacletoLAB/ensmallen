...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("get", 0.12245513),
        ("graph", 0.90023714),
        ("normalized", 1.3524538),
        ("symmetric", 1.7322195),
        ("transformed", 1.4875431),
    ],
    &[
        ("connected", 0.9466909),
        ("from", 0.24796864),
    ...
    &[
        ...
        ("node", 0.08764897),
        ("selfloops", 0.575276),
        ("singleton", 0.44143164),
        ("unchecked", 0.30377048),
        ("with", 0.48385987),
    ],
    &[
        ("from", 0.19273922),
    ...
    &[("has", 1.511392), ("name", 1.4805726), ("node", 0.3792146)],
    &[
        ("has", 1.0369406),
        ("id", 0.72652775),
        ("node", 0.26017275),
    ...
    &[
        ("coo", 0.9912849),
        ("get", 0.09210443),
        ("intersection", 1.2243503),
        ("matrix", 0.927229),
        ("neighbours", 1.2243503),
        ("size", 1.1188531),
    ],
    &[
        ("get", 0.12245513),
        ("graph", 0.90023714),
        ("intersection", 1.6278043),
        ("neighbours", 1.6278043),
        ("size", 1.4875431),
    ],
    &[
        ("ancestors", 1.1656915),
    ...
    &[
        ("coo", 1.825588),
        ("cooccurrence", 1.9887135),
        ("get", 0.16962302),
        ("matrix", 1.7076201),
    ],
    &[
        ("cooccurrence", 2.8986478),
        ("get", 0.2472339),
        ("graph", 1.8175566),
    ],
    &[
        ("coo", 1.317938),
        ("cooccurrence", 1.4357023),
        ("get", 0.12245513),
        ("matrix", 1.232774),
        ("normalized", 1.3524538),
    ],
    &[
        ...
        ("get", 0.16962302),
        ("graph", 1.246995),
        ("normalized", 1.8733989),
    ],
    &[
        ("coo", 0.9912849),
        ("cooccurrence", 1.0798612),
        ("get", 0.09210443),
        ("log", 1.302886),
        ("matrix", 0.927229),
        ("normalized", 1.017246),
    ...
    &[("components", 4.841259), ("remove", 2.7859275)],
    &[("overlaps", 9.626854)],
    &[("contains", 8.819733)],
    &[
        ("bipartite", 2.8986478),
    ...
    &[("edge", 1.2361737), ("encode", 5.906226)],
    &[("decode", 5.906226), ("edge", 1.2361737)],
    &[
        ("edge", 0.3957321),
        ("encodable", 1.8907402),
        ("get", 0.12245513),
    ...
    &[("id", 1.05895), ("node", 0.3792146), ("validate", 2.730571)],
    &[
        ("ids", 1.005074),
        ("node", 0.3792146),
        ("validate", 2.730571),
    ],
    &[("edge", 0.7989734), ("id", 1.05895), ("validate", 2.730571)],
    &[
        ("edge", 0.7989734),
        ("ids", 1.005074),
        ("validate", 2.730571),
    ...
    &[
        ("be", 3.12904),
        ("multigraph", 3.2864969),
        ("must", 2.4407218),
    ],
    &[
        ("be", 2.1467817),
        ("multigraph", 2.2548103),
        ("must", 1.6745381),
        ("not", 1.9887135),
    ],
    &[
    ...
    &[("edges", 2.0934272), ("have", 3.12904), ("must", 2.4407218)],
    &[("have", 3.12904), ("must", 2.4407218), ("nodes", 1.693392)],
    &[
        ("be", 3.12904),
        ("connected", 2.5411818),
        ("must", 2.4407218),
    ...
    &[
        ("inplace", 1.0115294),
        ("isomorphic", 1.0792586),
        ("node", 0.18782528),
        ("remove", 0.8918495),
        ("types", 0.6324806),
    ],
    &[
        ("isomorphic", 1.4949728),
        ("node", 0.26017275),
        ("remove", 1.2353767),
        ("types", 0.87610275),
    ],
    ...
    &[("circles", 5.906226), ("get", 0.38252094)],
    &[
        ("get", 0.2472339),
        ("memory", 2.4889405),
        ("stats", 3.817358),
    ...
    &[("get", 0.38252094), ("transitivity", 5.906226)],
    &[
        ("get", 0.09210443),
        ("node", 0.14127247),
        ("number", 0.60133314),
    ...
    &[
        ("clustering", 1.6278043),
        ("coefficient", 1.3912948),
        ("get", 0.12245513),
        ("node", 0.18782528),
        ("per", 1.7322195),
    ],
    &[
        ("clustering", 3.2864969),
        ("coefficient", 2.80899),
        ("get", 0.2472339),
    ],
    &[
        ("average", 2.619025),
        ("clustering", 2.2548103),
        ("coefficient", 1.9272008),
        ("get", 0.16962302),
    ],
    &[
        ("are", 3.817358),
    ...
    &[("connected", 3.931723), ("holdout", 4.2247467)],
    &[("holdout", 4.2247467), ("random", 3.5247273)],
    &[
        ("get", 0.12245513),
        ("holdout", 1.3524538),
        ("indices", 1.8907402),
    ...
    &[("chains", 5.906226), ("get", 0.38252094)],
    &[
        ("breadth", 0.4167883),
        ("first", 0.4167883),
        ("from", 0.10425905),
        ...
        ("node", 0.059398375),
        ("parallel", 0.47042468),
        ("predecessors", 0.5979328),
        ("search", 0.4167883),
        ("unchecked", 0.20586064),
    ],
    &[
        ("breadth", 0.4167883),
        ("distances", 0.51478124),
        ("first", 0.4167883),
        ("from", 0.10425905),
        ("get", 0.038725544),
        ("ids", 0.15743002),
    ...
    &[
        ("and", 0.30585432),
        ("distant", 0.46206018),
        ("eccentricity", 0.38296586),
        ("from", 0.08794049),
        ("get", 0.032664247),
        ("id", 0.27084643),
        ("most", 0.413405),
        ("node", 0.09699129),
        ("unchecked", 0.17363946),
    ],
    &[
        ("eccentricity", 0.83934647),
        ("from", 0.19273922),
        ("get", 0.071590245),
        ("id", 0.30663466),
        ("node", 0.10980722),
    ...
    &[("diameter", 5.411045), ("get", 0.38252094)],
    &[
        ("breadth", 0.7704986),
        ("first", 0.7704986),
        ("from", 0.19273922),
    ...
    &[("density", 5.906226), ("get", 0.38252094)],
    &[
        ("get", 0.16962302),
        ("nodes", 1.1618078),
        ("rate", 1.9887135),
    ...
    &[
        ...
        ("get", 0.16962302),
        ("number", 1.107438),
        ("undirected", 2.0605226),
    ],
    &[
        ("edges", 1.036876),
        ("get", 0.12245513),
        ("number", 0.7994874),
        ("undirected", 1.4875431),
        ("unique", 1.2586491),
    ],
    &[
        ("edges", 2.0934272),
    ...
    &[
        ("destination", 1.8733989),
        ("get", 0.16962302),
        ("ids", 0.68956435),
        ("node", 0.26017275),
    ],
    &[
        ("destination", 1.3524538),
        ("directed", 1.0239439),
        ("get", 0.12245513),
        ("ids", 0.49781388),
        ("node", 0.18782528),
    ...
    &[("get", 0.2472339), ("node", 0.3792146), ("urls", 3.817358)],
    &[
        ("get", 0.2472339),
        ("node", 0.3792146),
        ("ontologies", 3.003313),
    ...
    &[("get", 0.2472339), ("ids", 1.005074), ("node", 0.3792146)],
    &[
        ("edge", 0.5481622),
        ("get", 0.16962302),
        ("ids", 0.68956435),
    ...
    &[("directed", 3.1985595), ("to", 3.8508952)],
    &[
        ("to", 2.4889405),
        ("triangular", 3.4973085),
        ("upper", 3.817358),
    ],
    &[
        ("lower", 3.817358),
    ...
    &[("bidiagonal", 5.906226), ("to", 3.8508952)],
    &[("arrowhead", 5.906226), ("to", 3.8508952)],
    &[("to", 3.8508952), ("transposed", 5.906226)],
    &[("complementary", 5.906226), ("to", 3.8508952)],
    &[
        ("graph", 0.90023714),
        ("multi", 1.8907402),
        ("similarity", 1.8907402),
        ("structural", 1.7322195),
        ("to", 1.232774),
    ],
    &[
        ("approximated", 2.5981789),
        ("cliques", 3.4973085),
        ("get", 0.2472339),
    ],
    &[("clique", 2.80899), ("get", 0.2472339), ("max", 3.4973085)],
    &[
        ("approximated", 1.7825668),
        ("cliques", 2.3994446),
        ("get", 0.16962302),
        ("number", 1.107438),
    ],
    ...
    &[("report", 4.6467338), ("textual", 5.411045)],
    &[
        ("connected", 1.7434621),
        ("generate", 1.7434621),
        ("graph", 1.246995),
    ...
    &[("remove", 2.7859275), ("tendrils", 5.411045)],
    &[
        ("dendritic", 3.4973085),
        ("remove", 1.8006223),
        ("trees", 3.4973085),
    ...
    &[
        ("disconnected", 3.12904),
        ("nodes", 1.693392),
        ("remove", 1.8006223),
    ],
    &[("remove", 2.7859275), ("selfloops", 3.8508952)],
    &[
        ("edges", 2.0934272),
        ("parallel", 3.003313),
        ("remove", 1.8006223),
    ...
    &[
        ("arborescence", 2.3994446),
        ("kruskal", 2.3994446),
        ("random", 1.562986),
        ("spanning", 2.2548103),
    ],
    &[
        ("arborescence", 3.4973085),
        ("kruskal", 3.4973085),
        ("spanning", 3.2864969),
    ],
    &[
    ...
    &[("enable", 9.626854)],
    &[("all", 3.931723), ("disable", 5.906226)],
    &[
        ("compatible", 2.1467817),
        ("has", 1.0369406),
        ("node", 0.26017275),
        ("vocabularies", 2.2548103),
    ],
    &[
        ("compatible", 1.5498158),
        ("has", 0.74859357),
        ("node", 0.18782528),
        ("types", 0.6324806),
        ("vocabularies", 1.6278043),
    ],
    &[
        ("compatible", 1.5498158),
        ("edge", 0.3957321),
    ...
    &[("compatible", 4.841259), ("is", 3.6423717)],
    &[
        ("adjacency", 2.619025),
        ("has", 1.0369406),
        ("matrix", 1.7076201),
    ...
    &[("has", 2.3384297), ("nodes", 2.6200206)],
    &[("edges", 3.238956), ("has", 2.3384297)],
    &[("has", 1.511392), ("nodes", 1.693392), ("trap", 2.8986478)],
    &[("directed", 3.1985595), ("is", 3.6423717)],
    &[
        ("edge", 0.7989734),
        ("has", 1.511392),
        ("weights", 2.3149948),
    ...
    &[
        ("edge", 0.3957321),
        ("has", 0.74859357),
        ("probabilities", 1.8907402),
        ("representing", 1.8907402),
        ("weights", 1.1466185),
    ],
    &[
        ("has", 1.0369406),
    ...
    &[("edge", 0.7989734), ("has", 1.511392), ("types", 1.2769629)],
    &[("has", 2.3384297), ("selfloops", 3.8508952)],
    &[
        ("disconnected", 3.12904),
        ("has", 1.511392),
        ("nodes", 1.693392),
    ...
    &[("connected", 3.931723), ("is", 3.6423717)],
    &[("has", 1.511392), ("node", 0.3792146), ("types", 1.2769629)],
    &[
        ("has", 1.0369406),
        ("multilabel", 2.3994446),
        ("node", 0.26017275),
    ...
    &[("is", 3.6423717), ("multigraph", 5.0848765)],
    &[
        ("has", 1.511392),
        ("node", 0.3792146),
        ("ontologies", 3.003313),
    ...
    &[("get", 0.38252094), ("tendrils", 5.411045)],
    &[
        ("degree", 0.7900344),
        ("distribution", 1.4221171),
        ("geometric", 1.4221171),
        ("get", 0.09210443),
        ("node", 0.14127247),
        ("threshold", 1.4221171),
    ...
    &[("add", 4.346077), ("selfloops", 3.8508952)],
    &[
        ("centrality", 2.2433126),
        ("degree", 2.120672),
        ("get", 0.2472339),
    ],
    &[
        ("centrality", 1.5390991),
        ("degree", 1.4549574),
        ("get", 0.16962302),
        ("weighted", 1.224064),
    ],
    &[
        ("centrality", 0.6495845),
        ("closeness", 0.90606),
        ("from", 0.19273922),
        ("get", 0.071590245),
        ("id", 0.30663466),
    ...
    &[
        ("betweenness", 3.003313),
        ("centrality", 2.2433126),
        ("get", 0.2472339),
    ],
    &[
        ("approximated", 0.7523412),
        ("betweenness", 0.8696538),
        ("centrality", 0.6495845),
        ("from", 0.19273922),
        ("get", 0.071590245),
        ("id", 0.30663466),
    ...
    &[
        ("approximated", 0.6005246),
        ("betweenness", 0.69416445),
        ("centrality", 0.51850337),
        ("from", 0.15384595),
        ("get", 0.057143886),
        ("id", 0.24475817),
    ...
    &[
        ("centrality", 2.2433126),
        ("eigenvector", 3.4973085),
        ("get", 0.2472339),
    ],
    &[
        ("centrality", 1.5390991),
        ("eigenvector", 2.3994446),
        ("get", 0.16962302),
        ("weighted", 1.224064),
    ],
    &[("dot", 5.906226), ("to", 3.8508952)],
    &[("get", 0.38252094), ("stars", 5.906226)],
    &[
        ("community", 1.6278043),
        ("detection", 1.8907402),
        ("get", 0.12245513),
    ...
    &[
        ("community", 0.95165396),
        ("directed", 0.5986225),
        ("from", 0.19273922),
        ("get", 0.071590245),
        ("memberships", 1.0126976),
        ("modularity", 1.0126976),
        ("node", 0.10980722),
    ],
    &[
        ("community", 0.95165396),
    ...
    &[
        ...
        ("ids", 0.2910341),
        ("node", 0.10980722),
        ("structural", 1.0126976),
        ("unchecked", 0.3805657),
    ],
    &[
        ("attachment", 1.2586491),
        ("get", 0.12245513),
        ("minimum", 1.3912948),
        ("preferential", 1.2586491),
        ("unchecked", 0.6509577),
    ],
    &[
        ("attachment", 1.2586491),
    ...
    &[
        ("attachment", 0.9466909),
        ("get", 0.09210443),
        ("minimum", 1.0464602),
        ("preferential", 0.9466909),
        ("unchecked", 0.48961678),
        ("weighted", 0.6646605),
    ],
    &[
    ...
    &[
        ("attachment", 0.73583686),
        ("from", 0.19273922),
        ("get", 0.071590245),
        ("ids", 0.2910341),
        ("node", 0.10980722),
        ("preferential", 0.73583686),
        ("unchecked", 0.3805657),
    ],
    &[
        ("attachment", 0.9466909),
    ...
    &[
        ("attachment", 0.5873507),
        ("from", 0.15384595),
        ("get", 0.057143886),
        ("ids", 0.23230568),
        ("node", 0.08764897),
        ("preferential", 0.5873507),
        ("unchecked", 0.30377048),
        ("weighted", 0.41237196),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.057143886),
        ("ids", 0.23230568),
        ("intersection", 0.75961757),
        ("neighbours", 0.75961757),
        ("node", 0.08764897),
        ("size", 0.69416445),
        ("unchecked", 0.30377048),
    ],
    &[
        ("coefficient", 0.8133848),
        ("from", 0.19273922),
        ("get", 0.071590245),
        ("ids", 0.2910341),
        ("jaccard", 0.79067737),
    ...
    &[
        ("attachment", 1.7434621),
        ("get", 0.16962302),
        ("preferential", 1.7434621),
        ("scores", 2.1467817),
    ],
    &[
        ("allocation", 1.3912948),
        ("get", 0.12245513),
        ("index", 1.2868798),
        ("resource", 1.3912948),
        ("scores", 1.5498158),
...
pub const SHORTESTPATHSRESULTBFS_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[("eccentricity", 2.22895), ("get", 0.08480925)],
    &[
        ("distant", 0.7497478),
        ("get", 0.036129102),
        ("most", 0.7497478),
    ...
    &[("distances", 2.22895), ("get", 0.08480925)],
    &[("get", 0.08480925), ("predecessors", 1.7599539)],
];
