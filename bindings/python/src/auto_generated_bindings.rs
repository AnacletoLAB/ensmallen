...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[("compatible", 4.8691688), ("is", 3.606942)],
    &[
        ("adjacency", 2.6368551),
        ("has", 1.0559827),
        ("matrix", 1.6291118),
    ...
    &[("get", 0.37716028), ("stars", 5.9364486)],
    &[("chains", 5.9364486), ("get", 0.37716028)],
    &[
    ...
    &[("get", 0.37716028), ("transitivity", 5.9364486)],
    &[
        ("get", 0.091044314),
        ("node", 0.14292653),
        ("number", 0.60836947),
    ...
    &[("four", 3.840678), ("get", 0.24400973), ("sweep", 3.840678)],
    &[
        ("diameter", 3.5196168),
        ("get", 0.24400973),
        ("naive", 3.840678),
    ],
    &[("diameter", 5.4401917), ("get", 0.37716028)],
    &[
        ("breadth", 0.7776097),
        ("first", 0.7776097),
        ("from", 0.19538479),
    ...
    &[("components", 4.8691688), ("remove", 2.8093758)],
    &[
    ...
    &[("circles", 5.9364486), ("get", 0.37716028)],
    ...
    &[("density", 5.9364486), ("get", 0.37716028)],
    &[
        ("get", 0.16752727),
        ("nodes", 1.1740175),
        ("rate", 2.0041125),
    ...
    &[("get", 0.37716028), ("tendrils", 5.4401917)],
    &[
        ("coo", 1.721935),
        ("get", 0.16752727),
        ("jaccard", 1.8883531),
