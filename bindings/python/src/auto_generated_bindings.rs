...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("normalized", 0.89699805),
        ("laplacian", 0.8522431),
        ("transformed", 0.8522431),
        ("graph", 0.6319961),
        ("random", 0.6703039),
        ("walk", 0.95691824),
        ("get", 0.066276744),
    ...
    &[
        ("graph", 0.81391513),
        ("symmetric", 1.2323656),
        ("normalized", 1.1551974),
        ("laplacian", 1.0975599),
        ("get", 0.085354395),
        ("transformed", 1.0975599),
    ],
    &[
        ("normalized", 1.5379183),
        ("symmetric", 1.6406525),
        ("graph", 1.0835681),
        ("transformed", 1.4611853),
        ("get", 0.113632604),
    ],
    &[
        ("is", 0.82921046),
        ("connected", 0.90323675),
        ("node", 0.14494047),
        ("unchecked", 0.46328008),
        ("id", 0.3762462),
        ("from", 0.25474328),
    ],
    &[
        ("unchecked", 0.35973185),
        ("from", 0.19780533),
        ("disconnected", 0.8522431),
        ("id", 0.292151),
        ("is", 0.64387274),
        ("node", 0.21012166),
    ],
    &[
        ...
        ("node", 0.14494047),
        ("id", 0.3762462),
        ("singleton", 0.65127605),
    ],
    &[
        ("singleton", 0.86704606),
        ("node", 0.19295974),
        ("from", 0.3391406),
        ("id", 0.5008979),
        ("is", 1.1039307),
    ...
    &[("has", 1.5584248), ("name", 1.503957), ("node", 0.39130172)],
    &[
        ("type", 0.77033484),
        ("node", 0.26777413),
        ("has", 1.0664555),
    ...
    &[
        ("connected", 2.4385052),
        ("strongly", 3.643356),
        ("components", 2.9631274),
    ],
    &[
        ("degree", 0.7284441),
        ("outbound", 1.0975599),
        ("increasing", 1.2323656),
        ("by", 0.98040485),
        ("sort", 1.0975599),
        ("node", 0.14494047),
    ],
    ...
    &[("components", 4.6014504), ("remove", 3.0976684)],
    &[("overlaps", 9.266434)],
    &[("contains", 8.461993)],
    &[
        ("get", 0.23043476),
    ...
    &[("encode", 5.6577797), ("edge", 1.2927611)],
    &[("decode", 5.6577797), ("edge", 1.2927611)],
    &[
        ("number", 0.7547697),
        ("max", 1.7966214),
        ("encodable", 1.7966214),
    ...
    &[("edges", 2.0242493), ("have", 3.118734), ("must", 2.382178)],
    &[("have", 3.118734), ("nodes", 1.6181502), ("must", 2.382178)],
    &[
        ("must", 2.382178),
        ("be", 2.9631274),
        ("connected", 2.4385052),
    ...
    &[("circles", 5.6577797), ("get", 0.35784292)],
    &[
        ("memory", 2.3305507),
        ("get", 0.23043476),
        ("stats", 3.643356),
    ...
    &[
        ...
        ("total", 0.8632497),
        ("get", 0.085354395),
        ("requirements", 1.0132242),
    ],
    &[
        ("human", 0.6512322),
        ("total", 0.5346231),
        ("requirements", 0.6275044),
        ("weights", 0.51354206),
        ("get", 0.052861214),
        ("memory", 0.5346231),
        ("edge", 0.19096905),
    ...
    &[("get", 0.35784292), ("transitivity", 5.6577797)],
    &[
        ("number", 0.56694037),
        ("get", 0.085354395),
        ("of", 0.9516994),
    ...
    &[
        ("clustering", 1.5379183),
        ("coefficient", 1.3489089),
        ("get", 0.113632604),
        ("node", 0.19295974),
        ("per", 1.6406525),
    ],
    &[
        ("clustering", 3.118734),
        ("coefficient", 2.7354429),
        ("get", 0.23043476),
    ],
    &[
        ("average", 2.493208),
        ("get", 0.15769026),
        ("clustering", 2.1342003),
        ("coefficient", 1.8719081),
    ],
    &[
        ("nodes", 1.6181502),
        ("remappable", 3.643356),
    ...
    &[("sample", 5.6577797), ("negatives", 5.6577797)],
    &[("holdout", 3.9899395), ("connected", 3.786763)],
    &[("holdout", 3.9899395), ("random", 3.61912)],
    &[
        ("node", 0.19295974),
        ("holdout", 1.2670007),
        ("indices", 1.7966214),
    ...
    &[("chains", 5.6577797), ("get", 0.35784292)],
    &[
        ("search", 0.3882838),
        ("node", 0.06076292),
        ("breadth", 0.3882838),
        ("id", 0.15773247),
        ("unchecked", 0.19421941),
        ("parallel", 0.44083253),
        ("first", 0.3882838),
        ("from", 0.10679519),
        ("predecessors", 0.5657551),
        ("get", 0.035782848),
    ],
    &[
        ("ids", 0.1568168),
    ...
    &[("diameter", 4.8430924), ("get", 0.35784292)],
    &[
        ("get", 0.15769026),
        ("diameter", 2.1342003),
        ("weighted", 1.0967333),
    ...
    &[("density", 5.6577797), ("get", 0.35784292)],
    &[
        ("nodes", 1.1073265),
        ("get", 0.15769026),
        ("trap", 1.8719081),
    ...
    &[
        ("undirected", 1.9426904),
        ("number", 1.0474092),
        ("edges", 1.3852267),
        ("get", 0.15769026),
    ],
    &[
        ("undirected", 1.3999151),
        ("number", 0.7547697),
        ("edges", 0.9982032),
        ("unique", 1.2024822),
        ("get", 0.113632604),
    ...
    &[
        ("node", 0.26777413),
        ("destination", 1.8112751),
        ("get", 0.15769026),
        ("ids", 0.6910708),
    ],
    &[
        ("destination", 1.3052163),
        ("ids", 0.49799),
        ("node", 0.19295974),
        ("get", 0.113632604),
        ("directed", 1.2024822),
    ...
    &[("to", 3.6992924), ("directed", 3.786763)],
    &[
        ("to", 2.382178),
        ("triangular", 3.3270679),
        ("upper", 3.643356),
    ],
    &[
        ("triangular", 3.3270679),
    ...
    &[("to", 3.6992924), ("bidiagonal", 5.6577797)],
    &[("to", 3.6992924), ("arrowhead", 5.6577797)],
    &[("to", 3.6992924), ("transposed", 5.6577797)],
    &[("complementary", 5.6577797), ("to", 3.6992924)],
    &[("report", 7.2203417)],
    &[
        ("report", 2.838878),
        ("overlap", 3.643356),
    ...
    &[("textual", 5.1666145), ("report", 4.408503)],
    &[
        ("random", 1.5948337),
        ("generate", 1.6301633),
        ("connected", 1.6687088),
    ...
    &[("drop", 3.786763), ("tendrils", 5.1666145)],
    &[
        ("dendritic", 3.3270679),
        ("drop", 2.4385052),
        ("trees", 3.3270679),
    ...
    &[
        ("disconnected", 2.9631274),
        ("nodes", 1.6181502),
        ("drop", 2.4385052),
    ],
    &[("selfloops", 3.61912), ("drop", 3.786763)],
    &[
        ("edges", 2.0242493),
        ("drop", 2.4385052),
        ("parallel", 2.838878),
    ...
    &[("enable", 9.266434)],
    &[("compatible", 5.6577797), ("is", 3.4764125)],
    &[
        ("has", 1.0664555),
        ("same", 2.493208),
        ("adjacency", 2.1342003),
    ...
    &[("nodes", 2.512831), ("has", 2.420083)],
    &[("has", 2.420083), ("edges", 3.1434634)],
    &[
        ("has", 1.5584248),
        ("trap", 2.7354429),
        ("nodes", 1.6181502),
    ],
    &[("directed", 3.786763), ("is", 3.4764125)],
    &[
        ("has", 1.5584248),
        ("edge", 0.83248013),
        ("weights", 2.2386534),
    ...
    &[
        ("probabilities", 1.7966214),
        ("representing", 1.7966214),
        ("weights", 1.1039307),
        ("edge", 0.4105148),
        ("has", 0.7684946),
    ],
    ...
    &[("has", 2.420083), ("selfloops", 3.61912)],
    &[
        ("disconnected", 2.9631274),
        ("nodes", 1.6181502),
        ("has", 1.5584248),
    ...
    &[("is", 3.4764125), ("connected", 3.786763)],
    &[
        ("node", 0.39130172),
        ("types", 1.2507362),
        ("has", 1.5584248),
    ...
    &[("multigraph", 4.8430924), ("is", 3.4764125)],
    &[
        ("by", 0.6071789),
        ("outbound", 0.67973477),
        ("node", 0.08976373),
        ("has", 0.35749912),
        ("decreasing", 0.7632218),
        ("degree", 0.45113596),
        ("nodes", 0.3712),
        ("sorted", 0.7154305),
    ],
    ...
    &[
        ...
        ("get", 0.052861214),
        ("unchecked", 0.28691605),
        ("reciprocal", 0.67973477),
    ],
    &[
        ("from", 0.19780533),
        ("sqrt", 0.8522431),
        ("get", 0.066276744),
        ("reciprocal", 0.8522431),
        ("node", 0.11254466),
        ("id", 0.292151),
        ("degree", 0.56562877),
    ],
    ...
    &[("get", 0.35784292), ("tendrils", 5.1666145)],
    &[
        ("distribution", 1.3495206),
        ("node", 0.14494047),
        ("geometric", 1.3495206),
        ("get", 0.085354395),
        ("degree", 0.7284441),
    ...
    &[("add", 5.6577797), ("selfloops", 3.61912)],
    &[
        ("get", 0.23043476),
        ("centrality", 2.0878098),
        ("degree", 1.9666103),
    ],
    &[
        ("weighted", 1.0967333),
        ("degree", 1.3457835),
        ("get", 0.15769026),
        ("centrality", 1.4287223),
    ],
    &[
        ("get", 0.066276744),
        ("centrality", 0.6004877),
        ("id", 0.292151),
        ("from", 0.19780533),
        ("node", 0.11254466),
        ("closeness", 0.8522431),
    ...
    &[
        ("unchecked", 0.28691605),
        ("closeness", 0.67973477),
        ("id", 0.23301472),
        ("weighted", 0.3676489),
        ("centrality", 0.47893885),
        ("node", 0.08976373),
        ("from", 0.1577662),
        ("get", 0.052861214),
    ],
    ...
    &[
        ("centrality", 2.0878098),
        ("get", 0.23043476),
        ("betweenness", 2.838878),
    ],
    &[
        ("betweenness", 0.816507),
        ("from", 0.19780533),
        ("approximated", 0.816507),
        ("centrality", 0.6004877),
        ("get", 0.066276744),
        ("node", 0.11254466),
        ("id", 0.292151),
    ...
    &[
        ...
        ("centrality", 0.47893885),
        ("get", 0.052861214),
        ("betweenness", 0.6512322),
        ("from", 0.1577662),
        ("weighted", 0.3676489),
        ("node", 0.08976373),
        ("approximated", 0.6512322),
    ],
    &[
        ("centrality", 0.47893885),
        ("weighted", 0.3676489),
    ...
    &[
        ("get", 0.23043476),
        ("eigenvector", 3.3270679),
        ("centrality", 2.0878098),
    ],
    &[
        ("eigenvector", 2.2767665),
        ("get", 0.15769026),
        ("centrality", 1.4287223),
        ("weighted", 1.0967333),
    ],
    &[("to", 3.6992924), ("dot", 5.6577797)],
    &[("stars", 5.6577797), ("get", 0.35784292)],
    &[
        ("detection", 1.7966214),
        ("get", 0.113632604),
        ("louvain", 1.7966214),
    ...
    &[
        ("modularity", 0.95691824),
        ("node", 0.11254466),
        ("get", 0.066276744),
        ("from", 0.19780533),
        ("community", 0.89699805),
        ("memberships", 0.95691824),
        ("directed", 0.7013533),
    ],
    &[
        ("memberships", 0.95691824),
    ...
    &[
        ("get", 0.113632604),
        ("preferential", 1.2024822),
        ("unchecked", 0.6167664),
        ("attachment", 1.2024822),
        ("minimum", 1.3052163),
    ],
    &[
        ("attachment", 1.2024822),
    ...
    &[
        ("attachment", 0.90323675),
        ("weighted", 0.5936385),
        ("unchecked", 0.46328008),
        ("preferential", 0.90323675),
        ("get", 0.085354395),
        ("minimum", 0.98040485),
    ],
    &[
    ...
    &[
        ("preferential", 0.7013533),
        ("unchecked", 0.35973185),
        ("get", 0.066276744),
        ("from", 0.19780533),
        ("attachment", 0.7013533),
        ("node", 0.11254466),
        ("ids", 0.29045498),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.052861214),
        ("from", 0.1577662),
        ("attachment", 0.55938756),
        ("ids", 0.231662),
        ("preferential", 0.55938756),
    ],
    &[
        ("ids", 0.29045498),
        ("weighted", 0.4609537),
    ...
    &[
        ...
        ("ids", 0.18887056),
        ("resource", 0.51159495),
        ("allocation", 0.51159495),
        ("unchecked", 0.23391837),
    ],
    &[
        ("allocation", 0.7867574),
        ("index", 0.7191766),
        ("get", 0.066276744),
        ("node", 0.11254466),
        ("ids", 0.29045498),
...
pub const DENDRITICTREE_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[("tree", 1.5688217), ("is", 0.87846726)],
    &[("is", 0.87846726), ("tendril", 2.0160882)],
    &[
        ("tree", 0.971282),
        ("is", 0.5438728),
        ("dendritic", 1.2481917),
    ...
    &[("star", 2.0160882), ("is", 0.87846726)],
    &[("get", 0.39992672), ("depth", 2.0160882)],
    &[
        ("get", 0.16498879),
        ("name", 0.83173233),
        ("root", 0.6472135),
