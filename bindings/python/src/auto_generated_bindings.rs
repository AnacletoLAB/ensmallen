...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    &[
        ("connected", 0.96806514),
        ("from", 0.23846117),
        ("id", 0.39984813),
        ("is", 0.88279766),
        ("node", 0.1373002),
        ("unchecked", 0.49422935),
    ],
    &[
        ("connected", 1.2858915),
        ("from", 0.3167506),
    ...
    &[("has", 1.5830958), ("name", 1.4897506), ("node", 0.3671134)],
    &[
        ("has", 1.088039),
        ("id", 0.7347869),
        ("node", 0.25231177),
    ...
    &[
        ...
        ("node", 0.05784393),
        ("type", 0.16613996),
        ("unchecked", 0.20821653),
    ],
    &[
        ("components", 3.1809525),
        ("connected", 2.5884135),
        ("strongly", 3.8747518),
    ],
    &[
    ...
    &[
        ("coo", 1.0131904),
        ("get", 0.08846761),
        ("intersection", 1.2490323),
        ("matrix", 0.9483713),
        ("neighbours", 1.2490323),
        ("size", 1.1422781),
    ],
    &[
        ("get", 0.1175125),
        ("graph", 0.95995665),
        ("intersection", 1.6591032),
        ("neighbours", 1.6591032),
        ("size", 1.5173005),
    ],
    &[
        ("ancestors", 1.1028218),
    ...
    &[("components", 4.909368), ("remove", 2.8428102)],
    &[("overlaps", 9.715905)],
    &[("contains", 8.906993)],
    &[
        ("bipartite", 2.9487262),
    ...
    &[
        ("be", 3.0542245),
        ("multigraph", 3.0542245),
        ("must", 2.4420254),
    ],
    &[
        ("be", 2.0991244),
        ("multigraph", 2.0991244),
        ("must", 1.678369),
        ("not", 2.026617),
    ],
    &[
    ...
    &[("circles", 5.9801526), ("get", 0.36507475)],
    &[
        ("get", 0.2365448),
        ("memory", 2.535756),
        ("stats", 3.8747518),
    ...
    &[("get", 0.36507475), ("transitivity", 5.9801526)],
    &[
        ("get", 0.08846761),
        ("node", 0.1373002),
        ("number", 0.6005891),
    ...
    &[
        ("clustering", 1.6591032),
        ("coefficient", 1.4199947),
        ("get", 0.1175125),
        ("node", 0.18237735),
        ("per", 1.6591032),
    ],
    &[
        ("clustering", 3.3396637),
        ("coefficient", 2.8583543),
        ("get", 0.2365448),
    ],
    &[
        ("average", 2.6630611),
        ("clustering", 2.2953029),
        ("coefficient", 1.9645058),
        ("get", 0.16257384),
    ],
    &[
        ("are", 3.1809525),
        ("nodes", 1.7338729),
        ("remappable", 3.8747518),
    ],
    &[
        ("from", 0.3167506),
        ("ids", 0.4875423),
    ...
    &[("connected", 3.9948645), ("holdout", 4.289489)],
    &[("holdout", 4.289489), ("random", 3.4801729)],
    &[
        ("get", 0.1175125),
        ("holdout", 1.3807269),
        ("indices", 1.9249283),
    ...
    &[("chains", 5.9801526), ("get", 0.36507475)],
    &[
        ("breadth", 0.42685238),
        ("first", 0.42685238),
        ("from", 0.10046258),
        ...
        ("node", 0.05784393),
        ("parallel", 0.48123646),
        ("predecessors", 0.6105222),
        ("search", 0.42685238),
        ("unchecked", 0.20821653),
    ],
    &[
        ("breadth", 0.42685238),
        ("distances", 0.52621144),
        ("first", 0.42685238),
        ("from", 0.10046258),
        ("get", 0.037270993),
        ("ids", 0.15463194),
    ...
    &[
        ("and", 0.31379625),
        ("distant", 0.47222525),
        ("eccentricity", 0.39200526),
        ("from", 0.084762596),
        ("get", 0.031446397),
        ("id", 0.27502152),
        ("most", 0.4228776),
        ("node", 0.09443712),
        ("unchecked", 0.17567708),
    ],
    &[
        ("eccentricity", 0.85778534),
        ("from", 0.18547738),
        ("get", 0.068810955),
        ("id", 0.31100568),
        ("node", 0.1067934),
    ...
    &[("diameter", 5.482266), ("get", 0.36507475)],
    &[
        ("breadth", 0.7880691),
        ("first", 0.7880691),
        ("from", 0.18547738),
    ...
    &[("density", 5.9801526), ("get", 0.36507475)],
    &[
        ("get", 0.16257384),
        ("nodes", 1.1916659),
        ("rate", 2.026617),
    ...
    &[
        ("destination", 1.9101804),
        ("get", 0.16257384),
        ("ids", 0.6744952),
        ("node", 0.25231177),
    ],
    &[
        ("destination", 1.3807269),
        ("directed", 1.0011611),
        ("get", 0.1175125),
        ("ids", 0.4875423),
        ("node", 0.18237735),
    ...
    &[("get", 0.2365448), ("node", 0.3671134), ("urls", 3.8747518)],
    &[
        ("get", 0.2365448),
        ("node", 0.3671134),
        ("ontologies", 3.0542245),
    ],
    &[
        ("from", 0.23846117),
        ("get", 0.08846761),
    ...
    &[("get", 0.2365448), ("ids", 0.98139), ("node", 0.3671134)],
    &[
        ("directed", 1.0011611),
        ("edge", 0.41180536),
        ("get", 0.1175125),
    ...
    &[("directed", 3.1102955), ("to", 3.8385832)],
    &[
        ("to", 2.4871533),
        ("triangular", 3.5521536),
        ("upper", 3.8747518),
    ],
    &[
        ("lower", 3.8747518),
    ...
    &[("bidiagonal", 5.9801526), ("to", 3.8385832)],
    &[("arrowhead", 5.9801526), ("to", 3.8385832)],
    &[("to", 3.8385832), ("transposed", 5.9801526)],
    &[("to", 3.8385832), ("undirected", 4.289489)],
    &[("complementary", 5.9801526), ("to", 3.8385832)],
    &[
        ("graph", 0.95995665),
        ("multi", 1.9249283),
        ("similarity", 1.9249283),
        ("structural", 1.7646655),
        ("to", 1.2355868),
    ],
    &[
        ("approximated", 2.7090695),
        ("cliques", 3.5521536),
        ("get", 0.2365448),
    ],
    &[
    ...
    &[("report", 4.7137804), ("textual", 5.482266)],
    &[
        ("connected", 1.7789794),
        ("generate", 1.7789794),
        ("graph", 1.3280616),
    ...
    &[("remove", 2.8428102), ("tendrils", 5.482266)],
    &[
        ("dendritic", 3.5521536),
        ("remove", 1.841957),
        ("trees", 3.5521536),
    ...
    &[
        ("disconnected", 3.1809525),
        ("nodes", 1.7338729),
        ("remove", 1.841957),
    ],
    &[("remove", 2.8428102), ("selfloops", 3.7039323)],
    &[
        ("edges", 2.1370933),
        ("parallel", 3.0542245),
        ("remove", 1.841957),
    ...
    &[
        ("arborescence", 2.441344),
        ("kruskal", 2.441344),
        ("random", 1.5497787),
        ("spanning", 2.186223),
    ],
    &[
        ("arborescence", 3.5521536),
        ("kruskal", 3.5521536),
        ("spanning", 3.1809525),
    ],
    &[
    ...
    &[("enable", 9.715905)],
    &[("all", 3.9948645), ("disable", 5.9801526)],
    &[
        ("compatible", 2.186223),
        ("has", 1.088039),
        ("node", 0.25231177),
        ("vocabularies", 2.2953029),
    ],
    &[
        ("compatible", 1.5802575),
        ("has", 0.78646225),
        ("node", 0.18237735),
        ("types", 0.65649027),
        ("vocabularies", 1.6591032),
    ],
    &[
        ("compatible", 1.5802575),
        ("edge", 0.41180536),
    ...
    &[("compatible", 4.909368), ("is", 3.6429956)],
    &[
        ("adjacency", 2.6630611),
        ("has", 1.088039),
        ("matrix", 1.7427887),
    ...
    &[("has", 2.443293), ("nodes", 2.675997)],
    &[("edges", 3.2983131), ("has", 2.443293)],
    &[
        ("has", 1.5830958),
        ("nodes", 1.7338729),
        ("trap", 2.8583543),
    ],
    &[("directed", 3.1102955), ("is", 3.6429956)],
    &[
        ("acyclic", 3.5521536),
        ("directed", 2.0152702),
        ("is", 2.3604252),
    ...
    &[
        ("edge", 0.41180536),
        ("has", 0.78646225),
        ("probabilities", 1.9249283),
        ("representing", 1.9249283),
        ("weights", 1.1541696),
    ],
    &[
        ("has", 1.088039),
    ...
    &[("edge", 0.8289366), ("has", 1.5830958), ("types", 1.321471)],
    &[("has", 2.443293), ("selfloops", 3.7039323)],
    &[
        ("disconnected", 3.1809525),
        ("has", 1.5830958),
        ("nodes", 1.7338729),
    ...
    &[("connected", 3.9948645), ("is", 3.6429956)],
    &[("has", 1.5830958), ("node", 0.3671134), ("types", 1.321471)],
    &[
        ("has", 1.088039),
        ("multilabel", 2.441344),
        ("node", 0.25231177),
    ...
    &[("is", 3.6429956), ("multigraph", 4.7137804)],
    &[
        ("has", 1.5830958),
        ("node", 0.3671134),
        ("ontologies", 3.0542245),
    ...
    &[("get", 0.36507475), ("tendrils", 5.482266)],
    &[
        ("degree", 0.7799801),
        ("distribution", 1.4491549),
        ("geometric", 1.4491549),
        ("get", 0.08846761),
        ("node", 0.1373002),
        ("threshold", 1.4491549),
    ...
    &[("add", 4.4114814), ("selfloops", 3.7039323)],
    &[
        ("centrality", 2.2881725),
        ("degree", 2.0855117),
        ("get", 0.2365448),
    ],
    &[
    ...
    &[
        ("betweenness", 3.0542245),
        ("centrality", 2.2881725),
        ("get", 0.2365448),
    ],
    &[
        ("approximated", 0.7880691),
        ("betweenness", 0.8884748),
        ("centrality", 0.6656301),
        ("from", 0.18547738),
        ("get", 0.068810955),
        ("id", 0.31100568),
    ...
    &[
        ("approximated", 0.62938076),
        ("betweenness", 0.70956844),
        ("centrality", 0.5315965),
        ("from", 0.148129),
        ("get", 0.05495494),
        ("id", 0.2483805),
    ...
    &[
        ("centrality", 2.2881725),
        ("eigenvector", 3.5521536),
        ("get", 0.2365448),
    ],
    &[
        ("centrality", 1.572628),
        ("eigenvector", 2.441344),
        ("get", 0.16257384),
        ("weighted", 1.2545279),
    ],
    &[("dot", 5.9801526), ("to", 3.8385832)],
    &[
        ("16", 0.97150916),
        ("base", 0.7529703),
        ("from", 0.18547738),
    ...
    &[("get", 0.36507475), ("stars", 5.9801526)],
    &[
        ("community", 1.6591032),
        ("detection", 1.9249283),
        ("get", 0.1175125),
    ...
    &[
        ("community", 0.97150916),
        ("directed", 0.58624274),
        ("from", 0.18547738),
        ("get", 0.068810955),
        ("memberships", 1.0333226),
        ("modularity", 1.0333226),
        ("node", 0.1067934),
    ],
    &[
        ("community", 0.97150916),
    ...
    &[
        ...
        ("ids", 0.28548664),
        ("node", 0.1067934),
        ("structural", 1.0333226),
        ("unchecked", 0.3844163),
    ],
    &[
        ("attachment", 1.2858915),
        ("get", 0.1175125),
        ("minimum", 1.4199947),
        ("preferential", 1.2858915),
        ("unchecked", 0.65649027),
    ],
    &[
        ("attachment", 1.2858915),
    ...
    &[
        ("attachment", 0.96806514),
        ("get", 0.08846761),
        ("minimum", 1.0690228),
        ("preferential", 0.96806514),
        ("unchecked", 0.49422935),
        ("weighted", 0.68267494),
    ],
    &[
    ...
    &[
        ("attachment", 0.7529703),
        ("from", 0.18547738),
        ("get", 0.068810955),
        ("ids", 0.28548664),
        ("node", 0.1067934),
        ("preferential", 0.7529703),
        ("unchecked", 0.3844163),
    ],
    &[
        ("attachment", 0.96806514),
    ...
    &[
        ("attachment", 0.60134953),
        ("from", 0.148129),
        ("get", 0.05495494),
        ("ids", 0.22800006),
        ("node", 0.085289106),
        ("preferential", 0.60134953),
        ("unchecked", 0.3070089),
        ("weighted", 0.42406887),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.05495494),
        ("ids", 0.22800006),
        ("intersection", 0.7758827),
        ("neighbours", 0.7758827),
        ("node", 0.085289106),
        ("size", 0.70956844),
        ("unchecked", 0.3070089),
    ],
    &[
        ("coefficient", 0.8314962),
        ("from", 0.18547738),
        ("get", 0.068810955),
        ("ids", 0.28548664),
        ("jaccard", 0.76968277),
    ...
    &[
        ("attachment", 1.7789794),
        ("get", 0.16257384),
        ("preferential", 1.7789794),
        ("scores", 2.186223),
    ],
    &[
        ("allocation", 1.4199947),
        ("get", 0.1175125),
        ("index", 1.3144324),
        ("resource", 1.4199947),
        ("scores", 1.5802575),
