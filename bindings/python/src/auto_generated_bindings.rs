...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("approximated", 1.773801),
        ("cliques", 2.391508),
        ("get", 0.17435916),
        ("number", 1.097764),
    ],
    &[
        ("compatible", 2.1385055),
        ("has", 1.0271717),
        ("node", 0.25174046),
        ("vocabularies", 2.2466795),
    ],
    &[
        ("compatible", 1.5441071),
        ("has", 0.74166894),
        ("node", 0.1817691),
        ("types", 0.6253798),
        ("vocabularies", 1.6222141),
    ],
    &[
        ("compatible", 1.5441071),
        ("edge", 0.38827202),
    ...
    &[("compatible", 4.8197684), ("is", 3.6199722)],
    &[
        ("adjacency", 2.2466795),
        ("has", 1.0271717),
        ("matrix", 1.9802247),
    ...
    &[("get", 0.39297104), ("stars", 5.8855433)],
    &[("chains", 5.8855433), ("get", 0.39297104)],
    &[
        ("arborescence", 2.391508),
        ("kruskal", 2.391508),
        ("random", 1.5539247),
        ("spanning", 2.2466795),
    ],
    &[
        ("arborescence", 3.484897),
        ("kruskal", 3.484897),
        ("spanning", 3.273853),
    ],
    &[
        ("components", 3.1162224),
        ("connected", 2.5277162),
        ("get", 0.25407553),
    ],
    &[("overlaps", 9.588835)],
    ...
    &[("dot", 5.8855433), ("to", 3.9095433)],
    &[
        ("are", 3.8052995),
        ("nodes", 1.6789916),
        ("remappable", 3.8052995),
    ],
    &[
        ("from", 0.32484043),
        ("ids", 0.4952),
    ...
    &[
        ("disconnected", 0.9029222),
        ("from", 0.18995163),
        ("id", 0.30245444),
        ("is", 0.6781557),
        ("node", 0.19817401),
        ("unchecked", 0.38102952),
    ],
    &[
        ("from", 0.244359),
        ("id", 0.3890857),
    ...
    &[
        ...
        ("node", 0.08484791),
        ("selfloops", 0.5725566),
        ("singleton", 0.43846953),
        ("unchecked", 0.30416328),
        ("with", 0.48097473),
    ],
    &[
        ("from", 0.18995163),
    ...
    &[
        ...
        ("node", 0.057506274),
        ("type", 0.15970372),
        ("unchecked", 0.20614883),
    ],
    &[
        ("attachment", 1.2524987),
        ("get", 0.12589596),
        ("minimum", 1.3853457),
        ("preferential", 1.2524987),
        ("unchecked", 0.6516069),
    ],
    &[
        ("attachment", 1.2524987),
    ...
    &[
        ("attachment", 0.9421836),
        ("get", 0.094704375),
        ("minimum", 1.0421168),
        ("preferential", 0.9421836),
        ("unchecked", 0.49016684),
        ("weighted", 0.65369445),
    ],
    &[
    ...
    &[
        ("attachment", 0.73240316),
        ("from", 0.18995163),
        ("get", 0.07361812),
        ("ids", 0.28957),
        ("node", 0.10629014),
        ("preferential", 0.73240316),
        ("unchecked", 0.38102952),
    ],
    &[
        ("attachment", 0.9421836),
    ...
    &[
        ("attachment", 0.58465326),
        ("from", 0.1516321),
        ("get", 0.058766913),
        ("ids", 0.23115416),
        ("node", 0.08484791),
        ("preferential", 0.58465326),
        ("unchecked", 0.30416328),
        ("weighted", 0.4056371),
    ],
    &[
    ...
    &[
        ...
        ("node", 0.06922239),
        ("resource", 0.5275756),
        ("unchecked", 0.24814884),
        ("weighted", 0.33093533),
    ],
    &[
        ("allocation", 0.8100859),
        ("from", 0.18995163),
        ("get", 0.07361812),
        ("ids", 0.28957),
        ("index", 0.74893624),
    ...
    &[
        ("attachment", 1.7346436),
        ("get", 0.17435916),
        ("preferential", 1.7346436),
        ("scores", 2.1385055),
    ],
    &[
        ("allocation", 1.3853457),
        ("get", 0.12589596),
        ("index", 1.2807722),
        ("resource", 1.3853457),
        ("scores", 1.5441071),
    ...
    &[("enable", 9.588835)],
    &[("all", 3.9095433), ("disable", 5.8855433)],
    &[
        ("get", 0.25407553),
        ("node", 0.36683527),
        ("tuples", 3.8052995),
    ...
    &[("get", 0.39297104), ("transitivity", 5.8855433)],
    &[
        ("get", 0.094704375),
        ("node", 0.13673456),
        ("number", 0.59625804),
    ...
    &[
        ("clustering", 1.6222141),
        ("coefficient", 1.3853457),
        ("get", 0.12589596),
        ("node", 0.1817691),
        ("per", 1.7267876),
    ],
    &[
        ("clustering", 3.273853),
        ("coefficient", 2.7958198),
        ("get", 0.25407553),
    ],
    &[
        ("average", 2.6113842),
        ("clustering", 2.2466795),
        ("coefficient", 1.9186295),
        ("get", 0.17435916),
    ],
    &[
    ...
    &[
        ("and", 0.3043027),
        ("distant", 0.4608147),
        ("eccentricity", 0.38156536),
        ("from", 0.08668771),
        ("get", 0.033596903),
        ("id", 0.2671962),
        ("most", 0.41206416),
        ("node", 0.09389951),
        ("unchecked", 0.17388941),
    ],
    &[
        ("eccentricity", 0.8360927),
        ("from", 0.18995163),
        ("get", 0.07361812),
        ("id", 0.30245444),
        ("node", 0.10629014),
    ...
    &[("diameter", 5.389986), ("get", 0.39297104)],
    &[
        ("breadth", 0.7671251),
        ("first", 0.7671251),
        ("from", 0.18995163),
    ...
    &[("remove", 2.762879), ("tendrils", 5.389986)],
    &[
        ("dendritic", 3.484897),
        ("remove", 1.7863401),
        ("trees", 3.484897),
    ...
    &[
        ("disconnected", 3.1162224),
        ("nodes", 1.6789916),
        ("remove", 1.7863401),
    ],
    &[("remove", 2.762879), ("selfloops", 3.8286538)],
    &[
        ("edges", 2.0794678),
        ("parallel", 2.9903567),
        ("remove", 1.7863401),
    ...
    &[("components", 4.8197684), ("remove", 2.762879)],
    &[
        ("centrality", 2.2295184),
        ("degree", 2.1067426),
        ("get", 0.25407553),
    ],
    &[
        ("centrality", 1.5300057),
        ("degree", 1.4457508),
        ("get", 0.17435916),
        ("weighted", 1.2035096),
    ],
    &[
        ("centrality", 0.6460007),
        ("closeness", 0.9029222),
        ("from", 0.18995163),
        ("get", 0.07361812),
        ("id", 0.30245444),
    ...
    &[
        ("betweenness", 2.9903567),
        ("centrality", 2.2295184),
        ("get", 0.25407553),
    ],
    &[
        ("approximated", 0.74893624),
        ("betweenness", 0.86645275),
        ("centrality", 0.6460007),
        ("from", 0.18995163),
        ("get", 0.07361812),
        ("id", 0.30245444),
    ...
    &[
        ("approximated", 0.59785104),
        ("betweenness", 0.69166064),
        ("centrality", 0.515681),
        ("from", 0.1516321),
        ("get", 0.058766913),
        ("id", 0.24143939),
    ...
    &[
        ("centrality", 2.2295184),
        ("eigenvector", 3.484897),
        ("get", 0.25407553),
    ],
    &[
        ("centrality", 1.5300057),
        ("eigenvector", 2.391508),
        ("get", 0.17435916),
        ("weighted", 1.2035096),
    ],
    &[("circles", 5.8855433), ("get", 0.39297104)],
    &[("name", 2.2673218), ("set", 4.4630346)],
    &[
        ("all", 1.2524987),
        ("edge", 0.38827202),
        ("inplace", 1.0050039),
    ...
    &[
        ...
        ("must", 1.6656269),
        ("node", 0.25174046),
        ("ontologies", 2.0521302),
    ],
    &[
        ("be", 3.1162224),
        ("must", 2.4271452),
        ("undirected", 2.9903567),
    ],
    &[
        ("have", 1.5441071),
        ("must", 1.2026652),
    ...
    &[
        ...
        ("node", 0.25174046),
        ("share", 2.6113842),
        ("vocabulary", 2.6113842),
    ],
    &[("edge", 1.2119503), ("encode", 5.8855433)],
    &[("decode", 5.8855433), ("edge", 1.2119503)],
    &[
        ("edge", 0.38827202),
        ("encodable", 1.885549),
        ("get", 0.12589596),
    ...
    &[("report", 4.6250954), ("textual", 5.389986)],
    &[
        ("components", 2.1385055),
        ("connected", 1.7346436),
        ("get", 0.17435916),
        ("number", 1.097764),
    ],
    ...
    &[("density", 5.8855433), ("get", 0.39297104)],
    &[
        ("get", 0.17435916),
        ("nodes", 1.1522069),
        ("rate", 1.9802247),
    ...
    &[
        ...
        ("get", 0.17435916),
        ("number", 1.097764),
        ("undirected", 2.0521302),
    ],
    &[
        ("edges", 1.030389),
        ("get", 0.12589596),
        ("number", 0.79264003),
        ("undirected", 1.4817399),
        ("unique", 1.2524987),
    ],
    &[
        ("edges", 2.0794678),
    ...
    &[
        ("destination", 1.8647552),
        ("get", 0.17435916),
        ("ids", 0.68582547),
        ("node", 0.25174046),
    ],
    &[
        ("destination", 1.3464458),
        ("directed", 1.0174372),
        ("get", 0.12589596),
        ("ids", 0.4952),
        ("node", 0.1817691),
    ...
    &[("get", 0.39297104), ("tendrils", 5.389986)],
    &[
        ("get", 0.17435916),
        ("graph", 1.3593756),
        ("laplacian", 2.0521302),
        ("transformed", 2.0521302),
    ],
    &[
        ("coo", 1.4183913),
        ("edges", 0.77510303),
    ...
    &[
        ("get", 0.12589596),
        ("graph", 0.98153657),
        ("normalized", 1.5441071),
        ("symmetric", 1.7267876),
        ("transformed", 1.4817399),
    ],
    &[
        ("community", 1.6222141),
        ("detection", 1.885549),
    ...
    &[
        ...
        ("from", 0.18995163),
        ("get", 0.07361812),
        ("memberships", 1.0097452),
        ("modularity", 1.0097452),
        ("node", 0.10629014),
    ],
    &[
        ("community", 0.9485956),
    ...
    &[("has", 2.3150418), ("nodes", 2.596846)],
    &[("edges", 3.216251), ("has", 2.3150418)],
    &[("has", 1.4967909), ("nodes", 1.6789916), ("trap", 2.885576)],
    &[("directed", 3.1758235), ("is", 3.6199722)],
    &[
        ("edge", 0.7835868),
        ("has", 1.4967909),
        ("weights", 2.3012795),
    ...
    &[
        ("edge", 0.38827202),
        ("has", 0.74166894),
        ("probabilities", 1.885549),
        ("representing", 1.885549),
        ("weights", 1.140298),
    ],
    &[
        ("has", 1.0271717),
    ...
    &[("has", 2.3150418), ("selfloops", 3.8286538)],
    &[
        ("disconnected", 3.1162224),
        ("has", 1.4967909),
        ("nodes", 1.6789916),
    ...
    &[("connected", 3.9095433), ("is", 3.6199722)],
    &[
        ("has", 1.4967909),
        ("node", 0.36683527),
        ("types", 1.2621032),
    ...
    &[("is", 3.6199722), ("multigraph", 5.063571)],
    &[
        ("has", 1.4967909),
        ("node", 0.36683527),
        ("ontologies", 2.9903567),
    ...
    &[
        ...
        ("enabled", 1.161544),
        ("has", 0.5579154),
        ("reciprocal", 1.1146287),
        ("sqrt", 1.1146287),
        ("tradeoff", 1.161544),
    ],
    &[("csv", 5.8855433), ("from", 1.0139554)],
    &[
        ("edges", 0.77510303),
        ("features", 1.4183913),
        ("from", 0.244359),
    ...
    &[("add", 4.324211), ("selfloops", 3.8286538)],
    &[
        ("directed", 2.0533295),
        ("inplace", 2.0282373),
        ("to", 2.5277162),
    ],
    &[("directed", 3.1758235), ("to", 3.9095433)],
    &[
        ("to", 2.5277162),
        ("triangular", 3.484897),
        ("upper", 3.8052995),
    ...
    &[("bidiagonal", 5.8855433), ("to", 3.9095433)],
    &[("arrowhead", 5.8855433), ("to", 3.9095433)],
    &[("to", 3.9095433), ("transposed", 5.8855433)],
    &[("complementary", 5.8855433), ("to", 3.9095433)],
    &[
        ("graph", 1.9808769),
        ("negative", 3.484897),
        ("sample", 3.484897),
    ...
    &[("connected", 3.9095433), ("holdout", 4.2027893)],
    &[("holdout", 4.2027893), ("random", 3.5022388)],
    &[
        ("get", 0.12589596),
        ("holdout", 1.3464458),
        ("indices", 1.885549),
