...
impl Graph {
    ...
    ///     Minimum node degree for each of the two nodes involved in the edge isomorphism. By default, 10.
    ...
    ) -> PyResult<Vec<Vec<EdgeT>>> {
        Ok(pe!(self
            .inner
            .get_isomorphic_edge_ids_groups(minimum_node_degree, number_of_neighbours_for_hash))?
        .into_iter()
        .map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>())
        .collect::<Vec<_>>())
    }
...
pub const GRAPH_METHODS_NAMES: &[&str] = &[
    ...
    "get_clique_edge_names",
    "from_csv",
    "get_isomorphic_edge_ids_groups",
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    &[
        ...
        ("node", 0.0578071),
        ("parallel", 0.48093003),
        ("predecessors", 0.61013347),
        ("search", 0.42658058),
        ("unchecked", 0.20925388),
    ],
    &[
        ("breadth", 0.42658058),
        ("distances", 0.5258764),
    ...
    &[
        ("and", 0.31359226),
        ("distant", 0.47191828),
        ("eccentricity", 0.3917504),
        ("from", 0.08504043),
        ("get", 0.031425953),
        ("id", 0.27612692),
        ("most", 0.4226027),
        ("node", 0.09437773),
        ("unchecked", 0.17654997),
    ],
    &[
        ("eccentricity", 0.8572911),
        ("from", 0.18609911),
        ("get", 0.06877131),
        ("id", 0.31227225),
        ("node", 0.106731884),
        ("unchecked", 0.38635498),
        ("weighted", 0.5306852),
    ],
    &[
        ("and", 0.37168172),
        ("distant", 0.5593359),
        ("eccentricity", 0.4643178),
        ("from", 0.10079322),
        ("get", 0.03724726),
        ("id", 0.32531962),
        ("most", 0.5008851),
    ...
    &[("diameter", 5.480898), ("get", 0.3649836)],
    &[
        ("breadth", 0.7876151),
        ("first", 0.7876151),
        ("from", 0.18609911),
    ...
    &[("chains", 5.97866), ("get", 0.3649836)],
    &[("circles", 5.97866), ("get", 0.3649836)],
    &[
        ("approximated", 2.7080843),
        ("cliques", 3.5508618),
        ("get", 0.23645876),
    ],
    &[
    ...
    &[
        ("coo", 1.0126392),
        ("get", 0.088419475),
        ("intersection", 1.2483528),
        ("matrix", 0.94785535),
        ("neighbours", 1.2483528),
        ("size", 1.1416566),
    ],
    &[
        ("get", 0.11745351),
        ("graph", 0.9594748),
        ("intersection", 1.6582704),
        ("neighbours", 1.6582704),
        ("size", 1.516539),
    ],
    &[
        ("ancestors", 1.1022217),
    ...
    &[("csv", 5.97866), ("from", 0.9876666)],
    &[
        ("edge", 0.41159865),
        ("get", 0.11745351),
        ("groups", 1.2349665),
        ("ids", 0.48516443),
        ("isomorphic", 1.0480809),
    ],
    &[
        ("edge", 0.569463),
        ("get", 0.16250157),
    ...
    &[
        ("approximated", 0.6290026),
        ("get", 0.054921914),
        ("groups", 0.5774773),
        ("isomorphic", 0.49008846),
        ("node", 0.08523786),
        ("number", 0.37285405),
        ("of", 0.38115606),
        ("type", 0.24594903),
    ...
    &[("get", 0.3649836), ("transitivity", 5.97866)],
    &[
        ("get", 0.088419475),
        ("node", 0.1372255),
        ("number", 0.6002624),
    ...
    &[
        ("clustering", 1.6582704),
        ("coefficient", 1.419282),
        ("get", 0.11745351),
        ("node", 0.18228582),
        ("per", 1.6582704),
    ],
    &[
        ("clustering", 3.3384492),
        ("coefficient", 2.8573148),
        ("get", 0.23645876),
    ],
    &[
        ("average", 2.6618776),
        ("clustering", 2.2942827),
        ("coefficient", 1.9636327),
        ("get", 0.16250157),
    ],
    &[
        ("edge", 0.44902107),
    ...
    &[
        ("community", 0.97094953),
        ("directed", 0.585905),
        ("from", 0.18609911),
        ("get", 0.06877131),
        ("memberships", 1.0327274),
        ("modularity", 1.0327274),
        ("node", 0.106731884),
    ],
    &[
        ("community", 0.97094953),
    ...
    &[
        ("get", 0.23645876),
        ("nodes", 1.7332424),
        ("subsampled", 3.8733428),
    ],
    &[
        ("compatible", 2.1852512),
        ("has", 1.0875554),
        ("node", 0.25219962),
        ("vocabularies", 2.2942827),
    ],
    &[
        ("compatible", 1.5794643),
        ("has", 0.7860675),
        ("node", 0.18228582),
        ("types", 0.6561608),
        ("vocabularies", 1.6582704),
    ],
    &[
        ("compatible", 1.5794643),
        ("edge", 0.41159865),
    ...
    &[("compatible", 4.9081426), ("is", 3.6420865)],
    &[
        ("adjacency", 2.6618776),
        ("has", 1.0875554),
        ("matrix", 1.742014),
    ...
    &[
        ...
        ("must", 1.677623),
        ("node", 0.25219962),
        ("ontologies", 2.0981915),
    ],
    &[
        ("be", 3.0531137),
        ("must", 2.4411376),
        ("undirected", 2.7783003),
    ],
    &[
        ("acyclic", 2.440259),
        ("be", 2.0981915),
    ...
    &[
        ("be", 3.0531137),
        ("multigraph", 3.0531137),
        ("must", 2.4411376),
    ],
    &[
        ("be", 2.0981915),
        ("multigraph", 2.0981915),
        ("must", 1.677623),
        ("not", 2.025716),
    ],
    &[
    ...
    &[("remove", 2.8421006), ("tendrils", 5.480898)],
    &[
        ("dendritic", 3.5508618),
        ("remove", 1.841287),
        ("trees", 3.5508618),
    ...
    &[
        ("disconnected", 3.1797957),
        ("nodes", 1.7332424),
        ("remove", 1.841287),
    ],
    &[("remove", 2.8421006), ("selfloops", 3.703008)],
    &[
        ("edges", 2.1363163),
        ("parallel", 3.0531137),
        ("remove", 1.841287),
    ...
    &[
        ("destination", 1.9093314),
        ("get", 0.16250157),
        ("ids", 0.67124414),
        ("node", 0.25219962),
    ],
    &[
        ("destination", 1.380034),
        ("directed", 1.0006585),
        ("get", 0.11745351),
        ("ids", 0.48516443),
        ("node", 0.18228582),
    ...
    &[("components", 4.9081426), ("remove", 2.8421006)],
    &[("add", 4.4103804), ("selfloops", 3.703008)],
    &[("name", 2.3136454), ("set", 4.7126036)],
    &[
        ("all", 1.285246),
        ("edge", 0.41159865),
        ("inplace", 1.0355362),
    ...
    &[
        ("components", 3.1797957),
        ("connected", 2.5874722),
        ("strongly", 3.8733428),
    ],
    &[("get", 0.3649836), ("tendrils", 5.480898)],
    &[
        ("edges", 0.7988368),
        ("features", 1.4483665),
        ("from", 0.23926818),
    ...
    &[("directed", 3.1095192), ("to", 3.8376253)],
    &[
        ("to", 2.486249),
        ("triangular", 3.5508618),
        ("upper", 3.8733428),
    ],
    &[
        ("lower", 3.8733428),
    ...
    &[("bidiagonal", 5.97866), ("to", 3.8376253)],
    &[("arrowhead", 5.97866), ("to", 3.8376253)],
    &[("to", 3.8376253), ("transposed", 5.97866)],
    &[("to", 3.8376253), ("undirected", 4.2884183)],
    &[("complementary", 5.97866), ("to", 3.8376253)],
    &[
        ("graph", 0.9594748),
        ("multi", 1.9239621),
        ("similarity", 1.9239621),
        ("structural", 1.7637798),
        ("to", 1.2349665),
    ],
    &[("dot", 5.97866), ("to", 3.8376253)],
    &[("enable", 9.71492)],
    &[("all", 3.9938674), ("disable", 5.97866)],
    &[("report", 7.657664)],
    &[
        ("overlap", 3.8733428),
        ("report", 3.0531137),
    ...
    &[("report", 4.7126036), ("textual", 5.480898)],
    &[
        ("16", 0.97094953),
        ("base", 0.75253654),
        ("from", 0.18609911),
    ...
    &[
        ("attachment", 0.9675385),
        ("get", 0.088419475),
        ("minimum", 1.0684413),
        ("preferential", 0.9675385),
        ("unchecked", 0.49673775),
        ("weighted", 0.68230355),
    ],
    &[
    ...
    &[
        ("attachment", 0.75253654),
        ("from", 0.18609911),
        ("get", 0.06877131),
        ("ids", 0.2840732),
        ("node", 0.106731884),
        ("preferential", 0.75253654),
        ("unchecked", 0.38635498),
    ],
    &[
        ("attachment", 0.9675385),
    ...
    &[
        ("attachment", 0.6009882),
        ("from", 0.14862186),
        ("get", 0.054921914),
        ("ids", 0.22686559),
        ("node", 0.08523786),
        ("preferential", 0.6009882),
        ("unchecked", 0.30854952),
        ("weighted", 0.42381406),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.054921914),
        ("ids", 0.22686559),
        ("intersection", 0.7754165),
        ("neighbours", 0.7754165),
        ("node", 0.08523786),
        ("size", 0.7091421),
        ("unchecked", 0.30854952),
    ],
    &[
        ("coefficient", 0.83101714),
        ("from", 0.18609911),
        ("get", 0.06877131),
        ("ids", 0.2840732),
        ("jaccard", 0.76923937),
    ...
    &[
        ("attachment", 1.7781887),
        ("get", 0.16250157),
        ("preferential", 1.7781887),
        ("scores", 2.1852512),
    ],
    &[
        ("allocation", 1.419282),
    ...
    &[
        ("arborescence", 2.440259),
        ("kruskal", 2.440259),
        ("random", 1.5490899),
        ("spanning", 2.1852512),
    ],
    &[
        ("arborescence", 3.5508618),
        ("kruskal", 3.5508618),
        ("spanning", 3.1797957),
    ],
    &[
    ...
    &[
        ("centrality", 2.2873404),
        ("degree", 2.0847533),
        ("get", 0.23645876),
    ],
    &[
        ("centrality", 1.5719291),
        ("degree", 1.4327052),
        ("get", 0.16250157),
        ("weighted", 1.2539703),
    ],
    &[
        ("centrality", 0.66524667),
        ("closeness", 0.924807),
        ("from", 0.18609911),
        ("get", 0.06877131),
        ("id", 0.31227225),
    ...
    &[
        ("centrality", 0.53127706),
        ("closeness", 0.73856634),
        ("from", 0.14862186),
        ("get", 0.054921914),
        ("id", 0.24938583),
        ("node", 0.08523786),
    ...
    &[
        ("betweenness", 3.0531137),
        ("centrality", 2.2873404),
        ("get", 0.23645876),
    ],
    &[
        ("approximated", 0.7876151),
        ("betweenness", 0.887963),
        ("centrality", 0.66524667),
        ("from", 0.18609911),
        ("get", 0.06877131),
        ("id", 0.31227225),
    ...
    &[
        ("centrality", 2.2873404),
        ("eigenvector", 3.5508618),
        ("get", 0.23645876),
    ],
    &[
        ("centrality", 1.5719291),
        ("eigenvector", 2.440259),
        ("get", 0.16250157),
        ("weighted", 1.2539703),
    ],
    &[("overlaps", 9.71492)],
    ...
    &[("connected", 3.9938674), ("holdout", 4.2884183)],
    &[("holdout", 4.2884183), ("random", 3.4793043)],
    &[
        ("get", 0.11745351),
        ("holdout", 1.380034),
        ("indices", 1.9239621),
    ...
    &[("has", 2.4426835), ("nodes", 2.6753292)],
    &[("edges", 3.29749), ("has", 2.4426835)],
    &[
        ("has", 1.5825201),
        ("nodes", 1.7332424),
        ("trap", 2.8573148),
    ],
    &[("directed", 3.1095192), ("is", 3.6420865)],
    &[
        ("acyclic", 3.5508618),
        ("directed", 2.0145373),
        ("is", 2.359567),
    ...
    &[
        ("edge", 0.41159865),
        ("has", 0.7860675),
        ("probabilities", 1.9239621),
        ("representing", 1.9239621),
        ("weights", 1.1535903),
    ],
    &[
        ("has", 1.0875554),
    ...
    &[("has", 2.4426835), ("selfloops", 3.703008)],
    &[
        ("disconnected", 3.1797957),
        ("has", 1.5825201),
        ("nodes", 1.7332424),
    ...
    &[("connected", 3.9938674), ("is", 3.6420865)],
    &[
        ("has", 1.5825201),
        ("node", 0.3669799),
        ("types", 1.3209904),
    ...
    &[("is", 3.6420865), ("multigraph", 4.7126036)],
    &[
        ("has", 1.5825201),
        ("node", 0.3669799),
        ("ontologies", 3.0531137),
    ...
    &[("has", 1.5825201), ("name", 1.4989213), ("node", 0.3669799)],
    &[
        ("has", 1.0875554),
        ("id", 0.7378765),
        ("node", 0.25219962),
