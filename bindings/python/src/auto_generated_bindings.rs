...
impl Graph {
    ...
    #[automatically_generated_binding]
    #[text_signature = "($self, number_of_negative_samples, random_state, seed_graph, only_from_same_component, sample_only_edges_with_heterogeneous_node_types, minimum_node_degree, maximum_node_degree, verbose)"]
    ...
    ///     If there are no node types in the graph.
    ///
    pub fn get_node_with_unknown_node_types_mask(&self) -> PyResult<Py<PyArray1<bool>>> {
        Ok({
            let gil = pyo3::Python::acquire_gil();
            to_ndarray_1d!(
                gil,
                pe!(self.inner.get_node_with_unknown_node_types_mask())?,
                bool
            )
        })
    }
    ...
    ///     If there are no node types in the graph.
    ///
    pub fn get_node_with_known_node_types_mask(&self) -> PyResult<Py<PyArray1<bool>>> {
        Ok({
            let gil = pyo3::Python::acquire_gil();
            to_ndarray_1d!(
                gil,
                pe!(self.inner.get_node_with_known_node_types_mask())?,
                bool
            )
        })
    }
    ...
    #[automatically_generated_binding]
    #[text_signature = "($self, src_node_name_prefix, dst_node_name_prefix)"]
    /// Returns vector of directed edge node names with given node name prefixes
    ///
    /// Parameters
    /// ----------
    /// src_node_name_prefix: Optional[str]
    ///     Prefix of the source node names.
    /// dst_node_name_prefix: Optional[str]
    ///     Prefix of the source node names.
    ///
    pub fn get_directed_edge_node_names_from_node_curie_prefixes(
        ...
        self.inner
            .get_directed_edge_node_names_from_node_curie_prefixes(
                src_node_name_prefix.into(),
                dst_node_name_prefix.into(),
            )
            .into_iter()
            .map(|x| x.into())
            .collect::<Vec<_>>()
    ...
    #[automatically_generated_binding]
    #[text_signature = "($self, curie_prefix)"]
    ...
    ///     Prefix of the source node names.
    ///
    pub fn get_node_ids_from_node_curie_prefix(&self, curie_prefix: &str) -> Py<PyArray1<NodeT>> {
        let gil = pyo3::Python::acquire_gil();
        to_ndarray_1d!(
            gil,
            self.inner
                .get_node_ids_from_node_curie_prefix(curie_prefix.into()),
            NodeT
        )
    }
    ...
    pub fn get_node_names_from_node_curie_prefix(&self, curie_prefix: &str) -> Vec<String> {
        self.inner
            .get_node_names_from_node_curie_prefix(curie_prefix.into())
            .into_iter()
            .map(|x| x.into())
            .collect::<Vec<_>>()
    }
    ...
    pub fn get_number_of_nodes_from_node_curie_prefix(&self, curie_prefix: &str) -> NodeT {
        self.inner
            .get_number_of_nodes_from_node_curie_prefix(curie_prefix.into())
            .into()
    }
...
pub const GRAPH_METHODS_NAMES: &[&str] = &[
    ...
    "get_node_with_unknown_node_types_mask",
    "get_node_with_known_node_types_mask",
    ...
    "get_number_of_directed_edges_from_node_curie_prefixes",
    "get_node_ids_from_node_curie_prefix",
    "get_node_names_from_node_curie_prefix",
    "get_number_of_nodes_from_node_curie_prefix",
    "get_tendrils",
    "get_node_degree_geometric_distribution_threshold",
    "get_sparse_edge_weighting_methods",
    "get_edge_weighting_methods",
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("get", 0.065645136),
        ("graph", 0.65139806),
        ("laplacian", 0.87434477),
        ("normalized", 0.91964835),
        ("random", 0.6901754),
        ("transformed", 0.87434477),
        ("walk", 0.980303),
    ],
    &[
        ("get", 0.08448525),
        ("graph", 0.8383488),
        ("laplacian", 1.1252811),
        ("normalized", 1.1835868),
        ("symmetric", 1.2616493),
        ("transformed", 1.1252811),
    ],
    &[
        ("get", 0.112377174),
        ("graph", 1.115121),
        ("normalized", 1.5743357),
        ("symmetric", 1.6781696),
        ("transformed", 1.496781),
    ],
    &[
        ("connected", 0.92870575),
        ("from", 0.24327356),
        ("id", 0.37849313),
        ("is", 0.85382134),
        ("node", 0.13925067),
    ...
    &[
        ("disconnected", 0.87434477),
        ("from", 0.18902385),
        ("id", 0.29408962),
        ("is", 0.66342026),
        ("node", 0.20184177),
        ("unchecked", 0.36361164),
    ],
    &[
        ("from", 0.24327356),
        ("id", 0.37849313),
    ...
    &[("has", 1.5430219), ("name", 1.4702411), ("node", 0.3745297)],
    &[
        ("has", 1.0577),
        ("id", 0.6978103),
        ("node", 0.25673005),
    ...
    &[("components", 4.688641), ("remove", 3.1767902)],
    &[("overlaps", 9.388769)],
    &[("contains", 8.582566)],
    &[
        ("bipartite", 3.3933415),
    ...
    &[("edge", 1.2766539), ("encode", 5.750639)],
    &[("decode", 5.750639), ("edge", 1.2766539)],
    &[
        ("edge", 0.40755332),
        ("encodable", 1.8358084),
        ("get", 0.112377174),
    ...
    &[
        ("be", 3.0265648),
        ("multigraph", 3.1833842),
        ("must", 2.389058),
    ],
    &[
        ("be", 2.0746288),
        ("multigraph", 2.1821244),
        ("must", 1.6376351),
        ("not", 1.9173409),
    ],
    &[
    ...
    &[("circles", 5.750639), ("get", 0.3520196)],
    &[
        ("get", 0.22723217),
        ("memory", 2.389058),
        ("stats", 3.7120948),
    ...
    &[("get", 0.3520196), ("transitivity", 5.750639)],
    &[
        ("get", 0.08448525),
        ("node", 0.13925067),
        ("number", 0.56432265),
    ...
    &[
        ("clustering", 1.5743357),
        ("coefficient", 1.3833026),
        ("get", 0.112377174),
        ("node", 0.18522283),
        ("per", 1.6781696),
    ],
    &[
        ("clustering", 3.1833842),
        ("coefficient", 2.7971058),
        ("get", 0.22723217),
    ],
    &[
        ("average", 2.5445411),
        ("clustering", 2.1821244),
        ("coefficient", 1.9173409),
        ("get", 0.15576155),
    ],
    &[
        ("are", 3.7120948),
        ("nodes", 1.6555047),
        ("remappable", 3.7120948),
    ],
    &[
        ("from", 0.3235878),
        ("ids", 0.49002936),
    ...
    &[("negatives", 5.750639), ("sample", 5.750639)],
    &[("connected", 3.8695824), ("holdout", 4.0738487)],
    &[("holdout", 4.0738487), ("random", 3.7010398)],
    &[
        ("get", 0.112377174),
        ("holdout", 1.3005174),
        ("indices", 1.8358084),
    ...
    &[
        ...
        ("node", 0.058489133),
        ("parallel", 0.4530943),
        ("predecessors", 0.57970625),
        ("search", 0.39983496),
        ("unchecked", 0.19655946),
    ],
    &[
        ("breadth", 0.39983496),
        ("distances", 0.4971392),
    ...
    &[
        ("and", 0.30245247),
        ("distant", 0.4469189),
        ("eccentricity", 0.36839187),
        ("from", 0.08617574),
        ("get", 0.029927539),
        ("id", 0.25961575),
        ("most", 0.3986127),
        ("node", 0.09551473),
        ("unchecked", 0.16577008),
    ],
    &[
        ("eccentricity", 0.80805635),
        ("from", 0.18902385),
        ("get", 0.065645136),
        ("id", 0.29408962),
        ("node", 0.10819794),
    ...
    &[("diameter", 4.93158), ("get", 0.3520196)],
    &[
        ("diameter", 2.1821244),
        ("get", 0.15576155),
        ("naive", 2.3260443),
    ...
    &[("density", 5.750639), ("get", 0.3520196)],
    &[
        ("get", 0.15576155),
        ("nodes", 1.134804),
        ("rate", 1.9173409),
    ...
    &[
        ...
        ("get", 0.15576155),
        ("number", 1.0404156),
        ("undirected", 1.9887954),
    ],
    &[
        ("edges", 0.9866955),
        ("get", 0.112377174),
        ("number", 0.75062793),
        ("undirected", 1.4348549),
        ("unique", 1.2353083),
    ],
    &[
        ("edges", 1.9951469),
    ...
    &[
        ("destination", 1.856132),
        ("get", 0.15576155),
        ("ids", 0.6792103),
        ("node", 0.25673005),
    ],
    &[
        ("destination", 1.3391422),
        ("directed", 1.0288422),
        ("get", 0.112377174),
        ("ids", 0.49002936),
        ("node", 0.18522283),
    ...
    &[("get", 0.22723217), ("ids", 0.9908635), ("node", 0.3745297)],
    &[
        ("edge", 0.5648935),
        ("get", 0.15576155),
        ("ids", 0.6792103),
    ...
    &[("directed", 3.2228308), ("to", 3.7816424)],
    &[
        ("to", 2.441088),
        ("triangular", 3.3933415),
        ("upper", 3.7120948),
    ],
    &[
        ("lower", 3.7120948),
    ...
    &[("bidiagonal", 5.750639), ("to", 3.7816424)],
    &[("arrowhead", 5.750639), ("to", 3.7816424)],
    &[("to", 3.7816424), ("transposed", 5.750639)],
    &[("complementary", 5.750639), ("to", 3.7816424)],
    &[
        ("approximated", 2.4978542),
        ("cliques", 3.3933415),
        ("get", 0.22723217),
    ],
    &[
    ...
    &[("report", 4.4946585), ("textual", 5.2568383)],
    &[
        ("connected", 1.7122118),
        ("generate", 1.6733003),
        ("graph", 1.5456251),
    ...
    &[("drop", 3.8695824), ("tendrils", 5.2568383)],
    &[
        ("dendritic", 3.3933415),
        ("drop", 2.4978542),
        ("trees", 3.3933415),
    ...
    &[
        ("disconnected", 3.0265648),
        ("drop", 2.4978542),
        ("nodes", 1.6555047),
    ],
    &[("drop", 3.8695824), ("selfloops", 3.7010398)],
    &[
        ("drop", 2.4978542),
        ("edges", 1.9951469),
        ("parallel", 2.901347),
    ...
    &[
        ("arborescence", 2.3260443),
        ("kruskal", 2.3260443),
        ("random", 1.6376351),
        ("spanning", 2.1821244),
    ],
    &[
        ("arborescence", 3.3933415),
        ("kruskal", 3.3933415),
        ("spanning", 3.1833842),
    ],
    &[
    ...
    &[("enable", 9.388769)],
    &[("all", 4.0738487), ("disable", 5.750639)],
    &[("compatible", 5.750639), ("is", 3.5575662)],
    &[
        ("adjacency", 2.1821244),
        ("has", 1.0577),
        ("matrix", 1.9173409),
    ...
    &[("has", 2.390392), ("nodes", 2.5646462)],
    &[("edges", 3.0908072), ("has", 2.390392)],
    &[
        ("has", 1.5430219),
        ("nodes", 1.6555047),
        ("trap", 2.7971058),
    ],
    &[("directed", 3.2228308), ("is", 3.5575662)],
    &[
        ("edge", 0.82409286),
        ("has", 1.5430219),
        ("weights", 2.2964447),
    ...
    &[
        ("edge", 0.40755332),
        ("has", 0.7630981),
        ("probabilities", 1.8358084),
        ("representing", 1.8358084),
        ("weights", 1.1357017),
    ],
    &[
        ("has", 1.0577),
    ...
    &[("has", 2.390392), ("selfloops", 3.7010398)],
    &[
        ("disconnected", 3.0265648),
        ("has", 1.5430219),
        ("nodes", 1.6555047),
    ...
    &[("connected", 3.8695824), ("is", 3.5575662)],
    &[
        ("has", 1.5430219),
        ("node", 0.3745297),
        ("types", 1.2836132),
    ...
    &[("is", 3.5575662), ("multigraph", 4.93158)],
    &[
        ("has", 1.5430219),
        ("node", 0.3745297),
        ("ontologies", 2.901347),
    ...
    &[("get", 0.3520196), ("tendrils", 5.2568383)],
    &[
        ("degree", 0.75188714),
        ("distribution", 1.3801621),
        ("geometric", 1.3801621),
        ("get", 0.08448525),
        ("node", 0.13925067),
        ("threshold", 1.3801621),
    ...
    &[("add", 5.750639), ("selfloops", 3.7010398)],
    &[
        ("centrality", 2.1444254),
        ("degree", 2.0222814),
        ("get", 0.22723217),
    ],
    &[
        ("centrality", 1.4699459),
        ("degree", 1.3862196),
        ("get", 0.15576155),
        ("weighted", 1.134804),
    ],
    &[
        ("centrality", 0.6195034),
        ("closeness", 0.87434477),
        ("from", 0.18902385),
        ("get", 0.065645136),
        ("id", 0.29408962),
        ("node", 0.10819794),
    ...
    &[
        ("centrality", 0.49435842),
        ("closeness", 0.69771975),
        ("from", 0.15083943),
        ("get", 0.052384265),
        ("id", 0.23468103),
        ("node", 0.08634104),
    ...
    &[
        ("betweenness", 2.901347),
        ("centrality", 2.1444254),
        ("get", 0.22723217),
    ],
    &[
        ("approximated", 0.7216055),
        ("betweenness", 0.8381706),
        ("centrality", 0.6195034),
        ("from", 0.18902385),
        ("get", 0.065645136),
        ("id", 0.29408962),
    ...
    &[
        ("approximated", 0.57583505),
        ("betweenness", 0.66885304),
        ("centrality", 0.49435842),
        ("from", 0.15083943),
        ("get", 0.052384265),
        ("id", 0.23468103),
    ...
    &[
        ("centrality", 2.1444254),
        ("eigenvector", 3.3933415),
        ("get", 0.22723217),
    ],
    &[
        ("centrality", 1.4699459),
        ("eigenvector", 2.3260443),
        ("get", 0.15576155),
        ("weighted", 1.134804),
    ],
    &[("dot", 5.750639), ("to", 3.7816424)],
    &[("get", 0.3520196), ("stars", 5.750639)],
    &[
        ("community", 1.5743357),
        ("detection", 1.8358084),
        ("get", 0.112377174),
    ...
    &[
        ("community", 0.91964835),
        ("directed", 0.6009983),
        ("from", 0.18902385),
        ("get", 0.065645136),
        ("memberships", 0.980303),
        ("modularity", 0.980303),
        ("node", 0.10819794),
    ],
    &[
        ...
        ("modularity", 0.980303),
        ("node", 0.10819794),
        ("undirected", 0.8381706),
    ],
    &[
        ("attachment", 1.2353083),
        ("get", 0.112377174),
        ("minimum", 1.3391422),
        ("preferential", 1.2353083),
        ("unchecked", 0.62246263),
    ],
    &[
        ("attachment", 1.2353083),
    ...
    &[
        ("attachment", 0.92870575),
        ("get", 0.08448525),
        ("minimum", 1.0067681),
        ("preferential", 0.92870575),
        ("unchecked", 0.4679679),
        ("weighted", 0.615519),
    ],
    &[
    ...
    &[
        ("attachment", 0.7216055),
        ("from", 0.18902385),
        ("get", 0.065645136),
        ("ids", 0.2862507),
        ("node", 0.10819794),
        ("preferential", 0.7216055),
        ("unchecked", 0.36361164),
    ],
    &[
        ("attachment", 0.92870575),
    ...
    &[
        ("attachment", 0.57583505),
        ("from", 0.15083943),
        ("get", 0.052384265),
        ("ids", 0.22842564),
        ("node", 0.08634104),
        ("preferential", 0.57583505),
        ("unchecked", 0.290159),
        ("weighted", 0.38164663),
    ],
    &[
