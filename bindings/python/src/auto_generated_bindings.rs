...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("laplacian", 1.1137015),
        ("left", 1.4173099),
        ("normalized", 1.1605929),
        ("transformed", 1.1137015),
    ],
    &[
        ("get", 0.09483703),
        ("graph", 0.73761797),
    ...
    &[
        ("get", 0.12607722),
        ("graph", 0.98059607),
        ("normalized", 1.5429028),
        ("symmetric", 1.7254976),
        ("transformed", 1.4805648),
    ],
    &[
        ("connected", 0.9413439),
        ("from", 0.24490292),
    ...
    &[
        ("disconnected", 0.90215635),
        ("from", 0.19036883),
        ("id", 0.30201107),
        ("is", 0.67751056),
        ("node", 0.19849168),
        ("unchecked", 0.38054392),
    ],
    &[
        ("from", 0.24490292),
        ("id", 0.38852677),
    ...
    &[
        ...
        ("is", 0.54082185),
        ("node", 0.08497888),
        ("selfloops", 0.57201177),
        ("singleton", 0.43799973),
        ("unchecked", 0.30376866),
        ("with", 0.48048112),
    ],
    &[
        ("from", 0.19036883),
        ...
        ("is", 0.67751056),
        ("node", 0.10645665),
        ("selfloops", 0.71658343),
        ("singleton", 0.54870087),
        ("with", 0.6019191),
    ],
    &[
        ("from", 0.24490292),
    ...
    &[("components", 4.817139), ("remove", 2.7607317)],
    &[("overlaps", 9.585475)],
    &[("contains", 8.778181)],
    &[
        ("bipartite", 2.8836234),
    ...
    &[("edge", 1.2154088), ("encode", 5.882664)],
    &[("decode", 5.882664), ("edge", 1.2154088)],
    &[
        ("edge", 0.3892887),
        ("encodable", 1.8841847),
        ("get", 0.12607722),
    ...
    &[
        ...
        ("must", 1.6642694),
        ("node", 0.2521655),
        ("ontologies", 2.0506122),
    ],
    &[
        ("be", 3.114191),
        ("must", 2.4253488),
        ("undirected", 2.9883683),
    ],
    &[
        ("have", 1.5429028),
        ("must", 1.201621),
    ...
    &[
        ("be", 3.114191),
        ("multigraph", 3.2717683),
        ("must", 2.4253488),
    ],
    &[
        ("be", 2.1369517),
        ("multigraph", 2.2450807),
        ("must", 1.6642694),
        ("not", 1.9787365),
    ],
    &[
    ...
    &[("have", 3.114191), ("must", 2.4253488), ("nodes", 1.67745)],
    &[
        ("be", 3.114191),
        ("connected", 2.5258853),
        ("must", 2.4253488),
    ...
    &[
        ("inplace", 1.0040523),
        ("isomorphic", 1.0718523),
        ("node", 0.18206629),
        ("remove", 0.884247),
        ("types", 0.62460625),
    ],
    &[
        ("isomorphic", 1.4845372),
        ("node", 0.2521655),
        ("remove", 1.2247),
        ("types", 0.8650923),
    ],
    ...
    &[("circles", 5.882664), ("get", 0.39362913)],
    &[
        ("get", 0.25447392),
        ("memory", 2.4736042),
        ("stats", 3.8030336),
    ...
    &[("get", 0.39362913), ("transitivity", 5.882664)],
    &[
        ("get", 0.09483703),
        ("node", 0.1369528),
        ("number", 0.595594),
    ...
    &[
        ("clustering", 1.6209732),
        ("coefficient", 1.3842158),
        ("get", 0.12607722),
        ("node", 0.18206629),
        ("per", 1.7254976),
    ],
    &[
        ("clustering", 3.2717683),
        ("coefficient", 2.7938976),
        ("get", 0.25447392),
    ],
    &[
        ("average", 2.609634),
        ("clustering", 2.2450807),
        ("coefficient", 1.917167),
        ("get", 0.1746195),
    ],
    &[
        ("are", 3.8030336),
        ("nodes", 1.67745),
        ("remappable", 3.8030336),
    ],
    &[
        ("from", 0.3255762),
        ("ids", 0.49685875),
    ...
    &[("connected", 3.9071274), ("holdout", 4.2003045)],
    &[("holdout", 4.2003045), ("random", 3.4999185)],
    &[
        ("get", 0.12607722),
        ("holdout", 1.3453342),
        ("indices", 1.8841847),
    ...
    &[("chains", 5.882664), ("get", 0.39362913)],
    &[
        ("breadth", 0.41464046),
        ("first", 0.41464046),
        ("from", 0.102989696),
    ...
    &[
        ("and", 0.30399033),
        ("distant", 0.4604076),
        ("eccentricity", 0.3812062),
        ("from", 0.08687218),
        ("get", 0.03364068),
        ("id", 0.2667915),
        ("most", 0.41168657),
        ("node", 0.09404202),
        ("unchecked", 0.17365596),
    ],
    &[
        ("eccentricity", 0.83536273),
        ("from", 0.19036883),
        ("get", 0.07371907),
        ("id", 0.30201107),
        ("node", 0.10645665),
    ...
    &[("diameter", 5.3872232), ("get", 0.39362913)],
    &[
        ("breadth", 0.76643217),
        ("first", 0.76643217),
        ("from", 0.19036883),
    ...
    &[("density", 5.882664), ("get", 0.39362913)],
    &[
        ("get", 0.1746195),
        ("nodes", 1.1510627),
        ("rate", 1.9787365),
    ...
    &[
        ...
        ("get", 0.1746195),
        ("number", 1.0966425),
        ("undirected", 2.0506122),
    ],
    &[
        ("edges", 1.0294255),
        ("get", 0.12607722),
        ("number", 0.79178804),
        ("undirected", 1.4805648),
        ("unique", 1.2514311),
    ],
    &[
        ("edges", 2.0777898),
    ...
    &[
        ("destination", 1.863315),
        ("get", 0.1746195),
        ("ids", 0.6881594),
        ("node", 0.2521655),
    ],
    &[
        ("destination", 1.3453342),
        ("directed", 1.0164798),
        ("get", 0.12607722),
        ("ids", 0.49685875),
        ("node", 0.18206629),
    ...
    &[("directed", 3.1735797), ("to", 3.9071274)],
    &[
        ("to", 2.5258853),
        ("triangular", 3.48274),
        ("upper", 3.8030336),
    ...
    &[("bidiagonal", 5.882664), ("to", 3.9071274)],
    &[("arrowhead", 5.882664), ("to", 3.9071274)],
    &[("to", 3.9071274), ("transposed", 5.882664)],
    &[("complementary", 5.882664), ("to", 3.9071274)],
    &[
        ("approximated", 2.5829258),
        ("cliques", 3.48274),
        ("get", 0.25447392),
    ],
    &[("clique", 2.7938976), ("get", 0.25447392), ("max", 3.48274)],
    &[
        ("approximated", 1.7723985),
        ("cliques", 2.3898492),
        ("get", 0.1746195),
        ("number", 1.0966425),
    ],
    ...
    &[("report", 4.622512), ("textual", 5.3872232)],
    &[
        ("connected", 1.7332574),
        ("generate", 1.7332574),
        ("graph", 1.3581454),
    ...
    &[("filter", 3.48274), ("from", 0.6571421), ("ids", 1.0028584)],
    &[
        ("filter", 3.48274),
        ("from", 0.6571421),
        ("names", 1.2903901),
    ...
    &[("remove", 2.7607317), ("tendrils", 5.3872232)],
    &[
        ("dendritic", 3.48274),
        ("remove", 1.7847619),
        ("trees", 3.48274),
    ...
    &[
        ("disconnected", 3.114191),
        ("nodes", 1.67745),
        ("remove", 1.7847619),
    ],
    &[("remove", 2.7607317), ("selfloops", 3.8262572)],
    &[
        ("edges", 2.0777898),
        ("parallel", 2.9883683),
        ("remove", 1.7847619),
    ...
    &[
        ("arborescence", 2.3898492),
        ("kruskal", 2.3898492),
        ("random", 1.5526137),
        ("spanning", 2.2450807),
    ],
    &[
        ("arborescence", 3.48274),
        ("kruskal", 3.48274),
        ("spanning", 3.2717683),
    ],
    &[
    ...
    &[("enable", 9.585475)],
    &[("all", 3.9953594), ("disable", 5.882664)],
    &[
        ("compatible", 2.1369517),
        ("has", 1.0260795),
        ("node", 0.2521655),
        ("vocabularies", 2.2450807),
    ],
    &[
        ("compatible", 1.5429028),
        ("has", 0.7408408),
        ("node", 0.18206629),
        ("types", 0.62460625),
        ("vocabularies", 1.6209732),
    ],
    &[
        ("compatible", 1.5429028),
        ("edge", 0.3892887),
    ...
    &[("compatible", 4.817139), ("is", 3.6176243)],
    &[
        ("adjacency", 2.2450807),
        ("has", 1.0260795),
        ("matrix", 1.9787365),
    ...
    &[("has", 2.3129992), ("nodes", 2.594738)],
    &[("edges", 3.2139974), ("has", 2.3129992)],
    &[("has", 1.4953111), ("nodes", 1.67745), ("trap", 2.8836234)],
    &[("directed", 3.1735797), ("is", 3.6176243)],
    &[
        ("edge", 0.7857393),
        ("has", 1.4953111),
        ("weights", 2.299526),
    ...
    &[
        ("edge", 0.3892887),
        ("has", 0.7408408),
        ("probabilities", 1.8841847),
        ("representing", 1.8841847),
        ("weights", 1.1392831),
    ],
    &[
        ("has", 1.0260795),
    ...
    &[("has", 2.3129992), ("selfloops", 3.8262572)],
    &[
        ("disconnected", 3.114191),
        ("has", 1.4953111),
        ("nodes", 1.67745),
    ...
    &[("connected", 3.9071274), ("is", 3.6176243)],
    &[
        ("has", 1.4953111),
        ("node", 0.36748216),
        ("types", 1.2607037),
    ...
    &[("is", 3.6176243), ("multigraph", 5.060885)],
    &[
        ("has", 1.4953111),
        ("node", 0.36748216),
        ("ontologies", 2.9883683),
    ...
    &[("get", 0.39362913), ("tendrils", 5.3872232)],
    &[
        ("degree", 0.7845095),
        ("distribution", 1.4173099),
        ("geometric", 1.4173099),
        ("get", 0.09483703),
        ("node", 0.1369528),
        ("threshold", 1.4173099),
    ...
    &[("add", 4.321698), ("selfloops", 3.8262572)],
    &[
        ("centrality", 2.2277894),
        ("degree", 2.1050553),
        ("get", 0.25447392),
    ],
    &[
        ("centrality", 1.5287046),
        ("degree", 1.4444847),
        ("get", 0.1746195),
        ("weighted", 1.2023442),
    ],
    &[
        ("centrality", 0.64537287),
        ("closeness", 0.90215635),
        ("from", 0.19036883),
        ("get", 0.07371907),
        ("id", 0.30201107),
        ("node", 0.10645665),
    ...
    &[
        ("betweenness", 2.9883683),
        ("centrality", 2.2277894),
        ("get", 0.25447392),
    ],
    &[
        ("approximated", 0.74825305),
        ("betweenness", 0.8657065),
        ("centrality", 0.64537287),
        ("from", 0.19036883),
        ("get", 0.07371907),
        ("id", 0.30201107),
    ...
    &[
        ("approximated", 0.59729195),
        ("betweenness", 0.69104904),
        ("centrality", 0.515168),
        ("from", 0.15196167),
        ("get", 0.05884615),
        ("id", 0.24107991),
    ...
    &[
        ("centrality", 1.5287046),
        ("eigenvector", 2.3898492),
        ("get", 0.1746195),
        ("weighted", 1.2023442),
    ],
    &[("dot", 5.882664), ("to", 3.9071274)],
    &[("get", 0.39362913), ("stars", 5.882664)],
    &[
        ("community", 1.6209732),
        ("detection", 1.8841847),
        ("get", 0.12607722),
    ...
    &[
        ("community", 0.94780517),
        ("directed", 0.5943497),
        ("from", 0.19036883),
        ("get", 0.07371907),
        ("memberships", 1.008922),
        ("modularity", 1.008922),
        ("node", 0.10645665),
    ],
    &[
        ...
        ("modularity", 1.008922),
        ("node", 0.10645665),
        ("undirected", 0.8657065),
    ],
    &[
        ("attachment", 1.2514311),
        ("get", 0.12607722),
        ("minimum", 1.3842158),
        ("preferential", 1.2514311),
        ("unchecked", 0.650821),
    ],
    &[
        ("attachment", 1.2514311),
    ...
    &[
        ("attachment", 0.9413439),
        ("get", 0.09483703),
        ("minimum", 1.0412264),
        ("preferential", 0.9413439),
        ("unchecked", 0.48955658),
        ("weighted", 0.65300125),
    ],
    &[
    ...
    &[
        ("attachment", 0.73172885),
        ("from", 0.19036883),
        ("get", 0.07371907),
        ("ids", 0.2905201),
        ("node", 0.10645665),
        ("preferential", 0.73172885),
        ("unchecked", 0.38054392),
    ],
    &[
        ("attachment", 0.9413439),
    ...
    &[
        ("attachment", 0.58410156),
        ("from", 0.15196167),
        ("get", 0.05884615),
        ("ids", 0.23190726),
        ("node", 0.08497888),
        ("preferential", 0.58410156),
        ("unchecked", 0.30376866),
        ("weighted", 0.40518567),
    ],
    &[
    ...
    &[
        ("attachment", 1.7332574),
        ("get", 0.1746195),
        ("preferential", 1.7332574),
        ("scores", 2.1369517),
    ],
    &[
        ("allocation", 1.3842158),
        ("get", 0.12607722),
        ("index", 1.2796915),
        ("resource", 1.3842158),
        ("scores", 1.5429028),
