...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("graph", 0.6516519),
        ("laplacian", 0.8745784),
        ("normalized", 0.9198779),
        ("random", 0.69042575),
        ("transformed", 0.8745784),
        ("walk", 0.9805269),
    ],
    &[
        ("get", 0.08546247),
        ...
        ("normalized", 1.183888),
        ("symmetric", 1.2619436),
        ("transformed", 1.1255872),
    ],
    &[
        ("get", 0.11367777),
        ("graph", 1.1155684),
        ("normalized", 1.5747466),
        ("symmetric", 1.6785723),
        ("transformed", 1.4971981),
    ],
    &[
        ("connected", 0.9290288),
        ("from", 0.2436557),
        ...
        ("is", 0.8541509),
        ("node", 0.13964178),
        ("unchecked", 0.46833068),
    ],
    &[
        ("disconnected", 0.8745784),
        ("from", 0.18931985),
        ("id", 0.29437608),
        ("is", 0.66367304),
        ("node", 0.20240892),
        ("unchecked", 0.36389172),
    ],
    &[
        ("from", 0.2436557),
        ("id", 0.37886363),
    ...
    &[
        ...
        ("node", 0.08658277),
        ("selfloops", 0.5509517),
        ("singleton", 0.41800874),
        ("unchecked", 0.29038137),
        ("with", 0.4729452),
    ],
    &[
        ("from", 0.18931985),
    ...
    &[("has", 1.5440167), ("name", 1.47124), ("node", 0.37559217)],
    &[
        ("has", 1.0583686),
        ("id", 0.69850427),
        ("node", 0.25745508),
    ...
    &[("components", 4.690134), ("remove", 3.1783433)],
    &[("overlaps", 9.391358)],
    &[("contains", 8.585168)],
    &[
        ("bipartite", 3.394229),
    ...
    &[("edge", 1.2657696), ("encode", 5.7520895)],
    &[("decode", 5.7520895), ("edge", 1.2657696)],
    &[
        ("edge", 0.40406257),
        ("encodable", 1.8361984),
        ("get", 0.11367777),
    ...
    &[
        ("be", 3.0274734),
        ("multigraph", 3.1842837),
        ("must", 2.390004),
    ],
    &[
        ("be", 2.0752256),
        ("multigraph", 2.1827135),
        ("must", 1.6382627),
        ("not", 1.9179487),
    ],
    &[
    ...
    &[("edges", 2.051615), ("have", 3.0274734), ("must", 2.390004)],
    &[("have", 3.0274734), ("must", 2.390004), ("nodes", 1.656493)],
    &[
        ("be", 3.0274734),
        ("connected", 2.4987936),
        ("must", 2.390004),
    ...
    &[("circles", 5.7520895), ("get", 0.35610786)],
    &[
        ("get", 0.22986701),
        ("memory", 2.390004),
        ("stats", 3.7129638),
    ...
    &[("get", 0.35610786), ("transitivity", 5.7520895)],
    &[
        ("get", 0.08546247),
        ("node", 0.13964178),
        ("number", 0.5646771),
    ...
    &[
        ("clustering", 1.5747466),
        ("coefficient", 1.3837286),
        ("get", 0.11367777),
        ("node", 0.18574427),
        ("per", 1.6785723),
    ],
    &[
        ("clustering", 3.1842837),
        ("coefficient", 2.7980278),
        ("get", 0.22986701),
    ],
    &[
        ("average", 2.5451047),
        ("clustering", 2.1827135),
        ("coefficient", 1.9179487),
        ("get", 0.15756567),
    ],
    &[
        ("are", 3.7129638),
        ("nodes", 1.656493),
        ("remappable", 3.7129638),
    ],
    &[
        ("from", 0.32409823),
        ("ids", 0.48531848),
    ...
    &[("negatives", 5.7520895), ("sample", 5.7520895)],
    &[("connected", 3.871108), ("holdout", 4.075366)],
    &[("holdout", 4.075366), ("random", 3.7025719)],
    &[
        ("get", 0.11367777),
        ("holdout", 1.30095),
        ("indices", 1.8361984),
    ...
    &[("chains", 5.7520895), ("get", 0.35610786)],
    &[
        ("breadth", 0.39996412),
        ("first", 0.39996412),
        ("from", 0.10234067),
        ...
        ("node", 0.058652565),
        ("parallel", 0.4532181),
        ("predecessors", 0.57981735),
        ("search", 0.39996412),
        ("unchecked", 0.19670902),
    ],
    &[
        ("breadth", 0.39996412),
        ("distances", 0.49725854),
        ("first", 0.39996412),
        ("from", 0.10234067),
        ("get", 0.03589609),
        ("ids", 0.15324926),
    ...
    &[
        ("and", 0.3025642),
        ("distant", 0.44701582),
        ("eccentricity", 0.36849687),
        ("from", 0.08630969),
        ("get", 0.030273207),
        ("id", 0.25986645),
        ("most", 0.39871457),
        ("node", 0.09578172),
        ("unchecked", 0.16589586),
    ],
    &[
        ("eccentricity", 0.808296),
        ("from", 0.18931985),
        ("get", 0.06640413),
        ("id", 0.29437608),
        ("node", 0.10850129),
    ...
    &[("diameter", 5.2583084), ("get", 0.35610786)],
    &[
        ("breadth", 0.739893),
        ("first", 0.739893),
        ("from", 0.18931985),
    ...
    &[("density", 5.7520895), ("get", 0.35610786)],
    &[
        ("get", 0.15756567),
        ("nodes", 1.135467),
        ("rate", 1.9179487),
    ...
    &[
        ...
        ("get", 0.15756567),
        ("number", 1.0410854),
        ("undirected", 1.9893982),
    ],
    &[
        ("edges", 1.0145998),
        ("get", 0.11367777),
        ("number", 0.75110435),
        ("undirected", 1.4352767),
        ("unique", 1.2357461),
    ],
    &[
        ("edges", 2.051615),
    ...
    &[
        ("destination", 1.8567442),
        ("get", 0.15756567),
        ("ids", 0.67268676),
        ("node", 0.25745508),
    ],
    &[
        ("destination", 1.3395718),
        ("directed", 1.0292965),
        ("get", 0.11367777),
        ("ids", 0.48531848),
        ("node", 0.18574427),
    ...
    &[("get", 0.22986701), ("ids", 0.981359), ("node", 0.37559217)],
    &[
        ("edge", 0.56006014),
        ("get", 0.15756567),
        ("ids", 0.67268676),
    ...
    &[("directed", 3.2243822), ("to", 3.7831714)],
    &[
        ("to", 2.4420307),
        ("triangular", 3.394229),
        ("upper", 3.7129638),
    ...
    &[("bidiagonal", 5.7520895), ("to", 3.7831714)],
    &[("arrowhead", 5.7520895), ("to", 3.7831714)],
    &[("to", 3.7831714), ("transposed", 5.7520895)],
    &[("complementary", 5.7520895), ("to", 3.7831714)],
    &[
        ("approximated", 2.4987936),
        ("cliques", 3.394229),
        ("get", 0.22986701),
    ],
    &[
    ...
    &[("report", 4.496159), ("textual", 5.2583084)],
    &[
        ("connected", 1.7128342),
        ("generate", 1.6739253),
        ("graph", 1.546259),
    ...
    &[("filter", 3.394229), ("from", 0.6553567), ("ids", 0.981359)],
    &[
        ("filter", 3.394229),
        ("from", 0.6553567),
        ("names", 1.2931706),
    ...
    &[("drop", 3.871108), ("tendrils", 5.2583084)],
    &[
        ("dendritic", 3.394229),
        ("drop", 2.4987936),
        ("trees", 3.394229),
    ...
    &[
        ("disconnected", 3.0274734),
        ("drop", 2.4987936),
        ("nodes", 1.656493),
    ],
    &[("drop", 3.871108), ("selfloops", 3.7025719)],
    &[
        ("drop", 2.4987936),
        ("edges", 2.051615),
        ("parallel", 2.902263),
    ...
    &[
        ("arborescence", 2.3266234),
        ("kruskal", 2.3266234),
        ("random", 1.6382627),
        ("spanning", 2.1827135),
    ],
    &[
        ("arborescence", 3.394229),
        ("kruskal", 3.394229),
        ("spanning", 3.1842837),
    ],
    &[
    ...
    &[("enable", 9.391358)],
    &[("all", 4.075366), ("disable", 5.7520895)],
    &[("compatible", 5.7520895), ("is", 3.5591042)],
    &[
        ("adjacency", 2.1827135),
        ("has", 1.0583686),
        ("matrix", 1.9179487),
    ...
    &[("has", 2.3919766), ("nodes", 2.5662236)],
    &[("edges", 3.1783433), ("has", 2.3919766)],
    &[("has", 1.5440167), ("nodes", 1.656493), ("trap", 2.7980278)],
    &[("directed", 3.2243822), ("is", 3.5591042)],
    &[
        ("edge", 0.81705207),
        ("has", 1.5440167),
        ("weights", 2.2167726),
    ...
    &[
        ("edge", 0.40406257),
        ("has", 0.7635736),
        ("probabilities", 1.8361984),
        ("representing", 1.8361984),
        ("weights", 1.0962764),
    ],
    &[
        ("has", 1.0583686),
    ...
    &[("has", 2.3919766), ("selfloops", 3.7025719)],
    &[
        ("disconnected", 3.0274734),
        ("has", 1.5440167),
        ("nodes", 1.656493),
    ...
    &[("connected", 3.871108), ("is", 3.5591042)],
    &[
        ("has", 1.5440167),
        ("node", 0.37559217),
        ("types", 1.2846229),
    ...
    &[("is", 3.5591042), ("multigraph", 4.933063)],
    &[
        ("has", 1.5440167),
        ("node", 0.37559217),
        ("ontologies", 2.902263),
    ...
    &[("get", 0.35610786), ("tendrils", 5.2583084)],
    &[
        ("degree", 0.75222546),
        ("distribution", 1.3804463),
        ("geometric", 1.3804463),
        ("get", 0.08546247),
        ("node", 0.13964178),
        ("threshold", 1.3804463),
    ...
    &[("add", 5.7520895), ("selfloops", 3.7025719)],
    &[
        ("centrality", 2.145385),
        ("degree", 2.0232484),
        ("get", 0.22986701),
    ...
    &[
        ("centrality", 1.4705853),
        ("degree", 1.3868649),
        ("get", 0.15756567),
        ("weighted", 1.1461601),
    ],
    &[
        ("centrality", 0.61976016),
        ("closeness", 0.8745784),
        ("from", 0.18931985),
        ("get", 0.06640413),
        ("id", 0.29437608),
    ...
    &[
        ("betweenness", 2.902263),
        ("centrality", 2.145385),
        ("get", 0.22986701),
    ],
    &[
        ("approximated", 0.721853),
        ("betweenness", 0.8384075),
        ("centrality", 0.61976016),
        ("from", 0.18931985),
        ("get", 0.06640413),
        ("id", 0.29437608),
    ...
    &[
        ("approximated", 0.5760303),
        ("betweenness", 0.6690394),
        ("centrality", 0.4945614),
        ("from", 0.15107504),
        ("get", 0.052989718),
        ("id", 0.23490867),
    ...
    &[
        ("centrality", 2.145385),
        ("eigenvector", 3.394229),
        ("get", 0.22986701),
    ],
    &[
        ("centrality", 1.4705853),
        ("eigenvector", 2.3266234),
        ("get", 0.15756567),
        ("weighted", 1.1461601),
    ],
    &[("dot", 5.7520895), ("to", 3.7831714)],
    &[("get", 0.35610786), ("stars", 5.7520895)],
    &[
        ("community", 1.5747466),
        ("detection", 1.8361984),
        ("get", 0.11367777),
    ...
    &[
        ...
        ("from", 0.18931985),
        ("get", 0.06640413),
        ("memberships", 0.9805269),
        ("modularity", 0.9805269),
        ("node", 0.10850129),
    ],
    &[
        ("community", 0.9198779),
        ...
        ("modularity", 0.9805269),
        ("node", 0.10850129),
        ("undirected", 0.8384075),
    ],
    &[
        ("attachment", 1.2357461),
        ("get", 0.11367777),
        ("minimum", 1.3395718),
        ("preferential", 1.2357461),
        ("unchecked", 0.6229493),
    ],
    &[
        ("attachment", 1.2357461),
    ...
    &[
        ("attachment", 0.9290288),
        ("get", 0.08546247),
        ("minimum", 1.0070845),
        ("preferential", 0.9290288),
        ("unchecked", 0.46833068),
        ("weighted", 0.62166893),
    ],
    &[
    ...
    &[
        ("attachment", 0.5760303),
        ("from", 0.15107504),
        ("get", 0.052989718),
        ("ids", 0.22622618),
        ("node", 0.08658277),
        ("preferential", 0.5760303),
        ("unchecked", 0.29038137),
        ("weighted", 0.38545644),
    ],
    &[
