...
impl Graph {
    ...
    pub fn get_number_of_triangles(&self) -> EdgeT {
        self.inner.get_number_of_triangles().into()
    }
    ...
    pub fn get_transitivity(&self) -> f64 {
        self.inner.get_transitivity().into()
    }
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("compatible", 2.1635654),
        ("has", 1.0694308),
        ("node", 0.2573545),
        ("vocabularies", 2.2722428),
    ],
    &[
        ("compatible", 1.5631341),
        ("has", 0.77264315),
        ("node", 0.18593363),
        ("types", 0.6432123),
        ("vocabularies", 1.6416514),
    ],
    &[
        ("compatible", 1.5631341),
        ("edge", 0.4012257),
    ...
    &[("compatible", 4.866359), ("is", 3.6026125)],
    &[
        ("adjacency", 2.638645),
        ("has", 1.0694308),
        ("matrix", 1.7217661),
    ...
    &[("get", 0.37319484), ("stars", 5.934923)],
    &[("chains", 5.934923), ("get", 0.37319484)],
    &[
        ("arborescence", 2.4177456),
        ("kruskal", 2.4177456),
        ("random", 1.5294679),
        ("spanning", 2.1635654),
    ],
    &[
        ("arborescence", 3.5201752),
        ("kruskal", 3.5201752),
        ("spanning", 3.1500952),
    ],
    &[
    ...
    &[("dot", 5.934923), ("to", 3.7977946)],
    &[
        ("are", 3.8417988),
        ("nodes", 1.7073855),
        ("remappable", 3.8417988),
    ],
    &[
        ("from", 0.3279926),
        ("ids", 0.48803267),
    ...
    &[
        ("connected", 0.95576197),
        ("from", 0.24683817),
        ("id", 0.39951456),
        ("is", 0.8708792),
        ("node", 0.13992852),
        ("unchecked", 0.49532938),
    ],
    &[
        ("connected", 1.2699933),
        ("from", 0.3279926),
    ...
    &[
        ...
        ("is", 0.5407243),
        ("node", 0.086880885),
        ("selfloops", 0.58125496),
        ("singleton", 0.44632503),
        ("unchecked", 0.30754742),
        ("with", 0.48909742),
    ],
    &[
        ("from", 0.19194224),
    ...
    &[("has", 1.5570637), ("name", 1.4935192), ("node", 0.3747015)],
    &[
        ("has", 1.0694308),
        ("id", 0.73478127),
        ("node", 0.2573545),
    ...
    &[
        ...
        ("ids", 0.2855982),
        ("node", 0.10880893),
        ("structural", 1.0222176),
        ("unchecked", 0.3851699),
    ],
    &[
        ("attachment", 1.2699933),
        ("get", 0.119874746),
        ("minimum", 1.4035385),
        ("preferential", 1.2699933),
        ("unchecked", 0.6581817),
    ],
    &[
        ("attachment", 1.2699933),
    ...
    &[
        ("attachment", 0.95576197),
        ("get", 0.090214424),
        ("minimum", 1.0562643),
        ("preferential", 0.95576197),
        ("unchecked", 0.49532938),
        ("weighted", 0.67165923),
    ],
    &[
    ...
    &[
        ("attachment", 0.74320394),
        ("from", 0.19194224),
        ("get", 0.07015106),
        ("ids", 0.2855982),
        ("node", 0.10880893),
        ("preferential", 0.74320394),
        ("unchecked", 0.3851699),
    ],
    &[
        ("attachment", 0.95576197),
    ...
    &[
        ("attachment", 0.59342754),
        ("from", 0.15326053),
        ("get", 0.056013662),
        ("ids", 0.22804217),
        ("node", 0.086880885),
        ("preferential", 0.59342754),
        ("unchecked", 0.30754742),
        ("weighted", 0.41702968),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.056013662),
        ("ids", 0.22804217),
        ("intersection", 0.7670916),
        ("neighbours", 0.7670916),
        ("node", 0.086880885),
        ("size", 0.70110756),
        ("unchecked", 0.30754742),
    ],
    &[
        ("coefficient", 0.8213549),
        ("from", 0.19194224),
        ("get", 0.07015106),
        ("ids", 0.2855982),
        ("jaccard", 0.7598366),
    ...
    &[
        ("attachment", 1.7578233),
        ("get", 0.16592105),
        ("preferential", 1.7578233),
        ("scores", 2.1635654),
    ],
    &[
        ("allocation", 1.4035385),
        ("get", 0.119874746),
        ("index", 1.2984154),
        ("resource", 1.4035385),
        ("scores", 1.5631341),
    ...
    &[("enable", 9.654309)],
    &[("all", 3.9537516), ("disable", 5.934923)],
    &[
        ("get", 0.24157675),
        ("node", 0.3747015),
        ("tuples", 3.8417988),
    ...
    &[("get", 0.37319484), ("transitivity", 5.934923)],
    &[
        ("get", 0.090214424),
        ("node", 0.13992852),
        ("number", 0.6125692),
    ...
    &[
        ("clustering", 1.6416514),
        ("coefficient", 1.4035385),
        ("get", 0.119874746),
        ("node", 0.18593363),
        ("per", 1.7467744),
    ],
    &[
        ("clustering", 3.3083267),
        ("coefficient", 2.8284712),
        ("get", 0.24157675),
    ],
    &[
        ("average", 2.638645),
        ("clustering", 2.2722428),
        ("coefficient", 1.9426658),
        ("get", 0.16592105),
    ],
    &[
        ...
        ("node", 0.058905985),
        ("parallel", 0.47535697),
        ("predecessors", 0.60396063),
        ("search", 0.42125973),
        ("unchecked", 0.20851977),
    ],
    &[
        ("breadth", 0.42125973),
        ("distances", 0.52009463),
        ("first", 0.42125973),
        ("from", 0.10391195),
        ("get", 0.037977744),
        ("ids", 0.15461454),
    ...
    &[
        ("and", 0.30928802),
        ("distant", 0.46686393),
        ("eccentricity", 0.38707587),
        ("from", 0.08766324),
        ("get", 0.032039165),
        ("id", 0.2745989),
        ("most", 0.417782),
        ("node", 0.09617727),
        ("unchecked", 0.17591354),
    ],
    &[
        ("eccentricity", 0.8475185),
        ("from", 0.19194224),
        ("get", 0.07015106),
        ("id", 0.31066394),
        ("node", 0.10880893),
    ...
    &[("diameter", 5.43807), ("get", 0.37319484)],
    &[
        ("breadth", 0.7781352),
        ("first", 0.7781352),
        ("from", 0.19194224),
    ...
    &[("remove", 2.8040862), ("tendrils", 5.43807)],
    &[
        ("dendritic", 3.5201752),
        ("remove", 1.8151431),
        ("trees", 3.5201752),
    ...
    &[
        ("disconnected", 3.1500952),
        ("nodes", 1.7073855),
        ("remove", 1.8151431),
    ],
    &[("remove", 2.8040862), ("selfloops", 3.8726509)],
    &[
        ("edges", 2.1093884),
        ("parallel", 3.0237498),
        ("remove", 1.8151431),
    ...
    &[("components", 4.866359), ("remove", 2.8040862)],
    &[
        ("centrality", 2.2600112),
        ("degree", 2.1367671),
        ("get", 0.24157675),
    ],
    &[
    ...
    &[
        ("centrality", 0.65628076),
        ("closeness", 0.91475075),
        ("from", 0.19194224),
        ("get", 0.07015106),
        ("id", 0.31066394),
        ("node", 0.10880893),
    ...
    &[
        ("centrality", 0.52402186),
        ("closeness", 0.73040295),
        ("from", 0.15326053),
        ("get", 0.056013662),
        ("id", 0.24805647),
        ("node", 0.086880885),
    ...
    &[
        ("betweenness", 3.0237498),
        ("centrality", 2.2600112),
        ("get", 0.24157675),
    ],
    &[
        ("approximated", 0.7598366),
        ("betweenness", 0.87806153),
        ("centrality", 0.65628076),
        ("from", 0.19194224),
        ("get", 0.07015106),
        ("id", 0.31066394),
    ...
    &[
        ("approximated", 0.6067083),
        ("betweenness", 0.70110756),
        ("centrality", 0.52402186),
        ("from", 0.15326053),
        ("get", 0.056013662),
        ("id", 0.24805647),
    ...
    &[
        ("centrality", 2.2600112),
        ("eigenvector", 3.5201752),
        ("get", 0.24157675),
    ],
    &[
        ("centrality", 1.552233),
        ("eigenvector", 2.4177456),
        ("get", 0.16592105),
        ("weighted", 1.2353058),
    ],
    &[("circles", 5.934923), ("get", 0.37319484)],
    &[("name", 2.3072321), ("set", 4.671177)],
    &[
        ("all", 1.2699933),
        ("edge", 0.4012257),
        ("inplace", 1.0211982),
    ...
    &[
        ("inplace", 1.0211982),
        ("isomorphic", 1.0893865),
        ("node", 0.18593363),
        ("remove", 0.90070677),
        ("types", 0.6432123),
    ],
    &[
        ("isomorphic", 1.5078416),
        ("node", 0.2573545),
        ("remove", 1.2466863),
        ("types", 0.89028305),
    ],
    ...
    &[("report", 4.671177), ("textual", 5.43807)],
    &[
        ("components", 1.5631341),
        ("connected", 1.2699933),
        ("get", 0.119874746),
        ("number", 0.81396717),
        ("of", 0.83350027),
    ...
    &[("density", 5.934923), ("get", 0.37319484)],
    &[
        ("get", 0.16592105),
        ("nodes", 1.1726757),
        ("rate", 2.0045478),
    ...
    &[
        ("destination", 1.8885405),
        ("get", 0.16592105),
        ("ids", 0.6754958),
        ("node", 0.2573545),
    ],
    &[
        ("destination", 1.364434),
        ("directed", 0.9864483),
        ("get", 0.119874746),
        ("ids", 0.48803267),
        ("node", 0.18593363),
    ...
    &[("get", 0.24157675), ("ids", 0.9835045), ("node", 0.3747015)],
    &[
        ("directed", 0.9864483),
        ("edge", 0.4012257),
        ("get", 0.119874746),
    ...
    &[("get", 0.37319484), ("tendrils", 5.43807)],
    &[
        ("coo", 1.8404425),
        ("get", 0.16592105),
        ("jaccard", 1.7971629),
    ...
    &[
        ("coo", 1.0006835),
        ("get", 0.090214424),
        ("intersection", 1.2354615),
        ("matrix", 0.936157),
        ("neighbours", 1.2354615),
        ("size", 1.1291891),
    ],
    &[
        ("get", 0.119874746),
        ("graph", 0.9454154),
        ("intersection", 1.6416514),
        ("neighbours", 1.6416514),
        ("size", 1.5004392),
    ],
    &[
        ("ancestors", 1.0899107),
    ...
    &[
        ...
        ("from", 0.19194224),
        ("get", 0.07015106),
        ("memberships", 1.0222176),
        ("modularity", 1.0222176),
        ("node", 0.10880893),
    ],
    &[
        ("community", 0.9606993),
    ...
    &[("has", 2.4053977), ("nodes", 2.6376193)],
    &[("edges", 3.2586448), ("has", 2.4053977)],
    &[
        ("has", 1.5570637),
        ("nodes", 1.7073855),
        ("trap", 2.8284712),
    ],
    &[("directed", 3.0710173), ("is", 3.6026125)],
    &[
        ("acyclic", 3.5201752),
        ("directed", 1.987933),
        ("is", 2.3320456),
    ...
    &[
        ("edge", 0.4012257),
        ("has", 0.77264315),
        ("probabilities", 1.9063699),
        ("representing", 1.9063699),
        ("weights", 1.1388198),
    ],
    &[
        ("has", 1.0694308),
    ...
    &[("has", 2.4053977), ("selfloops", 3.8726509)],
    &[
        ("disconnected", 3.1500952),
        ("has", 1.5570637),
        ("nodes", 1.7073855),
    ...
    &[("connected", 3.9537516), ("is", 3.6026125)],
    &[
        ("has", 1.5570637),
        ("node", 0.3747015),
        ("types", 1.2962291),
    ...
    &[("is", 3.6026125), ("multigraph", 4.671177)],
    &[
        ("has", 1.5570637),
        ("node", 0.3747015),
        ("ontologies", 3.0237498),
    ...
    &[
        ...
        ("enabled", 1.3145742),
        ("has", 0.5814699),
        ("reciprocal", 1.1291891),
        ("sqrt", 1.1291891),
        ("tradeoff", 1.3145742),
    ],
    &[("csv", 5.934923), ("from", 1.0211087)],
    &[
        ("edges", 0.78773),
        ("features", 1.4346814),
        ("from", 0.24683817),
    ...
    &[("add", 4.3695054), ("selfloops", 3.8726509)],
    &[
        ("directed", 1.987933),
        ("inplace", 2.0579624),
        ("to", 2.4583912),
    ],
    &[("directed", 3.0710173), ("to", 3.7977946)],
    &[
        ("to", 2.4583912),
        ("triangular", 3.5201752),
        ("upper", 3.8417988),
    ],
    &[
        ("lower", 3.8417988),
    ...
    &[("bidiagonal", 5.934923), ("to", 3.7977946)],
    &[("arrowhead", 5.934923), ("to", 3.7977946)],
    &[("to", 3.7977946), ("transposed", 5.934923)],
    &[("to", 3.7977946), ("undirected", 4.247765)],
    &[("complementary", 5.934923), ("to", 3.7977946)],
    &[
        ("graph", 0.9454154),
        ("multi", 1.9063699),
        ("similarity", 1.9063699),
        ("structural", 1.7467744),
        ("to", 1.2198981),
    ],
    &[
        ("graph", 1.9052418),
    ...
    &[("connected", 3.9537516), ("holdout", 4.247765)],
    &[("holdout", 4.247765), ("random", 3.4401276)],
    &[
        ("get", 0.119874746),
        ("holdout", 1.364434),
        ("indices", 1.9063699),
