...
impl Graph {
    ...
    #[automatically_generated_binding]
    #[text_signature = "($self, number_of_negative_samples, random_state, seed_graph, only_from_same_component, sample_only_edges_with_heterogeneous_node_types, minimum_node_degree, maximum_node_degree, use_zipfian_sampling)"]
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("get", 0.068408124),
        ("graph", 0.6542859),
        ("laplacian", 0.87642986),
        ("normalized", 0.92157024),
        ("random", 0.66626483),
        ("transformed", 0.87642986),
        ("walk", 0.9820065),
    ],
    &[
        ("get", 0.088058464),
        ("graph", 0.8422305),
        ("laplacian", 1.1281857),
        ("normalized", 1.1862926),
        ("symmetric", 1.2640893),
        ("transformed", 1.1281857),
    ],
    &[
        ("get", 0.1171605),
        ("graph", 1.1205754),
        ("normalized", 1.5783451),
        ("symmetric", 1.6818525),
        ("transformed", 1.5010346),
    ],
    &[
        ("connected", 0.9112459),
        ("from", 0.24803723),
    ...
    &[
        ("disconnected", 0.87642986),
        ("from", 0.19268745),
        ("id", 0.29509896),
        ("is", 0.6542859),
        ("node", 0.2015021),
        ("unchecked", 0.36753577),
    ],
    &[
        ("from", 0.24803723),
        ("id", 0.3798666),
    ...
    &[
        ...
        ("is", 0.52203506),
        ("node", 0.08616173),
        ("selfloops", 0.55286294),
        ("singleton", 0.42040625),
        ("unchecked", 0.29324573),
        ("with", 0.47514176),
    ],
    &[
        ("from", 0.19268745),
    ...
    &[("components", 4.709357), ("remove", 2.662995)],
    &[("overlaps", 9.428665)],
    &[("contains", 8.622983)],
    &[
        ("bipartite", 3.4037018),
    ...
    &[("edge", 1.2477671), ("encode", 5.769677)],
    &[("decode", 5.769677), ("edge", 1.2477671)],
    &[
        ("edge", 0.39770645),
        ("encodable", 1.8389952),
        ("get", 0.1171605),
    ...
    &[
        ...
        ("must", 1.6454904),
        ("node", 0.25644386),
        ("ontologies", 1.9956701),
    ],
    &[
        ("be", 3.0377657),
        ("must", 2.4017208),
        ("undirected", 2.9128351),
    ],
    &[
        ("have", 1.5010346),
        ("must", 1.1867491),
    ...
    &[("have", 3.0377657), ("must", 2.4017208), ("nodes", 1.63984)],
    &[
        ("be", 3.0377657),
        ("connected", 2.4536312),
        ("must", 2.4017208),
    ...
    &[
        ("inplace", 1.0499525),
        ("isomorphic", 1.0345681),
        ("node", 0.18495065),
        ("remove", 0.84878844),
        ("types", 0.617634),
    ],
    &[
        ("isomorphic", 1.4344834),
        ("node", 0.25644386),
        ("remove", 1.1768901),
        ("types", 0.85638225),
    ],
    ...
    &[("circles", 5.769677), ("get", 0.3675802)],
    &[
        ("get", 0.23710725),
        ("memory", 2.4017208),
        ("stats", 3.7217243),
    ...
    &[("get", 0.3675802), ("transitivity", 5.769677)],
    &[
        ("get", 0.088058464),
        ("node", 0.13900991),
        ("number", 0.5691376),
    ...
    &[
        ("clustering", 1.5783451),
        ("coefficient", 1.3879132),
        ("get", 0.1171605),
        ("node", 0.18495065),
        ("per", 1.6818525),
    ],
    &[
        ("clustering", 3.1942255),
        ("coefficient", 2.808833),
        ("get", 0.23710725),
    ],
    &[
        ("average", 2.5498643),
        ("clustering", 2.188459),
        ("coefficient", 1.9244151),
        ("get", 0.16244924),
    ],
    &[
        ("are", 3.7217243),
        ("nodes", 1.63984),
        ("remappable", 3.7217243),
    ],
    &[
        ("from", 0.3300099),
        ("ids", 0.49745068),
    ...
    &[("negatives", 5.769677), ("sample", 5.769677)],
    &[("connected", 3.8037903), ("holdout", 4.0955353)],
    &[("holdout", 4.0955353), ("random", 3.5800683)],
    &[
        ("get", 0.1171605),
        ("holdout", 1.3053886),
        ("indices", 1.8389952),
    ...
    &[
        ...
        ("node", 0.05835487),
        ("parallel", 0.45412305),
        ("predecessors", 0.5802322),
        ("search", 0.4010752),
        ("unchecked", 0.19860692),
    ],
    &[
        ("breadth", 0.4010752),
        ("distances", 0.49799296),
        ("first", 0.4010752),
        ("from", 0.10412337),
        ("get", 0.036966),
        ("ids", 0.15695359),
    ...
    &[
        ("and", 0.30361173),
        ("distant", 0.44749278),
        ("eccentricity", 0.36928394),
        ("from", 0.08780619),
        ("get", 0.031173054),
        ("id", 0.26042238),
        ("most", 0.3993823),
        ("node", 0.09530001),
        ("unchecked", 0.16748321),
    ],
    &[
        ("eccentricity", 0.8103801),
        ("from", 0.19268745),
        ("get", 0.068408124),
        ("id", 0.29509896),
        ("node", 0.1079897),
    ...
    &[("diameter", 5.276656), ("get", 0.3675802)],
    &[
        ("breadth", 0.74221724),
        ("first", 0.74221724),
        ("from", 0.19268745),
    ...
    &[("density", 5.769677), ("get", 0.3675802)],
    &[
        ("get", 0.16244924),
        ("nodes", 1.1235032),
        ("rate", 1.9244151),
    ...
    &[
        ...
        ("get", 0.16244924),
        ("number", 1.0499384),
        ("undirected", 1.9956701),
    ],
    &[
        ("edges", 0.99255407),
        ("get", 0.1171605),
        ("number", 0.75722927),
        ("undirected", 1.4393033),
        ("unique", 1.2123992),
    ],
    &[
        ("edges", 2.0087125),
    ...
    &[
        ("destination", 1.8633771),
        ("get", 0.16244924),
        ("ids", 0.6897417),
        ("node", 0.25644386),
    ],
    &[
        ("destination", 1.3438919),
        ("directed", 1.0059311),
        ("get", 0.1171605),
        ("ids", 0.49745068),
        ("node", 0.18495065),
    ...
    &[("directed", 3.1560159), ("to", 3.8037903)],
    &[
        ("to", 2.4536312),
        ("triangular", 3.4037018),
        ("upper", 3.7217243),
    ],
    &[
        ("lower", 3.7217243),
    ...
    &[("bidiagonal", 5.769677), ("to", 3.8037903)],
    &[("arrowhead", 5.769677), ("to", 3.8037903)],
    &[("to", 3.8037903), ("transposed", 5.769677)],
    &[("complementary", 5.769677), ("to", 3.8037903)],
    &[
        ("approximated", 2.510267),
        ("cliques", 3.4037018),
        ("get", 0.23710725),
    ],
    &[
    ...
    &[("report", 4.5156803), ("textual", 5.276656)],
    &[
        ("connected", 1.6810558),
        ("generate", 1.6810558),
        ("graph", 1.553737),
    ...
    &[("remove", 2.662995), ("tendrils", 5.276656)],
    &[
        ("dendritic", 3.4037018),
        ("remove", 1.7177622),
        ("trees", 3.4037018),
    ...
    &[
        ("disconnected", 3.0377657),
        ("nodes", 1.63984),
        ("remove", 1.7177622),
    ],
    &[("remove", 2.662995), ("selfloops", 3.7233152)],
    &[
        ("edges", 2.0087125),
        ("parallel", 2.9128351),
        ("remove", 1.7177622),
    ...
    &[
        ("arborescence", 2.3319774),
        ("kruskal", 2.3319774),
        ("random", 1.5821835),
        ("spanning", 2.188459),
    ],
    &[
        ("arborescence", 3.4037018),
        ("kruskal", 3.4037018),
        ("spanning", 3.1942255),
    ],
    &[
    ...
    &[("enable", 9.428665)],
    &[("all", 4.0955353), ("disable", 5.769677)],
    &[
        ("compatible", 2.0812638),
        ("has", 1.0415746),
        ("node", 0.25644386),
        ("vocabularies", 2.188459),
    ],
    &[
        ("compatible", 1.5010346),
        ("has", 0.75119716),
        ("node", 0.18495065),
        ("types", 0.617634),
        ("vocabularies", 1.5783451),
    ],
    &[
        ("compatible", 1.5010346),
        ("edge", 0.39770645),
    ...
    &[("compatible", 4.709357), ("is", 3.5157013)],
    &[
        ("adjacency", 2.188459),
        ("has", 1.0415746),
        ("matrix", 1.9244151),
    ...
    &[("has", 2.3568115), ("nodes", 2.5421946)],
    &[("edges", 3.1140463), ("has", 2.3568115)],
    &[("has", 1.5202589), ("nodes", 1.63984), ("trap", 2.808833)],
    &[("directed", 3.1560159), ("is", 3.5157013)],
    &[
        ("edge", 0.8048709),
        ("has", 1.5202589),
        ("weights", 2.2288766),
    ...
    &[
        ("edge", 0.39770645),
        ("has", 0.75119716),
        ("probabilities", 1.8389952),
        ("representing", 1.8389952),
        ("weights", 1.1013426),
    ],
    &[
        ("has", 1.0415746),
    ...
    &[("has", 2.3568115), ("selfloops", 3.7233152)],
    &[
        ("disconnected", 3.0377657),
        ("has", 1.5202589),
        ("nodes", 1.63984),
    ...
    &[("connected", 3.8037903), ("is", 3.5157013)],
    &[
        ("has", 1.5202589),
        ("node", 0.37429968),
        ("types", 1.2499563),
    ...
    &[("is", 3.5157013), ("multigraph", 4.9519114)],
    &[
        ("has", 1.5202589),
        ("node", 0.37429968),
        ("ontologies", 2.9128351),
    ...
    &[("get", 0.3675802), ("tendrils", 5.276656)],
    &[
        ("degree", 0.75606334),
        ("distribution", 1.3821987),
        ("geometric", 1.3821987),
        ("get", 0.088058464),
        ("node", 0.13900991),
        ("threshold", 1.3821987),
    ...
    &[("add", 5.769677), ("selfloops", 3.7233152)],
    &[
        ("centrality", 2.1576486),
        ("degree", 2.0357847),
        ("get", 0.23710725),
    ],
    &[
        ("centrality", 1.4782693),
        ("degree", 1.3947768),
        ("get", 0.16244924),
        ("weighted", 1.1547272),
    ],
    &[
        ("centrality", 0.6225061),
        ("closeness", 0.87642986),
        ("from", 0.19268745),
        ("get", 0.068408124),
        ("id", 0.29509896),
        ("node", 0.1079897),
    ...
    &[
        ("centrality", 0.4966789),
        ("closeness", 0.69927704),
        ("from", 0.15373953),
        ("get", 0.054580785),
        ("id", 0.23545058),
        ("node", 0.08616173),
    ...
    &[
        ("betweenness", 2.9128351),
        ("centrality", 2.1576486),
        ("get", 0.23710725),
    ],
    &[
        ("approximated", 0.7242405),
        ("betweenness", 0.8403859),
        ("centrality", 0.6225061),
        ("from", 0.19268745),
        ("get", 0.068408124),
        ("id", 0.29509896),
    ...
    &[
        ("approximated", 0.5778497),
        ("betweenness", 0.67051864),
        ("centrality", 0.4966789),
        ("from", 0.15373953),
        ("get", 0.054580785),
        ("id", 0.23545058),
    ...
    &[
        ("centrality", 2.1576486),
        ("eigenvector", 3.4037018),
        ("get", 0.23710725),
    ],
    &[
        ("centrality", 1.4782693),
        ("eigenvector", 2.3319774),
        ("get", 0.16244924),
        ("weighted", 1.1547272),
    ],
    &[("dot", 5.769677), ("to", 3.8037903)],
    &[("get", 0.3675802), ("stars", 5.769677)],
    &[
        ("community", 1.5783451),
        ("detection", 1.8389952),
        ("get", 0.1171605),
    ...
    &[
        ("community", 0.92157024),
        ("directed", 0.587347),
        ("from", 0.19268745),
        ("get", 0.068408124),
        ("memberships", 0.9820065),
        ("modularity", 0.9820065),
        ("node", 0.1079897),
    ],
    &[
        ("community", 0.92157024),
        ...
        ("modularity", 0.9820065),
        ("node", 0.1079897),
        ("undirected", 0.8403859),
    ],
    &[
        ("attachment", 1.2403845),
        ("get", 0.1171605),
        ("minimum", 1.3438919),
        ("preferential", 1.2403845),
        ("unchecked", 0.62946725),
    ],
    &[
        ("attachment", 1.2403845),
    ...
    &[
        ("attachment", 0.93227965),
        ("get", 0.088058464),
        ("minimum", 1.0100764),
        ("preferential", 0.93227965),
        ("unchecked", 0.47311097),
        ("weighted", 0.6259402),
    ],
    &[
    ...
    &[
        ("attachment", 0.7242405),
        ("from", 0.19268745),
        ("get", 0.068408124),
        ("ids", 0.2904534),
        ("node", 0.1079897),
        ("preferential", 0.7242405),
        ("unchecked", 0.36753577),
    ],
    &[
        ("attachment", 0.93227965),
    ...
    &[
        ("attachment", 0.5778497),
        ("from", 0.15373953),
        ("get", 0.054580785),
        ("ids", 0.23174405),
        ("node", 0.08616173),
        ("preferential", 0.5778497),
        ("unchecked", 0.29324573),
        ("weighted", 0.38797304),
    ],
    &[
