...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[("selfloops", 3.643762), ("add", 5.6863265)],
    &[
        ("generate", 0.8902425),
        ("edges", 0.75711715),
        ("from", 0.2536291),
    ...
    &[("transposed", 5.6863265), ("to", 3.724088)],
    ...
    &[("diameter", 4.870079), ("get", 0.35571262)],
    &[
        ("get", 0.15698083),
        ("naive", 2.2922802),
        ("weighted", 1.1082569),
    ...
    &[("chains", 5.6863265), ("get", 0.35571262)],
    &[
        ("get", 0.22926007),
        ("trees", 3.347723),
        ("dendritic", 3.347723),
    ],
    &[("get", 0.35571262), ("stars", 5.6863265)],
    &[
        ("edge", 0.41553885),
        ("all", 1.3158216),
        ("set", 1.410881),
