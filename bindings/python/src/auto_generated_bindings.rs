...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("graph", 0.6355736),
        ("normalized", 0.90152156),
        ("transformed", 0.85660684),
        ("laplacian", 0.85660684),
        ("random", 0.67401814),
        ("get", 0.066875175),
        ("walk", 0.9616556),
    ],
    &[
        ("graph", 0.81836516),
        ("normalized", 1.1608),
        ("transformed", 1.1029677),
        ("laplacian", 1.1029677),
        ("get", 0.086108536),
        ("symmetric", 1.2382287),
    ],
    &[
        ("transformed", 1.4680105),
        ("graph", 1.0892147),
        ("get", 0.11460738),
        ("symmetric", 1.6480379),
        ("normalized", 1.5449833),
    ],
    &[
        ("unchecked", 0.45708773),
        ("is", 0.83371216),
        ("from", 0.25217676),
        ("node", 0.14394076),
        ("connected", 0.9079884),
    ...
    &[
        ("disconnected", 0.85660684),
        ("unchecked", 0.35499176),
        ("from", 0.1958501),
        ("id", 0.2911272),
        ("node", 0.20866294),
        ("is", 0.6474927),
    ...
    &[
        ("with", 0.4603494),
        ("unchecked", 0.28317767),
        ("from", 0.15623003),
        ("selfloops", 0.53766567),
        ("id", 0.23223278),
        ("singleton", 0.40589902),
        ("is", 0.51650625),
        ("node", 0.08917503),
    ],
    &[
    ...
    &[("name", 1.5119698), ("node", 0.3881767), ("has", 1.5386657)],
    &[
        ("has", 1.0534532),
        ("id", 0.69211894),
        ("type", 0.7660088),
    ...
    &[
        ...
        ("by", 0.9854172),
        ("degree", 0.7326055),
        ("increasing", 1.2382287),
    ],
    &[
        ("decreasing", 1.2382287),
        ("degree", 0.7326055),
        ("by", 0.9854172),
        ("node", 0.14394076),
        ("sort", 1.1029677),
    ...
    &[
        ("by", 1.3115549),
        ("node", 0.19158),
        ("lexicographic", 1.6480379),
        ("sort", 1.4680105),
        ("order", 1.6480379),
    ],
    &[
        ("topological", 0.90152156),
        ("sorting", 0.90152156),
        ("bfs", 0.90152156),
        ("get", 0.066875175),
        ("node", 0.11178989),
    ...
    &[("remove", 3.1096535), ("components", 4.6157966)],
    &[("overlaps", 9.284037)],
    &[("contains", 8.479079)],
    &[
        ("edges", 2.0334468),
    ...
    &[("encode", 5.6737847), ("edge", 1.2950816)],
    &[("decode", 5.6737847), ("edge", 1.2950816)],
    &[
        ("max", 1.8044937),
        ("get", 0.11460738),
        ("edge", 0.41188848),
    ...
    &[("get", 0.3603546), ("circles", 5.6737847)],
    &[
        ("get", 0.23221585),
        ("memory", 2.3404455),
        ("stats", 3.6562397),
    ...
    &[("transitivity", 5.6737847), ("get", 0.3603546)],
    &[
        ("triangles", 1.2382287),
        ("per", 1.2382287),
        ("get", 0.086108536),
    ...
    &[
        ("clustering", 1.5449833),
        ("get", 0.11460738),
        ("node", 0.19158),
        ("per", 1.6480379),
        ("coefficient", 1.3553839),
    ],
    &[
        ("clustering", 3.1304233),
        ("get", 0.23221585),
        ("coefficient", 2.7462597),
    ],
    &[
        ("average", 2.5032585),
        ("get", 0.15898746),
        ("clustering", 2.1432562),
        ("coefficient", 1.8802371),
    ],
    &[
        ("nodes", 1.6264229),
        ("are", 3.6562397),
        ("remappable", 3.6562397),
    ],
    &[
        ("unchecked", 0.6083674),
        ("remap", 1.4680105),
    ...
    &[("negatives", 5.6737847), ("sample", 5.6737847)],
    &[("connected", 3.79983), ("holdout", 4.0033255)],
    &[("holdout", 4.0033255), ("random", 3.631924)],
    &[
        ("label", 1.2391536),
        ("get", 0.11460738),
        ("holdout", 1.2732198),
    ...
    &[("get", 0.3603546), ("chains", 5.6737847)],
    &[
        ("unchecked", 0.19172993),
        ("get", 0.03611907),
        ("parallel", 0.4432808),
        ("predecessors", 0.56869495),
        ("search", 0.39052525),
        ("from", 0.105778016),
        ("id", 0.15723689),
        ("node", 0.060377367),
    ...
    &[
        ...
        ("get", 0.030455425),
        ("node", 0.09860948),
        ("unchecked", 0.16166575),
        ("eccentricity", 0.3601757),
        ("and", 0.29487273),
        ("from", 0.08919152),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.03611907),
        ("and", 0.34970874),
        ("eccentricity", 0.4271558),
    ],
    &[
        ("eccentricity", 1.0183474),
        ("id", 0.37485567),
        ("weighted", 0.59734464),
        ("node", 0.14394076),
        ("from", 0.25217676),
    ...
    &[("get", 0.3603546), ("diameter", 4.857818)],
    &[
        ("get", 0.15898746),
        ("weighted", 1.102914),
        ("diameter", 2.1432562),
    ...
    &[("density", 5.6737847), ("get", 0.3603546)],
    &[
        ("trap", 1.8802371),
        ("get", 0.15898746),
        ("nodes", 1.1135366),
    ...
    &[
        ("number", 1.0534532),
        ("undirected", 1.9512155),
        ("get", 0.15898746),
        ("edges", 1.392207),
    ],
    &[
        ("unique", 1.2085),
        ("undirected", 1.4065492),
        ("edges", 1.0035834),
        ("get", 0.11460738),
        ("number", 0.7593901),
    ],
    ...
    &[
        ...
        ("node", 0.19158),
        ("get", 0.11460738),
        ("destination", 1.3115549),
        ("directed", 1.2085),
    ],
    &[
        ("destination", 2.657454),
        ("get", 0.23221585),
        ("names", 1.3031617),
    ],
    &[
    ...
    &[
        ("get", 0.23221585),
        ("node", 0.3881767),
        ("ontologies", 3.6562397),
    ],
    &[("ids", 0.9936641), ("get", 0.23221585), ("node", 0.3881767)],
    &[
        ("get", 0.15898746),
        ("ids", 0.6803159),
        ("edge", 0.57138646),
    ...
    &[
        ("cumulative", 2.5032585),
        ("get", 0.15898746),
        ("node", 0.26576665),
        ("degrees", 1.6764747),
    ],
    &[
        ("reciprocal", 2.0364769),
        ("sqrt", 2.0364769),
        ("degrees", 1.6764747),
        ("get", 0.15898746),
    ],
    ...
    &[("directed", 3.79983), ("to", 3.7122223)],
    &[
        ("to", 2.3921905),
        ("triangular", 3.3392313),
        ("upper", 3.6562397),
    ],
    &[
        ("to", 2.3921905),
    ...
    &[("bidiagonal", 5.6737847), ("to", 3.7122223)],
    &[("to", 3.7122223), ("arrowhead", 5.6737847)],
    &[("to", 3.7122223), ("transposed", 5.6737847)],
    &[("complementary", 5.6737847), ("to", 3.7122223)],
    &[("report", 7.236631)],
    &[
        ("textual", 3.3392313),
        ("report", 2.8499303),
    ...
    &[("textual", 5.1818485), ("report", 4.422547)],
    &[
        ("connected", 1.6764747),
        ("graph", 1.5109977),
        ("generate", 1.6378223),
    ...
    &[("tendrils", 5.1818485), ("drop", 3.79983)],
    &[
        ("dendritic", 3.3392313),
        ("drop", 2.4486458),
        ("trees", 3.3392313),
    ...
    &[
        ("disconnected", 2.9744623),
        ("drop", 2.4486458),
        ("nodes", 1.6264229),
    ],
    &[("selfloops", 3.631924), ("drop", 3.79983)],
    &[
        ("edges", 2.0334468),
        ("drop", 2.4486458),
        ("parallel", 2.8499303),
    ...
    &[
        ("random", 1.6023949),
        ("spanning", 2.1432562),
        ("arborescence", 2.2862172),
        ("kruskal", 2.2862172),
    ],
    &[
        ("spanning", 3.1304233),
        ("arborescence", 3.3392313),
        ("kruskal", 3.3392313),
    ],
    &[
        ("connected", 2.4486458),
    ...
    &[("enable", 9.284037)],
    &[("is", 3.4889922), ("compatible", 5.6737847)],
    &[
        ("same", 2.5032585),
        ("matrix", 1.8802371),
        ("adjacency", 2.1432562),
    ...
    &[
        ("subsampled", 3.6562397),
        ("get", 0.23221585),
        ("nodes", 1.6264229),
    ],
    &[
        ("feature", 1.3557793),
        ("propagation", 1.2382287),
        ("bm25", 1.2382287),
        ("okapi", 1.2382287),
        ("node", 0.14394076),
        ("get", 0.086108536),
    ...
    &[("nodes", 2.5238972), ("has", 2.3877149)],
    &[("edges", 3.1555204), ("has", 2.3877149)],
    &[
        ("has", 1.5386657),
        ("nodes", 1.6264229),
        ("trap", 2.7462597),
    ],
    &[("is", 3.4889922), ("directed", 3.79983)],
    &[
        ("has", 1.5386657),
        ("weights", 2.248339),
        ("edge", 0.83456266),
    ...
    &[
        ("probabilities", 1.8044937),
        ("weights", 1.1096411),
        ("representing", 1.8044937),
        ("has", 0.7593901),
        ("edge", 0.41188848),
    ],
    &[
    ...
    &[("selfloops", 3.631924), ("has", 2.3877149)],
    &[
        ("nodes", 1.6264229),
        ("has", 1.5386657),
        ("disconnected", 2.9744623),
    ...
    &[("connected", 3.79983), ("is", 3.4889922)],
    &[
        ("node", 0.3881767),
        ("has", 1.5386657),
        ("types", 1.2410518),
    ...
    &[("multigraph", 4.857818), ("is", 3.4889922)],
    &[
        ("decreasing", 0.7671147),
        ("has", 0.35347447),
        ("sorted", 0.71914566),
        ("node", 0.08917503),
        ("outbound", 0.68331707),
    ...
    &[
        ...
        ("from", 0.15623003),
        ("sqrt", 0.68331707),
        ("reciprocal", 0.68331707),
    ],
    &[
        ("get", 0.066875175),
        ("reciprocal", 0.85660684),
        ("degree", 0.56896937),
        ("from", 0.1958501),
        ("sqrt", 0.85660684),
        ("node", 0.11178989),
    ...
    &[("tendrils", 5.1818485), ("get", 0.3603546)],
    &[
        ("get", 0.086108536),
        ("geometric", 1.3557793),
        ("degree", 0.7326055),
        ("distribution", 1.3557793),
        ("threshold", 1.3557793),
        ("node", 0.14394076),
    ],
    &[
    ...
    &[("selfloops", 3.631924), ("add", 5.6737847)],
    &[
        ("degree", 1.9756765),
        ("get", 0.23221585),
        ("centrality", 2.0971518),
    ],
    &[
        ("get", 0.15898746),
        ("weighted", 1.102914),
        ("centrality", 1.4358228),
        ("degree", 1.3526545),
    ],
    &[
        ("get", 0.066875175),
        ("closeness", 0.85660684),
        ("centrality", 0.6039527),
        ("id", 0.2911272),
        ("from", 0.1958501),
        ("node", 0.11178989),
        ("unchecked", 0.35499176),
    ...
    &[
        ("weighted", 0.37007046),
        ("unchecked", 0.28317767),
        ("closeness", 0.68331707),
        ("centrality", 0.48177433),
        ("node", 0.08917503),
        ("from", 0.15623003),
        ("id", 0.23223278),
        ("get", 0.053346466),
    ...
    &[
        ("betweenness", 2.8499303),
        ("get", 0.23221585),
        ("centrality", 2.0971518),
    ],
    &[
        ("from", 0.1958501),
        ("approximated", 0.8207432),
        ("get", 0.066875175),
        ("id", 0.2911272),
        ("centrality", 0.6039527),
        ("betweenness", 0.8207432),
        ("node", 0.11178989),
    ],
    &[
        ("node", 0.11178989),
    ...
    &[
        ("get", 0.053346466),
        ("betweenness", 0.65470856),
        ("approximated", 0.65470856),
        ("node", 0.08917503),
        ("id", 0.23223278),
        ("weighted", 0.37007046),
        ("centrality", 0.48177433),
    ...
    &[
        ("get", 0.23221585),
        ("centrality", 2.0971518),
        ("eigenvector", 3.3392313),
    ],
    &[
        ("get", 0.15898746),
        ("weighted", 1.102914),
        ("eigenvector", 2.2862172),
        ("centrality", 1.4358228),
    ],
    &[("dot", 5.6737847), ("to", 3.7122223)],
    &[("stars", 5.6737847), ("get", 0.3603546)],
    &[
        ("louvain", 1.8044937),
        ("get", 0.11460738),
        ("community", 1.5449833),
    ...
    &[
        ("modularity", 0.9616556),
        ("memberships", 0.9616556),
        ("directed", 0.70517844),
        ("from", 0.1958501),
        ("community", 0.90152156),
        ("node", 0.11178989),
        ("get", 0.066875175),
    ],
    &[
        ("community", 0.90152156),
        ("undirected", 0.8207432),
        ("get", 0.066875175),
        ("from", 0.1958501),
        ("node", 0.11178989),
        ("memberships", 0.9616556),
    ...
    &[
        ("attachment", 0.9079884),
        ("preferential", 0.9079884),
        ("get", 0.086108536),
        ("unchecked", 0.45708773),
        ("weighted", 0.59734464),
        ("minimum", 0.9854172),
    ...
    &[
        ("get", 0.066875175),
        ("ids", 0.28616247),
        ("preferential", 0.70517844),
        ("attachment", 0.70517844),
        ("unchecked", 0.35499176),
        ("node", 0.11178989),
        ("from", 0.1958501),
    ],
    ...
    &[
        ("ids", 0.2282724),
        ("node", 0.08917503),
        ("preferential", 0.56252235),
        ("attachment", 0.56252235),
        ("unchecked", 0.28317767),
        ("get", 0.053346466),
        ("from", 0.15623003),
        ("weighted", 0.37007046),
    ...
    &[
        ...
        ("types", 0.28510427),
        ("from", 0.15623003),
        ("isomorphic", 0.52669376),
        ("has", 0.35347447),
    ],
    &[
        ("types", 0.35740694),
        ("isomorphic", 0.6602638),
        ("has", 0.4431159),
        ("node", 0.20866294),
        ("from", 0.1958501),
        ("ids", 0.28616247),
    ],
    &[("from", 1.0553316), ("csv", 5.6737847)],
];
