...
impl Graph {
    ...
    #[automatically_generated_binding]
    #[text_signature = "($self, minimum_degree)"]
    /// Returns graph cliques with at least `minimum_degree` nodes.
    ///
    /// Parameters
    /// ----------
    ///
    pub fn get_cliques(&self, minimum_degree: Option<NodeT>) -> PyResult<Vec<Clique>> {
        Ok(pe!(self.inner.get_cliques(minimum_degree.into()))?
            .into_iter()
            .map(|x| x.into())
            .collect::<Vec<_>>())
    }
    ...
    /// ----------
    ///
    pub fn get_cliques_number(&self, minimum_degree: Option<NodeT>) -> PyResult<usize> {
        Ok(pe!(self.inner.get_cliques_number(minimum_degree.into()))?.into())
    }
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("graph", 0.63596374),
        ("normalized", 0.9018001),
        ("get", 0.06654986),
        ("random", 0.67439216),
        ("laplacian", 0.85690427),
        ("transformed", 0.85690427),
        ("walk", 0.961909),
    ],
    &[
        ("symmetric", 1.2385831),
        ("graph", 0.81888616),
        ("transformed", 1.1033759),
        ("laplacian", 1.1033759),
        ("get", 0.08569161),
        ("normalized", 1.1611851),
    ],
    &[
        ("graph", 1.0899408),
        ("normalized", 1.5455421),
        ("transformed", 1.4685978),
        ("symmetric", 1.6485591),
        ("get", 0.11405588),
    ],
    &[
        ("node", 0.14393887),
        ("unchecked", 0.45775208),
        ("id", 0.37555262),
        ("is", 0.834227),
        ("from", 0.2516585),
        ("connected", 0.90847385),
    ],
    &[
        ("from", 0.19544315),
        ("unchecked", 0.35549963),
        ("disconnected", 0.85690427),
        ("id", 0.29166186),
        ("node", 0.20866129),
        ("is", 0.6478778),
    ],
    ...
    &[
        ("selfloops", 0.5379545),
        ("id", 0.23265517),
        ("singleton", 0.40624547),
        ("is", 0.51680434),
        ("node", 0.08917025),
        ("unchecked", 0.28357777),
        ("from", 0.15590265),
        ("with", 0.46067202),
    ],
    &[
        ("selfloops", 0.67439216),
        ("with", 0.57750905),
        ("id", 0.29166186),
        ("singleton", 0.50927866),
        ("from", 0.19544315),
        ("node", 0.11178587),
        ("is", 0.6478778),
    ],
    ...
    &[
        ...
        ("by", 1.3121994),
        ("node", 0.19158322),
        ("lexicographic", 1.6485591),
    ],
    &[
        ("sorting", 0.9018001),
        ("topological", 0.9018001),
        ("get", 0.06654986),
        ("id", 0.29166186),
        ("from", 0.19544315),
        ("node", 0.11178587),
    ...
    &[("remove", 3.1126194), ("components", 4.618485)],
    &[("overlaps", 9.289129)],
    &[("contains", 8.484233)],
    &[
        ("edges", 2.0351834),
    ...
    &[("encode", 5.676278), ("edge", 1.2983825)],
    &[("decode", 5.676278), ("edge", 1.2983825)],
    &[
        ("max", 1.8049575),
        ("encodable", 1.8049575),
        ("get", 0.11405588),
    ...
    &[
        ("be", 2.9759476),
        ("must", 2.3938313),
        ("multigraph", 3.1318665),
    ],
    &[
        ("be", 2.0373752),
        ("must", 1.6388503),
        ("not", 1.8811861),
        ("multigraph", 2.1441195),
    ],
    &[
        ("identity", 2.2870343),
        ("matrix", 1.8811861),
    ...
    &[("circles", 5.676278), ("get", 0.35868594)],
    &[
        ("memory", 2.3421001),
        ("stats", 3.6575425),
        ("get", 0.23112136),
    ...
    &[("transitivity", 5.676278), ("get", 0.35868594)],
    &[
        ("of", 0.9570807),
        ("node", 0.14393887),
        ("triangles", 1.2385831),
    ...
    &[
        ("clustering", 1.5455421),
        ("node", 0.19158322),
        ("get", 0.11405588),
        ("per", 1.6485591),
        ("coefficient", 1.3560122),
    ],
    &[
        ("coefficient", 2.7478056),
        ("clustering", 3.1318665),
        ("get", 0.23112136),
    ],
    &[
        ("coefficient", 1.8811861),
        ("average", 2.5040047),
        ("clustering", 2.1441195),
        ("get", 0.1582289),
    ],
    &[
        ("are", 3.6575425),
        ("nodes", 1.6282686),
        ("remappable", 3.6575425),
    ],
    &[
        ("remap", 1.4071589),
        ("unchecked", 0.60926986),
    ...
    &[("sample", 5.676278), ("negatives", 5.676278)],
    &[("connected", 3.8026686), ("holdout", 4.0061264)],
    &[("random", 3.6347933), ("holdout", 4.0061264)],
    &[
        ("get", 0.11405588),
        ("node", 0.19158322),
        ("holdout", 1.2738783),
    ...
    &[("chains", 5.676278), ("get", 0.35868594)],
    &[
        ("get", 0.035941828),
        ("predecessors", 0.56878674),
        ("id", 0.1575189),
        ("from", 0.1055537),
        ("parallel", 0.44343054),
        ("unchecked", 0.191996),
    ...
    &[
        ("from", 0.089001544),
        ("unchecked", 0.16188858),
        ("eccentricity", 0.3603049),
        ("distant", 0.43803728),
        ("node", 0.09860224),
        ("get", 0.030305691),
        ("most", 0.3902199),
    ...
    &[
        ...
        ("distant", 0.51950175),
        ("get", 0.035941828),
        ("eccentricity", 0.427313),
        ("id", 0.3033315),
        ("node", 0.11625851),
    ],
    &[
        ("get", 0.08569161),
        ("eccentricity", 1.0187889),
        ("node", 0.14393887),
        ("weighted", 0.59795326),
        ("from", 0.2516585),
        ("id", 0.37555262),
    ...
    &[("get", 0.35868594), ("diameter", 4.8604617)],
    &[
        ("get", 0.1582289),
        ("diameter", 2.1441195),
        ("naive", 2.2870343),
    ...
    &[("get", 0.35868594), ("density", 5.676278)],
    &[
        ("get", 0.1582289),
        ("rate", 1.8811861),
        ("trap", 1.8811861),
    ...
    &[
        ("node", 0.26578203),
        ("ids", 0.6816559),
        ("destination", 1.8204049),
        ("get", 0.1582289),
    ],
    &[
        ("get", 0.11405588),
        ("destination", 1.3121994),
        ("node", 0.19158322),
        ("directed", 1.2091824),
        ("ids", 0.49135685),
    ],
    &[
        ("destination", 2.659024),
        ("names", 1.295834),
        ("get", 0.23112136),
    ],
    &[
    ...
    &[("directed", 3.8026686), ("to", 3.715077)],
    &[
        ("triangular", 3.3406188),
        ("to", 2.3938313),
        ("upper", 3.6575425),
    ],
    &[
    ...
    &[("to", 3.715077), ("bidiagonal", 5.676278)],
    &[("to", 3.715077), ("arrowhead", 5.676278)],
    &[("transposed", 5.676278), ("to", 3.715077)],
    &[("to", 3.715077), ("complementary", 5.676278)],
    &[("get", 0.35868594), ("cliques", 5.184432)],
    &[
        ("number", 1.527047),
        ("cliques", 3.3406188),
        ("get", 0.23112136),
    ...
    &[("textual", 5.184432), ("report", 4.42527)],
    &[
        ("graph", 1.5120672),
        ("random", 1.6034344),
        ("connected", 1.6774901),
    ...
    &[("tendrils", 5.184432), ("drop", 3.8026686)],
    &[
        ("trees", 3.3406188),
        ("dendritic", 3.3406188),
        ("drop", 2.4502714),
    ...
    &[
        ("nodes", 1.6282686),
        ("disconnected", 2.9759476),
        ("drop", 2.4502714),
    ],
    &[("selfloops", 3.6347933), ("drop", 3.8026686)],
    &[
        ("drop", 2.4502714),
        ("parallel", 2.8514485),
        ("edges", 2.0351834),
    ...
    &[
        ...
        ("random", 1.6034344),
        ("spanning", 2.1441195),
        ("arborescence", 2.2870343),
    ],
    &[
        ("kruskal", 3.3406188),
        ("arborescence", 3.3406188),
        ("spanning", 3.1318665),
    ],
    &[
        ("get", 0.23112136),
    ...
    &[("enable", 9.289129)],
    &[("compatible", 5.676278), ("is", 3.491888)],
    &[
        ("adjacency", 2.1441195),
        ("same", 2.5040047),
        ("matrix", 1.8811861),
    ...
    &[("has", 2.3908138), ("nodes", 2.5269713)],
    &[("edges", 3.1584778), ("has", 2.3908138)],
    &[
        ("has", 1.5405347),
        ("nodes", 1.6282686),
        ("trap", 2.7478056),
    ],
    &[("directed", 3.8026686), ("is", 3.491888)],
    &[
        ("edge", 0.83662033),
        ("has", 1.5405347),
        ("weights", 2.2500184),
    ...
    &[
        ("weights", 1.1103595),
        ("edge", 0.41286302),
        ("representing", 1.8049575),
        ("has", 0.76023716),
        ("probabilities", 1.8049575),
    ],
    &[
        ("has", 1.0546716),
        ("nodes", 1.1147354),
    ...
    &[("has", 2.3908138), ("selfloops", 3.6347933)],
    &[
        ("has", 1.5405347),
        ("disconnected", 2.9759476),
        ("nodes", 1.6282686),
    ...
    &[("is", 3.491888), ("connected", 3.8026686)],
    &[
        ("node", 0.38822174),
        ("types", 1.2430007),
        ("has", 1.5405347),
    ...
    &[("is", 3.491888), ("multigraph", 4.8604617)],
    &[
        ("degree", 0.45419353),
        ("has", 0.3538438),
        ("by", 0.6107484),
        ...
        ("nodes", 0.37399527),
        ("outbound", 0.68354225),
        ("decreasing", 0.7673032),
        ("node", 0.08917025),
    ],
    &[
        ("order", 1.2385831),
        ("lexicographic", 1.2385831),
        ("has", 0.5711757),
        ("nodes", 0.6037043),
        ("sorted", 1.1611851),
        ("by", 0.9858718),
    ...
    &[("get", 0.35868594), ("tendrils", 5.184432)],
    &[
        ("threshold", 1.3560871),
        ("node", 0.14393887),
        ("degree", 0.7331605),
        ("get", 0.08569161),
        ("distribution", 1.3560871),
        ("geometric", 1.3560871),
    ],
    &[
        ("methods", 1.5455421),
    ...
    &[("add", 5.676278), ("selfloops", 3.6347933)],
    &[
        ("centrality", 2.0988717),
        ("degree", 1.9774288),
        ("get", 0.23112136),
    ],
    &[
        ...
        ("get", 0.1582289),
        ("degree", 1.3537754),
        ("centrality", 1.4369168),
    ],
    &[
        ("id", 0.29166186),
        ("centrality", 0.6043561),
        ("get", 0.06654986),
        ("unchecked", 0.35549963),
        ("closeness", 0.85690427),
        ("node", 0.11178587),
        ("from", 0.19544315),
    ],
    &[
        ("weighted", 0.37043256),
        ("centrality", 0.4820876),
        ("closeness", 0.68354225),
        ("node", 0.08917025),
        ("id", 0.23265517),
        ("get", 0.05308602),
        ("from", 0.15590265),
    ...
    &[
        ("centrality", 2.0988717),
        ("betweenness", 2.8514485),
        ("get", 0.23112136),
    ],
    &[
        ("node", 0.11178587),
        ("approximated", 0.82105565),
        ("centrality", 0.6043561),
        ("from", 0.19544315),
        ("id", 0.29166186),
        ("betweenness", 0.82105565),
        ("get", 0.06654986),
    ],
    &[
        ("approximated", 0.82105565),
    ...
    &[
        ...
        ("weighted", 0.37043256),
        ("centrality", 0.4820876),
        ("approximated", 0.6549462),
        ("from", 0.15590265),
        ("betweenness", 0.6549462),
    ],
    &[
        ("name", 0.34771374),
        ("from", 0.15590265),
    ...
    &[
        ("centrality", 2.0988717),
        ("eigenvector", 3.3406188),
        ("get", 0.23112136),
    ],
    &[
        ("weighted", 1.1041162),
        ("get", 0.1582289),
        ("eigenvector", 2.2870343),
        ("centrality", 1.4369168),
    ],
    &[("dot", 5.676278), ("to", 3.715077)],
    &[("get", 0.35868594), ("stars", 5.676278)],
    &[
        ("community", 1.5455421),
        ("undirected", 1.4071589),
        ("detection", 1.8049575),
    ...
    &[
        ("unchecked", 0.60926986),
        ("minimum", 1.3121994),
        ("preferential", 1.2091824),
        ("get", 0.11405588),
        ("attachment", 1.2091824),
    ],
    &[
        ("unchecked", 0.60926986),
        ("preferential", 1.2091824),
    ...
    &[
        ("attachment", 0.90847385),
        ("weighted", 0.59795326),
        ("minimum", 0.9858718),
        ("unchecked", 0.45775208),
        ("get", 0.08569161),
        ("preferential", 0.90847385),
    ],
    &[
        ("preferential", 0.90847385),
        ("unchecked", 0.45775208),
    ...
    &[
        ("preferential", 0.70553935),
        ("attachment", 0.70553935),
        ("unchecked", 0.35549963),
        ("from", 0.19544315),
        ("ids", 0.2866992),
        ("get", 0.06654986),
    ...
    &[
        ...
        ("node", 0.08917025),
        ("get", 0.05308602),
        ("attachment", 0.5628003),
        ("unchecked", 0.28357777),
        ("preferential", 0.5628003),
        ("ids", 0.22869651),
    ],
    &[
        ("ids", 0.2866992),
    ...
    &[
        ...
        ("node", 0.20866129),
        ("has", 0.44358674),
        ("isomorphic", 0.6606435),
        ("types", 0.3579138),
        ("ids", 0.2866992),
    ],
    &[("csv", 5.676278), ("from", 1.0533863)],
];
