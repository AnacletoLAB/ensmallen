...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    &[("encode", 5.67784), ("edge", 1.3001013)],
    &[("edge", 1.3001013), ("decode", 5.67784)],
    &[
        ("edge", 0.41339505),
        ("get", 0.11379481),
        ("number", 0.754089),
    ...
    &[
        ("get", 0.23059674),
        ("centrality", 2.0999005),
        ("degree", 1.9784639),
    ],
    &[
        ("degree", 1.354469),
        ("centrality", 1.4376051),
        ("get", 0.15786798),
        ("weighted", 1.1048255),
    ],
    &[
        ("unchecked", 0.35579836),
        ("centrality", 0.60463476),
        ("id", 0.29196575),
        ("closeness", 0.8571625),
        ("get", 0.06639686),
        ("from", 0.19575481),
    ...
    &[
        ("node", 0.089423954),
        ("weighted", 0.37066257),
        ("centrality", 0.48230824),
        ("closeness", 0.6837459),
        ("get", 0.0529638),
        ("unchecked", 0.28381512),
        ("id", 0.23289679),
        ("from", 0.15615074),
    ],
    &[
    ...
    &[
        ("centrality", 2.0999005),
        ("betweenness", 2.8524382),
        ("get", 0.23059674),
    ],
    &[
        ("get", 0.06639686),
        ("approximated", 0.7659138),
        ("from", 0.19575481),
        ("node", 0.1121043),
        ("betweenness", 0.82131666),
        ("id", 0.29196575),
        ("centrality", 0.60463476),
    ],
    &[
    ...
    &[
        ("from", 0.15615074),
        ("approximated", 0.61095816),
        ("get", 0.0529638),
        ("node", 0.089423954),
        ("id", 0.23289679),
        ("centrality", 0.48230824),
        ("weighted", 0.37066257),
        ("betweenness", 0.65515226),
    ],
    &[
        ("weighted", 0.37066257),
        ("approximated", 0.61095816),
    ...
    &[
        ("get", 0.23059674),
        ("centrality", 2.0999005),
        ("eigenvector", 3.3415835),
    ],
    &[
        ("eigenvector", 2.2876692),
        ("centrality", 1.4376051),
        ("weighted", 1.1048255),
        ("get", 0.15786798),
    ],
    ...
    &[
        ("minimum", 0.9862179),
        ("attachment", 0.90882593),
        ("weighted", 0.5983291),
        ("unchecked", 0.45813867),
        ("preferential", 0.90882593),
        ("get", 0.085494965),
    ],
    &[
        ("weighted", 0.5983291),
    ...
    &[
        ("ids", 0.2870035),
        ("preferential", 0.70580983),
        ("attachment", 0.70580983),
        ("unchecked", 0.35579836),
        ("from", 0.19575481),
        ("get", 0.06639686),
        ("node", 0.1121043),
    ...
    &[
        ...
        ("get", 0.06639686),
        ("jaccard", 0.9020547),
        ("coefficient", 0.79147583),
    ],
    &[
        ("node", 0.1443495),
        ("ids", 0.36955595),
        ("coefficient", 1.0191325),
        ("from", 0.2520609),
        ("get", 0.085494965),
        ("jaccard", 1.1615179),
    ],
    ...
    &[
        ...
        ("unchecked", 0.28381512),
        ("index", 0.57727504),
        ("allocation", 0.63134867),
    ],
    &[
        ("get", 0.04318499),
        ("node", 0.07291342),
        ("ids", 0.1866691),
        ("unchecked", 0.23141377),
        ("allocation", 0.5147815),
        ("from", 0.12732032),
        ("resource", 0.5147815),
        ("weighted", 0.3022264),
        ("index", 0.4706916),
    ...
    &[("nodes", 2.5286462), ("has", 2.3924937)],
    &[("edges", 3.1601303), ("has", 2.3924937)],
    &[
        ("trap", 2.7488008),
        ("nodes", 1.6293217),
        ("has", 1.5415925),
    ],
    &[("directed", 3.804298), ("is", 3.4935286)],
    &[
        ("has", 1.5415925),
        ("edge", 0.8377144),
        ("weights", 2.2510393),
    ...
    &[
        ("has", 0.7607446),
        ("probabilities", 1.805391),
        ("weights", 1.1108422),
        ("edge", 0.41339505),
        ("representing", 1.805391),
    ],
    &[
        ("singleton", 1.2115632),
        ("weighted", 1.1048255),
    ...
    &[("selfloops", 3.6364288), ("has", 2.3924937)],
    &[
        ("disconnected", 2.9769309),
        ("nodes", 1.6293217),
        ("has", 1.5415925),
    ],
    &[
    ...
    &[("is", 3.4935286), ("connected", 3.804298)],
    &[
        ("has", 1.5415925),
        ("node", 0.38933897),
        ("types", 1.2440736),
    ...
    &[("is", 3.4935286), ("multigraph", 4.8620534)],
    &[
        ("by", 0.61095816),
        ("sorted", 0.7195558),
        ("degree", 0.4544165),
        ("node", 0.089423954),
        ("decreasing", 0.7674998),
        ("outbound", 0.6837459),
        ("has", 0.35407525),
        ("nodes", 0.37422502),
    ],
    ...
    &[("add", 5.67784), ("selfloops", 3.6364288)],
    &[
        ("node", 0.1443495),
        ("features", 1.3564049),
        ("from", 0.2520609),
    ...
    &[("report", 4.4268775), ("textual", 5.1860123)],
    &[
        ("tuples", 3.6584907),
        ("node", 0.38933897),
        ("get", 0.23059674),
    ...
    &[
        ...
        ("degree", 0.4544165),
        ("id", 0.23289679),
        ("comulative", 0.7674998),
        ("node", 0.16920392),
        ("get", 0.0529638),
    ],
    &[
        ("comulative", 0.9621587),
        ("id", 0.29196575),
        ("degree", 0.5696689),
        ("get", 0.06639686),
        ("from", 0.19575481),
    ...
    &[("transitivity", 5.67784), ("get", 0.3578775)],
    &[
        ("per", 1.2389098),
        ("number", 0.5665532),
        ("triangles", 1.2389098),
    ...
    &[
        ("per", 1.6490036),
        ("coefficient", 1.3564774),
        ("node", 0.19213088),
        ("get", 0.11379481),
        ("clustering", 1.545994),
    ],
    &[
        ("coefficient", 2.7488008),
        ("clustering", 3.132842),
        ("get", 0.23059674),
    ],
    &[
        ("coefficient", 1.8818465),
        ("clustering", 2.1447635),
        ("average", 2.504626),
        ("get", 0.15786798),
    ],
    &[("compatible", 5.67784), ("is", 3.4935286)],
    &[
        ("matrix", 1.8818465),
        ("same", 2.504626),
        ("adjacency", 2.1447635),
    ...
    &[("remove", 3.1142733), ("components", 4.6200852)],
    &[
        ("get", 0.15786798),
        ("components", 2.0380259),
        ("connected", 1.6781633),
        ("number", 1.0461507),
    ],
    &[
    ...
    &[
        ...
        ("number", 1.0461507),
        ("edges", 1.3940061),
        ("undirected", 1.9527974),
    ],
    &[
        ("undirected", 1.4076204),
        ("unique", 1.209658),
        ("number", 0.754089),
        ("get", 0.11379481),
        ("edges", 1.0048311),
    ...
    &[
        ("directed", 1.209658),
        ("get", 0.11379481),
        ("destination", 1.3126677),
        ("node", 0.19213088),
        ("ids", 0.4918833),
    ],
    &[
        ("get", 0.23059674),
        ("destination", 2.6600237),
        ("names", 1.2969041),
    ],
    &[
        ("node", 0.38933897),
    ...
    &[
        ("get", 0.23059674),
        ("ontologies", 3.6584907),
        ("node", 0.38933897),
    ],
    &[("ids", 0.996765), ("get", 0.23059674), ("node", 0.38933897)],
    &[
        ("type", 0.76805127),
        ("get", 0.15786798),
        ("ids", 0.68239164),
    ...
    &[("directed", 3.804298), ("to", 3.7167094)],
    &[
        ("triangular", 3.3415835),
        ("to", 2.3948448),
        ("upper", 3.6584907),
    ],
    &[
    ...
    &[("bidiagonal", 5.67784), ("to", 3.7167094)],
    &[("arrowhead", 5.67784), ("to", 3.7167094)],
    &[("transposed", 5.67784), ("to", 3.7167094)],
    &[("to", 3.7167094), ("complementary", 5.67784)],
    &[("from", 1.0551138), ("csv", 5.67784)],
    &[
        ("isomorphic", 1.132719),
        ("groups", 1.2402983),
        ("get", 0.11379481),
    ...
    &[("diameter", 4.8620534), ("get", 0.3578775)],
    &[
        ("naive", 2.2876692),
        ("weighted", 1.1048255),
        ("get", 0.15786798),
    ...
    &[("tendrils", 5.1860123), ("drop", 3.804298)],
    &[
        ("drop", 2.451282),
        ("dendritic", 3.3415835),
        ("trees", 3.3415835),
    ...
    &[("drop", 3.804298), ("selfloops", 3.6364288)],
    &[
        ("edges", 2.0362155),
        ("parallel", 2.8524382),
        ("drop", 2.451282),
    ],
    &[("negatives", 5.67784), ("sample", 5.67784)],
    &[("holdout", 4.0077486), ("connected", 3.804298)],
    &[("holdout", 4.0077486), ("random", 3.6364288)],
    &[
        ("label", 1.2402983),
        ("indices", 1.805391),
        ("get", 0.11379481),
    ...
    &[("dot", 5.67784), ("to", 3.7167094)],
    &[("get", 0.3578775), ("circles", 5.67784)],
    &[("get", 0.3578775), ("tendrils", 5.1860123)],
    &[
        ("community", 1.545994),
        ("detection", 1.805391),
        ("louvain", 1.805391),
    ...
    &[
        ("get", 0.06639686),
        ("community", 0.9020547),
        ("modularity", 0.9621587),
        ("node", 0.1121043),
        ("memberships", 0.9621587),
        ("from", 0.19575481),
        ("directed", 0.70580983),
    ],
    &[
        ("undirected", 0.82131666),
        ("memberships", 0.9621587),
        ("community", 0.9020547),
        ("from", 0.19575481),
        ("node", 0.1121043),
    ...
    &[
        ("get", 0.23059674),
        ("subsampled", 3.6584907),
        ("nodes", 1.6293217),
    ],
    &[("get", 0.3578775), ("chains", 5.67784)],
    &[
        ("get", 0.23059674),
        ("trees", 3.3415835),
        ("dendritic", 3.3415835),
    ...
    &[
        ("id", 0.37594554),
        ("is", 0.83458483),
        ("connected", 0.90882593),
        ("unchecked", 0.45813867),
        ("from", 0.2520609),
        ("node", 0.1443495),
    ],
    &[
        ("disconnected", 0.8571625),
        ("node", 0.2092568),
        ("id", 0.29196575),
        ("is", 0.6481529),
        ("unchecked", 0.35579836),
    ...
    &[
        ...
        ("random", 0.6746651),
        ("graph", 0.6362398),
        ("transformed", 0.8571625),
        ("laplacian", 0.8571625),
        ("walk", 0.9621587),
        ("normalized", 0.9020547),
    ],
    &[
        ("normalized", 1.1615179),
        ("graph", 0.8192451),
        ("get", 0.085494965),
        ("laplacian", 1.103713),
        ("symmetric", 1.2389098),
        ("transformed", 1.103713),
    ],
    &[
        ("normalized", 1.545994),
        ("transformed", 1.4690549),
        ("symmetric", 1.6490036),
        ("get", 0.11379481),
        ("graph", 1.0904249),
    ],
    &[
        ...
        ("node", 0.1443495),
        ("outbound", 1.103713),
        ("increasing", 1.2389098),
    ],
    &[
        ("decreasing", 1.2389098),
        ("outbound", 1.103713),
        ("by", 0.9862179),
        ("degree", 0.733526),
        ("sort", 1.103713),
    ...
    &[
        ("arborescence", 2.2876692),
        ("kruskal", 2.2876692),
        ("spanning", 2.1447635),
        ("random", 1.6041124),
    ],
    &[
        ("arborescence", 3.3415835),
        ("kruskal", 3.3415835),
        ("spanning", 3.132842),
    ],
    &[
