...
impl Tendril {
    ...
    pub fn get_tail_node_id(&self) -> NodeT {
        self.inner.get_tail_node_id().into()
    }
...
pub const TENDRIL_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("tendril", 0.15030715),
        ("node_names", 0.27776715),
        ("first", 0.27776715),
        ("k", 0.27776715),
        ("get", 0.03953595),
    ],
    &[
        ("node_names", 0.61108774),
        ("get", 0.08697909),
        ("tendril", 0.33067572),
    ],
];
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    &[
        ("get", 0.14429973),
        ("laplacian", 1.7823714),
        ("transformed", 1.7823714),
        ("graph", 1.3440026),
    ],
    &[
        ("edges", 0.6723833),
        ("number", 0.5216312),
        ("laplacian", 0.94102156),
        ("get", 0.07618455),
        ("coo", 1.1583283),
        ("matrix", 0.8682852),
    ],
    &[
        ...
        ("laplacian", 0.7250202),
        ("graph", 0.5467037),
        ("normalized", 0.7633199),
        ("walk", 0.81459767),
        ("transformed", 0.7250202),
        ("random", 0.56932265),
    ],
    &[
        ("graph", 0.70958024),
        ("symmetric", 1.0572864),
        ("laplacian", 0.94102156),
        ("transformed", 0.94102156),
        ("normalized", 0.9907318),
        ("get", 0.07618455),
    ],
    &[
        ("graph", 0.95457697),
        ("symmetric", 1.4223356),
        ("get", 0.102488786),
        ("normalized", 1.3328017),
        ("transformed", 1.265928),
    ],
    &[
        ("connected", 1.0404656),
        ("node_id", 0.597414),
    ...
    &[
        ("is", 0.70958024),
        ("node", 0.44408485),
        ("disconnected", 0.94102156),
        ("node_id", 0.44408485),
        ("unchecked", 0.39959076),
        ("from", 0.22324593),
    ],
    &[
        ("from", 0.30032605),
    ...
    &[
        ...
        ("from", 0.17200223),
        ("with", 0.4866735),
        ("singleton", 0.42846745),
        ("selfloops", 0.56932265),
    ],
    &[
        ("node_id", 0.44408485),
        ("from", 0.22324593),
    ...
    &[("node_name", 2.778597), ("has", 2.2274761)],
    &[("node_type_id", 3.589229), ("has", 2.2274761)],
    &[("has", 2.2274761), ("node_type_name", 3.4996517)],
    &[("edge_type_id", 2.9008358), ("has", 2.2274761)],
    &[("has", 2.2274761), ("edge_type_name", 3.3436012)],
    &[
        ("from", 0.42284596),
        ("node_ids", 0.72090435),
        ("edge", 0.8619521),
    ...
    &[
        ("has", 0.9324061),
        ("node_type_name", 1.4649302),
        ("and", 1.3440026),
        ("node_name", 1.1631017),
    ],
    &[
        ("has", 0.9324061),
        ("node_names", 0.94111943),
        ("from", 0.42284596),
        ("edge", 0.8619521),
    ],
    &[
        ("from", 0.22324593),
        ("and", 0.70958024),
        ("node_names", 0.4968738),
        ("edge", 0.45507663),
        ("edge_type_name", 0.73893785),
        ("has", 0.49227354),
    ],
    &[
        ("components", 2.6594133),
        ("connected", 2.1857705),
        ("strongly", 3.273542),
    ],
    &[
        ("increasing", 1.0572864),
        ("sort", 0.94102156),
        ("by", 0.8399797),
        ("outbound", 0.94102156),
        ("node", 0.44408485),
    ...
    &[
        ("sort", 1.265928),
        ("order", 1.4223356),
        ("lexicographic", 1.4223356),
        ("node", 0.597414),
        ("by", 1.1299995),
    ],
    &[
        ("sorting", 0.9907318),
        ("topological", 0.9907318),
        ("bfs", 0.9907318),
        ("node_id", 0.44408485),
        ("get", 0.07618455),
        ("from", 0.22324593),
    ...
    &[("remove", 2.8582075), ("components", 4.2580047)],
    &[("overlaps", 8.949765)],
    &[("contains", 8.16907)],
    &[
        ("get", 0.21530452),
    ...
    &[("encode", 5.24129), ("edge", 2.0591648)],
    &[("decode", 5.24129), ("edge", 2.0591648)],
    &[
        ("encodable", 1.5582643),
        ("max", 1.5582643),
        ("edge", 0.6122009),
    ...
    &[("node_id", 2.0094283), ("validate", 3.6887789)],
    &[("validate", 3.6887789), ("node_ids", 1.7222079)],
    &[("validate", 3.6887789), ("edge_id", 2.6059437)],
    &[("edge_ids", 3.589229), ("validate", 3.6887789)],
    &[
        ("contain", 1.265928),
        ("not", 1.168078),
        ("must", 1.0162585),
        ("node_types", 0.69473183),
        ("unknown", 0.8897501),
    ],
    &[
        ("must", 1.0162585),
        ("edge_types", 0.73174924),
        ("unknown", 0.8897501),
        ("not", 1.168078),
        ("contain", 1.265928),
    ],
    &[("node_type_id", 3.589229), ("validate", 3.6887789)],
    &[("validate", 3.6887789), ("node_type_ids", 3.3436012)],
    &[("edge_type_id", 2.9008358), ("validate", 3.6887789)],
    &[("validate", 3.6887789), ("edge_type_ids", 3.9288816)],
    &[
        ("must", 2.134917),
        ("undirected", 2.5472376),
        ("be", 2.6594133),
    ],
    &[
        ("have", 1.3328017),
    ...
    &[("have", 2.799899), ("must", 2.134917), ("edges", 1.9002169)],
    &[("nodes", 1.5048157), ("have", 2.799899), ("must", 2.134917)],
    &[
        ("connected", 2.1857705),
        ("must", 2.134917),
        ("be", 2.6594133),
    ...
    &[
        ("all", 1.5440974),
        ("edge_types", 1.0302709),
        ("inplace", 1.3190166),
        ("set", 1.7071898),
    ],
    &[
        ("set", 2.5472376),
        ("edge_types", 1.5372308),
        ("all", 2.303893),
    ],
    &[
        ("set", 1.7071898),
        ("node_types", 0.9781521),
        ("all", 1.5440974),
        ("inplace", 1.3190166),
    ],
    &[
        ("all", 2.303893),
        ("node_types", 1.4594662),
        ("set", 2.5472376),
    ],
    &[
        ("inplace", 1.9680581),
        ("remove", 1.7851449),
        ("node_type_ids", 2.0883064),
    ],
    &[
        ("singleton", 1.0533336),
        ("remove", 1.1964259),
    ...
    &[
        ("remove", 1.7851449),
        ("node_type_name", 2.1857705),
        ("inplace", 1.9680581),
    ],
    &[("remove", 2.8582075), ("node_type_id", 3.589229)],
    &[
        ("node_types", 1.4594662),
        ("remove", 1.7851449),
        ("singleton", 1.5716419),
    ...
    &[("node_type_name", 3.4996517), ("remove", 2.8582075)],
    &[
        ("inplace", 1.9680581),
        ("edge_type_name", 2.0883064),
        ("remove", 1.7851449),
    ],
    &[("edge_type_id", 2.9008358), ("remove", 2.8582075)],
    &[
        ("edge_types", 1.5372308),
        ("remove", 1.7851449),
        ("singleton", 1.5716419),
    ],
    &[("edge_type_name", 3.3436012), ("remove", 2.8582075)],
    &[
        ("node_types", 1.4594662),
        ("remove", 1.7851449),
        ("inplace", 1.9680581),
    ],
    &[("remove", 2.8582075), ("node_types", 2.336761)],
    &[
        ("edge_types", 1.5372308),
        ("inplace", 1.9680581),
        ("remove", 1.7851449),
    ],
    &[("edge_types", 2.4612706), ("remove", 2.8582075)],
    &[
        ("inplace", 1.3190166),
        ("edge", 0.8619521),
        ("remove", 1.1964259),
    ...
    &[("get", 0.34472552), ("circles", 5.24129)],
    &[
        ("memory", 2.0883064),
        ("get", 0.21530452),
        ("stats", 3.273542),
    ...
    &[
        ...
        ("weights", 0.43343222),
        ("human", 0.55055773),
        ("requirements", 0.5303738),
        ("readable", 0.55055773),
    ],
    &[
        ("get", 0.102488786),
        ("node_types", 0.69473183),
        ("requirements", 1.168078),
        ("total", 0.99407095),
        ("memory", 0.99407095),
    ],
    &[
        ("readable", 0.69443834),
        ("requirements", 0.66897964),
        ("human", 0.69443834),
        ("memory", 0.56932265),
        ("total", 0.56932265),
        ("node_types", 0.39788565),
        ("get", 0.0586972),
    ],
    &[
        ("edge_types", 0.73174924),
    ...
    &[("get", 0.34472552), ("transitivity", 5.24129)],
    &[
        ("of", 1.0572864),
        ("number", 0.5216312),
        ("triangles", 1.0572864),
    ...
    &[
        ("get", 0.102488786),
        ("per", 1.4223356),
        ("coefficient", 1.168078),
        ("clustering", 1.3328017),
        ("node", 0.597414),
    ],
    &[
        ("coefficient", 2.4538538),
        ("get", 0.21530452),
        ("clustering", 2.799899),
    ],
    &[
        ("get", 0.14429973),
        ("clustering", 1.8765266),
        ("average", 2.1939678),
        ("coefficient", 1.6446028),
    ],
    &[
        ("nodes", 1.5048157),
        ("are", 3.273542),
    ...
    &[("negatives", 5.24129), ("sample", 5.24129)],
    &[("connected", 3.4996517), ("holdout", 3.6887789)],
    &[("random", 3.3436012), ("holdout", 3.6887789)],
    &[
        ("holdout", 1.0966941),
        ("node", 0.597414),
        ("label", 1.0670974),
    ...
    &[
        ("prediction", 2.1939678),
        ("kfold", 1.8765266),
        ("get", 0.14429973),
        ("edge", 0.8619521),
    ],
    &[("chains", 5.24129), ("get", 0.34472552)],
    &[
        ("first", 0.3931543),
        ("unchecked", 0.1980541),
        ("search", 0.3931543),
    ...
    &[("diameter", 4.482937), ("get", 0.34472552)],
    &[
        ("naive", 2.0025864),
        ("weighted", 0.9591784),
        ("diameter", 1.8765266),
    ...
    &[
        ...
        ("selfloops", 0.99407095),
        ("with", 0.8497607),
        ("node_names", 0.66842943),
    ],
    &[("density", 5.24129), ("get", 0.34472552)],
    &[
        ("rate", 1.6446028),
        ("get", 0.14429973),
        ("trap", 1.6446028),
    ...
    &[
        ...
        ("number", 0.9880119),
        ("edges", 1.2735486),
        ("undirected", 1.7071898),
    ],
    &[
        ("undirected", 1.2125304),
        ("number", 0.7017348),
        ("get", 0.102488786),
        ("edges", 0.9045371),
        ("unique", 1.0404656),
    ...
    &[("get", 0.34472552), ("source_names", 5.24129)],
    &[
        ("get", 0.21530452),
        ("destination", 2.4538538),
        ("node_ids", 1.0756359),
    ],
    &[
        ("destination", 1.6446028),
        ("get", 0.14429973),
        ("directed", 1.4649302),
        ("node_ids", 0.72090435),
    ],
    &[("get", 0.34472552), ("destination_names", 5.24129)],
    &[("node_names", 2.2482917), ("get", 0.34472552)],
    &[("urls", 3.273542), ("get", 0.21530452), ("node", 1.2550246)],
    &[
        ("node", 1.2550246),
        ("get", 0.21530452),
        ("ontologies", 3.273542),
    ],
    &[("get", 0.34472552), ("node_ids", 1.7222079)],
    &[("get", 0.34472552), ("edge_type_ids", 3.9288816)],
    &[
        ("edge_type_ids", 2.4538538),
        ("get", 0.21530452),
        ("unique", 2.1857705),
    ],
    &[("get", 0.34472552), ("edge_type_names", 4.078399)],
    &[
        ("unique", 2.1857705),
        ("edge_type_names", 2.5472376),
        ("get", 0.21530452),
    ],
    &[
        ("get", 0.21530452),
    ...
    &[("node_type_ids", 3.3436012), ("get", 0.34472552)],
    &[
        ("node_types", 0.9781521),
        ("mask", 1.6446028),
        ("known", 1.2955934),
    ...
    &[
        ("one", 0.94102156),
        ("encoded", 0.94102156),
        ("edge_types", 0.5439423),
        ("get", 0.07618455),
        ("known", 0.684022),
        ("hot", 0.94102156),
    ],
    &[("get", 0.34472552), ("node_type_names", 3.4182298)],
    &[
        ("node_type_ids", 2.0883064),
        ("get", 0.21530452),
        ("unique", 2.1857705),
    ...
    &[
        ("get", 0.14429973),
        ("degrees", 1.4649302),
        ("cumulative", 2.1939678),
        ("node", 0.8411328),
    ],
    &[
        ("get", 0.14429973),
        ("degrees", 1.4649302),
        ("reciprocal", 1.7823714),
        ("sqrt", 1.7823714),
    ],
    &[
        ("get", 0.102488786),
    ...
    &[
        ("get", 0.14429973),
        ("hashmap", 1.7823714),
        ("edge_type_id", 1.2142699),
        ("counts", 1.7823714),
    ],
    &[
        ("edge_type_names", 1.7071898),
        ("get", 0.14429973),
        ("hashmap", 1.7823714),
        ("counts", 1.7823714),
    ],
    ...
    &[("to", 3.4182298), ("directed", 3.4996517)],
    &[
        ("upper", 3.273542),
        ("to", 2.134917),
        ("triangular", 2.9879885),
    ],
    &[
        ("triangular", 2.9879885),
        ("lower", 3.273542),
    ...
    &[("to", 3.4182298), ("bidiagonal", 5.24129)],
    &[("to", 3.4182298), ("arrowhead", 5.24129)],
    &[("transposed", 5.24129), ("to", 3.4182298)],
    &[("to", 3.4182298), ("complementary", 5.24129)],
    &[("report", 6.964071)],
    &[
        ("report", 2.5472376),
        ("overlap", 3.273542),
    ...
    &[("textual", 4.784088), ("report", 4.078399)],
    &[
        ("connected", 1.4649302),
        ("generate", 1.4308475),
        ("random", 1.3996084),
    ...
    &[("replace", 8.949765)],
    &[("filter", 4.784088), ("from_ids", 5.24129)],
    &[("from_names", 5.24129), ("filter", 4.784088)],
    &[
        ("node_types", 1.4594662),
        ("unknown", 1.8691531),
        ("drop", 2.37386),
    ...
    &[
        ("disconnected", 2.6594133),
        ("nodes", 1.5048157),
        ("drop", 2.37386),
    ],
    &[("selfloops", 3.3436012), ("drop", 3.800803)],
    &[
        ("drop", 2.37386),
        ("parallel", 2.5472376),
        ("edges", 1.9002169),
    ...
    &[
        ("kruskal", 2.0025864),
        ("random", 1.3996084),
        ("arborescence", 2.0025864),
        ("spanning", 1.8765266),
    ],
    &[
        ("kruskal", 2.9879885),
        ("spanning", 2.799899),
        ("arborescence", 2.9879885),
    ],
    &[
        ("connected", 2.1857705),
        ("components", 2.6594133),
    ...
    &[("enable", 8.949765)],
    &[("disable", 5.24129), ("all", 3.6887789)],
    &[("is", 3.2107615), ("compatible", 5.24129)],
    &[
        ("matrix", 1.6446028),
        ("has", 0.9324061),
        ("same", 2.1939678),
    ...
    &[("has", 2.2274761), ("nodes", 2.4093704)],
    &[("edges", 3.0424502), ("has", 2.2274761)],
    &[
        ("trap", 2.4538538),
        ("has", 1.3912103),
        ("nodes", 1.5048157),
    ],
    &[("directed", 3.4996517), ("is", 3.2107615)],
    &[
        ("weights", 2.005339),
        ("has", 1.3912103),
        ("edge", 1.2860883),
    ...
    &[
        ("has", 0.6622408),
        ("weights", 0.95457697),
        ("representing", 1.5582643),
        ("edge", 0.6122009),
        ("probabilities", 1.5582643),
    ],
    &[
        ("nodes", 1.0085459),
        ("weighted", 0.9591784),
    ...
    &[("has", 2.2274761), ("edge_types", 2.4612706)],
    &[("has", 2.2274761), ("selfloops", 3.3436012)],
    &[
        ("disconnected", 2.6594133),
        ("nodes", 1.5048157),
        ("has", 1.3912103),
    ...
    &[("connected", 3.4996517), ("is", 3.2107615)],
    &[("node_types", 2.336761), ("has", 2.2274761)],
    &[
        ("has", 1.3912103),
        ("multilabel", 2.9879885),
        ("node_types", 1.4594662),
    ],
    &[
        ("has", 1.3912103),
    ...
    &[("is", 3.2107615), ("multigraph", 4.482937)],
    &[
        ("decreasing", 0.6458213),
        ("outbound", 0.5748033),
        ("has", 0.30069497),
        ("nodes", 0.32524955),
        ("by", 0.513084),
    ...
    &[
        ("edge_type_id", 0.8624343),
        ("edge_type_name", 0.99407095),
        ("get", 0.102488786),
        ("from", 0.30032605),
        ("unchecked", 0.5375574),
    ],
    ...
    &[
        ("node_ids", 0.15603088),
        ("edge_type_id", 0.26281378),
        ("edge", 0.18655895),
        ("edge_id", 0.23609675),
        ("get", 0.0312319),
        ("and", 0.56350803),
        ("unchecked", 0.16381247),
        ("weight", 0.30968934),
        ("from", 0.0915198),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.0586972),
        ("from", 0.17200223),
        ("comulative", 0.81459767),
    ],
    &[
        ("node", 0.44408485),
        ("comulative", 1.0572864),
        ("node_id", 0.44408485),
        ("get", 0.07618455),
        ("from", 0.22324593),
        ("degree", 0.62267303),
    ...
    &[
        ...
        ("get", 0.102488786),
        ("unchecked", 0.5375574),
        ("node_type_ids", 0.99407095),
    ],
    &[
        ("get", 0.14429973),
        ("node_type_ids", 1.3996084),
        ("node_id", 0.8411328),
        ("from", 0.42284596),
    ],
    &[
    ...
    &[("tendrils", 5.24129), ("get", 0.34472552)],
    &[
        ("distribution", 1.1583283),
        ("get", 0.07618455),
        ("node", 0.44408485),
        ("threshold", 1.1583283),
        ("degree", 0.62267303),
    ...
    &[("add", 5.24129), ("selfloops", 3.3436012)],
    &[
        ("centrality", 1.8691531),
        ("get", 0.21530452),
        ("degree", 1.7597313),
    ],
    &[
        ("degree", 1.1793934),
        ("centrality", 1.2527293),
        ("weighted", 0.9591784),
        ("get", 0.14429973),
    ],
    &[
        ("unchecked", 0.39959076),
        ("closeness", 0.94102156),
        ("from", 0.22324593),
        ("get", 0.07618455),
        ("node_id", 0.44408485),
        ("centrality", 0.6613915),
    ],
    &[
        ("get", 0.0586972),
        ("weighted", 0.39016765),
        ("centrality", 0.5095762),
        ("unchecked", 0.307869),
        ("node_id", 0.34214994),
        ("closeness", 0.7250202),
        ("from", 0.17200223),
    ...
    &[
        ("centrality", 1.8691531),
        ("get", 0.21530452),
        ("betweenness", 2.5472376),
    ],
    &[
        ("get", 0.07618455),
        ("betweenness", 0.9013287),
        ("approximated", 0.9013287),
        ("node_id", 0.44408485),
        ("from", 0.22324593),
        ("centrality", 0.6613915),
    ],
    ...
    &[
        ("betweenness", 0.69443834),
        ("from", 0.17200223),
        ("weighted", 0.39016765),
        ("centrality", 0.5095762),
        ("node_id", 0.34214994),
        ("approximated", 0.69443834),
        ("get", 0.0586972),
    ],
    &[
        ("node_name", 0.4731181),
    ...
    &[
        ("get", 0.21530452),
        ("centrality", 1.8691531),
        ("eigenvector", 2.9879885),
    ],
    &[
        ("weighted", 0.9591784),
        ("centrality", 1.2527293),
        ("get", 0.14429973),
        ("eigenvector", 2.0025864),
    ],
    &[("dot", 5.24129), ("to", 3.4182298)],
    &[("stars", 5.24129), ("get", 0.34472552)],
    &[
        ("detection", 1.5582643),
        ("undirected", 1.2125304),
        ("community", 1.3328017),
    ...
    &[
        ("directed", 0.59589374),
        ("modularity", 0.81459767),
        ("node", 0.34214994),
        ("from", 0.17200223),
        ("get", 0.0586972),
        ("community", 0.7633199),
        ("memberships", 0.81459767),
    ],
    &[
        ("get", 0.0586972),
        ("node", 0.34214994),
        ("community", 0.7633199),
        ("memberships", 0.81459767),
        ("undirected", 0.69443834),
        ("from", 0.17200223),
        ("modularity", 0.81459767),
    ],
    &[
        ("get", 0.102488786),
        ("preferential", 1.0404656),
        ("attachment", 1.0404656),
        ("minimum", 1.1299995),
        ("unchecked", 0.5375574),
    ],
    &[
    ...
    &[
        ...
        ("unchecked", 0.39959076),
        ("minimum", 0.8399797),
        ("attachment", 0.77342516),
        ("weighted", 0.5064082),
        ("preferential", 0.77342516),
    ],
    &[
        ("weighted", 0.5064082),
        ("preferential", 0.77342516),
    ...
    &[
        ("node_ids", 0.29324427),
        ("get", 0.0586972),
        ("preferential", 0.59589374),
        ("attachment", 0.59589374),
        ("unchecked", 0.307869),
        ("from", 0.17200223),
        ("weighted", 0.39016765),
    ],
    ...
    &[
        ...
        ("node_ids", 0.29324427),
        ("index", 0.6111463),
        ("allocation", 0.66897964),
        ("unchecked", 0.307869),
    ],
    &[
        ("allocation", 0.5303738),
        ("weighted", 0.30932885),
        ("unchecked", 0.24408165),
        ("resource", 0.5303738),
        ("index", 0.4845229),
    ...
    &[
        ("nodes", 1.5048157),
        ("has", 1.3912103),
        ("isomorphic", 2.6594133),
    ],
    &[("from", 1.0101599), ("csv", 5.24129)],
];
