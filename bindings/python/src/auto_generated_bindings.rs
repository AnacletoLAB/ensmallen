...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("graph", 0.6510294),
        ("laplacian", 0.8737429),
        ("normalized", 0.9189991),
        ("random", 0.68976617),
        ("transformed", 0.8737429),
        ("walk", 0.97959024),
    ],
    &[
        ("get", 0.08538527),
        ("graph", 0.837922),
        ("laplacian", 1.1245704),
        ("normalized", 1.1828184),
        ("symmetric", 1.2608036),
        ("transformed", 1.1245704),
    ],
    &[
        ("get", 0.11358292),
        ("graph", 1.1146375),
        ("normalized", 1.5734326),
        ("symmetric", 1.6771716),
        ("transformed", 1.4959487),
    ],
    &[
        ("connected", 0.9281896),
        ("from", 0.24343559),
    ...
    &[
        ...
        ("node", 0.08649656),
        ("selfloops", 0.5504032),
        ("singleton", 0.41759253),
        ("unchecked", 0.29009223),
        ("with", 0.4724743),
    ],
    &[
        ("from", 0.189139),
    ...
    &[("has", 1.5430785), ("name", 1.470346), ("node", 0.37536395)],
    &[
        ("has", 1.057585),
        ("id", 0.6979871),
        ("node", 0.2572645),
    ...
    &[("components", 4.6881714), ("remove", 3.1770134)],
    &[("overlaps", 9.389754)],
    &[("contains", 8.583702)],
    &[
        ("bipartite", 3.3921664),
    ...
    &[("edge", 1.26524), ("encode", 5.7496824)],
    &[("decode", 5.7496824), ("edge", 1.26524)],
    &[
        ("edge", 0.40372542),
        ("encodable", 1.8346663),
        ("get", 0.11358292),
    ...
    &[
        ...
        ("must", 1.6370498),
        ("node", 0.2572645),
        ("ontologies", 1.9879253),
    ],
    &[
        ("be", 3.0256338),
        ("must", 2.3885515),
        ("undirected", 2.9004993),
    ],
    &[
        ("have", 1.4959487),
        ("must", 1.1809593),
    ...
    &[("circles", 5.7496824), ("get", 0.35595885)],
    &[
        ("get", 0.22972733),
        ("memory", 2.3885515),
        ("stats", 3.7107077),
    ...
    &[("get", 0.35595885), ("transitivity", 5.7496824)],
    &[
        ("get", 0.08538527),
        ("node", 0.13951562),
        ("number", 0.564167),
    ...
    &[
        ("clustering", 1.5734326),
        ("coefficient", 1.382574),
        ("get", 0.11358292),
        ("node", 0.18558927),
        ("per", 1.6771716),
    ],
    &[
        ("clustering", 3.182349),
        ("coefficient", 2.7963276),
        ("get", 0.22972733),
    ],
    &[
        ("average", 2.5432205),
        ("clustering", 2.1810975),
        ("coefficient", 1.9165287),
        ("get", 0.15744902),
    ],
    &[
        ("are", 3.7107077),
        ("nodes", 1.6554863),
        ("remappable", 3.7107077),
    ],
    &[
        ("from", 0.32382777),
        ("ids", 0.49541032),
    ...
    &[("negatives", 5.7496824), ("sample", 5.7496824)],
    &[("connected", 3.8694882), ("holdout", 4.073661)],
    &[("holdout", 4.073661), ("random", 3.7010226)],
    &[
        ("get", 0.11358292),
        ("holdout", 1.2998645),
        ("indices", 1.8346663),
    ...
    &[("chains", 5.7496824), ("get", 0.35595885)],
    &[
        ("breadth", 0.39954263),
        ("first", 0.39954263),
        ("from", 0.10223282),
        ...
        ("node", 0.05859076),
        ("parallel", 0.45274052),
        ("predecessors", 0.57920635),
        ("search", 0.39954263),
        ("unchecked", 0.19650173),
    ],
    &[
        ("breadth", 0.39954263),
        ("distances", 0.49673456),
        ("first", 0.39954263),
        ("from", 0.10223282),
        ("get", 0.035858262),
        ("ids", 0.15640165),
    ...
    &[
        ("and", 0.30223885),
        ("distant", 0.44653514),
        ("eccentricity", 0.3681006),
        ("from", 0.086216874),
        ("get", 0.030240653),
        ("id", 0.2595959),
        ("most", 0.39828584),
        ("node", 0.095682),
        ("unchecked", 0.16571747),
    ],
    &[
        ("eccentricity", 0.8075238),
        ("from", 0.189139),
        ("get", 0.066340685),
        ("id", 0.29409483),
        ("node", 0.10839764),
    ...
    &[("diameter", 5.256108), ("get", 0.35595885)],
    &[
        ("breadth", 0.73918617),
        ("first", 0.73918617),
        ("from", 0.189139),
    ...
    &[("density", 5.7496824), ("get", 0.35595885)],
    &[
        ("get", 0.15744902),
        ("nodes", 1.1346264),
        ("rate", 1.9165287),
    ...
    &[
        ...
        ("get", 0.15744902),
        ("number", 1.0403146),
        ("undirected", 1.9879253),
    ],
    &[
        ("edges", 0.98632944),
        ("get", 0.11358292),
        ("number", 0.7504776),
        ("undirected", 1.4340792),
        ("unique", 1.234715),
    ],
    &[
        ("edges", 1.9949024),
    ...
    &[
        ("destination", 1.8553696),
        ("get", 0.15744902),
        ("ids", 0.6867395),
        ("node", 0.2572645),
    ],
    &[
        ("destination", 1.338454),
        ("directed", 1.0284376),
        ("get", 0.11358292),
        ("ids", 0.49541032),
        ("node", 0.18558927),
    ...
    &[("directed", 3.223033), ("to", 3.7815886)],
    &[
        ("to", 2.4405468),
        ("triangular", 3.3921664),
        ("upper", 3.7107077),
    ],
    &[
        ("lower", 3.7107077),
    ...
    &[("bidiagonal", 5.7496824), ("to", 3.7815886)],
    &[("arrowhead", 5.7496824), ("to", 3.7815886)],
    &[("to", 3.7815886), ("transposed", 5.7496824)],
    &[("complementary", 5.7496824), ("to", 3.7815886)],
    &[
        ("approximated", 2.497275),
        ("cliques", 3.3921664),
        ("get", 0.22972733),
    ],
    &[
    ...
    &[("report", 4.494278), ("textual", 5.256108)],
    &[
        ("connected", 1.7115661),
        ("generate", 1.672686),
        ("graph", 1.5451143),
    ...
    &[("drop", 3.8694882), ("tendrils", 5.256108)],
    &[
        ("dendritic", 3.3921664),
        ("drop", 2.497275),
        ("trees", 3.3921664),
    ...
    &[
        ("disconnected", 3.0256338),
        ("drop", 2.497275),
        ("nodes", 1.6554863),
    ],
    &[("drop", 3.8694882), ("selfloops", 3.7010226)],
    &[
        ("drop", 2.497275),
        ("edges", 1.9949024),
        ("parallel", 2.9004993),
    ...
    &[
        ("arborescence", 2.3249009),
        ("kruskal", 2.3249009),
        ("random", 1.6370498),
        ("spanning", 2.1810975),
    ],
    &[
        ("arborescence", 3.3921664),
        ("kruskal", 3.3921664),
        ("spanning", 3.182349),
    ],
    &[
    ...
    &[("enable", 9.389754)],
    &[("all", 4.073661), ("disable", 5.7496824)],
    &[("compatible", 5.7496824), ("is", 3.5576148)],
    &[
        ("adjacency", 2.1810975),
        ("has", 1.057585),
        ("matrix", 1.9165287),
    ...
    &[("has", 2.3909757), ("nodes", 2.5651498)],
    &[("edges", 3.0910697), ("has", 2.3909757)],
    &[
        ("has", 1.5430785),
        ("nodes", 1.6554863),
        ("trap", 2.7963276),
    ],
    &[("directed", 3.223033), ("is", 3.5576148)],
    &[
        ("edge", 0.81655556),
        ("has", 1.5430785),
        ("weights", 2.2154257),
    ...
    &[
        ("edge", 0.40372542),
        ("has", 0.7629364),
        ("probabilities", 1.8346663),
        ("representing", 1.8346663),
        ("weights", 1.0953616),
    ],
    &[
        ("has", 1.057585),
    ...
    &[("has", 2.3909757), ("selfloops", 3.7010226)],
    &[
        ("disconnected", 3.0256338),
        ("has", 1.5430785),
        ("nodes", 1.6554863),
    ...
    &[("connected", 3.8694882), ("is", 3.5576148)],
    &[
        ("has", 1.5430785),
        ("node", 0.37536395),
        ("types", 1.2838423),
    ...
    &[("is", 3.5576148), ("multigraph", 4.9309993)],
    &[
        ("has", 1.5430785),
        ("node", 0.37536395),
        ("ontologies", 2.9004993),
    ...
    &[("get", 0.35595885), ("tendrils", 5.256108)],
    &[
        ("degree", 0.7515459),
        ("distribution", 1.3791993),
        ("geometric", 1.3791993),
        ("get", 0.08538527),
        ("node", 0.13951562),
        ("threshold", 1.3791993),
    ...
    &[("add", 5.7496824), ("selfloops", 3.7010226)],
    &[
        ("centrality", 2.1440816),
        ("degree", 2.022019),
        ("get", 0.22972733),
    ],
    &[
        ("centrality", 1.4694966),
        ("degree", 1.3858382),
        ("get", 0.15744902),
        ("weighted", 1.1453116),
    ],
    &[
        ("centrality", 0.6191681),
        ("closeness", 0.8737429),
        ("from", 0.189139),
        ("get", 0.066340685),
        ("id", 0.29409483),
    ...
    &[
        ("betweenness", 2.9004993),
        ("centrality", 2.1440816),
        ("get", 0.22972733),
    ],
    &[
        ("approximated", 0.7211634),
        ("betweenness", 0.83760655),
        ("centrality", 0.6191681),
        ("from", 0.189139),
        ("get", 0.066340685),
        ("id", 0.29409483),
    ...
    &[
        ("approximated", 0.57545674),
        ("betweenness", 0.6683733),
        ("centrality", 0.49406898),
        ("from", 0.15092461),
        ("get", 0.052936956),
        ("id", 0.23467478),
    ...
    &[
        ("centrality", 2.1440816),
        ("eigenvector", 3.3921664),
        ("get", 0.22972733),
    ],
    &[
        ("centrality", 1.4694966),
        ("eigenvector", 2.3249009),
        ("get", 0.15744902),
        ("weighted", 1.1453116),
    ],
    &[("dot", 5.7496824), ("to", 3.7815886)],
    &[("get", 0.35595885), ("stars", 5.7496824)],
    &[
        ("community", 1.5734326),
        ("detection", 1.8346663),
        ("get", 0.11358292),
    ...
    &[
        ...
        ("from", 0.189139),
        ("get", 0.066340685),
        ("memberships", 0.97959024),
        ("modularity", 0.97959024),
        ("node", 0.10839764),
    ],
    &[
        ("community", 0.9189991),
        ...
        ("modularity", 0.97959024),
        ("node", 0.10839764),
        ("undirected", 0.83760655),
    ],
    &[
        ("attachment", 1.234715),
        ("get", 0.11358292),
        ("minimum", 1.338454),
        ("preferential", 1.234715),
        ("unchecked", 0.62242943),
    ],
    &[
        ("attachment", 1.234715),
    ...
    &[
        ("attachment", 0.9281896),
        ("get", 0.08538527),
        ("minimum", 1.0061748),
        ("preferential", 0.9281896),
        ("unchecked", 0.4679076),
        ("weighted", 0.62110734),
    ],
    &[
    ...
    &[
        ("attachment", 0.7211634),
        ("from", 0.189139),
        ("get", 0.066340685),
        ("ids", 0.2893557),
        ("node", 0.10839764),
        ("preferential", 0.7211634),
        ("unchecked", 0.3635441),
    ],
    &[
        ("attachment", 0.9281896),
    ...
    &[
        ("attachment", 0.57545674),
        ("from", 0.15092461),
        ("get", 0.052936956),
        ("ids", 0.23089315),
        ("node", 0.08649656),
        ("preferential", 0.57545674),
        ("unchecked", 0.29009223),
        ("weighted", 0.38507265),
    ],
    &[
