...
to_ndarray_1d!(gil, self.inner.get_first_k_chain_node_ids(k.into()), NodeT)
    ...
    /// 
            ...
            self.inner.get_first_k_chain_node_names(k.into()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
...
to_ndarray_1d!(gil, self.inner.get_first_k_circle_node_ids(k.into()), NodeT)
    ...
    /// 
            ...
            self.inner.get_first_k_circle_node_names(k.into()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
...
to_ndarray_1d!(gil, self.inner.get_dentritic_trees_node_ids(), NodeT)
    ...
    /// 
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_first_k_dentritic_trees_node_ids(k.into()), NodeT)
            }
    ...
    /// 
            ...
            self.inner.get_first_k_dentritic_trees_node_names(k.into()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
...
impl Graph {
    ...
    /// If the given node ID does not exists in the graph this method will panic.
            ...
            self.inner.is_unchecked_connected_from_node_id(node_id.into()).into()
            }
    ...
    /// If the given node ID does not exists in the graph this method will panic.
            ...
            self.inner.is_unchecked_disconnected_node_from_node_id(node_id.into()).into()
            }
    ...
    /// If the given node ID does not exists in the graph this method will panic.
            ...
            self.inner.is_unchecked_singleton_from_node_id(node_id.into()).into()
            }
    ...
    /// 
            ...
            self.inner.is_unchecked_singleton_with_selfloops_from_node_id(node_id.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.is_singleton_with_selfloops_from_node_id(node_id.into()))?.into())
            }
    ...
    /// If the given node name does not exist in the graph this method will panic.
            ...
            self.inner.is_unchecked_singleton_from_node_name(node_name.into()).into()
            }
    ...
    /// 
            ...
            self.inner.has_edge_from_node_ids(src.into(), dst.into()).into()
            }
    ...
    /// 
            ...
            self.inner.has_edge_from_node_ids_and_edge_type_id(src.into(), dst.into(), edge_type.into()).into()
            }
    ...
    /// If the given node ID does not exists in the graph this method will panic.
            ...
            self.inner.is_unchecked_trap_node_from_node_id(node_id.into()).into()
            }
    ...
    /// 
            ...
            self.inner.has_node_name_and_node_type_name(node_name.into(), node_type_name.into()).into()
            }
    ...
    /// 
            ...
            self.inner.has_edge_from_node_names(src_name.into(), dst_name.into()).into()
            }
    ...
    /// 
            ...
            self.inner.has_edge_from_node_names_and_edge_type_name(src_name.into(), dst_name.into(), edge_type_name.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.has_edge_from_node_id_and_edge_type_id(src.into(), edge_type_id.into()))?.into())
            }
    ...
    /// When
            ...
            self.inner.has_unchecked_edge_from_node_id_and_edge_type_id(src.into(), edge_type_id.into()).into()
            }
...
let result_array = ThreadDataRaceAware {t: PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)};
...
to_ndarray_1d!(gil, subresult_1, WeightT)})
    ...
    /// 
            pub fn get_cooccurrence_coo_matrix(&self, window_size: usize, node_ids_of_interest: Option<Vec<NodeT>>, py_kwargs: Option<&PyDict>)-> PyResult<(Py<PyArray2<NodeT>>, Py<PyArray1<WeightT>>)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_cooccurrence_coo_matrix(&{
...
}, window_size.into(), node_ids_of_interest.as_ref()))?.into();
({
// Warning: this copies the array so it uses double the memory.
// To avoid this you should directly generate data compatible with a numpy array
// Which is a flat vector with row-first or column-first unrolling
...
to_ndarray_1d!(gil, subresult_1, WeightT)})})
    ...
    ///     Whether to normalize the random walks by the node degree.
    /// 
            pub fn get_cooccurrence_graph(&self, window_size: usize, node_ids_of_interest: Option<Vec<NodeT>>, py_kwargs: Option<&PyDict>)-> PyResult<Graph>{
...
build_walk_parameters(kwargs)?
    ...
    ///     Whether to normalize the random walks by the node degree.
    /// 
            pub fn get_normalized_cooccurrence_coo_matrix(&self, window_size: usize, node_ids_of_interest: Option<Vec<NodeT>>, py_kwargs: Option<&PyDict>)-> PyResult<(Py<PyArray2<NodeT>>, Py<PyArray1<WeightT>>)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_normalized_cooccurrence_coo_matrix(&{
let py = pyo3::Python::acquire_gil();
let kwargs = normalize_kwargs!(py_kwargs, py.python());
pe!(validate_kwargs(
    kwargs,
...
to_ndarray_1d!(gil, subresult_1, WeightT)})})
    ...
    ///     Whether to normalize the random walks by the node degree.
    /// 
            pub fn get_normalized_cooccurrence_graph(&self, window_size: usize, node_ids_of_interest: Option<Vec<NodeT>>, py_kwargs: Option<&PyDict>)-> PyResult<Graph>{
...
build_walk_parameters(kwargs)?
    ...
    ///     Whether to normalize the random walks by the node degree.
    /// 
            pub fn get_log_normalized_cooccurrence_coo_matrix(&self, window_size: usize, node_ids_of_interest: Option<Vec<NodeT>>, py_kwargs: Option<&PyDict>)-> PyResult<(Py<PyArray2<NodeT>>, Py<PyArray1<WeightT>>)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_log_normalized_cooccurrence_coo_matrix(&{
let py = pyo3::Python::acquire_gil();
let kwargs = normalize_kwargs!(py_kwargs, py.python());
pe!(validate_kwargs(
    kwargs,
...
to_ndarray_1d!(gil, subresult_1, WeightT)})})
    ...
    ///     Whether to normalize the random walks by the node degree.
    /// 
            pub fn get_log_normalized_cooccurrence_graph(&self, window_size: usize, node_ids_of_interest: Option<Vec<NodeT>>, py_kwargs: Option<&PyDict>)-> PyResult<Graph>{
...
to_ndarray_1d!(gil, pe!(self.inner.get_bfs_topological_sorting_from_node_id(root_node_id.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_reversed_bfs_topological_sorting_from_node_id(root_node_id.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.sort_by_bfs_topological_sorting_from_node_id(root_node_id.into()))?.into())
            }
    ...
    /// 
            pub fn remove_components(&self, node_names: Option<Vec<String>>, node_types: Option<Vec<Option<String>>>, edge_types: Option<Vec<Option<String>>>, minimum_component_size: Option<NodeT>, top_k_components: Option<NodeT>, verbose: Option<bool>)-> PyResult<Graph>{
            Ok(pe!(self.inner.remove_components(node_names.into(), node_types.into(), edge_types.into(), minimum_component_size.into(), top_k_components.into(), verbose.into()))?.into())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_bipartite_edges(removed_existing_edges.into(), first_nodes_set.into(), second_nodes_set.into(), first_node_types_set.into(), second_node_types_set.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_bipartite_edge_names(removed_existing_edges.into(), first_nodes_set.into(), second_nodes_set.into(), first_node_types_set.into(), second_node_types_set.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_star_edges(central_node.into(), removed_existing_edges.into(), star_points_nodes_set.into(), star_points_node_types_set.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_star_edge_names(central_node.into(), removed_existing_edges.into(), star_points_nodes_set.into(), star_points_node_types_set.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, self.inner.get_clique_edges(directed.into(), allow_selfloops.into(), removed_existing_edges.into(), allow_node_type_set.into(), allow_node_set.into()), NodeT)
            }
    ...
    /// 
            ...
            self.inner.get_clique_edge_names(directed.into(), allow_selfloops.into(), removed_existing_edges.into(), allow_node_type_set.into(), allow_node_set.into()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
...
(subresult_0.into(), subresult_1.into())
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.validate_node_ids(node_ids.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.validate_edge_ids(edge_ids.into()))?, EdgeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.validate_node_type_ids(node_type_ids.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.validate_edge_type_ids(edge_type_ids.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.generate_new_edges_from_node_features(features.into(), neighbours_number.into(), max_degree.into(), distance_name.into(), verbose.into()))?.into())
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_node_type_ids(node_type_ids_to_remove.into()))?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.add_node_type_id_from_node_name_prefixes_inplace(node_type_id.into(), node_name_prefixes.into()))?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.replace_edge_type_id_from_edge_node_type_ids_inplace(edge_type_id.into(), source_node_type_ids.into(), destination_node_type_ids.into()))?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.replace_edge_type_id_from_edge_node_type_ids(edge_type_id.into(), source_node_type_ids.into(), destination_node_type_ids.into()))?;()})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.add_node_type_id_from_node_name_prefixes(node_type_id.into(), node_name_prefixes.into()))?.into())
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.add_node_type_name_from_node_name_prefixes_inplace(node_type_name.into(), node_name_prefixes.into()))?;()})
            }
    ...
    ///     If the given list of node name prefixes is empty.
    /// 
            pub fn replace_edge_type_name_from_edge_node_type_names_inplace(& mut self, edge_type_name: String, source_node_type_names: Vec<Option<String>>, destination_node_type_names: Vec<Option<String>>)-> PyResult<()>{
            Ok({pe!(self.inner.replace_edge_type_name_from_edge_node_type_names_inplace(edge_type_name.into(), source_node_type_names.into(), destination_node_type_names.into()))?;()})
            }
    ...
    ///     If the given list of node name prefixes is empty.
    /// 
            pub fn replace_edge_type_name_from_edge_node_type_names(& mut self, edge_type_name: String, source_node_type_names: Vec<Option<String>>, destination_node_type_names: Vec<Option<String>>)-> PyResult<()>{
            Ok({pe!(self.inner.replace_edge_type_name_from_edge_node_type_names(edge_type_name.into(), source_node_type_names.into(), destination_node_type_names.into()))?;()})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.add_node_type_name_from_node_name_prefixes(node_type_name.into(), node_name_prefixes.into()))?.into())
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_edge_type_ids(edge_type_ids_to_remove.into()))?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_node_type_names(node_type_names.into()))?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_node_type_name(node_type_name.into()))?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_isomorphic_edge_types(minimum_number_of_edges.into()))?;()})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.remove_isomorphic_edge_types(minimum_number_of_edges.into()))?.into())
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_edge_type_name(edge_type_name.into()))?;()})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.build_bipartite_graph_from_edge_node_ids(source_node_ids.into(), destination_node_ids.into(), directed.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.build_clique_graph_from_node_ids(node_ids.into(), directed.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.build_bipartite_graph_from_edge_node_names(source_node_names.into(), destination_node_names.into(), directed.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.build_clique_graph_from_node_names(node_names.into(), directed.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.build_bipartite_graph_from_edge_node_prefixes(source_node_prefixes.into(), destination_node_prefixes.into(), directed.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.build_clique_graph_from_node_prefixes(node_prefixes.into(), directed.into()))?.into())
            }
    ...
    ///     Whether to make the graph directed or undirected.
    /// 
            pub fn build_bipartite_graph_from_edge_node_types(&self, source_node_types: Vec<Option<String>>, destination_node_types: Vec<Option<String>>, directed: bool)-> PyResult<Graph>{
            Ok(pe!(self.inner.build_bipartite_graph_from_edge_node_types(source_node_types.into(), destination_node_types.into(), directed.into()))?.into())
            }
    ...
    ///     Whether to make the graph directed or undirected.
    /// 
            pub fn build_clique_graph_from_node_types(&self, node_types: Vec<Option<String>>, directed: bool)-> PyResult<Graph>{
            Ok(pe!(self.inner.build_clique_graph_from_node_types(node_types.into(), directed.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_circles(minimum_number_of_nodes_per_circle.into(), compute_circle_nodes.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_number_of_triangles(&self, normalize: Option<bool>, low_centrality: Option<usize>, verbose: Option<bool>)-> EdgeT{
            self.inner.get_number_of_triangles(normalize.into(), low_centrality.into(), verbose.into()).into()
            }
    ...
    /// 
            ...
            self.inner.get_transitivity(low_centrality.into(), verbose.into()).into()
            }
    ...
    ///     Whether to show a loading bar.
    /// 
            pub fn get_number_of_triangles_per_node(&self, normalize: Option<bool>, low_centrality: Option<usize>, verbose: Option<bool>)-> Py<PyArray1<NodeT>>{
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_number_of_triangles_per_node(normalize.into(), low_centrality.into(), verbose.into()), NodeT)
            }
    ...
    /// 
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_clustering_coefficient_per_node(low_centrality.into(), verbose.into()), f64)
            }
    ...
    /// 
            ...
            self.inner.get_clustering_coefficient(low_centrality.into(), verbose.into()).into()
            }
    ...
    /// 
            ...
            self.inner.get_average_clustering_coefficient(low_centrality.into(), verbose.into()).into()
            }
    ...
    ///  * Not available for each of the node IDs of the graph.
            ...
            self.inner.remap_unchecked_from_node_ids(node_ids.into()).into()
            }
    ...
    /// 
            pub fn sample_negative_graph(&self, number_of_negative_samples: EdgeT, random_state: Option<EdgeT>, only_from_same_component: Option<bool>, sample_only_edges_with_heterogeneous_node_types: Option<bool>, minimum_node_degree: Option<NodeT>, maximum_node_degree: Option<NodeT>, source_node_types_names: Option<Vec<String>>, destination_node_types_names: Option<Vec<String>>, source_edge_types_names: Option<Vec<String>>, destination_edge_types_names: Option<Vec<String>>, source_nodes_prefixes: Option<Vec<String>>, destination_nodes_prefixes: Option<Vec<String>>, graph_to_avoid: Option<& Graph>, support: Option<& Graph>, use_scale_free_distribution: Option<bool>)-> PyResult<Graph>{
            Ok(pe!(self.inner.sample_negative_graph(number_of_negative_samples.into(), random_state.into(), only_from_same_component.into(), sample_only_edges_with_heterogeneous_node_types.into(), minimum_node_degree.into(), maximum_node_degree.into(), source_node_types_names.into(), destination_node_types_names.into(), source_edge_types_names.into(), destination_edge_types_names.into(), source_nodes_prefixes.into(), destination_nodes_prefixes.into(), graph_to_avoid.map(|sg| &sg.inner), support.map(|sg| &sg.inner), use_scale_free_distribution.into()))?.into())
            }
    ...
    ///     If the `sample_only_edges_with_heterogeneous_node_types` argument is provided as true, but the graph does not have node types.
    /// 
            pub fn sample_positive_graph(&self, number_of_samples: usize, random_state: Option<EdgeT>, sample_only_edges_with_heterogeneous_node_types: Option<bool>, minimum_node_degree: Option<NodeT>, maximum_node_degree: Option<NodeT>, source_node_types_names: Option<Vec<String>>, destination_node_types_names: Option<Vec<String>>, source_edge_types_names: Option<Vec<String>>, destination_edge_types_names: Option<Vec<String>>, source_nodes_prefixes: Option<Vec<String>>, destination_nodes_prefixes: Option<Vec<String>>, edge_type_names: Option<Vec<Option<String>>>, support: Option<& Graph>)-> PyResult<Graph>{
            Ok(pe!(self.inner.sample_positive_graph(number_of_samples.into(), random_state.into(), sample_only_edges_with_heterogeneous_node_types.into(), minimum_node_degree.into(), maximum_node_degree.into(), source_node_types_names.into(), destination_node_types_names.into(), source_edge_types_names.into(), destination_edge_types_names.into(), source_nodes_prefixes.into(), destination_nodes_prefixes.into(), edge_type_names.into(), support.map(|sg| &sg.inner)))?.into())
            }
    ...
    /// 
            pub fn connected_holdout(&self, train_size: f64, random_state: Option<EdgeT>, edge_types: Option<Vec<Option<String>>>, include_all_edge_types: Option<bool>, minimum_node_degree: Option<NodeT>, maximum_node_degree: Option<NodeT>, verbose: Option<bool>)-> PyResult<(Graph, Graph)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.connected_holdout(train_size.into(), random_state.into(), edge_types.into(), include_all_edge_types.into(), minimum_node_degree.into(), maximum_node_degree.into(), verbose.into()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            pub fn random_holdout(&self, train_size: f64, random_state: Option<EdgeT>, include_all_edge_types: Option<bool>, edge_types: Option<Vec<Option<String>>>, min_number_overlaps: Option<EdgeT>, verbose: Option<bool>)-> PyResult<(Graph, Graph)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.random_holdout(train_size.into(), random_state.into(), include_all_edge_types.into(), edge_types.into(), min_number_overlaps.into(), verbose.into()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_node_label_holdout_indices(train_size.into(), use_stratification.into(), random_state.into()))?.into();
({let gil = pyo3::Python::acquire_gil();
...
to_ndarray_1d!(gil, subresult_1, NodeT)})})
    ...
    ///     If stratification is requested but the graph has a multilabel node types.
    /// 
            pub fn get_node_label_holdout_labels(&self, train_size: f64, use_stratification: Option<bool>, random_state: Option<EdgeT>)-> PyResult<(Vec<Option<Vec<NodeTypeT>>>, Vec<Option<Vec<NodeTypeT>>>)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_node_label_holdout_labels(train_size.into(), use_stratification.into(), random_state.into()))?.into();
(subresult_0.into_iter().map(|x| x.into()).collect::<Vec<_>>(), subresult_1.into_iter().map(|x| x.into()).collect::<Vec<_>>())})
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_node_label_holdout_graphs(train_size.into(), use_stratification.into(), random_state.into()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_edge_label_holdout_graphs(train_size.into(), use_stratification.into(), random_state.into()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            pub fn get_random_subgraph(&self, nodes_number: NodeT, random_state: Option<usize>, verbose: Option<bool>)-> PyResult<Graph>{
            Ok(pe!(self.inner.get_random_subgraph(nodes_number.into(), random_state.into(), verbose.into()))?.into())
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_node_label_random_holdout(train_size.into(), use_stratification.into(), random_state.into()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_node_label_kfold(k.into(), k_index.into(), use_stratification.into(), random_state.into()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    ///     If stratification is required but the graph has singleton edge types.
    /// 
            pub fn get_edge_label_random_holdout(&self, train_size: f64, use_stratification: Option<bool>, random_state: Option<EdgeT>)-> PyResult<(Graph, Graph)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_edge_label_random_holdout(train_size.into(), use_stratification.into(), random_state.into()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_edge_label_kfold(k.into(), k_index.into(), use_stratification.into(), random_state.into()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            pub fn get_edge_prediction_kfold(&self, k: usize, k_index: usize, edge_types: Option<Vec<Option<String>>>, random_state: Option<EdgeT>, verbose: Option<bool>)-> PyResult<(Graph, Graph)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_edge_prediction_kfold(k.into(), k_index.into(), edge_types.into(), random_state.into(), verbose.into()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_chains(minimum_number_of_nodes_per_chain.into(), compute_chain_nodes.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// If any of the given node ID does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_breadth_first_search_predecessors_parallel_from_node_id(src_node_id.into()).into()
            }
    ...
    ///  The provided list of node ids must be non-empty, or the method will panic.
            ...
            self.inner.get_unchecked_breadth_first_search_distances_parallel_from_node_ids(src_node_ids.into(), maximal_depth.into()).into()
            }
    ...
    /// If any of the given node ID does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_breadth_first_search_distances_parallel_from_node_id(src_node_id.into(), maximal_depth.into()).into()
            }
    ...
    ///  TODO! Explore chains accelerations!
            ...
            self.inner.get_unchecked_breadth_first_search_distances_sequential_from_node_id(src_node_id.into()).into()
            }
    ...
    /// If any of the given node IDs does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_breadth_first_search_from_node_ids(src_node_ids.into(), dst_node_id.into(), compute_predecessors.into(), maximal_depth.into()).into()
            }
    ...
    /// If any of the given node IDs does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_breadth_first_search_from_node_id(src_node_id.into(), dst_node_id.into(), compute_predecessors.into(), maximal_depth.into()).into()
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_unchecked_shortest_path_node_ids_from_node_ids(src_node_id.into(), dst_node_id.into(), maximal_depth.into()))?, NodeT)})
            }
    ...
    /// If any of the given node IDs does not exist in the graph the method will panic.
            ...
            Ok(pe!(self.inner.get_unchecked_shortest_path_node_names_from_node_ids(src_node_id.into(), dst_node_id.into(), maximal_depth.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_shortest_path_node_ids_from_node_ids(src_node_id.into(), dst_node_id.into(), maximal_depth.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_shortest_path_node_ids_from_node_names(src_node_name.into(), dst_node_name.into(), maximal_depth.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_shortest_path_node_names_from_node_names(src_node_name.into(), dst_node_name.into(), maximal_depth.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// If any of the given node IDs does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_k_shortest_path_node_ids_from_node_ids(src_node_id.into(), dst_node_id.into(), k.into()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_k_shortest_path_node_ids_from_node_ids(src_node_id.into(), dst_node_id.into(), k.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_k_shortest_path_node_ids_from_node_names(src_node_name.into(), dst_node_name.into(), k.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_k_shortest_path_node_names_from_node_names(src_node_name.into(), dst_node_name.into(), k.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// If any of the given node IDs does not exist in the graph the method will panic.
            ...
            let (subresult_0, subresult_1) = self.inner.get_unchecked_eccentricity_and_most_distant_node_id_from_node_id(node_id.into());
(subresult_0.into(), subresult_1.into())
            }
    ...
    /// If any of the given node IDs does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_weighted_eccentricity_from_node_id(node_id.into(), use_edge_weights_as_probabilities.into()).into()
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_eccentricity_and_most_distant_node_id_from_node_id(node_id.into()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_weighted_eccentricity_from_node_id(node_id.into(), use_edge_weights_as_probabilities.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_weighted_eccentricity_from_node_name(node_name.into(), use_edge_weights_as_probabilities.into()))?.into())
            }
    ...
    /// If any of the given node IDs does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_dijkstra_from_node_ids(src_node_ids.into(), maybe_dst_node_id.into(), maybe_dst_node_ids.into(), compute_predecessors.into(), maximal_depth.into(), use_edge_weights_as_probabilities.into()).into()
            }
    ...
    /// If any of the given node IDs does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_dijkstra_from_node_id(src_node_id.into(), maybe_dst_node_id.into(), maybe_dst_node_ids.into(), compute_predecessors.into(), maximal_depth.into(), use_edge_weights_as_probabilities.into()).into()
            }
    ...
    /// If any of the given node IDs does not exist in the graph the method will panic.
            ...
            let (subresult_0, subresult_1) = self.inner.get_unchecked_weighted_shortest_path_node_ids_from_node_ids(src_node_id.into(), dst_node_id.into(), use_edge_weights_as_probabilities.into(), maximal_depth.into());
...
to_ndarray_1d!(gil, subresult_1, NodeT)})
    ...
    /// If any of the given node IDs does not exist in the graph the method will panic.
            ...
            let (subresult_0, subresult_1) = self.inner.get_unchecked_weighted_shortest_path_node_names_from_node_ids(src_node_id.into(), dst_node_id.into(), use_edge_weights_as_probabilities.into(), maximal_depth.into());
(subresult_0.into(), subresult_1.into_iter().map(|x| x.into()).collect::<Vec<_>>())
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_weighted_shortest_path_node_ids_from_node_ids(src_node_id.into(), dst_node_id.into(), use_edge_weights_as_probabilities.into(), maximal_depth.into()))?.into();
(subresult_0.into(), {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_1, NodeT)})})
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_weighted_shortest_path_node_ids_from_node_names(src_node_name.into(), dst_node_name.into(), use_edge_weights_as_probabilities.into(), maximal_depth.into()))?.into();
(subresult_0.into(), {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_1, NodeT)})})
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_weighted_shortest_path_node_names_from_node_names(src_node_name.into(), dst_node_name.into(), use_edge_weights_as_probabilities.into(), maximal_depth.into()))?.into();
(subresult_0.into(), subresult_1.into_iter().map(|x| x.into()).collect::<Vec<_>>())})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_breadth_first_search_from_node_ids(src_node_id.into(), dst_node_id.into(), compute_predecessors.into(), maximal_depth.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_dijkstra_from_node_ids(src_node_id.into(), maybe_dst_node_id.into(), maybe_dst_node_ids.into(), compute_predecessors.into(), maximal_depth.into(), use_edge_weights_as_probabilities.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_diameter_naive(ignore_infinity.into(), verbose.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_diameter(ignore_infinity.into(), verbose.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_breadth_first_search_from_node_names(src_node_name.into(), dst_node_name.into(), compute_predecessors.into(), maximal_depth.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_dijkstra_from_node_names(src_node_name.into(), maybe_dst_node_name.into(), maybe_dst_node_names.into(), compute_predecessors.into(), maximal_depth.into(), use_edge_weights_as_probabilities.into()))?.into())
            }
    ...
    /// 
            ...
            let (subresult_0, subresult_1, subresult_2) = self.inner.get_number_of_connected_components(verbose.into());
...
to_ndarray_1d!(gil, self.inner.get_directed_source_node_ids(), NodeT)
    ...
    /// 
            ...
            self.inner.get_source_names(directed.into()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
    ...
    /// 
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_destination_node_ids(directed.into()), NodeT)
            }
...
to_ndarray_1d!(gil, self.inner.get_directed_destination_node_ids(), NodeT)
    ...
    /// 
            ...
            self.inner.get_destination_names(directed.into()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
            ...
            self.inner.get_node_urls().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
            ...
            self.inner.get_node_ontologies().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
    ...
    /// 
            ...
            self.inner.get_unchecked_ontology_from_node_name(node_name.into()).map(|x| x.into())
            }
    ...
    /// 
            ...
            self.inner.get_unchecked_ontology_from_node_id(node_id.into()).map(|x| x.into())
            }
...
to_ndarray_1d!(gil, self.inner.get_node_ids(), NodeT)
            ...
            Ok(pe!(self.inner.get_directed_edge_type_ids())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
            ...
            Ok(pe!(self.inner.get_undirected_edge_type_ids())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_unique_edge_type_ids())?, EdgeTypeT)})
            ...
            Ok(pe!(self.inner.get_edge_type_names())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_weighted_node_indegrees())?, f64)})
            ...
            Ok(pe!(self.inner.get_node_type_ids())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
...
to_ndarray_2d!(gil, pe!(self.inner.get_one_hot_encoded_known_edge_types())?, bool)})
            ...
            Ok(pe!(self.inner.get_node_type_names())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
...
to_ndarray_2d!(gil, pe!(self.inner.get_directed_edge_triples_ids())?, NodeT)})
    ...
    /// 
            ...
            self.inner.get_edge_node_names(directed.into()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
            ...
            self.inner.get_directed_edge_node_names().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_directed_edge_triples_names())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_singleton_node_type_ids())?, NodeTypeT)})
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_edge_ids_with_unknown_edge_types())?, EdgeT)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_edge_ids_with_known_edge_types())?, EdgeT)})
            }
    ...
    ///     If there are no edge types in the graph.
    /// 
            pub fn get_edge_node_ids_with_unknown_edge_types(&self, directed: bool)-> PyResult<Py<PyArray2<NodeT>>>{
            Ok({
// Warning: this copies the array so it uses double the memory.
// To avoid this you should directly generate data compatible with a numpy array
// Which is a flat vector with row-first or column-first unrolling
let gil = pyo3::Python::acquire_gil();
let body = pe!(self.inner.get_edge_node_ids_with_unknown_edge_types(directed.into()))?;
let result_array = ThreadDataRaceAware {t: PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)};
body.into_par_iter().enumerate()
    .for_each(|(i, (a, b))| unsafe {
        *(result_array.t.uget_mut([i, 0]))  = a;
...
// Which is a flat vector with row-first or column-first unrolling
let gil = pyo3::Python::acquire_gil();
let body = pe!(self.inner.get_edge_node_ids_with_known_edge_types(directed.into()))?;
let result_array = ThreadDataRaceAware {t: PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)};
body.into_par_iter().enumerate()
    .for_each(|(i, (a, b))| unsafe {
        *(result_array.t.uget_mut([i, 0]))  = a;
...
result_array.t.to_owned()})
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_node_names_with_unknown_edge_types(directed.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_node_names_with_known_edge_types(directed.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_edges_with_unknown_edge_types_mask())?, bool)})
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_edges_with_known_edge_types_mask())?, bool)})
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_node_ids_with_known_node_types())?, NodeT)})
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_node_ids_from_node_type_id(node_type_id.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_node_ids_from_node_type_ids(node_type_ids.into()))?, NodeT)})
            }
    ...
    ///     If there are no node types in the graph.
    /// 
            pub fn get_node_ids_from_node_type_names(&self, node_type_names: Vec<Option<String>>)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_node_ids_from_node_type_names(node_type_names.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_names_from_node_type_id(node_type_id.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_node_ids_from_node_type_name(node_type_name.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_names_from_node_type_name(node_type_name.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_singleton_edge_type_ids())?, EdgeTypeT)})
    ...
    /// 
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_node_connected_component_ids(verbose.into()), NodeT)
            }
...
to_ndarray_1d!(gil, self.inner.get_reciprocal_sqrt_degrees(), WeightT)
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_single_label_node_type_ids(unknown_node_types_value.into()))?, NodeTypeT)})
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_known_single_label_node_type_ids())?, NodeTypeT)})
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_boolean_node_type_ids(target_value.into(), unknown_node_types_value.into()))?, bool)})
            }
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_known_boolean_node_type_ids(target_value.into()))?, bool)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.to_structural_similarity_multi_graph(maximal_hop_distance.into(), change_layer_probability.into(), random_walk_length.into(), iterations.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_approximated_cliques(minimum_degree.into(), minimum_clique_size.into(), clique_per_node.into(), verbose.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_approximated_number_of_cliques(minimum_degree.into(), minimum_clique_size.into(), clique_per_node.into(), verbose.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.overlap_textual_report(&other.inner, verbose.into()))?.into())
            }
    ...
    /// 
            pub fn generate_random_connected_graph(random_state: Option<u64>, minimum_node_id: Option<NodeT>, minimum_node_sampling: Option<NodeT>, maximum_node_sampling: Option<NodeT>, nodes_number: Option<NodeT>, include_selfloops: Option<bool>, node_type: Option<&str>, edge_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_random_connected_graph(random_state.into(), minimum_node_id.into(), minimum_node_sampling.into(), maximum_node_sampling.into(), nodes_number.into(), include_selfloops.into(), node_type.into(), edge_type.into(), weight.into(), directed.into(), name.into()))?.into())
            }
    ...
    ///     Name of the graph. By default 'Chain'.
    /// 
            pub fn generate_random_spanning_tree(random_state: Option<u64>, minimum_node_id: Option<NodeT>, nodes_number: Option<NodeT>, include_selfloops: Option<bool>, node_type: Option<&str>, edge_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_random_spanning_tree(random_state.into(), minimum_node_id.into(), nodes_number.into(), include_selfloops.into(), node_type.into(), edge_type.into(), weight.into(), directed.into(), name.into()))?.into())
            }
    ...
    /// 
            pub fn generate_star_graph(minimum_node_id: Option<NodeT>, nodes_number: Option<NodeT>, include_selfloops: Option<bool>, node_type: Option<&str>, edge_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_star_graph(minimum_node_id.into(), nodes_number.into(), include_selfloops.into(), node_type.into(), edge_type.into(), weight.into(), directed.into(), name.into()))?.into())
            }
    ...
    /// 
            pub fn generate_wheel_graph(minimum_node_id: Option<NodeT>, nodes_number: Option<NodeT>, include_selfloops: Option<bool>, node_type: Option<&str>, edge_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_wheel_graph(minimum_node_id.into(), nodes_number.into(), include_selfloops.into(), node_type.into(), edge_type.into(), weight.into(), directed.into(), name.into()))?.into())
            }
    ...
    /// 
            pub fn generate_circle_graph(minimum_node_id: Option<NodeT>, nodes_number: Option<NodeT>, include_selfloops: Option<bool>, node_type: Option<&str>, edge_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_circle_graph(minimum_node_id.into(), nodes_number.into(), include_selfloops.into(), node_type.into(), edge_type.into(), weight.into(), directed.into(), name.into()))?.into())
            }
    ...
    ///     Name of the graph. By default 'Chain'.
    /// 
            pub fn generate_chain_graph(minimum_node_id: Option<NodeT>, nodes_number: Option<NodeT>, include_selfloops: Option<bool>, node_type: Option<&str>, edge_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_chain_graph(minimum_node_id.into(), nodes_number.into(), include_selfloops.into(), node_type.into(), edge_type.into(), weight.into(), directed.into(), name.into()))?.into())
            }
    ...
    /// 
            pub fn generate_complete_graph(minimum_node_id: Option<NodeT>, nodes_number: Option<NodeT>, include_selfloops: Option<bool>, node_type: Option<&str>, edge_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_complete_graph(minimum_node_id.into(), nodes_number.into(), include_selfloops.into(), node_type.into(), edge_type.into(), weight.into(), directed.into(), name.into()))?.into())
            }
    ...
    /// 
            pub fn generate_barbell_graph(minimum_node_id: Option<NodeT>, left_clique_nodes_number: Option<NodeT>, right_clique_nodes_number: Option<NodeT>, chain_nodes_number: Option<NodeT>, include_selfloops: Option<bool>, left_clique_node_type: Option<&str>, right_clique_node_type: Option<&str>, chain_node_type: Option<&str>, left_clique_edge_type: Option<&str>, right_clique_edge_type: Option<&str>, chain_edge_type: Option<&str>, left_clique_weight: Option<WeightT>, right_clique_weight: Option<WeightT>, chain_weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_barbell_graph(minimum_node_id.into(), left_clique_nodes_number.into(), right_clique_nodes_number.into(), chain_nodes_number.into(), include_selfloops.into(), left_clique_node_type.into(), right_clique_node_type.into(), chain_node_type.into(), left_clique_edge_type.into(), right_clique_edge_type.into(), chain_edge_type.into(), left_clique_weight.into(), right_clique_weight.into(), chain_weight.into(), directed.into(), name.into()))?.into())
            }
    ...
    ///     If the edge weights are provided only for a subset.
    /// 
            pub fn generate_lollipop_graph(minimum_node_id: Option<NodeT>, clique_nodes_number: Option<NodeT>, chain_nodes_number: Option<NodeT>, include_selfloops: Option<bool>, clique_node_type: Option<&str>, chain_node_type: Option<&str>, clique_edge_type: Option<&str>, chain_edge_type: Option<&str>, clique_weight: Option<WeightT>, chain_weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_lollipop_graph(minimum_node_id.into(), clique_nodes_number.into(), chain_nodes_number.into(), include_selfloops.into(), clique_node_type.into(), chain_node_type.into(), clique_edge_type.into(), chain_edge_type.into(), clique_weight.into(), chain_weight.into(), directed.into(), name.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(graph::Graph::generate_squared_lattice_graph(&sides, minimum_node_id.into(), node_type.into(), weight.into(), directed.into(), name.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.filter_from_ids(node_ids_to_keep.into(), node_ids_to_remove.into(), node_names_to_keep_from_graph.map(|sg| &sg.inner), node_names_to_remove_from_graph.map(|sg| &sg.inner), node_prefixes_to_keep.into(), node_prefixes_to_remove.into(), node_type_ids_to_keep.into(), node_type_ids_to_remove.into(), node_type_id_to_keep.into(), node_type_id_to_remove.into(), source_node_ids_to_keep.into(), source_node_ids_to_remove.into(), source_node_names_to_keep_from_graph.map(|sg| &sg.inner), source_node_names_to_remove_from_graph.map(|sg| &sg.inner), source_node_prefixes_to_keep.into(), source_node_prefixes_to_remove.into(), source_node_type_ids_to_keep.into(), source_node_type_ids_to_remove.into(), source_node_type_id_to_keep.into(), source_node_type_id_to_remove.into(), destination_node_ids_to_keep.into(), destination_node_ids_to_remove.into(), destination_node_names_to_keep_from_graph.map(|sg| &sg.inner), destination_node_names_to_remove_from_graph.map(|sg| &sg.inner), destination_node_prefixes_to_keep.into(), destination_node_prefixes_to_remove.into(), destination_node_type_ids_to_keep.into(), destination_node_type_ids_to_remove.into(), destination_node_type_id_to_keep.into(), destination_node_type_id_to_remove.into(), edge_ids_to_keep.into(), edge_ids_to_remove.into(), edge_node_ids_to_keep.into(), edge_node_ids_to_remove.into(), edge_type_ids_to_keep.into(), edge_type_ids_to_remove.into(), min_edge_weight.into(), max_edge_weight.into(), min_node_degree.into(), max_node_degree.into(), filter_singleton_nodes.into(), filter_singleton_nodes_with_selfloop.into(), filter_selfloops.into(), filter_parallel_edges.into()))?.into())
            }
    ...
    ///     Whether to show loading bar while building the graphs.
    /// 
            pub fn filter_from_names(&self, node_names_to_keep: Option<Vec<&str>>, node_names_to_remove: Option<Vec<&str>>, node_names_to_keep_from_graph: Option<& Graph>, node_names_to_remove_from_graph: Option<& Graph>, node_prefixes_to_keep: Option<Vec<String>>, node_prefixes_to_remove: Option<Vec<String>>, node_type_names_to_keep: Option<Vec<Option<Vec<&str>>>>, node_type_names_to_remove: Option<Vec<Option<Vec<&str>>>>, node_type_name_to_keep: Option<Vec<Option<String>>>, node_type_name_to_remove: Option<Vec<Option<String>>>, source_node_names_to_keep: Option<Vec<&str>>, source_node_names_to_remove: Option<Vec<&str>>, source_node_names_to_keep_from_graph: Option<& Graph>, source_node_names_to_remove_from_graph: Option<& Graph>, source_node_prefixes_to_keep: Option<Vec<String>>, source_node_prefixes_to_remove: Option<Vec<String>>, source_node_type_names_to_keep: Option<Vec<Option<Vec<&str>>>>, source_node_type_names_to_remove: Option<Vec<Option<Vec<&str>>>>, source_node_type_name_to_keep: Option<Vec<Option<String>>>, source_node_type_name_to_remove: Option<Vec<Option<String>>>, destination_node_names_to_keep: Option<Vec<&str>>, destination_node_names_to_remove: Option<Vec<&str>>, destination_node_names_to_keep_from_graph: Option<& Graph>, destination_node_names_to_remove_from_graph: Option<& Graph>, destination_node_prefixes_to_keep: Option<Vec<String>>, destination_node_prefixes_to_remove: Option<Vec<String>>, destination_node_type_names_to_keep: Option<Vec<Option<Vec<&str>>>>, destination_node_type_names_to_remove: Option<Vec<Option<Vec<&str>>>>, destination_node_type_name_to_keep: Option<Vec<Option<String>>>, destination_node_type_name_to_remove: Option<Vec<Option<String>>>, edge_node_names_to_keep: Option<Vec<(&str, &str)>>, edge_node_names_to_remove: Option<Vec<(&str, &str)>>, edge_type_names_to_keep: Option<Vec<Option<String>>>, edge_type_names_to_remove: Option<Vec<Option<String>>>, min_edge_weight: Option<WeightT>, max_edge_weight: Option<WeightT>, min_node_degree: Option<NodeT>, max_node_degree: Option<NodeT>, filter_singleton_nodes: Option<bool>, filter_singleton_nodes_with_selfloop: Option<bool>, filter_selfloops: Option<bool>, filter_parallel_edges: Option<bool>)-> PyResult<Graph>{
            Ok(pe!(self.inner.filter_from_names(node_names_to_keep.into(), node_names_to_remove.into(), node_names_to_keep_from_graph.map(|sg| &sg.inner), node_names_to_remove_from_graph.map(|sg| &sg.inner), node_prefixes_to_keep.into(), node_prefixes_to_remove.into(), node_type_names_to_keep.into(), node_type_names_to_remove.into(), node_type_name_to_keep.into(), node_type_name_to_remove.into(), source_node_names_to_keep.into(), source_node_names_to_remove.into(), source_node_names_to_keep_from_graph.map(|sg| &sg.inner), source_node_names_to_remove_from_graph.map(|sg| &sg.inner), source_node_prefixes_to_keep.into(), source_node_prefixes_to_remove.into(), source_node_type_names_to_keep.into(), source_node_type_names_to_remove.into(), source_node_type_name_to_keep.into(), source_node_type_name_to_remove.into(), destination_node_names_to_keep.into(), destination_node_names_to_remove.into(), destination_node_names_to_keep_from_graph.map(|sg| &sg.inner), destination_node_names_to_remove_from_graph.map(|sg| &sg.inner), destination_node_prefixes_to_keep.into(), destination_node_prefixes_to_remove.into(), destination_node_type_names_to_keep.into(), destination_node_type_names_to_remove.into(), destination_node_type_name_to_keep.into(), destination_node_type_name_to_remove.into(), edge_node_names_to_keep.into(), edge_node_names_to_remove.into(), edge_type_names_to_keep.into(), edge_type_names_to_remove.into(), min_edge_weight.into(), max_edge_weight.into(), min_node_degree.into(), max_node_degree.into(), filter_singleton_nodes.into(), filter_singleton_nodes_with_selfloop.into(), filter_selfloops.into(), filter_parallel_edges.into()))?.into())
            }
    ...
    /// 
            ...
            self.inner.remove_isomorphic_nodes(minimum_node_degree.into()).into()
            }
    ...
    /// 
            ...
            let (subresult_0, subresult_1, subresult_2, subresult_3, subresult_4) = self.inner.random_spanning_arborescence_kruskal(random_state.into(), undesired_edge_types.into(), verbose.into());
(subresult_0.into(), {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_1, NodeT)}, subresult_2.into(), subresult_3.into(), subresult_4.into())
    ...
    /// 
            ...
            let (subresult_0, subresult_1, subresult_2, subresult_3, subresult_4) = self.inner.spanning_arborescence_kruskal(verbose.into());
(subresult_0.into(), {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_1, NodeT)}, subresult_2.into(), subresult_3.into(), subresult_4.into())
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1, subresult_2, subresult_3) = pe!(self.inner.get_connected_components(verbose.into()))?.into();
({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_0, NodeT)}, subresult_1.into(), subresult_2.into(), subresult_3.into())})
    ...
    /// 
            pub fn enable(& mut self, vector_sources: Option<bool>, vector_destinations: Option<bool>, vector_cumulative_node_degrees: Option<bool>, vector_reciprocal_sqrt_degrees: Option<bool>)-> PyResult<()>{
            Ok(pe!(self.inner.enable(vector_sources.into(), vector_destinations.into(), vector_cumulative_node_degrees.into(), vector_reciprocal_sqrt_degrees.into()))?)
            }
    ...
    /// * If the graph does not have edge types, the method will always return None.
            pub unsafe fn get_unchecked_random_zifian_edge_type(&self, random_state: u64)-> Option<EdgeTypeT>{
            self.inner.get_unchecked_random_zifian_edge_type(random_state.into()).map(|x| x.into())
            }
    ...
    /// 
            ...
            self.inner.get_random_outbounds_scale_free_node(random_state.into()).into()
            }
    ...
    /// 
            ...
            self.inner.get_random_inbounds_scale_free_node(random_state.into()).into()
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_sorted_unique_random_nodes(number_of_nodes_to_sample.into(), random_state.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_breadth_first_search_random_nodes(number_of_nodes_to_sample.into(), root_node.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_uniform_random_walk_random_nodes(node.into(), random_state.into(), walk_length.into(), unique.into()))?, NodeT)})
            }
            ...
            self.inner.get_node_sampling_methods().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
    ...
    /// 
            pub fn get_subsampled_nodes(&self, number_of_nodes_to_sample: NodeT, random_state: u64, root_node: Option<NodeT>, node_sampling_method: &str, unique: Option<bool>)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_subsampled_nodes(number_of_nodes_to_sample.into(), random_state.into(), root_node.into(), node_sampling_method.into(), unique.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_okapi_bm25_node_feature_propagation(features.into(), iterations.into(), maximal_distance.into(), k1.into(), b.into(), include_central_node.into(), verbose.into()))?, f64)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_okapi_bm25_node_label_propagation(iterations.into(), maximal_distance.into(), k1.into(), b.into(), verbose.into()))?, f64)})
            }
    ...
    /// 
            ...
            self.inner.has_cumulative_node_degrees_tradeoff_enabled().into()
            }
    ...
    /// 
            ...
            self.inner.get_transitive_closure(iterations.into(), verbose.into()).into()
            }
    ...
    /// 
            ...
            self.inner.get_all_shortest_paths(iterations.into(), verbose.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_weighted_all_shortest_paths(iterations.into(), use_edge_weights_as_probabilities.into(), verbose.into()))?.into())
            }
    ...
    /// If the given edge ID does not exists in the graph this method will panic.
            ...
            self.inner.get_unchecked_edge_weight_from_edge_id(edge_id.into()).map(|x| x.into())
            }
    ...
    /// If either of the two given node IDs does not exists in the graph.
            ...
            self.inner.get_unchecked_edge_weight_from_node_ids(src.into(), dst.into()).into()
            }
    ...
    /// If the given node name does not exists in the considered graph the method will panic.
            ...
            self.inner.get_unchecked_node_id_from_node_name(node_name.into()).into()
            }
    ...
    /// If the given edge type name does not exists in the considered graph the method will panic.
            ...
            self.inner.get_unchecked_edge_type_id_from_edge_type_name(edge_type_name.into()).map(|x| x.into())
            }
    ...
    /// If the given edge type ID does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_edge_type_name_from_edge_type_id(edge_type_id.into()).map(|x| x.into())
            }
    ...
    /// If the given edge type ID does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_edge_count_from_edge_type_id(edge_type.into()).into()
            }
    ...
    ///  the method will panic.
            ...
            self.inner.get_unchecked_node_count_from_node_type_id(node_type.into()).into()
            }
    ...
    /// If the given node IDs or edge type does not exists in the graph this method will panic.
            ...
            self.inner.get_unchecked_edge_id_from_node_ids_and_edge_type_id(src.into(), dst.into(), edge_type.into()).into()
            }
    ...
    /// If the given node type IDs do not exist in the graph this method will panic.
            ...
            let (subresult_0, subresult_1) = self.inner.get_unchecked_minmax_edge_ids_from_node_ids(src.into(), dst.into());
(subresult_0.into(), subresult_1.into())
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            ...
            let (subresult_0, subresult_1) = self.inner.get_unchecked_node_ids_from_edge_id(edge_id.into());
(subresult_0.into(), subresult_1.into())
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            ...
            let (subresult_0, subresult_1) = self.inner.get_unchecked_node_names_from_edge_id(edge_id.into());
(subresult_0.into(), subresult_1.into())
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will cause an out of bounds.
            ...
            self.inner.get_unchecked_source_node_id_from_edge_id(edge_id.into()).into()
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will cause an out of bounds.
            ...
            self.inner.get_unchecked_destination_node_id_from_edge_id(edge_id.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_destination_node_id_from_edge_id(edge_id.into()))?.into())
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            ...
            self.inner.get_unchecked_source_node_name_from_edge_id(edge_id.into()).into()
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            ...
            self.inner.get_unchecked_destination_node_name_from_edge_id(edge_id.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_destination_node_name_from_edge_id(edge_id.into()))?.into())
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_node_names_from_edge_id(edge_id.into()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_node_ids_from_edge_id(edge_id.into()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// If any of the given node IDs do not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_edge_id_from_node_ids(src.into(), dst.into()).into()
            }
    ...
    /// If the given source node ID does not exist in the current graph the method will panic.
            ...
            self.inner.get_unchecked_unique_source_node_id(source_id.into()).into()
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            ...
            let (subresult_0, subresult_1, subresult_2) = self.inner.get_unchecked_node_ids_and_edge_type_id_from_edge_id(edge_id.into());
(subresult_0.into(), subresult_1.into(), subresult_2.map(|x| x.into()))
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1, subresult_2) = pe!(self.inner.get_node_ids_and_edge_type_id_from_edge_id(edge_id.into()))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.map(|x| x.into()))})
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            ...
            let (subresult_0, subresult_1, subresult_2, subresult_3) = self.inner.get_unchecked_node_ids_and_edge_type_id_and_edge_weight_from_edge_id(edge_id.into());
(subresult_0.into(), subresult_1.into(), subresult_2.map(|x| x.into()), subresult_3.map(|x| x.into()))
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1, subresult_2, subresult_3) = pe!(self.inner.get_node_ids_and_edge_type_id_and_edge_weight_from_edge_id(edge_id.into()))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.map(|x| x.into()), subresult_3.map(|x| x.into()))})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_top_k_central_node_ids(k.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_weighted_top_k_central_node_ids(k.into()))?, NodeT)})
            }
    ...
    /// If the given node ID does not exist in the current graph the method will raise a panic.
            ...
            self.inner.get_unchecked_node_degree_from_node_id(node_id.into()).into()
            }
    ...
    /// If the given node ID does not exist in the current graph the method will raise a panic.
            ...
            self.inner.get_unchecked_weighted_node_degree_from_node_id(node_id.into()).into()
            }
    ...
    /// If the given node ID does not exist in the current graph the method will raise a panic.
            ...
            self.inner.get_unchecked_comulative_node_degree_from_node_id(node_id.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_comulative_node_degree_from_node_id(node_id.into()))?.into())
            }
    ...
    /// If the given node ID does not exist in the current graph the method will raise a panic.
            ...
            self.inner.get_unchecked_reciprocal_sqrt_degree_from_node_id(node_id.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_reciprocal_sqrt_degree_from_node_id(node_id.into()))?.into())
            }
...
to_ndarray_1d!(gil, self.inner.get_unchecked_reciprocal_sqrt_degrees_from_node_ids(&node_ids), WeightT)
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_weighted_node_degree_from_node_id(node_id.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_top_k_central_node_names(k.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    ///  not available for the current graph, the behaviour is undefined.
            ...
            self.inner.get_unchecked_node_type_ids_from_node_id(node_id.into()).map(|x| {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, {x}.clone(), NodeTypeT)})
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_type_ids_from_node_id(node_id.into()))?.map(|x| {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, {x}.clone(), NodeTypeT)}))
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            ...
            self.inner.get_unchecked_edge_type_id_from_edge_id(edge_id.into()).map(|x| x.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_type_id_from_edge_node_ids(src.into(), dst.into()))?.map(|x| x.into()))
            }
    ...
    ///  does not contain node types.
            ...
            self.inner.get_unchecked_node_type_names_from_node_id(node_id.into()).map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_type_names_from_node_id(node_id.into()))?.map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()))
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_type_names_from_node_name(node_name.into()))?.map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()))
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_type_name_from_edge_type_id(edge_type_id.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_weight_from_node_ids(src.into(), dst.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_weight_from_node_ids_and_edge_type_id(src.into(), dst.into(), edge_type.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_weight_from_node_names_and_edge_type_name(src.into(), dst.into(), edge_type.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_weight_from_node_names(src_name.into(), dst_name.into()))?.into())
            }
    ...
    /// If the given node ID does not exist in the current graph the method will raise a panic.
            ...
            self.inner.get_unchecked_node_name_from_node_id(node_id.into()).into()
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_node_ids_from_node_names(node_names.into()))?, NodeT)})
            }
...
// Which is a flat vector with row-first or column-first unrolling
let gil = pyo3::Python::acquire_gil();
let body = pe!(self.inner.get_edge_node_ids_from_edge_node_names(edge_node_names.into()))?;
let result_array = ThreadDataRaceAware {t: PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)};
body.into_par_iter().enumerate()
    .for_each(|(i, (a, b))| unsafe {
        *(result_array.t.uget_mut([i, 0]))  = a;
...
result_array.t.to_owned()})
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_node_names_from_edge_node_ids(edge_node_ids.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_type_ids_from_node_name(node_name.into()))?.map(|x| {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, {x}.clone(), NodeTypeT)}))
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_type_name_from_node_name(node_name.into()))?.map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()))
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_count_from_edge_type_id(edge_type_id.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_type_id_from_edge_type_name(edge_type_name.into()))?.map(|x| x.into()))
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_count_from_edge_type_name(edge_type_name.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_type_id_from_node_type_name(node_type_name.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_count_from_node_type_id(node_type_id.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_count_from_node_type_name(node_type_name.into()))?.into())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_neighbour_node_ids_from_node_id(node_id.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_neighbour_node_ids_from_node_name(node_name.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_neighbour_node_names_from_node_name(node_name.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_minmax_edge_ids_from_node_ids(src.into(), dst.into()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_id_from_node_ids_and_edge_type_id(src.into(), dst.into(), edge_type.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_id_from_node_names(src_name.into(), dst_name.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_id_from_node_names_and_edge_type_name(src_name.into(), dst_name.into(), edge_type_name.into()))?.into())
            }
    ...
    /// 
            pub fn get_edge_type_ids_from_edge_type_names(&self, edge_type_names: Vec<Option<String>>)-> PyResult<Vec<Option<EdgeTypeT>>>{
            Ok(pe!(self.inner.get_edge_type_ids_from_edge_type_names(edge_type_names.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_node_type_ids_from_node_type_names(&self, node_type_names: Vec<Option<String>>)-> PyResult<Vec<Option<NodeTypeT>>>{
            Ok(pe!(self.inner.get_node_type_ids_from_node_type_names(node_type_names.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_multiple_node_type_ids_from_node_type_names(&self, node_type_names: Vec<Option<Vec<&str>>>)-> PyResult<Vec<Option<Vec<NodeTypeT>>>>{
            Ok(pe!(self.inner.get_multiple_node_type_ids_from_node_type_names(node_type_names.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// If the given node ID does not exist in the current graph the method will raise a panic.
            ...
            let (subresult_0, subresult_1) = self.inner.get_unchecked_minmax_edge_ids_from_source_node_id(src.into());
(subresult_0.into(), subresult_1.into())
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_minmax_edge_ids_from_source_node_id(src.into()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_type_name_from_node_type_id(node_type_id.into()))?.into())
            }
    ...
    ///  is provided. If the graph does not have node types, zero will be returned.
            ...
            self.inner.get_unchecked_number_of_nodes_from_node_type_id(node_type_id.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_number_of_nodes_from_node_type_id(node_type_id.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_number_of_nodes_from_node_type_name(node_type_name.into()))?.into())
            }
    ...
    ///  is provided. If the graph does not have edge types, zero will be returned.
            ...
            self.inner.get_unchecked_number_of_edges_from_edge_type_id(edge_type_id.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_number_of_edges_from_edge_type_id(edge_type_id.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_number_of_edges_from_edge_type_name(edge_type_name.into()))?.into())
            }
    ...
    /// 
            pub fn get_edge_node_ids_from_edge_type_id(&self, edge_type_id: Option<EdgeTypeT>, directed: bool)-> PyResult<Py<PyArray2<NodeT>>>{
            Ok({
// Warning: this copies the array so it uses double the memory.
// To avoid this you should directly generate data compatible with a numpy array
// Which is a flat vector with row-first or column-first unrolling
let gil = pyo3::Python::acquire_gil();
let body = pe!(self.inner.get_edge_node_ids_from_edge_type_id(edge_type_id.into(), directed.into()))?;
let result_array = ThreadDataRaceAware {t: PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)};
body.into_par_iter().enumerate()
    .for_each(|(i, (a, b))| unsafe {
        *(result_array.t.uget_mut([i, 0]))  = a;
...
// Which is a flat vector with row-first or column-first unrolling
let gil = pyo3::Python::acquire_gil();
let body = pe!(self.inner.get_directed_edge_node_ids_from_edge_type_id(edge_type_id.into()))?;
let result_array = ThreadDataRaceAware {t: PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)};
body.into_par_iter().enumerate()
    .for_each(|(i, (a, b))| unsafe {
        *(result_array.t.uget_mut([i, 0]))  = a;
...
result_array.t.to_owned()})
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_directed_edge_node_names_from_edge_type_id(edge_type_id.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_directed_edge_node_names_from_edge_type_name(edge_type_name.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_directed_edge_ids_from_edge_type_id(edge_type_id.into()))?, EdgeT)})
            }
    ...
    ///     If the given edge type name does not exist in the graph.
    /// 
            pub fn get_edge_node_ids_from_edge_type_name(&self, edge_type_name: Option<&str>, directed: bool)-> PyResult<Py<PyArray2<NodeT>>>{
            Ok({
// Warning: this copies the array so it uses double the memory.
// To avoid this you should directly generate data compatible with a numpy array
// Which is a flat vector with row-first or column-first unrolling
let gil = pyo3::Python::acquire_gil();
let body = pe!(self.inner.get_edge_node_ids_from_edge_type_name(edge_type_name.into(), directed.into()))?;
let result_array = ThreadDataRaceAware {t: PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)};
body.into_par_iter().enumerate()
    .for_each(|(i, (a, b))| unsafe {
        *(result_array.t.uget_mut([i, 0]))  = a;
...
// Which is a flat vector with row-first or column-first unrolling
let gil = pyo3::Python::acquire_gil();
let body = pe!(self.inner.get_directed_edge_node_ids_from_edge_type_name(edge_type_name.into()))?;
let result_array = ThreadDataRaceAware {t: PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)};
body.into_par_iter().enumerate()
    .for_each(|(i, (a, b))| unsafe {
        *(result_array.t.uget_mut([i, 0]))  = a;
...
result_array.t.to_owned()})
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_directed_edge_ids_from_edge_type_name(edge_type_name.into()))?, EdgeT)})
            }
    ...
    /// 
            ...
            self.inner.get_directed_edge_node_names_from_node_curie_prefixes(src_node_name_prefixes.into(), dst_node_name_prefixes.into()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
...
// Which is a flat vector with row-first or column-first unrolling
let gil = pyo3::Python::acquire_gil();
let body = self.inner.get_directed_edge_node_ids_from_node_curie_prefixes(src_node_name_prefixes.into(), dst_node_name_prefixes.into());
let result_array = ThreadDataRaceAware {t: PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)};
body.into_par_iter().enumerate()
    .for_each(|(i, (a, b))| unsafe {
        *(result_array.t.uget_mut([i, 0]))  = a;
...
result_array.t.to_owned()
    ...
    /// 
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_directed_edge_ids_from_node_curie_prefixes(src_node_name_prefixes.into(), dst_node_name_prefixes.into()), EdgeT)
            }
    ...
    /// 
            ...
            self.inner.get_number_of_directed_edges_from_node_curie_prefixes(src_node_name_prefixes.into(), dst_node_name_prefixes.into()).into()
            }
    ...
    /// 
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_node_ids_from_node_curie_prefixes(curie_prefixes.into()), NodeT)
            }
    ...
    /// 
            ...
            self.inner.get_node_names_from_node_curie_prefixes(curie_prefixes.into()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
    ...
    /// 
            ...
            self.inner.get_number_of_nodes_from_node_curie_prefixes(curie_prefixes.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_names_prefixes(separator.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_non_zero_subgraph_node_degrees(&subgraph.inner))?, NodeT)})
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_multigraph_edge_ids_from_node_ids(src.into(), dst.into()))?, EdgeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_number_of_multigraph_edges_from_node_ids(src.into(), dst.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_tendrils(minimum_number_of_nodes_per_tendril.into(), compute_tendril_nodes.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            self.inner.get_node_degree_geometric_distribution_threshold(number_of_nodes_above_threshold.into()).into()
            }
            ...
            self.inner.get_sparse_edge_weighting_methods().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
            ...
            self.inner.get_edge_weighting_methods().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.add_selfloops(edge_type_name.into(), weight.into()))?.into())
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_weighted_degree_centrality())?, f32)})
    ...
    /// If the given node ID does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_closeness_centrality_from_node_id(node_id.into()).into()
            }
    ...
    /// If the given node ID does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_weighted_closeness_centrality_from_node_id(node_id.into(), use_edge_weights_as_probabilities.into()).into()
            }
    ...
    /// 
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_closeness_centrality(verbose.into()), f32)
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_weighted_closeness_centrality(use_edge_weights_as_probabilities.into(), verbose.into()))?, f32)})
            }
    ...
    /// If the given node ID does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_harmonic_centrality_from_node_id(node_id.into()).into()
            }
    ...
    /// If the given node ID does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_weighted_harmonic_centrality_from_node_id(node_id.into(), use_edge_weights_as_probabilities.into()).into()
            }
...
to_ndarray_1d!(gil, self.inner.get_harmonic_centrality(verbose.into()), f32)
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_weighted_harmonic_centrality(use_edge_weights_as_probabilities.into(), verbose.into()))?, f32)})
            }
    ...
    /// 
            pub fn get_stress_centrality(&self, normalize: Option<bool>, verbose: Option<bool>)-> Py<PyArray1<f32>>{
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_stress_centrality(normalize.into(), verbose.into()), f32)
            }
    ...
    ///     Whether to show a loading bar. By default, it is true.
    /// 
            pub fn get_betweenness_centrality(&self, edges_normalization: Option<bool>, min_max_normalization: Option<bool>, verbose: Option<bool>)-> Py<PyArray1<f32>>{
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_betweenness_centrality(edges_normalization.into(), min_max_normalization.into(), verbose.into()), f32)
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_approximated_betweenness_centrality_from_node_id(node_id.into(), ant.into(), maximum_samples_number.into(), random_state.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_approximated_betweenness_centrality_from_node_name(node_name.into(), ant.into(), maximum_samples_number.into(), random_state.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_weighted_approximated_betweenness_centrality_from_node_id(node_id.into(), ant.into(), use_edge_weights_as_probabilities.into(), maximum_samples_number.into(), random_state.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_weighted_approximated_betweenness_centrality_from_node_name(node_name.into(), ant.into(), use_edge_weights_as_probabilities.into(), maximum_samples_number.into(), random_state.into()))?.into())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_eigenvector_centrality(maximum_iterations_number.into(), tollerance.into()))?, f32)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_weighted_eigenvector_centrality(maximum_iterations_number.into(), tollerance.into()))?, f32)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_stars(minimum_number_of_nodes_per_star.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_undirected_louvain_community_detection(recursion_minimum_improvement.into(), first_phase_minimum_improvement.into(), patience.into(), random_state.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    ///  number of nodes in the graph.
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_unchecked_structural_distance_from_node_ids(source_node_id.into(), destination_node_id.into(), maximal_hop_distance.into()), f32)
            }
    ...
    ///  number of nodes in the graph.
            ...
            self.inner.get_unchecked_preferential_attachment_from_node_ids(source_node_id.into(), destination_node_id.into(), normalize.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_preferential_attachment_from_node_ids(source_node_id.into(), destination_node_id.into(), normalize.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_preferential_attachment_from_node_names(first_node_name.into(), second_node_name.into(), normalize.into()))?.into())
            }
    ...
    ///  number of nodes in the graph.
            ...
            self.inner.get_unchecked_weighted_preferential_attachment_from_node_ids(source_node_id.into(), destination_node_id.into(), normalize.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_weighted_preferential_attachment_from_node_ids(source_node_id.into(), destination_node_id.into(), normalize.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_weighted_preferential_attachment_from_node_names(first_node_name.into(), second_node_name.into(), normalize.into()))?.into())
            }
    ...
    ///  number of nodes in the graph.
            ...
            self.inner.get_unchecked_neighbours_intersection_size_from_node_ids(source_node_id.into(), destination_node_id.into()).into()
            }
    ...
    ///  number of nodes in the graph.
            ...
            self.inner.get_unchecked_jaccard_coefficient_from_node_ids(source_node_id.into(), destination_node_id.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_jaccard_coefficient_from_node_ids(source_node_id.into(), destination_node_id.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_jaccard_coefficient_from_node_names(first_node_name.into(), second_node_name.into()))?.into())
            }
    ...
    ///  number of nodes in the graph.
            ...
            self.inner.get_unchecked_adamic_adar_index_from_node_ids(source_node_id.into(), destination_node_id.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_adamic_adar_index_from_node_ids(source_node_id.into(), destination_node_id.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_adamic_adar_index_from_node_names(first_node_name.into(), second_node_name.into()))?.into())
            }
    ...
    ///  number of nodes in the graph.
            ...
            self.inner.get_unchecked_resource_allocation_index_from_node_ids(source_node_id.into(), destination_node_id.into()).into()
            }
    ...
    ///  number of nodes in the graph.
            ...
            self.inner.get_unchecked_weighted_resource_allocation_index_from_node_ids(source_node_id.into(), destination_node_id.into()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_resource_allocation_index_from_node_ids(source_node_id.into(), destination_node_id.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_resource_allocation_index_from_node_names(first_node_name.into(), second_node_name.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_weighted_resource_allocation_index_from_node_ids(source_node_id.into(), destination_node_id.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_weighted_resource_allocation_index_from_node_names(first_node_name.into(), second_node_name.into()))?.into())
            }
            ...
            self.inner.get_available_edge_metrics_names().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
    ...
    /// If the given node IDs do not exist in the graph this method will panic.
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_unchecked_all_edge_metrics_from_node_ids_tuple(source_node_id.into(), destination_node_id.into(), normalize.into()), f32)
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_all_edge_metrics_from_node_ids_tuple(source_node_id.into(), destination_node_id.into(), normalize.into()))?, f32)})
            }
    ...
    /// If the given node IDs do not exist in the graph this method will panic.
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_all_edge_metrics_from_node_ids(source_node_ids.into(), destination_node_ids.into(), normalize.into()))?, f32)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_preferential_attachment_scores(normalize.into(), subgraph.map(|sg| &sg.inner)))?, f32)})
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_adamic_adar_scores(subgraph.map(|sg| &sg.inner)))?, f32)})
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_all_edge_metrics(normalize.into(), subgraph.map(|sg| &sg.inner)))?, f32)})
            }
    ...
    /// 
            pub fn get_isomorphic_node_ids_groups(&self, minimum_node_degree: Option<NodeT>)-> Vec<Vec<NodeT>>{
            self.inner.get_isomorphic_node_ids_groups(minimum_node_degree.into()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
    ...
    ///     Minimum node degree for the topological synonims. By default, 5.
    /// 
            pub fn get_isomorphic_node_names_groups(&self, minimum_node_degree: Option<NodeT>)-> Vec<Vec<String>>{
            self.inner.get_isomorphic_node_names_groups(minimum_node_degree.into()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
    ...
    /// 
            ...
            self.inner.get_number_of_isomorphic_node_groups(minimum_node_degree.into()).into()
            }
            ...
            Ok(pe!(self.inner.get_isomorphic_node_type_ids_groups())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
            ...
            Ok(pe!(self.inner.get_isomorphic_node_type_names_groups())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
            ...
            Ok(pe!(self.inner.get_approximated_isomorphic_node_type_ids_groups())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
            ...
            Ok(pe!(self.inner.get_approximated_isomorphic_node_type_names_groups())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_isomorphic_edge_type_ids_groups(minimum_number_of_edges.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_isomorphic_edge_type_names_groups(minimum_number_of_edges.into()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_number_of_isomorphic_edge_type_groups(minimum_number_of_edges.into()))?.into())
            }
    ...
    /// 
            ...
            self.inner.has_isomorphic_nodes(minimum_node_degree.into()).into()
            }
    ...
    /// 
            pub fn from_csv(node_type_path: Option<String>, node_type_list_separator: Option<char>, node_types_column_number: Option<usize>, node_types_column: Option<String>, node_types_ids_column_number: Option<usize>, node_types_ids_column: Option<String>, node_types_number: Option<NodeTypeT>, numeric_node_type_ids: Option<bool>, minimum_node_type_id: Option<NodeTypeT>, node_type_list_header: Option<bool>, node_type_list_support_balanced_quotes: Option<bool>, node_type_list_rows_to_skip: Option<usize>, node_type_list_is_correct: Option<bool>, node_type_list_max_rows_number: Option<usize>, node_type_list_comment_symbol: Option<String>, load_node_type_list_in_parallel: Option<bool>, node_path: Option<String>, node_list_separator: Option<char>, node_list_header: Option<bool>, node_list_support_balanced_quotes: Option<bool>, node_list_rows_to_skip: Option<usize>, node_list_is_correct: Option<bool>, node_list_max_rows_number: Option<usize>, node_list_comment_symbol: Option<String>, default_node_type: Option<String>, nodes_column_number: Option<usize>, nodes_column: Option<String>, node_types_separator: Option<char>, node_list_node_types_column_number: Option<usize>, node_list_node_types_column: Option<String>, node_ids_column: Option<String>, node_ids_column_number: Option<usize>, nodes_number: Option<NodeT>, minimum_node_id: Option<NodeT>, numeric_node_ids: Option<bool>, node_list_numeric_node_type_ids: Option<bool>, skip_node_types_if_unavailable: Option<bool>, load_node_list_in_parallel: Option<bool>, edge_type_path: Option<String>, edge_types_column_number: Option<usize>, edge_types_column: Option<String>, edge_types_ids_column_number: Option<usize>, edge_types_ids_column: Option<String>, edge_types_number: Option<EdgeTypeT>, numeric_edge_type_ids: Option<bool>, minimum_edge_type_id: Option<EdgeTypeT>, edge_type_list_separator: Option<char>, edge_type_list_header: Option<bool>, edge_type_list_support_balanced_quotes: Option<bool>, edge_type_list_rows_to_skip: Option<usize>, edge_type_list_is_correct: Option<bool>, edge_type_list_max_rows_number: Option<usize>, edge_type_list_comment_symbol: Option<String>, load_edge_type_list_in_parallel: Option<bool>, edge_path: Option<String>, edge_list_separator: Option<char>, edge_list_header: Option<bool>, edge_list_support_balanced_quotes: Option<bool>, edge_list_rows_to_skip: Option<usize>, sources_column_number: Option<usize>, sources_column: Option<String>, destinations_column_number: Option<usize>, destinations_column: Option<String>, edge_list_edge_types_column_number: Option<usize>, edge_list_edge_types_column: Option<String>, default_edge_type: Option<String>, weights_column_number: Option<usize>, weights_column: Option<String>, default_weight: Option<WeightT>, edge_ids_column: Option<String>, edge_ids_column_number: Option<usize>, edge_list_numeric_edge_type_ids: Option<bool>, edge_list_numeric_node_ids: Option<bool>, skip_weights_if_unavailable: Option<bool>, skip_edge_types_if_unavailable: Option<bool>, edge_list_is_complete: Option<bool>, edge_list_may_contain_duplicates: Option<bool>, edge_list_is_sorted: Option<bool>, edge_list_is_correct: Option<bool>, edge_list_max_rows_number: Option<usize>, edge_list_comment_symbol: Option<String>, edges_number: Option<EdgeT>, load_edge_list_in_parallel: Option<bool>, verbose: Option<bool>, may_have_singletons: Option<bool>, may_have_singleton_with_selfloops: Option<bool>, directed: bool, name: Option<String>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::from_csv(node_type_path.into(), node_type_list_separator.into(), node_types_column_number.into(), node_types_column.into(), node_types_ids_column_number.into(), node_types_ids_column.into(), node_types_number.into(), numeric_node_type_ids.into(), minimum_node_type_id.into(), node_type_list_header.into(), node_type_list_support_balanced_quotes.into(), node_type_list_rows_to_skip.into(), node_type_list_is_correct.into(), node_type_list_max_rows_number.into(), node_type_list_comment_symbol.into(), load_node_type_list_in_parallel.into(), node_path.into(), node_list_separator.into(), node_list_header.into(), node_list_support_balanced_quotes.into(), node_list_rows_to_skip.into(), node_list_is_correct.into(), node_list_max_rows_number.into(), node_list_comment_symbol.into(), default_node_type.into(), nodes_column_number.into(), nodes_column.into(), node_types_separator.into(), node_list_node_types_column_number.into(), node_list_node_types_column.into(), node_ids_column.into(), node_ids_column_number.into(), nodes_number.into(), minimum_node_id.into(), numeric_node_ids.into(), node_list_numeric_node_type_ids.into(), skip_node_types_if_unavailable.into(), load_node_list_in_parallel.into(), edge_type_path.into(), edge_types_column_number.into(), edge_types_column.into(), edge_types_ids_column_number.into(), edge_types_ids_column.into(), edge_types_number.into(), numeric_edge_type_ids.into(), minimum_edge_type_id.into(), edge_type_list_separator.into(), edge_type_list_header.into(), edge_type_list_support_balanced_quotes.into(), edge_type_list_rows_to_skip.into(), edge_type_list_is_correct.into(), edge_type_list_max_rows_number.into(), edge_type_list_comment_symbol.into(), load_edge_type_list_in_parallel.into(), edge_path.into(), edge_list_separator.into(), edge_list_header.into(), edge_list_support_balanced_quotes.into(), edge_list_rows_to_skip.into(), sources_column_number.into(), sources_column.into(), destinations_column_number.into(), destinations_column.into(), edge_list_edge_types_column_number.into(), edge_list_edge_types_column.into(), default_edge_type.into(), weights_column_number.into(), weights_column.into(), default_weight.into(), edge_ids_column.into(), edge_ids_column_number.into(), edge_list_numeric_edge_type_ids.into(), edge_list_numeric_node_ids.into(), skip_weights_if_unavailable.into(), skip_edge_types_if_unavailable.into(), edge_list_is_complete.into(), edge_list_may_contain_duplicates.into(), edge_list_is_sorted.into(), edge_list_is_correct.into(), edge_list_max_rows_number.into(), edge_list_comment_symbol.into(), edges_number.into(), load_edge_list_in_parallel.into(), verbose.into(), may_have_singletons.into(), may_have_singleton_with_selfloops.into(), directed.into(), name.into()))?.into())
            }
...
&[("connected", 0.95566344), ("from", 0.2500987), ("id", 0.39967737), ("is", 0.88551366), ("node", 0.14277129), ("unchecked", 0.49544722)],
&[("connected", 1.2699087), ("from", 0.33233717), ("id", 0.5311009), ("is", 1.1766919), ("node", 0.18971793)],
&[("disconnected", 0.91456854), ("from", 0.19447234), ("id", 0.31078207), ("is", 0.6885598), ("node", 0.20690848), ("unchecked", 0.38525102)],
&[("from", 0.2500987), ("id", 0.39967737), ("is", 0.88551366), ("node", 0.14277129), ("singleton", 0.71885455), ("unchecked", 0.49544722)],
&[("from", 0.33233717), ("id", 0.5311009), ("is", 1.1766919), ("node", 0.18971793), ("singleton", 0.95523125)],
&[("from", 0.15527742), ("id", 0.24814549), ("is", 0.549784), ("node", 0.08864163), ("selfloops", 0.5811713), ("singleton", 0.44631127), ("unchecked", 0.3076056), ("with", 0.48906144)],
&[("from", 0.19447234), ("id", 0.31078207), ("is", 0.6885598), ("node", 0.11101644), ("selfloops", 0.72786975), ("singleton", 0.5589686), ("with", 0.6125097)],
&[("from", 0.2500987), ("is", 0.88551366), ("name", 0.5578283), ("node", 0.14277129), ("singleton", 0.71885455), ("unchecked", 0.49544722)],
&[("from", 0.33233717), ("is", 1.1766919), ("name", 0.7412557), ("node", 0.18971793), ("singleton", 0.95523125)],
&[("has", 1.5249496), ("name", 1.4939883), ("node", 0.38237324)],
&[("has", 1.0473012), ("id", 0.7351438), ("node", 0.2626054), ("type", 0.7144736)],
&[("has", 1.0473012), ("name", 1.0260377), ("node", 0.2626054), ("type", 0.7144736)],
&[("edge", 0.548841), ("has", 1.0473012), ("id", 0.7351438), ("type", 0.7144736)],
&[("edge", 0.548841), ("has", 1.0473012), ("name", 1.0260377), ("type", 0.7144736)],
&[("edge", 0.39650738), ("from", 0.33233717), ("has", 0.7566174), ("ids", 0.49730676), ("node", 0.18971793)],
&[("from", 0.33233717), ("has", 0.7566174), ("id", 0.5311009), ("node", 0.18971793), ("selfloop", 1.746483)],
&[("and", 0.4411766), ("edge", 0.28859687), ("from", 0.12670542), ("has", 0.28846467), ("id", 0.20248522), ("ids", 0.189601), ("node", 0.07233103), ("type", 0.19679189)],
&[("from", 0.19447234), ("id", 0.31078207), ("is", 0.6885598), ("node", 0.20690848), ("trap", 0.8473697), ("unchecked", 0.38525102)],
&[("from", 0.2500987), ("id", 0.39967737), ("is", 0.88551366), ("node", 0.26100656), ("trap", 1.0897491)],
&[("and", 0.6771347), ("has", 0.4427466), ("name", 0.80842173), ("node", 0.20690848), ("type", 0.30204374)],
&[("edge", 0.39650738), ("from", 0.33233717), ("has", 0.7566174), ("names", 0.6545537), ("node", 0.18971793)],
&[("and", 0.4411766), ("edge", 0.28859687), ("from", 0.12670542), ("has", 0.28846467), ("name", 0.2826079), ("names", 0.2495523), ("node", 0.07233103), ("type", 0.19679189)],
&[("and", 0.4411766), ("edge", 0.28859687), ("from", 0.12670542), ("has", 0.28846467), ("id", 0.3865604), ("node", 0.07233103), ("type", 0.19679189)],
&[("and", 0.36656192), ("edge", 0.24164537), ("from", 0.105276175), ("has", 0.23967762), ("id", 0.32367134), ("node", 0.060097933), ("type", 0.16350916), ("unchecked", 0.20855281)],
&[("components", 3.150043), ("connected", 2.5594792), ("strongly", 3.8415294)],
&[("coo", 1.7217498), ("get", 0.16840003), ("jaccard", 1.88846), ("matrix", 1.6287634)],
&[("get", 0.24520314), ("graph", 1.8500084), ("jaccard", 2.7497404)],
&[("coo", 0.9360677), ("get", 0.09155444), ("intersection", 1.2352316), ("matrix", 0.88551366), ("neighbours", 1.2352316), ("size", 1.129009)],
&[("get", 0.12165975), ("graph", 0.9178983), ("intersection", 1.6414056), ("neighbours", 1.6414056), ("size", 1.5002545)],
&[("ancestors", 1.1761694), ("coo", 0.9360677), ("get", 0.09155444), ("matrix", 0.88551366), ("shared", 1.3143071), ("size", 1.129009)],
&[("ancestors", 1.5629222), ("get", 0.12165975), ("graph", 0.9178983), ("shared", 1.746483), ("size", 1.5002545)],
&[("ancestors", 1.5629222), ("coo", 1.2438694), ("get", 0.12165975), ("jaccard", 1.3643084), ("matrix", 1.1766919)],
&[("ancestors", 2.163379), ("get", 0.16840003), ("graph", 1.2705443), ("jaccard", 1.88846)],
&[("adamic", 1.4480848), ("adar", 1.4480848), ("coo", 1.2438694), ("get", 0.12165975), ("matrix", 1.1766919)],
&[("adamic", 2.0044224), ("adar", 2.0044224), ("get", 0.16840003), ("graph", 1.2705443)],
&[("coo", 1.7217498), ("cooccurrence", 2.0044224), ("get", 0.16840003), ("matrix", 1.6287634)],
&[("cooccurrence", 2.9185903), ("get", 0.24520314), ("graph", 1.8500084)],
&[("coo", 1.2438694), ("cooccurrence", 1.4480848), ("get", 0.12165975), ("matrix", 1.1766919), ("normalized", 1.2983184)],
&[("cooccurrence", 2.0044224), ("get", 0.16840003), ("graph", 1.2705443), ("normalized", 1.7971175)],
&[("coo", 0.9360677), ("cooccurrence", 1.0897491), ("get", 0.09155444), ("log", 1.3143071), ("matrix", 0.88551366), ("normalized", 0.9770431)],
&[("cooccurrence", 1.4480848), ("get", 0.12165975), ("graph", 0.9178983), ("log", 1.746483), ("normalized", 1.2983184)],
&[("coo", 1.7217498), ("get", 0.16840003), ("laplacian", 1.88846), ("matrix", 1.6287634)],
&[("get", 0.24520314), ("graph", 1.8500084), ("laplacian", 2.7497404)],
&[("coo", 0.9360677), ("get", 0.09155444), ("laplacian", 1.0267035), ("left", 1.3143071), ("matrix", 0.88551366), ("normalized", 0.9770431)],
&[("get", 0.12165975), ("graph", 0.9178983), ("laplacian", 1.3643084), ("left", 1.746483), ("normalized", 1.2983184)],
&[("coo", 0.9360677), ("get", 0.09155444), ("laplacian", 1.0267035), ("matrix", 0.88551366), ("normalized", 0.9770431), ("right", 1.3143071)],
&[("get", 0.12165975), ("graph", 0.9178983), ("laplacian", 1.3643084), ("normalized", 1.2983184), ("right", 1.746483)],
&[("coo", 0.9360677), ("get", 0.09155444), ("laplacian", 1.0267035), ("matrix", 0.88551366), ("normalized", 0.9770431), ("symmetric", 1.3143071)],
&[("get", 0.12165975), ("graph", 0.9178983), ("laplacian", 1.3643084), ("normalized", 1.2983184), ("symmetric", 1.746483)],
&[("by", 1.0561185), ("degree", 0.79793), ("increasing", 1.3143071), ("node", 0.14277129), ("outbound", 1.1761694), ("sort", 1.1761694)],
&[("by", 1.0561185), ("decreasing", 1.3143071), ("degree", 0.79793), ("node", 0.14277129), ("outbound", 1.1761694), ("sort", 1.1761694)],
&[("by", 1.4033958), ("lexicographic", 1.746483), ("node", 0.18971793), ("order", 1.746483), ("sort", 1.5629222)],
&[("bfs", 0.96049434), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("node", 0.11101644), ("sorting", 0.96049434), ("topological", 0.96049434)],
&[("bfs", 0.7669115), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("node", 0.08864163), ("reversed", 0.890542), ("sorting", 0.7669115), ("topological", 0.7669115)],
&[("bfs", 0.7669115), ("by", 0.6557065), ("from", 0.15527742), ("id", 0.24814549), ("node", 0.08864163), ("sort", 0.73024184), ("sorting", 0.7669115), ("topological", 0.7669115)],
&[("components", 4.8667574), ("remove", 2.8049307)],
&[("overlaps", 9.65582)],
&[("contains", 8.847661)],
&[("bipartite", 2.9185903), ("edges", 2.1096637), ("get", 0.24520314)],
&[("bipartite", 2.0044224), ("edge", 0.548841), ("get", 0.16840003), ("names", 0.90602577)],
&[("edges", 2.1096637), ("get", 0.24520314), ("star", 3.308225)],
&[("edge", 0.548841), ("get", 0.16840003), ("names", 0.90602577), ("star", 2.2720149)],
&[("clique", 2.8285203), ("edges", 2.1096637), ("get", 0.24520314)],
&[("clique", 1.9425644), ("edge", 0.548841), ("get", 0.16840003), ("names", 0.90602577)],
&[("edge", 1.2346778), ("encode", 5.935091)],
&[("decode", 5.935091), ("edge", 1.2346778)],
&[("edge", 0.39650738), ("encodable", 1.9060094), ("get", 0.12165975), ("max", 1.746483), ("number", 0.80783415)],
&[("id", 1.0704248), ("node", 0.38237324), ("validate", 2.7497404)],
&[("ids", 1.0023133), ("node", 0.38237324), ("validate", 2.7497404)],
&[("edge", 0.79915386), ("id", 1.0704248), ("validate", 2.7497404)],
&[("edge", 0.79915386), ("ids", 1.0023133), ("validate", 2.7497404)],
&[("contain", 1.1761694), ("must", 0.91798085), ("node", 0.14277129), ("not", 1.0897491), ("types", 0.48145416), ("unknown", 0.81980747)],
&[("contain", 1.1761694), ("edge", 0.29838964), ("must", 0.91798085), ("not", 1.0897491), ("types", 0.48145416), ("unknown", 0.81980747)],
&[("id", 0.7351438), ("node", 0.2626054), ("type", 0.7144736), ("validate", 1.88846)],
&[("ids", 0.6883663), ("node", 0.2626054), ("type", 0.7144736), ("validate", 1.88846)],
&[("edge", 0.548841), ("id", 0.7351438), ("type", 0.7144736), ("validate", 1.88846)],
&[("edge", 0.548841), ("ids", 0.6883663), ("type", 0.7144736), ("validate", 1.88846)],
&[("have", 2.163379), ("must", 1.6884818), ("node", 0.2626054), ("ontologies", 2.0766351)],
&[("be", 3.150043), ("must", 2.458557), ("undirected", 2.8285203)],
&[("have", 1.5629222), ("must", 1.219835), ("nodes", 0.847334), ("not", 1.4480848), ("trap", 1.4480848)],
&[("be", 3.150043), ("multigraph", 3.0237372), ("must", 2.458557)],
&[("be", 2.163379), ("multigraph", 2.0766351), ("must", 1.6884818), ("not", 2.0044224)],
&[("contain", 2.163379), ("identity", 2.4174616), ("matrix", 1.6287634), ("must", 1.6884818)],
&[("contain", 1.1761694), ("must", 0.91798085), ("nodes", 0.637657), ("not", 1.0897491), ("singleton", 0.71885455), ("weighted", 0.6716942)],
&[("edges", 2.1096637), ("have", 3.150043), ("must", 2.458557)],
&[("have", 3.150043), ("must", 2.458557), ("nodes", 1.7077873)],
&[("be", 3.150043), ("connected", 2.5594792), ("must", 2.458557)],
&[("must", 1.6884818), ("node", 0.2626054), ("share", 2.6382763), ("vocabulary", 2.6382763)],
&[("edge", 0.548841), ("get", 0.16840003), ("total", 1.7217498), ("weights", 1.5763028)],
&[("edge", 0.548841), ("get", 0.16840003), ("mininum", 2.6382763), ("weight", 1.7577931)],
&[("edge", 0.548841), ("get", 0.16840003), ("maximum", 1.88846), ("weight", 1.7577931)],
&[("degree", 1.0603087), ("get", 0.12165975), ("maximum", 1.3643084), ("node", 0.18971793), ("unchecked", 0.6583622)],
&[("degree", 1.0603087), ("get", 0.12165975), ("minimum", 1.4033958), ("node", 0.18971793), ("unchecked", 0.6583622)],
&[("degree", 1.0603087), ("get", 0.12165975), ("maximum", 1.3643084), ("node", 0.18971793), ("weighted", 0.8925635)],
&[("degree", 1.0603087), ("get", 0.12165975), ("minimum", 1.4033958), ("node", 0.18971793), ("weighted", 0.8925635)],
&[("get", 0.09155444), ("nodes", 0.637657), ("number", 0.60793155), ("of", 0.62732506), ("singleton", 0.71885455), ("weighted", 0.6716942)],
&[("get", 0.16840003), ("number", 1.1181947), ("of", 1.153866), ("selfloops", 1.7217498)],
&[("get", 0.12165975), ("number", 0.80783415), ("of", 0.8336047), ("selfloops", 1.2438694), ("unique", 1.2699087)],
&[("edges", 0.7877104), ("features", 1.4343579), ("from", 0.2500987), ("generate", 0.95566344), ("new", 1.4343579), ("node", 0.14277129)],
&[("name", 2.308184), ("set", 4.5091677)],
&[("all", 1.2699087), ("edge", 0.39650738), ("inplace", 1.0212213), ("set", 1.4480848), ("types", 0.63976794)],
&[("all", 1.7577931), ("edge", 0.548841), ("set", 2.0044224), ("types", 0.88555944)],
&[("all", 1.2699087), ("inplace", 1.0212213), ("node", 0.18971793), ("set", 1.4480848), ("types", 0.63976794)],
&[("all", 1.7577931), ("node", 0.2626054), ("set", 2.0044224), ("types", 0.88555944)],
&[("ids", 0.49730676), ("inplace", 1.0212213), ("node", 0.18971793), ("remove", 0.90078217), ("type", 0.5161678)],
&[("inplace", 1.0212213), ("node", 0.18971793), ("remove", 0.90078217), ("singleton", 0.95523125), ("types", 0.63976794)],
&[("add", 0.53505254), ("from", 0.12670542), ("id", 0.20248522), ("inplace", 0.38934636), ("name", 0.2826079), ("node", 0.13808571), ("prefixes", 0.45656088), ("type", 0.19679189)],
&[("edge", 0.24164537), ("from", 0.105276175), ("id", 0.1682396), ("ids", 0.15753444), ("inplace", 0.32349756), ("node", 0.060097933), ("replace", 0.49509498), ("type", 0.3145706)],
&[("edge", 0.28859687), ("from", 0.12670542), ("id", 0.20248522), ("ids", 0.189601), ("node", 0.07233103), ("replace", 0.59587294), ("type", 0.3756914)],
&[("add", 0.6557065), ("from", 0.15527742), ("id", 0.24814549), ("name", 0.34633583), ("node", 0.1675068), ("prefixes", 0.55951506), ("type", 0.24116832)],
&[("add", 1.4033958), ("inplace", 1.0212213), ("name", 0.7412557), ("node", 0.18971793), ("type", 0.5161678)],
&[("add", 0.53505254), ("from", 0.12670542), ("inplace", 0.38934636), ("name", 0.53952104), ("node", 0.13808571), ("prefixes", 0.45656088), ("type", 0.19679189)],
&[("add", 1.4033958), ("edge", 0.39650738), ("inplace", 1.0212213), ("name", 0.7412557), ("type", 0.5161678)],
&[("edge", 0.24164537), ("from", 0.105276175), ("inplace", 0.32349756), ("name", 0.23481143), ("names", 0.20734638), ("node", 0.060097933), ("replace", 0.49509498), ("type", 0.3145706)],
&[("edge", 0.28859687), ("from", 0.12670542), ("name", 0.2826079), ("names", 0.2495523), ("node", 0.07233103), ("replace", 0.59587294), ("type", 0.3756914)],
&[("add", 0.6557065), ("from", 0.15527742), ("name", 0.65447354), ("node", 0.1675068), ("prefixes", 0.55951506), ("type", 0.24116832)],
&[("homogeneous", 1.3295736), ("inplace", 1.0212213), ("node", 0.18971793), ("remove", 0.90078217), ("types", 0.63976794)],
&[("edge", 0.39650738), ("ids", 0.49730676), ("inplace", 1.0212213), ("remove", 0.90078217), ("type", 0.5161678)],
&[("edge", 0.39650738), ("inplace", 1.0212213), ("remove", 0.90078217), ("singleton", 0.95523125), ("types", 0.63976794)],
&[("inplace", 1.0212213), ("names", 0.6545537), ("node", 0.18971793), ("remove", 0.90078217), ("type", 0.5161678)],
&[("inplace", 1.0212213), ("name", 0.7412557), ("node", 0.18971793), ("remove", 0.90078217), ("type", 0.5161678)],
&[("id", 0.7351438), ("node", 0.2626054), ("remove", 1.2468524), ("type", 0.7144736)],
&[("node", 0.2626054), ("remove", 1.2468524), ("singleton", 1.3222201), ("types", 0.88555944)],
&[("homogeneous", 1.8403805), ("node", 0.2626054), ("remove", 1.2468524), ("types", 0.88555944)],
&[("inplace", 1.0212213), ("isomorphic", 1.0893799), ("node", 0.18971793), ("remove", 0.90078217), ("types", 0.63976794)],
&[("isomorphic", 1.5079073), ("node", 0.2626054), ("remove", 1.2468524), ("types", 0.88555944)],
&[("edge", 0.39650738), ("inplace", 1.0212213), ("isomorphic", 1.0893799), ("remove", 0.90078217), ("types", 0.63976794)],
&[("edge", 0.548841), ("isomorphic", 1.5079073), ("remove", 1.2468524), ("types", 0.88555944)],
&[("names", 0.90602577), ("node", 0.2626054), ("remove", 1.2468524), ("type", 0.7144736)],
&[("name", 1.0260377), ("node", 0.2626054), ("remove", 1.2468524), ("type", 0.7144736)],
&[("edge", 0.39650738), ("inplace", 1.0212213), ("name", 0.7412557), ("remove", 0.90078217), ("type", 0.5161678)],
&[("edge", 0.548841), ("id", 0.7351438), ("remove", 1.2468524), ("type", 0.7144736)],
&[("edge", 0.548841), ("remove", 1.2468524), ("singleton", 1.3222201), ("types", 0.88555944)],
&[("edge", 0.548841), ("name", 1.0260377), ("remove", 1.2468524), ("type", 0.7144736)],
&[("inplace", 1.4135628), ("node", 0.2626054), ("remove", 1.2468524), ("types", 0.88555944)],
&[("node", 0.38237324), ("remove", 1.8155111), ("types", 1.2894413)],
&[("edge", 0.548841), ("inplace", 1.4135628), ("remove", 1.2468524), ("types", 0.88555944)],
&[("edge", 0.79915386), ("remove", 1.8155111), ("types", 1.2894413)],
&[("edge", 0.548841), ("inplace", 1.4135628), ("remove", 1.2468524), ("weights", 1.5763028)],
&[("edge", 0.79915386), ("remove", 1.8155111), ("weights", 2.2952158)],
&[("divide", 2.4174616), ("edge", 0.548841), ("inplace", 1.4135628), ("weights", 1.5763028)],
&[("divide", 3.5200067), ("edge", 0.79915386), ("weights", 2.2952158)],
&[("edge", 0.548841), ("inplace", 1.4135628), ("normalize", 2.4174616), ("weights", 1.5763028)],
&[("edge", 0.79915386), ("normalize", 3.5200067), ("weights", 2.2952158)],
&[("edge", 0.548841), ("inplace", 1.4135628), ("multiply", 2.4174616), ("weights", 1.5763028)],
&[("edge", 0.79915386), ("multiply", 3.5200067), ("weights", 2.2952158)],
&[("bipartite", 0.8473697), ("build", 0.7983465), ("edge", 0.23202254), ("from", 0.19447234), ("graph", 0.53712267), ("ids", 0.2910069), ("node", 0.11101644)],
&[("build", 1.0267035), ("clique", 1.0561185), ("from", 0.2500987), ("graph", 0.6907598), ("ids", 0.37424573), ("node", 0.14277129)],
&[("bipartite", 0.8473697), ("build", 0.7983465), ("edge", 0.23202254), ("from", 0.19447234), ("graph", 0.53712267), ("names", 0.3830224), ("node", 0.11101644)],
&[("build", 1.0267035), ("clique", 1.0561185), ("from", 0.2500987), ("graph", 0.6907598), ("names", 0.49258113), ("node", 0.14277129)],
&[("bipartite", 0.8473697), ("build", 0.7983465), ("edge", 0.23202254), ("from", 0.19447234), ("graph", 0.53712267), ("node", 0.11101644), ("prefixes", 0.70074713)],
&[("build", 1.0267035), ("clique", 1.0561185), ("from", 0.2500987), ("graph", 0.6907598), ("node", 0.14277129), ("prefixes", 0.901187)],
&[("bipartite", 0.8473697), ("build", 0.7983465), ("edge", 0.23202254), ("from", 0.19447234), ("graph", 0.53712267), ("node", 0.11101644), ("types", 0.37437028)],
&[("build", 1.0267035), ("clique", 1.0561185), ("from", 0.2500987), ("graph", 0.6907598), ("node", 0.14277129), ("types", 0.48145416)],
&[("circles", 5.935091), ("get", 0.37883428)],
&[("get", 0.24520314), ("memory", 2.5069976), ("stats", 3.8415294)],
&[("get", 0.16840003), ("memory", 1.7217498), ("total", 1.7217498), ("used", 2.6382763)],
&[("get", 0.12165975), ("memory", 1.2438694), ("nodes", 0.847334), ("requirement", 1.5629222), ("total", 1.2438694)],
&[("get", 0.07119112), ("human", 0.8778975), ("memory", 0.72786975), ("nodes", 0.49583086), ("readable", 0.8778975), ("requirement", 0.91456854), ("total", 0.72786975)],
&[("edges", 1.0467286), ("get", 0.12165975), ("memory", 1.2438694), ("requirement", 1.5629222), ("total", 1.2438694)],
&[("edges", 0.6125097), ("get", 0.07119112), ("human", 0.8778975), ("memory", 0.72786975), ("readable", 0.8778975), ("requirement", 0.91456854), ("total", 0.72786975)],
&[("edge", 0.29838964), ("get", 0.09155444), ("memory", 0.9360677), ("requirements", 1.0897491), ("total", 0.9360677), ("weights", 0.85699224)],
&[("edge", 0.18525955), ("get", 0.056842905), ("human", 0.70096165), ("memory", 0.5811713), ("readable", 0.70096165), ("requirements", 0.67658657), ("total", 0.5811713), ("weights", 0.53207606)],
&[("get", 0.09155444), ("memory", 0.9360677), ("node", 0.14277129), ("requirements", 1.0897491), ("total", 0.9360677), ("types", 0.48145416)],
&[("get", 0.056842905), ("human", 0.70096165), ("memory", 0.5811713), ("node", 0.08864163), ("readable", 0.70096165), ("requirements", 0.67658657), ("total", 0.5811713), ("types", 0.29891783)],
&[("edge", 0.29838964), ("get", 0.09155444), ("memory", 0.9360677), ("requirements", 1.0897491), ("total", 0.9360677), ("types", 0.48145416)],
&[("edge", 0.18525955), ("get", 0.056842905), ("human", 0.70096165), ("memory", 0.5811713), ("readable", 0.70096165), ("requirements", 0.67658657), ("total", 0.5811713), ("types", 0.29891783)],
&[("get", 0.16840003), ("number", 1.1181947), ("of", 1.153866), ("triangles", 2.4174616)],
&[("get", 0.16840003), ("number", 1.1181947), ("of", 1.153866), ("triads", 2.4174616)],
&[("get", 0.12165975), ("number", 0.80783415), ("of", 0.8336047), ("triads", 1.746483), ("weighted", 0.8925635)],
&[("get", 0.37883428), ("transitivity", 5.935091)],
&[("get", 0.09155444), ("node", 0.14277129), ("number", 0.60793155), ("of", 0.62732506), ("per", 1.3143071), ("triangles", 1.3143071)],
&[("clustering", 1.6414056), ("coefficient", 1.4033958), ("get", 0.12165975), ("node", 0.18971793), ("per", 1.746483)],
&[("clustering", 3.308225), ("coefficient", 2.8285203), ("get", 0.24520314)],
&[("average", 2.6382763), ("clustering", 2.2720149), ("coefficient", 1.9425644), ("get", 0.16840003)],
&[("are", 3.8415294), ("nodes", 1.7077873), ("remappable", 3.8415294)],
&[("from", 0.33233717), ("ids", 0.49730676), ("node", 0.18971793), ("remap", 1.5002545), ("unchecked", 0.6583622)],
&[("from", 0.46001732), ("ids", 0.6883663), ("node", 0.2626054), ("remap", 2.0766351)],
&[("from", 0.46001732), ("names", 0.90602577), ("node", 0.2626054), ("remap", 2.0766351)],
&[("from", 0.33233717), ("map", 1.9060094), ("names", 0.6545537), ("node", 0.18971793), ("remap", 1.5002545)],
&[("from", 0.66981995), ("graph", 1.8500084), ("remap", 3.0237372)],
&[("graph", 1.8500084), ("negative", 3.5200067), ("sample", 3.5200067)],
&[("graph", 1.8500084), ("positive", 3.8415294), ("sample", 3.5200067)],
&[("connected", 3.9543476), ("holdout", 4.248297)],
&[("holdout", 4.248297), ("random", 3.492027)],
&[("get", 0.12165975), ("holdout", 1.3643084), ("indices", 1.9060094), ("label", 1.2699087), ("node", 0.18971793)],
&[("get", 0.12165975), ("holdout", 1.3643084), ("label", 1.2699087), ("labels", 1.9060094), ("node", 0.18971793)],
&[("get", 0.12165975), ("graphs", 1.746483), ("holdout", 1.3643084), ("label", 1.2699087), ("node", 0.18971793)],
&[("edge", 0.39650738), ("get", 0.12165975), ("graphs", 1.746483), ("holdout", 1.3643084), ("label", 1.2699087)],
&[("get", 0.24520314), ("random", 2.2602391), ("subgraph", 3.5200067)],
&[("get", 0.12165975), ("holdout", 1.3643084), ("label", 1.2699087), ("node", 0.18971793), ("random", 1.121438)],
&[("get", 0.16840003), ("kfold", 2.2720149), ("label", 1.7577931), ("node", 0.2626054)],
&[("edge", 0.39650738), ("get", 0.12165975), ("holdout", 1.3643084), ("label", 1.2699087), ("random", 1.121438)],
&[("edge", 0.548841), ("get", 0.16840003), ("kfold", 2.2720149), ("label", 1.7577931)],
&[("edge", 0.548841), ("get", 0.16840003), ("kfold", 2.2720149), ("prediction", 2.6382763)],
&[("get", 0.24520314), ("node", 0.38237324), ("tuples", 3.8415294)],
&[("chains", 5.935091), ("get", 0.37883428)],
&[("breadth", 0.42117593), ("first", 0.42117593), ("from", 0.105276175), ("get", 0.038538788), ("id", 0.1682396), ("node", 0.060097933), ("parallel", 0.4752434), ("predecessors", 0.6037765), ("search", 0.42117593), ("unchecked", 0.20855281)],
&[("breadth", 0.42117593), ("distances", 0.5199566), ("first", 0.42117593), ("from", 0.105276175), ("get", 0.038538788), ("ids", 0.15753444), ("node", 0.060097933), ("parallel", 0.4752434), ("search", 0.42117593), ("unchecked", 0.20855281)],
&[("breadth", 0.42117593), ("distances", 0.5199566), ("first", 0.42117593), ("from", 0.105276175), ("get", 0.038538788), ("id", 0.1682396), ("node", 0.060097933), ("parallel", 0.4752434), ("search", 0.42117593), ("unchecked", 0.20855281)],
&[("breadth", 0.42117593), ("distances", 0.5199566), ("first", 0.42117593), ("from", 0.105276175), ("get", 0.038538788), ("id", 0.1682396), ("node", 0.060097933), ("search", 0.42117593), ("sequential", 0.6037765), ("unchecked", 0.20855281)],
&[("breadth", 0.6212147), ("first", 0.6212147), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("node", 0.08864163), ("search", 0.6212147), ("unchecked", 0.3076056)],
&[("breadth", 0.6212147), ("first", 0.6212147), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("node", 0.08864163), ("search", 0.6212147), ("unchecked", 0.3076056)],
&[("from", 0.12670542), ("get", 0.046383467), ("ids", 0.36196342), ("node", 0.13808571), ("path", 0.45656088), ("shortest", 0.4411766), ("unchecked", 0.2510043)],
&[("from", 0.12670542), ("get", 0.046383467), ("ids", 0.189601), ("names", 0.2495523), ("node", 0.13808571), ("path", 0.45656088), ("shortest", 0.4411766), ("unchecked", 0.2510043)],
&[("from", 0.15527742), ("get", 0.056842905), ("ids", 0.4390848), ("node", 0.1675068), ("path", 0.55951506), ("shortest", 0.5406616)],
&[("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("names", 0.30582616), ("node", 0.1675068), ("path", 0.55951506), ("shortest", 0.5406616)],
&[("from", 0.15527742), ("get", 0.056842905), ("names", 0.57792217), ("node", 0.1675068), ("path", 0.55951506), ("shortest", 0.5406616)],
&[("from", 0.105276175), ("get", 0.038538788), ("ids", 0.30307603), ("k", 0.44456095), ("node", 0.1156207), ("path", 0.3793443), ("shortest", 0.36656192), ("unchecked", 0.20855281)],
&[("from", 0.12670542), ("get", 0.046383467), ("ids", 0.36196342), ("k", 0.53505254), ("node", 0.13808571), ("path", 0.45656088), ("shortest", 0.4411766)],
&[("from", 0.12670542), ("get", 0.046383467), ("ids", 0.189601), ("k", 0.53505254), ("names", 0.2495523), ("node", 0.13808571), ("path", 0.45656088), ("shortest", 0.4411766)],
&[("from", 0.12670542), ("get", 0.046383467), ("k", 0.53505254), ("names", 0.47641522), ("node", 0.13808571), ("path", 0.45656088), ("shortest", 0.4411766)],
&[("and", 0.3092391), ("distant", 0.4667266), ("eccentricity", 0.3869833), ("from", 0.08881312), ("get", 0.032512106), ("id", 0.2746908), ("most", 0.4176722), ("node", 0.09812405), ("unchecked", 0.1759394)],
&[("eccentricity", 0.8473697), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("node", 0.11101644), ("unchecked", 0.38525102), ("weighted", 0.52229756)],
&[("and", 0.36656192), ("distant", 0.55324244), ("eccentricity", 0.45871738), ("from", 0.105276175), ("get", 0.038538788), ("id", 0.32367134), ("most", 0.49509498), ("node", 0.1156207)],
&[("eccentricity", 1.0897491), ("from", 0.2500987), ("get", 0.09155444), ("id", 0.39967737), ("node", 0.14277129), ("weighted", 0.6716942)],
&[("eccentricity", 1.4480848), ("from", 0.33233717), ("get", 0.12165975), ("name", 0.7412557), ("node", 0.18971793)],
&[("eccentricity", 1.0897491), ("from", 0.2500987), ("get", 0.09155444), ("name", 0.5578283), ("node", 0.14277129), ("weighted", 0.6716942)],
&[("dijkstra", 1.1761694), ("from", 0.2500987), ("get", 0.09155444), ("ids", 0.37424573), ("node", 0.14277129), ("unchecked", 0.49544722)],
&[("dijkstra", 1.1761694), ("from", 0.2500987), ("get", 0.09155444), ("id", 0.39967737), ("node", 0.14277129), ("unchecked", 0.49544722)],
&[("from", 0.105276175), ("get", 0.038538788), ("ids", 0.30307603), ("node", 0.1156207), ("path", 0.3793443), ("shortest", 0.36656192), ("unchecked", 0.20855281), ("weighted", 0.28274196)],
&[("from", 0.105276175), ("get", 0.038538788), ("ids", 0.15753444), ("names", 0.20734638), ("node", 0.1156207), ("path", 0.3793443), ("shortest", 0.36656192), ("unchecked", 0.20855281), ("weighted", 0.28274196)],
&[("from", 0.12670542), ("get", 0.046383467), ("ids", 0.36196342), ("node", 0.13808571), ("path", 0.45656088), ("shortest", 0.4411766), ("weighted", 0.34029487)],
&[("from", 0.12670542), ("get", 0.046383467), ("ids", 0.189601), ("names", 0.2495523), ("node", 0.13808571), ("path", 0.45656088), ("shortest", 0.4411766), ("weighted", 0.34029487)],
&[("from", 0.12670542), ("get", 0.046383467), ("names", 0.47641522), ("node", 0.13808571), ("path", 0.45656088), ("shortest", 0.4411766), ("weighted", 0.34029487)],
&[("breadth", 0.7780209), ("first", 0.7780209), ("from", 0.19447234), ("get", 0.07119112), ("ids", 0.2910069), ("node", 0.11101644), ("search", 0.7780209)],
&[("dijkstra", 1.5629222), ("from", 0.33233717), ("get", 0.12165975), ("ids", 0.49730676), ("node", 0.18971793)],
&[("diameter", 3.5200067), ("get", 0.24520314), ("naive", 3.8415294)],
&[("diameter", 5.4383445), ("get", 0.37883428)],
&[("breadth", 0.7780209), ("first", 0.7780209), ("from", 0.19447234), ("get", 0.07119112), ("names", 0.3830224), ("node", 0.11101644), ("search", 0.7780209)],
&[("dijkstra", 1.5629222), ("from", 0.33233717), ("get", 0.12165975), ("names", 0.6545537), ("node", 0.18971793)],
&[("components", 1.5629222), ("connected", 1.2699087), ("get", 0.12165975), ("number", 0.80783415), ("of", 0.8336047)],
&[("connected", 1.2699087), ("get", 0.12165975), ("nodes", 0.847334), ("number", 0.80783415), ("of", 0.8336047)],
&[("get", 0.07119112), ("nodes", 0.49583086), ("number", 0.47271687), ("of", 0.48779693), ("selfloops", 0.72786975), ("singleton", 0.5589686), ("with", 0.6125097)],
&[("get", 0.12165975), ("nodes", 0.847334), ("number", 0.80783415), ("of", 0.8336047), ("singleton", 0.95523125)],
&[("disconnected", 1.5629222), ("get", 0.12165975), ("nodes", 0.847334), ("number", 0.80783415), ("of", 0.8336047)],
&[("get", 0.16840003), ("ids", 0.6883663), ("node", 0.2626054), ("singleton", 1.3222201)],
&[("get", 0.16840003), ("names", 0.90602577), ("node", 0.2626054), ("singleton", 1.3222201)],
&[("get", 0.09155444), ("ids", 0.37424573), ("node", 0.14277129), ("selfloops", 0.9360677), ("singleton", 0.71885455), ("with", 0.7877104)],
&[("get", 0.09155444), ("names", 0.49258113), ("node", 0.14277129), ("selfloops", 0.9360677), ("singleton", 0.71885455), ("with", 0.7877104)],
&[("density", 5.935091), ("get", 0.37883428)],
&[("get", 0.16840003), ("nodes", 1.17287), ("rate", 2.0044224), ("trap", 2.0044224)],
&[("degrees", 1.6575922), ("get", 0.16840003), ("mean", 2.4174616), ("node", 0.2626054)],
&[("degrees", 1.1975191), ("get", 0.12165975), ("mean", 1.746483), ("node", 0.18971793), ("weighted", 0.8925635)],
&[("edges", 1.0467286), ("get", 0.12165975), ("number", 0.80783415), ("of", 0.8336047), ("undirected", 1.4033958)],
&[("edges", 0.7877104), ("get", 0.09155444), ("number", 0.60793155), ("of", 0.62732506), ("undirected", 1.0561185), ("unique", 0.95566344)],
&[("edges", 1.4488697), ("get", 0.16840003), ("number", 1.1181947), ("of", 1.153866)],
&[("edges", 1.0467286), ("get", 0.12165975), ("number", 0.80783415), ("of", 0.8336047), ("unique", 1.2699087)],
&[("degrees", 1.6575922), ("get", 0.16840003), ("median", 2.4174616), ("node", 0.2626054)],
&[("degrees", 1.1975191), ("get", 0.12165975), ("median", 1.746483), ("node", 0.18971793), ("weighted", 0.8925635)],
&[("degree", 1.4676671), ("get", 0.16840003), ("maximum", 1.88846), ("node", 0.2626054)],
&[("central", 1.129009), ("get", 0.09155444), ("id", 0.39967737), ("most", 1.1761694), ("node", 0.14277129), ("unchecked", 0.49544722)],
&[("central", 1.5002545), ("get", 0.12165975), ("id", 0.5311009), ("most", 1.5629222), ("node", 0.18971793)],
&[("degree", 1.4676671), ("get", 0.16840003), ("minimum", 1.9425644), ("node", 0.2626054)],
&[("degrees", 1.6575922), ("get", 0.16840003), ("mode", 2.6382763), ("node", 0.2626054)],
&[("get", 0.16840003), ("nodes", 1.17287), ("rate", 2.0044224), ("selfloop", 2.4174616)],
&[("get", 0.37883428), ("name", 2.308184)],
&[("get", 0.12165975), ("nodes", 0.847334), ("number", 0.80783415), ("of", 0.8336047), ("trap", 1.4480848)],
&[("get", 0.16840003), ("ids", 0.6883663), ("node", 0.2626054), ("source", 1.7217498)],
&[("directed", 1.0092086), ("get", 0.12165975), ("ids", 0.49730676), ("node", 0.18971793), ("source", 1.2438694)],
&[("get", 0.24520314), ("names", 1.3192419), ("source", 2.5069976)],
&[("destination", 1.88846), ("get", 0.16840003), ("ids", 0.6883663), ("node", 0.2626054)],
&[("destination", 1.3643084), ("directed", 1.0092086), ("get", 0.12165975), ("ids", 0.49730676), ("node", 0.18971793)],
&[("destination", 2.7497404), ("get", 0.24520314), ("names", 1.3192419)],
&[("get", 0.24520314), ("names", 1.3192419), ("node", 0.38237324)],
&[("get", 0.24520314), ("node", 0.38237324), ("urls", 3.8415294)],
&[("get", 0.24520314), ("node", 0.38237324), ("ontologies", 3.0237372)],
&[("from", 0.2500987), ("get", 0.09155444), ("name", 0.5578283), ("node", 0.14277129), ("ontology", 1.1761694), ("unchecked", 0.49544722)],
&[("from", 0.2500987), ("get", 0.09155444), ("id", 0.39967737), ("node", 0.14277129), ("ontology", 1.1761694), ("unchecked", 0.49544722)],
&[("from", 0.33233717), ("get", 0.12165975), ("name", 0.7412557), ("node", 0.18971793), ("ontology", 1.5629222)],
&[("from", 0.33233717), ("get", 0.12165975), ("id", 0.5311009), ("node", 0.18971793), ("ontology", 1.5629222)],
&[("get", 0.24520314), ("ids", 1.0023133), ("node", 0.38237324)],
&[("directed", 1.0092086), ("edge", 0.39650738), ("get", 0.12165975), ("ids", 0.49730676), ("type", 0.5161678)],
&[("edge", 0.39650738), ("get", 0.12165975), ("ids", 0.49730676), ("type", 0.5161678), ("undirected", 1.4033958)],
&[("edge", 0.39650738), ("get", 0.12165975), ("ids", 0.49730676), ("known", 1.0603087), ("type", 0.5161678)],
&[("directed", 0.471531), ("edge", 0.18525955), ("get", 0.056842905), ("known", 0.49540645), ("nodes", 0.39589864), ("source", 0.5811713), ("types", 0.29891783), ("with", 0.48906144)],
&[("destination", 0.6374438), ("directed", 0.471531), ("edge", 0.18525955), ("get", 0.056842905), ("known", 0.49540645), ("nodes", 0.39589864), ("types", 0.29891783), ("with", 0.48906144)],
&[("edge", 0.39650738), ("get", 0.12165975), ("ids", 0.49730676), ("type", 0.5161678), ("unique", 1.2699087)],
&[("edge", 0.548841), ("get", 0.16840003), ("names", 0.90602577), ("type", 0.7144736)],
&[("edge", 0.39650738), ("get", 0.12165975), ("names", 0.6545537), ("type", 0.5161678), ("unique", 1.2699087)],
&[("directed", 1.3969349), ("edge", 0.548841), ("get", 0.16840003), ("weights", 1.5763028)],
&[("edge", 0.548841), ("get", 0.16840003), ("undirected", 1.9425644), ("weights", 1.5763028)],
&[("get", 0.16840003), ("indegrees", 2.4174616), ("node", 0.2626054), ("weighted", 1.2354761)],
&[("get", 0.16840003), ("ids", 0.6883663), ("node", 0.2626054), ("type", 0.7144736)],
&[("get", 0.12165975), ("known", 1.0603087), ("mask", 1.3643084), ("node", 0.18971793), ("types", 0.63976794)],
&[("get", 0.12165975), ("mask", 1.3643084), ("node", 0.18971793), ("types", 0.63976794), ("unknown", 1.0893799)],
&[("edge", 0.39650738), ("get", 0.12165975), ("known", 1.0603087), ("mask", 1.3643084), ("types", 0.63976794)],
&[("edge", 0.39650738), ("get", 0.12165975), ("mask", 1.3643084), ("types", 0.63976794), ("unknown", 1.0893799)],
&[("encoded", 1.1761694), ("get", 0.09155444), ("hot", 1.1761694), ("node", 0.14277129), ("one", 1.1761694), ("types", 0.48145416)],
&[("encoded", 0.91456854), ("get", 0.07119112), ("hot", 0.91456854), ("known", 0.6204563), ("node", 0.11101644), ("one", 0.91456854), ("types", 0.37437028)],
&[("edge", 0.29838964), ("encoded", 1.1761694), ("get", 0.09155444), ("hot", 1.1761694), ("one", 1.1761694), ("types", 0.48145416)],
&[("edge", 0.23202254), ("encoded", 0.91456854), ("get", 0.07119112), ("hot", 0.91456854), ("known", 0.6204563), ("one", 0.91456854), ("types", 0.37437028)],
&[("get", 0.16840003), ("names", 0.90602577), ("node", 0.2626054), ("type", 0.7144736)],
&[("get", 0.12165975), ("ids", 0.49730676), ("node", 0.18971793), ("type", 0.5161678), ("unique", 1.2699087)],
&[("get", 0.12165975), ("names", 0.6545537), ("node", 0.18971793), ("type", 0.5161678), ("unique", 1.2699087)],
&[("directed", 0.7594749), ("edges", 0.7877104), ("get", 0.09155444), ("number", 0.60793155), ("of", 0.62732506), ("unique", 0.95566344)],
&[("get", 0.24520314), ("mapping", 3.308225), ("nodes", 1.7077873)],
&[("edge", 0.548841), ("get", 0.16840003), ("ids", 0.6883663), ("node", 0.2626054)],
&[("directed", 1.0092086), ("edge", 0.39650738), ("get", 0.12165975), ("ids", 0.49730676), ("node", 0.18971793)],
&[("directed", 1.0092086), ("edge", 0.39650738), ("get", 0.12165975), ("ids", 0.49730676), ("triples", 1.746483)],
&[("edge", 0.548841), ("get", 0.16840003), ("names", 0.90602577), ("node", 0.2626054)],
&[("directed", 1.0092086), ("edge", 0.39650738), ("get", 0.12165975), ("names", 0.6545537), ("node", 0.18971793)],
&[("directed", 1.0092086), ("edge", 0.39650738), ("get", 0.12165975), ("names", 0.6545537), ("triples", 1.746483)],
&[("get", 0.09155444), ("node", 0.14277129), ("number", 0.60793155), ("of", 0.62732506), ("types", 0.48145416), ("unknown", 0.81980747)],
&[("get", 0.09155444), ("known", 0.79793), ("node", 0.14277129), ("number", 0.60793155), ("of", 0.62732506), ("types", 0.48145416)],
&[("get", 0.12165975), ("node", 0.18971793), ("rate", 1.4480848), ("types", 0.63976794), ("unknown", 1.0893799)],
&[("get", 0.12165975), ("known", 1.0603087), ("node", 0.18971793), ("rate", 1.4480848), ("types", 0.63976794)],
&[("get", 0.12165975), ("minimum", 1.4033958), ("node", 0.18971793), ("number", 0.80783415), ("types", 0.63976794)],
&[("get", 0.12165975), ("maximum", 1.3643084), ("node", 0.18971793), ("number", 0.80783415), ("types", 0.63976794)],
&[("count", 1.9425644), ("get", 0.16840003), ("maximum", 1.88846), ("multilabel", 2.4174616)],
&[("get", 0.09155444), ("node", 0.14277129), ("number", 0.60793155), ("of", 0.62732506), ("singleton", 0.71885455), ("types", 0.48145416)],
&[("get", 0.09155444), ("homogeneous", 1.000564), ("node", 0.14277129), ("number", 0.60793155), ("of", 0.62732506), ("types", 0.48145416)],
&[("get", 0.12165975), ("homogeneous", 1.3295736), ("ids", 0.49730676), ("node", 0.18971793), ("type", 0.5161678)],
&[("get", 0.12165975), ("homogeneous", 1.3295736), ("names", 0.6545537), ("node", 0.18971793), ("type", 0.5161678)],
&[("get", 0.12165975), ("ids", 0.49730676), ("node", 0.18971793), ("singleton", 0.95523125), ("type", 0.5161678)],
&[("get", 0.12165975), ("names", 0.6545537), ("node", 0.18971793), ("singleton", 0.95523125), ("type", 0.5161678)],
&[("edge", 0.29838964), ("get", 0.09155444), ("number", 0.60793155), ("of", 0.62732506), ("types", 0.48145416), ("unknown", 0.81980747)],
&[("edge", 0.43243533), ("get", 0.07119112), ("ids", 0.2910069), ("types", 0.37437028), ("unknown", 0.6374678), ("with", 0.6125097)],
&[("edge", 0.43243533), ("get", 0.07119112), ("ids", 0.2910069), ("known", 0.6204563), ("types", 0.37437028), ("with", 0.6125097)],
&[("edge", 0.35008645), ("get", 0.056842905), ("ids", 0.2323559), ("node", 0.08864163), ("types", 0.29891783), ("unknown", 0.5089894), ("with", 0.48906144)],
&[("edge", 0.35008645), ("get", 0.056842905), ("ids", 0.2323559), ("known", 0.49540645), ("node", 0.08864163), ("types", 0.29891783), ("with", 0.48906144)],
&[("edge", 0.35008645), ("get", 0.056842905), ("names", 0.30582616), ("node", 0.08864163), ("types", 0.29891783), ("unknown", 0.5089894), ("with", 0.48906144)],
&[("edge", 0.35008645), ("get", 0.056842905), ("known", 0.49540645), ("names", 0.30582616), ("node", 0.08864163), ("types", 0.29891783), ("with", 0.48906144)],
&[("edge", 0.23202254), ("edges", 0.6125097), ("get", 0.07119112), ("mask", 0.7983465), ("types", 0.37437028), ("unknown", 0.6374678), ("with", 0.6125097)],
&[("edge", 0.23202254), ("edges", 0.6125097), ("get", 0.07119112), ("known", 0.6204563), ("mask", 0.7983465), ("types", 0.37437028), ("with", 0.6125097)],
&[("get", 0.07119112), ("ids", 0.2910069), ("node", 0.20690848), ("types", 0.37437028), ("unknown", 0.6374678), ("with", 0.6125097)],
&[("get", 0.07119112), ("ids", 0.2910069), ("known", 0.6204563), ("node", 0.20690848), ("types", 0.37437028), ("with", 0.6125097)],
&[("get", 0.07119112), ("names", 0.3830224), ("node", 0.20690848), ("types", 0.37437028), ("unknown", 0.6374678), ("with", 0.6125097)],
&[("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("ids", 0.2910069), ("node", 0.20690848), ("type", 0.30204374)],
&[("from", 0.19447234), ("get", 0.07119112), ("ids", 0.5423683), ("node", 0.20690848), ("type", 0.30204374)],
&[("from", 0.19447234), ("get", 0.07119112), ("ids", 0.2910069), ("names", 0.3830224), ("node", 0.20690848), ("type", 0.30204374)],
&[("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("names", 0.3830224), ("node", 0.20690848), ("type", 0.30204374)],
&[("from", 0.19447234), ("get", 0.07119112), ("ids", 0.2910069), ("name", 0.43375745), ("node", 0.20690848), ("type", 0.30204374)],
&[("from", 0.19447234), ("get", 0.07119112), ("name", 0.43375745), ("names", 0.3830224), ("node", 0.20690848), ("type", 0.30204374)],
&[("get", 0.07119112), ("known", 0.6204563), ("names", 0.3830224), ("node", 0.20690848), ("types", 0.37437028), ("with", 0.6125097)],
&[("get", 0.07119112), ("mask", 0.7983465), ("node", 0.11101644), ("nodes", 0.49583086), ("types", 0.37437028), ("unknown", 0.6374678), ("with", 0.6125097)],
&[("get", 0.07119112), ("known", 0.6204563), ("mask", 0.7983465), ("node", 0.11101644), ("nodes", 0.49583086), ("types", 0.37437028), ("with", 0.6125097)],
&[("edge", 0.29838964), ("get", 0.09155444), ("known", 0.79793), ("number", 0.60793155), ("of", 0.62732506), ("types", 0.48145416)],
&[("edge", 0.39650738), ("get", 0.12165975), ("rate", 1.4480848), ("types", 0.63976794), ("unknown", 1.0893799)],
&[("edge", 0.39650738), ("get", 0.12165975), ("known", 1.0603087), ("rate", 1.4480848), ("types", 0.63976794)],
&[("edge", 0.39650738), ("get", 0.12165975), ("minimum", 1.4033958), ("number", 0.80783415), ("types", 0.63976794)],
&[("edge", 0.29838964), ("get", 0.09155444), ("number", 0.60793155), ("of", 0.62732506), ("singleton", 0.71885455), ("types", 0.48145416)],
&[("edge", 0.39650738), ("get", 0.12165975), ("ids", 0.49730676), ("singleton", 0.95523125), ("type", 0.5161678)],
&[("edge", 0.39650738), ("get", 0.12165975), ("names", 0.6545537), ("singleton", 0.95523125), ("type", 0.5161678)],
&[("get", 0.16840003), ("nodes", 1.17287), ("number", 1.1181947), ("of", 1.153866)],
&[("component", 1.9060094), ("connected", 1.2699087), ("get", 0.12165975), ("ids", 0.49730676), ("node", 0.18971793)],
&[("directed", 1.0092086), ("edges", 1.0467286), ("get", 0.12165975), ("number", 0.80783415), ("of", 0.8336047)],
&[("edge", 0.39650738), ("get", 0.12165975), ("number", 0.80783415), ("of", 0.8336047), ("types", 0.63976794)],
&[("get", 0.12165975), ("node", 0.18971793), ("number", 0.80783415), ("of", 0.8336047), ("types", 0.63976794)],
&[("degrees", 2.4135792), ("get", 0.24520314), ("node", 0.38237324)],
&[("get", 0.24520314), ("indegrees", 3.5200067), ("node", 0.38237324)],
&[("degrees", 1.6575922), ("get", 0.16840003), ("node", 0.2626054), ("weighted", 1.2354761)],
&[("get", 0.12165975), ("ids", 0.49730676), ("node", 0.18971793), ("not", 1.4480848), ("singletons", 1.9060094)],
&[("dense", 2.6382763), ("get", 0.16840003), ("mapping", 2.2720149), ("nodes", 1.17287)],
&[("edges", 1.0467286), ("get", 0.12165975), ("number", 0.80783415), ("of", 0.8336047), ("parallel", 1.5002545)],
&[("cumulative", 2.4174616), ("degrees", 1.6575922), ("get", 0.16840003), ("node", 0.2626054)],
&[("degrees", 1.6575922), ("get", 0.16840003), ("reciprocal", 2.0766351), ("sqrt", 2.0766351)],
&[("get", 0.09155444), ("nodes", 0.637657), ("number", 0.60793155), ("of", 0.62732506), ("source", 0.9360677), ("unique", 0.95566344)],
&[("counts", 1.0897491), ("edge", 0.29838964), ("get", 0.09155444), ("hashmap", 1.0897491), ("id", 0.39967737), ("type", 0.38843954)],
&[("counts", 1.0897491), ("edge", 0.29838964), ("get", 0.09155444), ("hashmap", 1.0897491), ("names", 0.49258113), ("type", 0.38843954)],
&[("counts", 1.0897491), ("get", 0.09155444), ("hashmap", 1.0897491), ("id", 0.39967737), ("node", 0.14277129), ("type", 0.38843954)],
&[("counts", 1.0897491), ("get", 0.09155444), ("hashmap", 1.0897491), ("names", 0.49258113), ("node", 0.14277129), ("type", 0.38843954)],
&[("get", 0.09155444), ("ids", 0.37424573), ("label", 0.95566344), ("node", 0.14277129), ("single", 1.3143071), ("type", 0.38843954)],
&[("get", 0.07119112), ("ids", 0.2910069), ("known", 0.6204563), ("label", 0.7431071), ("node", 0.11101644), ("single", 1.021982), ("type", 0.30204374)],
&[("boolean", 1.746483), ("get", 0.12165975), ("ids", 0.49730676), ("node", 0.18971793), ("type", 0.5161678)],
&[("boolean", 1.3143071), ("get", 0.09155444), ("ids", 0.37424573), ("known", 0.79793), ("node", 0.14277129), ("type", 0.38843954)],
&[("directed", 2.0340426), ("inplace", 2.058254), ("to", 2.5069976)],
&[("directed", 3.1425576), ("to", 3.873264)],
&[("to", 2.5069976), ("triangular", 3.5200067), ("upper", 3.8415294)],
&[("lower", 3.8415294), ("to", 2.5069976), ("triangular", 3.5200067)],
&[("diagonal", 3.5200067), ("main", 3.8415294), ("to", 2.5069976)],
&[("anti", 3.8415294), ("diagonal", 3.5200067), ("to", 2.5069976)],
&[("bidiagonal", 5.935091), ("to", 3.873264)],
&[("arrowhead", 5.935091), ("to", 3.873264)],
&[("to", 3.873264), ("transposed", 5.935091)],
&[("complementary", 5.935091), ("to", 3.873264)],
&[("graph", 0.9178983), ("multi", 1.9060094), ("similarity", 1.9060094), ("structural", 1.746483), ("to", 1.2438694)],
&[("approximated", 2.6167386), ("cliques", 3.5200067), ("get", 0.24520314)],
&[("clique", 2.8285203), ("get", 0.24520314), ("max", 3.5200067)],
&[("approximated", 1.2983184), ("cliques", 1.746483), ("get", 0.12165975), ("number", 0.80783415), ("of", 0.8336047)],
&[("report", 7.6002703)],
&[("overlap", 3.8415294), ("report", 3.0237372), ("textual", 3.5200067)],
&[("from", 0.2500987), ("get", 0.09155444), ("id", 0.39967737), ("node", 0.26100656), ("report", 1.129009)],
&[("from", 0.2500987), ("get", 0.09155444), ("name", 0.5578283), ("node", 0.26100656), ("report", 1.129009)],
&[("report", 4.6716175), ("textual", 5.4383445)],
&[("connected", 1.7577931), ("generate", 1.7577931), ("graph", 1.2705443), ("random", 1.5522816)],
&[("generate", 1.7577931), ("random", 1.5522816), ("spanning", 2.2720149), ("tree", 2.6382763)],
&[("generate", 2.5594792), ("graph", 1.8500084), ("star", 3.308225)],
&[("generate", 2.5594792), ("graph", 1.8500084), ("wheel", 3.8415294)],
&[("circle", 3.8415294), ("generate", 2.5594792), ("graph", 1.8500084)],
&[("chain", 3.8415294), ("generate", 2.5594792), ("graph", 1.8500084)],
&[("complete", 3.8415294), ("generate", 2.5594792), ("graph", 1.8500084)],
&[("barbell", 3.8415294), ("generate", 2.5594792), ("graph", 1.8500084)],
&[("generate", 2.5594792), ("graph", 1.8500084), ("lollipop", 3.8415294)],
&[("generate", 1.7577931), ("graph", 1.2705443), ("lattice", 2.6382763), ("squared", 2.6382763)],
&[("filter", 3.5200067), ("from", 0.66981995), ("ids", 1.0023133)],
&[("filter", 3.5200067), ("from", 0.66981995), ("names", 1.3192419)],
&[("node", 0.2626054), ("remove", 1.2468524), ("types", 0.88555944), ("unknown", 1.5079073)],
&[("edge", 0.548841), ("remove", 1.2468524), ("types", 0.88555944), ("unknown", 1.5079073)],
&[("nodes", 1.7077873), ("remove", 1.8155111), ("singleton", 1.9252523)],
&[("remove", 2.8049307), ("tendrils", 5.4383445)],
&[("dendritic", 3.5200067), ("remove", 1.8155111), ("trees", 3.5200067)],
&[("isomorphic", 2.1956267), ("nodes", 1.7077873), ("remove", 1.8155111)],
&[("nodes", 0.847334), ("remove", 0.90078217), ("selfloops", 1.2438694), ("singleton", 0.95523125), ("with", 1.0467286)],
&[("disconnected", 3.150043), ("nodes", 1.7077873), ("remove", 1.8155111)],
&[("remove", 2.8049307), ("selfloops", 3.873264)],
&[("edges", 2.1096637), ("parallel", 3.0237372), ("remove", 1.8155111)],
&[("arborescence", 2.4174616), ("kruskal", 2.4174616), ("random", 1.5522816), ("spanning", 2.2720149)],
&[("arborescence", 3.5200067), ("kruskal", 3.5200067), ("spanning", 3.308225)],
&[("components", 3.150043), ("connected", 2.5594792), ("get", 0.24520314)],
&[("enable", 9.65582)],
&[("all", 3.9543476), ("disable", 5.935091)],
&[("compatible", 2.163379), ("has", 1.0473012), ("node", 0.2626054), ("vocabularies", 2.2720149)],
&[("compatible", 1.5629222), ("has", 0.7566174), ("node", 0.18971793), ("types", 0.63976794), ("vocabularies", 1.6414056)],
&[("compatible", 1.5629222), ("edge", 0.39650738), ("has", 0.7566174), ("types", 0.63976794), ("vocabularies", 1.6414056)],
&[("compatible", 4.8667574), ("is", 3.6640813)],
&[("adjacency", 2.6382763), ("has", 1.0473012), ("matrix", 1.6287634), ("same", 2.6382763)],
&[("approximated", 1.7971175), ("cover", 2.6382763), ("set", 2.0044224), ("vertex", 2.6382763)],
&[("get", 0.16840003), ("node", 0.2626054), ("random", 1.5522816), ("type", 0.7144736)],
&[("edge", 0.548841), ("get", 0.16840003), ("random", 1.5522816), ("type", 0.7144736)],
&[("edge", 0.29838964), ("get", 0.09155444), ("random", 0.84393257), ("type", 0.38843954), ("unchecked", 0.49544722), ("zifian", 1.3143071)],
&[("edge", 0.39650738), ("get", 0.12165975), ("random", 1.121438), ("type", 0.5161678), ("zifian", 1.746483)],
&[("get", 0.24520314), ("node", 0.38237324), ("random", 2.2602391)],
&[("edge", 0.548841), ("get", 0.16840003), ("id", 0.7351438), ("random", 1.5522816)],
&[("free", 1.3143071), ("get", 0.09155444), ("node", 0.14277129), ("outbounds", 1.4343579), ("random", 0.84393257), ("scale", 1.3143071)],
&[("free", 1.3143071), ("get", 0.09155444), ("inbounds", 1.4343579), ("node", 0.14277129), ("random", 0.84393257), ("scale", 1.3143071)],
&[("get", 0.12165975), ("nodes", 0.847334), ("random", 1.121438), ("sorted", 1.5629222), ("unique", 1.2699087)],
&[("breadth", 1.000564), ("first", 1.000564), ("get", 0.09155444), ("nodes", 0.637657), ("random", 0.84393257), ("search", 1.000564)],
&[("get", 0.09155444), ("nodes", 0.637657), ("random", 1.5428307), ("uniform", 1.4343579), ("walk", 1.4343579)],
&[("get", 0.16840003), ("methods", 2.2720149), ("node", 0.2626054), ("sampling", 2.6382763)],
&[("get", 0.24520314), ("nodes", 1.7077873), ("subsampled", 3.8415294)],
&[("bm25", 1.3143071), ("feature", 1.4343579), ("get", 0.09155444), ("node", 0.14277129), ("okapi", 1.3143071), ("propagation", 1.3143071)],
&[("bm25", 1.3143071), ("get", 0.09155444), ("label", 0.95566344), ("node", 0.14277129), ("okapi", 1.3143071), ("propagation", 1.3143071)],
&[("default", 2.6382763), ("graph", 1.2705443), ("has", 1.0473012), ("name", 1.0260377)],
&[("has", 2.3560185), ("nodes", 2.6384995)],
&[("edges", 3.2593908), ("has", 2.3560185)],
&[("has", 1.5249496), ("nodes", 1.7077873), ("trap", 2.9185903)],
&[("directed", 3.1425576), ("is", 3.6640813)],
&[("edge", 0.79915386), ("has", 1.5249496), ("weights", 2.2952158)],
&[("edge", 0.39650738), ("has", 0.7566174), ("probabilities", 1.9060094), ("representing", 1.9060094), ("weights", 1.1387919)],
&[("has", 1.0473012), ("nodes", 1.17287), ("singleton", 1.3222201), ("weighted", 1.2354761)],
&[("constant", 2.4174616), ("edge", 0.548841), ("has", 1.0473012), ("weights", 1.5763028)],
&[("constant", 1.3143071), ("degrees", 0.901187), ("has", 0.5693887), ("node", 0.14277129), ("non", 1.3143071), ("zero", 1.3143071)],
&[("edge", 0.548841), ("has", 1.0473012), ("negative", 2.4174616), ("weights", 1.5763028)],
&[("edge", 0.79915386), ("has", 1.5249496), ("types", 1.2894413)],
&[("has", 2.3560185), ("selfloops", 3.873264)],
&[("disconnected", 3.150043), ("has", 1.5249496), ("nodes", 1.7077873)],
&[("has", 1.5249496), ("nodes", 1.7077873), ("singleton", 1.9252523)],
&[("has", 0.7566174), ("nodes", 0.847334), ("selfloops", 1.2438694), ("singleton", 0.95523125), ("with", 1.0467286)],
&[("connected", 3.9543476), ("is", 3.6640813)],
&[("has", 1.5249496), ("node", 0.38237324), ("types", 1.2894413)],
&[("has", 1.0473012), ("multilabel", 2.4174616), ("node", 0.2626054), ("types", 0.88555944)],
&[("has", 1.0473012), ("node", 0.2626054), ("types", 0.88555944), ("unknown", 1.5079073)],
&[("has", 1.0473012), ("known", 1.4676671), ("node", 0.2626054), ("types", 0.88555944)],
&[("edge", 0.548841), ("has", 1.0473012), ("types", 0.88555944), ("unknown", 1.5079073)],
&[("edge", 0.548841), ("has", 1.0473012), ("known", 1.4676671), ("types", 0.88555944)],
&[("has", 1.0473012), ("homogeneous", 1.8403805), ("node", 0.2626054), ("types", 0.88555944)],
&[("exclusively", 1.9060094), ("has", 0.7566174), ("homogeneous", 1.3295736), ("node", 0.18971793), ("types", 0.63976794)],
&[("has", 1.0473012), ("homogeneous", 1.8403805), ("node", 0.2626054), ("ontologies", 2.0766351)],
&[("edge", 0.548841), ("has", 1.0473012), ("homogeneous", 1.8403805), ("types", 0.88555944)],
&[("has", 1.0473012), ("node", 0.2626054), ("singleton", 1.3222201), ("types", 0.88555944)],
&[("has", 1.5249496), ("node", 0.38237324), ("oddities", 3.308225)],
&[("has", 1.0473012), ("node", 0.2626054), ("oddities", 2.2720149), ("types", 0.88555944)],
&[("edge", 0.548841), ("has", 1.0473012), ("singleton", 1.3222201), ("types", 0.88555944)],
&[("edge", 0.548841), ("has", 1.0473012), ("oddities", 2.2720149), ("types", 0.88555944)],
&[("is", 3.6640813), ("multigraph", 4.6716175)],
&[("has", 1.5249496), ("node", 0.38237324), ("ontologies", 3.0237372)],
&[("has", 1.0473012), ("node", 0.2626054), ("ontologies", 2.0766351), ("unknown", 1.5079073)],
&[("by", 0.6557065), ("decreasing", 0.81600666), ("degree", 0.49540645), ("has", 0.35351324), ("node", 0.08864163), ("nodes", 0.39589864), ("outbound", 0.73024184), ("sorted", 0.73024184)],
&[("by", 1.0561185), ("has", 0.5693887), ("lexicographic", 1.3143071), ("nodes", 0.637657), ("order", 1.3143071), ("sorted", 1.1761694)],
&[("contains", 3.5200067), ("identity", 3.5200067), ("matrix", 2.3716025)],
&[("by", 0.6557065), ("degree", 0.49540645), ("has", 0.35351324), ("increasing", 0.81600666), ("node", 0.08864163), ("nodes", 0.39589864), ("outbound", 0.73024184), ("sorted", 0.73024184)],
&[("destinations", 2.6382763), ("enabled", 2.163379), ("has", 1.0473012), ("tradeoff", 2.163379)],
&[("enabled", 2.163379), ("has", 1.0473012), ("sources", 2.6382763), ("tradeoff", 2.163379)],
&[("cumulative", 1.3143071), ("degrees", 0.901187), ("enabled", 1.1761694), ("has", 0.5693887), ("node", 0.14277129), ("tradeoff", 1.1761694)],
&[("degrees", 0.901187), ("enabled", 1.1761694), ("has", 0.5693887), ("reciprocal", 1.129009), ("sqrt", 1.129009), ("tradeoff", 1.1761694)],
&[("dendritic", 3.5200067), ("get", 0.24520314), ("trees", 3.5200067)],
&[("closure", 3.8415294), ("get", 0.24520314), ("transitive", 3.8415294)],
&[("all", 1.7577931), ("get", 0.16840003), ("paths", 2.4174616), ("shortest", 1.6017379)],
&[("all", 1.2699087), ("get", 0.12165975), ("paths", 1.746483), ("shortest", 1.1571673), ("weighted", 0.8925635)],
&[("edge", 0.43243533), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("unchecked", 0.38525102), ("weight", 0.7431071)],
&[("edge", 0.23202254), ("from", 0.19447234), ("get", 0.07119112), ("ids", 0.2910069), ("node", 0.11101644), ("unchecked", 0.38525102), ("weight", 0.7431071)],
&[("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("name", 0.43375745), ("node", 0.20690848), ("unchecked", 0.38525102)],
&[("edge", 0.28859687), ("from", 0.12670542), ("get", 0.046383467), ("id", 0.20248522), ("name", 0.2826079), ("type", 0.3756914), ("unchecked", 0.2510043)],
&[("edge", 0.28859687), ("from", 0.12670542), ("get", 0.046383467), ("id", 0.20248522), ("name", 0.2826079), ("type", 0.3756914), ("unchecked", 0.2510043)],
&[("count", 0.6557065), ("edge", 0.35008645), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("type", 0.24116832), ("unchecked", 0.3076056)],
&[("count", 0.6557065), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("node", 0.1675068), ("type", 0.24116832), ("unchecked", 0.3076056)],
&[("and", 0.3092391), ("edge", 0.20507766), ("from", 0.08881312), ("get", 0.032512106), ("id", 0.2746908), ("ids", 0.13289925), ("node", 0.050699838), ("type", 0.13793965), ("unchecked", 0.1759394)],
&[("edge", 0.18525955), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.4390848), ("minmax", 0.73024184), ("node", 0.08864163), ("unchecked", 0.3076056)],
&[("edge", 0.23202254), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("ids", 0.2910069), ("node", 0.11101644), ("unchecked", 0.38525102)],
&[("edge", 0.23202254), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("names", 0.3830224), ("node", 0.11101644), ("unchecked", 0.38525102)],
&[("edge", 0.18525955), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.46892253), ("node", 0.08864163), ("source", 0.5811713), ("unchecked", 0.3076056)],
&[("destination", 0.6374438), ("edge", 0.18525955), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.46892253), ("node", 0.08864163), ("unchecked", 0.3076056)],
&[("edge", 0.23202254), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.5792245), ("node", 0.11101644), ("source", 0.72786975)],
&[("destination", 0.7983465), ("edge", 0.23202254), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.5792245), ("node", 0.11101644)],
&[("edge", 0.18525955), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("name", 0.34633583), ("node", 0.08864163), ("source", 0.5811713), ("unchecked", 0.3076056)],
&[("destination", 0.6374438), ("edge", 0.18525955), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("name", 0.34633583), ("node", 0.08864163), ("unchecked", 0.3076056)],
&[("edge", 0.23202254), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("name", 0.43375745), ("node", 0.11101644), ("source", 0.72786975)],
&[("destination", 0.7983465), ("edge", 0.23202254), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("name", 0.43375745), ("node", 0.11101644)],
&[("edge", 0.29838964), ("from", 0.2500987), ("get", 0.09155444), ("id", 0.39967737), ("names", 0.49258113), ("node", 0.14277129)],
&[("edge", 0.29838964), ("from", 0.2500987), ("get", 0.09155444), ("id", 0.39967737), ("ids", 0.37424573), ("node", 0.14277129)],
&[("edge", 0.23202254), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("ids", 0.2910069), ("node", 0.11101644), ("unchecked", 0.38525102)],
&[("edge", 0.29838964), ("from", 0.2500987), ("get", 0.09155444), ("id", 0.39967737), ("ids", 0.37424573), ("node", 0.14277129)],
&[("get", 0.09155444), ("id", 0.39967737), ("node", 0.14277129), ("source", 0.9360677), ("unchecked", 0.49544722), ("unique", 0.95566344)],
&[("and", 0.3092391), ("edge", 0.20507766), ("from", 0.08881312), ("get", 0.032512106), ("id", 0.2746908), ("ids", 0.13289925), ("node", 0.050699838), ("type", 0.13793965), ("unchecked", 0.1759394)],
&[("and", 0.36656192), ("edge", 0.24164537), ("from", 0.105276175), ("get", 0.038538788), ("id", 0.32367134), ("ids", 0.15753444), ("node", 0.060097933), ("type", 0.16350916)],
&[("and", 0.39027402), ("edge", 0.19645476), ("from", 0.057249088), ("get", 0.02095736), ("id", 0.17912266), ("ids", 0.08566709), ("node", 0.032681204), ("type", 0.08891614), ("unchecked", 0.11341083), ("weight", 0.2187571)],
&[("and", 0.4458319), ("edge", 0.22376412), ("from", 0.0655998), ("get", 0.02401433), ("id", 0.20462185), ("ids", 0.09816302), ("node", 0.037448287), ("type", 0.101886), ("weight", 0.25066635)],
&[("central", 1.129009), ("get", 0.09155444), ("ids", 0.37424573), ("k", 1.0561185), ("node", 0.14277129), ("top", 1.2352316)],
&[("central", 0.8778975), ("get", 0.07119112), ("ids", 0.2910069), ("k", 0.82121915), ("node", 0.11101644), ("top", 0.96049434), ("weighted", 0.52229756)],
&[("degree", 0.6204563), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("node", 0.20690848), ("unchecked", 0.38525102)],
&[("degree", 0.49540645), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("node", 0.1675068), ("unchecked", 0.3076056), ("weighted", 0.4170311)],
&[("degree", 0.79793), ("from", 0.2500987), ("get", 0.09155444), ("id", 0.39967737), ("node", 0.26100656)],
&[("comulative", 0.81600666), ("degree", 0.49540645), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("node", 0.1675068), ("unchecked", 0.3076056)],
&[("comulative", 1.021982), ("degree", 0.6204563), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("node", 0.20690848)],
&[("degree", 0.49540645), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("node", 0.08864163), ("reciprocal", 0.70096165), ("sqrt", 0.70096165), ("unchecked", 0.3076056)],
&[("degree", 0.6204563), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("node", 0.11101644), ("reciprocal", 0.8778975), ("sqrt", 0.8778975)],
&[("degrees", 0.55951506), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("node", 0.08864163), ("reciprocal", 0.70096165), ("sqrt", 0.70096165), ("unchecked", 0.3076056)],
&[("degree", 0.6204563), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("node", 0.20690848), ("weighted", 0.52229756)],
&[("degree", 0.79793), ("from", 0.2500987), ("get", 0.09155444), ("name", 0.5578283), ("node", 0.26100656)],
&[("central", 1.129009), ("get", 0.09155444), ("k", 1.0561185), ("names", 0.49258113), ("node", 0.14277129), ("top", 1.2352316)],
&[("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("ids", 0.2323559), ("node", 0.1675068), ("type", 0.24116832), ("unchecked", 0.3076056)],
&[("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("ids", 0.2910069), ("node", 0.20690848), ("type", 0.30204374)],
&[("edge", 0.35008645), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.46892253), ("type", 0.24116832), ("unchecked", 0.3076056)],
&[("edge", 0.43243533), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.5792245), ("type", 0.30204374)],
&[("edge", 0.35008645), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("ids", 0.2323559), ("node", 0.08864163), ("type", 0.24116832)],
&[("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("names", 0.30582616), ("node", 0.1675068), ("type", 0.24116832), ("unchecked", 0.3076056)],
&[("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("names", 0.3830224), ("node", 0.20690848), ("type", 0.30204374)],
&[("from", 0.19447234), ("get", 0.07119112), ("name", 0.43375745), ("names", 0.3830224), ("node", 0.20690848), ("type", 0.30204374)],
&[("edge", 0.43243533), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("name", 0.43375745), ("type", 0.30204374)],
&[("edge", 0.35008645), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("name", 0.34633583), ("type", 0.4557377)],
&[("edge", 0.54549944), ("from", 0.2500987), ("get", 0.09155444), ("id", 0.39967737), ("weight", 0.95566344)],
&[("edge", 0.29838964), ("from", 0.2500987), ("get", 0.09155444), ("ids", 0.37424573), ("node", 0.14277129), ("weight", 0.95566344)],
&[("and", 0.36656192), ("edge", 0.24164537), ("from", 0.105276175), ("get", 0.038538788), ("id", 0.1682396), ("ids", 0.15753444), ("node", 0.060097933), ("type", 0.16350916), ("weight", 0.40227556)],
&[("and", 0.36656192), ("edge", 0.24164537), ("from", 0.105276175), ("get", 0.038538788), ("name", 0.23481143), ("names", 0.20734638), ("node", 0.060097933), ("type", 0.16350916), ("weight", 0.40227556)],
&[("edge", 0.29838964), ("from", 0.2500987), ("get", 0.09155444), ("names", 0.49258113), ("node", 0.14277129), ("weight", 0.95566344)],
&[("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("name", 0.43375745), ("node", 0.20690848), ("unchecked", 0.38525102)],
&[("from", 0.2500987), ("get", 0.09155444), ("id", 0.39967737), ("name", 0.5578283), ("node", 0.26100656)],
&[("from", 0.2500987), ("get", 0.09155444), ("id", 0.39967737), ("name", 0.5578283), ("node", 0.26100656)],
&[("from", 0.2500987), ("get", 0.09155444), ("ids", 0.37424573), ("names", 0.49258113), ("node", 0.26100656)],
&[("edge", 0.35008645), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("names", 0.30582616), ("node", 0.1675068)],
&[("edge", 0.35008645), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("names", 0.30582616), ("node", 0.1675068)],
&[("from", 0.19447234), ("get", 0.07119112), ("ids", 0.2910069), ("name", 0.43375745), ("node", 0.20690848), ("type", 0.30204374)],
&[("from", 0.19447234), ("get", 0.07119112), ("name", 0.80842173), ("node", 0.20690848), ("type", 0.30204374)],
&[("count", 0.82121915), ("edge", 0.43243533), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("type", 0.30204374)],
&[("edge", 0.35008645), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("name", 0.34633583), ("type", 0.4557377)],
&[("count", 0.82121915), ("edge", 0.43243533), ("from", 0.19447234), ("get", 0.07119112), ("name", 0.43375745), ("type", 0.30204374)],
&[("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("name", 0.34633583), ("node", 0.1675068), ("type", 0.4557377)],
&[("count", 0.82121915), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("node", 0.20690848), ("type", 0.30204374)],
&[("count", 0.82121915), ("from", 0.19447234), ("get", 0.07119112), ("name", 0.43375745), ("node", 0.20690848), ("type", 0.30204374)],
&[("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("ids", 0.2910069), ("neighbour", 0.96049434), ("node", 0.20690848)],
&[("from", 0.19447234), ("get", 0.07119112), ("ids", 0.2910069), ("name", 0.43375745), ("neighbour", 0.96049434), ("node", 0.20690848)],
&[("from", 0.19447234), ("get", 0.07119112), ("name", 0.43375745), ("names", 0.3830224), ("neighbour", 0.96049434), ("node", 0.20690848)],
&[("edge", 0.23202254), ("from", 0.19447234), ("get", 0.07119112), ("ids", 0.5423683), ("minmax", 0.91456854), ("node", 0.11101644)],
&[("and", 0.36656192), ("edge", 0.24164537), ("from", 0.105276175), ("get", 0.038538788), ("id", 0.32367134), ("ids", 0.15753444), ("node", 0.060097933), ("type", 0.16350916)],
&[("edge", 0.29838964), ("from", 0.2500987), ("get", 0.09155444), ("id", 0.39967737), ("names", 0.49258113), ("node", 0.14277129)],
&[("and", 0.36656192), ("edge", 0.24164537), ("from", 0.105276175), ("get", 0.038538788), ("id", 0.1682396), ("name", 0.23481143), ("names", 0.20734638), ("node", 0.060097933), ("type", 0.16350916)],
&[("edge", 0.35008645), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("names", 0.30582616), ("type", 0.4557377)],
&[("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("names", 0.30582616), ("node", 0.1675068), ("type", 0.4557377)],
&[("from", 0.12670542), ("get", 0.046383467), ("ids", 0.189601), ("multiple", 0.7266768), ("names", 0.2495523), ("node", 0.13808571), ("type", 0.3756914)],
&[("edge", 0.15117067), ("from", 0.12670542), ("get", 0.046383467), ("id", 0.20248522), ("ids", 0.189601), ("minmax", 0.59587294), ("node", 0.07233103), ("source", 0.47423223), ("unchecked", 0.2510043)],
&[("edge", 0.18525955), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("ids", 0.2323559), ("minmax", 0.73024184), ("node", 0.08864163), ("source", 0.5811713)],
&[("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("name", 0.34633583), ("node", 0.1675068), ("type", 0.4557377)],
&[("from", 0.12670542), ("get", 0.046383467), ("ids", 0.189601), ("names", 0.2495523), ("node", 0.13808571), ("type", 0.3756914), ("unchecked", 0.2510043)],
&[("from", 0.12670542), ("get", 0.046383467), ("id", 0.20248522), ("node", 0.07233103), ("nodes", 0.3230509), ("number", 0.30799133), ("of", 0.3178165), ("type", 0.19679189), ("unchecked", 0.2510043)],
&[("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("node", 0.08864163), ("nodes", 0.39589864), ("number", 0.37744313), ("of", 0.3894839), ("type", 0.24116832)],
&[("from", 0.15527742), ("get", 0.056842905), ("name", 0.34633583), ("node", 0.08864163), ("nodes", 0.39589864), ("number", 0.37744313), ("of", 0.3894839), ("type", 0.24116832)],
&[("edge", 0.15117067), ("edges", 0.3990712), ("from", 0.12670542), ("get", 0.046383467), ("id", 0.20248522), ("number", 0.30799133), ("of", 0.3178165), ("type", 0.19679189), ("unchecked", 0.2510043)],
&[("edge", 0.18525955), ("edges", 0.48906144), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("number", 0.37744313), ("of", 0.3894839), ("type", 0.24116832)],
&[("edge", 0.18525955), ("edges", 0.48906144), ("from", 0.15527742), ("get", 0.056842905), ("name", 0.34633583), ("number", 0.37744313), ("of", 0.3894839), ("type", 0.24116832)],
&[("counts", 0.45871738), ("from", 0.105276175), ("get", 0.038538788), ("hashmap", 0.45871738), ("id", 0.1682396), ("ids", 0.15753444), ("node", 0.1156207), ("type", 0.16350916), ("unchecked", 0.20855281)],
&[("counts", 0.45871738), ("edge", 0.1256037), ("from", 0.105276175), ("get", 0.038538788), ("hashmap", 0.45871738), ("id", 0.1682396), ("ids", 0.15753444), ("node", 0.060097933), ("type", 0.16350916), ("unchecked", 0.20855281)],
&[("edge", 0.35008645), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("ids", 0.2323559), ("node", 0.08864163), ("type", 0.24116832)],
&[("directed", 0.38476646), ("edge", 0.28859687), ("from", 0.12670542), ("get", 0.046383467), ("id", 0.20248522), ("ids", 0.189601), ("node", 0.07233103), ("type", 0.19679189)],
&[("directed", 0.38476646), ("edge", 0.28859687), ("from", 0.12670542), ("get", 0.046383467), ("id", 0.20248522), ("names", 0.2495523), ("node", 0.07233103), ("type", 0.19679189)],
&[("directed", 0.38476646), ("edge", 0.28859687), ("from", 0.12670542), ("get", 0.046383467), ("name", 0.2826079), ("names", 0.2495523), ("node", 0.07233103), ("type", 0.19679189)],
&[("directed", 0.471531), ("edge", 0.35008645), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("ids", 0.2323559), ("type", 0.24116832)],
&[("edge", 0.35008645), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("name", 0.34633583), ("node", 0.08864163), ("type", 0.24116832)],
&[("directed", 0.38476646), ("edge", 0.28859687), ("from", 0.12670542), ("get", 0.046383467), ("ids", 0.189601), ("name", 0.2826079), ("node", 0.07233103), ("type", 0.19679189)],
&[("directed", 0.471531), ("edge", 0.35008645), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("name", 0.34633583), ("type", 0.24116832)],
&[("curie", 0.53505254), ("directed", 0.38476646), ("edge", 0.15117067), ("from", 0.12670542), ("get", 0.046383467), ("names", 0.2495523), ("node", 0.13808571), ("prefixes", 0.45656088)],
&[("curie", 0.53505254), ("directed", 0.38476646), ("edge", 0.15117067), ("from", 0.12670542), ("get", 0.046383467), ("ids", 0.189601), ("node", 0.13808571), ("prefixes", 0.45656088)],
&[("curie", 0.6557065), ("directed", 0.471531), ("edge", 0.18525955), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("node", 0.08864163), ("prefixes", 0.55951506)],
&[("curie", 0.53505254), ("directed", 0.38476646), ("edges", 0.3990712), ("from", 0.12670542), ("get", 0.046383467), ("node", 0.07233103), ("number", 0.30799133), ("of", 0.3178165), ("prefixes", 0.45656088)],
&[("curie", 0.82121915), ("from", 0.19447234), ("get", 0.07119112), ("ids", 0.2910069), ("node", 0.20690848), ("prefixes", 0.70074713)],
&[("curie", 0.82121915), ("from", 0.19447234), ("get", 0.07119112), ("names", 0.3830224), ("node", 0.20690848), ("prefixes", 0.70074713)],
&[("curie", 0.6557065), ("from", 0.15527742), ("get", 0.056842905), ("node", 0.08864163), ("nodes", 0.39589864), ("number", 0.37744313), ("of", 0.3894839), ("prefixes", 0.55951506)],
&[("get", 0.16840003), ("names", 0.90602577), ("node", 0.2626054), ("prefixes", 1.6575922)],
&[("from", 0.2500987), ("get", 0.09155444), ("graph", 0.6907598), ("ids", 0.37424573), ("mapping", 1.2352316), ("node", 0.14277129)],
&[("degrees", 0.901187), ("get", 0.09155444), ("node", 0.14277129), ("non", 1.3143071), ("subgraph", 1.3143071), ("zero", 1.3143071)],
&[("edge", 0.23202254), ("from", 0.19447234), ("get", 0.07119112), ("ids", 0.5423683), ("multigraph", 0.8778975), ("node", 0.11101644)],
&[("edges", 0.48906144), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("multigraph", 0.70096165), ("node", 0.08864163), ("number", 0.37744313), ("of", 0.3894839)],
&[("get", 0.37883428), ("tendrils", 5.4383445)],
&[("degree", 0.79793), ("distribution", 1.4343579), ("geometric", 1.4343579), ("get", 0.09155444), ("node", 0.14277129), ("threshold", 1.4343579)],
&[("edge", 0.39650738), ("get", 0.12165975), ("methods", 1.6414056), ("sparse", 1.9060094), ("weighting", 1.746483)],
&[("edge", 0.548841), ("get", 0.16840003), ("methods", 2.2720149), ("weighting", 2.4174616)],
&[("add", 4.370011), ("selfloops", 3.873264)],
&[("centrality", 2.2602391), ("degree", 2.137034), ("get", 0.24520314)],
&[("centrality", 1.5522816), ("degree", 1.4676671), ("get", 0.16840003), ("weighted", 1.2354761)],
&[("centrality", 0.6562271), ("closeness", 0.91456854), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("node", 0.11101644), ("unchecked", 0.38525102)],
&[("centrality", 0.5239678), ("closeness", 0.73024184), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("node", 0.08864163), ("unchecked", 0.3076056), ("weighted", 0.4170311)],
&[("centrality", 2.2602391), ("closeness", 3.150043), ("get", 0.24520314)],
&[("centrality", 1.5522816), ("closeness", 2.163379), ("get", 0.16840003), ("weighted", 1.2354761)],
&[("centrality", 0.6562271), ("from", 0.19447234), ("get", 0.07119112), ("harmonic", 0.91456854), ("id", 0.31078207), ("node", 0.11101644), ("unchecked", 0.38525102)],
&[("centrality", 0.5239678), ("from", 0.15527742), ("get", 0.056842905), ("harmonic", 0.73024184), ("id", 0.24814549), ("node", 0.08864163), ("unchecked", 0.3076056), ("weighted", 0.4170311)],
&[("centrality", 2.2602391), ("get", 0.24520314), ("harmonic", 3.150043)],
&[("centrality", 1.5522816), ("get", 0.16840003), ("harmonic", 2.163379), ("weighted", 1.2354761)],
&[("centrality", 2.2602391), ("get", 0.24520314), ("stress", 3.8415294)],
&[("betweenness", 3.0237372), ("centrality", 2.2602391), ("get", 0.24520314)],
&[("approximated", 0.7597315), ("betweenness", 0.8778975), ("centrality", 0.6562271), ("from", 0.19447234), ("get", 0.07119112), ("id", 0.31078207), ("node", 0.11101644)],
&[("approximated", 0.7597315), ("betweenness", 0.8778975), ("centrality", 0.6562271), ("from", 0.19447234), ("get", 0.07119112), ("name", 0.43375745), ("node", 0.11101644)],
&[("approximated", 0.6066114), ("betweenness", 0.70096165), ("centrality", 0.5239678), ("from", 0.15527742), ("get", 0.056842905), ("id", 0.24814549), ("node", 0.08864163), ("weighted", 0.4170311)],
&[("approximated", 0.6066114), ("betweenness", 0.70096165), ("centrality", 0.5239678), ("from", 0.15527742), ("get", 0.056842905), ("name", 0.34633583), ("node", 0.08864163), ("weighted", 0.4170311)],
&[("centrality", 2.2602391), ("eigenvector", 3.5200067), ("get", 0.24520314)],
&[("centrality", 1.5522816), ("eigenvector", 2.4174616), ("get", 0.16840003), ("weighted", 1.2354761)],
&[("dot", 5.935091), ("to", 3.873264)],
&[("get", 0.37883428), ("stars", 5.935091)],
&[("community", 1.6414056), ("detection", 1.9060094), ("get", 0.12165975), ("louvain", 1.9060094), ("undirected", 1.4033958)],
&[("community", 0.96049434), ("directed", 0.5905543), ("from", 0.19447234), ("get", 0.07119112), ("memberships", 1.021982), ("modularity", 1.021982), ("node", 0.11101644)],
&[("community", 0.96049434), ("from", 0.19447234), ("get", 0.07119112), ("memberships", 1.021982), ("modularity", 1.021982), ("node", 0.11101644), ("undirected", 0.82121915)],
&[("distance", 1.1153314), ("from", 0.19447234), ("get", 0.07119112), ("ids", 0.2910069), ("node", 0.11101644), ("structural", 1.021982), ("unchecked", 0.38525102)],
&[("attachment", 1.2699087), ("get", 0.12165975), ("minimum", 1.4033958), ("preferential", 1.2699087), ("unchecked", 0.6583622)],
&[("attachment", 1.2699087), ("get", 0.12165975), ("maximum", 1.3643084), ("preferential", 1.2699087), ("unchecked", 0.6583622)],
&[("attachment", 0.95566344), ("get", 0.09155444), ("minimum", 1.0561185), ("preferential", 0.95566344), ("unchecked", 0.49544722), ("weighted", 0.6716942)],
&[("attachment", 0.95566344), ("get", 0.09155444), ("maximum", 1.0267035), ("preferential", 0.95566344), ("unchecked", 0.49544722), ("weighted", 0.6716942)],
&[("attachment", 0.7431071), ("from", 0.19447234), ("get", 0.07119112), ("ids", 0.2910069), ("node", 0.11101644), ("preferential", 0.7431071), ("unchecked", 0.38525102)],
&[("attachment", 0.95566344), ("from", 0.2500987), ("get", 0.09155444), ("ids", 0.37424573), ("node", 0.14277129), ("preferential", 0.95566344)],
&[("attachment", 0.95566344), ("from", 0.2500987), ("get", 0.09155444), ("names", 0.49258113), ("node", 0.14277129), ("preferential", 0.95566344)],
&[("attachment", 0.59333754), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("node", 0.08864163), ("preferential", 0.59333754), ("unchecked", 0.3076056), ("weighted", 0.4170311)],
&[("attachment", 0.7431071), ("from", 0.19447234), ("get", 0.07119112), ("ids", 0.2910069), ("node", 0.11101644), ("preferential", 0.7431071), ("weighted", 0.52229756)],
&[("attachment", 0.7431071), ("from", 0.19447234), ("get", 0.07119112), ("names", 0.3830224), ("node", 0.11101644), ("preferential", 0.7431071), ("weighted", 0.52229756)],
&[("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("intersection", 0.7669115), ("neighbours", 0.7669115), ("node", 0.08864163), ("size", 0.70096165), ("unchecked", 0.3076056)],
&[("coefficient", 0.82121915), ("from", 0.19447234), ("get", 0.07119112), ("ids", 0.2910069), ("jaccard", 0.7983465), ("node", 0.11101644), ("unchecked", 0.38525102)],
&[("coefficient", 1.0561185), ("from", 0.2500987), ("get", 0.09155444), ("ids", 0.37424573), ("jaccard", 1.0267035), ("node", 0.14277129)],
&[("coefficient", 1.0561185), ("from", 0.2500987), ("get", 0.09155444), ("jaccard", 1.0267035), ("names", 0.49258113), ("node", 0.14277129)],
&[("adamic", 0.67658657), ("adar", 0.67658657), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("index", 0.6066114), ("node", 0.08864163), ("unchecked", 0.3076056)],
&[("adamic", 0.8473697), ("adar", 0.8473697), ("from", 0.19447234), ("get", 0.07119112), ("ids", 0.2910069), ("index", 0.7597315), ("node", 0.11101644)],
&[("adamic", 0.8473697), ("adar", 0.8473697), ("from", 0.19447234), ("get", 0.07119112), ("index", 0.7597315), ("names", 0.3830224), ("node", 0.11101644)],
&[("allocation", 0.6557065), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("index", 0.6066114), ("node", 0.08864163), ("resource", 0.6557065), ("unchecked", 0.3076056)],
&[("allocation", 0.53505254), ("from", 0.12670542), ("get", 0.046383467), ("ids", 0.189601), ("index", 0.4949912), ("node", 0.07233103), ("resource", 0.53505254), ("unchecked", 0.2510043), ("weighted", 0.34029487)],
&[("allocation", 0.82121915), ("from", 0.19447234), ("get", 0.07119112), ("ids", 0.2910069), ("index", 0.7597315), ("node", 0.11101644), ("resource", 0.82121915)],
&[("allocation", 0.82121915), ("from", 0.19447234), ("get", 0.07119112), ("index", 0.7597315), ("names", 0.3830224), ("node", 0.11101644), ("resource", 0.82121915)],
&[("allocation", 0.6557065), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("index", 0.6066114), ("node", 0.08864163), ("resource", 0.6557065), ("weighted", 0.4170311)],
&[("allocation", 0.6557065), ("from", 0.15527742), ("get", 0.056842905), ("index", 0.6066114), ("names", 0.30582616), ("node", 0.08864163), ("resource", 0.6557065), ("weighted", 0.4170311)],
&[("available", 1.3143071), ("edge", 0.29838964), ("get", 0.09155444), ("metrics", 1.0897491), ("number", 0.60793155), ("of", 0.62732506)],
&[("available", 1.746483), ("edge", 0.39650738), ("get", 0.12165975), ("metrics", 1.4480848), ("names", 0.6545537)],
&[("all", 0.48415986), ("edge", 0.15117067), ("from", 0.12670542), ("get", 0.046383467), ("ids", 0.189601), ("metrics", 0.5520905), ("node", 0.07233103), ("tuple", 0.6658565), ("unchecked", 0.2510043)],
&[("all", 0.59333754), ("edge", 0.18525955), ("from", 0.15527742), ("get", 0.056842905), ("ids", 0.2323559), ("metrics", 0.67658657), ("node", 0.08864163), ("tuple", 0.81600666)],
&[("all", 0.7431071), ("edge", 0.23202254), ("from", 0.19447234), ("get", 0.07119112), ("ids", 0.2910069), ("metrics", 0.8473697), ("node", 0.11101644)],
&[("attachment", 1.7577931), ("get", 0.16840003), ("preferential", 1.7577931), ("scores", 2.163379)],
&[("allocation", 1.4033958), ("get", 0.12165975), ("index", 1.2983184), ("resource", 1.4033958), ("scores", 1.5629222)],
&[("coefficient", 1.9425644), ("get", 0.16840003), ("jaccard", 1.88846), ("scores", 2.163379)],
&[("adamic", 2.0044224), ("adar", 2.0044224), ("get", 0.16840003), ("scores", 2.163379)],
&[("all", 1.7577931), ("edge", 0.548841), ("get", 0.16840003), ("metrics", 2.0044224)],
&[("get", 0.12165975), ("groups", 1.2438694), ("ids", 0.49730676), ("isomorphic", 1.0893799), ("node", 0.18971793)],
&[("get", 0.12165975), ("groups", 1.2438694), ("isomorphic", 1.0893799), ("names", 0.6545537), ("node", 0.18971793)],
&[("get", 0.09155444), ("groups", 0.9360677), ("isomorphic", 0.81980747), ("node", 0.14277129), ("number", 0.60793155), ("of", 0.62732506)],
&[("get", 0.09155444), ("groups", 0.9360677), ("ids", 0.37424573), ("isomorphic", 0.81980747), ("node", 0.14277129), ("type", 0.38843954)],
&[("get", 0.09155444), ("groups", 0.9360677), ("isomorphic", 0.81980747), ("names", 0.49258113), ("node", 0.14277129), ("type", 0.38843954)],
&[("get", 0.07119112), ("groups", 0.72786975), ("isomorphic", 0.6374678), ("node", 0.11101644), ("number", 0.47271687), ("of", 0.48779693), ("type", 0.30204374)],
&[("approximated", 0.7597315), ("get", 0.07119112), ("groups", 0.72786975), ("ids", 0.2910069), ("isomorphic", 0.6374678), ("node", 0.11101644), ("type", 0.30204374)],
&[("approximated", 0.7597315), ("get", 0.07119112), ("groups", 0.72786975), ("isomorphic", 0.6374678), ("names", 0.3830224), ("node", 0.11101644), ("type", 0.30204374)],
&[("approximated", 0.6066114), ("get", 0.056842905), ("groups", 0.5811713), ("isomorphic", 0.5089894), ("node", 0.08864163), ("number", 0.37744313), ("of", 0.3894839), ("type", 0.24116832)],
&[("edge", 0.29838964), ("get", 0.09155444), ("groups", 0.9360677), ("ids", 0.37424573), ("isomorphic", 0.81980747), ("type", 0.38843954)],
&[("edge", 0.29838964), ("get", 0.09155444), ("groups", 0.9360677), ("isomorphic", 0.81980747), ("names", 0.49258113), ("type", 0.38843954)],
&[("edge", 0.23202254), ("get", 0.07119112), ("groups", 0.72786975), ("isomorphic", 0.6374678), ("number", 0.47271687), ("of", 0.48779693), ("type", 0.30204374)],
&[("has", 1.5249496), ("isomorphic", 2.1956267), ("nodes", 1.7077873)],
&[("from", 0.15527742), ("has", 0.35351324), ("ids", 0.2323559), ("isomorphic", 0.5089894), ("node", 0.1675068), ("types", 0.29891783), ("unchecked", 0.3076056)],
&[("from", 0.19447234), ("has", 0.4427466), ("ids", 0.2910069), ("isomorphic", 0.6374678), ("node", 0.20690848), ("types", 0.37437028)],
&[("csv", 5.935091), ("from", 1.0348593)],
];
...
impl ShortestPathsDjkstra {
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_point_at_given_distance_on_shortest_path(dst_node_id.into(), distance.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_number_of_shortest_paths_from_node_id(node_id.into()))?.into())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_successors_from_node_id(source_node_id.into()))?, NodeT)})
            }
...
&[("has", 0.58600885), ("id", 0.20386681), ("node", 0.15473326), ("path", 0.435766), ("to", 0.58600885)],
&[("distance", 0.435766), ("from", 0.2628876), ("get", 0.043118663), ("id", 0.20386681), ("node", 0.15473326)],
&[("from", 0.2628876), ("get", 0.043118663), ("id", 0.20386681), ("node", 0.15473326), ("parent", 0.58600885)],
&[("at", 0.2707106), ("distance", 0.20130494), ("get", 0.019918947), ("given", 0.2707106), ("on", 0.2707106), ("path", 0.20130494), ("point", 0.20130494), ("shortest", 0.15558861)],
&[("get", 0.088315345), ("median", 1.2002592), ("point", 0.8925329)],
&[("eccentricity", 1.8796511), ("get", 0.13830516)],
&[("distant", 0.81656975), ("get", 0.060083386), ("most", 0.81656975), ("node", 0.21561193)],
&[("get", 0.043118663), ("number", 0.435766), ("of", 0.435766), ("paths", 0.435766), ("shortest", 0.3368036)],
&[("from", 0.12144262), ("get", 0.019918947), ("id", 0.094177596), ("node", 0.071480036), ("number", 0.20130494), ("of", 0.20130494), ("paths", 0.20130494), ("shortest", 0.15558861)],
&[("from", 0.2628876), ("get", 0.043118663), ("id", 0.20386681), ("node", 0.15473326), ("successors", 0.58600885)],
];
...
impl ShortestPathsResultBFS {
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_unchecked_kth_point_on_shortest_path(dst_node_id.into(), k.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_kth_point_on_shortest_path(dst_node_id.into(), k.into()))?.into())
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_successors_from_node_id(source_node_id.into()))?, NodeT)})
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_predecessors_from_node_id(source_node_id.into()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_shared_ancestors_size(first_node_id.into(), second_node_id.into()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_ancestors_jaccard_index(first_node_id.into(), second_node_id.into()))?.into())
            }
...
to_ndarray_1d!(gil, self.inner.get_first_k_star_node_ids(k.into()), NodeT)
    ...
    /// 
            ...
            self.inner.get_first_k_star_node_names(k.into()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
...
to_ndarray_1d!(gil, self.inner.get_tendril_node_ids(), NodeT)
    ...
    /// 
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_first_k_tendril_node_ids(k.into()), NodeT)
            }
    ...
    /// 
            ...
            self.inner.get_first_k_tendril_node_names(k.into()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
...
#[module(edge_list_utils)]
    ...
    /// 
            pub fn convert_edge_list_to_numeric(original_node_path: Option<String>, original_node_list_separator: Option<char>, original_node_list_header: Option<bool>, original_node_list_support_balanced_quotes: Option<bool>, node_list_rows_to_skip: Option<usize>, node_list_is_correct: Option<bool>, node_list_max_rows_number: Option<usize>, node_list_comment_symbol: Option<String>, original_nodes_column_number: Option<usize>, original_nodes_column: Option<String>, nodes_number: Option<NodeT>, original_minimum_node_id: Option<NodeT>, original_numeric_node_ids: Option<bool>, original_load_node_list_in_parallel: Option<bool>, original_edge_type_path: Option<String>, original_edge_types_column_number: Option<usize>, original_edge_types_column: Option<String>, edge_types_number: Option<EdgeTypeT>, original_numeric_edge_type_ids: Option<bool>, original_minimum_edge_type_id: Option<EdgeTypeT>, original_edge_type_list_separator: Option<char>, original_edge_type_list_header: Option<bool>, original_edge_type_list_support_balanced_quotes: Option<bool>, edge_type_list_rows_to_skip: Option<usize>, edge_type_list_is_correct: Option<bool>, edge_type_list_max_rows_number: Option<usize>, edge_type_list_comment_symbol: Option<String>, load_edge_type_list_in_parallel: Option<bool>, original_edge_path: &str, original_edge_list_separator: Option<char>, original_edge_list_header: Option<bool>, original_edge_list_support_balanced_quotes: Option<bool>, original_sources_column_number: Option<usize>, original_sources_column: Option<String>, original_destinations_column_number: Option<usize>, original_destinations_column: Option<String>, original_edge_list_edge_types_column: Option<String>, original_edge_list_edge_types_column_number: Option<usize>, original_weights_column: Option<String>, original_weights_column_number: Option<usize>, target_edge_path: &str, target_edge_list_separator: Option<char>, target_edge_list_header: Option<bool>, target_sources_column: Option<String>, target_sources_column_number: Option<usize>, target_destinations_column: Option<String>, target_destinations_column_number: Option<usize>, target_edge_list_edge_types_column: Option<String>, target_edge_list_edge_types_column_number: Option<usize>, target_weights_column: Option<String>, target_weights_column_number: Option<usize>, target_node_path: Option<&str>, target_node_list_separator: Option<char>, target_node_list_header: Option<bool>, target_nodes_column: Option<String>, target_nodes_column_number: Option<usize>, target_edge_type_list_path: Option<String>, target_edge_type_list_separator: Option<char>, target_edge_type_list_header: Option<bool>, target_edge_type_list_edge_types_column: Option<String>, target_edge_type_list_edge_types_column_number: Option<usize>, comment_symbol: Option<String>, default_edge_type: Option<String>, default_weight: Option<WeightT>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, edges_number: Option<usize>, skip_edge_types_if_unavailable: Option<bool>, skip_weights_if_unavailable: Option<bool>, numeric_rows_are_surely_smaller_than_original: Option<bool>, directed: bool, verbose: Option<bool>, name: Option<String>)-> PyResult<(NodeT, Option<EdgeTypeT>)>{
            Ok({let (subresult_0, subresult_1) = pe!(graph::convert_edge_list_to_numeric(original_node_path.into(), original_node_list_separator.into(), original_node_list_header.into(), original_node_list_support_balanced_quotes.into(), node_list_rows_to_skip.into(), node_list_is_correct.into(), node_list_max_rows_number.into(), node_list_comment_symbol.into(), original_nodes_column_number.into(), original_nodes_column.into(), nodes_number.into(), original_minimum_node_id.into(), original_numeric_node_ids.into(), original_load_node_list_in_parallel.into(), original_edge_type_path.into(), original_edge_types_column_number.into(), original_edge_types_column.into(), edge_types_number.into(), original_numeric_edge_type_ids.into(), original_minimum_edge_type_id.into(), original_edge_type_list_separator.into(), original_edge_type_list_header.into(), original_edge_type_list_support_balanced_quotes.into(), edge_type_list_rows_to_skip.into(), edge_type_list_is_correct.into(), edge_type_list_max_rows_number.into(), edge_type_list_comment_symbol.into(), load_edge_type_list_in_parallel.into(), original_edge_path.into(), original_edge_list_separator.into(), original_edge_list_header.into(), original_edge_list_support_balanced_quotes.into(), original_sources_column_number.into(), original_sources_column.into(), original_destinations_column_number.into(), original_destinations_column.into(), original_edge_list_edge_types_column.into(), original_edge_list_edge_types_column_number.into(), original_weights_column.into(), original_weights_column_number.into(), target_edge_path.into(), target_edge_list_separator.into(), target_edge_list_header.into(), target_sources_column.into(), target_sources_column_number.into(), target_destinations_column.into(), target_destinations_column_number.into(), target_edge_list_edge_types_column.into(), target_edge_list_edge_types_column_number.into(), target_weights_column.into(), target_weights_column_number.into(), target_node_path.into(), target_node_list_separator.into(), target_node_list_header.into(), target_nodes_column.into(), target_nodes_column_number.into(), target_edge_type_list_path.into(), target_edge_type_list_separator.into(), target_edge_type_list_header.into(), target_edge_type_list_edge_types_column.into(), target_edge_type_list_edge_types_column_number.into(), comment_symbol.into(), default_edge_type.into(), default_weight.into(), max_rows_number.into(), rows_to_skip.into(), edges_number.into(), skip_edge_types_if_unavailable.into(), skip_weights_if_unavailable.into(), numeric_rows_are_surely_smaller_than_original.into(), directed.into(), verbose.into(), name.into()))?.into();
...
#[module(edge_list_utils)]
    ...
    /// 
            pub fn densify_sparse_numeric_edge_list(maximum_node_id: Option<EdgeT>, original_edge_path: &str, original_edge_list_separator: Option<char>, original_edge_list_header: Option<bool>, original_sources_column: Option<String>, original_sources_column_number: Option<usize>, original_destinations_column: Option<String>, original_destinations_column_number: Option<usize>, original_edge_list_edge_types_column: Option<String>, original_edge_list_edge_types_column_number: Option<usize>, original_weights_column: Option<String>, original_weights_column_number: Option<usize>, original_edge_type_path: Option<String>, original_edge_types_column_number: Option<usize>, original_edge_types_column: Option<String>, edge_types_number: Option<EdgeTypeT>, original_numeric_edge_type_ids: Option<bool>, original_minimum_edge_type_id: Option<EdgeTypeT>, original_edge_type_list_separator: Option<char>, original_edge_type_list_header: Option<bool>, edge_type_list_rows_to_skip: Option<usize>, edge_type_list_is_correct: Option<bool>, edge_type_list_max_rows_number: Option<usize>, edge_type_list_comment_symbol: Option<String>, load_edge_type_list_in_parallel: Option<bool>, target_edge_path: &str, target_edge_list_separator: Option<char>, target_edge_list_header: Option<bool>, target_sources_column: Option<String>, target_sources_column_number: Option<usize>, target_destinations_column: Option<String>, target_destinations_column_number: Option<usize>, target_edge_list_edge_types_column: Option<String>, target_edge_list_edge_types_column_number: Option<usize>, target_weights_column: Option<String>, target_weights_column_number: Option<usize>, target_node_path: Option<&str>, target_node_list_separator: Option<char>, target_node_list_header: Option<bool>, target_nodes_column: Option<String>, target_nodes_column_number: Option<usize>, target_edge_type_list_path: Option<String>, target_edge_type_list_separator: Option<char>, target_edge_type_list_header: Option<bool>, target_edge_type_list_edge_types_column: Option<String>, target_edge_type_list_edge_types_column_number: Option<usize>, comment_symbol: Option<String>, default_edge_type: Option<String>, default_weight: Option<WeightT>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, edges_number: Option<usize>, skip_edge_types_if_unavailable: Option<bool>, skip_weights_if_unavailable: Option<bool>, numeric_rows_are_surely_smaller_than_original: Option<bool>, directed: bool, verbose: Option<bool>, name: Option<String>)-> PyResult<(NodeT, Option<EdgeTypeT>)>{
            Ok({let (subresult_0, subresult_1) = pe!(graph::densify_sparse_numeric_edge_list(maximum_node_id.into(), original_edge_path.into(), original_edge_list_separator.into(), original_edge_list_header.into(), original_sources_column.into(), original_sources_column_number.into(), original_destinations_column.into(), original_destinations_column_number.into(), original_edge_list_edge_types_column.into(), original_edge_list_edge_types_column_number.into(), original_weights_column.into(), original_weights_column_number.into(), original_edge_type_path.into(), original_edge_types_column_number.into(), original_edge_types_column.into(), edge_types_number.into(), original_numeric_edge_type_ids.into(), original_minimum_edge_type_id.into(), original_edge_type_list_separator.into(), original_edge_type_list_header.into(), edge_type_list_rows_to_skip.into(), edge_type_list_is_correct.into(), edge_type_list_max_rows_number.into(), edge_type_list_comment_symbol.into(), load_edge_type_list_in_parallel.into(), target_edge_path.into(), target_edge_list_separator.into(), target_edge_list_header.into(), target_sources_column.into(), target_sources_column_number.into(), target_destinations_column.into(), target_destinations_column_number.into(), target_edge_list_edge_types_column.into(), target_edge_list_edge_types_column_number.into(), target_weights_column.into(), target_weights_column_number.into(), target_node_path.into(), target_node_list_separator.into(), target_node_list_header.into(), target_nodes_column.into(), target_nodes_column_number.into(), target_edge_type_list_path.into(), target_edge_type_list_separator.into(), target_edge_type_list_header.into(), target_edge_type_list_edge_types_column.into(), target_edge_type_list_edge_types_column_number.into(), comment_symbol.into(), default_edge_type.into(), default_weight.into(), max_rows_number.into(), rows_to_skip.into(), edges_number.into(), skip_edge_types_if_unavailable.into(), skip_weights_if_unavailable.into(), numeric_rows_are_surely_smaller_than_original.into(), directed.into(), verbose.into(), name.into()))?.into();
(subresult_0.into(), subresult_1.map(|x| x.into()))})
            }
...
#[module(edge_list_utils)]
    ...
    ///     The name of the graph to display in the loading bar.
    /// 
            pub fn are_there_selfloops_in_edge_list(path: &str, separator: Option<char>, header: Option<bool>, sources_column: Option<String>, sources_column_number: Option<usize>, destinations_column: Option<String>, destinations_column_number: Option<usize>, comment_symbol: Option<String>, support_balanced_quotes: Option<bool>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, edges_number: Option<EdgeT>, load_edge_list_in_parallel: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<bool>{
            Ok(pe!(graph::are_there_selfloops_in_edge_list(path.into(), separator.into(), header.into(), sources_column.into(), sources_column_number.into(), destinations_column.into(), destinations_column_number.into(), comment_symbol.into(), support_balanced_quotes.into(), max_rows_number.into(), rows_to_skip.into(), edges_number.into(), load_edge_list_in_parallel.into(), verbose.into(), name.into()))?.into())
            }
...
#[module(edge_list_utils)]
    ...
    ///     If the original and target paths are identical.
    /// 
            pub fn convert_directed_edge_list_to_undirected(original_edge_path: &str, original_edge_list_separator: Option<char>, original_edge_list_header: Option<bool>, original_edge_list_support_balanced_quotes: Option<bool>, original_sources_column: Option<String>, original_sources_column_number: Option<usize>, original_destinations_column: Option<String>, original_destinations_column_number: Option<usize>, original_edge_list_edge_type_column: Option<String>, original_edge_list_edge_type_column_number: Option<usize>, original_weights_column: Option<String>, original_weights_column_number: Option<usize>, target_edge_path: &str, target_edge_list_separator: Option<char>, target_edge_list_header: Option<bool>, target_sources_column_number: Option<usize>, target_sources_column: Option<String>, target_destinations_column_number: Option<usize>, target_destinations_column: Option<String>, target_edge_list_edge_type_column: Option<String>, target_edge_list_edge_type_column_number: Option<usize>, target_weights_column: Option<String>, target_weights_column_number: Option<usize>, comment_symbol: Option<String>, default_edge_type: Option<String>, default_weight: Option<WeightT>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, edges_number: Option<usize>, skip_edge_types_if_unavailable: Option<bool>, skip_weights_if_unavailable: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<EdgeT>{
            Ok(pe!(graph::convert_directed_edge_list_to_undirected(original_edge_path.into(), original_edge_list_separator.into(), original_edge_list_header.into(), original_edge_list_support_balanced_quotes.into(), original_sources_column.into(), original_sources_column_number.into(), original_destinations_column.into(), original_destinations_column_number.into(), original_edge_list_edge_type_column.into(), original_edge_list_edge_type_column_number.into(), original_weights_column.into(), original_weights_column_number.into(), target_edge_path.into(), target_edge_list_separator.into(), target_edge_list_header.into(), target_sources_column_number.into(), target_sources_column.into(), target_destinations_column_number.into(), target_destinations_column.into(), target_edge_list_edge_type_column.into(), target_edge_list_edge_type_column_number.into(), target_weights_column.into(), target_weights_column_number.into(), comment_symbol.into(), default_edge_type.into(), default_weight.into(), max_rows_number.into(), rows_to_skip.into(), edges_number.into(), skip_edge_types_if_unavailable.into(), skip_weights_if_unavailable.into(), verbose.into(), name.into()))?.into())
            }
...
#[module(edge_list_utils)]
    ...
    ///     If the original and target paths are identical.
    /// 
            pub fn add_numeric_id_to_csv(original_csv_path: &str, original_csv_separator: Option<char>, original_csv_header: Option<bool>, target_csv_path: &str, target_csv_separator: Option<char>, target_csv_header: Option<bool>, target_csv_ids_column: Option<String>, target_csv_ids_column_number: Option<usize>, comment_symbol: Option<String>, support_balanced_quotes: Option<bool>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, lines_number: Option<usize>, verbose: Option<bool>)-> PyResult<usize>{
            Ok(pe!(graph::add_numeric_id_to_csv(original_csv_path.into(), original_csv_separator.into(), original_csv_header.into(), target_csv_path.into(), target_csv_separator.into(), target_csv_header.into(), target_csv_ids_column.into(), target_csv_ids_column_number.into(), comment_symbol.into(), support_balanced_quotes.into(), max_rows_number.into(), rows_to_skip.into(), lines_number.into(), verbose.into()))?.into())
            }
...
#[module(edge_list_utils)]
            ...
            pub fn build_optimal_lists_files(original_node_type_path: Option<String>, original_node_type_list_separator: Option<char>, original_node_types_column_number: Option<usize>, original_node_types_column: Option<String>, original_numeric_node_type_ids: Option<bool>, original_minimum_node_type_id: Option<NodeTypeT>, original_node_type_list_header: Option<bool>, original_node_type_list_support_balanced_quotes: Option<bool>, original_node_type_list_rows_to_skip: Option<usize>, original_node_type_list_max_rows_number: Option<usize>, original_node_type_list_comment_symbol: Option<String>, original_load_node_type_list_in_parallel: Option<bool>, original_node_type_list_is_correct: Option<bool>, node_types_number: Option<NodeTypeT>, target_node_type_list_path: Option<String>, target_node_type_list_separator: Option<char>, target_node_type_list_node_types_column_number: Option<usize>, target_node_type_list_node_types_column: Option<String>, target_node_type_list_header: Option<bool>, original_node_path: Option<String>, original_node_list_separator: Option<char>, original_node_list_header: Option<bool>, original_node_list_support_balanced_quotes: Option<bool>, node_list_rows_to_skip: Option<usize>, node_list_is_correct: Option<bool>, node_list_max_rows_number: Option<usize>, node_list_comment_symbol: Option<String>, default_node_type: Option<String>, original_nodes_column_number: Option<usize>, original_nodes_column: Option<String>, original_node_types_separator: Option<char>, original_node_list_node_types_column_number: Option<usize>, original_node_list_node_types_column: Option<String>, nodes_number: Option<NodeT>, original_minimum_node_id: Option<NodeT>, original_numeric_node_ids: Option<bool>, original_node_list_numeric_node_type_ids: Option<bool>, original_skip_node_types_if_unavailable: Option<bool>, original_load_node_list_in_parallel: Option<bool>, maximum_node_id: Option<EdgeT>, target_node_path: Option<String>, target_node_list_separator: Option<char>, target_node_list_header: Option<bool>, target_nodes_column: Option<String>, target_nodes_column_number: Option<usize>, target_node_types_separator: Option<char>, target_node_list_node_types_column: Option<String>, target_node_list_node_types_column_number: Option<usize>, original_edge_type_path: Option<String>, original_edge_type_list_separator: Option<char>, original_edge_types_column_number: Option<usize>, original_edge_types_column: Option<String>, original_numeric_edge_type_ids: Option<bool>, original_minimum_edge_type_id: Option<EdgeTypeT>, original_edge_type_list_header: Option<bool>, original_edge_type_list_support_balanced_quotes: Option<bool>, edge_type_list_rows_to_skip: Option<usize>, edge_type_list_max_rows_number: Option<usize>, edge_type_list_comment_symbol: Option<String>, load_edge_type_list_in_parallel: Option<bool>, edge_type_list_is_correct: Option<bool>, edge_types_number: Option<NodeTypeT>, target_edge_type_list_path: Option<String>, target_edge_type_list_separator: Option<char>, target_edge_type_list_edge_types_column_number: Option<usize>, target_edge_type_list_edge_types_column: Option<String>, target_edge_type_list_header: Option<bool>, original_edge_path: String, original_edge_list_separator: Option<char>, original_edge_list_header: Option<bool>, original_edge_list_support_balanced_quotes: Option<bool>, original_sources_column_number: Option<usize>, original_sources_column: Option<String>, original_destinations_column_number: Option<usize>, original_destinations_column: Option<String>, original_edge_list_edge_types_column_number: Option<usize>, original_edge_list_edge_types_column: Option<String>, default_edge_type: Option<String>, original_weights_column_number: Option<usize>, original_weights_column: Option<String>, default_weight: Option<WeightT>, original_edge_list_numeric_node_ids: Option<bool>, skip_weights_if_unavailable: Option<bool>, skip_edge_types_if_unavailable: Option<bool>, edge_list_comment_symbol: Option<String>, edge_list_max_rows_number: Option<usize>, edge_list_rows_to_skip: Option<usize>, load_edge_list_in_parallel: Option<bool>, edges_number: Option<EdgeT>, target_edge_path: String, target_edge_list_separator: Option<char>, numeric_rows_are_surely_smaller_than_original: Option<bool>, sort_temporary_directory: Option<String>, verbose: Option<bool>, directed: bool, name: Option<String>)-> PyResult<(Option<NodeTypeT>, NodeT, Option<EdgeTypeT>, EdgeT)>{
            Ok({let (subresult_0, subresult_1, subresult_2, subresult_3) = pe!(graph::build_optimal_lists_files(original_node_type_path.into(), original_node_type_list_separator.into(), original_node_types_column_number.into(), original_node_types_column.into(), original_numeric_node_type_ids.into(), original_minimum_node_type_id.into(), original_node_type_list_header.into(), original_node_type_list_support_balanced_quotes.into(), original_node_type_list_rows_to_skip.into(), original_node_type_list_max_rows_number.into(), original_node_type_list_comment_symbol.into(), original_load_node_type_list_in_parallel.into(), original_node_type_list_is_correct.into(), node_types_number.into(), target_node_type_list_path.into(), target_node_type_list_separator.into(), target_node_type_list_node_types_column_number.into(), target_node_type_list_node_types_column.into(), target_node_type_list_header.into(), original_node_path.into(), original_node_list_separator.into(), original_node_list_header.into(), original_node_list_support_balanced_quotes.into(), node_list_rows_to_skip.into(), node_list_is_correct.into(), node_list_max_rows_number.into(), node_list_comment_symbol.into(), default_node_type.into(), original_nodes_column_number.into(), original_nodes_column.into(), original_node_types_separator.into(), original_node_list_node_types_column_number.into(), original_node_list_node_types_column.into(), nodes_number.into(), original_minimum_node_id.into(), original_numeric_node_ids.into(), original_node_list_numeric_node_type_ids.into(), original_skip_node_types_if_unavailable.into(), original_load_node_list_in_parallel.into(), maximum_node_id.into(), target_node_path.into(), target_node_list_separator.into(), target_node_list_header.into(), target_nodes_column.into(), target_nodes_column_number.into(), target_node_types_separator.into(), target_node_list_node_types_column.into(), target_node_list_node_types_column_number.into(), original_edge_type_path.into(), original_edge_type_list_separator.into(), original_edge_types_column_number.into(), original_edge_types_column.into(), original_numeric_edge_type_ids.into(), original_minimum_edge_type_id.into(), original_edge_type_list_header.into(), original_edge_type_list_support_balanced_quotes.into(), edge_type_list_rows_to_skip.into(), edge_type_list_max_rows_number.into(), edge_type_list_comment_symbol.into(), load_edge_type_list_in_parallel.into(), edge_type_list_is_correct.into(), edge_types_number.into(), target_edge_type_list_path.into(), target_edge_type_list_separator.into(), target_edge_type_list_edge_types_column_number.into(), target_edge_type_list_edge_types_column.into(), target_edge_type_list_header.into(), original_edge_path.into(), original_edge_list_separator.into(), original_edge_list_header.into(), original_edge_list_support_balanced_quotes.into(), original_sources_column_number.into(), original_sources_column.into(), original_destinations_column_number.into(), original_destinations_column.into(), original_edge_list_edge_types_column_number.into(), original_edge_list_edge_types_column.into(), default_edge_type.into(), original_weights_column_number.into(), original_weights_column.into(), default_weight.into(), original_edge_list_numeric_node_ids.into(), skip_weights_if_unavailable.into(), skip_edge_types_if_unavailable.into(), edge_list_comment_symbol.into(), edge_list_max_rows_number.into(), edge_list_rows_to_skip.into(), load_edge_list_in_parallel.into(), edges_number.into(), target_edge_path.into(), target_edge_list_separator.into(), numeric_rows_are_surely_smaller_than_original.into(), sort_temporary_directory.into(), verbose.into(), directed.into(), name.into()))?.into();
...
#[module(edge_list_utils)]
    ...
    ///     The name of the graph to display in the loading bar.
    /// 
            pub fn filter_duplicates_from_edge_list(original_edge_path: &str, original_edge_list_separator: Option<char>, original_edge_list_header: Option<bool>, original_edge_list_support_balanced_quotes: Option<bool>, original_edge_list_sources_column: Option<String>, original_edge_list_sources_column_number: Option<usize>, original_edge_list_destinations_column: Option<String>, original_edge_list_destinations_column_number: Option<usize>, original_edge_list_edge_type_column: Option<String>, original_edge_list_edge_type_column_number: Option<usize>, original_edge_list_weights_column: Option<String>, original_edge_list_weights_column_number: Option<usize>, target_edge_path: &str, target_edge_list_separator: Option<char>, target_edge_list_header: Option<bool>, target_edge_list_sources_column_number: Option<usize>, target_edge_list_sources_column: Option<String>, target_edge_list_destinations_column_number: Option<usize>, target_edge_list_destinations_column: Option<String>, target_edge_list_edge_type_column: Option<String>, target_edge_list_edge_type_column_number: Option<usize>, target_edge_list_weights_column: Option<String>, target_edge_list_weights_column_number: Option<usize>, comment_symbol: Option<String>, default_edge_type: Option<String>, default_weight: Option<WeightT>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, edges_number: Option<usize>, skip_edge_types_if_unavailable: Option<bool>, skip_weights_if_unavailable: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<()>{
            Ok(pe!(graph::filter_duplicates_from_edge_list(original_edge_path.into(), original_edge_list_separator.into(), original_edge_list_header.into(), original_edge_list_support_balanced_quotes.into(), original_edge_list_sources_column.into(), original_edge_list_sources_column_number.into(), original_edge_list_destinations_column.into(), original_edge_list_destinations_column_number.into(), original_edge_list_edge_type_column.into(), original_edge_list_edge_type_column_number.into(), original_edge_list_weights_column.into(), original_edge_list_weights_column_number.into(), target_edge_path.into(), target_edge_list_separator.into(), target_edge_list_header.into(), target_edge_list_sources_column_number.into(), target_edge_list_sources_column.into(), target_edge_list_destinations_column_number.into(), target_edge_list_destinations_column.into(), target_edge_list_edge_type_column.into(), target_edge_list_edge_type_column_number.into(), target_edge_list_weights_column.into(), target_edge_list_weights_column_number.into(), comment_symbol.into(), default_edge_type.into(), default_weight.into(), max_rows_number.into(), rows_to_skip.into(), edges_number.into(), skip_edge_types_if_unavailable.into(), skip_weights_if_unavailable.into(), verbose.into(), name.into()))?)
            }
...
#[module(edge_list_utils)]
    ...
    ///     The name of the graph to display in the loading bar.
    /// 
            pub fn convert_undirected_edge_list_to_directed(original_edge_path: &str, original_edge_list_separator: Option<char>, original_edge_list_header: Option<bool>, original_edge_list_support_balanced_quotes: Option<bool>, original_sources_column: Option<String>, original_sources_column_number: Option<usize>, original_destinations_column: Option<String>, original_destinations_column_number: Option<usize>, original_edge_list_edge_type_column: Option<String>, original_edge_list_edge_type_column_number: Option<usize>, original_weights_column: Option<String>, original_weights_column_number: Option<usize>, target_edge_path: &str, target_edge_list_separator: Option<char>, target_edge_list_header: Option<bool>, target_sources_column: Option<String>, target_sources_column_number: Option<usize>, target_destinations_column: Option<String>, target_destinations_column_number: Option<usize>, target_edge_list_edge_type_column: Option<String>, target_edge_list_edge_type_column_number: Option<usize>, target_weights_column: Option<String>, target_weights_column_number: Option<usize>, comment_symbol: Option<String>, default_edge_type: Option<String>, default_weight: Option<WeightT>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, edges_number: Option<usize>, skip_edge_types_if_unavailable: Option<bool>, skip_weights_if_unavailable: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<EdgeT>{
            Ok(pe!(graph::convert_undirected_edge_list_to_directed(original_edge_path.into(), original_edge_list_separator.into(), original_edge_list_header.into(), original_edge_list_support_balanced_quotes.into(), original_sources_column.into(), original_sources_column_number.into(), original_destinations_column.into(), original_destinations_column_number.into(), original_edge_list_edge_type_column.into(), original_edge_list_edge_type_column_number.into(), original_weights_column.into(), original_weights_column_number.into(), target_edge_path.into(), target_edge_list_separator.into(), target_edge_list_header.into(), target_sources_column.into(), target_sources_column_number.into(), target_destinations_column.into(), target_destinations_column_number.into(), target_edge_list_edge_type_column.into(), target_edge_list_edge_type_column_number.into(), target_weights_column.into(), target_weights_column_number.into(), comment_symbol.into(), default_edge_type.into(), default_weight.into(), max_rows_number.into(), rows_to_skip.into(), edges_number.into(), skip_edge_types_if_unavailable.into(), skip_weights_if_unavailable.into(), verbose.into(), name.into()))?.into())
            }
...
#[module(edge_list_utils)]
    ...
    /// 
            pub fn get_minmax_node_from_numeric_edge_list(path: &str, separator: Option<char>, header: Option<bool>, sources_column: Option<String>, sources_column_number: Option<usize>, destinations_column: Option<String>, destinations_column_number: Option<usize>, comment_symbol: Option<String>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, edges_number: Option<EdgeT>, load_edge_list_in_parallel: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<(EdgeT, EdgeT, EdgeT)>{
            Ok({let (subresult_0, subresult_1, subresult_2) = pe!(graph::get_minmax_node_from_numeric_edge_list(path.into(), separator.into(), header.into(), sources_column.into(), sources_column_number.into(), destinations_column.into(), destinations_column_number.into(), comment_symbol.into(), max_rows_number.into(), rows_to_skip.into(), edges_number.into(), load_edge_list_in_parallel.into(), verbose.into(), name.into()))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.into())})
            }
...
#[module(edge_list_utils)]
            ...
            #[text_signature = "(source_path, edge_path, node_path, node_type_path, edge_type_path, node_list_separator, node_type_list_separator, edge_type_list_separator, node_types_separator, nodes_column, node_types_column, node_list_node_types_column, edge_types_column, node_descriptions_column, edge_list_separator, sort_temporary_directory, directed, compute_node_description, keep_nodes_without_descriptions, keep_nodes_without_categories, keep_interwikipedia_nodes, keep_external_nodes, verbose)"]
                /// TODO: write the docstrin
            pub fn parse_wikipedia_graph(source_path: &str, edge_path: &str, node_path: &str, node_type_path: &str, edge_type_path: &str, node_list_separator: char, node_type_list_separator: char, edge_type_list_separator: char, node_types_separator: &str, nodes_column: &str, node_types_column: &str, node_list_node_types_column: &str, edge_types_column: &str, node_descriptions_column: &str, edge_list_separator: char, sort_temporary_directory: Option<String>, directed: bool, compute_node_description: Option<bool>, keep_nodes_without_descriptions: Option<bool>, keep_nodes_without_categories: Option<bool>, keep_interwikipedia_nodes: Option<bool>, keep_external_nodes: Option<bool>, verbose: Option<bool>)-> PyResult<(NodeTypeT, NodeT, EdgeT)>{
            Ok({let (subresult_0, subresult_1, subresult_2) = pe!(graph::parse_wikipedia_graph(source_path.into(), edge_path.into(), node_path.into(), node_type_path.into(), edge_type_path.into(), node_list_separator.into(), node_type_list_separator.into(), edge_type_list_separator.into(), node_types_separator.into(), nodes_column.into(), node_types_column.into(), node_list_node_types_column.into(), edge_types_column.into(), node_descriptions_column.into(), edge_list_separator.into(), sort_temporary_directory.into(), directed.into(), compute_node_description.into(), keep_nodes_without_descriptions.into(), keep_nodes_without_categories.into(), keep_interwikipedia_nodes.into(), keep_external_nodes.into(), verbose.into()))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.into())})
            }
...
#[module(edge_list_utils)]
    ...
    /// 
            ...
            Ok(pe!(graph::is_numeric_edge_list(path.into(), separator.into(), header.into(), support_balanced_quotes.into(), sources_column.into(), sources_column_number.into(), destinations_column.into(), destinations_column_number.into(), comment_symbol.into(), max_rows_number.into(), rows_to_skip.into(), edges_number.into(), load_edge_list_in_parallel.into(), verbose.into(), name.into()))?.into())
            }
...
#[module(edge_list_utils)]
    ...
    /// ----------
    /// 
            pub fn convert_node_list_node_types_to_numeric(original_node_type_path: Option<String>, original_node_type_list_separator: Option<char>, original_node_types_column_number: Option<usize>, original_node_types_column: Option<String>, node_types_number: Option<NodeTypeT>, original_numeric_node_type_ids: Option<bool>, original_minimum_node_type_id: Option<NodeTypeT>, original_node_type_list_header: Option<bool>, original_node_type_list_support_balanced_quotes: Option<bool>, original_node_type_list_rows_to_skip: Option<usize>, original_node_type_list_is_correct: Option<bool>, original_node_type_list_max_rows_number: Option<usize>, original_node_type_list_comment_symbol: Option<String>, original_load_node_type_list_in_parallel: Option<bool>, target_node_type_list_path: Option<String>, target_node_type_list_separator: Option<char>, target_node_type_list_header: Option<bool>, target_node_type_list_node_types_column: Option<String>, target_node_type_list_node_types_column_number: Option<usize>, original_node_path: String, original_node_list_separator: Option<char>, original_node_list_header: Option<bool>, original_node_list_support_balanced_quotes: Option<bool>, node_list_rows_to_skip: Option<usize>, node_list_max_rows_number: Option<usize>, node_list_comment_symbol: Option<String>, default_node_type: Option<String>, original_nodes_column_number: Option<usize>, original_nodes_column: Option<String>, original_node_types_separator: Option<char>, original_node_list_node_types_column_number: Option<usize>, original_node_list_node_types_column: Option<String>, original_minimum_node_id: Option<NodeT>, original_numeric_node_ids: Option<bool>, original_node_list_numeric_node_type_ids: Option<bool>, original_skip_node_types_if_unavailable: Option<bool>, target_node_path: String, target_node_list_separator: Option<char>, target_node_list_header: Option<bool>, target_nodes_column_number: Option<usize>, target_nodes_column: Option<String>, target_node_types_separator: Option<char>, target_node_list_node_types_column_number: Option<usize>, target_node_list_node_types_column: Option<String>, nodes_number: Option<NodeT>)-> PyResult<(NodeT, Option<NodeTypeT>)>{
            Ok({let (subresult_0, subresult_1) = pe!(graph::convert_node_list_node_types_to_numeric(original_node_type_path.into(), original_node_type_list_separator.into(), original_node_types_column_number.into(), original_node_types_column.into(), node_types_number.into(), original_numeric_node_type_ids.into(), original_minimum_node_type_id.into(), original_node_type_list_header.into(), original_node_type_list_support_balanced_quotes.into(), original_node_type_list_rows_to_skip.into(), original_node_type_list_is_correct.into(), original_node_type_list_max_rows_number.into(), original_node_type_list_comment_symbol.into(), original_load_node_type_list_in_parallel.into(), target_node_type_list_path.into(), target_node_type_list_separator.into(), target_node_type_list_header.into(), target_node_type_list_node_types_column.into(), target_node_type_list_node_types_column_number.into(), original_node_path.into(), original_node_list_separator.into(), original_node_list_header.into(), original_node_list_support_balanced_quotes.into(), node_list_rows_to_skip.into(), node_list_max_rows_number.into(), node_list_comment_symbol.into(), default_node_type.into(), original_nodes_column_number.into(), original_nodes_column.into(), original_node_types_separator.into(), original_node_list_node_types_column_number.into(), original_node_list_node_types_column.into(), original_minimum_node_id.into(), original_numeric_node_ids.into(), original_node_list_numeric_node_type_ids.into(), original_skip_node_types_if_unavailable.into(), target_node_path.into(), target_node_list_separator.into(), target_node_list_header.into(), target_nodes_column_number.into(), target_nodes_column.into(), target_node_types_separator.into(), target_node_list_node_types_column_number.into(), target_node_list_node_types_column.into(), nodes_number.into()))?.into();
(subresult_0.into(), subresult_1.map(|x| x.into()))})
            }
...
#[module(edge_list_utils)]
    ...
    /// 
            ...
            Ok(pe!(graph::has_duplicated_edges_in_edge_list(edge_path.into(), edge_list_separator.into(), edge_list_header.into(), edge_list_support_balanced_quotes.into(), edge_list_sources_column.into(), edge_list_sources_column_number.into(), edge_list_destinations_column.into(), edge_list_destinations_column_number.into(), edge_list_edge_type_column.into(), edge_list_edge_type_column_number.into(), edge_list_weights_column.into(), edge_list_weights_column_number.into(), comment_symbol.into(), default_edge_type.into(), default_weight.into(), max_rows_number.into(), rows_to_skip.into(), edges_number.into(), skip_edge_types_if_unavailable.into(), skip_weights_if_unavailable.into(), verbose.into(), name.into()))?.into())
            }
...
#[module(edge_list_utils)]
    ...
    /// 
            ...
            Ok(pe!(graph::sort_numeric_edge_list(path.into(), target_path.into(), separator.into(), header.into(), sources_column.into(), sources_column_number.into(), destinations_column.into(), destinations_column_number.into(), edge_types_column.into(), edge_types_column_number.into(), rows_to_skip.into(), skip_edge_types_if_unavailable.into(), sort_temporary_directory.into()))?)
            }
...
#[module(edge_list_utils)]
    ...
    /// 
            ...
            Ok(pe!(graph::sort_numeric_edge_list_inplace(path.into(), separator.into(), header.into(), sources_column.into(), sources_column_number.into(), destinations_column.into(), destinations_column_number.into(), edge_types_column.into(), edge_types_column_number.into(), rows_to_skip.into(), skip_edge_types_if_unavailable.into(), sort_temporary_directory.into()))?)
            }
...
#[module(edge_list_utils)]
    ...
    /// 
            ...
            Ok(pe!(graph::get_number_of_selfloops_from_edge_list(path.into(), separator.into(), header.into(), support_balanced_quotes.into(), sources_column.into(), sources_column_number.into(), destinations_column.into(), destinations_column_number.into(), comment_symbol.into(), max_rows_number.into(), rows_to_skip.into(), edges_number.into(), load_edge_list_in_parallel.into(), verbose.into(), name.into()))?.into())
            }
