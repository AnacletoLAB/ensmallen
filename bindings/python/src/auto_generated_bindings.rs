...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    &[
        ("transformed", 1.7824374),
        ("laplacian", 1.7824374),
        ("graph", 1.3442281),
        ("get", 0.14391226),
    ],
    &[
        ("laplacian", 0.94099206),
        ("number", 0.5217829),
        ("get", 0.07597478),
        ("edges", 0.67246985),
        ("coo", 1.1582049),
    ...
    &[
        ("walk", 0.81451917),
        ("graph", 0.5467466),
        ("laplacian", 0.72498226),
        ("transformed", 0.72498226),
        ("get", 0.058534358),
        ("random", 0.56935525),
        ("normalized", 0.7632648),
    ],
    &[
        ("normalized", 0.99068093),
        ("graph", 0.70965075),
        ("symmetric", 1.0572066),
        ("laplacian", 0.94099206),
        ("transformed", 0.94099206),
        ("get", 0.07597478),
    ],
    &[
        ("graph", 0.9546989),
        ("symmetric", 1.4222687),
        ("get", 0.102209486),
        ("transformed", 1.2659243),
        ("normalized", 1.3327711),
    ],
    &[
        ("node_id", 0.5976801),
        ("connected", 1.0405529),
    ...
    &[
        ("node_id", 0.44427),
        ("from", 0.2235265),
        ("unchecked", 0.39979514),
        ("node", 0.4407393),
        ("disconnected", 0.94099206),
        ("is", 0.70965075),
    ],
    &[
        ("from", 0.300712),
    ...
    &[
        ("singleton", 0.42856386),
        ("selfloops", 0.56935525),
        ("node_id", 0.34228545),
        ("unchecked", 0.30802003),
        ("is", 0.5467466),
        ("with", 0.48674357),
        ("from", 0.17221478),
    ],
    ...
    &[("node_name", 2.7797), ("has", 2.2286985)],
    &[("node_type_id", 3.5901558), ("has", 2.2286985)],
    &[("node_type_name", 3.5005982), ("has", 2.2286985)],
    &[("has", 2.2286985), ("edge_type_id", 2.901912)],
    &[("has", 2.2286985), ("edge_type_name", 3.3445814)],
    &[
        ("from", 0.4234063),
        ("has", 0.9327812),
        ("node_ids", 0.72135633),
    ...
    &[
        ...
        ("from", 0.4234063),
        ("edge", 0.86235285),
        ("node_names", 0.94149137),
    ],
    &[
        ("and", 0.70965075),
        ("edge", 0.45525706),
        ("from", 0.2235265),
        ("edge_type_name", 0.73899573),
        ("node_names", 0.4970362),
        ("has", 0.4924379),
    ],
    &[
        ("connected", 2.1861687),
    ...
    &[
        ...
        ("outbound", 0.94099206),
        ("by", 0.8399939),
        ("increasing", 1.0572066),
    ],
    &[
        ("sort", 0.94099206),
        ("by", 0.8399939),
        ("decreasing", 1.0572066),
        ("outbound", 0.94099206),
        ("degree", 0.6227811),
        ("node", 0.4407393),
    ],
    ...
    &[("remove", 2.859293), ("components", 4.258786)],
    &[("overlaps", 8.951849)],
    &[("contains", 8.1712265)],
    &[
        ("edges", 1.9007024),
    ...
    &[("encode", 5.241858), ("edge", 2.0604236)],
    &[("decode", 5.241858), ("edge", 2.0604236)],
    &[
        ("edge", 0.61246103),
        ("encodable", 1.5581424),
        ("max", 1.5581424),
    ...
    &[("validate", 3.689684), ("node_id", 2.010698)],
    &[("node_ids", 1.7235401), ("validate", 3.689684)],
    &[("validate", 3.689684), ("edge_id", 2.6070838)],
    &[("edge_ids", 3.5901558), ("validate", 3.689684)],
    &[
        ("not", 1.1681138),
        ("must", 1.0163554),
        ("node_types", 0.6949586),
        ("unknown", 0.88989824),
        ("contain", 1.2659243),
    ],
    &[
    ...
    &[("validate", 3.689684), ("node_type_id", 3.5901558)],
    &[("node_type_ids", 3.3445814), ("validate", 3.689684)],
    &[("validate", 3.689684), ("edge_type_id", 2.901912)],
    &[("edge_type_ids", 3.929735), ("validate", 3.689684)],
    &[
        ("be", 2.659667),
        ("must", 2.1353307),
        ("undirected", 2.5475254),
    ],
    &[
        ("trap", 1.1681138),
        ("must", 1.0163554),
    ...
    &[
        ("be", 2.659667),
        ("must", 2.1353307),
        ("multigraph", 2.8001099),
    ],
    &[
        ("be", 1.7824374),
        ("not", 1.6447191),
        ("must", 1.4310412),
        ("multigraph", 1.8765585),
    ],
    &[
        ("contain", 1.7824374),
        ("identity", 2.0025723),
    ...
    &[
        ("set", 2.5475254),
        ("all", 2.3042552),
        ("node_types", 1.4600861),
    ],
    &[
        ("inplace", 1.9685228),
        ("node_type_ids", 2.0887344),
        ("remove", 1.7856654),
    ],
    &[
        ("remove", 1.1967051),
    ...
    &[
        ("inplace", 1.9685228),
        ("node_type_name", 2.1861687),
        ("remove", 1.7856654),
    ],
    &[("node_type_id", 3.5901558), ("remove", 2.859293)],
    &[
        ("remove", 1.7856654),
        ("node_types", 1.4600861),
        ("singleton", 1.5722276),
    ...
    &[
        ("node_types", 1.4600861),
        ("homogeneous", 2.3742006),
        ("remove", 1.7856654),
    ],
    &[("remove", 2.859293), ("node_type_name", 3.5005982)],
    &[
        ("remove", 1.7856654),
        ("edge_type_name", 2.0887344),
        ("inplace", 1.9685228),
    ],
    &[("edge_type_id", 2.901912), ("remove", 2.859293)],
    &[
        ("singleton", 1.5722276),
        ("remove", 1.7856654),
        ("edge_types", 1.537827),
    ],
    &[("remove", 2.859293), ("edge_type_name", 3.3445814)],
    &[
        ("remove", 1.7856654),
        ("node_types", 1.4600861),
        ("inplace", 1.9685228),
    ],
    &[("node_types", 2.3379598), ("remove", 2.859293)],
    &[
        ("remove", 1.7856654),
        ("inplace", 1.9685228),
        ("edge_types", 1.537827),
    ],
    &[("remove", 2.859293), ("edge_types", 2.4624422)],
    &[
        ("edge", 0.86235285),
        ("inplace", 1.3192512),
        ("remove", 1.1967051),
    ...
    &[("get", 0.3438502), ("circles", 5.241858)],
    &[
        ("get", 0.2147389),
        ("stats", 3.273608),
        ("memory", 2.0887344),
    ...
    &[
        ("memory", 0.9941769),
        ("nodes", 0.7165371),
        ("requirement", 1.2659243),
        ("total", 0.9941769),
        ("get", 0.102209486),
    ],
    &[
        ("total", 0.56935525),
        ("requirement", 0.72498226),
        ("readable", 0.6944143),
        ("memory", 0.56935525),
        ("human", 0.6944143),
        ("get", 0.058534358),
    ...
    &[
        ("memory", 0.56935525),
        ("human", 0.6944143),
        ("node_types", 0.39799592),
        ("requirements", 0.6689672),
        ("readable", 0.6944143),
        ("total", 0.56935525),
        ("get", 0.058534358),
    ],
    ...
    &[("transitivity", 5.241858), ("get", 0.3438502)],
    &[
        ("per", 1.0572066),
        ("triangles", 1.0572066),
        ("get", 0.07597478),
    ...
    &[
        ("per", 1.4222687),
        ("coefficient", 1.1681138),
        ("get", 0.102209486),
        ("node", 0.5929302),
        ("clustering", 1.3327711),
    ],
    &[
        ("coefficient", 2.4541702),
        ("clustering", 2.8001099),
        ("get", 0.2147389),
    ],
    &[
        ("clustering", 1.8765585),
        ("coefficient", 1.6447191),
        ("average", 2.1938844),
        ("get", 0.14391226),
    ],
    &[
    ...
    &[("negatives", 5.241858), ("sample", 5.241858)],
    &[("holdout", 3.689684), ("connected", 3.5005982)],
    &[("random", 3.3445814), ("holdout", 3.689684)],
    &[
        ("node", 0.5929302),
        ("holdout", 1.0967586),
        ("label", 1.067174),
    ...
    &[("get", 0.3438502), ("chains", 5.241858)],
    &[
        ("predecessors", 0.5740269),
        ("first", 0.3931518),
        ("unchecked", 0.19814557),
        ("search", 0.3931518),
        ("node_id", 0.2201881),
        ("from", 0.11078369),
        ("breadth", 0.3931518),
    ...
    &[
        ...
        ("from", 0.17221478),
        ("k", 0.64716876),
        ("node_names", 0.72189164),
        ("path", 0.5467466),
    ],
    &[
        ("node_id", 0.42376605),
        ("eccentricity", 0.43033853),
        ("most", 0.46637237),
        ("distant", 0.52397037),
        ("get", 0.03765445),
        ("from", 0.11078369),
    ...
    &[
        ...
        ("node_id", 0.51771694),
        ("from", 0.13653141),
        ("eccentricity", 0.5303554),
        ("distant", 0.6457487),
    ],
    &[
        ("weighted", 0.68148804),
        ("eccentricity", 1.1681138),
        ("node_id", 0.5976801),
        ("from", 0.300712),
        ("get", 0.102209486),
    ],
    ...
    &[("get", 0.3438502), ("diameter", 4.48367)],
    &[
        ("weighted", 0.95954376),
        ("get", 0.14391226),
        ("naive", 2.0025723),
    ...
    &[
        ...
        ("selfloops", 0.9941769),
        ("with", 0.8499249),
        ("node_names", 0.66866684),
    ],
    &[("density", 5.241858), ("get", 0.3438502)],
    &[
        ("get", 0.14391226),
        ("rate", 1.6447191),
        ("nodes", 1.0088933),
    ...
    &[("source_names", 5.241858), ("get", 0.3438502)],
    &[
        ("get", 0.2147389),
        ("destination", 2.4541702),
        ("node_ids", 1.076373),
    ],
    &[
        ("node_ids", 0.72135633),
        ("directed", 1.4651116),
        ("get", 0.14391226),
        ("destination", 1.6447191),
    ],
    &[("get", 0.3438502), ("destination_names", 5.241858)],
    &[("get", 0.3438502), ("node_names", 2.2495096)],
    &[("node", 1.2457275), ("urls", 3.273608), ("get", 0.2147389)],
    &[
        ("ontologies", 3.273608),
        ("get", 0.2147389),
        ("node", 1.2457275),
    ],
    &[("node_ids", 1.7235401), ("get", 0.3438502)],
    &[("get", 0.3438502), ("edge_type_ids", 3.929735)],
    &[
        ("get", 0.2147389),
        ("edge_type_ids", 2.4541702),
        ("unique", 2.1861687),
    ],
    &[("edge_type_names", 4.07922), ("get", 0.3438502)],
    &[
        ("edge_type_names", 2.5475254),
        ("unique", 2.1861687),
        ("get", 0.2147389),
    ],
    &[
    ...
    &[("node_type_ids", 3.3445814), ("get", 0.3438502)],
    &[
        ("get", 0.14391226),
        ("known", 1.2958364),
        ("node_types", 0.97851056),
    ...
    &[("node_type_names", 3.4191937), ("get", 0.3438502)],
    &[
        ("unique", 2.1861687),
        ("node_type_ids", 2.0887344),
        ("get", 0.2147389),
    ...
    &[
        ...
        ("get", 0.14391226),
        ("counts", 1.7824374),
        ("edge_type_id", 1.2145424),
    ],
    &[
        ("hashmap", 1.7824374),
        ("edge_type_names", 1.7072833),
        ("counts", 1.7824374),
        ("get", 0.14391226),
    ],
    &[
    ...
    &[("directed", 3.5005982), ("to", 3.4191937)],
    &[
        ("triangular", 2.9881418),
        ("upper", 3.273608),
        ("to", 2.1353307),
    ],
    &[
    ...
    &[("to", 3.4191937), ("bidiagonal", 5.241858)],
    &[("arrowhead", 5.241858), ("to", 3.4191937)],
    &[("transposed", 5.241858), ("to", 3.4191937)],
    &[("to", 3.4191937), ("complementary", 5.241858)],
    &[("report", 6.966339)],
    &[
        ("textual", 2.9881418),
        ("overlap", 3.273608),
    ...
    &[("textual", 4.7847557), ("report", 4.07922)],
    &[
        ("graph", 1.3442281),
        ("connected", 1.4651116),
        ("generate", 1.4310412),
    ...
    &[("replace", 8.951849)],
    &[("filter", 4.7847557), ("from_ids", 5.241858)],
    &[("from_names", 5.241858), ("filter", 4.7847557)],
    &[
        ("node_types", 1.4600861),
        ("drop", 2.3742006),
        ("unknown", 1.8696481),
    ...
    &[
        ("drop", 2.3742006),
        ("disconnected", 2.659667),
        ("nodes", 1.5054218),
    ],
    &[("drop", 3.8016837), ("selfloops", 3.3445814)],
    &[
        ("edges", 1.9007024),
        ("parallel", 2.5475254),
        ("drop", 2.3742006),
    ...
    &[
        ("kruskal", 2.0025723),
        ("random", 1.3998137),
        ("arborescence", 2.0025723),
        ("spanning", 1.8765585),
    ],
    &[
        ("spanning", 2.8001099),
        ("kruskal", 2.9881418),
        ("arborescence", 2.9881418),
    ],
    &[
        ("components", 2.659667),
        ("get", 0.2147389),
    ...
    &[("enable", 8.951849)],
    &[("all", 3.689684), ("disable", 5.241858)],
    &[("compatible", 5.241858), ("is", 3.2117705)],
    &[
        ("matrix", 1.6447191),
        ("same", 2.1938844),
        ("adjacency", 1.8765585),
    ...
    &[("nodes", 2.4105535), ("has", 2.2286985)],
    &[("has", 2.2286985), ("edges", 3.0434957)],
    &[
        ("trap", 2.4541702),
        ("has", 1.3918511),
        ("nodes", 1.5054218),
    ],
    &[("directed", 3.5005982), ("is", 3.2117705)],
    &[
        ("has", 1.3918511),
        ("weights", 2.0057921),
        ("edge", 1.2867613),
    ...
    &[
        ("edge", 0.61246103),
        ("representing", 1.5581424),
        ("probabilities", 1.5581424),
        ("has", 0.6624807),
        ("weights", 0.9546989),
    ],
    &[
    ...
    &[("has", 2.2286985), ("edge_types", 2.4624422)],
    &[("has", 2.2286985), ("selfloops", 3.3445814)],
    &[
        ("has", 1.3918511),
        ("nodes", 1.5054218),
        ("disconnected", 2.659667),
    ...
    &[("connected", 3.5005982), ("is", 3.2117705)],
    &[("has", 2.2286985), ("node_types", 2.3379598)],
    &[
        ("has", 1.3918511),
        ("node_types", 1.4600861),
        ("multilabel", 2.9881418),
    ],
    &[
        ("node_types", 1.4600861),
        ("unknown", 1.8696481),
    ...
    &[("is", 3.2117705), ("multigraph", 4.48367)],
    &[
        ("by", 0.5130737),
        ("decreasing", 0.6457487),
        ("sorted", 0.6051143),
        ("nodes", 0.3253273),
        ("outbound", 0.574764),
        ("has", 0.30078426),
    ...
    &[
        ("edge_type_id", 0.8625934),
        ("edge_type_name", 0.9941769),
        ("get", 0.102209486),
        ("unchecked", 0.5378477),
        ("from", 0.300712),
    ],
    ...
    &[
        ...
        ("weight", 0.30969155),
        ("edge_id", 0.23613517),
        ("edge_type_id", 0.26283905),
        ("get", 0.031144042),
        ("and", 0.563539),
        ("unchecked", 0.16388644),
        ("from", 0.091629334),
    ],
    &[
        ("weight", 0.37443003),
    ...
    &[
        ("from", 0.2235265),
        ("node", 0.4407393),
        ("comulative", 1.0572066),
        ("get", 0.07597478),
        ("node_id", 0.44427),
        ("degree", 0.6227811),
    ],
    &[
        ("reciprocal", 0.72498226),
        ("from", 0.17221478),
        ("get", 0.058534358),
        ("degree", 0.47981834),
        ("unchecked", 0.30802003),
    ...
    &[
        ("node", 0.5929302),
        ("count", 1.1681138),
        ("node_type_id", 1.067174),
        ("from", 0.300712),
        ("get", 0.102209486),
    ],
    &[
        ("node_type_name", 1.0405529),
        ("from", 0.300712),
        ("get", 0.102209486),
        ("count", 1.1681138),
        ("node", 0.5929302),
    ...
    &[("tendrils", 5.241858), ("get", 0.3438502)],
    &[
        ("threshold", 1.1582049),
        ("node", 0.4407393),
        ("degree", 0.6227811),
        ("distribution", 1.1582049),
        ("geometric", 1.1582049),
        ("get", 0.07597478),
    ],
    &[
    ...
    &[("selfloops", 3.3445814), ("add", 5.241858)],
    &[
        ("degree", 1.7602595),
        ("get", 0.2147389),
        ("centrality", 1.8696481),
    ],
    &[
        ("get", 0.14391226),
        ("weighted", 0.95954376),
    ...
    &[
        ...
        ("node_id", 0.44427),
        ("unchecked", 0.39979514),
        ("centrality", 0.6614829),
        ("get", 0.07597478),
        ("closeness", 0.94099206),
    ],
    &[
        ("node_id", 0.34228545),
        ("closeness", 0.72498226),
        ("weighted", 0.3902814),
        ("centrality", 0.50963587),
        ("unchecked", 0.30802003),
        ("get", 0.058534358),
        ("from", 0.17221478),
    ],
    ...
    &[
        ("betweenness", 2.5475254),
        ("centrality", 1.8696481),
        ("get", 0.2147389),
    ],
    &[
        ("betweenness", 0.90131634),
        ("centrality", 0.6614829),
        ("get", 0.07597478),
        ("node_id", 0.44427),
        ("approximated", 0.90131634),
        ("from", 0.2235265),
    ],
    &[
        ("centrality", 0.6614829),
    ...
    &[
        ("approximated", 0.6944143),
        ("get", 0.058534358),
        ("centrality", 0.50963587),
        ("from", 0.17221478),
        ("betweenness", 0.6944143),
        ("weighted", 0.3902814),
        ("node_id", 0.34228545),
    ],
    &[
    ...
    &[
        ("centrality", 1.252988),
        ("weighted", 0.95954376),
        ("eigenvector", 2.0025723),
        ("get", 0.14391226),
    ],
    &[("dot", 5.241858), ("to", 3.4191937)],
    &[("get", 0.3438502), ("stars", 5.241858)],
    &[
        ("detection", 1.5581424),
        ("undirected", 1.2125483),
        ("get", 0.102209486),
    ...
    &[
        ("directed", 0.5959143),
        ("from", 0.17221478),
        ("memberships", 0.81451917),
        ("get", 0.058534358),
        ("modularity", 0.81451917),
        ("community", 0.7632648),
        ("node", 0.33956522),
    ],
    &[
        ...
        ("memberships", 0.81451917),
        ("community", 0.7632648),
        ("undirected", 0.6944143),
        ("from", 0.17221478),
        ("get", 0.058534358),
    ],
    &[
        ("unchecked", 0.5378477),
        ("attachment", 1.0405529),
        ("minimum", 1.1300505),
        ("preferential", 1.0405529),
        ("get", 0.102209486),
    ],
    &[
        ("maximum", 1.0967586),
    ...
    &[
        ("get", 0.07597478),
        ("unchecked", 0.39979514),
        ("preferential", 0.7734681),
        ("minimum", 0.8399939),
        ("weighted", 0.50656646),
        ("attachment", 0.7734681),
    ],
    &[
        ("weighted", 0.50656646),
        ("get", 0.07597478),
    ...
    &[
        ("unchecked", 0.30802003),
        ("attachment", 0.5959143),
        ("weighted", 0.3902814),
        ("preferential", 0.5959143),
        ("get", 0.058534358),
        ("from", 0.17221478),
        ("node_ids", 0.29340193),
    ],
    ...
    &[
        ...
        ("node_ids", 0.23260826),
        ("get", 0.04640588),
        ("allocation", 0.5303554),
    ],
    &[
        ("resource", 0.8682872),
        ("node_ids", 0.38082156),
        ("index", 0.7932561),
        ("allocation", 0.8682872),
        ("from", 0.2235265),
        ("get", 0.07597478),
    ],
    &[
