...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("graph", 0.65378696),
        ("laplacian", 0.8759679),
        ("normalized", 0.9211158),
        ("random", 0.66576785),
        ("transformed", 0.8759679),
        ("walk", 0.98156214),
    ],
    &[
        ("get", 0.08843599),
        ("graph", 0.8415807),
        ("laplacian", 1.1275809),
        ("normalized", 1.1856971),
        ("symmetric", 1.263506),
        ("transformed", 1.1275809),
    ],
    &[
        ("get", 0.11766137),
        ("graph", 1.1196972),
        ("normalized", 1.5775336),
        ("symmetric", 1.681056),
        ("transformed", 1.5002118),
    ],
    &[
        ("connected", 0.9106069),
        ("from", 0.24729374),
    ...
    &[
        ("disconnected", 0.8759679),
        ("from", 0.19211161),
        ("id", 0.29454017),
        ("is", 0.65378696),
        ("node", 0.20039904),
        ("unchecked", 0.36698902),
    ],
    &[
        ("from", 0.24729374),
        ("id", 0.37914386),
    ...
    &[
        ...
        ("is", 0.5216406),
        ("node", 0.08569163),
        ("selfloops", 0.55247384),
        ("singleton", 0.41999418),
        ("unchecked", 0.29281157),
        ("with", 0.4747392),
    ],
    &[
        ("from", 0.19211161),
    ...
    &[("has", 1.518313), ("name", 1.4830604), ("node", 0.37223235)],
    &[
        ("has", 1.0402654),
        ("id", 0.69942033),
        ("node", 0.25503334),
    ...
    &[("components", 4.7064347), ("remove", 2.6599233)],
    &[("overlaps", 9.423609)],
    &[("contains", 8.617903)],
    &[
        ("bipartite", 3.4019558),
    ...
    &[("edge", 1.2565453), ("encode", 5.7668324)],
    &[("decode", 5.7668324), ("edge", 1.2565453)],
    &[
        ("edge", 0.40053335),
        ("encodable", 1.8382217),
        ("get", 0.11766137),
    ...
    &[("circles", 5.7668324), ("get", 0.36912492)],
    &[
        ("get", 0.23811151),
        ("memory", 2.3998685),
        ("stats", 3.720012),
    ...
    &[("get", 0.36912492), ("transitivity", 5.7668324)],
    &[
        ("get", 0.08843599),
        ("node", 0.13824923),
        ("number", 0.5684447),
    ...
    &[
        ("clustering", 1.5775336),
        ("coefficient", 1.387074),
        ("get", 0.11766137),
        ("node", 0.18393637),
        ("per", 1.681056),
    ],
    &[
        ("clustering", 3.1924572),
        ("coefficient", 2.8070238),
        ("get", 0.23811151),
    ],
    &[
        ("average", 2.5487497),
        ("clustering", 2.187298),
        ("coefficient", 1.9232199),
        ("get", 0.16314104),
    ],
    &[
        ("are", 3.720012),
    ...
    &[("negatives", 5.7668324), ("sample", 5.7668324)],
    &[("connected", 3.8008022), ("holdout", 4.0925684)],
    &[("holdout", 4.0925684), ("random", 3.5770636)],
    &[
        ("get", 0.11766137),
        ("holdout", 1.3045373),
        ("indices", 1.8382217),
    ...
    &[("chains", 5.7668324), ("get", 0.36912492)],
    &[
        ("breadth", 0.40082034),
        ("first", 0.40082034),
        ("from", 0.10381397),
        ...
        ("node", 0.058037065),
        ("parallel", 0.45387793),
        ("predecessors", 0.5800103),
        ("search", 0.40082034),
        ("unchecked", 0.19831486),
    ],
    &[
        ("breadth", 0.40082034),
        ("distances", 0.49775591),
        ("first", 0.40082034),
        ("from", 0.10381397),
        ("get", 0.03712545),
        ("ids", 0.15748364),
    ...
    &[
        ("and", 0.3033916),
        ("distant", 0.44729963),
        ("eccentricity", 0.36907616),
        ("from", 0.0875456),
        ("get", 0.031307638),
        ("id", 0.2599331),
        ("most", 0.39918014),
        ("node", 0.094780795),
        ("unchecked", 0.16723755),
    ],
    &[
        ("eccentricity", 0.80990714),
        ("from", 0.19211161),
        ("get", 0.06870203),
        ("id", 0.29454017),
        ("node", 0.10739974),
    ...
    &[("diameter", 5.2737756), ("get", 0.36912492)],
    &[
        ("breadth", 0.74173295),
        ("first", 0.74173295),
        ("from", 0.19211161),
    ...
    &[("density", 5.7668324), ("get", 0.36912492)],
    &[
        ("get", 0.16314104),
        ("nodes", 1.1222045),
        ("rate", 1.9232199),
    ...
    &[
        ...
        ("get", 0.16314104),
        ("number", 1.0486304),
        ("undirected", 1.9944842),
    ],
    &[
        ("edges", 0.9916573),
        ("get", 0.11766137),
        ("number", 0.75629824),
        ("undirected", 1.4384714),
        ("unique", 1.2115346),
    ],
    &[
        ("edges", 2.0068185),
    ...
    &[
        ("destination", 1.8621742),
        ("get", 0.16314104),
        ("ids", 0.69203323),
        ("node", 0.25503334),
    ],
    &[
        ("destination", 1.3430462),
        ("directed", 1.0336775),
        ("get", 0.11766137),
        ("ids", 0.49911153),
        ("node", 0.18393637),
    ...
    &[("directed", 3.2428324), ("to", 3.8008022)],
    &[
        ("to", 2.4517846),
        ("triangular", 3.4019558),
        ("upper", 3.720012),
    ],
    &[
        ("lower", 3.720012),
    ...
    &[("bidiagonal", 5.7668324), ("to", 3.8008022)],
    &[("arrowhead", 5.7668324), ("to", 3.8008022)],
    &[("to", 3.8008022), ("transposed", 5.7668324)],
    &[("complementary", 5.7668324), ("to", 3.8008022)],
    &[
        ("approximated", 2.5084262),
        ("cliques", 3.4019558),
        ("get", 0.23811151),
    ],
    &[
    ...
    &[("report", 4.5127444), ("textual", 5.2737756)],
    &[
        ("connected", 1.6798292),
        ("generate", 1.6798292),
        ("graph", 1.552494),
    ...
    &[("remove", 2.6599233), ("tendrils", 5.2737756)],
    &[
        ("dendritic", 3.4019558),
        ("remove", 1.7158375),
        ("trees", 3.4019558),
    ...
    &[
        ("disconnected", 3.035981),
        ("nodes", 1.6379068),
        ("remove", 1.7158375),
    ],
    &[("remove", 2.6599233), ("selfloops", 3.720321)],
    &[
        ("edges", 2.0068185),
        ("parallel", 2.911037),
        ("remove", 1.7158375),
    ...
    &[
        ("arborescence", 2.3308349),
        ("kruskal", 2.3308349),
        ("random", 1.5809442),
        ("spanning", 2.187298),
    ],
    &[
        ("arborescence", 3.4019558),
        ("kruskal", 3.4019558),
        ("spanning", 3.1924572),
    ],
    &[
    ...
    &[("enable", 9.423609)],
    &[("all", 4.0925684), ("disable", 5.7668324)],
    &[
        ("compatible", 2.0800889),
        ("has", 1.0402654),
        ("node", 0.25503334),
        ("vocabularies", 2.187298),
    ],
    &[
        ("compatible", 1.5002118),
        ("has", 0.7502653),
        ("node", 0.18393637),
        ("types", 0.6166827),
        ("vocabularies", 1.5775336),
    ],
    &[
        ("compatible", 1.5002118),
        ("edge", 0.40053335),
    ...
    &[("compatible", 4.7064347), ("is", 3.512692)],
    &[
        ("adjacency", 2.187298),
        ("has", 1.0402654),
        ("matrix", 1.9232199),
    ...
    &[("has", 2.3537173), ("nodes", 2.5391138)],
    &[("edges", 3.1110077), ("has", 2.3537173)],
    &[("has", 1.518313), ("nodes", 1.6379068), ("trap", 2.8070238)],
    &[("directed", 3.2428324), ("is", 3.512692)],
    &[("edge", 0.81056), ("has", 1.518313), ("weights", 2.227006)],
    &[
        ("edge", 0.40053335),
        ("has", 0.7502653),
        ("probabilities", 1.8382217),
        ("representing", 1.8382217),
        ("weights", 1.1004617),
    ],
    &[
        ("has", 1.0402654),
    ...
    &[("edge", 0.81056), ("has", 1.518313), ("types", 1.2479818)],
    &[("has", 2.3537173), ("selfloops", 3.720321)],
    &[
        ("disconnected", 3.035981),
        ("has", 1.518313),
        ("nodes", 1.6379068),
    ...
    &[("connected", 3.8008022), ("is", 3.512692)],
    &[
        ("has", 1.518313),
        ("node", 0.37223235),
        ("types", 1.2479818),
    ...
    &[("is", 3.512692), ("multigraph", 4.949007)],
    &[
        ("has", 1.518313),
        ("node", 0.37223235),
        ("ontologies", 2.911037),
    ...
    &[("get", 0.36912492), ("tendrils", 5.2737756)],
    &[
        ("degree", 0.7553999),
        ("distribution", 1.381634),
        ("geometric", 1.381634),
        ("get", 0.08843599),
        ("node", 0.13824923),
        ("threshold", 1.381634),
    ...
    &[("add", 5.7668324), ("selfloops", 3.720321)],
    &[
        ("centrality", 2.1557705),
        ("degree", 2.0338938),
        ("get", 0.23811151),
    ],
    &[
        ("centrality", 1.4770166),
        ("degree", 1.3935133),
        ("get", 0.16314104),
        ("weighted", 1.1534327),
    ],
    &[
        ("centrality", 0.6220018),
        ("closeness", 0.8759679),
        ("from", 0.19211161),
        ("get", 0.06870203),
        ("id", 0.29454017),
    ...
    &[
        ("betweenness", 2.911037),
        ("centrality", 2.1557705),
        ("get", 0.23811151),
    ],
    &[
        ("approximated", 0.72375315),
        ("betweenness", 0.83991796),
        ("centrality", 0.6220018),
        ("from", 0.19211161),
        ("get", 0.06870203),
        ("id", 0.29454017),
    ...
    &[
        ("approximated", 0.57746494),
        ("betweenness", 0.67015004),
        ("centrality", 0.49628007),
        ("from", 0.15328115),
        ("get", 0.054815665),
        ("id", 0.2350064),
    ...
    &[
        ("centrality", 2.1557705),
        ("eigenvector", 3.4019558),
        ("get", 0.23811151),
    ],
    &[
        ("centrality", 1.4770166),
        ("eigenvector", 2.3308349),
        ("get", 0.16314104),
        ("weighted", 1.1534327),
    ],
    &[("dot", 5.7668324), ("to", 3.8008022)],
    &[("get", 0.36912492), ("stars", 5.7668324)],
    &[
        ("community", 1.5775336),
        ("detection", 1.8382217),
        ("get", 0.11766137),
    ...
    &[
        ...
        ("from", 0.19211161),
        ("get", 0.06870203),
        ("memberships", 0.98156214),
        ("modularity", 0.98156214),
        ("node", 0.10739974),
    ],
    &[
        ("community", 0.9211158),
        ...
        ("modularity", 0.98156214),
        ("node", 0.10739974),
        ("undirected", 0.83991796),
    ],
    &[
        ("attachment", 1.2395238),
        ("get", 0.11766137),
        ("minimum", 1.3430462),
        ("preferential", 1.2395238),
        ("unchecked", 0.62851757),
    ],
    &[
        ("attachment", 1.2395238),
    ...
    &[
        ("attachment", 0.93164396),
        ("get", 0.08843599),
        ("minimum", 1.0094529),
        ("preferential", 0.93164396),
        ("unchecked", 0.4724029),
        ("weighted", 0.6252563),
    ],
    &[
    ...
    &[
        ("attachment", 0.72375315),
        ("from", 0.19211161),
        ("get", 0.06870203),
        ("ids", 0.2914293),
        ("node", 0.10739974),
        ("preferential", 0.72375315),
        ("unchecked", 0.36698902),
    ],
    &[
        ("attachment", 0.93164396),
    ...
    &[
        ("attachment", 0.57746494),
        ("from", 0.15328115),
        ("get", 0.054815665),
        ("ids", 0.23252434),
        ("node", 0.08569163),
        ("preferential", 0.57746494),
        ("unchecked", 0.29281157),
        ("weighted", 0.38755533),
    ],
    &[
