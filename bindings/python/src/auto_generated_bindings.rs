...
impl Graph {
    ...
    pub fn get_isomorphic_node_ids(&self, minimum_node_degree: Option<NodeT>) -> Vec<Vec<NodeT>> {
        self.inner
            .get_isomorphic_node_ids(minimum_node_degree.into())
            .into_iter()
            .map(|x| x.into())
            .collect::<Vec<_>>()
    }
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("laplacian", 0.7260212),
        ("random", 0.57010865),
        ("transformed", 0.7260212),
        ("normalized", 0.7643738),
        ("get", 0.060067896),
    ],
    &[
        ("graph", 0.71051437),
        ("get", 0.077958606),
        ("symmetric", 1.0586783),
        ("normalized", 0.99203604),
        ("laplacian", 0.9422604),
        ("transformed", 0.9422604),
    ],
    &[
        ("normalized", 1.3344406),
        ("symmetric", 1.4240845),
        ("transformed", 1.2674847),
        ("get", 0.10486628),
        ("graph", 0.95575076),
    ],
    &[
    ...
    &[
        ("unchecked", 0.39728728),
        ("is", 0.6732685),
        ("node", 0.44827074),
        ("disconnected", 0.9422604),
        ("from", 0.22006498),
        ("node_id", 0.44466946),
    ],
    &[
    ...
    &[
        ...
        ("node_id", 0.3426223),
        ("with", 0.48734543),
        ("selfloops", 0.57010865),
        ("unchecked", 0.30611387),
        ("from", 0.1695623),
    ],
    &[
        ("with", 0.63249713),
        ("selfloops", 0.73991066),
        ("from", 0.22006498),
        ("is", 0.6732685),
        ("singleton", 0.5568506),
        ("node_id", 0.44466946),
    ...
    &[("has", 2.2289495), ("node_name", 2.7804353)],
    &[("node_type_id", 3.5916035), ("has", 2.2289495)],
    &[("node_type_name", 3.501967), ("has", 2.2289495)],
    &[("has", 2.2289495), ("edge_type_id", 2.9027548)],
    &[("edge_type_name", 3.3458133), ("has", 2.2289495)],
    &[
        ("edge", 0.8629071),
        ("node_ids", 0.7120234),
        ("from", 0.41673416),
    ...
    &[
        ("edge", 0.8629071),
        ("node_names", 0.9421621),
        ("has", 0.9334392),
        ("from", 0.41673416),
    ],
    &[
        ("edge_type_name", 0.73991066),
        ("has", 0.49292162),
        ("node_names", 0.49752793),
        ("from", 0.22006498),
        ("and", 0.71051437),
        ("edge", 0.45567572),
    ],
    ...
    &[
        ...
        ("node", 0.44827074),
        ("outbound", 0.9422604),
        ("decreasing", 1.0586783),
        ("by", 0.8410855),
    ],
    &[
        ("by", 1.131389),
        ("node", 0.60299283),
        ("lexicographic", 1.4240845),
        ("sort", 1.2674847),
        ("order", 1.4240845),
    ],
    &[
        ("node_id", 0.44466946),
        ("get", 0.077958606),
        ("topological", 0.8694283),
        ("from", 0.22006498),
        ("sorting", 0.99203604),
        ("bfs", 0.99203604),
    ],
    &[
        ("topological", 0.6699033),
        ("from", 0.1695623),
        ("bfs", 0.7643738),
        ("reversed", 0.89367855),
        ("get", 0.060067896),
    ...
    &[("components", 4.2608213), ("remove", 2.8600984)],
    &[("overlaps", 8.952292)],
    &[("contains", 8.171377)],
    &[
        ("bipartite", 2.9907668),
    ...
    &[("encode", 5.2447577), ("edge", 2.0605268)],
    &[("edge", 2.0605268), ("decode", 5.2447577)],
    &[
        ("get", 0.10486628),
        ("encodable", 1.5601803),
        ("edge", 0.6129537),
    ...
    &[("validate", 3.691219), ("node_id", 2.0107577)],
    &[("validate", 3.691219), ("node_ids", 1.7002332)],
    &[("validate", 3.691219), ("edge_id", 2.6076677)],
    &[("edge_ids", 3.5916035), ("validate", 3.691219)],
    &[
        ("contain", 1.2674847),
        ("unknown", 0.8908442),
        ("node_types", 0.6955861),
        ("must", 1.017508),
        ("not", 1.1695143),
    ],
    &[
    ...
    &[("validate", 3.691219), ("node_type_id", 3.5916035)],
    &[("node_type_ids", 3.3458133), ("validate", 3.691219)],
    &[("edge_type_id", 2.9027548), ("validate", 3.691219)],
    &[("validate", 3.691219), ("edge_type_ids", 3.931481)],
    &[
        ("be", 2.661886),
        ("undirected", 2.549606),
        ("must", 2.136902),
    ...
    &[
        ("all", 2.3060353),
        ("edge_types", 1.5386602),
        ("set", 2.549606),
    ],
    &[
        ("all", 1.5458082),
        ("set", 1.7090813),
        ("node_types", 0.9792358),
        ("inplace", 1.320478),
    ],
    &[
        ("set", 2.549606),
        ("node_types", 1.4608232),
        ("all", 2.3060353),
    ],
    &[
        ("inplace", 1.969888),
        ("node_type_ids", 2.0902479),
        ("remove", 1.7868047),
    ],
    &[
        ("inplace", 1.320478),
    ...
    &[
        ...
        ("inplace", 1.320478),
        ("node_types", 0.9792358),
        ("homogeneous", 1.5927526),
    ],
    &[
        ("edge_type_ids", 2.4561353),
        ("remove", 1.7868047),
        ("inplace", 1.969888),
    ],
    &[
    ...
    &[
        ("remove", 1.7868047),
        ("node_type_name", 2.1878028),
        ("inplace", 1.969888),
    ],
    &[("node_type_id", 3.5916035), ("remove", 2.8600984)],
    &[
        ("remove", 1.7868047),
        ("node_types", 1.4608232),
        ("singleton", 1.5731032),
    ...
    &[
        ("node_types", 1.4608232),
        ("homogeneous", 2.376067),
        ("remove", 1.7868047),
    ],
    &[("remove", 2.8600984), ("node_type_name", 3.501967)],
    &[
        ("inplace", 1.969888),
        ("remove", 1.7868047),
        ("edge_type_name", 2.0902479),
    ],
    &[("remove", 2.8600984), ("edge_type_id", 2.9027548)],
    &[
        ("singleton", 1.5731032),
        ("remove", 1.7868047),
        ("edge_types", 1.5386602),
    ],
    &[("remove", 2.8600984), ("edge_type_name", 3.3458133)],
    &[
        ("remove", 1.7868047),
        ("node_types", 1.4608232),
        ("inplace", 1.969888),
    ],
    &[("node_types", 2.338307), ("remove", 2.8600984)],
    &[
        ("inplace", 1.969888),
        ("edge_types", 1.5386602),
        ("remove", 1.7868047),
    ],
    &[("remove", 2.8600984), ("edge_types", 2.462899)],
    &[
        ("inplace", 1.320478),
        ("edge", 0.8629071),
        ("remove", 1.1977515),
    ...
    &[("circles", 5.2447577), ("get", 0.3525222)],
    &[
        ("memory", 2.0902479),
        ("get", 0.22023311),
        ("stats", 3.2765858),
    ...
    &[
        ("memory", 0.73991066),
        ("weights", 0.71051437),
        ("requirements", 0.8694283),
        ("edge", 0.45567572),
        ("total", 0.73991066),
        ("get", 0.077958606),
    ],
    &[
        ("requirements", 0.5311321),
        ("edge", 0.27837145),
        ("total", 0.45201004),
        ("memory", 0.45201004),
        ("get", 0.04762477),
    ...
    &[
        ...
        ("human", 0.69539714),
        ("readable", 0.69539714),
        ("requirements", 0.6699033),
        ("node_types", 0.39843497),
        ("total", 0.57010865),
        ("memory", 0.57010865),
    ],
    &[
    ...
    &[("transitivity", 5.2447577), ("get", 0.3525222)],
    &[
        ("get", 0.077958606),
        ("node", 0.44827074),
        ("of", 1.0586783),
    ...
    &[
        ("get", 0.10486628),
        ("node", 0.60299283),
        ("clustering", 1.3344406),
        ("per", 1.4240845),
        ("coefficient", 1.1695143),
    ],
    &[
        ("coefficient", 2.4561353),
        ("get", 0.22023311),
        ("clustering", 2.8025024),
    ],
    &[
        ("average", 2.1963987),
        ("coefficient", 1.6464249),
        ("get", 0.14762919),
        ("clustering", 1.8786056),
    ],
    &[
        ("nodes", 1.5062149),
        ("are", 3.2765858),
        ("remappable", 3.2765858),
    ],
    &[
        ("from", 0.41673416),
        ("unchecked", 0.75233775),
        ("node_ids", 0.7120234),
        ("remap", 1.7843461),
    ],
    &[
    ...
    &[("negatives", 5.2447577), ("sample", 5.2447577)],
    &[("holdout", 3.691219), ("connected", 3.501967)],
    &[("holdout", 3.691219), ("random", 3.3458133)],
    &[
        ("indices", 1.5601803),
        ("node", 0.60299283),
        ("holdout", 1.0980426),
    ...
    &[
        ("prediction", 2.1963987),
        ("kfold", 1.8786056),
        ("edge", 0.8629071),
        ("get", 0.14762919),
    ],
    &[("chains", 5.2447577), ("get", 0.3525222)],
    &[
        ("parallel", 0.44739267),
        ("first", 0.39373165),
        ("unchecked", 0.1969423),
        ("predecessors", 0.5749596),
        ("from", 0.10909008),
        ("breadth", 0.39373165),
        ("node_id", 0.22043048),
        ("search", 0.39373165),
    ...
    &[
        ...
        ("path", 0.54745847),
        ("from", 0.1695623),
        ("node_names", 0.7225912),
    ],
    &[
        ("from", 0.10909008),
        ("node_id", 0.42420128),
        ("most", 0.46709505),
        ("eccentricity", 0.43099087),
        ("get", 0.038645454),
        ("unchecked", 0.1969423),
        ("distant", 0.5248054),
        ("and", 0.35221446),
    ...
    &[
        ...
        ("node_id", 0.5981486),
        ("weighted", 0.68209344),
        ("eccentricity", 1.1695143),
    ],
    &[
        ("from", 0.41673416),
        ("eccentricity", 1.6464249),
        ("node_name", 1.1643902),
        ("get", 0.14762919),
    ],
    &[
    ...
    &[("diameter", 4.485903), ("get", 0.3525222)],
    &[
        ("naive", 2.004805),
        ("weighted", 0.9602411),
        ("get", 0.14762919),
    ...
    &[
        ...
        ("get", 0.10486628),
        ("selfloops", 0.99529326),
        ("node_names", 0.6692513),
        ("singleton", 0.7490494),
    ],
    &[("get", 0.3525222), ("density", 5.2447577)],
    &[
        ("nodes", 1.0096632),
        ("rate", 1.6464249),
        ("get", 0.14762919),
    ...
    &[("get", 0.3525222), ("source_names", 5.2447577)],
    &[
        ("node_ids", 1.0621959),
        ("destination", 2.4561353),
        ("get", 0.22023311),
    ],
    &[
        ("node_ids", 0.7120234),
        ("destination", 1.6464249),
        ("directed", 1.4665532),
        ("get", 0.14762919),
    ],
    &[("get", 0.3525222), ("destination_names", 5.2447577)],
    &[("node_names", 2.249779), ("get", 0.3525222)],
    &[("get", 0.22023311), ("urls", 3.2765858), ("node", 1.266365)],
    &[
        ("node", 1.266365),
        ("get", 0.22023311),
        ("ontologies", 3.2765858),
    ],
    &[("get", 0.3525222), ("node_ids", 1.7002332)],
    &[("edge_type_ids", 3.931481), ("get", 0.3525222)],
    &[
        ("get", 0.22023311),
        ("unique", 2.1878028),
        ("edge_type_ids", 2.4561353),
    ],
    &[("edge_type_names", 4.081097), ("get", 0.3525222)],
    &[
        ("get", 0.22023311),
        ("edge_type_names", 2.549606),
        ("unique", 2.1878028),
    ],
    &[
        ("edge", 1.2872841),
    ...
    &[("node_type_ids", 3.3458133), ("get", 0.3525222)],
    &[
        ("mask", 1.6464249),
        ("known", 1.2970288),
        ("get", 0.14762919),
    ...
    &[
        ...
        ("known", 0.6849225),
        ("hot", 0.9422604),
        ("edge_types", 0.54465836),
        ("encoded", 0.9422604),
        ("one", 0.9422604),
    ],
    &[("node_type_names", 3.4204912), ("get", 0.3525222)],
    &[
        ("unique", 2.1878028),
        ("get", 0.22023311),
        ("node_type_ids", 2.0902479),
    ...
    &[
        ("get", 0.14762919),
        ("hashmap", 1.7843461),
        ("edge_type_id", 1.2156152),
        ("counts", 1.7843461),
    ],
    &[
        ("counts", 1.7843461),
        ("edge_type_names", 1.7090813),
        ("get", 0.14762919),
        ("hashmap", 1.7843461),
    ],
    &[
    ...
    &[("to", 3.4204912), ("directed", 3.501967)],
    &[
        ("upper", 3.2765858),
        ("triangular", 2.9907668),
        ("to", 2.136902),
    ],
    &[
        ("triangular", 2.9907668),
    ...
    &[("to", 3.4204912), ("bidiagonal", 5.2447577)],
    &[("arrowhead", 5.2447577), ("to", 3.4204912)],
    &[("transposed", 5.2447577), ("to", 3.4204912)],
    &[("to", 3.4204912), ("complementary", 5.2447577)],
    &[("report", 6.9660373)],
    &[
        ("report", 2.549606),
        ("textual", 2.9907668),
    ...
    &[("textual", 4.7872534), ("report", 4.081097)],
    &[
        ("generate", 1.4324328),
        ("graph", 1.3454918),
        ("connected", 1.4665532),
    ...
    &[("replace", 8.952292)],
    &[("from_ids", 5.2447577), ("filter", 4.7872534)],
    &[("from_names", 5.2447577), ("filter", 4.7872534)],
    &[
        ("drop", 2.376067),
        ("unknown", 1.8708911),
        ("node_types", 1.4608232),
    ...
    &[
        ("drop", 2.376067),
        ("nodes", 1.5062149),
        ("disconnected", 2.661886),
    ],
    &[("drop", 3.8033173), ("selfloops", 3.3458133)],
    &[
        ("edges", 1.9019837),
        ("parallel", 2.549606),
        ("drop", 2.376067),
    ...
    &[
        ("arborescence", 2.004805),
        ("spanning", 1.8786056),
        ("kruskal", 2.004805),
        ("random", 1.401159),
    ],
    &[
        ("arborescence", 2.9907668),
        ("spanning", 2.8025024),
        ("kruskal", 2.9907668),
    ],
    &[
    ...
    &[("enable", 8.952292)],
    &[("all", 3.691219), ("disable", 5.2447577)],
    &[("compatible", 5.2447577), ("is", 3.044463)],
    &[
        ("has", 0.9334392),
        ("adjacency", 1.8786056),
        ("matrix", 1.6464249),
    ...
    &[
        ("graph_name", 3.2765858),
        ("has", 1.3925037),
        ("default", 3.2765858),
    ],
    &[("nodes", 2.4109643), ("has", 2.2289495)],
    &[("edges", 3.044463), ("has", 2.2289495)],
    &[
        ("trap", 2.4561353),
        ("nodes", 1.5062149),
        ("has", 1.3925037),
    ],
    &[("is", 3.044463), ("directed", 3.501967)],
    &[
        ("weights", 2.0072033),
        ("edge", 1.2872841),
        ("has", 1.3925037),
    ...
    &[
        ("weights", 0.95575076),
        ("probabilities", 1.5601803),
        ("edge", 0.6129537),
        ("representing", 1.5601803),
        ("has", 0.6630551),
    ],
    &[
        ("has", 0.9334392),
    ...
    &[("has", 2.2289495), ("edge_types", 2.462899)],
    &[("has", 2.2289495), ("selfloops", 3.3458133)],
    &[
        ("nodes", 1.5062149),
        ("has", 1.3925037),
        ("disconnected", 2.661886),
    ...
    &[("connected", 3.501967), ("is", 3.044463)],
    &[("has", 2.2289495), ("node_types", 2.338307)],
    &[
        ("multilabel", 2.9907668),
        ("has", 1.3925037),
        ("node_types", 1.4608232),
    ],
    &[
    ...
    &[("multigraph", 4.485903), ("is", 3.044463)],
    &[
        ("degree", 0.38089058),
        ("decreasing", 0.6467446),
        ("nodes", 0.32571456),
        ("has", 0.3011249),
        ("sorted", 0.60603297),
        ("by", 0.5138176),
    ...
    &[
        ("from", 0.29602113),
        ("unchecked", 0.5344123),
        ("edge_type_name", 0.99529326),
        ("get", 0.10486628),
        ("edge_type_id", 0.8634948),
    ],
    &[
        ("edge_type_name", 0.99529326),
        ("from", 0.29602113),
    ...
    &[
        ...
        ("edge", 0.18683869),
        ("edge_id", 0.23645078),
        ("unchecked", 0.16289794),
        ("and", 0.5643264),
        ("get", 0.03196502),
        ("weight", 0.31015372),
        ("edge_type_id", 0.26320788),
    ],
    &[
        ("edge_type_id", 0.3182162),
        ("edge", 0.22588646),
        ("from", 0.10909008),
        ("edge_id", 0.2858671),
        ("and", 0.6778093),
    ...
    &[
        ("unchecked", 0.5344123),
        ("from", 0.29602113),
        ("node_type_ids", 0.99529326),
        ("get", 0.10486628),
        ("node_id", 0.5981486),
    ],
    &[
        ("node_type_ids", 1.401159),
        ("from", 0.41673416),
        ("node_id", 0.84206474),
        ("get", 0.14762919),
    ],
    ...
    &[("selfloops", 3.3458133), ("add", 5.2447577)],
    &[
        ("centrality", 1.8708911),
        ("get", 0.22023311),
        ("degree", 1.7613674),
    ],
    &[
        ("degree", 1.1807001),
        ("centrality", 1.2541173),
        ("weighted", 0.9602411),
        ("get", 0.14762919),
    ],
    &[
        ("centrality", 0.6622622),
        ("closeness", 0.9422604),
        ("unchecked", 0.39728728),
        ("node_id", 0.44466946),
        ("get", 0.077958606),
    ...
    &[
        ("get", 0.22023311),
        ("centrality", 1.8708911),
        ("betweenness", 2.549606),
    ],
    &[
        ("node_id", 0.44466946),
        ("betweenness", 0.90251523),
        ("get", 0.077958606),
        ("approximated", 0.90251523),
        ("centrality", 0.6622622),
        ("from", 0.22006498),
    ],
    &[
    ...
    &[
        ...
        ("weighted", 0.39070633),
        ("get", 0.060067896),
        ("approximated", 0.69539714),
        ("betweenness", 0.69539714),
    ],
    &[
        ("betweenness", 0.69539714),
        ("get", 0.060067896),
        ("approximated", 0.69539714),
        ("node_name", 0.47377127),
        ("weighted", 0.39070633),
        ("centrality", 0.5102797),
        ("from", 0.1695623),
    ],
    &[
        ("eigenvector", 2.9907668),
        ("centrality", 1.8708911),
        ("get", 0.22023311),
    ],
    &[
        ("eigenvector", 2.004805),
        ("get", 0.14762919),
        ("weighted", 0.9602411),
        ("centrality", 1.2541173),
    ],
    &[("dot", 5.2447577), ("to", 3.4204912)],
    &[("get", 0.3525222), ("stars", 5.2447577)],
    &[
        ("community", 1.3344406),
        ("louvain", 1.5601803),
        ("undirected", 1.2140213),
    ...
    &[
        ...
        ("get", 0.060067896),
        ("from", 0.1695623),
        ("memberships", 0.8157223),
        ("modularity", 0.8157223),
        ("directed", 0.5967164),
        ("community", 0.7643738),
    ],
    &[
        ...
        ("from", 0.1695623),
        ("community", 0.7643738),
        ("undirected", 0.69539714),
        ("modularity", 0.8157223),
        ("node", 0.3453971),
        ("get", 0.060067896),
    ],
    &[
        ("preferential", 1.0417451),
        ("get", 0.10486628),
        ("minimum", 1.131389),
        ("unchecked", 0.5344123),
        ("attachment", 1.0417451),
    ],
    &[
        ("preferential", 1.0417451),
        ("unchecked", 0.5344123),
    ...
    &[
        ...
        ("weighted", 0.5070749),
        ("get", 0.077958606),
        ("preferential", 0.7744433),
        ("attachment", 0.7744433),
        ("minimum", 0.8410855),
    ],
    &[
        ("unchecked", 0.39728728),
    ...
    &[
        ("from", 0.1695623),
        ("get", 0.060067896),
        ("attachment", 0.5967164),
        ("preferential", 0.5967164),
        ("node_ids", 0.28971064),
        ("unchecked", 0.30611387),
        ("weighted", 0.39070633),
    ],
    ...
    &[
        ...
        ("index", 0.48521563),
        ("unchecked", 0.24270207),
        ("allocation", 0.5311321),
        ("node_ids", 0.22969677),
        ("weighted", 0.30977112),
    ],
    &[
        ("resource", 0.8694283),
        ("allocation", 0.8694283),
        ("node_ids", 0.37599847),
        ("index", 0.79426605),
        ("from", 0.22006498),
        ("get", 0.077958606),
