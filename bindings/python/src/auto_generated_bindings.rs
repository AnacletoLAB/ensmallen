...
impl Graph {
    ...
    #[automatically_generated_binding]
    #[text_signature = "($self, src_node_ids)"]
    ...
    #[automatically_generated_binding]
    #[text_signature = "($self, node_centralities, adjust_by_central_node_distance, number_of_nodes_to_sample_per_feature, maximum_number_of_features, validate_node_centralities, maximal_depth, central_node_name, central_node_id, use_edge_weights, use_edge_weights_as_probabilities, random_state, verbose)"]
    ...
    #[automatically_generated_binding]
    #[text_signature = "($self, node_centralities, adjust_by_central_node_distance, number_of_nodes_to_sample_per_feature, maximum_number_of_features_per_node_type, validate_node_centralities, maximal_depth, central_node_name, central_node_id, use_edge_weights, use_edge_weights_as_probabilities, random_state, verbose)"]
    /// Return node embedding vector obtained from shortest-paths.
    ///
    /// Parameters
    /// ----------
    ...
    pub fn get_shortest_paths_node_embedding_per_node_type(
        ...
        Ok(
            pe!(self.inner.get_shortest_paths_node_embedding_per_node_type(
                node_centralities.into(),
                adjust_by_central_node_distance.into(),
                number_of_nodes_to_sample_per_feature.into(),
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[("decode", 5.224546265667863), ("edge", 1.9944726275377456)],
    &[
    ...
    &[("diameter", 4.462777298481476), ("get", 0.3419422964063188)],
    &[
    ...
    &[("density", 5.224546265667863), ("get", 0.3419422964063188)],
    &[
        ("get", 0.14357082654403988),
    ...
    &[("to", 3.393273563880107), ("arrowhead", 5.224546265667863)],
    &[("transposed", 5.224546265667863), ("to", 3.393273563880107)],
    &[
    ...
    &[("textual", 4.76528497631357), ("report", 4.056416965245162)],
    &[
        ("connected", 1.4590695023829132),
        ("graph", 1.4590695023829132),
    ...
    &[("has", 2.2180650388831844), ("nodes", 2.4320033877106138)],
    &[("edges", 3.015801077220556), ("has", 2.2180650388831844)],
    &[
        ("nodes", 1.5217295037301775),
        ("has", 1.3878660810741414),
        ("trap", 2.53814176684021),
    ],
    &[("is", 3.1848707289527396), ("directed", 3.4750623665748477)],
    &[
        ("edge", 1.2479620123241293),
        ("has", 1.3878660810741414),
        ("weights", 1.9928063333728845),
    ...
    &[("dot", 5.224546265667863), ("to", 3.393273563880107)],
    &[
        ("get", 0.10205582849186985),
