...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("walk", 0.81495816),
        ("get", 0.058881253),
        ("transformed", 0.725309),
        ("normalized", 0.7636394),
        ("graph", 0.54684985),
        ("laplacian", 0.725309),
        ("random", 0.56948686),
    ],
    &[
        ...
        ("graph", 0.7097435),
        ("get", 0.07642059),
        ("normalized", 0.99110955),
        ("transformed", 0.9413614),
    ],
    &[
        ("normalized", 1.3332429),
        ("graph", 0.9547486),
        ("transformed", 1.2663215),
        ("symmetric", 1.4228406),
        ("get", 0.10280115),
    ],
    &[
    ...
    &[
        ...
        ("from", 0.17184852),
        ("with", 0.4867716),
        ("singleton", 0.42851898),
        ("selfloops", 0.56948686),
        ("node_id", 0.3421324),
        ("unchecked", 0.30782402),
    ],
    &[
        ("with", 0.63176936),
        ("selfloops", 0.7391235),
    ...
    &[("has", 2.2266202), ("node_name", 2.7779527)],
    &[("has", 2.2266202), ("node_type_id", 3.5888956)],
    &[("has", 2.2266202), ("node_type_name", 3.4992838)],
    &[("has", 2.2266202), ("edge_type_id", 2.900238)],
    &[("has", 2.2266202), ("edge_type_name", 3.3431735)],
    &[
        ("node_ids", 0.72065115),
        ("has", 0.93228877),
        ("edge", 0.8617896),
    ...
    &[
        ("node_name", 1.1631324),
        ("and", 1.3441496),
        ("node_type_name", 1.4651548),
        ("has", 0.93228877),
    ],
    &[
        ("has", 0.93228877),
        ("from", 0.42240137),
        ("node_names", 0.9410077),
        ("edge", 0.8617896),
    ],
    &[
        ("has", 0.492271),
        ("node_names", 0.49687478),
        ("from", 0.22303814),
        ("edge", 0.45504573),
        ("and", 0.7097435),
        ("edge_type_name", 0.7391235),
    ],
    &[
        ("strongly", 3.2742376),
        ("components", 2.659778),
    ...
    &[
        ...
        ("sort", 0.9413614),
        ("outbound", 0.9413614),
        ("increasing", 1.0577149),
        ("degree", 0.62277),
    ],
    &[
        ("by", 0.8402425),
        ("node", 0.44404554),
        ("decreasing", 1.0577149),
        ("outbound", 0.9413614),
        ("degree", 0.62277),
        ("sort", 0.9413614),
    ],
    ...
    &[("remove", 2.8575935), ("components", 4.2579274)],
    &[("overlaps", 8.948311)],
    &[("contains", 8.167488)],
    &[
        ("edges", 1.9001726),
    ...
    &[("edge", 2.0582442), ("encode", 5.24159)],
    &[("decode", 5.24159), ("edge", 2.0582442)],
    &[
        ("max", 1.558866),
        ("encodable", 1.558866),
        ("get", 0.10280115),
    ...
    &[("validate", 3.6884835), ("node_id", 2.0084887)],
    &[("node_ids", 1.7211581), ("validate", 3.6884835)],
    &[("validate", 3.6884835), ("edge_id", 2.605233)],
    &[("edge_ids", 3.5888956), ("validate", 3.6884835)],
    &[
        ("not", 1.1684017),
        ("node_types", 0.6947183),
        ("contain", 1.2663215),
        ("unknown", 0.8898756),
        ("must", 1.016474),
    ],
    &[
        ("unknown", 0.8898756),
        ("edge_types", 0.73176205),
        ("must", 1.016474),
        ("contain", 1.2663215),
        ("not", 1.1684017),
    ],
    &[("validate", 3.6884835), ("node_type_id", 3.5888956)],
    &[("validate", 3.6884835), ("node_type_ids", 3.3431735)],
    &[("edge_type_id", 2.900238), ("validate", 3.6884835)],
    &[("validate", 3.6884835), ("edge_type_ids", 3.9286783)],
    &[
        ("must", 2.134999),
        ("be", 2.659778),
        ("undirected", 2.5475419),
    ],
    &[
        ("not", 1.1684017),
        ("trap", 1.1684017),
    ...
    &[
        ("multigraph", 2.8003395),
        ("be", 2.659778),
        ("must", 2.134999),
    ],
    &[
        ("be", 1.7827998),
        ("multigraph", 1.8770155),
        ("must", 1.4310502),
        ("not", 1.6449428),
    ],
    &[
    ...
    &[("connected", 2.18588), ("must", 2.134999), ("be", 2.659778)],
    &[
        ("get", 0.14472935),
        ("weights", 1.3441496),
        ("edge", 0.8617896),
    ...
    &[
        ("inplace", 1.3191476),
        ("edge_types", 1.0302165),
        ("all", 1.5443729),
        ("set", 1.7075701),
    ],
    &[
        ("edge_types", 1.5369909),
        ("set", 2.5475419),
        ("all", 2.3040664),
    ],
    &[
        ...
        ("all", 1.5443729),
        ("set", 1.7075701),
        ("node_types", 0.9780641),
    ],
    &[
        ("all", 2.3040664),
        ("node_types", 1.4591843),
        ("set", 2.5475419),
    ],
    &[
        ("node_type_ids", 2.0883632),
        ("remove", 1.7850385),
        ("inplace", 1.9680504),
    ],
    &[
    ...
    &[
        ("node_types", 0.9780641),
        ("remove", 1.1964781),
        ("homogeneous", 1.5912955),
        ("inplace", 1.3191476),
    ],
    &[
        ("inplace", 1.9680504),
        ("remove", 1.7850385),
        ("edge_type_ids", 2.4541078),
    ],
    &[
        ("singleton", 1.053294),
        ("edge_types", 1.0302165),
    ...
    &[
        ("inplace", 1.9680504),
        ("node_type_name", 2.18588),
        ("remove", 1.7850385),
    ],
    &[("remove", 2.8575935), ("node_type_id", 3.5888956)],
    &[
        ("singleton", 1.5714204),
        ("node_types", 1.4591843),
        ("remove", 1.7850385),
    ...
    &[
        ("remove", 1.7850385),
        ("homogeneous", 2.3740706),
        ("node_types", 1.4591843),
    ],
    &[("remove", 2.8575935), ("node_type_name", 3.4992838)],
    &[
        ("edge_type_name", 2.0883632),
        ("remove", 1.7850385),
        ("inplace", 1.9680504),
    ],
    &[("remove", 2.8575935), ("edge_type_id", 2.900238)],
    &[
        ("remove", 1.7850385),
        ("edge_types", 1.5369909),
        ("singleton", 1.5714204),
    ],
    &[("edge_type_name", 3.3431735), ("remove", 2.8575935)],
    &[
        ("inplace", 1.9680504),
        ("remove", 1.7850385),
        ("node_types", 1.4591843),
    ],
    &[("node_types", 2.335947), ("remove", 2.8575935)],
    &[
        ("remove", 1.7850385),
        ("edge_types", 1.5369909),
        ("inplace", 1.9680504),
    ],
    &[("edge_types", 2.4605043), ("remove", 2.8575935)],
    &[
        ("remove", 1.1964781),
        ("weights", 1.3441496),
        ("edge", 0.8617896),
    ...
    &[("circles", 5.24159), ("get", 0.34566247)],
    &[
        ("memory", 2.0883632),
        ("stats", 3.2742376),
        ("get", 0.21592325),
    ...
    &[
        ("get", 0.10280115),
        ("nodes", 0.7163208),
        ("requirement", 1.2663215),
        ("total", 0.9942707),
        ("memory", 0.9942707),
    ],
    &[
        ("readable", 0.69470274),
        ("requirement", 0.725309),
        ("human", 0.69470274),
        ("get", 0.058881253),
        ("nodes", 0.41028595),
        ("memory", 0.56948686),
    ...
    &[
        ...
        ("total", 0.45150772),
        ("memory", 0.45150772),
        ("requirements", 0.53058225),
        ("edge", 0.27797335),
        ("get", 0.046682972),
    ],
    &[
        ("memory", 0.9942707),
        ("requirements", 1.1684017),
        ("node_types", 0.6947183),
        ("get", 0.10280115),
        ("total", 0.9942707),
    ],
    &[
        ("total", 0.56948686),
        ("requirements", 0.6692236),
        ("get", 0.058881253),
        ("node_types", 0.3979127),
        ("human", 0.69470274),
        ("readable", 0.69470274),
        ("memory", 0.56948686),
    ],
    ...
    &[("transitivity", 5.24159), ("get", 0.34566247)],
    &[
        ("per", 1.0577149),
        ("get", 0.07642059),
        ("of", 1.0577149),
    ...
    &[
        ("per", 1.4228406),
        ("get", 0.10280115),
        ("coefficient", 1.1684017),
        ("clustering", 1.3332429),
        ("node", 0.5973311),
    ],
    &[
        ("coefficient", 2.4541078),
        ("get", 0.21592325),
        ("clustering", 2.8003395),
    ],
    &[
        ("average", 2.1946607),
        ("clustering", 1.8770155),
        ("get", 0.14472935),
        ("coefficient", 1.6449428),
    ],
    &[
        ("are", 3.2742376),
        ("remappable", 3.2742376),
        ("nodes", 1.5045582),
    ],
    &[
        ("from", 0.42240137),
    ...
    &[("sample", 5.24159), ("negatives", 5.24159)],
    &[("holdout", 3.6884835), ("connected", 3.4992838)],
    &[("random", 3.3431735), ("holdout", 3.6884835)],
    &[
        ("get", 0.10280115),
        ("indices", 1.558866),
        ("holdout", 1.096967),
    ...
    &[
        ("kfold", 1.8770155),
        ("edge", 0.8617896),
        ("prediction", 2.1946607),
        ("get", 0.14472935),
    ],
    &[("get", 0.34566247), ("chains", 5.24159)],
    &[
        ("first", 0.3933015),
        ("breadth", 0.3933015),
        ("from", 0.11055688),
        ("unchecked", 0.19803523),
        ("search", 0.3933015),
        ("get", 0.037880614),
        ("predecessors", 0.5744177),
        ("parallel", 0.44692943),
        ("node_id", 0.22010715),
    ],
    &[
    ...
    &[
        ...
        ("from", 0.11055688),
        ("most", 0.46661964),
        ("eccentricity", 0.43053773),
    ],
    &[
        ("node_id", 0.44404554),
        ("unchecked", 0.3995175),
        ("eccentricity", 0.86856955),
        ("get", 0.07642059),
        ("weighted", 0.5064165),
        ("from", 0.22303814),
    ],
    ...
    &[("get", 0.34566247), ("diameter", 4.4829464)],
    &[
        ("get", 0.14472935),
        ("weighted", 0.9590782),
        ("diameter", 1.8770155),
    ...
    &[
        ...
        ("get", 0.10280115),
        ("selfloops", 0.9942707),
        ("node_names", 0.6683971),
        ("singleton", 0.748154),
    ],
    &[("get", 0.34566247), ("density", 5.24159)],
    &[
        ("rate", 1.6449428),
        ("trap", 1.6449428),
        ("nodes", 1.0084774),
    ...
    &[("source_names", 5.24159), ("get", 0.34566247)],
    &[
        ("node_ids", 1.0751472),
        ("get", 0.21592325),
        ("destination", 2.4541078),
    ],
    &[
        ("directed", 1.4651548),
        ("get", 0.14472935),
        ("destination", 1.6449428),
        ("node_ids", 0.72065115),
    ],
    &[("get", 0.34566247), ("destination_names", 5.24159)],
    &[("get", 0.34566247), ("node_names", 2.2474437)],
    &[
        ("node", 1.2546325),
        ("get", 0.21592325),
        ("urls", 3.2742376),
    ...
    &[
        ("node", 1.2546325),
        ("ontologies", 3.2742376),
        ("get", 0.21592325),
    ],
    &[("get", 0.34566247), ("node_ids", 1.7211581)],
    &[("edge_type_ids", 3.9286783), ("get", 0.34566247)],
    &[
        ("unique", 2.18588),
        ("get", 0.21592325),
        ("edge_type_ids", 2.4541078),
    ],
    &[("edge_type_names", 4.0782533), ("get", 0.34566247)],
    &[
        ("unique", 2.18588),
        ("edge_type_names", 2.5475419),
        ("get", 0.21592325),
    ],
    &[
        ("edge", 1.2857131),
    ...
    &[("get", 0.34566247), ("node_type_ids", 3.3431735)],
    &[
        ("known", 1.2957093),
        ("mask", 1.6449428),
        ("get", 0.14472935),
    ...
    &[("get", 0.34566247), ("node_type_names", 3.4178307)],
    &[
        ("node_type_ids", 2.0883632),
        ("get", 0.21592325),
        ("unique", 2.18588),
    ...
    &[
        ...
        ("node", 0.84095687),
        ("get", 0.14472935),
        ("cumulative", 2.1946607),
    ],
    &[
        ("sqrt", 1.7827998),
        ("get", 0.14472935),
        ("degrees", 1.4651548),
        ("reciprocal", 1.7827998),
    ],
    &[
        ("source", 1.0406984),
        ("nodes", 0.7163208),
    ...
    &[
        ...
        ("counts", 1.7827998),
        ("hashmap", 1.7827998),
        ("edge_type_id", 1.2143334),
    ],
    &[
        ("get", 0.14472935),
        ("hashmap", 1.7827998),
        ("counts", 1.7827998),
        ("edge_type_names", 1.7075701),
    ],
    &[
        ("node_type_id", 1.5026753),
        ("hashmap", 1.7827998),
    ...
    &[("directed", 3.4992838), ("to", 3.4178307)],
    &[
        ("upper", 3.2742376),
        ("triangular", 2.9885304),
        ("to", 2.134999),
    ],
    &[
        ("lower", 3.2742376),
    ...
    &[("to", 3.4178307), ("bidiagonal", 5.24159)],
    &[("arrowhead", 5.24159), ("to", 3.4178307)],
    &[("to", 3.4178307), ("transposed", 5.24159)],
    &[("to", 3.4178307), ("complementary", 5.24159)],
    &[("report", 6.9622912)],
    &[
        ("report", 2.5475419),
        ("textual", 2.9885304),
    ...
    &[("report", 4.0782533), ("textual", 4.784213)],
    &[
        ("random", 1.3997911),
        ("connected", 1.4651548),
        ("generate", 1.4310502),
    ...
    &[("replace", 8.948311)],
    &[("from_ids", 5.24159), ("filter", 4.784213)],
    &[("from_names", 5.24159), ("filter", 4.784213)],
    &[
        ("unknown", 1.8690921),
        ("node_types", 1.4591843),
        ("drop", 2.3740706),
    ...
    &[
        ("nodes", 1.5045582),
        ("drop", 2.3740706),
        ("disconnected", 2.659778),
    ],
    &[("selfloops", 3.3431735), ("drop", 3.8005505)],
    &[
        ("drop", 2.3740706),
        ("edges", 1.9001726),
        ("parallel", 2.5475419),
    ...
    &[
        ...
        ("spanning", 1.8770155),
        ("random", 1.3997911),
        ("arborescence", 2.0031564),
    ],
    &[
        ("kruskal", 2.9885304),
        ("arborescence", 2.9885304),
        ("spanning", 2.8003395),
    ],
    &[
        ("connected", 2.18588),
    ...
    &[("enable", 8.948311)],
    &[("all", 3.6884835), ("disable", 5.24159)],
    &[("compatible", 5.24159), ("is", 3.2102828)],
    &[
        ("same", 2.1946607),
        ("adjacency", 1.8770155),
        ("has", 0.93228877),
    ...
    &[
        ("graph_name", 3.2742376),
        ("has", 1.3908916),
        ("default", 3.2742376),
    ],
    &[("has", 2.2266202), ("nodes", 2.4085844)],
    &[("edges", 3.0419068), ("has", 2.2266202)],
    &[
        ("nodes", 1.5045582),
        ("has", 1.3908916),
        ("trap", 2.4541078),
    ],
    &[("directed", 3.4992838), ("is", 3.2102828)],
    &[
        ("has", 1.3908916),
        ("weights", 2.005351),
        ("edge", 1.2857131),
    ...
    &[
        ("edge", 0.61212856),
        ("has", 0.6622041),
        ("representing", 1.558866),
        ("weights", 0.9547486),
        ("probabilities", 1.558866),
    ],
    &[
        ("weighted", 0.9590782),
        ("nodes", 1.0084774),
    ...
    &[("edge_types", 2.4605043), ("has", 2.2266202)],
    &[("selfloops", 3.3431735), ("has", 2.2266202)],
    &[
        ("has", 1.3908916),
        ("nodes", 1.5045582),
        ("disconnected", 2.659778),
    ...
    &[("is", 3.2102828), ("connected", 3.4992838)],
    &[("has", 2.2266202), ("node_types", 2.335947)],
    &[
        ("node_types", 1.4591843),
        ("multilabel", 2.9885304),
        ("has", 1.3908916),
    ],
    &[
        ("has", 1.3908916),
    ...
    &[("is", 3.2102828), ("multigraph", 4.4829464)],
    &[
        ("outbound", 0.57504857),
        ("sorted", 0.6054382),
        ("node", 0.27125368),
    ...
    &[
        ("unchecked", 0.5374319),
        ("edge_type_id", 0.86254025),
        ("from", 0.30003142),
        ("get", 0.10280115),
        ("edge_type_name", 0.9942707),
    ],
    &[
        ("edge_type_name", 0.9942707),
        ("get", 0.10280115),
    ...
    &[
        ...
        ("edge", 0.18656604),
        ("get", 0.031331986),
        ("unchecked", 0.16379979),
        ("edge_type_id", 0.26288712),
        ("edge_id", 0.2361469),
    ],
    &[
        ("weight", 0.37455475),
    ...
    &[
        ...
        ("node_id", 0.3421324),
        ("degree", 0.4798377),
        ("comulative", 0.81495816),
        ("node", 0.3421324),
        ("get", 0.058881253),
        ("from", 0.17184852),
    ],
    &[
        ("comulative", 1.0577149),
        ("degree", 0.62277),
        ("get", 0.07642059),
        ("node_id", 0.44404554),
        ("from", 0.22303814),
    ...
    &[("selfloops", 3.3431735), ("add", 5.24159)],
    &[
        ("degree", 1.7596111),
        ("centrality", 1.8690921),
        ("get", 0.21592325),
    ],
    &[
        ("degree", 1.1794347),
        ("get", 0.14472935),
        ("centrality", 1.2528176),
        ("weighted", 0.9590782),
    ],
    &[
        ("closeness", 0.9413614),
    ...
    &[
        ("betweenness", 2.5475419),
        ("get", 0.21592325),
        ("centrality", 1.8690921),
    ],
    &[
        ("betweenness", 0.90163827),
        ("approximated", 0.90163827),
        ("get", 0.07642059),
        ("from", 0.22303814),
        ("centrality", 0.66151804),
        ("node_id", 0.44404554),
    ...
    &[
        ("node_id", 0.3421324),
        ("approximated", 0.69470274),
        ("from", 0.17184852),
        ("centrality", 0.5096926),
        ("get", 0.058881253),
        ("betweenness", 0.69470274),
        ("weighted", 0.39018852),
    ],
    &[
        ("weighted", 0.39018852),
        ...
        ("approximated", 0.69470274),
        ("from", 0.17184852),
        ("node_name", 0.47320533),
        ("centrality", 0.5096926),
    ],
    &[
        ("centrality", 1.8690921),
        ("eigenvector", 2.9885304),
        ("get", 0.21592325),
    ],
    &[
        ("weighted", 0.9590782),
        ("get", 0.14472935),
        ("centrality", 1.2528176),
        ("eigenvector", 2.0031564),
    ],
    &[("to", 3.4178307), ("dot", 5.24159)],
    &[("get", 0.34566247), ("stars", 5.24159)],
    &[
        ("undirected", 1.2128859),
        ("get", 0.10280115),
        ("detection", 1.558866),
    ...
    &[
        ("from", 0.17184852),
        ("get", 0.058881253),
        ("memberships", 0.81495816),
        ("node", 0.3421324),
        ("modularity", 0.81495816),
        ("directed", 0.59607923),
        ("community", 0.7636394),
    ],
    &[
        ...
        ("memberships", 0.81495816),
        ("node", 0.3421324),
        ("undirected", 0.69470274),
    ],
    &[
        ("unchecked", 0.5374319),
        ("preferential", 1.0406984),
        ("minimum", 1.1302961),
        ("attachment", 1.0406984),
        ("get", 0.10280115),
    ],
    &[
        ("preferential", 1.0406984),
    ...
    &[
        ("unchecked", 0.3995175),
        ("attachment", 0.7736371),
        ("weighted", 0.5064165),
        ("get", 0.07642059),
        ("preferential", 0.7736371),
        ("minimum", 0.8402425),
    ],
    &[
        ("weighted", 0.5064165),
    ...
    &[
        ("preferential", 0.59607923),
        ("weighted", 0.39018852),
        ("node_ids", 0.2931876),
        ("get", 0.058881253),
        ("from", 0.17184852),
        ("attachment", 0.59607923),
        ("unchecked", 0.30782402),
    ],
    &[
        ("attachment", 0.7736371),
