...
impl Graph {
    ...
    pub unsafe fn is_unchecked_topological_synonim_from_node_ids(
        ...
        self.inner
            .is_unchecked_topological_synonim_from_node_ids(
                first_node_id.into(),
                second_node_id.into(),
            )
            .into()
    ...
    pub fn get_topological_synonims_node_ids(
        ...
        self.inner
            .get_topological_synonims_node_ids(minimum_node_degree.into())
            .into_iter()
            .map(|x| x.into())
            .collect::<Vec<_>>()
    }
    ...
    pub fn has_topological_synonims(&self, minimum_node_degree: Option<NodeT>) -> bool {
        self.inner
            .has_topological_synonims(minimum_node_degree.into())
            .into()
    }
    ...
    pub fn is_topological_synonim_from_node_ids(
        ...
        Ok(pe!(self
            .inner
            .is_topological_synonim_from_node_ids(first_node_id.into(), second_node_id.into()))?
        .into())
    }
    ...
    pub fn is_topological_synonim_from_node_names(
        ...
        Ok(pe!(self.inner.is_topological_synonim_from_node_names(
...
pub const GRAPH_METHODS_NAMES: &[&str] = &[
    ...
    "is_unchecked_topological_synonim_from_node_ids",
    "get_topological_synonims_node_ids",
    "has_topological_synonims",
    "is_topological_synonim_from_node_ids",
    "is_topological_synonim_from_node_names",
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("transformed", 0.72680974),
        ("random", 0.5702854),
        ("laplacian", 0.72680974),
        ("walk", 0.8168629),
        ("normalized", 0.7653129),
        ("get", 0.05954891),
        ("graph", 0.5475464),
    ],
    &[
        ("normalized", 0.9930736),
        ("transformed", 0.9431117),
        ("laplacian", 0.9431117),
        ("get", 0.07727095),
        ("symmetric", 1.0599651),
        ("graph", 0.71049875),
    ...
    &[
        ("symmetric", 1.4254644),
        ("get", 0.10391566),
        ("transformed", 1.2683173),
        ("graph", 0.95549434),
        ("normalized", 1.3355072),
    ],
    &[
        ("connected", 1.0417889),
        ("from", 0.29345977),
        ("is", 0.90521777),
        ("unchecked", 0.53268385),
        ("node_id", 0.59664285),
    ],
    &[
        ("from", 0.21821459),
    ...
    &[
        ...
        ("node_id", 0.3419064),
        ("from", 0.16816723),
        ("singleton", 0.42868227),
        ("unchecked", 0.30525467),
        ("with", 0.48719737),
    ],
    &[
        ("selfloops", 0.740005),
    ...
    &[("has", 2.2210639), ("node_name", 2.7735841)],
    &[("has", 2.2210639), ("node_type_id", 3.4964693)],
    &[("node_type_name", 3.4964693), ("has", 2.2210639)],
    &[("has", 2.2210639), ("edge_type_id", 2.896133)],
    &[("edge_type_name", 3.3400228), ("has", 2.2210639)],
    &[
        ("edge", 0.86056244),
        ("node_ids", 0.70920384),
        ("from", 0.41298544),
    ...
    &[
        ...
        ("from", 0.41298544),
        ("has", 0.93131644),
        ("node_names", 0.9400667),
    ],
    &[
        ("and", 0.71049875),
        ("node_names", 0.4967155),
        ("edge", 0.45470676),
        ("from", 0.21821459),
        ("has", 0.49209198),
        ("edge_type_name", 0.740005),
    ],
    &[
        ("connected", 2.1860318),
        ("strongly", 3.2776883),
        ("components", 2.6613665),
    ],
    &[
        ("increasing", 1.0599651),
        ("outbound", 0.9431117),
        ("sort", 0.9431117),
        ("node", 0.44727403),
        ("degree", 0.62315154),
    ...
    &[
        ...
        ("sort", 1.2683173),
        ("node", 0.6015039),
        ("lexicographic", 1.4254644),
    ],
    &[
        ("bfs", 0.9930736),
        ("from", 0.21821459),
        ("node_id", 0.44365934),
        ("topological", 0.81667566),
        ("get", 0.07727095),
        ("sorting", 0.9930736),
    ],
    &[
    ...
    &[("remove", 2.9410071), ("components", 4.2567477)],
    &[("overlaps", 8.938875)],
    &[("contains", 8.157335)],
    &[
        ("edges", 1.8994584),
    ...
    &[("edge", 2.0523252), ("encode", 5.2425294)],
    &[("edge", 2.0523252), ("decode", 5.2425294)],
    &[
        ("edge", 0.61149967),
        ("number", 0.71611),
        ("encodable", 1.5620356),
    ...
    &[("validate", 3.6860766), ("node_id", 2.0024624)],
    &[("validate", 3.6860766), ("node_ids", 1.6913553)],
    &[("validate", 3.6860766), ("edge_id", 2.6004922)],
    &[("edge_ids", 3.5862741), ("validate", 3.6860766)],
    &[
        ("contain", 1.2683173),
        ("not", 1.1700047),
        ("node_types", 0.71611),
    ...
    &[
        ("edge_types", 0.73161304),
        ("not", 1.1700047),
        ("unknown", 0.890361),
        ("contain", 1.2683173),
        ("must", 1.0174674),
    ],
    &[("node_type_id", 3.4964693), ("validate", 3.6860766)],
    &[("node_type_ids", 3.4964693), ("validate", 3.6860766)],
    &[("validate", 3.6860766), ("edge_type_id", 2.896133)],
    &[("edge_type_ids", 3.926789), ("validate", 3.6860766)],
    &[
        ("be", 2.6613665),
        ("undirected", 2.54879),
        ("must", 2.1349967),
    ...
    &[
        ...
        ("all", 1.5927045),
        ("inplace", 1.3446655),
        ("node_types", 1.0077803),
    ],
    &[
        ("node_types", 1.5026451),
        ("all", 2.374793),
        ("set", 2.54879),
    ],
    &[
    ...
    &[
        ("node_type_name", 2.1860318),
        ("inplace", 2.004956),
        ("remove", 1.8387507),
    ],
    &[("remove", 2.9410071), ("node_type_id", 3.4964693)],
    &[
        ("remove", 1.8387507),
        ("node_types", 1.5026451),
        ("singleton", 1.56971),
    ],
    &[("node_type_name", 3.4964693), ("remove", 2.9410071)],
    &[
        ("edge_type_name", 2.0882196),
        ("remove", 1.8387507),
        ("inplace", 2.004956),
    ],
    &[("edge_type_id", 2.896133), ("remove", 2.9410071)],
    &[
        ("edge_types", 1.535176),
        ("remove", 1.8387507),
        ("singleton", 1.56971),
    ],
    &[("edge_type_name", 3.3400228), ("remove", 2.9410071)],
    &[
        ("inplace", 2.004956),
        ("remove", 1.8387507),
        ("node_types", 1.5026451),
    ],
    &[("node_types", 2.40342), ("remove", 2.9410071)],
    &[
        ("edge_types", 1.535176),
        ("remove", 1.8387507),
        ("inplace", 2.004956),
    ],
    &[("edge_types", 2.4554517), ("remove", 2.9410071)],
    &[
        ("weights", 1.3446655),
        ("edge", 0.86056244),
        ("inplace", 1.3446655),
    ...
    &[("get", 0.34876347), ("circles", 5.2425294)],
    &[
        ("memory", 2.0882196),
        ("stats", 3.2776883),
        ("get", 0.21805082),
    ...
    &[
        ...
        ("total", 0.995175),
        ("get", 0.10391566),
        ("requirement", 1.2683173),
    ],
    &[
        ("get", 0.05954891),
        ("requirement", 0.72680974),
        ("memory", 0.5702854),
        ("human", 0.69606555),
        ("nodes", 0.4147447),
        ("total", 0.5702854),
    ...
    &[
        ...
        ("get", 0.047219876),
        ("edge", 0.27786896),
        ("requirements", 0.53165686),
        ("readable", 0.5519518),
        ("memory", 0.45221326),
    ],
    &[
        ("requirements", 1.1700047),
        ("get", 0.10391566),
        ("node_types", 0.71611),
        ("memory", 0.995175),
        ("total", 0.995175),
    ...
    &[
        ("get", 0.05954891),
        ("node_types", 0.41036707),
        ("memory", 0.5702854),
        ("requirements", 0.67047167),
        ("human", 0.69606555),
        ("readable", 0.69606555),
        ("total", 0.5702854),
    ],
    ...
    &[("get", 0.34876347), ("transitivity", 5.2425294)],
    &[
        ("of", 1.0599651),
        ("number", 0.53249425),
        ("get", 0.07727095),
    ...
    &[
        ("per", 1.4254644),
        ("coefficient", 1.1700047),
        ("get", 0.10391566),
        ("node", 0.6015039),
        ("clustering", 1.3355072),
    ],
    &[
        ("coefficient", 2.4550726),
        ("get", 0.21805082),
        ("clustering", 2.8023536),
    ],
    &[
        ("get", 0.14624034),
        ("clustering", 1.879457),
        ("average", 2.19825),
        ("coefficient", 1.6465456),
    ],
    &[
        ("topological", 0.81667566),
        ("is", 0.67311347),
    ...
    &[
        ("synonims", 2.0060537),
        ("get", 0.14624034),
        ("topological", 1.5456123),
        ("node_ids", 0.70920384),
    ],
    &[
        ("topological", 2.3045764),
        ("synonims", 2.9911149),
        ("has", 1.3886341),
    ],
    &[
        ...
        ("is", 0.90521777),
        ("from", 0.29345977),
        ("topological", 1.0982834),
        ("synonim", 1.3355072),
    ],
    &[
        ("node_names", 0.6679939),
        ("synonim", 1.3355072),
        ("topological", 1.0982834),
        ("is", 0.90521777),
        ("from", 0.29345977),
    ...
    &[("sample", 5.2425294), ("negatives", 5.2425294)],
    &[("holdout", 3.6860766), ("connected", 3.4964693)],
    &[("random", 3.3400228), ("holdout", 3.6860766)],
    &[
        ("indices", 1.5620356),
        ("label", 1.0685468),
        ("node", 0.6015039),
    ...
    &[("get", 0.34876347), ("chains", 5.2425294)],
    &[
        ("from", 0.108219504),
        ("predecessors", 0.5760337),
        ("unchecked", 0.19643845),
        ("search", 0.39404923),
        ("node_id", 0.22002468),
        ("first", 0.39404923),
        ("parallel", 0.44793427),
    ...
    &[
        ...
        ("unchecked", 0.3960999),
        ("weighted", 0.50629824),
        ("eccentricity", 0.87000716),
    ],
    &[
        ("eccentricity", 0.53165686),
        ("from", 0.1333498),
        ("get", 0.047219876),
        ("and", 0.4341821),
        ("distant", 0.64773923),
    ...
    &[("get", 0.34876347), ("diameter", 4.482251)],
    &[
        ("weighted", 0.95820266),
        ("diameter", 1.879457),
        ("naive", 2.0060537),
    ...
    &[("density", 5.2425294), ("get", 0.34876347)],
    &[
        ("rate", 1.6465456),
        ("trap", 1.6465456),
        ("get", 0.14624034),
    ...
    &[("source_names", 5.2425294), ("get", 0.34876347)],
    &[
        ("node_ids", 1.0574543),
        ("get", 0.21805082),
        ("destination", 2.4550726),
    ],
    &[
        ("directed", 1.4661078),
        ("get", 0.14624034),
        ("destination", 1.6465456),
        ("node_ids", 0.70920384),
    ],
    &[("destination_names", 5.2425294), ("get", 0.34876347)],
    &[("node_names", 2.2419322), ("get", 0.34876347)],
    &[
        ("node", 1.2621622),
        ("urls", 3.2776883),
        ("get", 0.21805082),
    ...
    &[
        ("ontologies", 3.2776883),
        ("node", 1.2621622),
        ("get", 0.21805082),
    ],
    &[("get", 0.34876347), ("node_ids", 1.6913553)],
    &[("get", 0.34876347), ("edge_type_ids", 3.926789)],
    &[
        ("get", 0.21805082),
        ("edge_type_ids", 2.4550726),
        ("unique", 2.1860318),
    ],
    &[("edge_type_names", 4.0766864), ("get", 0.34876347)],
    &[
        ("unique", 2.1860318),
        ("edge_type_names", 2.54879),
        ("get", 0.21805082),
    ],
    &[
        ("weights", 2.004956),
    ...
    &[("get", 0.34876347), ("node_type_ids", 3.4964693)],
    &[
        ("node_types", 1.0077803),
        ("known", 1.2960501),
        ("mask", 1.6465456),
    ...
    &[
        ...
        ("known", 0.6848112),
        ("get", 0.07727095),
        ("edge_types", 0.54402226),
    ],
    &[("get", 0.34876347), ("node_type_names", 3.4964693)],
    &[
        ("unique", 2.1860318),
        ("get", 0.21805082),
        ("node_type_ids", 2.1860318),
    ...
    &[("to", 3.4148407), ("directed", 3.4964693)],
    &[
        ("upper", 3.2776883),
        ("triangular", 2.9911149),
        ("to", 2.1349967),
    ],
    &[
        ("lower", 3.2776883),
    ...
    &[("bidiagonal", 5.2425294), ("to", 3.4148407)],
    &[("to", 3.4148407), ("arrowhead", 5.2425294)],
    &[("transposed", 5.2425294), ("to", 3.4148407)],
    &[("complementary", 5.2425294), ("to", 3.4148407)],
    &[("report", 6.951032)],
    &[
        ("textual", 2.9911149),
        ("report", 2.54879),
    ...
    &[("textual", 4.7841673), ("report", 4.0766864)],
    &[
        ("graph", 1.3446655),
        ("connected", 1.4661078),
        ("random", 1.4005082),
    ...
    &[("replace", 8.938875)],
    &[("filter", 4.7841673), ("from_ids", 5.2425294)],
    &[("from_names", 5.2425294), ("filter", 4.7841673)],
    &[
        ("drop", 2.374793),
        ("unknown", 1.8682839),
        ("node_types", 1.5026451),
    ...
    &[
        ("disconnected", 2.6613665),
        ("nodes", 1.5186747),
        ("drop", 2.374793),
    ],
    &[("selfloops", 3.3400228), ("drop", 3.7983851)],
    &[
        ("drop", 2.374793),
        ("edges", 1.8994584),
        ("parallel", 2.54879),
    ...
    &[("enable", 8.938875)],
    &[("compatible", 5.2425294), ("is", 3.038107)],
    &[
        ("matrix", 1.6465456),
        ("has", 0.93131644),
        ("adjacency", 1.879457),
    ...
    &[
        ("default", 3.2776883),
        ("has", 1.3886341),
        ("graph_name", 3.2776883),
    ],
    &[("nodes", 2.4290588), ("has", 2.2210639)],
    &[("edges", 3.038107), ("has", 2.2210639)],
    &[
        ("nodes", 1.5186747),
        ("trap", 2.4550726),
        ("has", 1.3886341),
    ],
    &[("is", 3.038107), ("directed", 3.4964693)],
    &[
        ("edge", 1.2831367),
        ("has", 1.3886341),
        ("weights", 2.004956),
    ...
    &[
        ("probabilities", 1.5620356),
        ("weights", 0.95549434),
        ("edge", 0.61149967),
        ("has", 0.6617761),
        ("representing", 1.5620356),
    ],
    &[
        ("weighted", 0.95820266),
        ("nodes", 1.018531),
    ...
    &[("edge_types", 2.4554517), ("has", 2.2210639)],
    &[("selfloops", 3.3400228), ("has", 2.2210639)],
    &[
        ("disconnected", 2.6613665),
        ("nodes", 1.5186747),
        ("has", 1.3886341),
    ...
    &[("connected", 3.4964693), ("is", 3.038107)],
    &[("node_types", 2.40342), ("has", 2.2210639)],
    &[
        ("node_types", 1.5026451),
        ("has", 1.3886341),
        ("multilabel", 2.9911149),
    ],
    &[
        ("unknown", 1.8682839),
        ("node_types", 1.5026451),
    ...
    &[("is", 3.038107), ("multigraph", 4.482251)],
    &[
        ("sorted", 0.6068621),
        ("by", 0.514272),
        ("decreasing", 0.64773923),
        ("outbound", 0.5763307),
        ("nodes", 0.32887578),
        ("degree", 0.38080472),
        ("node", 0.27332684),
    ...
    &[
        ...
        ("sorted", 0.6068621),
        ("outbound", 0.5763307),
        ("increasing", 0.64773923),
        ("degree", 0.38080472),
        ("node", 0.27332684),
        ("nodes", 0.32887578),
    ],
    &[
        ("transitive", 3.2776883),
        ("closure", 3.2776883),
        ("get", 0.21805082),
    ],
    &[
    ...
    &[
        ("get", 0.10391566),
        ("edge_type_name", 0.995175),
        ("unchecked", 0.53268385),
        ("edge_type_id", 0.86291605),
        ("from", 0.29345977),
    ],
    &[
        ("edge_type_name", 0.995175),
    ...
    &[
        ...
        ("edge_id", 0.7748285),
        ("from", 0.29345977),
        ("destination", 1.1700047),
    ],
    &[
        ("source", 0.77466685),
        ("node_name", 0.61450666),
        ("edge_id", 0.5761569),
        ("from", 0.21821459),
        ("unchecked", 0.3960999),
        ("get", 0.07727095),
    ...
    &[
        ...
        ("weight", 0.31037906),
        ("edge_id", 0.23636192),
        ("edge_type_id", 0.26323307),
        ("node_ids", 0.15372936),
        ("unchecked", 0.16249554),
        ("edge", 0.18653835),
    ],
    &[
        ("edge_id", 0.28573442),
    ...
    &[
        ...
        ("from", 0.21821459),
        ("node_id", 0.44365934),
        ("comulative", 1.0599651),
        ("degree", 0.62315154),
    ],
    &[
        ("from", 0.16816723),
        ("get", 0.05954891),
        ("reciprocal", 0.72680974),
        ("node_id", 0.3419064),
        ("unchecked", 0.30525467),
        ("degree", 0.4802322),
        ("sqrt", 0.72680974),
    ...
    &[
        ...
        ("from", 0.29345977),
        ("unchecked", 0.53268385),
        ("node_type_id", 1.0417889),
    ],
    &[
        ("get", 0.14624034),
        ("node_id", 0.83965445),
        ("node_type_ids", 1.4661078),
        ("from", 0.41298544),
    ],
    &[
        ("from", 0.29345977),
    ...
    &[("selfloops", 3.3400228), ("add", 5.2425294)],
    &[
        ("get", 0.21805082),
        ("degree", 1.758471),
        ("centrality", 1.8682839),
    ],
    &[
        ("weighted", 0.95820266),
        ("get", 0.14624034),
        ("centrality", 1.2530036),
        ("degree", 1.1793553),
    ],
    &[
        ("from", 0.21821459),
        ("centrality", 0.6620661),
        ("get", 0.07727095),
        ("node_id", 0.44365934),
        ("closeness", 0.9431117),
        ("unchecked", 0.3960999),
    ...
    &[
        ("node_id", 0.3419064),
        ("centrality", 0.5102217),
        ("from", 0.16816723),
        ("unchecked", 0.30525467),
        ("closeness", 0.72680974),
        ("weighted", 0.3901791),
        ("get", 0.05954891),
    ],
    &[
    ...
    &[
        ("approximated", 0.9032179),
        ("get", 0.07727095),
        ("betweenness", 0.9032179),
        ("centrality", 0.6620661),
        ("node_id", 0.44365934),
        ("from", 0.21821459),
    ],
    ...
    &[
        ...
        ("from", 0.16816723),
        ("node_id", 0.3419064),
        ("approximated", 0.69606555),
        ("get", 0.05954891),
        ("weighted", 0.3901791),
        ("betweenness", 0.69606555),
    ],
    &[
        ("from", 0.16816723),
        ("get", 0.05954891),
        ...
        ("centrality", 0.5102217),
        ("betweenness", 0.69606555),
        ("node_name", 0.47357002),
    ],
    &[
        ("centrality", 1.8682839),
        ("eigenvector", 2.9911149),
        ("get", 0.21805082),
    ],
    &[
        ("eigenvector", 2.0060537),
        ("get", 0.14624034),
        ("centrality", 1.2530036),
        ("weighted", 0.95820266),
    ],
    &[("to", 3.4148407), ("dot", 5.2425294)],
    &[("get", 0.34876347), ("stars", 5.2425294)],
    &[
        ("undirected", 1.2146673),
        ("community", 1.3355072),
        ("get", 0.10391566),
    ...
    &[
        ...
        ("community", 0.7653129),
        ("node", 0.34469205),
        ("modularity", 0.8168629),
        ("directed", 0.59699756),
        ("memberships", 0.8168629),
    ],
    &[
        ("undirected", 0.69606555),
        ("memberships", 0.8168629),
        ("from", 0.16816723),
        ("modularity", 0.8168629),
        ("community", 0.7653129),
    ...
    &[
        ("attachment", 1.0417889),
        ("get", 0.10391566),
        ("unchecked", 0.53268385),
        ("minimum", 1.1317462),
        ("preferential", 1.0417889),
    ],
    &[
        ("maximum", 1.0982834),
        ("get", 0.10391566),
    ...
    &[
        ("attachment", 0.77466685),
        ("weighted", 0.50629824),
        ("unchecked", 0.3960999),
        ("minimum", 0.8415584),
        ("preferential", 0.77466685),
        ("get", 0.07727095),
    ],
    &[
        ("attachment", 0.77466685),
    ...
    &[
        ("unchecked", 0.30525467),
        ("attachment", 0.59699756),
        ("node_ids", 0.28878704),
        ("from", 0.16816723),
        ("weighted", 0.3901791),
        ("get", 0.05954891),
        ("preferential", 0.59699756),
    ],
    &[
        ("node_ids", 0.37473142),
        ("preferential", 0.77466685),
    ...
    &[
        ...
        ("from", 0.16816723),
        ("index", 0.6123311),
        ("allocation", 0.67047167),
        ("resource", 0.67047167),
        ("get", 0.05954891),
    ],
    &[
        ("allocation", 0.53165686),
        ("from", 0.1333498),
        ("index", 0.48555377),
        ("unchecked", 0.24205461),
        ("node_ids", 0.22899644),
