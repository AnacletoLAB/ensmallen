...
impl Graph {
    ...
    pub fn approximated_vertex_cover(&self) -> Py<PyArray1<NodeT>> {
        let gil = pyo3::Python::acquire_gil();
        to_ndarray_1d!(gil, self.inner.approximated_vertex_cover(), NodeT)
    }
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    &[
        ("connected", 0.95558107),
        ("from", 0.24679147),
        ("id", 0.39943895),
        ("is", 0.87071437),
        ("node", 0.13990204),
        ("unchecked", 0.49523565),
    ],
    &[
        ("connected", 1.2697717),
        ("from", 0.32793534),
    ...
    &[
        ("disconnected", 0.9145676),
        ("from", 0.19190381),
        ("id", 0.31060174),
        ("is", 0.67706317),
        ("node", 0.20274952),
        ("unchecked", 0.38509277),
    ],
    &[
        ("from", 0.24679147),
        ("id", 0.39943895),
    ...
    &[("has", 1.5568663), ("name", 1.4933299), ("node", 0.374654)],
    &[
        ("has", 1.0692655),
        ("id", 0.73466766),
        ("node", 0.25731468),
    ...
    &[
        ...
        ("node", 0.058892954),
        ("type", 0.1626481),
        ("unchecked", 0.20847365),
    ],
    &[
        ("components", 3.1496959),
        ("connected", 2.559021),
        ("strongly", 3.841312),
    ],
    &[
    ...
    &[
        ("coo", 1.0004942),
        ("get", 0.090712875),
        ("intersection", 1.2352277),
        ("matrix", 0.93597984),
        ("neighbours", 1.2352277),
        ("size", 1.1289754),
    ],
    &[
        ("get", 0.120538846),
        ("graph", 0.94525033),
        ("intersection", 1.6413648),
        ("neighbours", 1.6413648),
        ("size", 1.5001773),
    ],
    &[
        ("ancestors", 1.0897044),
    ...
    &[("components", 4.865936), ("remove", 2.8038423)],
    &[("overlaps", 9.653967)],
    &[("contains", 8.845766)],
    &[
        ("bipartite", 2.9181998),
    ...
    &[
        ("be", 3.0233665),
        ("multigraph", 3.0233665),
        ("must", 2.4130936),
    ],
    &[
        ("be", 2.0764668),
        ("multigraph", 2.0764668),
        ("must", 1.6573277),
        ("not", 2.0042377),
    ],
    &[
    ...
    &[
        ("inplace", 1.0210198),
        ("isomorphic", 1.0891962),
        ("node", 0.18590118),
        ("remove", 0.9005496),
        ("types", 0.6431),
    ],
    &[
        ("isomorphic", 1.5076084),
        ("node", 0.25731468),
        ("remove", 1.2464936),
        ("types", 0.89014536),
    ],
    ...
    &[("circles", 5.9344068), ("get", 0.3752952)],
    &[
        ("get", 0.24292669),
        ("memory", 2.5065293),
        ("stats", 3.841312),
    ...
    &[("get", 0.3752952), ("transitivity", 5.9344068)],
    &[
        ("get", 0.090712875),
        ("node", 0.13990204),
        ("number", 0.61245334),
    ...
    &[
        ("clustering", 1.6413648),
        ("coefficient", 1.4032935),
        ("get", 0.120538846),
        ("node", 0.18590118),
        ("per", 1.7464695),
    ],
    &[
        ("clustering", 3.3079073),
        ("coefficient", 2.8281126),
        ("get", 0.24292669),
    ],
    &[
        ("average", 2.6382368),
        ("clustering", 2.2718914),
        ("coefficient", 1.9423654),
        ("get", 0.16684356),
    ],
    &[
        ("are", 3.841312),
    ...
    &[("connected", 3.9534075), ("holdout", 4.247396)],
    &[("holdout", 4.247396), ("random", 3.4398282)],
    &[
        ("get", 0.120538846),
        ("holdout", 1.364196),
        ("indices", 1.9060371),
    ...
    &[("chains", 5.9344068), ("get", 0.3752952)],
    &[
        ("breadth", 0.42116654),
        ("first", 0.42116654),
        ("from", 0.10388896),
    ...
    &[
        ("and", 0.3092181),
        ("distant", 0.4667584),
        ("eccentricity", 0.3869884),
        ("from", 0.08764343),
        ("get", 0.032215003),
        ("id", 0.27453884),
        ("most", 0.41768757),
        ("node", 0.09615625),
        ("unchecked", 0.17587379),
    ],
    &[
        ("eccentricity", 0.84734875),
        ("from", 0.19190381),
        ("get", 0.07053788),
        ("id", 0.31060174),
        ("node", 0.108787134),
    ...
    &[("four", 3.841312), ("get", 0.24292669), ("sweep", 3.841312)],
    &[
        ("diameter", 3.519729),
        ("get", 0.24292669),
        ("naive", 3.841312),
    ],
    &[("diameter", 5.4375963), ("get", 0.3752952)],
    &[
        ("breadth", 0.7779793),
        ("first", 0.7779793),
        ("from", 0.19190381),
    ...
    &[("density", 5.9344068), ("get", 0.3752952)],
    &[
        ("get", 0.16684356),
        ("nodes", 1.1724944),
        ("rate", 2.0042377),
    ...
    &[
        ("destination", 1.8882487),
        ("get", 0.16684356),
        ("ids", 0.6753914),
        ("node", 0.25731468),
    ],
    &[
        ("destination", 1.364196),
        ("directed", 0.9862761),
        ("get", 0.120538846),
        ("ids", 0.48794746),
        ("node", 0.18590118),
    ...
    &[("get", 0.24292669), ("node", 0.374654), ("urls", 3.841312)],
    &[
        ("get", 0.24292669),
        ("node", 0.374654),
        ("ontologies", 3.0233665),
    ],
    &[
        ("from", 0.24679147),
        ("get", 0.090712875),
    ...
    &[("get", 0.24292669), ("ids", 0.9833798), ("node", 0.374654)],
    &[
        ("directed", 0.9862761),
        ("edge", 0.40115565),
        ("get", 0.120538846),
    ...
    &[("bidiagonal", 5.9344068), ("to", 3.7974641)],
    &[("arrowhead", 5.9344068), ("to", 3.7974641)],
    &[("to", 3.7974641), ("transposed", 5.9344068)],
    &[("to", 3.7974641), ("undirected", 4.247396)],
    &[("complementary", 5.9344068), ("to", 3.7974641)],
    &[
        ("graph", 0.94525033),
        ("multi", 1.9060371),
        ("similarity", 1.9060371),
        ("structural", 1.7464695),
        ("to", 1.2196851),
    ],
    &[
        ("approximated", 2.616291),
        ("cliques", 3.519729),
        ("get", 0.24292669),
    ],
    &[
    ...
    &[("report", 4.6707706), ("textual", 5.4375963)],
    &[
        ("connected", 1.7575514),
        ("generate", 1.7575514),
        ("graph", 1.3083661),
    ...
    &[("filter", 3.519729), ("from", 0.660901), ("ids", 0.9833798)],
    &[
        ("filter", 3.519729),
        ("from", 0.660901),
        ("names", 1.2887444),
    ...
    &[("remove", 2.8038423), ("tendrils", 5.4375963)],
    &[
        ("dendritic", 3.519729),
        ("remove", 1.814913),
        ("trees", 3.519729),
    ...
    &[
        ("disconnected", 3.1496959),
        ("nodes", 1.7071692),
        ("remove", 1.814913),
    ],
    &[("remove", 2.8038423), ("selfloops", 3.8723137)],
    &[
        ("edges", 2.1091208),
        ("parallel", 3.0233665),
        ("remove", 1.814913),
    ...
    &[
        ("arborescence", 2.4173717),
        ("kruskal", 2.4173717),
        ("random", 1.5292314),
        ("spanning", 2.1632307),
    ],
    &[
        ("arborescence", 3.519729),
        ("kruskal", 3.519729),
        ("spanning", 3.1496959),
    ],
    &[
    ...
    &[("enable", 9.653967)],
    &[("all", 3.9534075), ("disable", 5.9344068)],
    &[
        ("compatible", 2.1632307),
        ("has", 1.0692655),
        ("node", 0.25731468),
        ("vocabularies", 2.2718914),
    ],
    &[
        ("compatible", 1.5628612),
        ("has", 0.77250826),
        ("node", 0.18590118),
        ("types", 0.6431),
        ("vocabularies", 1.6413648),
    ],
    &[
        ("compatible", 1.5628612),
        ("edge", 0.40115565),
    ...
    &[("compatible", 4.865936), ("is", 3.602299)],
    &[
        ("adjacency", 2.6382368),
        ("has", 1.0692655),
        ("matrix", 1.7214999),
    ...
    &[("has", 2.4051883), ("nodes", 2.6373897)],
    &[("edges", 3.2583613), ("has", 2.4051883)],
    &[
        ("has", 1.5568663),
        ("nodes", 1.7071692),
        ("trap", 2.8281126),
    ],
    &[("directed", 3.07075), ("is", 3.602299)],
    &[
        ("acyclic", 3.519729),
        ("directed", 1.987681),
        ("is", 2.3317502),
    ...
    &[
        ("edge", 0.40115565),
        ("has", 0.77250826),
        ("probabilities", 1.9060371),
        ("representing", 1.9060371),
        ("weights", 1.138621),
    ],
    &[
        ("has", 1.0692655),
    ...
    &[("has", 2.4051883), ("selfloops", 3.8723137)],
    &[
        ("disconnected", 3.1496959),
        ("has", 1.5568663),
        ("nodes", 1.7071692),
    ...
    &[("connected", 3.9534075), ("is", 3.602299)],
    &[("has", 1.5568663), ("node", 0.374654), ("types", 1.2960649)],
    &[
        ("has", 1.0692655),
        ("multilabel", 2.4173717),
        ("node", 0.25731468),
    ...
    &[("is", 3.602299), ("multigraph", 4.6707706)],
    &[
        ("has", 1.5568663),
        ("node", 0.374654),
        ("ontologies", 3.0233665),
    ...
    &[("get", 0.3752952), ("tendrils", 5.4375963)],
    &[
        ("degree", 0.79780334),
        ("distribution", 1.4344099),
        ("geometric", 1.4344099),
        ("get", 0.090712875),
        ("node", 0.13990204),
        ("threshold", 1.4344099),
    ...
    &[("add", 4.369125), ("selfloops", 3.8723137)],
    &[
        ("centrality", 2.2597246),
        ("degree", 2.1364963),
        ("get", 0.24292669),
    ],
    &[
    ...
    &[
        ("betweenness", 3.0233665),
        ("centrality", 2.2597246),
        ("get", 0.24292669),
    ],
    &[
        ("approximated", 0.75968444),
        ("betweenness", 0.8778857),
        ("centrality", 0.6561494),
        ("from", 0.19190381),
        ("get", 0.07053788),
        ("id", 0.31060174),
    ...
    &[
        ("approximated", 0.6065816),
        ("betweenness", 0.70096123),
        ("centrality", 0.5239125),
        ("from", 0.15322854),
        ("get", 0.05632205),
        ("id", 0.2480047),
    ...
    &[
        ("centrality", 2.2597246),
        ("eigenvector", 3.519729),
        ("get", 0.24292669),
    ],
    &[
        ("centrality", 1.551993),
        ("eigenvector", 2.4173717),
        ("get", 0.16684356),
        ("weighted", 1.2351147),
    ],
    &[("dot", 5.9344068), ("to", 3.7974641)],
    &[("get", 0.3752952), ("stars", 5.9344068)],
    &[
        ("community", 1.6413648),
        ("detection", 1.9060371),
        ("get", 0.120538846),
    ...
    &[
        ("attachment", 1.2697717),
        ("get", 0.120538846),
        ("minimum", 1.4032935),
        ("preferential", 1.2697717),
        ("unchecked", 0.6580668),
    ],
    &[
        ("attachment", 1.2697717),
    ...
    &[
        ("attachment", 0.95558107),
        ("get", 0.090712875),
        ("minimum", 1.0560645),
        ("preferential", 0.95558107),
        ("unchecked", 0.49523565),
        ("weighted", 0.67153215),
    ],
    &[
    ...
    &[
        ("attachment", 0.7430551),
        ("from", 0.19190381),
        ("get", 0.07053788),
        ("ids", 0.285541),
        ("node", 0.108787134),
        ("preferential", 0.7430551),
        ("unchecked", 0.38509277),
    ],
    &[
        ("attachment", 0.95558107),
    ...
    &[
        ("attachment", 0.5933037),
        ("from", 0.15322854),
        ("get", 0.05632205),
        ("ids", 0.22799456),
        ("node", 0.08686275),
        ("preferential", 0.5933037),
        ("unchecked", 0.3074832),
        ("weighted", 0.41694263),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.05632205),
        ("ids", 0.22799456),
        ("intersection", 0.7669314),
        ("neighbours", 0.7669314),
        ("node", 0.08686275),
        ("size", 0.70096123),
        ("unchecked", 0.3074832),
    ],
    &[
        ("coefficient", 0.8211904),
        ("from", 0.19190381),
        ("get", 0.07053788),
        ("ids", 0.285541),
        ("jaccard", 0.75968444),
    ...
    &[
        ("attachment", 1.7575514),
        ("get", 0.16684356),
        ("preferential", 1.7575514),
        ("scores", 2.1632307),
    ],
    &[
        ("allocation", 1.4032935),
        ("get", 0.120538846),
        ("index", 1.2981888),
        ("resource", 1.4032935),
        ("scores", 1.5628612),
