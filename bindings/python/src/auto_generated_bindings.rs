...
impl Graph {
    ...
    pub fn has_unknown_ontologies(&self) -> bool {
        self.inner.has_unknown_ontologies().into()
    }
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("graph", 0.6396264),
        ("laplacian", 0.8602673),
        ("normalized", 0.9051023),
        ("random", 0.67800266),
        ("transformed", 0.8602673),
        ("walk", 0.96512955),
    ],
    &[
        ("get", 0.085967235),
        ("graph", 0.8236624),
        ("laplacian", 1.107787),
        ("normalized", 1.1655222),
        ("symmetric", 1.2428207),
        ("transformed", 1.107787),
    ],
    &[
        ("get", 0.114433855),
        ("graph", 1.0964046),
        ("normalized", 1.5514655),
        ("symmetric", 1.6543602),
        ("transformed", 1.4746122),
    ],
    &[
        ("connected", 0.9131351),
        ("from", 0.25218165),
        ...
        ("is", 0.83898354),
        ("node", 0.14259541),
        ("unchecked", 0.45690563),
    ],
    &[
        ("disconnected", 0.8602673),
        ("from", 0.19583511),
        ("id", 0.2924721),
        ("is", 0.65152425),
        ("node", 0.20671731),
        ("unchecked", 0.35481635),
    ],
    &[
        ("from", 0.25218165),
        ("id", 0.37662342),
    ...
    &[
        ...
        ("is", 0.5196836),
        ("node", 0.08832651),
        ("selfloops", 0.54080385),
        ("singleton", 0.40928087),
        ("unchecked", 0.28301668),
        ("with", 0.46363056),
    ],
    &[
        ("from", 0.19583511),
    ...
    &[("components", 4.640134), ("remove", 3.1351674)],
    &[("overlaps", 9.326815)],
    &[("contains", 8.522114)],
    &[
        ("bipartite", 3.3534498),
    ...
    &[("edge", 1.3152374), ("encode", 5.6972947)],
    &[("decode", 5.6972947), ("edge", 1.3152374)],
    &[
        ("edge", 0.41797614),
        ("encodable", 1.8105731),
        ("get", 0.114433855),
    ...
    &[
        ...
        ("must", 1.6125077),
        ("node", 0.263362),
        ("ontologies", 2.0459914),
    ],
    &[
        ("be", 2.989094),
        ("must", 2.3557954),
        ("undirected", 2.8647027),
    ],
    &[
        ("have", 1.4746122),
        ("must", 1.1621865),
    ...
    &[
        ("be", 2.989094),
        ("multigraph", 3.1448784),
        ("must", 2.3557954),
    ],
    &[
        ("be", 2.0459914),
        ("multigraph", 2.1526234),
        ("must", 1.6125077),
        ("not", 1.8899668),
    ],
    &[
    ...
    &[("circles", 5.6972947), ("get", 0.36008677)],
    &[
        ("get", 0.23196168),
        ("memory", 2.3557954),
        ("stats", 3.670099),
    ...
    &[("get", 0.36008677), ("transitivity", 5.6972947)],
    &[
        ("get", 0.085967235),
        ("node", 0.14259541),
        ("number", 0.5616009),
    ...
    &[
        ("clustering", 1.5514655),
        ("coefficient", 1.3621603),
        ("get", 0.114433855),
        ("node", 0.18981351),
        ("per", 1.6543602),
    ],
    &[
        ("clustering", 3.1448784),
        ("coefficient", 2.7611496),
        ("get", 0.23196168),
    ],
    &[
        ("average", 2.5121295),
        ("clustering", 2.1526234),
        ("coefficient", 1.8899668),
        ("get", 0.1587744),
    ],
    &[
        ("are", 3.670099),
    ...
    &[("negatives", 5.6972947), ("sample", 5.6972947)],
    &[("connected", 3.8248045), ("holdout", 4.028141)],
    &[("holdout", 4.028141), ("random", 3.6570296)],
    &[
        ("get", 0.114433855),
        ("holdout", 1.280124),
        ("indices", 1.8105731),
    ...
    &[("chains", 5.6972947), ("get", 0.36008677)],
    &[
        ("breadth", 0.39255902),
        ("first", 0.39255902),
        ("from", 0.10575073),
        ...
        ("node", 0.05979646),
        ("parallel", 0.44521132),
        ("predecessors", 0.57038015),
        ("search", 0.39255902),
        ("unchecked", 0.19160041),
    ],
    &[
        ("breadth", 0.39255902),
        ("distances", 0.48875415),
        ("first", 0.39255902),
        ("from", 0.10575073),
        ("get", 0.0360498),
        ("ids", 0.15617496),
    ...
    &[
        ("and", 0.2966431),
        ("distant", 0.4394296),
        ("eccentricity", 0.36181572),
        ("from", 0.08916497),
        ("get", 0.030395813),
        ("id", 0.25794777),
        ("most", 0.39168513),
        ("node", 0.09766299),
        ("unchecked", 0.16155013),
    ],
    &[
        ("eccentricity", 0.7946644),
        ("from", 0.19583511),
        ("get", 0.066759035),
        ("id", 0.2924721),
        ("node", 0.110734425),
    ...
    &[("diameter", 4.881966), ("get", 0.36008677)],
    &[
        ("diameter", 2.1526234),
        ("get", 0.1587744),
        ("naive", 2.2953877),
    ...
    &[("density", 5.6972947), ("get", 0.36008677)],
    &[
        ("get", 0.1587744),
        ("nodes", 1.1243232),
        ("rate", 1.8899668),
    ...
    &[
        ...
        ("get", 0.1587744),
        ("number", 1.0372307),
        ("undirected", 1.9608474),
    ],
    &[
        ("edges", 1.0109061),
        ("get", 0.114433855),
        ("number", 0.74756575),
        ("undirected", 1.4132463),
        ("unique", 1.2155046),
    ],
    &[
        ("edges", 2.0491443),
    ...
    &[
        ("destination", 1.8292496),
        ("get", 0.1587744),
        ("ids", 0.6878425),
        ("node", 0.263362),
    ],
    &[
        ("destination", 1.3183994),
        ("directed", 1.2155046),
        ("get", 0.114433855),
        ("ids", 0.49575037),
        ("node", 0.18981351),
    ...
    &[("directed", 3.8248045), ("to", 3.7372653)],
    &[
        ("to", 2.407482),
        ("triangular", 3.3534498),
        ("upper", 3.670099),
    ],
    &[
        ("lower", 3.670099),
    ...
    &[("bidiagonal", 5.6972947), ("to", 3.7372653)],
    &[("arrowhead", 5.6972947), ("to", 3.7372653)],
    &[("to", 3.7372653), ("transposed", 5.6972947)],
    &[("complementary", 5.6972947), ("to", 3.7372653)],
    &[
        ("approximated", 2.4638731),
        ("cliques", 3.3534498),
        ("get", 0.23196168),
    ],
    &[
    ...
    &[("report", 4.4470344), ("textual", 5.205743)],
    &[
        ("connected", 1.6864853),
        ("generate", 1.6478863),
        ("graph", 1.5212367),
    ...
    &[("drop", 3.8248045), ("tendrils", 5.205743)],
    &[
        ("dendritic", 3.3534498),
        ("drop", 2.4638731),
        ("trees", 3.3534498),
    ...
    &[
        ("disconnected", 2.989094),
        ("drop", 2.4638731),
        ("nodes", 1.6425816),
    ],
    &[("drop", 3.8248045), ("selfloops", 3.6570296)],
    &[
        ("drop", 2.4638731),
        ("edges", 2.0491443),
        ("parallel", 2.8647027),
    ...
    &[
        ("arborescence", 2.2953877),
        ("kruskal", 2.2953877),
        ("random", 1.6125077),
        ("spanning", 2.1526234),
    ],
    &[
        ("arborescence", 3.3534498),
        ("kruskal", 3.3534498),
        ("spanning", 3.1448784),
    ],
    &[
    ...
    &[("enable", 9.326815)],
    &[("all", 4.028141), ("disable", 5.6972947)],
    &[("compatible", 5.6972947), ("is", 3.5142097)],
    &[
        ("adjacency", 2.1526234),
        ("has", 1.0460706),
        ("matrix", 1.8899668),
    ...
    &[("has", 2.3723986), ("nodes", 2.549869)],
    &[("edges", 3.1809986), ("has", 2.3723986)],
    &[
        ("has", 1.5282583),
        ("nodes", 1.6425816),
        ("trap", 2.7611496),
    ],
    &[("directed", 3.8248045), ("is", 3.5142097)],
    &[
        ("edge", 0.8472532),
        ("has", 1.5282583),
        ("weights", 2.2637932),
    ...
    &[
        ("edge", 0.41797614),
        ("has", 0.75393695),
        ("probabilities", 1.8105731),
        ("representing", 1.8105731),
        ("weights", 1.116799),
    ],
    &[
        ("has", 1.0460706),
    ...
    &[("has", 2.3723986), ("selfloops", 3.6570296)],
    &[
        ("disconnected", 2.989094),
        ("has", 1.5282583),
        ("nodes", 1.6425816),
    ...
    &[("connected", 3.8248045), ("is", 3.5142097)],
    &[
        ("has", 1.5282583),
        ("node", 0.38475904),
        ("types", 1.2576473),
    ...
    &[("is", 3.5142097), ("multigraph", 4.881966)],
    &[
        ("has", 1.5282583),
        ("node", 0.38475904),
        ("ontologies", 2.989094),
    ...
    &[("get", 0.36008677), ("tendrils", 5.205743)],
    &[
        ("degree", 0.7380467),
        ("distribution", 1.3601741),
        ("geometric", 1.3601741),
        ("get", 0.085967235),
        ("node", 0.14259541),
        ("threshold", 1.3601741),
    ...
    &[("add", 5.6972947), ("selfloops", 3.6570296)],
    &[
        ("centrality", 2.1127775),
        ("degree", 1.9914397),
        ("get", 0.23196168),
    ],
    &[
        ("centrality", 1.4461654),
        ("degree", 1.3631115),
        ("get", 0.1587744),
        ("weighted", 1.1137153),
    ],
    &[
        ("centrality", 0.60806155),
        ("closeness", 0.8602673),
        ("from", 0.19583511),
        ("get", 0.066759035),
        ("id", 0.2924721),
    ...
    &[
        ("centrality", 0.4850159),
        ("closeness", 0.68618596),
        ("from", 0.15620646),
        ("get", 0.053249862),
        ("id", 0.23328824),
        ("node", 0.08832651),
    ...
    &[
        ("betweenness", 2.8647027),
        ("centrality", 2.1127775),
        ("get", 0.23196168),
    ],
    &[
        ("approximated", 0.70910764),
        ("betweenness", 0.8244672),
        ("centrality", 0.60806155),
        ("from", 0.19583511),
        ("get", 0.066759035),
        ("id", 0.2924721),
    ...
    &[
        ("approximated", 0.5656145),
        ("betweenness", 0.65763026),
        ("centrality", 0.4850159),
        ("from", 0.15620646),
        ("get", 0.053249862),
        ("id", 0.23328824),
    ...
    &[
        ("centrality", 2.1127775),
        ("eigenvector", 3.3534498),
        ("get", 0.23196168),
    ],
    &[
        ("centrality", 1.4461654),
        ("eigenvector", 2.2953877),
        ("get", 0.1587744),
        ("weighted", 1.1137153),
    ],
    &[("dot", 5.6972947), ("to", 3.7372653)],
    &[("get", 0.36008677), ("stars", 5.6972947)],
    &[
        ("community", 1.5514655),
        ("detection", 1.8105731),
        ("get", 0.114433855),
    ...
    &[
        ...
        ("from", 0.19583511),
        ("get", 0.066759035),
        ("memberships", 0.96512955),
        ("modularity", 0.96512955),
        ("node", 0.110734425),
    ],
    &[
        ("community", 0.9051023),
        ...
        ("modularity", 0.96512955),
        ("node", 0.110734425),
        ("undirected", 0.8244672),
    ],
    &[
        ("attachment", 1.2155046),
        ("get", 0.114433855),
        ("minimum", 1.3183994),
        ("preferential", 1.2155046),
        ("unchecked", 0.60820234),
    ],
    &[
        ("attachment", 1.2155046),
    ...
    &[
        ("attachment", 0.9131351),
        ("get", 0.085967235),
        ("minimum", 0.99043375),
        ("preferential", 0.9131351),
        ("unchecked", 0.45690563),
        ("weighted", 0.603013),
    ],
    &[
    ...
    &[
        ("attachment", 0.70910764),
        ("from", 0.19583511),
        ("get", 0.066759035),
        ("ids", 0.2892135),
        ("node", 0.110734425),
        ("preferential", 0.70910764),
        ("unchecked", 0.35481635),
    ],
    &[
        ("attachment", 0.9131351),
    ...
    &[
        ("attachment", 0.5656145),
        ("from", 0.15620646),
        ("get", 0.053249862),
        ("ids", 0.23068906),
        ("node", 0.08832651),
        ("preferential", 0.5656145),
        ("unchecked", 0.28301668),
        ("weighted", 0.37351856),
    ],
    &[
