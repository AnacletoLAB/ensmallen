...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("get", 0.0600886),
        ("transformed", 0.7262714),
        ("graph", 0.5476472),
        ("normalized", 0.76463723),
        ("walk", 0.81600344),
        ("random", 0.57030517),
        ("laplacian", 0.7262714),
    ],
    &[
        ...
        ("graph", 0.7107478),
        ("transformed", 0.94257),
        ("normalized", 0.99236196),
        ("get", 0.07798422),
        ("laplacian", 0.94257),
    ],
    &[
        ("normalized", 1.3348502),
        ("graph", 0.9560441),
        ("transformed", 1.2678738),
        ("symmetric", 1.4245217),
        ("get", 0.10489847),
    ],
    &[
        ("node_id", 0.5983322),
        ("unchecked", 0.53457636),
        ("connected", 1.0420648),
        ("is", 0.9059273),
        ("from", 0.296112),
    ],
    ...
    &[
        ...
        ("unchecked", 0.3062194),
        ("singleton", 0.4292069),
        ("selfloops", 0.57030517),
        ("is", 0.51893896),
        ("node_id", 0.34274042),
    ],
    &[
        ("singleton", 0.55703354),
        ("is", 0.6734897),
        ("from", 0.22013728),
        ("selfloops", 0.74015373),
        ("with", 0.6327049),
        ("node_id", 0.44481558),
    ],
    &[
    ...
    &[("has", 2.2293177), ("node_name", 2.7808943)],
    &[("node_type_id", 3.502545), ("has", 2.2293177)],
    &[("has", 2.2293177), ("node_type_name", 3.502545)],
    &[("has", 2.2293177), ("edge_type_id", 2.903234)],
    &[("has", 2.2293177), ("edge_type_name", 3.3463655)],
    &[
        ("from", 0.4168494),
        ("node_ids", 0.71222025),
        ("has", 0.9336973),
    ...
    &[
        ...
        ("edge", 0.8631457),
        ("from", 0.4168494),
        ("node_names", 0.9424226),
    ],
    &[
        ("edge", 0.45582545),
        ("and", 0.7107478),
        ("from", 0.22013728),
        ("edge_type_name", 0.74015373),
        ("node_names", 0.4976914),
        ("has", 0.49308357),
    ],
    &[
        ("components", 2.6625037),
        ("connected", 2.1883104),
        ("strongly", 3.277346),
    ],
    &[
        ("by", 0.8413619),
        ("increasing", 1.0590261),
        ("degree", 0.62369764),
        ("outbound", 0.94257),
        ("sort", 0.94257),
        ("node", 0.448418),
    ...
    &[("components", 4.2615247), ("remove", 2.8605704)],
    &[("overlaps", 8.952923)],
    &[("contains", 8.171952)],
    &[
        ("edges", 1.902425),
    ...
    &[("edge", 2.060867), ("encode", 5.245623)],
    &[("edge", 2.060867), ("decode", 5.245623)],
    &[
        ("max", 1.5606592),
        ("number", 0.71001655),
        ("edge", 0.61314183),
    ...
    &[("node_id", 2.0110896), ("validate", 3.6918283)],
    &[("validate", 3.6918283), ("node_ids", 1.7005138)],
    &[("validate", 3.6918283), ("edge_id", 2.608098)],
    &[("edge_ids", 3.5921965), ("validate", 3.6918283)],
    &[
        ("node_types", 0.69579965),
        ("not", 1.1698732),
        ("contain", 1.2678738),
        ("unknown", 0.89111763),
        ("must", 1.0178204),
    ...
    &[
        ("contain", 1.2678738),
        ("unknown", 0.89111763),
        ("edge_types", 0.7328739),
        ("must", 1.0178204),
        ("not", 1.1698732),
    ],
    &[("node_type_id", 3.502545), ("validate", 3.6918283)],
    &[("validate", 3.6918283), ("node_type_ids", 3.4210558)],
    &[("edge_type_id", 2.903234), ("validate", 3.6918283)],
    &[("validate", 3.6918283), ("edge_type_ids", 3.9321296)],
    &[
        ("undirected", 2.5501976),
        ("be", 2.6625037),
        ("must", 2.1373978),
    ],
    &[
    ...
    &[
        ("be", 2.6625037),
        ("must", 2.1373978),
        ("multigraph", 2.8031526),
    ],
    &[
        ("not", 1.6468801),
        ("must", 1.4328288),
        ("be", 1.7848395),
        ("multigraph", 1.8791251),
    ],
    &[
        ("must", 1.4328288),
        ("identity", 2.0053594),
    ...
    &[("set_name", 8.952923)],
    &[
        ("edge_types", 1.0316976),
        ("inplace", 1.3208431),
        ("all", 1.5462356),
        ("set", 1.7095538),
    ],
    &[
        ("edge_types", 1.5390172),
        ("all", 2.3065703),
        ("set", 2.5501976),
    ],
    &[
        ("all", 1.5462356),
        ("node_types", 0.9795066),
        ("set", 1.7095538),
        ("inplace", 1.3208431),
    ],
    &[
        ("set", 2.5501976),
        ("node_types", 1.4611621),
        ("all", 2.3065703),
    ],
    &[
        ("remove", 1.7872193),
        ("inplace", 1.970345),
        ("node_type_ids", 2.1373978),
    ],
    &[
        ("remove", 1.1980827),
        ("node_types", 0.9795066),
    ...
    &[
        ("node_types", 0.9795066),
        ("homogeneous", 1.593193),
        ("inplace", 1.3208431),
        ("remove", 1.1980827),
    ],
    &[
        ("edge_type_ids", 2.456705),
        ("remove", 1.7872193),
        ("inplace", 1.970345),
    ],
    &[
    ...
    &[
        ("node_type_name", 2.1883104),
        ("inplace", 1.970345),
        ("remove", 1.7872193),
    ],
    &[("node_type_id", 3.502545), ("remove", 2.8605704)],
    &[
        ("node_types", 1.4611621),
        ("singleton", 1.5734682),
        ("remove", 1.7872193),
    ...
    &[
        ("node_types", 1.4611621),
        ("remove", 1.7872193),
        ("homogeneous", 2.3766184),
    ],
    &[("node_type_name", 3.502545), ("remove", 2.8605704)],
    &[
        ("remove", 1.7872193),
        ("edge_type_name", 2.090733),
        ("inplace", 1.970345),
    ],
    &[("edge_type_id", 2.903234), ("remove", 2.8605704)],
    &[
        ("edge_types", 1.5390172),
        ("singleton", 1.5734682),
        ("remove", 1.7872193),
    ],
    &[("edge_type_name", 3.3463655), ("remove", 2.8605704)],
    &[
        ("node_types", 1.4611621),
        ("remove", 1.7872193),
        ("inplace", 1.970345),
    ],
    &[("node_types", 2.338693), ("remove", 2.8605704)],
    &[
        ("edge_types", 1.5390172),
        ("remove", 1.7872193),
        ("inplace", 1.970345),
    ],
    &[("remove", 2.8605704), ("edge_types", 2.4633055)],
    &[
        ("edge", 0.8631457),
        ("remove", 1.1980827),
        ("weights", 1.3458637),
    ...
    &[("circles", 5.245623), ("get", 0.3525804)],
    &[
        ("get", 0.22028421),
        ("memory", 2.090733),
        ("stats", 3.277346),
    ...
    &[
        ...
        ("get", 0.04764176),
        ("memory", 0.45217133),
        ("requirements", 0.53132164),
        ("human", 0.5515416),
        ("weights", 0.43420678),
    ],
    &[
        ("get", 0.10489847),
        ("requirements", 1.1698732),
        ("total", 0.9955988),
        ("node_types", 0.69579965),
        ("memory", 0.9955988),
    ],
    &[
        ("memory", 0.57030517),
        ("get", 0.0600886),
        ("node_types", 0.3985723),
        ("total", 0.57030517),
        ("human", 0.6956368),
        ("requirements", 0.6701342),
        ("readable", 0.6956368),
    ],
    &[
        ("total", 0.9955988),
    ...
    &[("get", 0.3525804), ("transitivity", 5.245623)],
    &[
        ("node", 0.448418),
        ("number", 0.5278446),
        ("per", 1.0590261),
    ...
    &[
        ("node", 0.6031779),
        ("per", 1.4245217),
        ("coefficient", 1.1698732),
        ("clustering", 1.3348502),
        ("get", 0.10489847),
    ],
    &[
        ("get", 0.22028421),
        ("coefficient", 2.456705),
        ("clustering", 2.8031526),
    ],
    &[
        ("coefficient", 1.6468801),
        ("clustering", 1.8791251),
        ("get", 0.14767002),
        ("average", 2.197006),
    ],
    &[
    ...
    &[
        ("get", 0.14767002),
        ("synonims", 2.0053594),
        ("topological", 1.5462356),
        ("node_ids", 0.71222025),
    ],
    &[
        ("has", 1.3928269),
        ("topological", 2.3065703),
        ("synonims", 2.9914606),
    ],
    &[
        ("node_ids", 0.50593084),
        ("topological", 1.0983797),
        ("is", 0.9059273),
        ("from", 0.296112),
        ("synonim", 1.3348502),
    ],
    ...
    &[("negatives", 5.245623), ("sample", 5.245623)],
    &[("holdout", 3.6918283), ("connected", 3.502545)],
    &[("holdout", 3.6918283), ("random", 3.3463655)],
    &[
        ("get", 0.10489847),
        ("indices", 1.5606592),
        ("node", 0.6031779),
    ...
    &[("get", 0.3525804), ("chains", 5.245623)],
    &[
        ("unchecked", 0.19701447),
        ("breadth", 0.39387593),
        ("search", 0.39387593),
        ("parallel", 0.4475566),
        ("get", 0.038659614),
        ("predecessors", 0.5751703),
        ("first", 0.39387593),
        ("node_id", 0.22051126),
        ("from", 0.109130055),
    ],
    ...
    &[
        ...
        ("from", 0.16962074),
        ("get", 0.0600886),
        ("node_names", 0.7228259),
        ("path", 0.5476472),
        ("k", 0.64828825),
    ],
    &[
        ("node_id", 0.42435083),
        ("eccentricity", 0.43114883),
        ("get", 0.038659614),
        ("distant", 0.5249978),
        ("unchecked", 0.19701447),
        ("most", 0.4672662),
    ...
    &[("get", 0.3525804), ("diameter", 4.4866433)],
    &[
        ("diameter", 1.8791251),
        ("naive", 2.0053594),
        ("get", 0.14767002),
    ...
    &[("get", 0.3525804), ("density", 5.245623)],
    &[
        ("nodes", 1.0206624),
        ("get", 0.14767002),
        ("trap", 1.6468801),
    ...
    &[("get", 0.3525804), ("source_names", 5.245623)],
    &[
        ("get", 0.22028421),
        ("destination", 2.456705),
        ("node_ids", 1.0624423),
    ],
    &[
        ("node_ids", 0.71222025),
        ("destination", 1.6468801),
        ("directed", 1.4669588),
        ("get", 0.14767002),
    ],
    &[("destination_names", 5.245623), ("get", 0.3525804)],
    &[("get", 0.3525804), ("node_names", 2.2501504)],
    &[("urls", 3.277346), ("get", 0.22028421), ("node", 1.2666589)],
    &[
        ("node", 1.2666589),
        ("ontologies", 3.277346),
        ("get", 0.22028421),
    ],
    &[("node_ids", 1.7005138), ("get", 0.3525804)],
    &[("get", 0.3525804), ("edge_type_ids", 3.9321296)],
    &[
        ("get", 0.22028421),
        ("edge_type_ids", 2.456705),
        ("unique", 2.1883104),
    ],
    &[("get", 0.3525804), ("edge_type_names", 4.081771)],
    &[
        ("get", 0.22028421),
        ("unique", 2.1883104),
        ("edge_type_names", 2.5501976),
    ],
    &[
        ("get", 0.22028421),
        ("edge", 1.2875829),
    ...
    &[("node_type_ids", 3.4210558), ("get", 0.3525804)],
    &[
        ("mask", 1.6468801),
        ("node_types", 0.9795066),
        ("known", 1.2973874),
    ...
    &[
        ...
        ("get", 0.07798422),
        ("encoded", 0.94257),
        ("edge_types", 0.5448373),
        ("known", 0.6851475),
        ("one", 0.94257),
    ],
    &[("node_type_names", 3.4210558), ("get", 0.3525804)],
    &[
        ("node_type_ids", 2.1373978),
        ("get", 0.22028421),
        ("unique", 2.1883104),
    ...
    &[
        ...
        ("counts", 1.7848395),
        ("hashmap", 1.7848395),
        ("edge_type_id", 1.2159513),
    ],
    &[
        ("edge_type_names", 1.7095538),
        ("get", 0.14767002),
        ("counts", 1.7848395),
        ("hashmap", 1.7848395),
    ],
    ...
    &[("to", 3.4210558), ("directed", 3.502545)],
    &[
        ("triangular", 2.9914606),
        ("to", 2.1373978),
        ("upper", 3.277346),
    ],
    &[
    ...
    &[("to", 3.4210558), ("bidiagonal", 5.245623)],
    &[("to", 3.4210558), ("arrowhead", 5.245623)],
    &[("to", 3.4210558), ("transposed", 5.245623)],
    &[("complementary", 5.245623), ("to", 3.4210558)],
    &[("report", 6.966528)],
    &[
        ("report", 2.5501976),
        ("overlap", 3.277346),
    ...
    &[("textual", 4.7880435), ("report", 4.081771)],
    &[
        ("graph", 1.3458637),
        ("generate", 1.4328288),
        ("random", 1.4015465),
    ...
    &[("replace", 8.952923)],
    &[("filter", 4.7880435), ("from_ids", 5.245623)],
    &[("from_names", 5.245623), ("filter", 4.7880435)],
    &[
        ("node_types", 1.4611621),
        ("drop", 2.3766184),
        ("unknown", 1.8713251),
    ...
    &[
        ("nodes", 1.5225556),
        ("drop", 2.3766184),
        ("disconnected", 2.6625037),
    ],
    &[("selfloops", 3.3463655), ("drop", 3.803945)],
    &[
        ("edges", 1.902425),
        ("parallel", 2.5501976),
        ("drop", 2.3766184),
    ...
    &[
        ("kruskal", 2.0053594),
        ("arborescence", 2.0053594),
        ("spanning", 1.8791251),
        ("random", 1.4015465),
    ],
    &[
        ("arborescence", 2.9914606),
        ("kruskal", 2.9914606),
        ("spanning", 2.8031526),
    ],
    &[
    ...
    &[("enable", 8.952923)],
    &[("disable", 5.245623), ("all", 3.6918283)],
    &[("is", 3.0449653), ("compatible", 5.245623)],
    &[
        ("adjacency", 1.8791251),
        ("has", 0.9336973),
        ("same", 2.197006),
    ...
    &[("nodes", 2.4369574), ("has", 2.2293177)],
    &[("edges", 3.0449653), ("has", 2.2293177)],
    &[("has", 1.3928269), ("trap", 2.456705), ("nodes", 1.5225556)],
    &[("is", 3.0449653), ("directed", 3.502545)],
    &[
        ("edge", 1.2875829),
        ("has", 1.3928269),
        ("weights", 2.0076692),
    ...
    &[
        ("representing", 1.5606592),
        ("has", 0.6632587),
        ("weights", 0.9560441),
        ("probabilities", 1.5606592),
        ("edge", 0.61314183),
    ],
    &[
        ("nodes", 1.0206624),
    ...
    &[("has", 2.2293177), ("edge_types", 2.4633055)],
    &[("has", 2.2293177), ("selfloops", 3.3463655)],
    &[
        ("nodes", 1.5225556),
        ("has", 1.3928269),
        ("disconnected", 2.6625037),
    ...
    &[("is", 3.0449653), ("connected", 3.502545)],
    &[("has", 2.2293177), ("node_types", 2.338693)],
    &[
        ("multilabel", 2.9914606),
        ("has", 1.3928269),
        ("node_types", 1.4611621),
    ],
    &[
    ...
    &[("multigraph", 4.4866433), ("is", 3.0449653)],
    &[
        ("nodes", 0.3292893),
        ("outbound", 0.5758305),
        ("degree", 0.3810265),
    ...
    &[
        ("unchecked", 0.53457636),
        ("edge_type_name", 0.9955988),
        ("from", 0.296112),
        ("get", 0.10489847),
        ("edge_type_id", 0.8637599),
    ],
    &[
        ("edge_type_id", 0.8637599),
        ("unchecked", 0.53457636),
    ...
    &[
        ...
        ("and", 0.5645309),
        ("weight", 0.31026977),
        ("edge_type_id", 0.26330635),
        ("get", 0.03197698),
        ("edge", 0.18690859),
        ("unchecked", 0.16295889),
        ("node_ids", 0.15422666),
    ],
    &[
        ("edge_id", 0.28597185),
    ...
    &[
        ...
        ("unchecked", 0.53457636),
        ("get", 0.10489847),
        ("node_type_id", 1.0420648),
    ],
    &[
        ("from", 0.4168494),
        ("node_type_ids", 1.4328288),
        ("node_id", 0.84229755),
        ("get", 0.14767002),
    ],
    &[
    ...
    &[("add", 5.245623), ("selfloops", 3.3463655)],
    &[
        ("degree", 1.7617761),
        ("get", 0.22028421),
        ("centrality", 1.8713251),
    ],
    &[
        ("degree", 1.1810266),
        ("centrality", 1.254464),
    ...
    &[
        ...
        ("node_id", 0.44481558),
        ("unchecked", 0.3974178),
        ("centrality", 0.6624798),
        ("from", 0.22013728),
    ],
    &[
        ("closeness", 0.7262714),
        ("centrality", 0.5104556),
        ("unchecked", 0.3062194),
        ("node_id", 0.34274042),
        ("from", 0.16962074),
        ("get", 0.0600886),
    ...
    &[
        ("get", 0.22028421),
        ("centrality", 1.8713251),
        ("betweenness", 2.5501976),
    ],
    &[
        ("get", 0.07798422),
        ("approximated", 0.90281177),
        ("betweenness", 0.90281177),
        ("from", 0.22013728),
        ("node_id", 0.44481558),
        ("centrality", 0.6624798),
    ],
    ...
    &[
        ("approximated", 0.6956368),
        ("node_id", 0.34274042),
        ("betweenness", 0.6956368),
        ("weighted", 0.390841),
        ("get", 0.0600886),
        ("from", 0.16962074),
        ("centrality", 0.5104556),
    ...
    &[
        ("eigenvector", 2.9914606),
        ("get", 0.22028421),
        ("centrality", 1.8713251),
    ],
    &[
        ("eigenvector", 2.0053594),
        ("weighted", 0.9605066),
        ("get", 0.14767002),
        ("centrality", 1.254464),
    ],
    &[("dot", 5.245623), ("to", 3.4210558)],
    &[("stars", 5.245623), ("get", 0.3525804)],
    &[
        ("detection", 1.5606592),
        ("louvain", 1.5606592),
        ("undirected", 1.214394),
    ...
    &[
        ("node", 0.34551618),
        ("memberships", 0.81600344),
        ("from", 0.16962074),
        ("community", 0.76463723),
        ("directed", 0.5969221),
        ("get", 0.0600886),
        ("modularity", 0.81600344),
    ],
    &[
        ("undirected", 0.6956368),
        ("modularity", 0.81600344),
        ("get", 0.0600886),
        ("memberships", 0.81600344),
        ("from", 0.16962074),
    ...
    &[
        ("preferential", 1.0420648),
        ("get", 0.10489847),
        ("unchecked", 0.53457636),
        ("minimum", 1.1317363),
        ("attachment", 1.0420648),
    ],
    &[
        ("get", 0.10489847),
        ("maximum", 1.0983797),
    ...
    &[
        ("preferential", 0.7746978),
        ("weighted", 0.5072415),
        ("attachment", 0.7746978),
        ("unchecked", 0.3974178),
        ("minimum", 0.8413619),
        ("get", 0.07798422),
    ],
    ...
    &[
        ("preferential", 0.5969221),
        ("attachment", 0.5969221),
        ("get", 0.0600886),
        ("from", 0.16962074),
        ("node_ids", 0.28981048),
        ("unchecked", 0.3062194),
    ...
    &[
        ...
        ("unchecked", 0.24278867),
        ("weighted", 0.30988166),
        ("allocation", 0.53132164),
        ("get", 0.04764176),
    ],
    &[
        ("allocation", 0.8697139),
        ("node_ids", 0.37612203),
        ("index", 0.794527),
        ("from", 0.22013728),
        ("get", 0.07798422),
