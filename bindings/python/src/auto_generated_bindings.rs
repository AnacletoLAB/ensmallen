...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("graph", 0.65170956),
        ("laplacian", 0.8747629),
        ("normalized", 0.9200881),
        ("random", 0.69050545),
        ("transformed", 0.8747629),
        ("walk", 0.9807717),
    ],
    &[
        ("get", 0.08452344),
        ("graph", 0.83872783),
        ("laplacian", 1.1257899),
        ("normalized", 1.1841218),
        ("symmetric", 1.2622195),
        ("transformed", 1.1257899),
    ],
    &[
        ("get", 0.112424105),
        ("graph", 1.1155866),
        ("normalized", 1.5749931),
        ("symmetric", 1.6788704),
        ("transformed", 1.497406),
    ],
    &[
        ("connected", 0.9291256),
        ("from", 0.24338354),
        ...
        ("is", 0.8542074),
        ("node", 0.13931362),
        ("unchecked", 0.46817946),
    ],
    &[
        ("disconnected", 0.8747629),
        ("from", 0.18911424),
        ("id", 0.29423025),
        ("is", 0.6637375),
        ("node", 0.2019318),
    ...
    &[
        ...
        ("is", 0.6637375),
        ("node", 0.10824968),
        ("selfloops", 0.69050545),
        ("singleton", 0.52381295),
        ("with", 0.59269583),
    ],
    &[
        ("from", 0.24338354),
    ...
    &[("has", 1.543491), ("name", 1.470688), ("node", 0.37464353)],
    &[
        ("has", 1.0580919),
        ("id", 0.6980688),
        ("node", 0.25682512),
    ...
    &[("components", 4.689623), ("remove", 3.1774552)],
    &[("overlaps", 9.38957)],
    &[("contains", 8.583299)],
    &[
        ("bipartite", 3.394373),
    ...
    &[("edge", 1.2769212), ("encode", 5.7518425)],
    &[("decode", 5.7518425), ("edge", 1.2769212)],
    &[
        ("edge", 0.40772352),
        ("encodable", 1.836575),
        ("get", 0.112424105),
    ...
    &[
        ("be", 3.0274847),
        ("multigraph", 3.1843517),
        ("must", 2.3897843),
    ],
    &[
        ("be", 2.0753973),
        ("multigraph", 2.1829326),
        ("must", 1.6382418),
        ("not", 1.918051),
    ],
    &[
    ...
    &[("circles", 5.7518425), ("get", 0.3520933)],
    &[
        ("get", 0.22730124),
        ("memory", 2.3897843),
        ("stats", 3.713223),
    ...
    &[("get", 0.3520933), ("transitivity", 5.7518425)],
    &[
        ("get", 0.08452344),
        ("node", 0.13931362),
        ("number", 0.56457776),
    ...
    &[
        ("clustering", 1.5749931),
        ("coefficient", 1.3838803),
        ("get", 0.112424105),
        ("node", 0.18530019),
        ("per", 1.6788704),
    ],
    &[
        ("clustering", 3.1843517),
        ("coefficient", 2.797956),
        ("get", 0.22730124),
    ],
    &[
        ("average", 2.5454838),
        ("clustering", 2.1829326),
        ("coefficient", 1.918051),
        ("get", 0.15581924),
    ],
    &[
        ("are", 3.713223),
    ...
    &[("negatives", 5.7518425), ("sample", 5.7518425)],
    &[("connected", 3.8703926), ("holdout", 4.074702)],
    &[("holdout", 4.074702), ("random", 3.7018147)],
    &[
        ("get", 0.112424105),
        ("holdout", 1.3010604),
        ("indices", 1.836575),
    ...
    &[("chains", 5.7518425), ("get", 0.3520933)],
    &[
        ("breadth", 0.40004593),
        ("first", 0.40004593),
        ("from", 0.10223554),
        ...
        ("node", 0.058519997),
        ("parallel", 0.45333338),
        ("predecessors", 0.58001214),
        ("search", 0.40004593),
        ("unchecked", 0.19666317),
    ],
    &[
        ("breadth", 0.40004593),
        ("distances", 0.49740148),
        ("first", 0.40004593),
        ("from", 0.10223554),
        ("get", 0.035504863),
        ("ids", 0.15317611),
    ...
    &[
        ("and", 0.30261526),
        ("distant", 0.44715947),
        ("eccentricity", 0.36859018),
        ("from", 0.08622213),
        ("get", 0.029943647),
        ("id", 0.25975105),
        ("most", 0.39882725),
        ("node", 0.0955645),
        ("unchecked", 0.16585931),
    ],
    &[
        ("eccentricity", 0.8084428),
        ("from", 0.18911424),
        ("get", 0.06567653),
        ("id", 0.29423025),
        ("node", 0.10824968),
    ...
    &[("diameter", 4.9326124), ("get", 0.3520933)],
    &[
        ("diameter", 2.1829326),
        ("get", 0.15581924),
        ("naive", 2.326906),
    ...
    &[("density", 5.7518425), ("get", 0.3520933)],
    &[
        ("get", 0.15581924),
        ("nodes", 1.1352243),
        ("rate", 1.918051),
    ...
    &[
        ("destination", 1.8568195),
        ("get", 0.15581924),
        ("ids", 0.6722399),
        ("node", 0.25682512),
    ],
    &[
        ("destination", 1.3397014),
        ("directed", 1.0292718),
        ("get", 0.112424105),
        ("ids", 0.48502335),
        ("node", 0.18530019),
    ...
    &[("directed", 3.2235055), ("to", 3.782434)],
    &[
        ("to", 2.44183),
        ("triangular", 3.394373),
        ("upper", 3.713223),
    ...
    &[("diagonal", 3.394373), ("main", 3.713223), ("to", 2.44183)],
    &[("anti", 3.713223), ("diagonal", 3.394373), ("to", 2.44183)],
    &[("bidiagonal", 5.7518425), ("to", 3.782434)],
    &[("arrowhead", 5.7518425), ("to", 3.782434)],
    &[("to", 3.782434), ("transposed", 5.7518425)],
    &[("complementary", 5.7518425), ("to", 3.782434)],
    &[
        ("approximated", 2.4986134),
        ("cliques", 3.394373),
        ("get", 0.22730124),
    ],
    &[
    ...
    &[("report", 4.4955993), ("textual", 5.2579384)],
    &[
        ("connected", 1.712846),
        ("generate", 1.67392),
        ("graph", 1.5461975),
    ...
    &[("drop", 3.8703926), ("tendrils", 5.2579384)],
    &[
        ("dendritic", 3.394373),
        ("drop", 2.4986134),
        ("trees", 3.394373),
    ...
    &[
        ("disconnected", 3.0274847),
        ("drop", 2.4986134),
        ("nodes", 1.6560079),
    ],
    &[("drop", 3.8703926), ("selfloops", 3.7018147)],
    &[
        ("drop", 2.4986134),
        ("edges", 2.051273),
        ("parallel", 2.9022288),
    ...
    &[
        ("arborescence", 2.326906),
        ("kruskal", 2.326906),
        ("random", 1.6382418),
        ("spanning", 2.1829326),
    ],
    &[
        ("arborescence", 3.394373),
        ("kruskal", 3.394373),
        ("spanning", 3.1843517),
    ],
    &[
    ...
    &[("enable", 9.38957)],
    &[("all", 4.074702), ("disable", 5.7518425)],
    &[("compatible", 5.7518425), ("is", 3.558311)],
    &[
        ("adjacency", 2.1829326),
        ("has", 1.0580919),
        ("matrix", 1.918051),
    ...
    &[("has", 2.3908925), ("nodes", 2.565183)],
    &[("edges", 3.1774552), ("has", 2.3908925)],
    &[("has", 1.543491), ("nodes", 1.6560079), ("trap", 2.797956)],
    &[("directed", 3.2235055), ("is", 3.558311)],
    &[
        ("edge", 0.8243433),
        ("has", 1.543491),
        ("weights", 2.2971425),
    ...
    &[
        ("edge", 0.40772352),
        ("has", 0.7634168),
        ("probabilities", 1.836575),
        ("representing", 1.836575),
        ("weights", 1.1361759),
    ],
    &[
        ("has", 1.0580919),
    ...
    &[("edge", 0.8243433), ("has", 1.543491), ("types", 1.2840034)],
    &[("has", 2.3908925), ("selfloops", 3.7018147)],
    &[
        ("disconnected", 3.0274847),
        ("has", 1.543491),
        ("nodes", 1.6560079),
    ...
    &[("connected", 3.8703926), ("is", 3.558311)],
    &[
        ("has", 1.543491),
        ("node", 0.37464353),
        ("types", 1.2840034),
    ...
    &[("is", 3.558311), ("multigraph", 4.9326124)],
    &[
        ("has", 1.543491),
        ("node", 0.37464353),
        ("ontologies", 2.9022288),
    ...
    &[("get", 0.3520933), ("tendrils", 5.2579384)],
    &[
        ("degree", 0.75222707),
        ("distribution", 1.3807861),
        ("geometric", 1.3807861),
        ("get", 0.08452344),
        ("node", 0.13931362),
        ("threshold", 1.3807861),
    ...
    &[("add", 5.7518425), ("selfloops", 3.7018147)],
    &[
        ("centrality", 2.145077),
        ("degree", 2.022896),
        ("get", 0.22730124),
    ...
    &[
        ("centrality", 1.4704903),
        ("degree", 1.386733),
        ("get", 0.15581924),
        ("weighted", 1.1352243),
    ],
    &[
        ("centrality", 0.6197996),
        ("closeness", 0.8747629),
        ("from", 0.18911424),
        ("get", 0.06567653),
        ("id", 0.29423025),
    ...
    &[
        ("betweenness", 2.9022288),
        ("centrality", 2.145077),
        ("get", 0.22730124),
    ],
    &[
        ("approximated", 0.72195053),
        ("betweenness", 0.8385714),
        ("centrality", 0.6197996),
        ("from", 0.18911424),
        ("get", 0.06567653),
        ("id", 0.29423025),
    ...
    &[
        ("approximated", 0.57612205),
        ("betweenness", 0.66918635),
        ("centrality", 0.4946048),
        ("from", 0.15091461),
        ("get", 0.05241037),
        ("id", 0.23479798),
    ...
    &[
        ("centrality", 2.145077),
        ("eigenvector", 3.394373),
        ("get", 0.22730124),
    ],
    &[
        ("centrality", 1.4704903),
        ("eigenvector", 2.326906),
        ("get", 0.15581924),
        ("weighted", 1.1352243),
    ],
    &[("dot", 5.7518425), ("to", 3.782434)],
    &[("get", 0.3520933), ("stars", 5.7518425)],
    &[
        ("community", 1.5749931),
        ("detection", 1.836575),
        ("get", 0.112424105),
    ...
    &[
        ...
        ("from", 0.18911424),
        ("get", 0.06567653),
        ("memberships", 0.9807717),
        ("modularity", 0.9807717),
        ("node", 0.10824968),
    ],
    &[
        ("community", 0.9200881),
        ...
        ("modularity", 0.9807717),
        ("node", 0.10824968),
        ("undirected", 0.8385714),
    ],
    &[
        ("attachment", 1.2358241),
        ("get", 0.112424105),
        ("minimum", 1.3397014),
        ("preferential", 1.2358241),
        ("unchecked", 0.62272257),
    ],
    &[
        ("attachment", 1.2358241),
    ...
    &[
        ("attachment", 0.9291256),
        ("get", 0.08452344),
        ("minimum", 1.0072234),
        ("preferential", 0.9291256),
        ("unchecked", 0.46817946),
        ("weighted", 0.6157973),
    ],
    &[
    ...
    &[
        ("attachment", 0.72195053),
        ("from", 0.18911424),
        ("get", 0.06567653),
        ("ids", 0.2833436),
        ("node", 0.10824968),
        ("preferential", 0.72195053),
        ("unchecked", 0.3637855),
    ],
    &[
        ("attachment", 0.9291256),
    ...
    &[
        ("attachment", 0.57612205),
        ("from", 0.15091461),
        ("get", 0.05241037),
        ("ids", 0.22611035),
        ("node", 0.08638407),
        ("preferential", 0.57612205),
        ("unchecked", 0.2903036),
        ("weighted", 0.38183683),
    ],
    &[
