...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    &[("tendrils", 5.1666145), ("get", 0.35784292)],
    &[("edge", 1.2927611), ("encode", 5.6577797)],
    &[("edge", 1.2927611), ("decode", 5.6577797)],
    &[
        ("encodable", 1.7966214),
        ("edge", 0.4105148),
        ("number", 0.7547697),
    ...
    &[("connected", 3.786763), ("is", 3.4764125)],
    &[
        ("node", 0.39130172),
        ("has", 1.5584248),
        ("types", 1.2507362),
    ...
    &[("is", 3.4764125), ("multigraph", 4.8430924)],
    &[
        ("by", 0.6071789),
        ("outbound", 0.67973477),
    ...
    &[("nodes", 1.6181502), ("have", 3.118734), ("must", 2.382178)],
    &[
        ("connected", 2.4385052),
        ("must", 2.382178),
        ("be", 2.9631274),
    ...
    &[("transitivity", 5.6577797), ("get", 0.35784292)],
    &[
        ("per", 1.2323656),
        ("node", 0.14494047),
        ("triangles", 1.2323656),
    ...
    &[("is", 3.4764125), ("compatible", 5.6577797)],
    &[
        ("same", 2.493208),
        ("adjacency", 2.1342003),
        ("matrix", 1.8719081),
    ...
    &[("get", 0.35784292), ("density", 5.6577797)],
    &[
        ("nodes", 1.1073265),
        ("get", 0.15769026),
        ("trap", 1.8719081),
    ...
    &[("arrowhead", 5.6577797), ("to", 3.6992924)],
    &[("to", 3.6992924), ("transposed", 5.6577797)],
    &[("to", 3.6992924), ("complementary", 5.6577797)],
    &[("csv", 5.6577797), ("from", 1.0679951)],
    &[("get", 0.35784292), ("chains", 5.6577797)],
    &[
        ("node", 0.06076292),
    ...
    &[("random", 3.61912), ("holdout", 3.9899395)],
    &[
        ("holdout", 1.2670007),
        ("indices", 1.7966214),
        ("get", 0.113632604),
    ...
    &[("report", 4.408503), ("textual", 5.1666145)],
    &[
        ("from", 0.19780533),
        ("get", 0.066276744),
        ("id", 0.292151),
    ...
    &[("name", 1.503957), ("has", 1.5584248), ("node", 0.39130172)],
    &[
        ("type", 0.77033484),
        ("has", 1.0664555),
        ("id", 0.6951061),
    ...
    &[("get", 0.35784292), ("circles", 5.6577797)],
    &[
        ("trees", 3.3270679),
        ("dendritic", 3.3270679),
        ("get", 0.23043476),
