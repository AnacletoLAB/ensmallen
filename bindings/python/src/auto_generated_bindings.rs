...
impl Graph {
    ...
    #[automatically_generated_binding]
    #[text_signature = "($self, number_of_negative_samples, random_state, seed_graph, only_from_same_component, sample_only_edges_with_heterogeneous_node_types, minimum_node_degree, maximum_node_degree)"]
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("graph", 0.6532864),
        ("laplacian", 0.8755047),
        ("normalized", 0.9206601),
        ("random", 0.6919371),
        ("transformed", 0.8755047),
        ("walk", 0.9811166),
    ],
    &[
        ("get", 0.08881677),
        ("graph", 0.8409288),
        ("laplacian", 1.1269743),
        ("normalized", 1.1850997),
        ("symmetric", 1.2629211),
        ("transformed", 1.1269743),
    ],
    &[
        ("get", 0.118166566),
        ("graph", 1.1188165),
        ("normalized", 1.5767199),
        ("symmetric", 1.6802576),
        ("transformed", 1.4993868),
    ],
    &[
        ("connected", 0.90996593),
        ("from", 0.24654761),
        ("id", 0.3804475),
        ("is", 0.8409288),
        ("node", 0.13819967),
        ("unchecked", 0.47169247),
    ],
    &[
        ("connected", 1.2106673),
        ("from", 0.3280201),
    ...
    &[
        ("disconnected", 0.8755047),
        ("from", 0.19153371),
        ("id", 0.29555556),
        ("is", 0.6532864),
        ("node", 0.20032674),
        ("unchecked", 0.36644042),
    ],
    &[
        ("from", 0.24654761),
        ("id", 0.3804475),
    ...
    &[
        ...
        ("node", 0.0856623),
        ("selfloops", 0.5520837),
        ("singleton", 0.41958082),
        ("unchecked", 0.29237598),
        ("with", 0.47433543),
    ],
    &[
        ("from", 0.19153371),
    ...
    &[("has", 1.5163609), ("name", 1.4811044), ("node", 0.3720796)],
    &[
        ("has", 1.0389521),
        ("id", 0.7018052),
        ("node", 0.25493464),
    ...
    &[("components", 4.703503), ("remove", 2.6568413)],
    &[("overlaps", 9.418536)],
    &[("contains", 8.612805)],
    &[
        ("bipartite", 3.400205),
    ...
    &[("edge", 1.259393), ("encode", 5.763979)],
    &[("decode", 5.763979), ("edge", 1.259393)],
    &[
        ("edge", 0.40147036),
        ("encodable", 1.8374462),
        ("get", 0.118166566),
    ...
    &[
        ...
        ("must", 1.6430244),
        ("node", 0.25493464),
        ("ontologies", 1.9932948),
    ],
    &[
        ("be", 3.034191),
        ("must", 2.3980105),
        ("undirected", 2.9092336),
    ],
    &[
        ("have", 1.4993868),
        ("must", 1.1850095),
    ...
    &[
        ("be", 3.034191),
        ("multigraph", 3.1906838),
        ("must", 2.3980105),
    ],
    &[
        ("be", 2.0789108),
        ("multigraph", 2.1861339),
        ("must", 1.6430244),
        ("not", 1.9220214),
    ],
    &[
    ...
    &[
        ("inplace", 1.0481731),
        ("isomorphic", 1.0327841),
        ("node", 0.18386821),
        ("remove", 0.8469502),
        ("types", 0.6157282),
    ],
    &[
        ("isomorphic", 1.4319627),
        ("node", 0.25493464),
        ("remove", 1.1743026),
        ("types", 0.85371166),
    ],
    ...
    &[("circles", 5.763979), ("get", 0.37068275)],
    &[
        ("get", 0.23912437),
        ("memory", 2.3980105),
        ("stats", 3.718295),
    ...
    &[("get", 0.37068275), ("transitivity", 5.763979)],
    &[
        ("get", 0.08881677),
        ("node", 0.13819967),
        ("number", 0.5677495),
    ...
    &[
        ("clustering", 1.5767199),
        ("coefficient", 1.3862324),
        ("get", 0.118166566),
        ("node", 0.18386821),
        ("per", 1.6802576),
    ],
    &[
        ("clustering", 3.1906838),
        ("coefficient", 2.8052094),
        ("get", 0.23912437),
    ],
    &[
        ("average", 2.5476327),
        ("clustering", 2.1861339),
        ("coefficient", 1.9220214),
        ("get", 0.16383882),
    ],
    &[
        ("are", 3.718295),
    ...
    &[("negatives", 5.763979), ("sample", 5.763979)],
    &[("connected", 3.7978039), ("holdout", 4.089592)],
    &[("holdout", 4.089592), ("random", 3.7173169)],
    &[
        ("get", 0.118166566),
        ("holdout", 1.3036836),
        ("indices", 1.8374462),
    ...
    &[("chains", 5.763979), ("get", 0.37068275)],
    &[
        ("breadth", 0.40056482),
        ("first", 0.40056482),
        ("from", 0.10350349),
        ...
        ("node", 0.05801779),
        ("parallel", 0.45363224),
        ("predecessors", 0.5797879),
        ("search", 0.40056482),
        ("unchecked", 0.19802186),
    ],
    &[
        ("breadth", 0.40056482),
        ("distances", 0.49751833),
        ("first", 0.40056482),
        ("from", 0.10350349),
        ("get", 0.03728629),
        ("ids", 0.15718308),
    ...
    &[
        ("and", 0.30317083),
        ("distant", 0.447106),
        ("eccentricity", 0.36886775),
        ("from", 0.087284096),
        ("get", 0.031443384),
        ("id", 0.26083317),
        ("most", 0.39897743),
        ("node", 0.0947491),
        ("unchecked", 0.16699107),
    ],
    &[
        ("eccentricity", 0.8094328),
        ("from", 0.19153371),
        ("get", 0.068998456),
        ("id", 0.29555556),
        ("node", 0.1073622),
    ...
    &[("diameter", 5.270886), ("get", 0.37068275)],
    &[
        ("breadth", 0.7412472),
        ("first", 0.7412472),
        ("from", 0.19153371),
    ...
    &[("density", 5.763979), ("get", 0.37068275)],
    &[
        ("get", 0.16383882),
        ("nodes", 1.1209018),
        ("rate", 1.9220214),
    ...
    &[
        ...
        ("get", 0.16383882),
        ("number", 1.0473181),
        ("undirected", 1.9932948),
    ],
    &[
        ("edges", 0.99075776),
        ("get", 0.118166566),
        ("number", 0.75536424),
        ("undirected", 1.4376374),
        ("unique", 1.2386606),
    ],
    &[
        ("edges", 2.0049186),
    ...
    &[
        ("destination", 1.8609676),
        ("get", 0.16383882),
        ("ids", 0.69067454),
        ("node", 0.25493464),
    ],
    &[
        ("destination", 1.3421981),
        ("directed", 1.0327841),
        ("get", 0.118166566),
        ("ids", 0.49813983),
        ("node", 0.18386821),
    ...
    &[("get", 0.23912437), ("node", 0.3720796), ("urls", 3.718295)],
    &[
        ("get", 0.23912437),
        ("node", 0.3720796),
        ("ontologies", 2.9092336),
    ],
    &[
        ("from", 0.24654761),
        ("get", 0.08881677),
    ...
    &[("get", 0.23912437), ("ids", 1.0080464), ("node", 0.3720796)],
    &[
        ("edge", 0.55664164),
        ("get", 0.16383882),
        ("ids", 0.69067454),
    ...
    &[("directed", 3.2397933), ("to", 3.7978039)],
    &[
        ("to", 2.4499319),
        ("triangular", 3.400205),
        ("upper", 3.718295),
    ...
    &[("bidiagonal", 5.763979), ("to", 3.7978039)],
    &[("arrowhead", 5.763979), ("to", 3.7978039)],
    &[("to", 3.7978039), ("transposed", 5.763979)],
    &[("complementary", 5.763979), ("to", 3.7978039)],
    &[
        ("approximated", 2.5065799),
        ("cliques", 3.400205),
        ("get", 0.23912437),
    ],
    &[
    ...
    &[("report", 4.5097985), ("textual", 5.270886)],
    &[
        ("connected", 1.678599),
        ("generate", 1.678599),
        ("graph", 1.5512474),
    ...
    &[("remove", 2.6568413), ("tendrils", 5.270886)],
    &[
        ("dendritic", 3.400205),
        ("remove", 1.7139063),
        ("trees", 3.400205),
    ...
    &[
        ("disconnected", 3.034191),
        ("nodes", 1.6359674),
        ("remove", 1.7139063),
    ],
    &[("remove", 2.6568413), ("selfloops", 3.7173169)],
    &[
        ("edges", 2.0049186),
        ("parallel", 2.9092336),
        ("remove", 1.7139063),
    ...
    &[
        ("arborescence", 2.3296895),
        ("kruskal", 2.3296895),
        ("random", 1.6430244),
        ("spanning", 2.1861339),
    ],
    &[
        ("arborescence", 3.400205),
        ("kruskal", 3.400205),
        ("spanning", 3.1906838),
    ],
    &[
    ...
    &[("enable", 9.418536)],
    &[("all", 4.089592), ("disable", 5.763979)],
    &[
        ("compatible", 2.0789108),
        ("has", 1.0389521),
        ("node", 0.25493464),
        ("vocabularies", 2.1861339),
    ],
    &[
        ("compatible", 1.4993868),
        ("has", 0.7493304),
        ("node", 0.18386821),
        ("types", 0.6157282),
        ("vocabularies", 1.5767199),
    ],
    &[
        ("compatible", 1.4993868),
        ("edge", 0.40147036),
    ...
    &[("compatible", 4.703503), ("is", 3.5096726)],
    &[
        ("adjacency", 2.1861339),
        ("has", 1.0389521),
        ("matrix", 1.9220214),
    ...
    &[("has", 2.3506129), ("nodes", 2.536023)],
    &[("edges", 3.1079588), ("has", 2.3506129)],
    &[
        ("has", 1.5163609),
        ("nodes", 1.6359674),
        ("trap", 2.8052094),
    ],
    &[("directed", 3.2397933), ("is", 3.5096726)],
    &[
        ("edge", 0.81242394),
        ("has", 1.5163609),
        ("weights", 2.2251296),
    ...
    &[
        ("edge", 0.40147036),
        ("has", 0.7493304),
        ("probabilities", 1.8374462),
        ("representing", 1.8374462),
        ("weights", 1.0995781),
    ],
    &[
        ("has", 1.0389521),
    ...
    &[("has", 2.3506129), ("selfloops", 3.7173169)],
    &[
        ("disconnected", 3.034191),
        ("has", 1.5163609),
        ("nodes", 1.6359674),
    ...
    &[("connected", 3.7978039), ("is", 3.5096726)],
    &[
        ("has", 1.5163609),
        ("node", 0.3720796),
        ("types", 1.2460006),
    ...
    &[("is", 3.5096726), ("multigraph", 4.9460936)],
    &[
        ("has", 1.5163609),
        ("node", 0.3720796),
        ("ontologies", 2.9092336),
    ...
    &[("get", 0.37068275), ("tendrils", 5.270886)],
    &[
        ("degree", 0.75473434),
        ("distribution", 1.3810678),
        ("geometric", 1.3810678),
        ("get", 0.08881677),
        ("node", 0.13819967),
        ("threshold", 1.3810678),
    ...
    &[("add", 5.763979), ("selfloops", 3.7173169)],
    &[
        ("centrality", 2.1538863),
        ("degree", 2.0319967),
        ("get", 0.23912437),
    ],
    &[
    ...
    &[
        ("betweenness", 2.9092336),
        ("centrality", 2.1538863),
        ("get", 0.23912437),
    ],
    &[
        ("approximated", 0.7232644),
        ("betweenness", 0.8394487),
        ("centrality", 0.621496),
        ("from", 0.19153371),
        ("get", 0.068998456),
        ("id", 0.29555556),
    ...
    &[
        ("approximated", 0.5770792),
        ("betweenness", 0.66978043),
        ("centrality", 0.49588004),
        ("from", 0.15282117),
        ("get", 0.055052582),
        ("id", 0.23581827),
    ...
    &[
        ("centrality", 2.1538863),
        ("eigenvector", 3.400205),
        ("get", 0.23912437),
    ],
    &[
        ("centrality", 1.47576),
        ("eigenvector", 2.3296895),
        ("get", 0.16383882),
        ("weighted", 1.1521341),
    ],
    &[("dot", 5.763979), ("to", 3.7978039)],
    &[("get", 0.37068275), ("stars", 5.763979)],
    &[
        ("community", 1.5767199),
        ("detection", 1.8374462),
        ("get", 0.118166566),
    ...
    &[
        ...
        ("from", 0.19153371),
        ("get", 0.068998456),
        ("memberships", 0.9811166),
        ("modularity", 0.9811166),
        ("node", 0.1073622),
    ],
    &[
        ("community", 0.9206601),
        ...
        ("modularity", 0.9811166),
        ("node", 0.1073622),
        ("undirected", 0.8394487),
    ],
    &[
        ("attachment", 1.2386606),
        ("get", 0.118166566),
        ("minimum", 1.3421981),
        ("preferential", 1.2386606),
        ("unchecked", 0.62756485),
    ],
    &[
        ("attachment", 1.2386606),
    ...
    &[
        ("attachment", 0.9310064),
        ("get", 0.08881677),
        ("minimum", 1.0088277),
        ("preferential", 0.9310064),
        ("unchecked", 0.47169247),
        ("weighted", 0.6245701),
    ],
    &[
    ...
    &[
        ("attachment", 0.7232644),
        ("from", 0.19153371),
        ("get", 0.068998456),
        ("ids", 0.29086807),
        ("node", 0.1073622),
        ("preferential", 0.7232644),
        ("unchecked", 0.36644042),
    ],
    &[
        ("attachment", 0.9310064),
    ...
    &[
        ("attachment", 0.5770792),
        ("from", 0.15282117),
        ("get", 0.055052582),
        ("ids", 0.2320782),
        ("node", 0.0856623),
        ("preferential", 0.5770792),
        ("unchecked", 0.29237598),
        ("weighted", 0.3871363),
    ],
    &[
