...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("disconnected", 0.9145744),
        ("from", 0.19297758),
        ("id", 0.31150028),
        ("is", 0.6774207),
        ("node", 0.20408052),
        ("unchecked", 0.38588133),
    ],
    &[
        ("from", 0.24819253),
        ("id", 0.40062708),
    ...
    &[
        ("coo", 0.97734904),
        ("get", 0.09181689),
        ("intersection", 1.2352498),
        ("matrix", 0.9183527),
        ("neighbours", 1.2352498),
        ("size", 1.1291457),
    ],
    &[
        ("get", 0.12201899),
        ("graph", 0.9463528),
        ("intersection", 1.641571),
        ("neighbours", 1.641571),
        ("size", 1.5005652),
    ],
    &[
    ...
    &[("components", 4.8700395), ("remove", 2.8092692)],
    &[("overlaps", 9.663207)],
    &[("contains", 8.855217)],
    &[
        ("bipartite", 2.920149),
    ...
    &[("edge", 1.2398216), ("encode", 5.937825)],
    &[("decode", 5.937825), ("edge", 1.2398216)],
    &[
        ("edge", 0.3979537),
        ("encodable", 1.9059027),
        ("get", 0.12201899),
    ...
    &[
        ...
        ("must", 1.6586481),
        ("node", 0.2590649),
        ("ontologies", 2.0773091),
    ],
    &[
        ("be", 3.0252175),
        ("must", 2.415515),
        ("undirected", 2.7514253),
    ],
    &[
        ("acyclic", 2.4178252),
        ("be", 2.0773091),
    ...
    &[
        ("be", 3.0252175),
        ("multigraph", 3.0252175),
        ("must", 2.415515),
    ],
    &[
        ("be", 2.0773091),
        ("multigraph", 2.0773091),
        ("must", 1.6586481),
        ("not", 2.0051625),
    ],
    &[
    ...
    &[("edges", 2.1118264), ("have", 3.151429), ("must", 2.415515)],
    &[("have", 3.151429), ("must", 2.415515), ("nodes", 1.7102501)],
    &[
        ("be", 3.0252175),
        ("connected", 2.5613062),
        ("must", 2.415515),
    ...
    &[
        ("inplace", 1.0220249),
        ("isomorphic", 1.0901134),
        ("node", 0.18713816),
        ("remove", 0.9017096),
        ("types", 0.64459145),
    ],
    &[
        ("isomorphic", 1.5090996),
        ("node", 0.2590649),
        ("remove", 1.2482828),
        ("types", 0.89234096),
    ],
    ...
    &[("circles", 5.937825), ("get", 0.38014922)],
    &[
        ("get", 0.24599664),
        ("memory", 2.5088634),
        ("stats", 3.842399),
    ...
    &[("get", 0.38014922), ("transitivity", 5.937825)],
    &[
        ("get", 0.09181689),
        ("node", 0.14081778),
        ("number", 0.6086491),
    ...
    &[
        ("clustering", 1.641571),
        ("coefficient", 1.4038062),
        ("get", 0.12201899),
        ("node", 0.18713816),
        ("per", 1.7465404),
    ],
    &[
        ("clustering", 3.3094926),
        ("coefficient", 2.8301463),
        ("get", 0.24599664),
    ],
    &[
        ("average", 2.6384385),
        ("clustering", 2.2725108),
        ("coefficient", 1.9433607),
        ("get", 0.16891713),
    ],
    &[
        ("are", 3.842399),
    ...
    &[("connected", 3.958097), ("holdout", 4.251896)],
    &[("holdout", 4.251896), ("random", 3.4960134)],
    &[
        ("get", 0.12201899),
        ("holdout", 1.364759),
        ("indices", 1.9059027),
    ...
    &[("chains", 5.937825), ("get", 0.38014922)],
    &[
        ("breadth", 0.42121422),
        ("first", 0.42121422),
        ("from", 0.10445408),
    ...
    &[
        ("and", 0.30932304),
        ("distant", 0.46660104),
        ("eccentricity", 0.38696384),
        ("from", 0.0881172),
        ("get", 0.03259827),
        ("id", 0.27529594),
        ("most", 0.4176119),
        ("node", 0.096764706),
        ("unchecked", 0.17620069),
    ],
    &[
        ("eccentricity", 0.84745485),
        ("from", 0.19297758),
        ("get", 0.07139055),
        ("id", 0.31150028),
        ("node", 0.10949029),
    ...
    &[("four", 3.842399), ("get", 0.24599664), ("sweep", 3.842399)],
    &[
        ("diameter", 3.5211163),
        ("get", 0.24599664),
        ("naive", 3.842399),
    ],
    &[("diameter", 5.441333), ("get", 0.38014922)],
    &[
        ("breadth", 0.7781879),
        ("first", 0.7781879),
        ("from", 0.19297758),
    ...
    &[("density", 5.937825), ("get", 0.38014922)],
    &[
        ("get", 0.16891713),
        ("nodes", 1.1743679),
        ("rate", 2.0051625),
    ...
    &[
        ("destination", 1.8893057),
        ("get", 0.16891713),
        ("ids", 0.67783195),
        ("node", 0.2590649),
    ],
    &[
        ("destination", 1.364759),
        ("directed", 0.98732567),
        ("get", 0.12201899),
        ("ids", 0.48963872),
        ("node", 0.18713816),
    ...
    &[("directed", 3.0760055), ("to", 3.8022535)],
    &[
        ("to", 2.460459),
        ("triangular", 3.5211163),
        ("upper", 3.842399),
    ],
    &[
        ("lower", 3.842399),
    ...
    &[("bidiagonal", 5.937825), ("to", 3.8022535)],
    &[("arrowhead", 5.937825), ("to", 3.8022535)],
    &[("to", 3.8022535), ("transposed", 5.937825)],
    &[("to", 3.8022535), ("undirected", 4.251896)],
    &[("complementary", 5.937825), ("to", 3.8022535)],
    &[
        ("graph", 0.9463528),
        ("multi", 1.9059027),
        ("similarity", 1.9059027),
        ("structural", 1.7465404),
        ("to", 1.2204343),
    ],
    &[
        ("approximated", 2.6185224),
        ("cliques", 3.5211163),
        ("get", 0.24599664),
    ],
    &[
    ...
    &[("report", 4.674999), ("textual", 5.441333)],
    &[
        ("connected", 1.7587578),
        ("generate", 1.7587578),
        ("graph", 1.3100846),
    ...
    &[("remove", 2.8092692), ("tendrils", 5.441333)],
    &[
        ("dendritic", 3.5211163),
        ("remove", 1.8178935),
        ("trees", 3.5211163),
    ...
    &[
        ("disconnected", 3.151429),
        ("nodes", 1.7102501),
        ("remove", 1.8178935),
    ],
    &[("remove", 2.8092692), ("selfloops", 3.877055)],
    &[
        ("edges", 2.1118264),
        ("parallel", 3.0252175),
        ("remove", 1.8178935),
    ...
    &[
        ("arborescence", 2.4178252),
        ("kruskal", 2.4178252),
        ("random", 1.5534335),
        ("spanning", 2.2725108),
    ],
    &[
        ("arborescence", 3.5211163),
        ("kruskal", 3.5211163),
        ("spanning", 3.3094926),
    ],
    &[
    ...
    &[("enable", 9.663207)],
    &[("all", 3.958097), ("disable", 5.937825)],
    &[
        ("compatible", 2.163974),
        ("has", 1.0562335),
        ("node", 0.2590649),
        ("vocabularies", 2.2725108),
    ],
    &[
        ("compatible", 1.5631685),
        ("has", 0.7629809),
        ("node", 0.18713816),
        ("types", 0.64459145),
        ("vocabularies", 1.641571),
    ],
    &[
        ("compatible", 1.5631685),
        ("edge", 0.3979537),
    ...
    &[("compatible", 4.8700395), ("is", 3.6072135)],
    &[
        ("adjacency", 2.6384385),
        ("has", 1.0562335),
        ("matrix", 1.6895096),
    ...
    &[("has", 2.3770611), ("nodes", 2.6429234)],
    &[("edges", 3.2634964), ("has", 2.3770611)],
    &[
        ("has", 1.5382092),
        ("nodes", 1.7102501),
        ("trap", 2.8301463),
    ],
    &[("directed", 3.0760055), ("is", 3.6072135)],
    &[
        ("acyclic", 3.5211163),
        ("directed", 1.9904999),
        ("is", 2.3342476),
    ...
    &[
        ("edge", 0.3979537),
        ("has", 0.7629809),
        ("probabilities", 1.9059027),
        ("representing", 1.9059027),
        ("weights", 1.1394745),
    ],
    &[
        ("has", 1.0562335),
    ...
    &[("has", 2.3770611), ("selfloops", 3.877055)],
    &[
        ("disconnected", 3.151429),
        ("has", 1.5382092),
        ("nodes", 1.7102501),
    ...
    &[("connected", 3.958097), ("is", 3.6072135)],
    &[
        ("has", 1.5382092),
        ("node", 0.37728027),
        ("types", 1.2995299),
    ...
    &[("is", 3.6072135), ("multigraph", 4.674999)],
    &[
        ("has", 1.5382092),
        ("node", 0.37728027),
        ("ontologies", 3.0252175),
    ...
    &[("get", 0.38014922), ("tendrils", 5.441333)],
    &[
        ("degree", 0.79843575),
        ("distribution", 1.4341542),
        ("geometric", 1.4341542),
        ("get", 0.09181689),
        ("node", 0.14081778),
        ("threshold", 1.4341542),
    ...
    &[("add", 4.373547), ("selfloops", 3.877055)],
    &[
        ("centrality", 2.2622893),
        ("degree", 2.1391761),
        ("get", 0.24599664),
    ],
    &[
        ("centrality", 1.5534335),
        ("degree", 1.4688962),
        ("get", 0.16891713),
        ("weighted", 1.2369169),
    ],
    &[
        ("centrality", 0.6565377),
        ("closeness", 0.9145744),
        ("from", 0.19297758),
        ("get", 0.07139055),
        ("id", 0.31150028),
    ...
    &[
        ("betweenness", 3.0252175),
        ("centrality", 2.2622893),
        ("get", 0.24599664),
    ],
    &[
        ("approximated", 0.75991994),
        ("betweenness", 0.8779467),
        ("centrality", 0.6565377),
        ("from", 0.19297758),
        ("get", 0.07139055),
        ("id", 0.31150028),
    ...
    &[
        ("approximated", 0.6067312),
        ("betweenness", 0.7009654),
        ("centrality", 0.5241893),
        ("from", 0.15407611),
        ("get", 0.05699925),
        ("id", 0.24870636),
    ...
    &[
        ("centrality", 2.2622893),
        ("eigenvector", 3.5211163),
        ("get", 0.24599664),
    ],
    &[
        ("centrality", 1.5534335),
        ("eigenvector", 2.4178252),
        ("get", 0.16891713),
        ("weighted", 1.2369169),
    ],
    &[("dot", 5.937825), ("to", 3.8022535)],
    &[("get", 0.38014922), ("stars", 5.937825)],
    &[
        ("community", 1.641571),
        ("detection", 1.9059027),
        ("get", 0.12201899),
    ...
    &[
        ("community", 0.96044594),
        ("directed", 0.5776619),
        ("from", 0.19297758),
        ("get", 0.07139055),
        ("memberships", 1.0218611),
        ("modularity", 1.0218611),
        ("node", 0.10949029),
    ],
    &[
        ("community", 0.96044594),
    ...
    &[
        ...
        ("ids", 0.2864765),
        ("node", 0.10949029),
        ("structural", 1.0218611),
        ("unchecked", 0.38588133),
    ],
    &[
        ("attachment", 1.2704564),
        ("get", 0.12201899),
        ("minimum", 1.4038062),
        ("preferential", 1.2704564),
        ("unchecked", 0.65953904),
    ],
    &[
        ("attachment", 1.2704564),
    ...
    &[
        ("attachment", 0.9559934),
        ("get", 0.09181689),
        ("minimum", 1.0563364),
        ("preferential", 0.9559934),
        ("unchecked", 0.49629015),
        ("weighted", 0.6723407),
    ],
    &[
    ...
    &[
        ("attachment", 0.7433152),
        ("from", 0.19297758),
        ("get", 0.07139055),
        ("ids", 0.2864765),
        ("node", 0.10949029),
        ("preferential", 0.7433152),
        ("unchecked", 0.38588133),
    ],
    &[
        ("attachment", 0.9559934),
    ...
    &[
        ("attachment", 0.59347373),
        ("from", 0.15407611),
        ("get", 0.05699925),
        ("ids", 0.22872701),
        ("node", 0.087418646),
        ("preferential", 0.59347373),
        ("unchecked", 0.30809328),
        ("weighted", 0.41738418),
    ],
    &[
    ...
    &[
        ("attachment", 1.7587578),
        ("get", 0.16891713),
        ("preferential", 1.7587578),
        ("scores", 2.163974),
    ],
    &[
        ("allocation", 1.4038062),
        ("get", 0.12201899),
        ("index", 1.2988368),
        ("resource", 1.4038062),
        ("scores", 1.5631685),
