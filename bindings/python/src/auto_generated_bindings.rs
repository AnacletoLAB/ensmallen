...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[("chains", 5.9821), ("get", 0.36303043)],
    &[("circles", 5.9821), ("get", 0.36303043)],
    &[
        ("approximated", 2.5370846),
        ("cliques", 3.5529218),
        ("get", 0.23517948),
    ],
    &[
    ...
    &[
        ("coo", 1.0133743),
        ("get", 0.08793294),
        ("intersection", 1.2490216),
        ("matrix", 0.9486087),
        ("neighbours", 1.2490216),
        ("size", 1.1423556),
    ],
    &[
        ("get", 0.11680976),
        ("graph", 0.9605807),
        ("intersection", 1.6591954),
        ("neighbours", 1.6591954),
        ("size", 1.5175006),
    ],
    &[
        ("ancestors", 1.1029317),
    ...
    &[("has", 1.5849495), ("name", 1.4916558), ("node", 0.3696375)],
    &[
        ("has", 1.0891798),
        ("id", 0.7361656),
        ("node", 0.25401545),
    ...
    &[
        ("approximated", 0.5892128),
        ("get", 0.054618105),
        ("groups", 0.5892128),
        ("isomorphic", 0.49667835),
        ("node", 0.08584464),
        ("number", 0.37337172),
        ("of", 0.38167116),
        ("type", 0.24537843),
    ...
    &[("get", 0.36303043), ("transitivity", 5.9821)],
    &[
        ("get", 0.08793294),
        ("node", 0.13820639),
        ("number", 0.6011133),
    ...
    &[
        ("clustering", 1.6591954),
        ("coefficient", 1.4202689),
        ("get", 0.11680976),
        ("node", 0.18359283),
        ("per", 1.6591954),
    ],
    &[
        ("clustering", 3.340549),
        ("coefficient", 2.859505),
        ("get", 0.23517948),
    ],
    &[
        ("average", 2.663141),
        ("clustering", 2.2956305),
        ("coefficient", 1.9650562),
        ("get", 0.1616157),
    ],
    &[
        ("community", 1.6591954),
    ...
    &[
        ...
        ("from", 0.18610835),
        ("get", 0.06839177),
        ("memberships", 1.0332135),
        ("modularity", 1.0332135),
        ("node", 0.10749306),
    ],
    &[
        ("community", 0.9714541),
    ...
    &[
        ("get", 0.23517948),
        ("nodes", 1.7356435),
        ("subsampled", 3.8753421),
    ],
    &[
        ("compatible", 2.186624),
        ("has", 1.0891798),
        ("node", 0.25401545),
        ("vocabularies", 2.2956305),
    ],
    &[
        ("compatible", 1.5804098),
        ("has", 0.7872182),
        ("node", 0.18359283),
        ("types", 0.6573451),
        ("vocabularies", 1.6591954),
    ],
    &[
        ("compatible", 1.5804098),
        ("edge", 0.41284636),
    ...
    &[("compatible", 4.91172), ("is", 3.6458266)],
    &[
        ("adjacency", 2.663141),
        ("has", 1.0891798),
        ("matrix", 1.7434884),
    ...
    &[
        ("destination", 1.9107674),
        ("get", 0.1616157),
        ("ids", 0.6759145),
        ("node", 0.25401545),
    ],
    &[
        ("destination", 1.3810309),
        ("directed", 1.0017538),
        ("get", 0.11680976),
        ("ids", 0.48852566),
        ("node", 0.18359283),
    ...
    &[
        ("centrality", 0.6469998),
        ("closeness", 0.88849217),
        ("from", 0.18610835),
        ("get", 0.06839177),
        ("id", 0.3115271),
        ("node", 0.10749306),
    ...
    &[
        ("betweenness", 3.055267),
        ("centrality", 2.2248447),
        ("get", 0.23517948),
    ],
    &[
        ("approximated", 0.73780125),
        ("betweenness", 0.88849217),
        ("centrality", 0.6469998),
        ("from", 0.18610835),
        ("get", 0.06839177),
        ("id", 0.3115271),
    ...
    &[
        ("centrality", 2.2248447),
        ("eigenvector", 3.5529218),
        ("get", 0.23517948),
    ],
    &[
        ("centrality", 1.5289167),
        ("eigenvector", 2.4415731),
        ("get", 0.1616157),
        ("weighted", 1.2555565),
    ],
    &[
    ...
    &[("components", 4.91172), ("remove", 2.8459437)],
    &[("add", 4.414022), ("selfloops", 3.7067401)],
    &[("name", 2.3025668), ("set", 4.716206)],
    &[
        ("all", 1.2862676),
        ("edge", 0.41284636),
        ("inplace", 1.0366223),
    ...
    &[
        ("components", 3.1819255),
        ("connected", 2.589713),
        ("strongly", 3.8753421),
    ],
    &[("get", 0.36303043), ("tendrils", 5.4844017)],
    &[
        ("edges", 0.799632),
        ("features", 1.4489794),
        ("from", 0.23928395),
    ...
    &[("directed", 3.113328), ("to", 3.8413403)],
    &[
        ("to", 2.488509),
        ("triangular", 3.5529218),
        ("upper", 3.8753421),
    ],
    &[
        ("lower", 3.8753421),
    ...
    &[("bidiagonal", 5.9821), ("to", 3.8413403)],
    &[("arrowhead", 5.9821), ("to", 3.8413403)],
    &[("to", 3.8413403), ("transposed", 5.9821)],
    &[("to", 3.8413403), ("undirected", 4.292075)],
    &[("complementary", 5.9821), ("to", 3.8413403)],
    &[
        ("graph", 0.9605807),
        ("multi", 1.9248184),
        ("similarity", 1.9248184),
        ("structural", 1.7646775),
        ("to", 1.2360013),
    ],
    &[("report", 7.664102)],
    &[
    ...
    &[("report", 4.716206), ("textual", 5.4844017)],
    &[("dot", 5.9821), ("to", 3.8413403)],
    &[("enable", 9.7212515)],
    &[("all", 3.9975624), ("disable", 5.9821)],
    &[
        ("breadth", 0.42687),
        ("first", 0.42687),
        ("from", 0.100795075),
        ...
        ("node", 0.05821754),
        ("parallel", 0.4812016),
        ("predecessors", 0.6103626),
        ("search", 0.42687),
        ("unchecked", 0.20844506),
    ],
    &[
        ("breadth", 0.42687),
        ("distances", 0.50115013),
        ("first", 0.42687),
        ("from", 0.100795075),
        ("get", 0.03704054),
        ("ids", 0.15491217),
    ...
    &[("diameter", 5.4844017), ("get", 0.36303043)],
    &[
        ("breadth", 0.78817415),
        ("first", 0.78817415),
        ("from", 0.18610835),
    ...
    &[
        ...
        ("ids", 0.28603035),
        ("node", 0.10749306),
        ("structural", 1.0332135),
        ("unchecked", 0.38487366),
    ],
    &[
        ("attachment", 1.2862676),
        ("get", 0.11680976),
        ("minimum", 1.4202689),
        ("preferential", 1.2862676),
        ("unchecked", 0.6573451),
    ],
    &[
        ("attachment", 1.2862676),
    ...
    &[
        ("attachment", 0.9682863),
        ("get", 0.08793294),
        ("minimum", 1.0691607),
        ("preferential", 0.9682863),
        ("unchecked", 0.49484125),
        ("weighted", 0.68313146),
    ],
    &[
    ...
    &[
        ("attachment", 0.75310594),
        ("from", 0.18610835),
        ("get", 0.06839177),
        ("ids", 0.28603035),
        ("node", 0.10749306),
        ("preferential", 0.75310594),
        ("unchecked", 0.38487366),
    ],
    &[
        ("attachment", 0.9682863),
    ...
    &[
        ("attachment", 0.60143524),
        ("from", 0.14862733),
        ("get", 0.054618105),
        ("ids", 0.22842565),
        ("node", 0.08584464),
        ("preferential", 0.60143524),
        ("unchecked", 0.30736256),
        ("weighted", 0.42431593),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.054618105),
        ("ids", 0.22842565),
        ("intersection", 0.7758094),
        ("neighbours", 0.7758094),
        ("node", 0.08584464),
        ("size", 0.7095555),
        ("unchecked", 0.30736256),
    ],
    &[
        ("coefficient", 0.83156323),
        ("from", 0.18610835),
        ("get", 0.06839177),
        ("ids", 0.28603035),
        ("jaccard", 0.7698038),
    ...
    &[
        ("attachment", 1.7796547),
        ("get", 0.1616157),
        ("preferential", 1.7796547),
        ("scores", 2.186624),
    ],
    &[
        ("allocation", 1.4202689),
        ("get", 0.11680976),
        ("index", 1.3147868),
        ("resource", 1.4202689),
        ("scores", 1.5804098),
    ...
    &[
        ("arborescence", 2.4415731),
        ("kruskal", 2.4415731),
        ("random", 1.5506084),
        ("spanning", 2.186624),
    ],
    &[
        ("arborescence", 3.5529218),
        ("kruskal", 3.5529218),
        ("spanning", 3.1819255),
    ],
    &[
    ...
    &[("remove", 2.8459437), ("tendrils", 5.4844017)],
    &[
        ("dendritic", 3.5529218),
        ("remove", 1.8436679),
        ("trees", 3.5529218),
    ...
    &[
        ("disconnected", 3.1819255),
        ("nodes", 1.7356435),
        ("remove", 1.8436679),
    ],
    &[("remove", 2.8459437), ("selfloops", 3.7067401)],
    &[
        ("edges", 2.1386416),
        ("parallel", 3.055267),
        ("remove", 1.8436679),
    ...
    &[("connected", 3.9975624), ("holdout", 4.292075)],
    &[("holdout", 4.292075), ("random", 3.4830654)],
    &[
        ("get", 0.11680976),
        ("holdout", 1.3810309),
        ("indices", 1.9248184),
    ...
    &[("has", 2.4465778), ("nodes", 2.6791937)],
    &[("edges", 3.3012745), ("has", 2.4465778)],
    &[("has", 1.5849495), ("nodes", 1.7356435), ("trap", 2.859505)],
    &[("directed", 3.113328), ("is", 3.6458266)],
    &[
        ("acyclic", 3.5529218),
        ("directed", 2.0168858),
        ("is", 2.3618505),
    ...
    &[
        ("edge", 0.41284636),
        ("has", 0.7872182),
        ("probabilities", 1.9248184),
        ("representing", 1.9248184),
        ("weights", 1.1546459),
    ],
    &[
        ("has", 1.0891798),
    ...
    &[("has", 2.4465778), ("selfloops", 3.7067401)],
    &[
        ("disconnected", 3.1819255),
        ("has", 1.5849495),
        ("nodes", 1.7356435),
    ...
    &[("connected", 3.9975624), ("is", 3.6458266)],
    &[
        ("has", 1.5849495),
        ("node", 0.3696375),
        ("types", 1.3234689),
    ...
    &[("is", 3.6458266), ("multigraph", 4.716206)],
    &[
        ("has", 1.5849495),
        ("node", 0.3696375),
        ("ontologies", 3.055267),
