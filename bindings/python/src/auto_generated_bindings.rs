...
to_ndarray_1d!(gil, self.inner.get_first_k_chain_node_ids(k.clone()), NodeT)
    ...
    /// 
            ...
            self.inner.get_first_k_chain_node_names(k.clone()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
            ...
            self.inner.get_chain_node_names().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
...
&[("get", 0.07583805), ("id", 0.611402), ("node", 0.07583805), ("root", 0.42482838)],
&[("get", 0.07583805), ("name", 0.611402), ("node", 0.07583805), ("root", 0.42482838)],
&[("len", 2.5416396)],
&[("chain", 0.21014561), ("get", 0.07583805), ("ids", 0.42482838), ("node", 0.07583805)],
&[("chain", 0.110427275), ("first", 0.22323874), ("get", 0.039851367), ("ids", 0.22323874), ("k", 0.22323874), ("node", 0.039851367)],
&[("chain", 0.110427275), ("first", 0.22323874), ("get", 0.039851367), ("k", 0.22323874), ("names", 0.22323874), ("node", 0.039851367)],
&[("chain", 0.21014561), ("get", 0.07583805), ("names", 0.42482838), ("node", 0.07583805)],
];
...
to_ndarray_1d!(gil, self.inner.get_circle_node_ids(), NodeT)
    ...
    /// 
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_first_k_circle_node_ids(k.clone()), NodeT)
            }
    ...
    /// 
            ...
            self.inner.get_first_k_circle_node_names(k.clone()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
            ...
            self.inner.get_circle_node_names().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
...
&[("get", 0.07583805), ("name", 0.611402), ("node", 0.07583805), ("root", 0.42482838)],
&[("len", 2.5416396)],
&[("circle", 0.21014561), ("get", 0.07583805), ("ids", 0.42482838), ("node", 0.07583805)],
&[("circle", 0.110427275), ("first", 0.22323874), ("get", 0.039851367), ("ids", 0.22323874), ("k", 0.22323874), ("node", 0.039851367)],
&[("circle", 0.110427275), ("first", 0.22323874), ("get", 0.039851367), ("k", 0.22323874), ("names", 0.22323874), ("node", 0.039851367)],
&[("circle", 0.21014561), ("get", 0.07583805), ("names", 0.42482838), ("node", 0.07583805)],
];
...
to_ndarray_1d!(gil, self.inner.get_node_ids(), NodeT)
            ...
            self.inner.get_node_names().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
            
}

pub const CLIQUE_METHODS_NAMES: &[&str] = &[
    "len",
    "get_node_ids",
    "get_node_names",
];

pub const CLIQUE_TERMS: &[&str] = &[
    "len",
    "get",
    "node",
    "ids",
...
&[("len", 1.3203471)],
&[("get", 0.18176937), ("ids", 0.37932625), ("node", 0.18176937)],
&[("get", 0.18176937), ("names", 0.37932625), ("node", 0.18176937)],
];
...
to_ndarray_1d!(gil, self.inner.get_dentritic_trees_node_ids(), NodeT)
    ...
    /// 
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_first_k_dentritic_trees_node_ids(k.clone()), NodeT)
            }
    ...
    /// 
            ...
            self.inner.get_first_k_dentritic_trees_node_names(k.clone()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
            ...
            self.inner.get_dentritic_trees_node_names().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
...
&[("dendritic", 0.509799), ("get", 0.2099079), ("tree", 0.59874874), ("type", 0.8986398)],
&[("get", 0.2099079), ("id", 0.8986398), ("node", 0.37964714), ("root", 0.7178391)],
&[("is", 0.6956208), ("tree", 1.4629598)],
&[("is", 0.6956208), ("tendril", 1.4629598)],
&[("dendritic", 0.76747227), ("is", 0.4285964), ("tree", 0.9013809)],
&[("chain", 0.8986398), ("floating", 0.8986398), ("free", 0.8986398), ("is", 0.28469825)],
&[("is", 0.6956208), ("star", 1.2456234)],
&[("is", 0.4285964), ("star", 0.76747227), ("tendril", 0.9013809)],
&[("dendritic", 0.76747227), ("is", 0.4285964), ("star", 0.76747227)],
&[("dendritic", 0.509799), ("is", 0.28469825), ("star", 0.509799), ("tendril", 0.59874874)],
&[("depth", 2.195702), ("get", 0.5128809)],
&[("get", 0.2099079), ("name", 0.8986398), ("node", 0.37964714), ("root", 0.7178391)],
&[("get", 0.14818765), ("involved", 0.50676936), ("nodes", 0.63440835), ("number", 0.50676936), ("of", 0.50676936)],
&[("edges", 0.63440835), ("get", 0.14818765), ("involved", 0.50676936), ("number", 0.50676936), ("of", 0.50676936)],
&[("dentritic", 0.3599003), ("get", 0.14818765), ("ids", 0.50676936), ("node", 0.26801765), ("trees", 0.3599003)],
&[("dentritic", 0.20459273), ("first", 0.2880835), ("get", 0.084240325), ("ids", 0.2880835), ("k", 0.2880835), ("node", 0.15236016), ("trees", 0.20459273)],
&[("dentritic", 0.20459273), ("first", 0.2880835), ("get", 0.084240325), ("k", 0.2880835), ("names", 0.2880835), ("node", 0.15236016), ("trees", 0.20459273)],
&[("dentritic", 0.3599003), ("get", 0.14818765), ("names", 0.50676936), ("node", 0.26801765), ("trees", 0.3599003)],
];
    ...
    fn __getattr__(&self, name: String) -> PyResult<()> {
        ...
        Err(PyAttributeError::new_err(format!(
            ...
            doc_scores
                .iter()
                .map(|(method_id, _)| { 
                    format!("* `{}`", DENDRITICTREE_METHODS_NAMES[*method_id].to_string()) 
                })
                .take(10)
                .collect::<Vec<String>>()
                .join("\n"),
...
impl Graph {
    ...
    /// If the given node ID does not exists in the graph this method will panic.
            ...
            self.inner.is_unchecked_connected_from_node_id(node_id.clone()).into()
            }
    ...
    /// If the given node ID does not exists in the graph this method will panic.
            ...
            self.inner.is_unchecked_disconnected_node_from_node_id(node_id.clone()).into()
            }
    ...
    /// If the given node ID does not exists in the graph this method will panic.
            ...
            self.inner.is_unchecked_singleton_from_node_id(node_id.clone()).into()
            }
    ...
    ///     The node to be checked for.
    /// 
            pub unsafe fn is_unchecked_singleton_with_selfloops_from_node_id(&self, node_id: NodeT)-> bool{
            self.inner.is_unchecked_singleton_with_selfloops_from_node_id(node_id.clone()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.is_singleton_with_selfloops_from_node_id(node_id.clone()))?.into())
            }
    ...
    /// If the given node name does not exist in the graph this method will panic.
            ...
            self.inner.is_unchecked_singleton_from_node_name(node_name).into()
            }
    ...
    /// 
            ...
            self.inner.has_edge_from_node_ids(src.clone(), dst.clone()).into()
            }
    ...
    /// 
            pub fn has_edge_from_node_ids_and_edge_type_id(&self, src: NodeT, dst: NodeT, edge_type: Option<EdgeTypeT>)-> bool{
            self.inner.has_edge_from_node_ids_and_edge_type_id(src.clone(), dst.clone(), edge_type).into()
            }
    ...
    /// If the given node ID does not exists in the graph this method will panic.
            ...
            self.inner.is_unchecked_trap_node_from_node_id(node_id.clone()).into()
            }
    ...
    /// ------
    /// If the given node ID does not exists in the graph this method will panic.
            pub unsafe fn is_unchecked_trap_node_with_selfloops_from_node_id(&self, node_id: NodeT)-> bool{
            self.inner.is_unchecked_trap_node_with_selfloops_from_node_id(node_id.clone()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.is_trap_node_with_selfloops_from_node_id(node_id.clone()))?.into())
            }
    ...
    ///  improper parametrization of the method.
            pub unsafe fn are_unchecked_isomorphic_from_node_ids(&self, first_node_id: NodeT, second_node_id: NodeT)-> bool{
            self.inner.are_unchecked_isomorphic_from_node_ids(first_node_id.clone(), second_node_id.clone()).into()
            }
    ...
    /// 
            pub fn are_isomorphic_from_node_ids(&self, first_node_id: NodeT, second_node_id: NodeT)-> PyResult<bool>{
            Ok(pe!(self.inner.are_isomorphic_from_node_ids(first_node_id.clone(), second_node_id.clone()))?.into())
            }
    ...
    /// 
            pub fn are_isomorphic_from_node_names(&self, first_node_name: &str, second_node_name: &str)-> PyResult<bool>{
            Ok(pe!(self.inner.are_isomorphic_from_node_names(first_node_name, second_node_name))?.into())
            }
    ...
    ///     The node types name.
    /// 
            pub fn has_node_name_and_node_type_name(&self, node_name: &str, node_type_name: Option<Vec<String>>)-> bool{
            self.inner.has_node_name_and_node_type_name(node_name, node_type_name).into()
            }
    ...
    /// 
            ...
            self.inner.has_edge_from_node_names(src_name, dst_name).into()
            }
    ...
    /// 
            pub fn has_edge_from_node_names_and_edge_type_name(&self, src_name: &str, dst_name: &str, edge_type_name: Option<&str>)-> bool{
            self.inner.has_edge_from_node_names_and_edge_type_name(src_name, dst_name, edge_type_name).into()
            }
    ...
    /// 
            pub fn has_edge_from_node_id_and_edge_type_id(&self, src: NodeT, edge_type_id: Option<EdgeTypeT>)-> PyResult<bool>{
            Ok(pe!(self.inner.has_edge_from_node_id_and_edge_type_id(src.clone(), edge_type_id))?.into())
            }
    ...
    /// ------
    /// When
            pub unsafe fn has_unchecked_edge_from_node_id_and_edge_type_id(&self, src: NodeT, edge_type_id: Option<EdgeTypeT>)-> bool{
            self.inner.has_unchecked_edge_from_node_id_and_edge_type_id(src.clone(), edge_type_id).into()
            }
    ...
    /// This is an implementation of Tarjan algorithm.
            ...
            self.inner.strongly_connected_components().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
...
({
    ...
    let result_array = ThreadDataRaceAware {t: unsafe{PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)}};
    body.into_par_iter().enumerate()
        .for_each(|(i, (a, b))| unsafe {
            *(result_array.t.uget_mut([i, 0]))  = a;
            *(result_array.t.uget_mut([i, 1]))  = b;
        });
    result_array.t.to_owned()}, {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_1, WeightT)})
            ...
            pub fn get_neighbours_intersection_size_coo_matrix(&self)-> (Py<PyArray2<NodeT>>, Py<PyArray1<WeightT>>){
...
to_ndarray_1d!(gil, subresult_1, WeightT)})
    ...
    /// 
            pub fn get_shared_ancestors_size_coo_matrix(&self, bfs: &ShortestPathsResultBFS)-> (Py<PyArray2<NodeT>>, Py<PyArray1<WeightT>>){
            let (subresult_0, subresult_1) = self.inner.get_shared_ancestors_size_coo_matrix(bfs.into());
({
    // Warning: this copies the array so it uses double the memory.
    // To avoid this you should directly generate data compatible with a numpy array
    // Which is a flat vector with row-first or column-first unrolling
...
to_ndarray_1d!(gil, subresult_1, WeightT)})
    ...
    /// 
            ...
            self.inner.get_shared_ancestors_size_graph(bfs.into()).into()
            }
    ...
    ///     The BFS object to use for the ancestors.
    /// 
            pub fn get_ancestors_jaccard_coo_matrix(&self, bfs: &ShortestPathsResultBFS)-> (Py<PyArray2<NodeT>>, Py<PyArray1<WeightT>>){
...
to_ndarray_1d!(gil, subresult_1, WeightT)})
            ...
            pub fn get_left_normalized_laplacian_coo_matrix(&self)-> (Py<PyArray2<NodeT>>, Py<PyArray1<WeightT>>){
...
to_ndarray_1d!(gil, subresult_1, WeightT)})
            ...
            pub fn get_right_normalized_laplacian_coo_matrix(&self)-> (Py<PyArray2<NodeT>>, Py<PyArray1<WeightT>>){
...
to_ndarray_1d!(gil, subresult_1, WeightT)})
            ...
            pub fn get_symmetric_normalized_laplacian_coo_matrix(&self)-> (Py<PyArray2<NodeT>>, Py<PyArray1<WeightT>>){
...
to_ndarray_1d!(gil, subresult_1, WeightT)})
    ...
    /// 
            pub fn get_bfs_topological_sorting_from_node_id(&self, root_node_id: NodeT)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_bfs_topological_sorting_from_node_id(root_node_id.clone()))?, NodeT)})
            }
    ...
    ///     If the given root node ID does not exist in the graph
    /// 
            pub fn get_reversed_bfs_topological_sorting_from_node_id(&self, root_node_id: NodeT)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_reversed_bfs_topological_sorting_from_node_id(root_node_id.clone()))?, NodeT)})
            }
    ...
    ///     If the given root node ID does not exist in the graph
    /// 
            pub fn sort_by_bfs_topological_sorting_from_node_id(&self, root_node_id: NodeT)-> PyResult<Graph>{
            Ok(pe!(self.inner.sort_by_bfs_topological_sorting_from_node_id(root_node_id.clone()))?.into())
            }
    ...
    /// 
            pub fn get_predictions_histograms(&self, path: String, source_column_name: Option<String>, destination_column_name: Option<String>, prediction_column_name: Option<String>, allowed_source_nodes: Option<Vec<String>>, allowed_destination_nodes: Option<Vec<String>>, allowed_source_node_prefixes: Option<Vec<String>>, allowed_destination_node_prefixes: Option<Vec<String>>, min_prediction: Option<f32>, max_prediction: Option<f32>, bins: Option<usize>, separator: Option<char>, remove_chevrons: Option<bool>, remove_spaces: Option<bool>, support_balanced_quotes: Option<bool>, comment_symbol: Option<String>, max_rows_number: Option<usize>)-> PyResult<(Py<PyArray1<usize>>, Py<PyArray1<usize>>)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_predictions_histograms(path.into(), source_column_name, destination_column_name, prediction_column_name, allowed_source_nodes, allowed_destination_nodes, allowed_source_node_prefixes, allowed_destination_node_prefixes, min_prediction, max_prediction, bins, separator, remove_chevrons, remove_spaces, support_balanced_quotes, comment_symbol, max_rows_number))?.into();
({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_0, usize)}, {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_1, usize)})})
    ...
    ///     Maximum number of rows to read.
    /// 
            pub fn get_filtered_predictions(&self, path: String, source_column_name: Option<String>, destination_column_name: Option<String>, prediction_column_name: Option<String>, allowed_source_nodes: Option<Vec<String>>, allowed_destination_nodes: Option<Vec<String>>, allowed_source_node_prefixes: Option<Vec<String>>, allowed_destination_node_prefixes: Option<Vec<String>>, min_prediction: Option<f32>, max_prediction: Option<f32>, exclude_existing_edges: Option<bool>, exclude_non_existing_edges: Option<bool>, separator: Option<char>, remove_chevrons: Option<bool>, remove_spaces: Option<bool>, support_balanced_quotes: Option<bool>, comment_symbol: Option<String>, max_rows_number: Option<usize>)-> PyResult<Vec<(String, String, f32)>>{
            Ok(pe!(self.inner.get_filtered_predictions(path.into(), source_column_name, destination_column_name, prediction_column_name, allowed_source_nodes, allowed_destination_nodes, allowed_source_node_prefixes, allowed_destination_node_prefixes, min_prediction, max_prediction, exclude_existing_edges, exclude_non_existing_edges, separator, remove_chevrons, remove_spaces, support_balanced_quotes, comment_symbol, max_rows_number))?.into_iter().map(|x| {let (subresult_0, subresult_1, subresult_2) = x;
(subresult_0.into(), subresult_1.into(), subresult_2.into())}).collect::<Vec<_>>())
            }
            ...
            #[automatically_generated_binding]
            #[pyo3(text_signature = "($self, node_names, node_types, edge_types, minimum_component_size, top_k_components)")]
    ...
    /// 
            pub fn remove_components(&self, node_names: Option<Vec<String>>, node_types: Option<Vec<Option<&str>>>, edge_types: Option<Vec<Option<&str>>>, minimum_component_size: Option<NodeT>, top_k_components: Option<NodeT>)-> PyResult<Graph>{
            Ok(pe!(self.inner.remove_components(node_names, node_types.as_ref().map(|x| x.as_slice()), edge_types.as_ref().map(|x| x.as_slice()), minimum_component_size, top_k_components))?.into())
            }
    ...
    /// 
            pub fn get_bipartite_edges(&self, removed_existing_edges: Option<bool>, first_nodes_set: Option<HashSet<String>>, second_nodes_set: Option<HashSet<String>>, first_node_types_set: Option<HashSet<String>>, second_node_types_set: Option<HashSet<String>>)-> PyResult<Py<PyArray2<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_bipartite_edges(removed_existing_edges, first_nodes_set, second_nodes_set, first_node_types_set, second_node_types_set))?, NodeT)})
            }
    ...
    ///     Optional set of node types to create the second set of nodes of the graph.
    /// 
            pub fn get_bipartite_edge_names(&self, removed_existing_edges: Option<bool>, first_nodes_set: Option<HashSet<String>>, second_nodes_set: Option<HashSet<String>>, first_node_types_set: Option<HashSet<String>>, second_node_types_set: Option<HashSet<String>>)-> PyResult<Vec<Vec<String>>>{
            Ok(pe!(self.inner.get_bipartite_edge_names(removed_existing_edges, first_nodes_set, second_nodes_set, first_node_types_set, second_node_types_set))?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_star_edges(&self, central_node: String, removed_existing_edges: Option<bool>, star_points_nodes_set: Option<HashSet<String>>, star_points_node_types_set: Option<HashSet<String>>)-> PyResult<Py<PyArray2<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_star_edges(central_node.into(), removed_existing_edges, star_points_nodes_set, star_points_node_types_set))?, NodeT)})
            }
    ...
    ///     Optional set of node types to create the set of star points.
    /// 
            pub fn get_star_edge_names(&self, central_node: String, removed_existing_edges: Option<bool>, star_points_nodes_set: Option<HashSet<String>>, star_points_node_types_set: Option<HashSet<String>>)-> PyResult<Vec<Vec<String>>>{
            Ok(pe!(self.inner.get_star_edge_names(central_node.into(), removed_existing_edges, star_points_nodes_set, star_points_node_types_set))?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_clique_edges(&self, directed: Option<bool>, allow_selfloops: Option<bool>, removed_existing_edges: Option<bool>, allow_node_type_set: Option<HashSet<String>>, allow_node_set: Option<HashSet<String>>)-> Py<PyArray2<NodeT>>{
            let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, self.inner.get_clique_edges(directed, allow_selfloops, removed_existing_edges, allow_node_type_set, allow_node_set), NodeT)
            }
    ...
    ///     Nodes to include i the clique.
    /// 
            pub fn get_clique_edge_names(&self, directed: Option<bool>, allow_selfloops: Option<bool>, removed_existing_edges: Option<bool>, allow_node_type_set: Option<HashSet<String>>, allow_node_set: Option<HashSet<String>>)-> Vec<Vec<String>>{
            self.inner.get_clique_edge_names(directed, allow_selfloops, removed_existing_edges, allow_node_type_set, allow_node_set).into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>()
            }
...
to_ndarray_1d!(gil, pe!(self.inner.validate_edge_ids(edge_ids))?, EdgeT)})
    ...
    /// 
            pub fn validate_node_type_id(&self, node_type_id: Option<NodeTypeT>)-> PyResult<Option<NodeTypeT>>{
    ...
    /// 
            pub fn validate_node_type_ids(&self, node_type_ids: Vec<Option<NodeTypeT>>)-> PyResult<Vec<Option<NodeTypeT>>>{
            Ok(pe!(self.inner.validate_node_type_ids(&node_type_ids))?.into_iter().map(|x| x.map(|x| x.into())).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn validate_edge_type_id(&self, edge_type_id: Option<EdgeTypeT>)-> PyResult<Option<EdgeTypeT>>{
    ...
    /// 
            pub fn validate_edge_type_ids(&self, edge_type_ids: Vec<Option<EdgeTypeT>>)-> PyResult<Vec<Option<EdgeTypeT>>>{
            Ok(pe!(self.inner.validate_edge_type_ids(edge_type_ids))?.into_iter().map(|x| x.map(|x| x.into())).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn generate_new_edges_from_node_features(&self, features: Vec<Vec<f64>>, neighbours_number: Option<NodeT>, max_degree: Option<NodeT>, distance_name: Option<&str>, verbose: Option<bool>)-> PyResult<Graph>{
            Ok(pe!(self.inner.generate_new_edges_from_node_features(features, neighbours_number, max_degree, distance_name, verbose))?.into())
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.set_inplace_all_edge_types(edge_type))?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.set_inplace_all_node_types(node_type))?;()})
            }
    ...
    ///     If the given node type ID does not exists in the graph.
    /// 
            pub fn remove_inplace_node_type_ids(& mut self, node_type_ids_to_remove: Vec<NodeTypeT>)-> PyResult<()>{
            Ok({pe!(self.inner.remove_inplace_node_type_ids(node_type_ids_to_remove))?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_singleton_node_types())?;()})
            }
    ...
    /// 
            pub fn add_node_type_id_from_node_name_prefixes_inplace(& mut self, node_type_id: NodeTypeT, node_name_prefixes: Vec<String>)-> PyResult<()>{
            Ok({pe!(self.inner.add_node_type_id_from_node_name_prefixes_inplace(node_type_id.clone(), node_name_prefixes))?;()})
            }
    ...
    ///     If the given list of node name prefixes is empty.
    /// 
            pub fn replace_edge_type_id_from_edge_node_type_ids_inplace(& mut self, edge_type_id: EdgeTypeT, source_node_type_ids: Vec<Option<NodeTypeT>>, destination_node_type_ids: Vec<Option<NodeTypeT>>)-> PyResult<()>{
            Ok({pe!(self.inner.replace_edge_type_id_from_edge_node_type_ids_inplace(edge_type_id.clone(), &source_node_type_ids, &destination_node_type_ids))?;()})
            }
    ...
    ///     If the given list of node name prefixes is empty.
    /// 
            pub fn replace_edge_type_id_from_edge_node_type_ids(& mut self, edge_type_id: EdgeTypeT, source_node_type_ids: Vec<Option<NodeTypeT>>, destination_node_type_ids: Vec<Option<NodeTypeT>>)-> PyResult<()>{
            Ok({pe!(self.inner.replace_edge_type_id_from_edge_node_type_ids(edge_type_id.clone(), &source_node_type_ids, &destination_node_type_ids))?;()})
            }
    ...
    ///     If the given list of node name prefixes is empty.
    /// 
            pub fn add_node_type_id_from_node_name_prefixes(&self, node_type_id: NodeTypeT, node_name_prefixes: Vec<String>)-> PyResult<Graph>{
            Ok(pe!(self.inner.add_node_type_id_from_node_name_prefixes(node_type_id.clone(), node_name_prefixes))?.into())
            }
    ...
    ///     If the given list of node name prefixes is empty.
    /// 
            pub fn add_node_type_name_from_node_name_prefixes_inplace(& mut self, node_type_name: String, node_name_prefixes: Vec<String>)-> PyResult<()>{
            Ok({pe!(self.inner.add_node_type_name_from_node_name_prefixes_inplace(node_type_name.into(), node_name_prefixes))?;()})
            }
    ...
    ///     If the given list of node name prefixes is empty.
    /// 
            pub fn replace_edge_type_name_from_edge_node_type_names_inplace(& mut self, edge_type_name: String, source_node_type_names: Vec<Option<&str>>, destination_node_type_names: Vec<Option<&str>>)-> PyResult<()>{
            Ok({pe!(self.inner.replace_edge_type_name_from_edge_node_type_names_inplace(edge_type_name.into(), &source_node_type_names, &destination_node_type_names))?;()})
            }
    ...
    ///     If the given list of node name prefixes is empty.
    /// 
            pub fn replace_edge_type_name_from_edge_node_type_names(& mut self, edge_type_name: String, source_node_type_names: Vec<Option<&str>>, destination_node_type_names: Vec<Option<&str>>)-> PyResult<()>{
            Ok({pe!(self.inner.replace_edge_type_name_from_edge_node_type_names(edge_type_name.into(), &source_node_type_names, &destination_node_type_names))?;()})
            }
    ...
    ///     If the given list of node name prefixes is empty.
    /// 
            pub fn add_node_type_name_from_node_name_prefixes(&self, node_type_name: String, node_name_prefixes: Vec<String>)-> PyResult<Graph>{
            Ok(pe!(self.inner.add_node_type_name_from_node_name_prefixes(node_type_name.into(), node_name_prefixes))?.into())
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_homogeneous_node_types())?;()})
            }
    ...
    ///     If the given edge type ID does not exists in the graph.
    /// 
            pub fn remove_inplace_edge_type_ids(& mut self, edge_type_ids_to_remove: Vec<EdgeTypeT>)-> PyResult<()>{
            Ok({pe!(self.inner.remove_inplace_edge_type_ids(edge_type_ids_to_remove))?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_singleton_edge_types())?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_node_type_names(node_type_names))?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_node_type_name(node_type_name))?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_isomorphic_node_types())?;()})
            }
    ...
    ///     If the graph does not have edge types.
    /// 
            pub fn remove_inplace_isomorphic_edge_types(& mut self, minimum_number_of_edges: Option<EdgeT>)-> PyResult<()>{
            Ok({pe!(self.inner.remove_inplace_isomorphic_edge_types(minimum_number_of_edges))?;()})
            }
    ...
    ///     If the graph does not have edge types.
    /// 
            pub fn remove_isomorphic_edge_types(&self, minimum_number_of_edges: Option<EdgeT>)-> PyResult<Graph>{
            Ok(pe!(self.inner.remove_isomorphic_edge_types(minimum_number_of_edges))?.into())
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_edge_type_name(edge_type_name))?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_node_types())?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_edge_types())?;()})
            }
    ...
    /// 
            ...
            Ok({pe!(self.inner.remove_inplace_edge_weights())?;()})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.divide_edge_weights_inplace(denominator.clone()))?)
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.multiply_edge_weights_inplace(denominator.clone()))?)
            }
    ...
    /// 
            pub fn build_bipartite_graph_from_edge_node_ids(&self, source_node_ids: Vec<NodeT>, destination_node_ids: Vec<NodeT>, directed: bool)-> PyResult<Graph>{
            Ok(pe!(self.inner.build_bipartite_graph_from_edge_node_ids(source_node_ids, destination_node_ids, directed.clone()))?.into())
            }
    ...
    ///     Whether to make the graph directed or undirected.
    /// 
            pub fn build_clique_graph_from_node_ids(&self, node_ids: Vec<NodeT>, directed: bool)-> PyResult<Graph>{
            Ok(pe!(self.inner.build_clique_graph_from_node_ids(node_ids, directed.clone()))?.into())
            }
    ...
    ///     Whether to make the graph directed or undirected.
    /// 
            pub fn build_bipartite_graph_from_edge_node_names(&self, source_node_names: Vec<&str>, destination_node_names: Vec<&str>, directed: bool)-> PyResult<Graph>{
            Ok(pe!(self.inner.build_bipartite_graph_from_edge_node_names(source_node_names, destination_node_names, directed.clone()))?.into())
            }
    ...
    ///     Whether to make the graph directed or undirected.
    /// 
            pub fn build_clique_graph_from_node_names(&self, node_names: Vec<&str>, directed: bool)-> PyResult<Graph>{
            Ok(pe!(self.inner.build_clique_graph_from_node_names(node_names, directed.clone()))?.into())
            }
    ...
    ///     Whether to make the graph directed or undirected.
    /// 
            pub fn build_bipartite_graph_from_edge_node_prefixes(&self, source_node_prefixes: Vec<&str>, destination_node_prefixes: Vec<&str>, directed: bool)-> PyResult<Graph>{
            Ok(pe!(self.inner.build_bipartite_graph_from_edge_node_prefixes(&source_node_prefixes, &destination_node_prefixes, directed.clone()))?.into())
            }
    ...
    ///     Whether to make the graph directed or undirected.
    /// 
            pub fn build_clique_graph_from_node_prefixes(&self, node_prefixes: Vec<&str>, directed: bool)-> PyResult<Graph>{
            Ok(pe!(self.inner.build_clique_graph_from_node_prefixes(&node_prefixes, directed.clone()))?.into())
            }
    ...
    ///     Whether to make the graph directed or undirected.
    /// 
            pub fn build_bipartite_graph_from_edge_node_types(&self, source_node_types: Vec<Option<&str>>, destination_node_types: Vec<Option<&str>>, directed: bool)-> PyResult<Graph>{
            Ok(pe!(self.inner.build_bipartite_graph_from_edge_node_types(&source_node_types, &destination_node_types, directed.clone()))?.into())
            }
    ...
    ///     Whether to make the graph directed or undirected.
    /// 
            pub fn build_clique_graph_from_node_type_names(&self, node_type_names: Vec<Option<&str>>, directed: bool)-> PyResult<Graph>{
            Ok(pe!(self.inner.build_clique_graph_from_node_type_names(&node_type_names, directed.clone()))?.into())
            }
    ...
    /// ----------
    /// 
            pub fn get_circles(&self, minimum_number_of_nodes_per_circle: Option<NodeT>, compute_circle_nodes: Option<bool>)-> PyResult<Vec<Circle>>{
            Ok(pe!(self.inner.get_circles(minimum_number_of_nodes_per_circle, compute_circle_nodes))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// structures used to store the current graph
            ...
            self.inner.get_nodes_total_memory_requirement_human_readable().into()
            }
            ...
            self.inner.get_edges_total_memory_requirement_human_readable().into()
            }
            ...
            self.inner.get_edge_weights_total_memory_requirements().into()
            }
            ...
            self.inner.get_edge_weights_total_memory_requirements_human_readable().into()
            }
            ...
            Ok(pe!(self.inner.get_node_types_total_memory_requirements_human_readable())?.into())
            }
            ...
            Ok(pe!(self.inner.get_edge_types_total_memory_requirements_human_readable())?.into())
            }
    ...
    /// 
            pub fn get_number_of_triangles(&self, approach: Option<&str>, insert_only_source: Option<bool>, verbose: Option<bool>)-> PyResult<EdgeT>{
            Ok(pe!(self.inner.get_number_of_triangles(approach, insert_only_source, verbose))?.into())
            }
    ...
    ///     Whether to show a loading bar. By default, True.
    /// 
            pub fn get_number_of_squares(&self, approach: Option<&str>, insert_only_source: Option<bool>, verbose: Option<bool>)-> PyResult<EdgeT>{
            Ok(pe!(self.inner.get_number_of_squares(approach, insert_only_source, verbose))?.into())
            }
    ...
    ///     Whether to show a loading bar. By default, True.
    /// 
            pub fn get_number_of_squares_per_node(&self, approach: Option<&str>, insert_only_source: Option<bool>, verbose: Option<bool>)-> PyResult<Py<PyArray1<EdgeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_number_of_squares_per_node(approach, insert_only_source, verbose))?, EdgeT)})
            }
    ...
    ///     Whether to show a loading bar. By default, True.
    /// 
            pub fn get_number_of_triangles_per_node(&self, approach: Option<&str>, insert_only_source: Option<bool>, verbose: Option<bool>)-> PyResult<Py<PyArray1<EdgeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_number_of_triangles_per_node(approach, insert_only_source, verbose))?, EdgeT)})
            }
    ...
    ///     Whether to show a loading bar.
    /// 
            pub fn get_clustering_coefficient_per_node(&self, approach: Option<&str>, insert_only_source: Option<bool>, verbose: Option<bool>)-> Py<PyArray1<f64>>{
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_clustering_coefficient_per_node(approach, insert_only_source, verbose), f64)
            }
    ...
    ///     Whether to show a loading bar.
    /// 
            pub fn get_clustering_coefficient(&self, approach: Option<&str>, insert_only_source: Option<bool>, verbose: Option<bool>)-> f64{
            self.inner.get_clustering_coefficient(approach, insert_only_source, verbose).into()
            }
    ...
    ///     Whether to show a loading bar.
    /// 
            pub fn get_average_clustering_coefficient(&self, approach: Option<&str>, insert_only_source: Option<bool>, verbose: Option<bool>)-> f64{
            self.inner.get_average_clustering_coefficient(approach, insert_only_source, verbose).into()
            }
    ...
    ///     The node names to remap the graph to.
    /// 
            pub fn remap_from_node_names_map(&self, node_names_map: HashMap<String, String>)-> PyResult<Graph>{
    ...
    /// 
            pub fn sample_negative_graph(&self, number_of_negative_samples: EdgeT, random_state: Option<EdgeT>, only_from_same_component: Option<bool>, minimum_node_degree: Option<NodeT>, maximum_node_degree: Option<NodeT>, source_node_types_names: Option<Vec<String>>, destination_node_types_names: Option<Vec<String>>, source_edge_types_names: Option<Vec<String>>, destination_edge_types_names: Option<Vec<String>>, source_nodes_prefixes: Option<Vec<String>>, destination_nodes_prefixes: Option<Vec<String>>, graph_to_avoid: Option<& Graph>, support: Option<& Graph>, use_scale_free_distribution: Option<bool>, sample_edge_types: Option<bool>, sample_edge_weights: Option<bool>, enforce_node_type_connection_consistency: Option<bool>, number_of_sampling_attempts: Option<usize>)-> PyResult<Graph>{
            Ok(pe!(self.inner.sample_negative_graph(number_of_negative_samples.clone(), random_state, only_from_same_component, minimum_node_degree, maximum_node_degree, source_node_types_names, destination_node_types_names, source_edge_types_names, destination_edge_types_names, source_nodes_prefixes, destination_nodes_prefixes, graph_to_avoid.map(|sg| &sg.inner), support.map(|sg| &sg.inner), use_scale_free_distribution, sample_edge_types, sample_edge_weights, enforce_node_type_connection_consistency, number_of_sampling_attempts))?.into())
            }
            ...
            #[automatically_generated_binding]
            #[pyo3(text_signature = "($self, number_of_samples, random_state, minimum_node_degree, maximum_node_degree, source_node_types_names, destination_node_types_names, source_edge_types_names, destination_edge_types_names, source_nodes_prefixes, destination_nodes_prefixes, edge_type_names, support, number_of_sampling_attempts)")]
    ...
    ///     Number of times to attempt to sample edges before giving up.
    /// 
            pub fn sample_positive_graph(&self, number_of_samples: usize, random_state: Option<EdgeT>, minimum_node_degree: Option<NodeT>, maximum_node_degree: Option<NodeT>, source_node_types_names: Option<Vec<String>>, destination_node_types_names: Option<Vec<String>>, source_edge_types_names: Option<Vec<String>>, destination_edge_types_names: Option<Vec<String>>, source_nodes_prefixes: Option<Vec<String>>, destination_nodes_prefixes: Option<Vec<String>>, edge_type_names: Option<Vec<Option<&str>>>, support: Option<& Graph>, number_of_sampling_attempts: Option<usize>)-> PyResult<Graph>{
            Ok(pe!(self.inner.sample_positive_graph(number_of_samples.clone(), random_state, minimum_node_degree, maximum_node_degree, source_node_types_names, destination_node_types_names, source_edge_types_names, destination_edge_types_names, source_nodes_prefixes, destination_nodes_prefixes, edge_type_names.as_ref().map(|x| x.as_slice()), support.map(|sg| &sg.inner), number_of_sampling_attempts))?.into())
            }
    ...
    /// 
            pub fn connected_holdout(&self, train_size: f64, random_state: Option<EdgeT>, edge_types: Option<Vec<Option<&str>>>, include_all_edge_types: Option<bool>, minimum_node_degree: Option<NodeT>, maximum_node_degree: Option<NodeT>, verbose: Option<bool>)-> PyResult<(Graph, Graph)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.connected_holdout(train_size.clone(), random_state, edge_types.as_ref().map(|x| x.as_slice()), include_all_edge_types, minimum_node_degree, maximum_node_degree, verbose))?.into();
(subresult_0.into(), subresult_1.into())})
    ...
    /// 
            pub fn random_holdout(&self, train_size: f64, random_state: Option<EdgeT>, include_all_edge_types: Option<bool>, edge_types: Option<Vec<Option<&str>>>, min_number_overlaps: Option<EdgeT>, verbose: Option<bool>)-> PyResult<(Graph, Graph)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.random_holdout(train_size.clone(), random_state, include_all_edge_types, edge_types.as_ref().map(|x| x.as_slice()), min_number_overlaps, verbose))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            pub fn get_node_label_holdout_indices(&self, train_size: f64, use_stratification: Option<bool>, random_state: Option<EdgeT>)-> PyResult<(Py<PyArray1<NodeT>>, Py<PyArray1<NodeT>>)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_node_label_holdout_indices(train_size.clone(), use_stratification, random_state))?.into();
({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_0, NodeT)}, {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_1, NodeT)})})
    ...
    ///     If stratification is requested but the graph has a multilabel node types.
    /// 
            pub fn get_node_label_holdout_labels(&self, train_size: f64, use_stratification: Option<bool>, random_state: Option<EdgeT>)-> PyResult<(Vec<Option<Py<PyArray1<NodeTypeT>>>>, Vec<Option<Py<PyArray1<NodeTypeT>>>>)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_node_label_holdout_labels(train_size.clone(), use_stratification, random_state))?.into();
(subresult_0.into_iter().map(|x| x.map(|x| {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, x, NodeTypeT)})).collect::<Vec<_>>(), subresult_1.into_iter().map(|x| x.map(|x| {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, x, NodeTypeT)})).collect::<Vec<_>>())})
            }
    ...
    ///     If stratification is requested but the graph has a multilabel node types.
    /// 
            pub fn get_node_label_holdout_graphs(&self, train_size: f64, use_stratification: Option<bool>, random_state: Option<EdgeT>)-> PyResult<(Graph, Graph)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_node_label_holdout_graphs(train_size.clone(), use_stratification, random_state))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            pub fn get_edge_label_holdout_graphs(&self, train_size: f64, use_stratification: Option<bool>, random_state: Option<EdgeT>)-> PyResult<(Graph, Graph)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_edge_label_holdout_graphs(train_size.clone(), use_stratification, random_state))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            pub fn get_random_subgraph(&self, number_of_nodes: NodeT, random_state: Option<usize>, verbose: Option<bool>)-> PyResult<Graph>{
            Ok(pe!(self.inner.get_random_subgraph(number_of_nodes.clone(), random_state, verbose))?.into())
            }
    ...
    ///     If stratification is requested but the graph has a multilabel node types.
    /// 
            pub fn get_node_label_random_holdout(&self, train_size: f64, use_stratification: Option<bool>, random_state: Option<EdgeT>)-> PyResult<(Graph, Graph)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_node_label_random_holdout(train_size.clone(), use_stratification, random_state))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    ///     If stratification is requested but the graph has a multilabel node types.
    /// 
            pub fn get_node_label_kfold(&self, k: usize, k_index: usize, use_stratification: Option<bool>, random_state: Option<EdgeT>)-> PyResult<(Graph, Graph)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_node_label_kfold(k.clone(), k_index.clone(), use_stratification, random_state))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    ///     If stratification is required but the graph has singleton edge types.
    /// 
            pub fn get_edge_label_kfold(&self, k: usize, k_index: usize, use_stratification: Option<bool>, random_state: Option<EdgeT>)-> PyResult<(Graph, Graph)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_edge_label_kfold(k.clone(), k_index.clone(), use_stratification, random_state))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            pub fn get_edge_prediction_kfold(&self, k: usize, k_index: usize, edge_types: Option<Vec<Option<&str>>>, random_state: Option<EdgeT>, verbose: Option<bool>)-> PyResult<(Graph, Graph)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_edge_prediction_kfold(k.clone(), k_index.clone(), edge_types.as_ref().map(|x| x.as_slice()), random_state, verbose))?.into();
(subresult_0.into(), subresult_1.into())})
            }
            ...
            Ok(pe!(self.inner.get_node_tuples())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// ----------
    /// 
            pub fn get_chains(&self, minimum_number_of_nodes_per_chain: Option<NodeT>, compute_chain_nodes: Option<bool>)-> PyResult<Vec<Chain>>{
            Ok(pe!(self.inner.get_chains(minimum_number_of_nodes_per_chain, compute_chain_nodes))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// If any of the given node ID does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_breadth_first_search_predecessors_parallel_from_node_id(&self, src_node_id: NodeT)-> ShortestPathsResultBFS{
            self.inner.get_unchecked_breadth_first_search_predecessors_parallel_from_node_id(src_node_id.clone()).into()
            }
    ...
    ///  The provided list of node ids must be non-empty, or the method will panic.
            pub unsafe fn get_unchecked_breadth_first_search_distances_parallel_from_node_ids(&self, src_node_ids: Vec<NodeT>, maximal_depth: Option<NodeT>)-> ShortestPathsResultBFS{
            self.inner.get_unchecked_breadth_first_search_distances_parallel_from_node_ids(src_node_ids, maximal_depth).into()
            }
    ...
    /// ------
    /// If any of the given node ID does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_breadth_first_search_distances_parallel_from_node_id(&self, src_node_id: NodeT, maximal_depth: Option<NodeT>)-> ShortestPathsResultBFS{
            self.inner.get_unchecked_breadth_first_search_distances_parallel_from_node_id(src_node_id.clone(), maximal_depth).into()
            }
    ...
    ///  TODO! Explore chains accelerations!
            pub unsafe fn get_unchecked_breadth_first_search_distances_sequential_from_node_id(&self, src_node_id: NodeT)-> ShortestPathsResultBFS{
            self.inner.get_unchecked_breadth_first_search_distances_sequential_from_node_id(src_node_id.clone()).into()
            }
    ...
    /// ------
    /// If any of the given node IDs does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_breadth_first_search_from_node_ids(&self, src_node_ids: Vec<NodeT>, dst_node_id: Option<NodeT>, compute_predecessors: Option<bool>, maximal_depth: Option<NodeT>)-> ShortestPathsResultBFS{
            self.inner.get_unchecked_breadth_first_search_from_node_ids(src_node_ids, dst_node_id, compute_predecessors, maximal_depth).into()
            }
    ...
    /// ------
    /// If any of the given node IDs does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_breadth_first_search_from_node_id(&self, src_node_id: NodeT, dst_node_id: Option<NodeT>, compute_predecessors: Option<bool>, maximal_depth: Option<NodeT>)-> ShortestPathsResultBFS{
            self.inner.get_unchecked_breadth_first_search_from_node_id(src_node_id.clone(), dst_node_id, compute_predecessors, maximal_depth).into()
            }
    ...
    /// 
            pub unsafe fn get_unchecked_shortest_path_node_ids_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, maximal_depth: Option<NodeT>)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_unchecked_shortest_path_node_ids_from_node_ids(src_node_id.clone(), dst_node_id.clone(), maximal_depth))?, NodeT)})
            }
    ...
    /// ------
    /// If any of the given node IDs does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_shortest_path_node_names_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, maximal_depth: Option<NodeT>)-> PyResult<Vec<String>>{
            Ok(pe!(self.inner.get_unchecked_shortest_path_node_names_from_node_ids(src_node_id.clone(), dst_node_id.clone(), maximal_depth))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_shortest_path_node_ids_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, maximal_depth: Option<NodeT>)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_shortest_path_node_ids_from_node_ids(src_node_id.clone(), dst_node_id.clone(), maximal_depth))?, NodeT)})
            }
    ...
    /// 
            pub fn get_shortest_path_node_ids_from_node_names(&self, src_node_name: &str, dst_node_name: &str, maximal_depth: Option<NodeT>)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_shortest_path_node_ids_from_node_names(src_node_name, dst_node_name, maximal_depth))?, NodeT)})
            }
    ...
    ///     If any of the given node names do not exist in the current graph.
    /// 
            pub fn get_shortest_path_node_names_from_node_names(&self, src_node_name: &str, dst_node_name: &str, maximal_depth: Option<NodeT>)-> PyResult<Vec<String>>{
            Ok(pe!(self.inner.get_shortest_path_node_names_from_node_names(src_node_name, dst_node_name, maximal_depth))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// ------
    /// If any of the given node IDs does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_k_shortest_path_node_ids_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, k: usize)-> Vec<Vec<NodeT>>{
            self.inner.get_unchecked_k_shortest_path_node_ids_from_node_ids(src_node_id.clone(), dst_node_id.clone(), k.clone()).into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>()
            }
    ...
    /// 
            pub fn get_k_shortest_path_node_ids_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, k: usize)-> PyResult<Vec<Vec<NodeT>>>{
            Ok(pe!(self.inner.get_k_shortest_path_node_ids_from_node_ids(src_node_id.clone(), dst_node_id.clone(), k.clone()))?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_k_shortest_path_node_ids_from_node_names(&self, src_node_name: &str, dst_node_name: &str, k: usize)-> PyResult<Vec<Vec<NodeT>>>{
            Ok(pe!(self.inner.get_k_shortest_path_node_ids_from_node_names(src_node_name, dst_node_name, k.clone()))?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
    ...
    ///     If any of the given node names does not exist in the graph.
    /// 
            pub fn get_k_shortest_path_node_names_from_node_names(&self, src_node_name: &str, dst_node_name: &str, k: usize)-> PyResult<Vec<Vec<String>>>{
            Ok(pe!(self.inner.get_k_shortest_path_node_names_from_node_names(src_node_name, dst_node_name, k.clone()))?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
    ...
    /// ------
    /// If any of the given node IDs does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_eccentricity_and_most_distant_node_id_from_node_id(&self, node_id: NodeT)-> (NodeT, NodeT){
            let (subresult_0, subresult_1) = self.inner.get_unchecked_eccentricity_and_most_distant_node_id_from_node_id(node_id.clone());
(subresult_0.into(), subresult_1.into())
            }
    ...
    /// ------
    /// If any of the given node IDs does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_weighted_eccentricity_from_node_id(&self, node_id: NodeT, use_edge_weights_as_probabilities: Option<bool>)-> f32{
            self.inner.get_unchecked_weighted_eccentricity_from_node_id(node_id.clone(), use_edge_weights_as_probabilities).into()
            }
    ...
    /// 
            pub fn get_eccentricity_and_most_distant_node_id_from_node_id(&self, node_id: NodeT)-> PyResult<(NodeT, NodeT)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_eccentricity_and_most_distant_node_id_from_node_id(node_id.clone()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            pub fn get_weighted_eccentricity_from_node_id(&self, node_id: NodeT, use_edge_weights_as_probabilities: Option<bool>)-> PyResult<f32>{
            Ok(pe!(self.inner.get_weighted_eccentricity_from_node_id(node_id.clone(), use_edge_weights_as_probabilities))?.into())
            }
    ...
    ///     If the graph contains negative weights.
    /// 
            pub fn get_weighted_eccentricity_from_node_name(&self, node_name: &str, use_edge_weights_as_probabilities: Option<bool>)-> PyResult<f32>{
            Ok(pe!(self.inner.get_weighted_eccentricity_from_node_name(node_name, use_edge_weights_as_probabilities))?.into())
            }
    ...
    /// ------
    /// If any of the given node IDs does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_dijkstra_from_node_ids(&self, src_node_ids: Vec<NodeT>, maybe_dst_node_id: Option<NodeT>, maybe_dst_node_ids: Option<Vec<NodeT>>, compute_predecessors: Option<bool>, maximal_depth: Option<NodeT>, use_edge_weights_as_probabilities: Option<bool>)-> ShortestPathsDjkstra{
            self.inner.get_unchecked_dijkstra_from_node_ids(src_node_ids, maybe_dst_node_id, maybe_dst_node_ids, compute_predecessors, maximal_depth, use_edge_weights_as_probabilities).into()
            }
    ...
    /// ------
    /// If any of the given node IDs does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_dijkstra_from_node_id(&self, src_node_id: NodeT, maybe_dst_node_id: Option<NodeT>, maybe_dst_node_ids: Option<Vec<NodeT>>, compute_predecessors: Option<bool>, maximal_depth: Option<NodeT>, use_edge_weights_as_probabilities: Option<bool>)-> ShortestPathsDjkstra{
            self.inner.get_unchecked_dijkstra_from_node_id(src_node_id.clone(), maybe_dst_node_id, maybe_dst_node_ids, compute_predecessors, maximal_depth, use_edge_weights_as_probabilities).into()
            }
    ...
    /// ------
    /// If any of the given node IDs does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_weighted_shortest_path_node_ids_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, use_edge_weights_as_probabilities: Option<bool>, maximal_depth: Option<NodeT>)-> (f32, Py<PyArray1<NodeT>>){
            let (subresult_0, subresult_1) = self.inner.get_unchecked_weighted_shortest_path_node_ids_from_node_ids(src_node_id.clone(), dst_node_id.clone(), use_edge_weights_as_probabilities, maximal_depth);
(subresult_0.into(), {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_1, NodeT)})
            }
    ...
    /// ------
    /// If any of the given node IDs does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_weighted_shortest_path_node_names_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, use_edge_weights_as_probabilities: Option<bool>, maximal_depth: Option<NodeT>)-> (f32, Vec<String>){
            let (subresult_0, subresult_1) = self.inner.get_unchecked_weighted_shortest_path_node_names_from_node_ids(src_node_id.clone(), dst_node_id.clone(), use_edge_weights_as_probabilities, maximal_depth);
(subresult_0.into(), subresult_1.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    ///     If any of the given node IDs do not exist in the current graph.
    /// 
            pub fn get_weighted_shortest_path_node_ids_from_node_ids(&self, src_node_id: NodeT, dst_node_id: NodeT, use_edge_weights_as_probabilities: Option<bool>, maximal_depth: Option<NodeT>)-> PyResult<(f32, Py<PyArray1<NodeT>>)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_weighted_shortest_path_node_ids_from_node_ids(src_node_id.clone(), dst_node_id.clone(), use_edge_weights_as_probabilities, maximal_depth))?.into();
(subresult_0.into(), {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_1, NodeT)})})
            }
    ...
    ///     If any of the given node names do not exist in the current graph.
    /// 
            pub fn get_weighted_shortest_path_node_ids_from_node_names(&self, src_node_name: &str, dst_node_name: &str, use_edge_weights_as_probabilities: Option<bool>, maximal_depth: Option<NodeT>)-> PyResult<(f32, Py<PyArray1<NodeT>>)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_weighted_shortest_path_node_ids_from_node_names(src_node_name, dst_node_name, use_edge_weights_as_probabilities, maximal_depth))?.into();
(subresult_0.into(), {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_1, NodeT)})})
            }
    ...
    ///     If any of the given node names do not exist in the current graph.
    /// 
            pub fn get_weighted_shortest_path_node_names_from_node_names(&self, src_node_name: &str, dst_node_name: &str, use_edge_weights_as_probabilities: Option<bool>, maximal_depth: Option<NodeT>)-> PyResult<(f32, Vec<String>)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_weighted_shortest_path_node_names_from_node_names(src_node_name, dst_node_name, use_edge_weights_as_probabilities, maximal_depth))?.into();
(subresult_0.into(), subresult_1.into_iter().map(|x| x.into()).collect::<Vec<_>>())})
            }
    ...
    /// 
            pub fn get_breadth_first_search_from_node_ids(&self, src_node_id: NodeT, dst_node_id: Option<NodeT>, compute_predecessors: Option<bool>, maximal_depth: Option<NodeT>)-> PyResult<ShortestPathsResultBFS>{
            Ok(pe!(self.inner.get_breadth_first_search_from_node_ids(src_node_id.clone(), dst_node_id, compute_predecessors, maximal_depth))?.into())
            }
    ...
    ///     If the graph contains negative weights.
    /// 
            pub fn get_dijkstra_from_node_ids(&self, src_node_id: NodeT, maybe_dst_node_id: Option<NodeT>, maybe_dst_node_ids: Option<Vec<NodeT>>, compute_predecessors: Option<bool>, maximal_depth: Option<NodeT>, use_edge_weights_as_probabilities: Option<bool>)-> PyResult<ShortestPathsDjkstra>{
            Ok(pe!(self.inner.get_dijkstra_from_node_ids(src_node_id.clone(), maybe_dst_node_id, maybe_dst_node_ids, compute_predecessors, maximal_depth, use_edge_weights_as_probabilities))?.into())
            }
...
(subresult_0.into(), subresult_1.into())
    ...
    /// 
            pub fn get_diameter_naive(&self, ignore_infinity: Option<bool>, verbose: Option<bool>)-> PyResult<f32>{
    ...
    ///     If the graph does not contain nodes.
    /// 
            pub fn get_diameter(&self, ignore_infinity: Option<bool>, verbose: Option<bool>)-> PyResult<f32>{
    ...
    /// 
            pub fn get_breadth_first_search_from_node_names(&self, src_node_name: &str, dst_node_name: Option<&str>, compute_predecessors: Option<bool>, maximal_depth: Option<NodeT>)-> PyResult<ShortestPathsResultBFS>{
            Ok(pe!(self.inner.get_breadth_first_search_from_node_names(src_node_name, dst_node_name, compute_predecessors, maximal_depth))?.into())
            }
    ...
    ///     If the given optional destination node name does not exist in the current graph.
    /// 
            pub fn get_dijkstra_from_node_names(&self, src_node_name: &str, maybe_dst_node_name: Option<&str>, maybe_dst_node_names: Option<Vec<&str>>, compute_predecessors: Option<bool>, maximal_depth: Option<NodeT>, use_edge_weights_as_probabilities: Option<bool>)-> PyResult<ShortestPathsDjkstra>{
            Ok(pe!(self.inner.get_dijkstra_from_node_names(src_node_name, maybe_dst_node_name, maybe_dst_node_names, compute_predecessors, maximal_depth, use_edge_weights_as_probabilities))?.into())
            }
    ...
    ///     Whether to show a loading bar.
    /// 
            pub fn get_distances_histogram_between_node_type_ids(&self, src_node_type_ids: Option<Vec<NodeTypeT>>, dst_node_type_ids: Option<Vec<NodeTypeT>>, verbose: Option<bool>)-> PyResult<Py<PyArray1<usize>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_distances_histogram_between_node_type_ids(src_node_type_ids, dst_node_type_ids, verbose))?, usize)})
            }
    ...
    ///     Whether to show a loading bar.
    /// 
            pub fn get_distances_histogram_between_node_type_names(&self, src_node_type_names: Option<Vec<&str>>, dst_node_type_names: Option<Vec<&str>>, verbose: Option<bool>)-> PyResult<Py<PyArray1<usize>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_distances_histogram_between_node_type_names(src_node_type_names, dst_node_type_names, verbose))?, usize)})
            }
    ...
    ///     Whether to show a loading bar.
    /// 
            pub fn get_distances_histogram_between_prefixes(&self, src_prefixes: Vec<String>, dst_prefixes: Vec<String>, verbose: Option<bool>)-> PyResult<Py<PyArray1<usize>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_distances_histogram_between_prefixes(src_prefixes, dst_prefixes, verbose))?, usize)})
            }
    ...
    /// 
            ...
            let (subresult_0, subresult_1, subresult_2) = self.inner.get_number_of_connected_components(verbose);
(subresult_0.into(), subresult_1.into(), subresult_2.into())
            ...
            self.inner.get_number_of_singleton_nodes_with_selfloops().into()
            }
...
to_ndarray_1d!(gil, self.inner.get_singleton_node_ids(), NodeT)
            ...
            self.inner.get_singleton_node_names().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_singleton_with_selfloops_node_ids(), NodeT)
            }
            ...
            self.inner.get_singleton_with_selfloops_node_names().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
...
to_ndarray_1d!(gil, self.inner.get_directed_source_node_ids(), NodeT)
    ...
    /// 
            ...
            self.inner.get_source_names(directed.clone()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
    ...
    /// 
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_destination_node_ids(directed.clone()), NodeT)
            }
...
to_ndarray_1d!(gil, self.inner.get_directed_destination_node_ids(), NodeT)
    ...
    /// 
            ...
            self.inner.get_destination_names(directed.clone()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
            ...
            self.inner.get_node_urls().into_iter().map(|x| x.map(|x| x.into())).collect::<Vec<_>>()
            }
            ...
            self.inner.get_node_ontologies().into_iter().map(|x| x.map(|x| x.into())).collect::<Vec<_>>()
            }
    ...
    /// 
            ...
            self.inner.get_unchecked_ontology_from_node_name(node_name).map(|x| x.into())
            }
    ...
    /// 
            ...
            self.inner.get_unchecked_ontology_from_node_id(node_id.clone()).map(|x| x.into())
            }
...
to_ndarray_1d!(gil, self.inner.get_node_ids(), NodeT)
            ...
            Ok(pe!(self.inner.get_directed_edge_type_ids())?.into_iter().map(|x| x.map(|x| x.into())).collect::<Vec<_>>())
            }
            ...
            Ok(pe!(self.inner.get_upper_triangular_edge_type_ids())?.into_iter().map(|x| x.map(|x| x.into())).collect::<Vec<_>>())
            }
            ...
            Ok(pe!(self.inner.get_lower_triangular_edge_type_ids())?.into_iter().map(|x| x.map(|x| x.into())).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_imputed_directed_edge_type_ids(&self, imputation_edge_type_id: EdgeTypeT)-> PyResult<Py<PyArray1<EdgeTypeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_imputed_directed_edge_type_ids(imputation_edge_type_id.clone()))?, EdgeTypeT)})
            }
    ...
    ///     The edge type id value to impute with.
    /// 
            pub fn get_imputed_upper_triangular_edge_type_ids(&self, imputation_edge_type_id: EdgeTypeT)-> PyResult<Py<PyArray1<EdgeTypeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_imputed_upper_triangular_edge_type_ids(imputation_edge_type_id.clone()))?, EdgeTypeT)})
            }
    ...
    ///     The edge type id value to impute with.
    /// 
            pub fn get_imputed_lower_triangular_edge_type_ids(&self, imputation_edge_type_id: EdgeTypeT)-> PyResult<Py<PyArray1<EdgeTypeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_imputed_lower_triangular_edge_type_ids(imputation_edge_type_id.clone()))?, EdgeTypeT)})
            }
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_directed_known_edge_type_ids())?, EdgeTypeT)})
            }
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_upper_triangular_known_edge_type_ids())?, EdgeTypeT)})
            }
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_lower_triangular_known_edge_type_ids())?, EdgeTypeT)})
            }
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_directed_source_nodes_with_known_edge_types())?, NodeT)})
            }
            ...
            pub fn get_directed_destination_nodes_with_known_edge_types(&self)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_directed_destination_nodes_with_known_edge_types())?, NodeT)})
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_unique_edge_type_ids())?, EdgeTypeT)})
            ...
            Ok(pe!(self.inner.get_directed_edge_type_names())?.into_iter().map(|x| x.map(|x| x.into())).collect::<Vec<_>>())
            }
            ...
            Ok(pe!(self.inner.get_upper_triangular_edge_type_names())?.into_iter().map(|x| x.map(|x| x.into())).collect::<Vec<_>>())
            }
            ...
            Ok(pe!(self.inner.get_lower_triangular_edge_type_names())?.into_iter().map(|x| x.map(|x| x.into())).collect::<Vec<_>>())
            }
            ...
            Ok(pe!(self.inner.get_unique_edge_type_names())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_weighted_node_indegrees())?, f64)})
            ...
            Ok(pe!(self.inner.get_node_type_ids())?.into_iter().cloned().map(|x| {x.map(|x| {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, x, NodeTypeT)})}).collect::<Vec<_>>())
            }
...
to_ndarray_2d!(gil, pe!(self.inner.get_one_hot_encoded_node_types())?, bool)})
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_one_hot_encoded_known_node_types())?, bool)})
            }
...
to_ndarray_2d!(gil, pe!(self.inner.get_one_hot_encoded_edge_types())?, bool)})
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_one_hot_encoded_known_edge_types())?, bool)})
            }
            ...
            Ok(pe!(self.inner.get_node_type_names())?.into_iter().map(|x| x.map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>())).collect::<Vec<_>>())
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_unique_node_type_ids())?, NodeTypeT)})
            ...
            Ok(pe!(self.inner.get_unique_node_type_names())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
...
to_ndarray_2d!(gil, pe!(self.inner.get_directed_edge_triples_ids())?, NodeT)})
    ...
    /// 
            ...
            self.inner.get_edge_node_names(directed.clone()).into_iter().map(|x| {let (subresult_0, subresult_1) = x;
(subresult_0.into(), subresult_1.into())}).collect::<Vec<_>>()
            }
            ...
            self.inner.get_directed_edge_node_names().into_iter().map(|x| {let (subresult_0, subresult_1) = x;
(subresult_0.into(), subresult_1.into())}).collect::<Vec<_>>()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_directed_edge_triples_names())?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_homogeneous_node_type_ids())?, NodeTypeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_homogeneous_node_type_names())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_singleton_node_type_ids())?, NodeTypeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_singleton_node_type_names())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_directed_edge_ids_with_unknown_edge_types())?, EdgeT)})
            }
    ...
    ///     If there are no edge types in the graph.
    /// 
            pub fn get_upper_triangular_edge_ids_with_unknown_edge_types(&self)-> PyResult<Py<PyArray1<EdgeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_upper_triangular_edge_ids_with_unknown_edge_types())?, EdgeT)})
            }
    ...
    ///     If there are no edge types in the graph.
    /// 
            pub fn get_lower_triangular_edge_ids_with_unknown_edge_types(&self)-> PyResult<Py<PyArray1<EdgeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_lower_triangular_edge_ids_with_unknown_edge_types())?, EdgeT)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_directed_edge_ids_with_known_edge_types())?, EdgeT)})
            }
    ...
    ///     If there are no edge types in the graph.
    /// 
            pub fn get_upper_triangular_edge_ids_with_known_edge_types(&self)-> PyResult<Py<PyArray1<EdgeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_upper_triangular_edge_ids_with_known_edge_types())?, EdgeT)})
            }
    ...
    ///     If there are no edge types in the graph.
    /// 
            pub fn get_lower_triangular_edge_ids_with_known_edge_types(&self)-> PyResult<Py<PyArray1<EdgeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_lower_triangular_edge_ids_with_known_edge_types())?, EdgeT)})
            }
    ...
    ///     If there are no edge types in the graph.
    /// 
            pub fn get_edge_node_ids_with_known_edge_types(&self, directed: bool)-> PyResult<Py<PyArray2<NodeT>>>{
            Ok({
    // Warning: this copies the array so it uses double the memory.
    // To avoid this you should directly generate data compatible with a numpy array
    // Which is a flat vector with row-first or column-first unrolling
    let gil = pyo3::Python::acquire_gil();
    let body = pe!(self.inner.get_edge_node_ids_with_known_edge_types(directed.clone()))?;
    let result_array = ThreadDataRaceAware {t: unsafe{PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)}};
    body.into_par_iter().enumerate()
        .for_each(|(i, (a, b))| unsafe {
            *(result_array.t.uget_mut([i, 0]))  = a;
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_node_names_with_known_edge_types(directed.clone()))?.into_iter().map(|x| {let (subresult_0, subresult_1) = x;
(subresult_0.into(), subresult_1.into())}).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_edges_with_unknown_edge_types_mask())?, bool)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_directed_edges_with_known_edge_types_mask())?, bool)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_upper_triangular_known_edge_types_mask())?, bool)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_lower_triangular_known_edge_types_mask())?, bool)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_node_ids_with_unknown_node_types())?, NodeT)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_node_ids_with_known_node_types())?, NodeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_names_with_unknown_node_types())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    ///     If there are no node types in the graph.
    /// 
            pub fn get_node_ids_from_node_type_id(&self, node_type_id: NodeTypeT)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_node_ids_from_node_type_id(node_type_id.clone()))?, NodeT)})
            }
    ...
    ///     If there are no node types in the graph.
    /// 
            pub fn get_node_ids_from_node_type_ids(&self, node_type_ids: Vec<Option<NodeTypeT>>)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_node_ids_from_node_type_ids(&node_type_ids))?, NodeT)})
            }
    ...
    ///     If there are no node types in the graph.
    /// 
            pub fn get_node_ids_from_node_type_names(&self, node_type_names: Vec<Option<&str>>)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_node_ids_from_node_type_names(&node_type_names))?, NodeT)})
            }
    ...
    ///     If there are no node types in the graph.
    /// 
            pub fn get_node_names_from_node_type_id(&self, node_type_id: NodeTypeT)-> PyResult<Vec<String>>{
            Ok(pe!(self.inner.get_node_names_from_node_type_id(node_type_id.clone()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    ///     If there are no node types in the graph.
    /// 
            pub fn get_node_ids_from_node_type_name(&self, node_type_name: &str)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_node_ids_from_node_type_name(node_type_name))?, NodeT)})
            }
    ...
    ///     If there are no node types in the graph.
    /// 
            pub fn get_node_names_from_node_type_name(&self, node_type_name: &str)-> PyResult<Vec<String>>{
            Ok(pe!(self.inner.get_node_names_from_node_type_name(node_type_name))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_names_with_known_node_types())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_nodes_with_unknown_node_types_mask())?, bool)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_nodes_with_known_node_types_mask())?, bool)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_singleton_edge_type_ids())?, EdgeTypeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_singleton_edge_type_names())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_node_connected_component_ids(verbose), NodeT)
            }
...
to_ndarray_1d!(gil, self.inner.get_not_singletons_node_ids(), NodeT)
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_cumulative_node_degrees().to_vec(), EdgeT)
            }
...
to_ndarray_1d!(gil, self.inner.get_reciprocal_sqrt_degrees(), WeightT)
    ...
    /// 
            pub fn get_single_label_node_type_ids(&self, unknown_node_types_value: Option<NodeTypeT>)-> PyResult<Py<PyArray1<NodeTypeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_single_label_node_type_ids(unknown_node_types_value))?, NodeTypeT)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_known_single_label_node_type_ids())?, NodeTypeT)})
            }
            ...
            pub fn get_boolean_node_type_ids(&self, target_value: Option<NodeTypeT>, unknown_node_types_value: Option<NodeTypeT>)-> PyResult<Py<PyArray1<bool>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_boolean_node_type_ids(target_value, unknown_node_types_value))?, bool)})
            }
            ...
            pub fn get_known_boolean_node_type_ids(&self, target_value: NodeTypeT)-> PyResult<Py<PyArray1<bool>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_known_boolean_node_type_ids(target_value.clone()))?, bool)})
            }
...
to_ndarray_1d!(gil, self.inner.get_root_node_ids(), NodeT)
            ...
            self.inner.get_root_node_names().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
    ...
    /// 
            pub fn to_structural_similarity_multi_graph(&self, maximal_hop_distance: Option<usize>, change_layer_probability: Option<f32>, random_walk_length: Option<u64>, iterations: Option<NodeT>)-> PyResult<Graph>{
            Ok(pe!(self.inner.to_structural_similarity_multi_graph(maximal_hop_distance, change_layer_probability, random_walk_length, iterations))?.into())
            }
    ...
    /// 
            pub fn get_approximated_cliques(&self, minimum_degree: Option<NodeT>, minimum_clique_size: Option<NodeT>, clique_per_node: Option<usize>, verbose: Option<bool>)-> PyResult<Vec<Clique>>{
            Ok(pe!(self.inner.get_approximated_cliques(minimum_degree, minimum_clique_size, clique_per_node, verbose))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    ///     If the current graph is directed.
    /// 
            pub fn get_approximated_number_of_cliques(&self, minimum_degree: Option<NodeT>, minimum_clique_size: Option<NodeT>, clique_per_node: Option<usize>, verbose: Option<bool>)-> PyResult<usize>{
            Ok(pe!(self.inner.get_approximated_number_of_cliques(minimum_degree, minimum_clique_size, clique_per_node, verbose))?.into())
            }
    ...
    /// ----------
    /// 
            pub fn get_isomorphic_nodes_mask(&self, minimum_node_degree: NodeT, number_of_neighbours_for_hash: usize)-> PyResult<Py<PyArray1<bool>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_isomorphic_nodes_mask(minimum_node_degree.clone(), number_of_neighbours_for_hash.clone()))?, bool)})
            }
    ...
    /// 
            pub fn get_isomorphic_node_ids(&self, minimum_node_degree: Option<NodeT>, number_of_neighbours_for_hash: Option<usize>, dtype: Option<&str>)-> PyResult<Vec<Vec<NodeT>>>{
            Ok(pe!(self.inner.get_isomorphic_node_ids(minimum_node_degree, number_of_neighbours_for_hash, dtype))?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_flat_repeated_isomorphic_node_ids(&self, minimum_node_degree: Option<NodeT>, number_of_neighbours_for_hash: Option<usize>)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_flat_repeated_isomorphic_node_ids(minimum_node_degree, number_of_neighbours_for_hash))?, NodeT)})
            }
    ...
    /// ----------
    /// 
            pub fn get_isomorphic_node_hashes(&self, minimum_node_degree: Option<NodeT>, number_of_neighbours_for_hash: Option<usize>, dtype: Option<&str>)-> PyResult<Py<PyArray1<u64>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_isomorphic_node_hashes(minimum_node_degree, number_of_neighbours_for_hash, dtype))?, u64)})
            }
    ...
    ///     The data type of the hash. By default, `&str`.
    /// 
            pub fn get_isomorphic_node_names(&self, minimum_node_degree: Option<NodeT>, number_of_neighbours_for_hash: Option<usize>, dtype: Option<&str>)-> PyResult<Vec<Vec<String>>>{
            Ok(pe!(self.inner.get_isomorphic_node_names(minimum_node_degree, number_of_neighbours_for_hash, dtype))?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
            ...
            #[automatically_generated_binding]
            #[pyo3(text_signature = "($self, minimum_node_degree, number_of_neighbours_for_hash, ignore_edges_including_isomorphic_nodes, dtype)")]
    ...
    ///     The data type of the hash. By default, `&str`.
    /// 
            pub fn get_isomorphic_edge_node_ids(&self, minimum_node_degree: Option<NodeT>, number_of_neighbours_for_hash: Option<usize>, ignore_edges_including_isomorphic_nodes: Option<bool>, dtype: Option<&str>)-> PyResult<Vec<Vec<Py<PyArray1<NodeT>>>>>{
            Ok(pe!(self.inner.get_isomorphic_edge_node_ids(minimum_node_degree, number_of_neighbours_for_hash, ignore_edges_including_isomorphic_nodes, dtype))?.into_iter().map(|x| x.into_iter().map(|x| {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, x.to_vec(), NodeT)}).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
    ...
    /// ----------
    /// 
            pub fn get_isomorphic_edge_hashes(&self, minimum_node_degree: Option<NodeT>, number_of_neighbours_for_hash: Option<usize>, ignore_edges_including_isomorphic_nodes: Option<bool>, dtype: Option<&str>)-> PyResult<Py<PyArray1<u64>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_isomorphic_edge_hashes(minimum_node_degree, number_of_neighbours_for_hash, ignore_edges_including_isomorphic_nodes, dtype))?, u64)})
            }
    ...
    ///     The data type of the hash. By default, `&str`.
    /// 
            pub fn get_isomorphic_edge_node_names(&self, minimum_node_degree: Option<NodeT>, number_of_neighbours_for_hash: Option<usize>, ignore_edges_including_isomorphic_nodes: Option<bool>, dtype: Option<&str>)-> PyResult<Vec<Vec<Vec<String>>>>{
            Ok(pe!(self.inner.get_isomorphic_edge_node_names(minimum_node_degree, number_of_neighbours_for_hash, ignore_edges_including_isomorphic_nodes, dtype))?.into_iter().map(|x| x.into_iter().map(|x| x.into_iter().cloned().map(|x| {x.into()}).collect::<Vec<_>>()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
    ...
    ///     The data type of the hash. By default, `&str`.
    /// 
            pub fn get_isomorphic_tuple_node_ids(&self, minimum_node_degree: Option<NodeT>, number_of_neighbours_for_hash: Option<usize>, dtype: Option<&str>)-> PyResult<Vec<Vec<Py<PyArray1<NodeT>>>>>{
            Ok(pe!(self.inner.get_isomorphic_tuple_node_ids(minimum_node_degree, number_of_neighbours_for_hash, dtype))?.into_iter().map(|x| x.into_iter().map(|x| {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, x.to_vec(), NodeT)}).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
    ...
    /// ----------
    /// 
            pub fn get_isomorphic_tuple_hashes(&self, minimum_node_degree: Option<NodeT>, number_of_neighbours_for_hash: Option<usize>, dtype: Option<&str>)-> PyResult<Py<PyArray1<u64>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_isomorphic_tuple_hashes(minimum_node_degree, number_of_neighbours_for_hash, dtype))?, u64)})
            }
    ...
    ///     The data type of the hash. By default, `&str`.
    /// 
            pub fn get_isomorphic_tuple_node_names(&self, minimum_node_degree: Option<NodeT>, number_of_neighbours_for_hash: Option<usize>, dtype: Option<&str>)-> PyResult<Vec<Vec<Vec<String>>>>{
            Ok(pe!(self.inner.get_isomorphic_tuple_node_names(minimum_node_degree, number_of_neighbours_for_hash, dtype))?.into_iter().map(|x| x.into_iter().map(|x| x.into_iter().cloned().map(|x| {x.into()}).collect::<Vec<_>>()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
            ...
            #[staticmethod]
            #[automatically_generated_binding]
            #[pyo3(text_signature = "(random_state, minimum_node_id, minimum_node_sampling, maximum_node_sampling, number_of_nodes, include_selfloops, node_type, edge_type, weight, directed, name)")]
    ...
    /// 
            pub fn generate_random_connected_graph(random_state: Option<u64>, minimum_node_id: Option<NodeT>, minimum_node_sampling: Option<NodeT>, maximum_node_sampling: Option<NodeT>, number_of_nodes: Option<NodeT>, include_selfloops: Option<bool>, node_type: Option<&str>, edge_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_random_connected_graph(random_state, minimum_node_id, minimum_node_sampling, maximum_node_sampling, number_of_nodes, include_selfloops, node_type, edge_type, weight, directed, name))?.into())
            }
            ...
            #[staticmethod]
            #[automatically_generated_binding]
            #[pyo3(text_signature = "(random_state, minimum_node_id, number_of_nodes, include_selfloops, node_type, edge_type, weight, directed, name)")]
                /// Creates new random connected graph with given sizes and types.
    /// 
    /// Parameters
    /// ----------
    ...
    ///     Name of the graph. By default 'Chain'.
    /// 
            pub fn generate_random_spanning_tree(random_state: Option<u64>, minimum_node_id: Option<NodeT>, number_of_nodes: Option<NodeT>, include_selfloops: Option<bool>, node_type: Option<&str>, edge_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_random_spanning_tree(random_state, minimum_node_id, number_of_nodes, include_selfloops, node_type, edge_type, weight, directed, name))?.into())
            }
            ...
            #[staticmethod]
            #[automatically_generated_binding]
            #[pyo3(text_signature = "(minimum_node_id, number_of_nodes, include_selfloops, node_type, edge_type, weight, directed, name)")]
    ...
    /// 
            pub fn generate_star_graph(minimum_node_id: Option<NodeT>, number_of_nodes: Option<NodeT>, include_selfloops: Option<bool>, node_type: Option<&str>, edge_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_star_graph(minimum_node_id, number_of_nodes, include_selfloops, node_type, edge_type, weight, directed, name))?.into())
            }
    ...
    /// 
            pub fn generate_wheel_graph(minimum_node_id: Option<NodeT>, number_of_nodes: Option<NodeT>, include_selfloops: Option<bool>, node_type: Option<&str>, edge_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_wheel_graph(minimum_node_id, number_of_nodes, include_selfloops, node_type, edge_type, weight, directed, name))?.into())
            }
    ...
    /// 
            pub fn generate_circle_graph(minimum_node_id: Option<NodeT>, number_of_nodes: Option<NodeT>, include_selfloops: Option<bool>, node_type: Option<&str>, edge_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_circle_graph(minimum_node_id, number_of_nodes, include_selfloops, node_type, edge_type, weight, directed, name))?.into())
            }
    ...
    ///     Name of the graph. By default 'Chain'.
    /// 
            pub fn generate_chain_graph(minimum_node_id: Option<NodeT>, number_of_nodes: Option<NodeT>, include_selfloops: Option<bool>, node_type: Option<&str>, edge_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_chain_graph(minimum_node_id, number_of_nodes, include_selfloops, node_type, edge_type, weight, directed, name))?.into())
            }
    ...
    /// 
            pub fn generate_complete_graph(minimum_node_id: Option<NodeT>, number_of_nodes: Option<NodeT>, include_selfloops: Option<bool>, node_type: Option<&str>, edge_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_complete_graph(minimum_node_id, number_of_nodes, include_selfloops, node_type, edge_type, weight, directed, name))?.into())
            }
    ...
    /// 
            pub fn generate_barbell_graph(minimum_node_id: Option<NodeT>, left_clique_number_of_nodes: Option<NodeT>, right_clique_number_of_nodes: Option<NodeT>, chain_number_of_nodes: Option<NodeT>, include_selfloops: Option<bool>, left_clique_node_type: Option<&str>, right_clique_node_type: Option<&str>, chain_node_type: Option<&str>, left_clique_edge_type: Option<&str>, right_clique_edge_type: Option<&str>, chain_edge_type: Option<&str>, left_clique_weight: Option<WeightT>, right_clique_weight: Option<WeightT>, chain_weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_barbell_graph(minimum_node_id, left_clique_number_of_nodes, right_clique_number_of_nodes, chain_number_of_nodes, include_selfloops, left_clique_node_type, right_clique_node_type, chain_node_type, left_clique_edge_type, right_clique_edge_type, chain_edge_type, left_clique_weight, right_clique_weight, chain_weight, directed, name))?.into())
            }
            ...
            #[staticmethod]
            #[automatically_generated_binding]
            #[pyo3(text_signature = "(minimum_node_id, clique_number_of_nodes, chain_number_of_nodes, include_selfloops, clique_node_type, chain_node_type, clique_edge_type, chain_edge_type, clique_weight, chain_weight, directed, name)")]
    ...
    ///     If the edge weights are provided only for a subset.
    /// 
            pub fn generate_lollipop_graph(minimum_node_id: Option<NodeT>, clique_number_of_nodes: Option<NodeT>, chain_number_of_nodes: Option<NodeT>, include_selfloops: Option<bool>, clique_node_type: Option<&str>, chain_node_type: Option<&str>, clique_edge_type: Option<&str>, chain_edge_type: Option<&str>, clique_weight: Option<WeightT>, chain_weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_lollipop_graph(minimum_node_id, clique_number_of_nodes, chain_number_of_nodes, include_selfloops, clique_node_type, chain_node_type, clique_edge_type, chain_edge_type, clique_weight, chain_weight, directed, name))?.into())
            }
    ...
    ///     If the edge weights are provided only for a subset.
    /// 
            pub fn generate_squared_lattice_graph(sides: Vec<NodeT>, minimum_node_id: Option<NodeT>, node_type: Option<&str>, weight: Option<WeightT>, directed: Option<bool>, name: Option<&str>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::generate_squared_lattice_graph(&sides, minimum_node_id, node_type, weight, directed, name))?.into())
            }
    ...
    /// 
            pub fn filter_from_ids(&self, node_ids_to_keep: Option<Vec<NodeT>>, node_ids_to_remove: Option<Vec<NodeT>>, node_names_to_keep_from_graph: Option<& Graph>, node_names_to_remove_from_graph: Option<& Graph>, node_prefixes_to_keep: Option<Vec<String>>, node_prefixes_to_remove: Option<Vec<String>>, node_type_ids_to_keep: Option<Vec<Option<Vec<NodeTypeT>>>>, node_type_ids_to_remove: Option<Vec<Option<Vec<NodeTypeT>>>>, node_type_id_to_keep: Option<Vec<Option<NodeTypeT>>>, node_type_id_to_remove: Option<Vec<Option<NodeTypeT>>>, source_node_ids_to_keep: Option<Vec<NodeT>>, source_node_ids_to_remove: Option<Vec<NodeT>>, source_node_names_to_keep_from_graph: Option<& Graph>, source_node_names_to_remove_from_graph: Option<& Graph>, source_node_prefixes_to_keep: Option<Vec<String>>, source_node_prefixes_to_remove: Option<Vec<String>>, source_node_type_ids_to_keep: Option<Vec<Option<Vec<NodeTypeT>>>>, source_node_type_ids_to_remove: Option<Vec<Option<Vec<NodeTypeT>>>>, source_node_type_id_to_keep: Option<Vec<Option<NodeTypeT>>>, source_node_type_id_to_remove: Option<Vec<Option<NodeTypeT>>>, destination_node_ids_to_keep: Option<Vec<NodeT>>, destination_node_ids_to_remove: Option<Vec<NodeT>>, destination_node_names_to_keep_from_graph: Option<& Graph>, destination_node_names_to_remove_from_graph: Option<& Graph>, destination_node_prefixes_to_keep: Option<Vec<String>>, destination_node_prefixes_to_remove: Option<Vec<String>>, destination_node_type_ids_to_keep: Option<Vec<Option<Vec<NodeTypeT>>>>, destination_node_type_ids_to_remove: Option<Vec<Option<Vec<NodeTypeT>>>>, destination_node_type_id_to_keep: Option<Vec<Option<NodeTypeT>>>, destination_node_type_id_to_remove: Option<Vec<Option<NodeTypeT>>>, edge_ids_to_keep: Option<Vec<EdgeT>>, edge_ids_to_remove: Option<Vec<EdgeT>>, edge_node_ids_to_keep: Option<Vec<(NodeT, NodeT, )>>, edge_node_ids_to_remove: Option<Vec<(NodeT, NodeT, )>>, edge_type_ids_to_keep: Option<Vec<Option<EdgeTypeT>>>, edge_type_ids_to_remove: Option<Vec<Option<EdgeTypeT>>>, min_edge_weight: Option<WeightT>, max_edge_weight: Option<WeightT>, min_node_degree: Option<NodeT>, max_node_degree: Option<NodeT>, filter_singleton_nodes: Option<bool>, filter_singleton_nodes_with_selfloop: Option<bool>, filter_selfloops: Option<bool>, filter_parallel_edges: Option<bool>)-> PyResult<Graph>{
            Ok(pe!(self.inner.filter_from_ids(node_ids_to_keep, node_ids_to_remove, node_names_to_keep_from_graph.map(|sg| &sg.inner), node_names_to_remove_from_graph.map(|sg| &sg.inner), node_prefixes_to_keep, node_prefixes_to_remove, node_type_ids_to_keep, node_type_ids_to_remove, node_type_id_to_keep, node_type_id_to_remove, source_node_ids_to_keep, source_node_ids_to_remove, source_node_names_to_keep_from_graph.map(|sg| &sg.inner), source_node_names_to_remove_from_graph.map(|sg| &sg.inner), source_node_prefixes_to_keep, source_node_prefixes_to_remove, source_node_type_ids_to_keep, source_node_type_ids_to_remove, source_node_type_id_to_keep, source_node_type_id_to_remove, destination_node_ids_to_keep, destination_node_ids_to_remove, destination_node_names_to_keep_from_graph.map(|sg| &sg.inner), destination_node_names_to_remove_from_graph.map(|sg| &sg.inner), destination_node_prefixes_to_keep, destination_node_prefixes_to_remove, destination_node_type_ids_to_keep, destination_node_type_ids_to_remove, destination_node_type_id_to_keep, destination_node_type_id_to_remove, edge_ids_to_keep, edge_ids_to_remove, edge_node_ids_to_keep, edge_node_ids_to_remove, edge_type_ids_to_keep, edge_type_ids_to_remove, min_edge_weight, max_edge_weight, min_node_degree, max_node_degree, filter_singleton_nodes, filter_singleton_nodes_with_selfloop, filter_selfloops, filter_parallel_edges))?.into())
            }
    ...
    ///     Whether to show loading bar while building the graphs.
    /// 
            pub fn filter_from_names(&self, node_names_to_keep: Option<Vec<&str>>, node_names_to_remove: Option<Vec<&str>>, node_names_to_keep_from_graph: Option<& Graph>, node_names_to_remove_from_graph: Option<& Graph>, node_prefixes_to_keep: Option<Vec<String>>, node_prefixes_to_remove: Option<Vec<String>>, node_type_names_to_keep: Option<Vec<Option<Vec<&str>>>>, node_type_names_to_remove: Option<Vec<Option<Vec<&str>>>>, node_type_name_to_keep: Option<Vec<Option<&str>>>, node_type_name_to_remove: Option<Vec<Option<&str>>>, source_node_names_to_keep: Option<Vec<&str>>, source_node_names_to_remove: Option<Vec<&str>>, source_node_names_to_keep_from_graph: Option<& Graph>, source_node_names_to_remove_from_graph: Option<& Graph>, source_node_prefixes_to_keep: Option<Vec<String>>, source_node_prefixes_to_remove: Option<Vec<String>>, source_node_type_names_to_keep: Option<Vec<Option<Vec<&str>>>>, source_node_type_names_to_remove: Option<Vec<Option<Vec<&str>>>>, source_node_type_name_to_keep: Option<Vec<Option<&str>>>, source_node_type_name_to_remove: Option<Vec<Option<&str>>>, destination_node_names_to_keep: Option<Vec<&str>>, destination_node_names_to_remove: Option<Vec<&str>>, destination_node_names_to_keep_from_graph: Option<& Graph>, destination_node_names_to_remove_from_graph: Option<& Graph>, destination_node_prefixes_to_keep: Option<Vec<String>>, destination_node_prefixes_to_remove: Option<Vec<String>>, destination_node_type_names_to_keep: Option<Vec<Option<Vec<&str>>>>, destination_node_type_names_to_remove: Option<Vec<Option<Vec<&str>>>>, destination_node_type_name_to_keep: Option<Vec<Option<&str>>>, destination_node_type_name_to_remove: Option<Vec<Option<&str>>>, edge_node_names_to_keep: Option<Vec<(&str, &str, )>>, edge_node_names_to_remove: Option<Vec<(&str, &str, )>>, edge_type_names_to_keep: Option<Vec<Option<&str>>>, edge_type_names_to_remove: Option<Vec<Option<&str>>>, min_edge_weight: Option<WeightT>, max_edge_weight: Option<WeightT>, min_node_degree: Option<NodeT>, max_node_degree: Option<NodeT>, filter_singleton_nodes: Option<bool>, filter_singleton_nodes_with_selfloop: Option<bool>, filter_selfloops: Option<bool>, filter_parallel_edges: Option<bool>)-> PyResult<Graph>{
            Ok(pe!(self.inner.filter_from_names(node_names_to_keep, node_names_to_remove, node_names_to_keep_from_graph.map(|sg| &sg.inner), node_names_to_remove_from_graph.map(|sg| &sg.inner), node_prefixes_to_keep, node_prefixes_to_remove, node_type_names_to_keep, node_type_names_to_remove, node_type_name_to_keep.as_ref().map(|x| x.as_slice()), node_type_name_to_remove.as_ref().map(|x| x.as_slice()), source_node_names_to_keep, source_node_names_to_remove, source_node_names_to_keep_from_graph.map(|sg| &sg.inner), source_node_names_to_remove_from_graph.map(|sg| &sg.inner), source_node_prefixes_to_keep, source_node_prefixes_to_remove, source_node_type_names_to_keep, source_node_type_names_to_remove, source_node_type_name_to_keep.as_ref().map(|x| x.as_slice()), source_node_type_name_to_remove.as_ref().map(|x| x.as_slice()), destination_node_names_to_keep, destination_node_names_to_remove, destination_node_names_to_keep_from_graph.map(|sg| &sg.inner), destination_node_names_to_remove_from_graph.map(|sg| &sg.inner), destination_node_prefixes_to_keep, destination_node_prefixes_to_remove, destination_node_type_names_to_keep, destination_node_type_names_to_remove, destination_node_type_name_to_keep.as_ref().map(|x| x.as_slice()), destination_node_type_name_to_remove.as_ref().map(|x| x.as_slice()), edge_node_names_to_keep, edge_node_names_to_remove, edge_type_names_to_keep.as_ref().map(|x| x.as_slice()), edge_type_names_to_remove.as_ref().map(|x| x.as_slice()), min_edge_weight, max_edge_weight, min_node_degree, max_node_degree, filter_singleton_nodes, filter_singleton_nodes_with_selfloop, filter_selfloops, filter_parallel_edges))?.into())
            }
    ...
    ///     The number of neighbours to consider for the hash. By default 10.
    /// 
            pub fn remove_isomorphic_nodes(&self, minimum_node_degree: Option<NodeT>, number_of_neighbours_for_hash: Option<usize>)-> PyResult<Graph>{
            Ok(pe!(self.inner.remove_isomorphic_nodes(minimum_node_degree, number_of_neighbours_for_hash))?.into())
            }
    ...
    ///     Whether to show a loading bar or not.
    /// 
            pub fn random_spanning_arborescence_kruskal(&self, random_state: Option<EdgeT>, undesired_edge_types: Option<HashSet<Option<EdgeTypeT>>>, verbose: Option<bool>)-> (HashSet<(NodeT, NodeT)>, Py<PyArray1<NodeT>>, NodeT, NodeT, NodeT){
            let (subresult_0, subresult_1, subresult_2, subresult_3, subresult_4) = self.inner.random_spanning_arborescence_kruskal(random_state, undesired_edge_types, verbose);
(subresult_0.into(), {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_1, NodeT)}, subresult_2.into(), subresult_3.into(), subresult_4.into())
            }
    ...
    ///     Whether to show a loading bar or not.
    /// 
            pub fn spanning_arborescence_kruskal(&self, verbose: Option<bool>)-> (HashSet<(NodeT, NodeT)>, Py<PyArray1<NodeT>>, NodeT, NodeT, NodeT){
            let (subresult_0, subresult_1, subresult_2, subresult_3, subresult_4) = self.inner.spanning_arborescence_kruskal(verbose);
(subresult_0.into(), {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_1, NodeT)}, subresult_2.into(), subresult_3.into(), subresult_4.into())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_random_spanning_tree(verbose))?, NodeT)})
            }
    ...
    ///     If the system configuration does not allow for the creation of the thread pool.
    /// 
            pub fn get_connected_components(&self, verbose: Option<bool>)-> PyResult<(Py<PyArray1<NodeT>>, NodeT, NodeT, NodeT)>{
            Ok({let (subresult_0, subresult_1, subresult_2, subresult_3) = pe!(self.inner.get_connected_components(verbose))?.into();
({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, subresult_0, NodeT)}, subresult_1.into(), subresult_2.into(), subresult_3.into())})
            }
    ...
    /// 
            pub fn enable(& mut self, vector_sources: Option<bool>, vector_reciprocal_sqrt_degrees: Option<bool>){
            self.inner.enable(vector_sources, vector_reciprocal_sqrt_degrees);
            }
    ...
    /// 
            pub fn get_approximated_total_distances(&self, precision: Option<u8>, bits: Option<u8>)-> PyResult<Py<PyArray1<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_approximated_total_distances(precision, bits))?, f32)})
            }
    ...
    ///     The number of bits to use for the HyperLogLog counters. It must be either 4, 5 or 6, and by default 6.
    /// 
            pub fn get_approximated_closeness_centrality(&self, precision: Option<u8>, bits: Option<u8>)-> PyResult<Py<PyArray1<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_approximated_closeness_centrality(precision, bits))?, f32)})
            }
    ...
    ///     The number of bits to use for the HyperLogLog counters. It must be either 4, 5 or 6, and by default 6.
    /// 
            pub fn get_approximated_harmonic_centrality(&self, precision: Option<u8>, bits: Option<u8>)-> PyResult<Py<PyArray1<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_approximated_harmonic_centrality(precision, bits))?, f32)})
            }
    ...
    /// 
            pub fn get_approximated_diameter(&self, precision: Option<u8>, bits: Option<u8>, dtype: Option<&str>)-> PyResult<usize>{
    ...
    /// 
            ...
            self.inner.has_compatible_node_vocabularies(&other.inner).into()
            }
    ...
    /// 
            ...
            self.inner.has_compatible_node_types_vocabularies(&other.inner).into()
            }
    ...
    /// 
            ...
            self.inner.has_compatible_edge_types_vocabularies(&other.inner).into()
            }
    ...
    /// 
            pub fn get_vertex_cover(&self, approach: Option<&str>, sequential: Option<bool>, insert_only_source: Option<bool>, random_seed: Option<u64>)-> PyResult<Py<PyArray1<bool>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_vertex_cover(approach, sequential, insert_only_source, random_seed))?, bool)})
            }
    ...
    /// * If the graph does not have edge types, the method will always return None.
            pub unsafe fn get_unchecked_random_scale_free_edge_type(&self, random_state: u64)-> Option<EdgeTypeT>{
            self.inner.get_unchecked_random_scale_free_edge_type(random_state.clone()).map(|x| x.into())
            }
    ...
    ///     If the graph does not have edge types.
    /// 
            pub fn get_random_scale_free_edge_type(&self, random_state: u64)-> PyResult<Option<EdgeTypeT>>{
            Ok(pe!(self.inner.get_random_scale_free_edge_type(random_state.clone()))?.map(|x| x.into()))
            }
    ...
    /// ------
    /// * If the graph does not have edge types, the method will always return None.
            pub unsafe fn get_unchecked_random_scale_free_edge_weight(&self, random_state: u64)-> Option<WeightT>{
            self.inner.get_unchecked_random_scale_free_edge_weight(random_state.clone()).map(|x| x.into())
            }
    ...
    ///     If the graph does not have edge types.
    /// 
            pub fn get_random_scale_free_edge_weight(&self, random_state: u64)-> PyResult<Option<WeightT>>{
            Ok(pe!(self.inner.get_random_scale_free_edge_weight(random_state.clone()))?.map(|x| x.into()))
            }
    ...
    /// 
            ...
            self.inner.get_random_outbounds_scale_free_node(random_state.clone()).into()
            }
    ...
    /// 
            ...
            self.inner.get_random_inbounds_scale_free_node(random_state.clone()).into()
            }
    ...
    ///     The random state to use to reproduce the sampling.
    /// 
            pub fn get_sorted_unique_random_nodes(&self, number_of_nodes_to_sample: NodeT, random_state: u64)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_sorted_unique_random_nodes(number_of_nodes_to_sample.clone(), random_state.clone()))?, NodeT)})
            }
    ...
    /// 
            pub fn get_breadth_first_search_random_nodes(&self, number_of_nodes_to_sample: NodeT, root_node: NodeT)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_breadth_first_search_random_nodes(number_of_nodes_to_sample.clone(), root_node.clone()))?, NodeT)})
            }
    ...
    /// 
            pub fn get_uniform_random_walk_random_nodes(&self, node: NodeT, random_state: u64, walk_length: u64, unique: Option<bool>)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_uniform_random_walk_random_nodes(node.clone(), random_state.clone(), walk_length.clone(), unique))?, NodeT)})
            }
            ...
            self.inner.get_node_sampling_methods().into_iter().map(|x| x.to_string()).collect::<Vec<_>>()
            }
            ...
            #[automatically_generated_binding]
            #[pyo3(text_signature = "($self, number_of_nodes_to_sample, random_state, node_sampling_method, root_node, unique)")]
    ...
    /// 
            pub fn get_subsampled_nodes(&self, number_of_nodes_to_sample: NodeT, random_state: u64, node_sampling_method: &str, root_node: Option<NodeT>, unique: Option<bool>)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_subsampled_nodes(number_of_nodes_to_sample.clone(), random_state.clone(), node_sampling_method, root_node, unique))?, NodeT)})
            }
    ...
    ///     If the graph does not have node types.
    /// 
            pub fn get_okapi_bm25_node_feature_propagation(&self, features: Vec<Vec<f64>>, iterations: Option<usize>, maximal_distance: Option<usize>, k1: Option<f64>, b: Option<f64>, include_central_node: Option<bool>, verbose: Option<bool>)-> PyResult<Py<PyArray2<f64>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_okapi_bm25_node_feature_propagation(features, iterations, maximal_distance, k1, b, include_central_node, verbose))?, f64)})
            }
    ...
    ///     If the graph does not have node types.
    /// 
            pub fn get_okapi_bm25_node_label_propagation(&self, iterations: Option<usize>, maximal_distance: Option<usize>, k1: Option<f64>, b: Option<f64>, verbose: Option<bool>)-> PyResult<Py<PyArray2<f64>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_okapi_bm25_node_label_propagation(iterations, maximal_distance, k1, b, verbose))?, f64)})
            }
    ...
    /// 
            ...
            self.inner.has_nodes_sorted_by_decreasing_outbound_node_degree().into()
            }
            ...
            self.inner.has_nodes_sorted_by_increasing_outbound_node_degree().into()
            }
            ...
            self.inner.has_reciprocal_sqrt_degrees_tradeoff_enabled().into()
            }
            ...
            Ok(pe!(self.inner.get_dendritic_trees())?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_transitive_closure(&self, iterations: Option<NodeT>, verbose: Option<bool>)-> Graph{
            self.inner.get_transitive_closure(iterations, verbose).into()
            }
    ...
    ///     Whether to show a loading bar while building the graph.
    /// 
            pub fn get_all_shortest_paths(&self, iterations: Option<NodeT>, verbose: Option<bool>)-> Graph{
            self.inner.get_all_shortest_paths(iterations, verbose).into()
            }
    ...
    /// 
            pub fn get_weighted_all_shortest_paths(&self, iterations: Option<NodeT>, use_edge_weights_as_probabilities: Option<bool>, verbose: Option<bool>)-> PyResult<Graph>{
            Ok(pe!(self.inner.get_weighted_all_shortest_paths(iterations, use_edge_weights_as_probabilities, verbose))?.into())
            }
    ...
    /// If the given edge ID does not exists in the graph this method will panic.
            ...
            self.inner.get_unchecked_edge_weight_from_edge_id(edge_id.clone()).map(|x| x.into())
            }
    ...
    /// If either of the two given node IDs does not exists in the graph.
            ...
            self.inner.get_unchecked_edge_weight_from_node_ids(src.clone(), dst.clone()).into()
            }
    ...
    /// If the given node name does not exists in the considered graph the method will panic.
            ...
            self.inner.get_unchecked_node_id_from_node_name(node_name).into()
            }
    ...
    /// If the given edge type name does not exists in the considered graph the method will panic.
            pub unsafe fn get_unchecked_edge_type_id_from_edge_type_name(&self, edge_type_name: &str)-> Option<EdgeTypeT>{
            self.inner.get_unchecked_edge_type_id_from_edge_type_name(edge_type_name).map(|x| x.into())
            }
    ...
    /// If the given edge type ID does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_edge_type_name_from_edge_type_id(&self, edge_type_id: Option<EdgeTypeT>)-> Option<String>{
            self.inner.get_unchecked_edge_type_name_from_edge_type_id(edge_type_id).map(|x| x.into())
            }
    ...
    /// ------
    /// If the given edge type ID does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_edge_count_from_edge_type_id(&self, edge_type: Option<EdgeTypeT>)-> EdgeT{
            self.inner.get_unchecked_edge_count_from_edge_type_id(edge_type).into()
            }
    ...
    ///  the method will panic.
            pub unsafe fn get_unchecked_node_count_from_node_type_id(&self, node_type: Option<NodeTypeT>)-> NodeT{
            self.inner.get_unchecked_node_count_from_node_type_id(node_type).into()
            }
    ...
    /// If the given node IDs or edge type does not exists in the graph this method will panic.
            pub unsafe fn get_unchecked_edge_id_from_node_ids_and_edge_type_id(&self, src: NodeT, dst: NodeT, edge_type: Option<EdgeTypeT>)-> EdgeT{
            self.inner.get_unchecked_edge_id_from_node_ids_and_edge_type_id(src.clone(), dst.clone(), edge_type).into()
            }
    ...
    /// If the given node type IDs do not exist in the graph this method will panic.
            pub unsafe fn get_unchecked_minmax_edge_ids_from_node_ids(&self, src: NodeT, dst: NodeT)-> (EdgeT, EdgeT){
            let (subresult_0, subresult_1) = self.inner.get_unchecked_minmax_edge_ids_from_node_ids(src.clone(), dst.clone());
(subresult_0.into(), subresult_1.into())
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            ...
            let (subresult_0, subresult_1) = self.inner.get_unchecked_node_ids_from_edge_id(edge_id.clone());
(subresult_0.into(), subresult_1.into())
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            ...
            let (subresult_0, subresult_1) = self.inner.get_unchecked_node_names_from_edge_id(edge_id.clone());
(subresult_0.into(), subresult_1.into())
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will cause an out of bounds.
            ...
            self.inner.get_unchecked_source_node_id_from_edge_id(edge_id.clone()).into()
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will cause an out of bounds.
            ...
            self.inner.get_unchecked_destination_node_id_from_edge_id(edge_id.clone()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_destination_node_id_from_edge_id(edge_id.clone()))?.into())
            }
    ...
    ///  the number of nodes in the graph.
            ...
            self.inner.get_unchecked_number_of_selfloops_from_node_id(node_id.clone()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_number_of_selfloops_from_node_id(node_id.clone()))?.into())
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            ...
            self.inner.get_unchecked_source_node_name_from_edge_id(edge_id.clone()).into()
            }
    ...
    /// ------
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            pub unsafe fn get_unchecked_destination_node_name_from_edge_id(&self, edge_id: EdgeT)-> String{
            self.inner.get_unchecked_destination_node_name_from_edge_id(edge_id.clone()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_source_node_name_from_edge_id(edge_id.clone()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_destination_node_name_from_edge_id(edge_id.clone()))?.into())
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_node_names_from_edge_id(edge_id.clone()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_node_ids_from_edge_id(edge_id.clone()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    /// If any of the given node IDs do not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_edge_id_from_node_ids(src.clone(), dst.clone()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_id_from_node_ids(src.clone(), dst.clone()))?.into())
            }
    ...
    /// If the given source node ID does not exist in the current graph the method will panic.
            ...
            self.inner.get_unchecked_unique_source_node_id(source_id.clone()).into()
            }
    ...
    /// ------
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            pub unsafe fn get_unchecked_node_ids_and_edge_type_id_from_edge_id(&self, edge_id: EdgeT)-> (NodeT, NodeT, Option<EdgeTypeT>){
            let (subresult_0, subresult_1, subresult_2) = self.inner.get_unchecked_node_ids_and_edge_type_id_from_edge_id(edge_id.clone());
(subresult_0.into(), subresult_1.into(), subresult_2.map(|x| x.into()))
            }
    ...
    ///     The edge ID whose source, destination and edge type are to be retrieved.
    /// 
            pub fn get_node_ids_and_edge_type_id_from_edge_id(&self, edge_id: EdgeT)-> PyResult<(NodeT, NodeT, Option<EdgeTypeT>)>{
            Ok({let (subresult_0, subresult_1, subresult_2) = pe!(self.inner.get_node_ids_and_edge_type_id_from_edge_id(edge_id.clone()))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.map(|x| x.into()))})
            }
    ...
    /// ------
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            pub unsafe fn get_unchecked_node_ids_and_edge_type_id_and_edge_weight_from_edge_id(&self, edge_id: EdgeT)-> (NodeT, NodeT, Option<EdgeTypeT>, Option<WeightT>){
            let (subresult_0, subresult_1, subresult_2, subresult_3) = self.inner.get_unchecked_node_ids_and_edge_type_id_and_edge_weight_from_edge_id(edge_id.clone());
(subresult_0.into(), subresult_1.into(), subresult_2.map(|x| x.into()), subresult_3.map(|x| x.into()))
            }
    ...
    ///     The edge ID whose source, destination, edge type and weight are to be retrieved.
    /// 
            pub fn get_node_ids_and_edge_type_id_and_edge_weight_from_edge_id(&self, edge_id: EdgeT)-> PyResult<(NodeT, NodeT, Option<EdgeTypeT>, Option<WeightT>)>{
            Ok({let (subresult_0, subresult_1, subresult_2, subresult_3) = pe!(self.inner.get_node_ids_and_edge_type_id_and_edge_weight_from_edge_id(edge_id.clone()))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.map(|x| x.into()), subresult_3.map(|x| x.into()))})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_top_k_central_node_ids(k.clone()))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_weighted_top_k_central_node_ids(k.clone()))?, NodeT)})
            }
    ...
    /// If the given node ID does not exist in the current graph the method will raise a panic.
            ...
            self.inner.get_unchecked_node_degree_from_node_id(node_id.clone()).into()
            }
    ...
    /// ------
    /// If the given node ID does not exist in the current graph the method will raise a panic.
            pub unsafe fn get_unchecked_selfloop_excluded_node_degree_from_node_id(&self, node_id: NodeT)-> NodeT{
            self.inner.get_unchecked_selfloop_excluded_node_degree_from_node_id(node_id.clone()).into()
            }
    ...
    /// 
            pub fn get_selfloop_adjusted_node_degree_from_node_id(&self, node_id: NodeT)-> PyResult<NodeT>{
            Ok(pe!(self.inner.get_selfloop_adjusted_node_degree_from_node_id(node_id.clone()))?.into())
            }
    ...
    /// 
            pub fn get_selfloop_adjusted_node_degree_from_node_name(&self, node_name: &str)-> PyResult<NodeT>{
            Ok(pe!(self.inner.get_selfloop_adjusted_node_degree_from_node_name(node_name))?.into())
            }
    ...
    /// If the given node ID does not exist in the current graph the method will raise a panic.
            ...
            self.inner.get_unchecked_weighted_node_degree_from_node_id(node_id.clone()).into()
            }
    ...
    /// ------
    /// If the given node ID does not exist in the current graph the method will raise a panic.
            pub unsafe fn get_unchecked_comulative_node_degree_from_node_id(&self, node_id: NodeT)-> EdgeT{
            self.inner.get_unchecked_comulative_node_degree_from_node_id(node_id.clone()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_comulative_node_degree_from_node_id(node_id.clone()))?.into())
            }
    ...
    /// ------
    /// If the given node ID does not exist in the current graph the method will raise a panic.
            pub unsafe fn get_unchecked_reciprocal_sqrt_degree_from_node_id(&self, node_id: NodeT)-> WeightT{
            self.inner.get_unchecked_reciprocal_sqrt_degree_from_node_id(node_id.clone()).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_reciprocal_sqrt_degree_from_node_id(node_id.clone()))?.into())
            }
    ...
    ///  they are not higher than the number of nodes in the graph.
            pub unsafe fn get_unchecked_reciprocal_sqrt_degrees_from_node_ids(&self, node_ids: Vec<NodeT>)-> Py<PyArray1<WeightT>>{
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_unchecked_reciprocal_sqrt_degrees_from_node_ids(&node_ids), WeightT)
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_weighted_node_degree_from_node_id(node_id.clone()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_top_k_central_node_names(k.clone()))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    ///  not available for the current graph, the behaviour is undefined.
            pub unsafe fn get_unchecked_node_type_ids_from_node_id(&self, node_id: NodeT)-> Option<Py<PyArray1<NodeTypeT>>>{
            self.inner.get_unchecked_node_type_ids_from_node_id(node_id.clone()).map(|x| {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, x.to_vec(), NodeTypeT)})
    ...
    ///     node whose node type is to be returned.
    /// 
            pub fn get_node_type_ids_from_node_id(&self, node_id: NodeT)-> PyResult<Option<Py<PyArray1<NodeTypeT>>>>{
            Ok(pe!(self.inner.get_node_type_ids_from_node_id(node_id.clone()))?.map(|x| {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, x.to_vec(), NodeTypeT)}))
            }
    ...
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            ...
            self.inner.get_unchecked_edge_type_id_from_edge_id(edge_id.clone()).map(|x| x.into())
            }
    ...
    /// ------
    /// If the given edge ID does not exist in the current graph the method will raise a panic.
            pub unsafe fn get_unchecked_edge_type_name_from_edge_id(&self, edge_id: EdgeT)-> Option<String>{
            self.inner.get_unchecked_edge_type_name_from_edge_id(edge_id.clone()).map(|x| x.into())
            }
    ...
    /// 
            pub fn get_edge_type_id_from_edge_node_ids(&self, src: NodeT, dst: NodeT)-> PyResult<Option<EdgeTypeT>>{
            Ok(pe!(self.inner.get_edge_type_id_from_edge_node_ids(src.clone(), dst.clone()))?.map(|x| x.into()))
            }
    ...
    ///  does not contain node types.
            pub unsafe fn get_unchecked_node_type_names_from_node_id(&self, node_id: NodeT)-> Option<Vec<String>>{
            self.inner.get_unchecked_node_type_names_from_node_id(node_id.clone()).map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_node_type_names_from_node_id(&self, node_id: NodeT)-> PyResult<Option<Vec<String>>>{
            Ok(pe!(self.inner.get_node_type_names_from_node_id(node_id.clone()))?.map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()))
            }
    ...
    /// 
            pub fn get_node_type_names_from_node_name(&self, node_name: &str)-> PyResult<Option<Vec<String>>>{
            Ok(pe!(self.inner.get_node_type_names_from_node_name(node_name))?.map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()))
            }
    ...
    ///     Id of the edge type.
    /// 
            pub fn get_edge_type_name_from_edge_type_id(&self, edge_type_id: EdgeTypeT)-> PyResult<String>{
            Ok(pe!(self.inner.get_edge_type_name_from_edge_type_id(edge_type_id.clone()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_edge_weight_from_node_ids(src.clone(), dst.clone()))?.into())
            }
    ...
    /// 
            pub fn get_edge_weight_from_node_ids_and_edge_type_id(&self, src: NodeT, dst: NodeT, edge_type: Option<EdgeTypeT>)-> PyResult<WeightT>{
            Ok(pe!(self.inner.get_edge_weight_from_node_ids_and_edge_type_id(src.clone(), dst.clone(), edge_type))?.into())
            }
    ...
    /// 
            pub fn get_edge_weight_from_node_names_and_edge_type_name(&self, src: &str, dst: &str, edge_type: Option<&str>)-> PyResult<WeightT>{
            Ok(pe!(self.inner.get_edge_weight_from_node_names_and_edge_type_name(src, dst, edge_type))?.into())
            }
    ...
    ///     The node name of the destination node.
    /// 
            pub fn get_edge_weight_from_node_names(&self, src_name: &str, dst_name: &str)-> PyResult<WeightT>{
            Ok(pe!(self.inner.get_edge_weight_from_node_names(src_name, dst_name))?.into())
            }
    ...
    /// If the given node ID does not exist in the current graph the method will raise a panic.
            ...
            self.inner.get_unchecked_node_name_from_node_id(node_id.clone()).into()
            }
    ...
    /// 
            pub fn get_node_ids_from_node_names(&self, node_names: Vec<&str>)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_node_ids_from_node_names(node_names))?, NodeT)})
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_names_from_node_ids(node_ids))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    ///     When any of the given node name does not exists in the current graph.
    /// 
            pub fn get_edge_node_ids_from_edge_node_names(&self, edge_node_names: Vec<(&str, &str, )>)-> PyResult<Py<PyArray2<NodeT>>>{
            Ok({
    // Warning: this copies the array so it uses double the memory.
    // To avoid this you should directly generate data compatible with a numpy array
    // Which is a flat vector with row-first or column-first unrolling
    let gil = pyo3::Python::acquire_gil();
    let body = pe!(self.inner.get_edge_node_ids_from_edge_node_names(edge_node_names))?;
    let result_array = ThreadDataRaceAware {t: unsafe{PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)}};
    body.into_par_iter().enumerate()
        .for_each(|(i, (a, b))| unsafe {
            *(result_array.t.uget_mut([i, 0]))  = a;
    ...
    ///     When any of the given node IDs does not exists in the current graph.
    /// 
            pub fn get_edge_node_names_from_edge_node_ids(&self, edge_node_ids: Vec<(NodeT, NodeT, )>)-> PyResult<Vec<(String, String)>>{
            Ok(pe!(self.inner.get_edge_node_names_from_edge_node_ids(edge_node_ids))?.into_iter().map(|x| {let (subresult_0, subresult_1) = x;
(subresult_0.into(), subresult_1.into())}).collect::<Vec<_>>())
            }
    ...
    ///     Name of the node.
    /// 
            pub fn get_node_type_ids_from_node_name(&self, node_name: &str)-> PyResult<Option<Py<PyArray1<NodeTypeT>>>>{
            Ok(pe!(self.inner.get_node_type_ids_from_node_name(node_name))?.map(|x| {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, x.to_vec(), NodeTypeT)}))
            }
    ...
    ///     Name of the node.
    /// 
            pub fn get_node_type_name_from_node_name(&self, node_name: &str)-> PyResult<Option<Vec<String>>>{
            Ok(pe!(self.inner.get_node_type_name_from_node_name(node_name))?.map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()))
            }
    ...
    /// 
            pub fn get_edge_count_from_edge_type_id(&self, edge_type_id: Option<EdgeTypeT>)-> PyResult<EdgeT>{
    ...
    /// 
            pub fn get_edge_type_id_from_edge_type_name(&self, edge_type_name: Option<&str>)-> PyResult<Option<EdgeTypeT>>{
            Ok(pe!(self.inner.get_edge_type_id_from_edge_type_name(edge_type_name))?.map(|x| x.into()))
            }
    ...
    /// 
            pub fn get_edge_count_from_edge_type_name(&self, edge_type_name: Option<&str>)-> PyResult<EdgeT>{
            Ok(pe!(self.inner.get_edge_count_from_edge_type_name(edge_type_name))?.into())
            }
    ...
    /// 
            pub fn get_node_type_id_from_node_type_name(&self, node_type_name: &str)-> PyResult<NodeTypeT>{
            Ok(pe!(self.inner.get_node_type_id_from_node_type_name(node_type_name))?.into())
            }
    ...
    /// 
            pub fn get_node_count_from_node_type_id(&self, node_type_id: Option<NodeTypeT>)-> PyResult<NodeT>{
    ...
    /// 
            pub fn get_node_count_from_node_type_name(&self, node_type_name: Option<&str>)-> PyResult<NodeT>{
            Ok(pe!(self.inner.get_node_count_from_node_type_name(node_type_name))?.into())
            }
    ...
    /// 
            pub fn get_neighbour_node_ids_from_node_id(&self, node_id: NodeT)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_neighbour_node_ids_from_node_id(node_id.clone()))?, NodeT)})
            }
    ...
    ///     Node ID whose neighbours are to be retrieved.
    /// 
            pub fn get_neighbour_node_ids_from_node_name(&self, node_name: &str)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_neighbour_node_ids_from_node_name(node_name))?, NodeT)})
            }
    ...
    /// 
            pub fn get_neighbour_node_names_from_node_name(&self, node_name: &str)-> PyResult<Vec<String>>{
            Ok(pe!(self.inner.get_neighbour_node_names_from_node_name(node_name))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    ///     Destination node.
    /// 
            pub fn get_minmax_edge_ids_from_node_ids(&self, src: NodeT, dst: NodeT)-> PyResult<(EdgeT, EdgeT)>{
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_minmax_edge_ids_from_node_ids(src.clone(), dst.clone()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    ///     Edge Type of the edge.
    /// 
            pub fn get_edge_id_from_node_ids_and_edge_type_id(&self, src: NodeT, dst: NodeT, edge_type: Option<EdgeTypeT>)-> PyResult<EdgeT>{
            Ok(pe!(self.inner.get_edge_id_from_node_ids_and_edge_type_id(src.clone(), dst.clone(), edge_type))?.into())
            }
    ...
    ///     Edge type name.
    /// 
            pub fn get_edge_id_from_node_names_and_edge_type_name(&self, src_name: &str, dst_name: &str, edge_type_name: Option<&str>)-> PyResult<EdgeT>{
            Ok(pe!(self.inner.get_edge_id_from_node_names_and_edge_type_name(src_name, dst_name, edge_type_name))?.into())
            }
    ...
    /// 
            pub fn get_edge_type_ids_from_edge_type_names(&self, edge_type_names: Vec<Option<&str>>)-> PyResult<Vec<Option<EdgeTypeT>>>{
            Ok(pe!(self.inner.get_edge_type_ids_from_edge_type_names(&edge_type_names))?.into_iter().map(|x| x.map(|x| x.into())).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_node_type_ids_from_node_type_names(&self, node_type_names: Vec<Option<&str>>)-> PyResult<Vec<Option<NodeTypeT>>>{
            Ok(pe!(self.inner.get_node_type_ids_from_node_type_names(&node_type_names))?.into_iter().map(|x| x.map(|x| x.into())).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_multiple_node_type_ids_from_node_type_names(&self, node_type_names: Vec<Option<Vec<&str>>>)-> PyResult<Vec<Option<Py<PyArray1<NodeTypeT>>>>>{
            Ok(pe!(self.inner.get_multiple_node_type_ids_from_node_type_names(node_type_names))?.into_iter().map(|x| x.map(|x| {let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, x, NodeTypeT)})).collect::<Vec<_>>())
            }
    ...
    /// If the given node ID does not exist in the current graph the method will raise a panic.
            ...
            let (subresult_0, subresult_1) = self.inner.get_unchecked_minmax_edge_ids_from_source_node_id(src.clone());
(subresult_0.into(), subresult_1.into())
            }
    ...
    /// 
            ...
            Ok({let (subresult_0, subresult_1) = pe!(self.inner.get_minmax_edge_ids_from_source_node_id(src.clone()))?.into();
(subresult_0.into(), subresult_1.into())})
            }
    ...
    ///     Id of the node type.
    /// 
            pub fn get_node_type_name_from_node_type_id(&self, node_type_id: NodeTypeT)-> PyResult<String>{
            Ok(pe!(self.inner.get_node_type_name_from_node_type_id(node_type_id.clone()))?.into())
            }
    ...
    /// The method will panic if the graph does not contain node types.
            pub unsafe fn get_unchecked_node_type_names_from_node_type_ids(&self, node_type_ids: Vec<NodeTypeT>)-> Vec<String>{
            self.inner.get_unchecked_node_type_names_from_node_type_ids(&node_type_ids).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
    ...
    ///  is provided. If the graph does not have node types, zero will be returned.
            pub unsafe fn get_unchecked_number_of_nodes_from_node_type_id(&self, node_type_id: NodeTypeT)-> NodeT{
            self.inner.get_unchecked_number_of_nodes_from_node_type_id(node_type_id.clone()).into()
            }
    ...
    /// 
            pub fn get_number_of_nodes_from_node_type_id(&self, node_type_id: NodeTypeT)-> PyResult<NodeT>{
            Ok(pe!(self.inner.get_number_of_nodes_from_node_type_id(node_type_id.clone()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_number_of_nodes_from_node_type_name(node_type_name))?.into())
            }
    ...
    ///  is provided. If the graph does not have edge types, zero will be returned.
            pub unsafe fn get_unchecked_number_of_edges_from_edge_type_id(&self, edge_type_id: EdgeTypeT)-> EdgeT{
            self.inner.get_unchecked_number_of_edges_from_edge_type_id(edge_type_id.clone()).into()
            }
    ...
    /// 
            pub fn get_number_of_edges_from_edge_type_id(&self, edge_type_id: EdgeTypeT)-> PyResult<EdgeT>{
            Ok(pe!(self.inner.get_number_of_edges_from_edge_type_id(edge_type_id.clone()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_number_of_edges_from_edge_type_name(edge_type_name))?.into())
            }
    ...
    ///  or the result will be undefined and most likely will lead to panic.
            pub unsafe fn get_unchecked_node_type_id_counts_hashmap_from_node_ids(&self, node_ids: Vec<NodeT>)-> PyResult<HashMap<NodeTypeT, NodeT>>{
            Ok(pe!(self.inner.get_unchecked_node_type_id_counts_hashmap_from_node_ids(&node_ids))?.into())
            }
    ...
    ///  or the result will be undefined and most likely will lead to panic.
            pub unsafe fn get_unchecked_edge_type_id_counts_hashmap_from_node_ids(&self, node_ids: Vec<NodeT>)-> PyResult<HashMap<EdgeTypeT, EdgeT>>{
            Ok(pe!(self.inner.get_unchecked_edge_type_id_counts_hashmap_from_node_ids(&node_ids))?.into())
            }
    ...
    /// 
            pub fn get_edge_node_ids_from_edge_type_id(&self, directed: bool, edge_type_id: Option<EdgeTypeT>)-> PyResult<Py<PyArray2<NodeT>>>{
            Ok({
    // Warning: this copies the array so it uses double the memory.
    // To avoid this you should directly generate data compatible with a numpy array
    // Which is a flat vector with row-first or column-first unrolling
    let gil = pyo3::Python::acquire_gil();
    let body = pe!(self.inner.get_edge_node_ids_from_edge_type_id(directed.clone(), edge_type_id))?;
    let result_array = ThreadDataRaceAware {t: unsafe{PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)}};
    body.into_par_iter().enumerate()
        .for_each(|(i, (a, b))| unsafe {
            *(result_array.t.uget_mut([i, 0]))  = a;
    ...
    ///     If the given edge type ID does not exist in the graph.
    /// 
            pub fn get_directed_edge_node_ids_from_edge_type_id(&self, edge_type_id: Option<EdgeTypeT>)-> PyResult<Py<PyArray2<NodeT>>>{
            Ok({
    // Warning: this copies the array so it uses double the memory.
    // To avoid this you should directly generate data compatible with a numpy array
    // Which is a flat vector with row-first or column-first unrolling
    let gil = pyo3::Python::acquire_gil();
    let body = pe!(self.inner.get_directed_edge_node_ids_from_edge_type_id(edge_type_id))?;
    let result_array = ThreadDataRaceAware {t: unsafe{PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)}};
    body.into_par_iter().enumerate()
        .for_each(|(i, (a, b))| unsafe {
            *(result_array.t.uget_mut([i, 0]))  = a;
    ...
    ///     If the given edge type ID does not exist in the graph.
    /// 
            pub fn get_directed_edge_node_names_from_edge_type_id(&self, edge_type_id: Option<EdgeTypeT>)-> PyResult<Vec<(String, String)>>{
            Ok(pe!(self.inner.get_directed_edge_node_names_from_edge_type_id(edge_type_id))?.into_iter().map(|x| {let (subresult_0, subresult_1) = x;
(subresult_0.into(), subresult_1.into())}).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_directed_edge_node_names_from_edge_type_name(&self, edge_type_name: Option<&str>)-> PyResult<Vec<(String, String)>>{
            Ok(pe!(self.inner.get_directed_edge_node_names_from_edge_type_name(edge_type_name))?.into_iter().map(|x| {let (subresult_0, subresult_1) = x;
(subresult_0.into(), subresult_1.into())}).collect::<Vec<_>>())
            }
    ...
    ///     If the given edge type id does not exist in the graph.
    /// 
            pub fn get_directed_edge_ids_from_edge_type_id(&self, edge_type_id: Option<EdgeTypeT>)-> PyResult<Py<PyArray1<EdgeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_directed_edge_ids_from_edge_type_id(edge_type_id))?, EdgeT)})
            }
    ...
    ///     If the given edge type name does not exist in the graph.
    /// 
            pub fn get_edge_node_ids_from_edge_type_name(&self, directed: bool, edge_type_name: Option<&str>)-> PyResult<Py<PyArray2<NodeT>>>{
            Ok({
    // Warning: this copies the array so it uses double the memory.
    // To avoid this you should directly generate data compatible with a numpy array
    // Which is a flat vector with row-first or column-first unrolling
    let gil = pyo3::Python::acquire_gil();
    let body = pe!(self.inner.get_edge_node_ids_from_edge_type_name(directed.clone(), edge_type_name))?;
    let result_array = ThreadDataRaceAware {t: unsafe{PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)}};
    body.into_par_iter().enumerate()
        .for_each(|(i, (a, b))| unsafe {
            *(result_array.t.uget_mut([i, 0]))  = a;
    ...
    /// 
            pub fn get_directed_edge_node_ids_from_edge_type_name(&self, edge_type_name: Option<&str>)-> PyResult<Py<PyArray2<NodeT>>>{
            Ok({
    // Warning: this copies the array so it uses double the memory.
    // To avoid this you should directly generate data compatible with a numpy array
    // Which is a flat vector with row-first or column-first unrolling
    let gil = pyo3::Python::acquire_gil();
    let body = pe!(self.inner.get_directed_edge_node_ids_from_edge_type_name(edge_type_name))?;
    let result_array = ThreadDataRaceAware {t: unsafe{PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)}};
    body.into_par_iter().enumerate()
        .for_each(|(i, (a, b))| unsafe {
            *(result_array.t.uget_mut([i, 0]))  = a;
    ...
    ///     If the given edge type names does not exist in the graph.
    /// 
            pub fn get_directed_edge_ids_from_edge_type_name(&self, edge_type_name: Option<&str>)-> PyResult<Py<PyArray1<EdgeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_directed_edge_ids_from_edge_type_name(edge_type_name))?, EdgeT)})
            }
    ...
    ///     Prefix of the source node names.
    /// 
            pub fn get_directed_edge_node_names_from_node_curie_prefixes(&self, src_node_name_prefixes: Option<Vec<&str>>, dst_node_name_prefixes: Option<Vec<&str>>)-> Vec<(String, String)>{
            self.inner.get_directed_edge_node_names_from_node_curie_prefixes(src_node_name_prefixes, dst_node_name_prefixes).into_iter().map(|x| {let (subresult_0, subresult_1) = x;
(subresult_0.into(), subresult_1.into())}).collect::<Vec<_>>()
            }
    ...
    ///     Prefix of the source node names.
    /// 
            pub fn get_directed_edge_node_ids_from_node_curie_prefixes(&self, src_node_name_prefixes: Option<Vec<&str>>, dst_node_name_prefixes: Option<Vec<&str>>)-> Py<PyArray2<NodeT>>{
            
    // Warning: this copies the array so it uses double the memory.
    // To avoid this you should directly generate data compatible with a numpy array
    // Which is a flat vector with row-first or column-first unrolling
    let gil = pyo3::Python::acquire_gil();
    let body = self.inner.get_directed_edge_node_ids_from_node_curie_prefixes(src_node_name_prefixes, dst_node_name_prefixes);
    let result_array = ThreadDataRaceAware {t: unsafe{PyArray2::<NodeT>::new(gil.python(), [body.len(), 2], false)}};
    body.into_par_iter().enumerate()
        .for_each(|(i, (a, b))| unsafe {
            *(result_array.t.uget_mut([i, 0]))  = a;
    ...
    ///     Prefix of the source node names.
    /// 
            pub fn get_directed_edge_ids_from_node_curie_prefixes(&self, src_node_name_prefixes: Option<Vec<&str>>, dst_node_name_prefixes: Option<Vec<&str>>)-> Py<PyArray1<EdgeT>>{
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_directed_edge_ids_from_node_curie_prefixes(src_node_name_prefixes, dst_node_name_prefixes), EdgeT)
            }
    ...
    ///     Prefix of the source node names.
    /// 
            pub fn get_number_of_directed_edges_from_node_curie_prefixes(&self, src_node_name_prefixes: Option<Vec<&str>>, dst_node_name_prefixes: Option<Vec<&str>>)-> EdgeT{
            self.inner.get_number_of_directed_edges_from_node_curie_prefixes(src_node_name_prefixes, dst_node_name_prefixes).into()
            }
    ...
    ///     Prefix of the source node names.
    /// 
            pub fn get_node_ids_from_node_curie_prefixes(&self, curie_prefixes: Vec<&str>)-> Py<PyArray1<NodeT>>{
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_node_ids_from_node_curie_prefixes(&curie_prefixes), NodeT)
            }
    ...
    /// 
            ...
            self.inner.get_node_names_from_node_curie_prefixes(curie_prefixes).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
    ...
    /// 
            ...
            self.inner.get_number_of_nodes_from_node_curie_prefixes(&curie_prefixes).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_node_names_prefixes(separator))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_node_ids_mapping_from_graph(&other.inner))?, NodeT)})
            }
            ...
            pub fn get_non_zero_subgraph_node_degrees(&self, subgraph: &Graph)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_non_zero_subgraph_node_degrees(&subgraph.inner))?, NodeT)})
            }
    ...
    /// 
            pub fn get_multigraph_edge_ids_from_node_ids(&self, src: NodeT, dst: NodeT)-> PyResult<Py<PyArray1<EdgeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_multigraph_edge_ids_from_node_ids(src.clone(), dst.clone()))?, EdgeT)})
            }
    ...
    ///      Destination node id of the edge.
    /// 
            pub fn get_number_of_multigraph_edges_from_node_ids(&self, src: NodeT, dst: NodeT)-> PyResult<usize>{
            Ok(pe!(self.inner.get_number_of_multigraph_edges_from_node_ids(src.clone(), dst.clone()))?.into())
            }
    ...
    /// 
            pub fn get_ancestors_jaccard_from_node_ids(&self, bfs: &ShortestPathsResultBFS, first_node_ids: Vec<NodeT>, second_node_ids: Vec<NodeT>)-> PyResult<Py<PyArray1<WeightT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_ancestors_jaccard_from_node_ids(bfs.into(), &first_node_ids, &second_node_ids))?, WeightT)})
            }
    ...
    /// 
            pub fn get_ancestors_jaccard_from_node_names(&self, bfs: &ShortestPathsResultBFS, first_node_names: Vec<String>, second_node_names: Vec<String>)-> PyResult<Py<PyArray1<WeightT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_ancestors_jaccard_from_node_names(bfs.into(), &first_node_names, &second_node_names))?, WeightT)})
            }
            ...
            #[pyo3(text_signature = "($self, src, dst)")]
                /// 
            pub fn get_heterogeneous_graphlet_ids_from_edge_node_ids(&self, src: NodeT, dst: NodeT)-> PyResult<HashMap<u16, u32>>{
            Ok(pe!(self.inner.get_heterogeneous_graphlet_ids_from_edge_node_ids(src.clone(), dst.clone()))?.into())
            }
            ...
            #[pyo3(text_signature = "($self, src, dst)")]
                /// 
            pub fn get_heterogeneous_graphlet_names_from_edge_node_ids(&self, src: NodeT, dst: NodeT)-> PyResult<HashMap<String, u32>>{
            Ok(pe!(self.inner.get_heterogeneous_graphlet_names_from_edge_node_ids(src.clone(), dst.clone()))?.into())
            }
            ...
            #[pyo3(text_signature = "($self, src, dst)")]
                /// 
            pub fn get_heterogeneous_graphlet_names_from_edge_node_names(&self, src: &str, dst: &str)-> PyResult<HashMap<String, u32>>{
            Ok(pe!(self.inner.get_heterogeneous_graphlet_names_from_edge_node_names(src, dst))?.into())
            }
    ...
    /// ----------
    /// 
            pub fn get_tendrils(&self, minimum_number_of_nodes_per_tendril: Option<NodeT>, compute_tendril_nodes: Option<bool>)-> PyResult<Vec<Tendril>>{
            Ok(pe!(self.inner.get_tendrils(minimum_number_of_nodes_per_tendril, compute_tendril_nodes))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_node_degree_geometric_distribution_threshold(&self, number_of_nodes_above_threshold: NodeT)-> f64{
            self.inner.get_node_degree_geometric_distribution_threshold(number_of_nodes_above_threshold.clone()).into()
            }
            ...
            self.inner.get_sparse_edge_weighting_methods().into_iter().map(|x| x.to_string()).collect::<Vec<_>>()
            }
            ...
            self.inner.get_edge_weighting_methods().into_iter().map(|x| x.to_string()).collect::<Vec<_>>()
            }
    ...
    /// 
            pub fn add_selfloops(&self, edge_type_name: Option<&str>, weight: Option<WeightT>)-> PyResult<Graph>{
...
to_ndarray_1d!(gil, pe!(self.inner.get_weighted_degree_centrality())?, f32)})
    ...
    /// If the given node ID does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_closeness_centrality_from_node_id(node_id.clone()).into()
            }
    ...
    /// ------
    /// If the given node ID does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_weighted_closeness_centrality_from_node_id(&self, node_id: NodeT, use_edge_weights_as_probabilities: bool)-> f32{
            self.inner.get_unchecked_weighted_closeness_centrality_from_node_id(node_id.clone(), use_edge_weights_as_probabilities.clone()).into()
            }
...
to_ndarray_1d!(gil, self.inner.get_closeness_centrality(), f32)
    ...
    ///     If the user has asked for the weights to be treated as probabilities but the weights are not between 0 and 1.
    /// 
            pub fn get_weighted_closeness_centrality(&self, use_edge_weights_as_probabilities: Option<bool>, verbose: Option<bool>)-> PyResult<Py<PyArray1<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_weighted_closeness_centrality(use_edge_weights_as_probabilities, verbose))?, f32)})
            }
    ...
    /// If the given node ID does not exist in the graph the method will panic.
            ...
            self.inner.get_unchecked_harmonic_centrality_from_node_id(node_id.clone()).into()
            }
    ...
    /// ------
    /// If the given node ID does not exist in the graph the method will panic.
            pub unsafe fn get_unchecked_weighted_harmonic_centrality_from_node_id(&self, node_id: NodeT, use_edge_weights_as_probabilities: bool)-> f32{
            self.inner.get_unchecked_weighted_harmonic_centrality_from_node_id(node_id.clone(), use_edge_weights_as_probabilities.clone()).into()
            }
...
to_ndarray_1d!(gil, self.inner.get_harmonic_centrality(), f32)
    ...
    ///     Whether to show an indicative progress bar.
    /// 
            pub fn get_weighted_harmonic_centrality(&self, use_edge_weights_as_probabilities: Option<bool>, verbose: Option<bool>)-> PyResult<Py<PyArray1<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_weighted_harmonic_centrality(use_edge_weights_as_probabilities, verbose))?, f32)})
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_stress_centrality(verbose))?, f32)})
    ...
    ///     If the graph is a multigraph.
    /// 
            pub fn get_betweenness_centrality(&self, edges_normalization: Option<bool>, min_max_normalization: Option<bool>, verbose: Option<bool>)-> PyResult<Py<PyArray1<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_betweenness_centrality(edges_normalization, min_max_normalization, verbose))?, f32)})
            }
    ...
    /// 
            pub fn get_approximated_betweenness_centrality_from_node_id(&self, node_id: NodeT, ant: Option<f32>, maximum_samples_number: Option<f32>, random_state: Option<u64>)-> PyResult<f32>{
            Ok(pe!(self.inner.get_approximated_betweenness_centrality_from_node_id(node_id.clone(), ant, maximum_samples_number, random_state))?.into())
            }
    ...
    /// 
            pub fn get_approximated_betweenness_centrality_from_node_name(&self, node_name: &str, ant: Option<f32>, maximum_samples_number: Option<f32>, random_state: Option<u64>)-> PyResult<f32>{
            Ok(pe!(self.inner.get_approximated_betweenness_centrality_from_node_name(node_name, ant, maximum_samples_number, random_state))?.into())
            }
    ...
    ///     If the provided node ID does not exist in the current graph instance.
    /// 
            pub fn get_weighted_approximated_betweenness_centrality_from_node_id(&self, node_id: NodeT, ant: Option<f32>, use_edge_weights_as_probabilities: Option<bool>, maximum_samples_number: Option<f32>, random_state: Option<u64>)-> PyResult<f32>{
            Ok(pe!(self.inner.get_weighted_approximated_betweenness_centrality_from_node_id(node_id.clone(), ant, use_edge_weights_as_probabilities, maximum_samples_number, random_state))?.into())
            }
    ...
    ///     If the provided node name does not exist in the current graph instance.
    /// 
            pub fn get_weighted_approximated_betweenness_centrality_from_node_name(&self, node_name: &str, ant: Option<f32>, use_edge_weights_as_probabilities: Option<bool>, maximum_samples_number: Option<f32>, random_state: Option<u64>)-> PyResult<f32>{
            Ok(pe!(self.inner.get_weighted_approximated_betweenness_centrality_from_node_name(node_name, ant, use_edge_weights_as_probabilities, maximum_samples_number, random_state))?.into())
            }
    ...
    /// 
            pub fn get_eigenvector_centrality(&self, maximum_iterations_number: Option<usize>, tollerance: Option<f32>)-> PyResult<Py<PyArray1<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_eigenvector_centrality(maximum_iterations_number, tollerance))?, f32)})
            }
    ...
    ///     The maximum error tollerance for convergence.
    /// 
            pub fn get_weighted_eigenvector_centrality(&self, maximum_iterations_number: Option<usize>, tollerance: Option<f32>)-> PyResult<Py<PyArray1<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_weighted_eigenvector_centrality(maximum_iterations_number, tollerance))?, f32)})
            }
    ...
    /// -------
    /// 
            pub fn get_base_16_tricodes_from_node_ids(&self, first: NodeT, second: NodeT, third: NodeT)-> PyResult<(u8, u8, u8)>{
            Ok({let (subresult_0, subresult_1, subresult_2) = pe!(self.inner.get_base_16_tricodes_from_node_ids(first.clone(), second.clone(), third.clone()))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.into())})
            }
    ...
    /// -------
    /// 
            pub fn get_base_13_tricodes_from_node_ids(&self, first: NodeT, second: NodeT, third: NodeT)-> PyResult<(u8, u8, u8)>{
            Ok({let (subresult_0, subresult_1, subresult_2) = pe!(self.inner.get_base_13_tricodes_from_node_ids(first.clone(), second.clone(), third.clone()))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.into())})
            }
    ...
    /// -------
    /// 
            pub fn get_base_30_tricodes_from_node_ids(&self, first: NodeT, second: NodeT, third: NodeT)-> PyResult<(u8, u8, u8)>{
            Ok({let (subresult_0, subresult_1, subresult_2) = pe!(self.inner.get_base_30_tricodes_from_node_ids(first.clone(), second.clone(), third.clone()))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.into())})
            }
    ...
    /// -------
    /// 
            pub fn get_base_64_tricodes_from_node_ids(&self, first: NodeT, second: NodeT, third: NodeT)-> PyResult<(u8, u8, u8)>{
            Ok({let (subresult_0, subresult_1, subresult_2) = pe!(self.inner.get_base_64_tricodes_from_node_ids(first.clone(), second.clone(), third.clone()))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.into())})
            }
    ...
    /// -------
    /// 
            pub fn get_base_16_tricodes_from_node_names(&self, first: &str, second: &str, third: &str)-> PyResult<(u8, u8, u8)>{
            Ok({let (subresult_0, subresult_1, subresult_2) = pe!(self.inner.get_base_16_tricodes_from_node_names(first, second, third))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.into())})
            }
    ...
    /// -------
    /// 
            pub fn get_base_13_tricodes_from_node_names(&self, first: &str, second: &str, third: &str)-> PyResult<(u8, u8, u8)>{
            Ok({let (subresult_0, subresult_1, subresult_2) = pe!(self.inner.get_base_13_tricodes_from_node_names(first, second, third))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.into())})
            }
    ...
    /// -------
    /// 
            pub fn get_base_30_tricodes_from_node_names(&self, first: &str, second: &str, third: &str)-> PyResult<(u8, u8, u8)>{
            Ok({let (subresult_0, subresult_1, subresult_2) = pe!(self.inner.get_base_30_tricodes_from_node_names(first, second, third))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.into())})
            }
    ...
    /// -------
    /// 
            pub fn get_base_64_tricodes_from_node_names(&self, first: &str, second: &str, third: &str)-> PyResult<(u8, u8, u8)>{
            Ok({let (subresult_0, subresult_1, subresult_2) = pe!(self.inner.get_base_64_tricodes_from_node_names(first, second, third))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.into())})
            }
...
to_ndarray_1d!(gil, self.inner.get_base_30_triad_census().to_vec(), u64)
    ...
    /// ----------
    /// 
            pub fn get_stars(&self, minimum_number_of_nodes_per_star: Option<NodeT>)-> PyResult<Vec<Star>>{
            Ok(pe!(self.inner.get_stars(minimum_number_of_nodes_per_star))?.into_iter().map(|x| x.into()).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_undirected_louvain_community_detection(&self, recursion_minimum_improvement: Option<f64>, first_phase_minimum_improvement: Option<f64>, patience: Option<usize>, random_state: Option<u64>)-> PyResult<Vec<Vec<usize>>>{
            Ok(pe!(self.inner.get_undirected_louvain_community_detection(recursion_minimum_improvement, first_phase_minimum_improvement, patience, random_state))?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
    ...
    /// 
            pub fn get_directed_modularity_from_node_community_memberships(&self, node_community_memberships: Vec<NodeT>)-> PyResult<f64>{
            Ok(pe!(self.inner.get_directed_modularity_from_node_community_memberships(&node_community_memberships))?.into())
            }
    ...
    ///     If the number of provided memberships does not match the number of nodes of the graph.
    /// 
            pub fn get_undirected_modularity_from_node_community_memberships(&self, node_community_memberships: Vec<NodeT>)-> PyResult<f64>{
            Ok(pe!(self.inner.get_undirected_modularity_from_node_community_memberships(&node_community_memberships))?.into())
            }
    ...
    ///  number of nodes in the graph.
            pub unsafe fn get_unchecked_structural_distance_from_node_ids(&self, source_node_id: NodeT, destination_node_id: NodeT, maximal_hop_distance: usize)-> Py<PyArray1<f32>>{
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_unchecked_structural_distance_from_node_ids(source_node_id.clone(), destination_node_id.clone(), maximal_hop_distance.clone()), f32)
            }
    ...
    /// If the graph does not contain nodes, the return value will be undefined.
            ...
            self.inner.get_unchecked_minimum_preferential_attachment().into()
            }
    ...
    /// If the graph does not contain nodes, the return value will be undefined.
            ...
            self.inner.get_unchecked_maximum_preferential_attachment().into()
            }
    ...
    /// If the graph does not contain nodes, the return value will be undefined.
            ...
            self.inner.get_unchecked_weighted_minimum_preferential_attachment().into()
            }
    ...
    /// If the graph does not contain nodes, the return value will be undefined.
            ...
            self.inner.get_unchecked_weighted_maximum_preferential_attachment().into()
            }
    ...
    /// If either of the provided one and two node IDs are higher than the
    ///  number of nodes in the graph.
            pub unsafe fn get_unchecked_preferential_attachment_from_node_ids(&self, source_node_id: NodeT, destination_node_id: NodeT, normalize: bool)-> f32{
            self.inner.get_unchecked_preferential_attachment_from_node_ids(source_node_id.clone(), destination_node_id.clone(), normalize.clone()).into()
            }
    ...
    /// 
            pub fn get_preferential_attachment_from_node_ids(&self, source_node_id: NodeT, destination_node_id: NodeT, normalize: bool)-> PyResult<f32>{
            Ok(pe!(self.inner.get_preferential_attachment_from_node_ids(source_node_id.clone(), destination_node_id.clone(), normalize.clone()))?.into())
            }
    ...
    /// 
            pub fn get_preferential_attachment_from_node_names(&self, first_node_name: &str, second_node_name: &str, normalize: bool)-> PyResult<f32>{
            Ok(pe!(self.inner.get_preferential_attachment_from_node_names(first_node_name, second_node_name, normalize.clone()))?.into())
            }
    ...
    /// If either of the provided one and two node IDs are higher than the
    ///  number of nodes in the graph.
            pub unsafe fn get_unchecked_weighted_preferential_attachment_from_node_ids(&self, source_node_id: NodeT, destination_node_id: NodeT, normalize: bool)-> f32{
            self.inner.get_unchecked_weighted_preferential_attachment_from_node_ids(source_node_id.clone(), destination_node_id.clone(), normalize.clone()).into()
            }
    ...
    ///     If either of the node IDs are higher than the number of nodes in the graph.
    /// 
            pub fn get_weighted_preferential_attachment_from_node_ids(&self, source_node_id: NodeT, destination_node_id: NodeT, normalize: bool)-> PyResult<f32>{
            Ok(pe!(self.inner.get_weighted_preferential_attachment_from_node_ids(source_node_id.clone(), destination_node_id.clone(), normalize.clone()))?.into())
            }
    ...
    ///     If either of the given node names do not exist in the current graph.
    /// 
            pub fn get_weighted_preferential_attachment_from_node_names(&self, first_node_name: &str, second_node_name: &str, normalize: bool)-> PyResult<f32>{
            Ok(pe!(self.inner.get_weighted_preferential_attachment_from_node_names(first_node_name, second_node_name, normalize.clone()))?.into())
            }
    ...
    /// If either of the provided one and two node IDs are higher than the
    ///  number of nodes in the graph.
            pub unsafe fn get_unchecked_neighbours_intersection_size_from_node_ids(&self, source_node_id: NodeT, destination_node_id: NodeT)-> f32{
            self.inner.get_unchecked_neighbours_intersection_size_from_node_ids(source_node_id.clone(), destination_node_id.clone()).into()
            }
    ...
    /// If either of the provided one and two node IDs are higher than the
    ///  number of nodes in the graph.
            pub unsafe fn get_unchecked_jaccard_coefficient_from_node_ids(&self, source_node_id: NodeT, destination_node_id: NodeT)-> f32{
            self.inner.get_unchecked_jaccard_coefficient_from_node_ids(source_node_id.clone(), destination_node_id.clone()).into()
            }
    ...
    ///     If either of the node IDs are higher than the number of nodes in the graph.
    /// 
            pub fn get_jaccard_coefficient_from_node_ids(&self, source_node_id: NodeT, destination_node_id: NodeT)-> PyResult<f32>{
            Ok(pe!(self.inner.get_jaccard_coefficient_from_node_ids(source_node_id.clone(), destination_node_id.clone()))?.into())
            }
    ...
    ///     If either of the given node names do not exist in the current graph.
    /// 
            pub fn get_jaccard_coefficient_from_node_names(&self, first_node_name: &str, second_node_name: &str)-> PyResult<f32>{
            Ok(pe!(self.inner.get_jaccard_coefficient_from_node_names(first_node_name, second_node_name))?.into())
            }
    ...
    /// If either of the provided one and two node IDs are higher than the
    ///  number of nodes in the graph.
            pub unsafe fn get_unchecked_adamic_adar_index_from_node_ids(&self, source_node_id: NodeT, destination_node_id: NodeT)-> f32{
            self.inner.get_unchecked_adamic_adar_index_from_node_ids(source_node_id.clone(), destination_node_id.clone()).into()
            }
    ...
    ///     If either of the node IDs are higher than the number of nodes in the graph.
    /// 
            pub fn get_adamic_adar_index_from_node_ids(&self, source_node_id: NodeT, destination_node_id: NodeT)-> PyResult<f32>{
            Ok(pe!(self.inner.get_adamic_adar_index_from_node_ids(source_node_id.clone(), destination_node_id.clone()))?.into())
            }
    ...
    ///     If either of the given node names do not exist in the current graph.
    /// 
            pub fn get_adamic_adar_index_from_node_names(&self, first_node_name: &str, second_node_name: &str)-> PyResult<f32>{
            Ok(pe!(self.inner.get_adamic_adar_index_from_node_names(first_node_name, second_node_name))?.into())
            }
    ...
    /// If either of the provided one and two node IDs are higher than the
    ///  number of nodes in the graph.
            pub unsafe fn get_unchecked_resource_allocation_index_from_node_ids(&self, source_node_id: NodeT, destination_node_id: NodeT)-> f32{
            self.inner.get_unchecked_resource_allocation_index_from_node_ids(source_node_id.clone(), destination_node_id.clone()).into()
            }
    ...
    /// If either of the provided one and two node IDs are higher than the
    ///  number of nodes in the graph.
            pub unsafe fn get_unchecked_weighted_resource_allocation_index_from_node_ids(&self, source_node_id: NodeT, destination_node_id: NodeT)-> f32{
            self.inner.get_unchecked_weighted_resource_allocation_index_from_node_ids(source_node_id.clone(), destination_node_id.clone()).into()
            }
    ...
    ///     If either of the node IDs are higher than the number of nodes in the graph.
    /// 
            pub fn get_resource_allocation_index_from_node_ids(&self, source_node_id: NodeT, destination_node_id: NodeT)-> PyResult<f32>{
            Ok(pe!(self.inner.get_resource_allocation_index_from_node_ids(source_node_id.clone(), destination_node_id.clone()))?.into())
            }
    ...
    ///     If either of the given node names do not exist in the current graph.
    /// 
            pub fn get_resource_allocation_index_from_node_names(&self, first_node_name: &str, second_node_name: &str)-> PyResult<f32>{
            Ok(pe!(self.inner.get_resource_allocation_index_from_node_names(first_node_name, second_node_name))?.into())
            }
    ...
    ///     If either of the node IDs are higher than the number of nodes in the graph.
    /// 
            pub fn get_weighted_resource_allocation_index_from_node_ids(&self, source_node_id: NodeT, destination_node_id: NodeT)-> PyResult<f32>{
            Ok(pe!(self.inner.get_weighted_resource_allocation_index_from_node_ids(source_node_id.clone(), destination_node_id.clone()))?.into())
            }
    ...
    ///     If either of the given node names do not exist in the current graph.
    /// 
            pub fn get_weighted_resource_allocation_index_from_node_names(&self, first_node_name: &str, second_node_name: &str)-> PyResult<f32>{
            Ok(pe!(self.inner.get_weighted_resource_allocation_index_from_node_names(first_node_name, second_node_name))?.into())
            }
            ...
            self.inner.get_available_edge_metrics_names().into_iter().map(|x| x.to_string()).collect::<Vec<_>>()
            }
    ...
    /// If the given node IDs do not exist in the graph this method will panic.
            pub unsafe fn get_unchecked_all_edge_metrics_from_node_ids_tuple(&self, source_node_id: NodeT, destination_node_id: NodeT, normalize: bool)-> Py<PyArray1<f32>>{
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_unchecked_all_edge_metrics_from_node_ids_tuple(source_node_id.clone(), destination_node_id.clone(), normalize.clone()).to_vec(), f32)
            }
    ...
    /// 
            pub fn get_all_edge_metrics_from_node_ids_tuple(&self, source_node_id: NodeT, destination_node_id: NodeT, normalize: bool)-> PyResult<Py<PyArray1<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_all_edge_metrics_from_node_ids_tuple(source_node_id.clone(), destination_node_id.clone(), normalize.clone()))?.to_vec(), f32)})
            }
    ...
    /// ------
    /// If the given node IDs do not exist in the graph this method will panic.
            pub fn get_all_edge_metrics_from_node_ids(&self, source_node_ids: Vec<NodeT>, destination_node_ids: Vec<NodeT>, normalize: bool)-> PyResult<Py<PyArray2<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_all_edge_metrics_from_node_ids(source_node_ids, destination_node_ids, normalize.clone()))?, f32)})
            }
    ...
    /// 
            pub fn get_preferential_attachment_scores(&self, normalize: Option<bool>, subgraph: Option<& Graph>)-> PyResult<Py<PyArray1<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_preferential_attachment_scores(normalize, subgraph.map(|sg| &sg.inner)))?, f32)})
            }
    ...
    ///     If the provided subgraph graph does not share a compatible vocabulary with the current graph instance.
    /// 
            pub fn get_resource_allocation_index_scores(&self, subgraph: Option<& Graph>)-> PyResult<Py<PyArray1<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_resource_allocation_index_scores(subgraph.map(|sg| &sg.inner)))?, f32)})
            }
    ...
    ///     If the provided subgraph graph does not share a compatible vocabulary with the current graph instance.
    /// 
            pub fn get_jaccard_coefficient_scores(&self, subgraph: Option<& Graph>)-> PyResult<Py<PyArray1<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_jaccard_coefficient_scores(subgraph.map(|sg| &sg.inner)))?, f32)})
            }
    ...
    /// 
            ...
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_adamic_adar_scores(subgraph.map(|sg| &sg.inner)))?, f32)})
            }
    ...
    ///     If the provided subgraph graph does not share a compatible vocabulary with the current graph instance.
    /// 
            pub fn get_all_edge_metrics(&self, normalize: Option<bool>, subgraph: Option<& Graph>)-> PyResult<Py<PyArray2<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_all_edge_metrics(normalize, subgraph.map(|sg| &sg.inner)))?, f32)})
            }
    ...
    ///     If the provided subgraph graph does not share a compatible vocabulary with the current graph instance.
    /// 
            pub fn get_all_directed_edge_metrics(&self, normalize: Option<bool>, subgraph: Option<& Graph>)-> PyResult<Py<PyArray2<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_all_directed_edge_metrics(normalize, subgraph.map(|sg| &sg.inner)))?, f32)})
            }
    ...
    ///     If the provided subgraph graph does not share a compatible vocabulary with the current graph instance.
    /// 
            pub fn get_all_upper_triangular_edge_metrics(&self, normalize: Option<bool>, subgraph: Option<& Graph>)-> PyResult<Py<PyArray2<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_all_upper_triangular_edge_metrics(normalize, subgraph.map(|sg| &sg.inner)))?, f32)})
            }
    ...
    ///     If the provided subgraph graph does not share a compatible vocabulary with the current graph instance.
    /// 
            pub fn get_all_lower_triangular_edge_metrics(&self, normalize: Option<bool>, subgraph: Option<& Graph>)-> PyResult<Py<PyArray2<f32>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_2d!(gil, pe!(self.inner.get_all_lower_triangular_edge_metrics(normalize, subgraph.map(|sg| &sg.inner)))?, f32)})
            }
            ...
            Ok(pe!(self.inner.get_isomorphic_node_type_ids_groups())?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
            ...
            Ok(pe!(self.inner.get_isomorphic_node_type_names_groups())?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
            ...
            #[pyo3(text_signature = "($self)")]
                /// Returns vector with isomorphic node type groups IDs
            pub fn get_approximated_isomorphic_node_type_ids_groups(&self)-> PyResult<Vec<Vec<NodeTypeT>>>{
            Ok(pe!(self.inner.get_approximated_isomorphic_node_type_ids_groups())?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
            ...
            Ok(pe!(self.inner.get_approximated_isomorphic_node_type_names_groups())?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
            ...
            Ok(pe!(self.inner.get_number_of_approximated_isomorphic_node_type_groups())?.into())
            }
    ...
    ///     Minimum number of edges to detect edge types topological synonims. By default, 5.
    /// 
            pub fn get_isomorphic_edge_type_ids_groups(&self, minimum_number_of_edges: Option<EdgeT>)-> PyResult<Vec<Vec<EdgeTypeT>>>{
            Ok(pe!(self.inner.get_isomorphic_edge_type_ids_groups(minimum_number_of_edges))?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
    ...
    ///     Minimum number of edges to detect edge types topological synonims. By default, 5.
    /// 
            pub fn get_isomorphic_edge_type_names_groups(&self, minimum_number_of_edges: Option<EdgeT>)-> PyResult<Vec<Vec<String>>>{
            Ok(pe!(self.inner.get_isomorphic_edge_type_names_groups(minimum_number_of_edges))?.into_iter().map(|x| x.into_iter().map(|x| x.into()).collect::<Vec<_>>()).collect::<Vec<_>>())
            }
    ...
    ///     Minimum number of edges to detect edge types topological synonims. By default, 5.
    /// 
            pub fn get_number_of_isomorphic_edge_type_groups(&self, minimum_number_of_edges: Option<EdgeT>)-> PyResult<EdgeTypeT>{
            Ok(pe!(self.inner.get_number_of_isomorphic_edge_type_groups(minimum_number_of_edges))?.into())
            }
    ...
    /// 
            pub unsafe fn has_unchecked_isomorphic_node_types_from_node_ids(&self, node_ids: Vec<NodeT>)-> bool{
            self.inner.has_unchecked_isomorphic_node_types_from_node_ids(&node_ids).into()
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.has_isomorphic_node_types_from_node_ids(&node_ids))?.into())
            }
    ...
    /// 
            pub fn from_csv(directed: bool, node_type_path: Option<String>, node_type_list_separator: Option<char>, node_types_column_number: Option<usize>, node_types_column: Option<String>, node_types_ids_column_number: Option<usize>, node_types_ids_column: Option<String>, number_of_node_types: Option<NodeTypeT>, numeric_node_type_ids: Option<bool>, minimum_node_type_id: Option<NodeTypeT>, node_type_list_header: Option<bool>, node_type_list_support_balanced_quotes: Option<bool>, node_type_list_rows_to_skip: Option<usize>, node_type_list_is_correct: Option<bool>, node_type_list_max_rows_number: Option<usize>, node_type_list_comment_symbol: Option<String>, load_node_type_list_in_parallel: Option<bool>, node_path: Option<String>, node_list_separator: Option<char>, node_list_header: Option<bool>, node_list_support_balanced_quotes: Option<bool>, node_list_rows_to_skip: Option<usize>, node_list_is_correct: Option<bool>, node_list_max_rows_number: Option<usize>, node_list_comment_symbol: Option<String>, default_node_type: Option<String>, nodes_column_number: Option<usize>, nodes_column: Option<String>, node_types_separator: Option<char>, node_list_node_types_column_number: Option<usize>, node_list_node_types_column: Option<String>, node_ids_column: Option<String>, node_ids_column_number: Option<usize>, number_of_nodes: Option<NodeT>, minimum_node_id: Option<NodeT>, numeric_node_ids: Option<bool>, node_list_numeric_node_type_ids: Option<bool>, skip_node_types_if_unavailable: Option<bool>, load_node_list_in_parallel: Option<bool>, edge_type_path: Option<String>, edge_types_column_number: Option<usize>, edge_types_column: Option<String>, edge_types_ids_column_number: Option<usize>, edge_types_ids_column: Option<String>, number_of_edge_types: Option<EdgeTypeT>, numeric_edge_type_ids: Option<bool>, minimum_edge_type_id: Option<EdgeTypeT>, edge_type_list_separator: Option<char>, edge_type_list_header: Option<bool>, edge_type_list_support_balanced_quotes: Option<bool>, edge_type_list_rows_to_skip: Option<usize>, edge_type_list_is_correct: Option<bool>, edge_type_list_max_rows_number: Option<usize>, edge_type_list_comment_symbol: Option<String>, load_edge_type_list_in_parallel: Option<bool>, edge_path: Option<String>, edge_list_separator: Option<char>, edge_list_header: Option<bool>, edge_list_support_balanced_quotes: Option<bool>, edge_list_rows_to_skip: Option<usize>, sources_column_number: Option<usize>, sources_column: Option<String>, destinations_column_number: Option<usize>, destinations_column: Option<String>, edge_list_edge_types_column_number: Option<usize>, edge_list_edge_types_column: Option<String>, default_edge_type: Option<String>, weights_column_number: Option<usize>, weights_column: Option<String>, default_weight: Option<WeightT>, edge_ids_column: Option<String>, edge_ids_column_number: Option<usize>, edge_list_numeric_edge_type_ids: Option<bool>, edge_list_numeric_node_ids: Option<bool>, skip_weights_if_unavailable: Option<bool>, skip_edge_types_if_unavailable: Option<bool>, edge_list_is_complete: Option<bool>, edge_list_may_contain_duplicates: Option<bool>, edge_list_is_sorted: Option<bool>, edge_list_is_correct: Option<bool>, edge_list_max_rows_number: Option<usize>, edge_list_comment_symbol: Option<String>, number_of_edges: Option<EdgeT>, load_edge_list_in_parallel: Option<bool>, remove_chevrons: Option<bool>, remove_spaces: Option<bool>, verbose: Option<bool>, may_have_singletons: Option<bool>, may_have_singleton_with_selfloops: Option<bool>, name: Option<String>)-> PyResult<Graph>{
            Ok(pe!(graph::Graph::from_csv(directed.clone(), node_type_path, node_type_list_separator, node_types_column_number, node_types_column, node_types_ids_column_number, node_types_ids_column, number_of_node_types, numeric_node_type_ids, minimum_node_type_id, node_type_list_header, node_type_list_support_balanced_quotes, node_type_list_rows_to_skip, node_type_list_is_correct, node_type_list_max_rows_number, node_type_list_comment_symbol, load_node_type_list_in_parallel, node_path, node_list_separator, node_list_header, node_list_support_balanced_quotes, node_list_rows_to_skip, node_list_is_correct, node_list_max_rows_number, node_list_comment_symbol, default_node_type, nodes_column_number, nodes_column, node_types_separator, node_list_node_types_column_number, node_list_node_types_column, node_ids_column, node_ids_column_number, number_of_nodes, minimum_node_id, numeric_node_ids, node_list_numeric_node_type_ids, skip_node_types_if_unavailable, load_node_list_in_parallel, edge_type_path, edge_types_column_number, edge_types_column, edge_types_ids_column_number, edge_types_ids_column, number_of_edge_types, numeric_edge_type_ids, minimum_edge_type_id, edge_type_list_separator, edge_type_list_header, edge_type_list_support_balanced_quotes, edge_type_list_rows_to_skip, edge_type_list_is_correct, edge_type_list_max_rows_number, edge_type_list_comment_symbol, load_edge_type_list_in_parallel, edge_path, edge_list_separator, edge_list_header, edge_list_support_balanced_quotes, edge_list_rows_to_skip, sources_column_number, sources_column, destinations_column_number, destinations_column, edge_list_edge_types_column_number, edge_list_edge_types_column, default_edge_type, weights_column_number, weights_column, default_weight, edge_ids_column, edge_ids_column_number, edge_list_numeric_edge_type_ids, edge_list_numeric_node_ids, skip_weights_if_unavailable, skip_edge_types_if_unavailable, edge_list_is_complete, edge_list_may_contain_duplicates, edge_list_is_sorted, edge_list_is_correct, edge_list_max_rows_number, edge_list_comment_symbol, number_of_edges, load_edge_list_in_parallel, remove_chevrons, remove_spaces, verbose, may_have_singletons, may_have_singleton_with_selfloops, name))?.into())
            }
...
&[("connected", 0.9867929), ("from", 0.24942788), ("id", 0.412462), ("is", 0.87402433), ("node", 0.14584725), ("unchecked", 0.5054528)],
&[("connected", 1.3103347), ("from", 0.3312083), ("id", 0.5476967), ("is", 1.1605924), ("node", 0.19366646)],
&[("disconnected", 0.9408769), ("from", 0.19405593), ("id", 0.32089716), ("is", 0.6799946), ("node", 0.21133932), ("unchecked", 0.39324442)],
&[("from", 0.24942788), ("id", 0.412462), ("is", 0.87402433), ("node", 0.14584725), ("singleton", 0.73318326), ("unchecked", 0.5054528)],
&[("from", 0.3312083), ("id", 0.5476967), ("is", 1.1605924), ("node", 0.19366646), ("singleton", 0.97357357)],
&[("from", 0.15501031), ("id", 0.25633007), ("is", 0.5431742), ("node", 0.090638734), ("selfloops", 0.53541404), ("singleton", 0.45564663), ("unchecked", 0.31412047), ("with", 0.4743904)],
&[("from", 0.19405593), ("id", 0.32089716), ("is", 0.6799946), ("node", 0.113469765), ("selfloops", 0.67027974), ("singleton", 0.57041967), ("with", 0.5938848)],
&[("from", 0.24942788), ("is", 0.87402433), ("name", 0.57414216), ("node", 0.14584725), ("singleton", 0.73318326), ("unchecked", 0.5054528)],
&[("from", 0.3312083), ("is", 1.1605924), ("name", 0.7623873), ("node", 0.19366646), ("singleton", 0.97357357)],
&[("has", 1.5832652), ("name", 1.5329753), ("node", 0.38941613)],
&[("has", 1.0888427), ("id", 0.7573753), ("node", 0.26780915), ("type", 0.7218666)],
&[("has", 1.0888427), ("name", 1.0542574), ("node", 0.26780915), ("type", 0.7218666)],
&[("edge", 0.5437204), ("has", 1.0888427), ("id", 0.7573753), ("type", 0.7218666)],
&[("edge", 0.5437204), ("has", 1.0888427), ("name", 1.0542574), ("type", 0.7218666)],
&[("edge", 0.39319196), ("from", 0.3312083), ("has", 0.7873977), ("ids", 0.4781446), ("node", 0.19366646)],
&[("from", 0.3312083), ("has", 0.7873977), ("id", 0.5476967), ("node", 0.19366646), ("selfloop", 1.5426534)],
&[("and", 0.45714217), ("edge", 0.28662342), ("from", 0.12652998), ("has", 0.3008059), ("id", 0.20923404), ("ids", 0.18266337), ("node", 0.0739855), ("type", 0.19942436)],
&[("from", 0.19405593), ("id", 0.32089716), ("is", 0.6799946), ("node", 0.21133932), ("trap", 0.76772904), ("unchecked", 0.39324442)],
&[("from", 0.24942788), ("id", 0.412462), ("is", 0.87402433), ("node", 0.2664172), ("trap", 0.9867929)],
&[("from", 0.12652998), ("id", 0.20923404), ("is", 0.44337574), ("node", 0.1411762), ("selfloops", 0.4370414), ("trap", 0.5005811), ("unchecked", 0.25640652), ("with", 0.38722974)],
&[("from", 0.15501031), ("id", 0.25633007), ("is", 0.5431742), ("node", 0.17118385), ("selfloops", 0.53541404), ("trap", 0.61325574), ("with", 0.4743904)],
&[("are", 1.2093469), ("from", 0.24942788), ("ids", 0.36008334), ("isomorphic", 0.74778455), ("node", 0.14584725), ("unchecked", 0.5054528)],
&[("are", 1.6058578), ("from", 0.3312083), ("ids", 0.4781446), ("isomorphic", 0.9929622), ("node", 0.19366646)],
&[("are", 1.6058578), ("from", 0.3312083), ("isomorphic", 0.9929622), ("names", 0.6370931), ("node", 0.19366646)],
&[("and", 0.7011078), ("has", 0.46133867), ("name", 0.8319583), ("node", 0.21133932), ("type", 0.30585226)],
&[("edge", 0.39319196), ("from", 0.3312083), ("has", 0.7873977), ("names", 0.6370931), ("node", 0.19366646)],
&[("and", 0.45714217), ("edge", 0.28662342), ("from", 0.12652998), ("has", 0.3008059), ("name", 0.2912513), ("names", 0.24338573), ("node", 0.0739855), ("type", 0.19942436)],
&[("and", 0.45714217), ("edge", 0.28662342), ("from", 0.12652998), ("has", 0.3008059), ("id", 0.3992521), ("node", 0.0739855), ("type", 0.19942436)],
&[("and", 0.3799311), ("edge", 0.24007486), ("from", 0.105159126), ("has", 0.24999994), ("id", 0.33441225), ("node", 0.061489392), ("type", 0.16574168), ("unchecked", 0.21309958)],
&[("components", 3.2289894), ("connected", 2.6347642), ("strongly", 3.9247627)],
&[("coo", 1.8951929), ("get", 0.15653217), ("jaccard", 1.8516018), ("matrix", 1.7756627)],
&[("get", 0.22761041), ("graph", 1.9768125), ("jaccard", 2.6923785)],
&[("coo", 1.0321105), ("get", 0.085246466), ("intersection", 1.2689577), ("matrix", 0.96701515), ("neighbours", 1.2689577), ("size", 1.1617486)],
&[("get", 0.113196395), ("graph", 0.9831187), ("intersection", 1.6850134), ("neighbours", 1.6850134), ("size", 1.5426534)],
&[("ancestors", 1.1221241), ("coo", 1.0321105), ("get", 0.085246466), ("matrix", 0.96701515), ("shared", 1.3487675), ("size", 1.1617486)],
&[("ancestors", 1.4900371), ("get", 0.113196395), ("graph", 0.9831187), ("shared", 1.7909907), ("size", 1.5426534)],
&[("ancestors", 1.4900371), ("coo", 1.3705107), ("get", 0.113196395), ("jaccard", 1.3389878), ("matrix", 1.2840723)],
&[("ancestors", 2.0604784), ("get", 0.15653217), ("graph", 1.3594929), ("jaccard", 1.8516018)],
&[("adamic", 1.4900371), ("adar", 1.4900371), ("coo", 1.3705107), ("get", 0.113196395), ("matrix", 1.2840723)],
&[("adamic", 2.0604784), ("adar", 2.0604784), ("get", 0.15653217), ("graph", 1.3594929)],
&[("coo", 1.8951929), ("get", 0.15653217), ("laplacian", 1.9436368), ("matrix", 1.7756627)],
&[("get", 0.22761041), ("graph", 1.9768125), ("laplacian", 2.8262048)],
&[("coo", 1.0321105), ("get", 0.085246466), ("laplacian", 1.0584928), ("left", 1.3487675), ("matrix", 0.96701515), ("normalized", 1.1221241)],
&[("get", 0.113196395), ("graph", 0.9831187), ("laplacian", 1.405543), ("left", 1.7909907), ("normalized", 1.4900371)],
&[("coo", 1.0321105), ("get", 0.085246466), ("laplacian", 1.0584928), ("matrix", 0.96701515), ("normalized", 1.1221241), ("right", 1.3487675)],
&[("get", 0.113196395), ("graph", 0.9831187), ("laplacian", 1.405543), ("normalized", 1.4900371), ("right", 1.7909907)],
&[("coo", 1.0321105), ("get", 0.085246466), ("laplacian", 1.0584928), ("matrix", 0.96701515), ("normalized", 1.1221241), ("symmetric", 1.3487675)],
&[("get", 0.113196395), ("graph", 0.9831187), ("laplacian", 1.405543), ("normalized", 1.4900371), ("symmetric", 1.7909907)],
&[("by", 1.0881811), ("degree", 0.7979063), ("increasing", 1.3487675), ("node", 0.14584725), ("outbound", 1.2093469), ("sort", 1.2093469)],
&[("by", 1.0881811), ("decreasing", 1.3487675), ("degree", 0.7979063), ("node", 0.14584725), ("outbound", 1.2093469), ("sort", 1.2093469)],
&[("by", 1.4449652), ("lexicographic", 1.7909907), ("node", 0.19366646), ("order", 1.7909907), ("sort", 1.6058578)],
&[("bfs", 0.9872544), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("node", 0.113469765), ("sorting", 0.9872544), ("topological", 0.9872544)],
&[("bfs", 0.7886109), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("node", 0.090638734), ("reversed", 0.9135099), ("sorting", 0.7886109), ("topological", 0.7886109)],
&[("bfs", 0.7886109), ("by", 0.6762648), ("from", 0.15501031), ("id", 0.25633007), ("node", 0.090638734), ("sort", 0.7515649), ("sorting", 0.7886109), ("topological", 0.7886109)],
&[("get", 0.22761041), ("histograms", 3.9247627), ("predictions", 3.6012464)],
&[("filtered", 3.9247627), ("get", 0.22761041), ("predictions", 3.6012464)],
&[("components", 4.979057), ("remove", 2.9084692)],
&[("overlaps", 9.821147)],
&[("contains", 9.011596)],
&[("bipartite", 2.996102), ("edges", 2.18216), ("get", 0.22761041)],
&[("bipartite", 2.0604784), ("edge", 0.5437204), ("get", 0.15653217), ("names", 0.8809959)],
&[("edges", 2.18216), ("get", 0.22761041), ("star", 3.388152)],
&[("edge", 0.5437204), ("get", 0.15653217), ("names", 0.8809959), ("star", 2.3300989)],
&[("clique", 2.9054735), ("edges", 2.18216), ("get", 0.22761041)],
&[("clique", 1.9981514), ("edge", 0.5437204), ("get", 0.15653217), ("names", 0.8809959)],
&[("id", 1.1012849), ("node", 0.38941613), ("validate", 2.8262048)],
&[("ids", 0.9614324), ("node", 0.38941613), ("validate", 2.8262048)],
&[("edge", 0.79061335), ("id", 1.1012849), ("validate", 2.8262048)],
&[("edge", 0.79061335), ("ids", 0.9614324), ("validate", 2.8262048)],
&[("contain", 1.2093469), ("must", 0.93181056), ("node", 0.14584725), ("not", 1.1221241), ("types", 0.4897214), ("unknown", 0.8496751)],
&[("contain", 1.2093469), ("edge", 0.29610685), ("must", 0.93181056), ("not", 1.1221241), ("types", 0.4897214), ("unknown", 0.8496751)],
&[("id", 0.7573753), ("node", 0.26780915), ("type", 0.7218666), ("validate", 1.9436368)],
&[("ids", 0.661196), ("node", 0.26780915), ("type", 0.7218666), ("validate", 1.9436368)],
&[("edge", 0.5437204), ("id", 0.7573753), ("type", 0.7218666), ("validate", 1.9436368)],
&[("edge", 0.5437204), ("ids", 0.661196), ("type", 0.7218666), ("validate", 1.9436368)],
&[("have", 2.2206397), ("must", 1.711019), ("node", 0.26780915), ("ontologies", 2.1332383)],
&[("be", 3.1019008), ("must", 2.4879599), ("undirected", 2.9054735)],
&[("acyclic", 2.476648), ("be", 2.1332383), ("directed", 1.3210373), ("must", 1.711019)],
&[("have", 1.6058578), ("must", 1.2373252), ("nodes", 0.8635923), ("not", 1.4900371), ("trap", 1.3103347)],
&[("be", 3.1019008), ("multigraph", 3.1019008), ("must", 2.4879599)],
&[("be", 2.1332383), ("multigraph", 2.1332383), ("must", 1.711019), ("not", 2.0604784)],
&[("contain", 2.2206397), ("identity", 2.476648), ("matrix", 1.7756627), ("must", 1.711019)],
&[("contain", 1.2093469), ("must", 0.93181056), ("nodes", 0.65035814), ("not", 1.1221241), ("singleton", 0.73318326), ("weighted", 0.70018625)],
&[("edges", 2.18216), ("have", 3.2289894), ("must", 2.4879599)],
&[("have", 3.2289894), ("must", 2.4879599), ("nodes", 1.736474)],
&[("be", 3.1019008), ("connected", 2.6347642), ("must", 2.4879599)],
&[("must", 1.711019), ("node", 0.26780915), ("share", 2.6991367), ("vocabulary", 2.6991367)],
&[("edge", 0.5437204), ("get", 0.15653217), ("total", 1.7421427), ("weights", 1.6291134)],
&[("edge", 0.5437204), ("get", 0.15653217), ("mininum", 2.6991367), ("weight", 1.7421427)],
&[("edge", 0.5437204), ("get", 0.15653217), ("maximum", 1.8951929), ("weight", 1.7421427)],
&[("degree", 1.0595174), ("get", 0.113196395), ("maximum", 1.3705107), ("node", 0.19366646), ("unchecked", 0.6711767)],
&[("degree", 1.0595174), ("get", 0.113196395), ("minimum", 1.4449652), ("node", 0.19366646), ("unchecked", 0.6711767)],
&[("degree", 1.0595174), ("get", 0.113196395), ("maximum", 1.3705107), ("node", 0.19366646), ("weighted", 0.9297577)],
&[("degree", 1.0595174), ("get", 0.113196395), ("minimum", 1.4449652), ("node", 0.19366646), ("weighted", 0.9297577)],
&[("get", 0.085246466), ("nodes", 0.65035814), ("number", 0.6134378), ("of", 0.6134378), ("singleton", 0.73318326), ("weighted", 0.70018625)],
&[("get", 0.15653217), ("number", 1.1264132), ("of", 1.1264132), ("selfloops", 1.5819814)],
&[("get", 0.113196395), ("number", 0.81456685), ("of", 0.81456685), ("selfloops", 1.1440115), ("unique", 1.3103347)],
&[("edges", 0.81727993), ("features", 1.4699334), ("from", 0.24942788), ("generate", 0.9867929), ("new", 1.4699334), ("node", 0.14584725)],
&[("name", 2.3638268), ("set", 4.783088)],
&[("all", 1.2373252), ("edge", 0.39319196), ("inplace", 1.0595174), ("set", 1.5426534), ("types", 0.65028733)],
&[("all", 1.711019), ("edge", 0.5437204), ("set", 2.1332383), ("types", 0.8992413)],
&[("all", 1.2373252), ("inplace", 1.0595174), ("node", 0.19366646), ("set", 1.5426534), ("types", 0.65028733)],
&[("all", 1.711019), ("node", 0.26780915), ("set", 2.1332383), ("types", 0.8992413)],
&[("ids", 0.4781446), ("inplace", 1.0595174), ("node", 0.19366646), ("remove", 0.93804675), ("type", 0.5220186)],
&[("inplace", 1.0595174), ("node", 0.19366646), ("remove", 0.93804675), ("singleton", 0.97357357), ("types", 0.65028733)],
&[("add", 0.5520134), ("from", 0.12652998), ("id", 0.20923404), ("inplace", 0.40476254), ("name", 0.2912513), ("node", 0.1411762), ("prefixes", 0.46466494), ("type", 0.19942436)],
&[("edge", 0.24007486), ("from", 0.105159126), ("id", 0.17389452), ("ids", 0.15181161), ("inplace", 0.33639833), ("node", 0.061489392), ("replace", 0.50986224), ("type", 0.31873372)],
&[("edge", 0.28662342), ("from", 0.12652998), ("id", 0.20923404), ("ids", 0.18266337), ("node", 0.0739855), ("replace", 0.6134784), ("type", 0.3805336)],
&[("add", 0.6762648), ("from", 0.15501031), ("id", 0.25633007), ("name", 0.35680836), ("node", 0.17118385), ("prefixes", 0.5692553), ("type", 0.24431232)],
&[("add", 1.4449652), ("inplace", 1.0595174), ("name", 0.7623873), ("node", 0.19366646), ("type", 0.5220186)],
&[("add", 0.5520134), ("from", 0.12652998), ("inplace", 0.40476254), ("name", 0.5557541), ("node", 0.1411762), ("prefixes", 0.46466494), ("type", 0.19942436)],
&[("add", 1.4449652), ("edge", 0.39319196), ("inplace", 1.0595174), ("name", 0.7623873), ("type", 0.5220186)],
&[("edge", 0.24007486), ("from", 0.105159126), ("inplace", 0.33639833), ("name", 0.2420591), ("names", 0.202278), ("node", 0.061489392), ("replace", 0.50986224), ("type", 0.31873372)],
&[("edge", 0.28662342), ("from", 0.12652998), ("name", 0.2912513), ("names", 0.24338573), ("node", 0.0739855), ("replace", 0.6134784), ("type", 0.3805336)],
&[("add", 0.6762648), ("from", 0.15501031), ("name", 0.67388225), ("node", 0.17118385), ("prefixes", 0.5692553), ("type", 0.24431232)],
&[("homogeneous", 1.3389878), ("inplace", 1.0595174), ("node", 0.19366646), ("remove", 0.93804675), ("types", 0.65028733)],
&[("edge", 0.39319196), ("ids", 0.4781446), ("inplace", 1.0595174), ("remove", 0.93804675), ("type", 0.5220186)],
&[("edge", 0.39319196), ("inplace", 1.0595174), ("remove", 0.93804675), ("singleton", 0.97357357), ("types", 0.65028733)],
&[("inplace", 1.0595174), ("names", 0.6370931), ("node", 0.19366646), ("remove", 0.93804675), ("type", 0.5220186)],
&[("inplace", 1.0595174), ("name", 0.7623873), ("node", 0.19366646), ("remove", 0.93804675), ("type", 0.5220186)],
&[("id", 0.7573753), ("node", 0.26780915), ("remove", 1.2971658), ("type", 0.7218666)],
&[("node", 0.26780915), ("remove", 1.2971658), ("singleton", 1.3462936), ("types", 0.8992413)],
&[("homogeneous", 1.8516018), ("node", 0.26780915), ("remove", 1.2971658), ("types", 0.8992413)],
&[("inplace", 1.0595174), ("isomorphic", 0.9929622), ("node", 0.19366646), ("remove", 0.93804675), ("types", 0.65028733)],
&[("isomorphic", 1.3731048), ("node", 0.26780915), ("remove", 1.2971658), ("types", 0.8992413)],
&[("edge", 0.39319196), ("inplace", 1.0595174), ("isomorphic", 0.9929622), ("remove", 0.93804675), ("types", 0.65028733)],
&[("edge", 0.5437204), ("isomorphic", 1.3731048), ("remove", 1.2971658), ("types", 0.8992413)],
&[("names", 0.8809959), ("node", 0.26780915), ("remove", 1.2971658), ("type", 0.7218666)],
&[("name", 1.0542574), ("node", 0.26780915), ("remove", 1.2971658), ("type", 0.7218666)],
&[("edge", 0.39319196), ("inplace", 1.0595174), ("name", 0.7623873), ("remove", 0.93804675), ("type", 0.5220186)],
&[("edge", 0.5437204), ("id", 0.7573753), ("remove", 1.2971658), ("type", 0.7218666)],
&[("edge", 0.5437204), ("remove", 1.2971658), ("singleton", 1.3462936), ("types", 0.8992413)],
&[("edge", 0.5437204), ("name", 1.0542574), ("remove", 1.2971658), ("type", 0.7218666)],
&[("inplace", 1.4651399), ("node", 0.26780915), ("remove", 1.2971658), ("types", 0.8992413)],
&[("node", 0.38941613), ("remove", 1.8861839), ("types", 1.3075695)],
&[("edge", 0.5437204), ("inplace", 1.4651399), ("remove", 1.2971658), ("types", 0.8992413)],
&[("edge", 0.79061335), ("remove", 1.8861839), ("types", 1.3075695)],
&[("edge", 0.5437204), ("inplace", 1.4651399), ("remove", 1.2971658), ("weights", 1.6291134)],
&[("edge", 0.79061335), ("remove", 1.8861839), ("weights", 2.3688624)],
&[("divide", 2.476648), ("edge", 0.5437204), ("inplace", 1.4651399), ("weights", 1.6291134)],
&[("divide", 3.6012464), ("edge", 0.79061335), ("weights", 2.3688624)],
&[("edge", 0.5437204), ("inplace", 1.4651399), ("normalize", 2.476648), ("weights", 1.6291134)],
&[("edge", 0.79061335), ("normalize", 3.6012464), ("weights", 2.3688624)],
&[("edge", 0.5437204), ("inplace", 1.4651399), ("multiply", 2.476648), ("weights", 1.6291134)],
&[("edge", 0.79061335), ("multiply", 3.6012464), ("weights", 2.3688624)],
&[("bipartite", 0.8730172), ("build", 0.82351184), ("edge", 0.23037235), ("from", 0.19405593), ("graph", 0.5760122), ("ids", 0.28014633), ("node", 0.113469765)],
&[("build", 1.0584928), ("clique", 1.0881811), ("from", 0.24942788), ("graph", 0.7403716), ("ids", 0.36008334), ("node", 0.14584725)],
&[("bipartite", 0.8730172), ("build", 0.82351184), ("edge", 0.23037235), ("from", 0.19405593), ("graph", 0.5760122), ("names", 0.37327477), ("node", 0.113469765)],
&[("build", 1.0584928), ("clique", 1.0881811), ("from", 0.24942788), ("graph", 0.7403716), ("names", 0.47978503), ("node", 0.14584725)],
&[("bipartite", 0.8730172), ("build", 0.82351184), ("edge", 0.23037235), ("from", 0.19405593), ("graph", 0.5760122), ("node", 0.113469765), ("prefixes", 0.7126453)],
&[("build", 1.0584928), ("clique", 1.0881811), ("from", 0.24942788), ("graph", 0.7403716), ("node", 0.14584725), ("prefixes", 0.91599154)],
&[("bipartite", 0.8730172), ("build", 0.82351184), ("edge", 0.23037235), ("from", 0.19405593), ("graph", 0.5760122), ("node", 0.113469765), ("types", 0.3810053)],
&[("build", 0.82351184), ("clique", 0.8466095), ("from", 0.19405593), ("graph", 0.5760122), ("names", 0.37327477), ("node", 0.113469765), ("type", 0.30585226)],
&[("circles", 6.0519295), ("get", 0.35097212)],
&[("get", 0.22761041), ("memory", 2.5819569), ("stats", 3.9247627)],
&[("get", 0.15653217), ("memory", 1.7756627), ("total", 1.7421427), ("used", 2.6991367)],
&[("get", 0.113196395), ("memory", 1.2840723), ("nodes", 0.8635923), ("requirement", 1.6058578), ("total", 1.2598323)],
&[("get", 0.06632211), ("human", 0.9038453), ("memory", 0.7523418), ("nodes", 0.5059813), ("readable", 0.9038453), ("requirement", 0.9408769), ("total", 0.7381395)],
&[("edges", 1.0852431), ("get", 0.113196395), ("memory", 1.2840723), ("requirement", 1.6058578), ("total", 1.2598323)],
&[("edges", 0.6358472), ("get", 0.06632211), ("human", 0.9038453), ("memory", 0.7523418), ("readable", 0.9038453), ("requirement", 0.9408769), ("total", 0.7381395)],
&[("edge", 0.29610685), ("get", 0.085246466), ("memory", 0.96701515), ("requirements", 1.1221241), ("total", 0.94876033), ("weights", 0.88720524)],
&[("edge", 0.18401958), ("get", 0.052977566), ("human", 0.7219843), ("memory", 0.6009646), ("readable", 0.7219843), ("requirements", 0.6973591), ("total", 0.5896199), ("weights", 0.5513657)],
&[("get", 0.085246466), ("memory", 0.96701515), ("node", 0.14584725), ("requirements", 1.1221241), ("total", 0.94876033), ("types", 0.4897214)],
&[("get", 0.052977566), ("human", 0.7219843), ("memory", 0.6009646), ("node", 0.090638734), ("readable", 0.7219843), ("requirements", 0.6973591), ("total", 0.5896199), ("types", 0.30434394)],
&[("edge", 0.29610685), ("get", 0.085246466), ("memory", 0.96701515), ("requirements", 1.1221241), ("total", 0.94876033), ("types", 0.4897214)],
&[("edge", 0.18401958), ("get", 0.052977566), ("human", 0.7219843), ("memory", 0.6009646), ("readable", 0.7219843), ("requirements", 0.6973591), ("total", 0.5896199), ("types", 0.30434394)],
&[("get", 0.15653217), ("number", 1.1264132), ("of", 1.1264132), ("triangles", 2.476648)],
&[("get", 0.15653217), ("number", 1.1264132), ("of", 1.1264132), ("squares", 2.476648)],
&[("get", 0.085246466), ("node", 0.14584725), ("number", 0.6134378), ("of", 0.6134378), ("per", 1.2689577), ("squares", 1.3487675)],
&[("get", 0.15653217), ("number", 1.1264132), ("of", 1.1264132), ("triads", 2.476648)],
&[("get", 0.113196395), ("number", 0.81456685), ("of", 0.81456685), ("triads", 1.7909907), ("weighted", 0.9297577)],
&[("get", 0.35097212), ("transitivity", 6.0519295)],
&[("get", 0.085246466), ("node", 0.14584725), ("number", 0.6134378), ("of", 0.6134378), ("per", 1.2689577), ("triangles", 1.3487675)],
&[("clustering", 1.6850134), ("coefficient", 1.4449652), ("get", 0.113196395), ("node", 0.19366646), ("per", 1.6850134)],
&[("clustering", 3.388152), ("coefficient", 2.9054735), ("get", 0.22761041)],
&[("average", 2.6991367), ("clustering", 2.3300989), ("coefficient", 1.9981514), ("get", 0.15653217)],
&[("are", 3.2289894), ("nodes", 1.736474), ("remappable", 3.9247627)],
&[("from", 0.3312083), ("ids", 0.4781446), ("node", 0.19366646), ("remap", 1.5426534), ("unchecked", 0.6711767)],
&[("from", 0.4580071), ("ids", 0.661196), ("node", 0.26780915), ("remap", 2.1332383)],
&[("from", 0.4580071), ("names", 0.8809959), ("node", 0.26780915), ("remap", 2.1332383)],
&[("from", 0.3312083), ("map", 1.9518834), ("names", 0.6370931), ("node", 0.19366646), ("remap", 1.5426534)],
&[("from", 0.6659793), ("graph", 1.9768125), ("remap", 3.1019008)],
&[("graph", 1.9768125), ("negative", 3.6012464), ("sample", 3.6012464)],
&[("graph", 1.9768125), ("positive", 3.9247627), ("sample", 3.6012464)],
&[("connected", 4.06277), ("holdout", 4.4802)],
&[("holdout", 4.4802), ("random", 3.498236)],
&[("get", 0.113196395), ("holdout", 1.4449652), ("indices", 1.9518834), ("label", 1.3389878), ("node", 0.19366646)],
&[("get", 0.113196395), ("holdout", 1.4449652), ("label", 1.3389878), ("labels", 1.9518834), ("node", 0.19366646)],
&[("get", 0.113196395), ("graphs", 1.7909907), ("holdout", 1.4449652), ("label", 1.3389878), ("node", 0.19366646)],
&[("edge", 0.39319196), ("get", 0.113196395), ("graphs", 1.7909907), ("holdout", 1.4449652), ("label", 1.3389878)],
&[("get", 0.22761041), ("random", 2.268656), ("subgraph", 3.6012464)],
&[("get", 0.113196395), ("holdout", 1.4449652), ("label", 1.3389878), ("node", 0.19366646), ("random", 1.1282598)],
&[("get", 0.15653217), ("kfold", 2.3300989), ("label", 1.8516018), ("node", 0.26780915)],
&[("edge", 0.5437204), ("get", 0.15653217), ("kfold", 2.3300989), ("label", 1.8516018)],
&[("edge", 0.5437204), ("get", 0.15653217), ("kfold", 2.3300989), ("prediction", 2.6991367)],
&[("get", 0.22761041), ("node", 0.38941613), ("tuples", 3.9247627)],
&[("chains", 6.0519295), ("get", 0.35097212)],
&[("breadth", 0.43513918), ("first", 0.43513918), ("from", 0.105159126), ("get", 0.035940025), ("id", 0.17389452), ("node", 0.061489392), ("parallel", 0.48979476), ("predecessors", 0.6197259), ("search", 0.43513918), ("unchecked", 0.21309958)],
&[("breadth", 0.43513918), ("distances", 0.4587786), ("first", 0.43513918), ("from", 0.105159126), ("get", 0.035940025), ("ids", 0.15181161), ("node", 0.061489392), ("parallel", 0.48979476), ("search", 0.43513918), ("unchecked", 0.21309958)],
&[("breadth", 0.43513918), ("distances", 0.4587786), ("first", 0.43513918), ("from", 0.105159126), ("get", 0.035940025), ("id", 0.17389452), ("node", 0.061489392), ("parallel", 0.48979476), ("search", 0.43513918), ("unchecked", 0.21309958)],
&[("breadth", 0.43513918), ("distances", 0.4587786), ("first", 0.43513918), ("from", 0.105159126), ("get", 0.035940025), ("id", 0.17389452), ("node", 0.061489392), ("search", 0.43513918), ("sequential", 0.6197259), ("unchecked", 0.21309958)],
&[("breadth", 0.641419), ("first", 0.641419), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("node", 0.090638734), ("search", 0.641419), ("unchecked", 0.31412047)],
&[("breadth", 0.641419), ("first", 0.641419), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("node", 0.090638734), ("search", 0.641419), ("unchecked", 0.31412047)],
&[("from", 0.12652998), ("get", 0.043243896), ("ids", 0.34855095), ("node", 0.1411762), ("path", 0.4726896), ("shortest", 0.45714217), ("unchecked", 0.25640652)],
&[("from", 0.12652998), ("get", 0.043243896), ("ids", 0.18266337), ("names", 0.24338573), ("node", 0.1411762), ("path", 0.4726896), ("shortest", 0.45714217), ("unchecked", 0.25640652)],
&[("from", 0.15501031), ("get", 0.052977566), ("ids", 0.4226371), ("node", 0.17118385), ("path", 0.57908624), ("shortest", 0.5600393)],
&[("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("names", 0.29816887), ("node", 0.17118385), ("path", 0.57908624), ("shortest", 0.5600393)],
&[("from", 0.15501031), ("get", 0.052977566), ("names", 0.5631334), ("node", 0.17118385), ("path", 0.57908624), ("shortest", 0.5600393)],
&[("from", 0.105159126), ("get", 0.035940025), ("ids", 0.29194516), ("k", 0.4587786), ("node", 0.11824872), ("path", 0.39285257), ("shortest", 0.3799311), ("unchecked", 0.21309958)],
&[("from", 0.12652998), ("get", 0.043243896), ("ids", 0.34855095), ("k", 0.5520134), ("node", 0.1411762), ("path", 0.4726896), ("shortest", 0.45714217)],
&[("from", 0.12652998), ("get", 0.043243896), ("ids", 0.18266337), ("k", 0.5520134), ("names", 0.24338573), ("node", 0.1411762), ("path", 0.4726896), ("shortest", 0.45714217)],
&[("from", 0.12652998), ("get", 0.043243896), ("k", 0.5520134), ("names", 0.46441898), ("node", 0.1411762), ("path", 0.4726896), ("shortest", 0.45714217)],
&[("and", 0.32059008), ("distant", 0.4798266), ("eccentricity", 0.39919773), ("from", 0.08873444), ("get", 0.030326592), ("id", 0.28388616), ("most", 0.43022743), ("node", 0.10038262), ("unchecked", 0.1798158)],
&[("eccentricity", 0.8730172), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("node", 0.113469765), ("unchecked", 0.39324442), ("weighted", 0.5447478)],
&[("and", 0.3799311), ("distant", 0.5686422), ("eccentricity", 0.47308898), ("from", 0.105159126), ("get", 0.035940025), ("id", 0.33441225), ("most", 0.50986224), ("node", 0.11824872)],
&[("eccentricity", 1.1221241), ("from", 0.24942788), ("get", 0.085246466), ("id", 0.412462), ("node", 0.14584725), ("weighted", 0.70018625)],
&[("eccentricity", 1.4900371), ("from", 0.3312083), ("get", 0.113196395), ("name", 0.7623873), ("node", 0.19366646)],
&[("eccentricity", 1.1221241), ("from", 0.24942788), ("get", 0.085246466), ("name", 0.57414216), ("node", 0.14584725), ("weighted", 0.70018625)],
&[("dijkstra", 1.2093469), ("from", 0.24942788), ("get", 0.085246466), ("ids", 0.36008334), ("node", 0.14584725), ("unchecked", 0.5054528)],
&[("dijkstra", 1.2093469), ("from", 0.24942788), ("get", 0.085246466), ("id", 0.412462), ("node", 0.14584725), ("unchecked", 0.5054528)],
&[("from", 0.105159126), ("get", 0.035940025), ("ids", 0.29194516), ("node", 0.11824872), ("path", 0.39285257), ("shortest", 0.3799311), ("unchecked", 0.21309958), ("weighted", 0.29519945)],
&[("from", 0.105159126), ("get", 0.035940025), ("ids", 0.15181161), ("names", 0.202278), ("node", 0.11824872), ("path", 0.39285257), ("shortest", 0.3799311), ("unchecked", 0.21309958), ("weighted", 0.29519945)],
&[("from", 0.12652998), ("get", 0.043243896), ("ids", 0.34855095), ("node", 0.1411762), ("path", 0.4726896), ("shortest", 0.45714217), ("weighted", 0.35519102)],
&[("from", 0.12652998), ("get", 0.043243896), ("ids", 0.18266337), ("names", 0.24338573), ("node", 0.1411762), ("path", 0.4726896), ("shortest", 0.45714217), ("weighted", 0.35519102)],
&[("from", 0.12652998), ("get", 0.043243896), ("names", 0.46441898), ("node", 0.1411762), ("path", 0.4726896), ("shortest", 0.45714217), ("weighted", 0.35519102)],
&[("breadth", 0.80298626), ("first", 0.80298626), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("node", 0.113469765), ("search", 0.80298626)],
&[("dijkstra", 1.6058578), ("from", 0.3312083), ("get", 0.113196395), ("ids", 0.4781446), ("node", 0.19366646)],
&[("four", 3.9247627), ("get", 0.22761041), ("sweep", 3.9247627)],
&[("diameter", 3.388152), ("get", 0.22761041), ("naive", 3.9247627)],
&[("diameter", 5.2244835), ("get", 0.35097212)],
&[("breadth", 0.80298626), ("first", 0.80298626), ("from", 0.19405593), ("get", 0.06632211), ("names", 0.37327477), ("node", 0.113469765), ("search", 0.80298626)],
&[("dijkstra", 1.6058578), ("from", 0.3312083), ("get", 0.113196395), ("names", 0.6370931), ("node", 0.19366646)],
&[("between", 0.9872544), ("distances", 0.8466095), ("get", 0.06632211), ("histogram", 0.9872544), ("ids", 0.28014633), ("node", 0.113469765), ("type", 0.30585226)],
&[("between", 0.9872544), ("distances", 0.8466095), ("get", 0.06632211), ("histogram", 0.9872544), ("names", 0.37327477), ("node", 0.113469765), ("type", 0.30585226)],
&[("between", 1.6850134), ("distances", 1.4449652), ("get", 0.113196395), ("histogram", 1.6850134), ("prefixes", 1.2163196)],
&[("components", 1.6058578), ("connected", 1.3103347), ("get", 0.113196395), ("number", 0.81456685), ("of", 0.81456685)],
&[("connected", 1.3103347), ("get", 0.113196395), ("nodes", 0.8635923), ("number", 0.81456685), ("of", 0.81456685)],
&[("get", 0.06632211), ("nodes", 0.5059813), ("number", 0.47725716), ("of", 0.47725716), ("selfloops", 0.67027974), ("singleton", 0.57041967), ("with", 0.5938848)],
&[("get", 0.113196395), ("nodes", 0.8635923), ("number", 0.81456685), ("of", 0.81456685), ("singleton", 0.97357357)],
&[("disconnected", 1.6058578), ("get", 0.113196395), ("nodes", 0.8635923), ("number", 0.81456685), ("of", 0.81456685)],
&[("get", 0.15653217), ("ids", 0.661196), ("node", 0.26780915), ("singleton", 1.3462936)],
&[("get", 0.15653217), ("names", 0.8809959), ("node", 0.26780915), ("singleton", 1.3462936)],
&[("get", 0.085246466), ("ids", 0.36008334), ("node", 0.14584725), ("selfloops", 0.86153746), ("singleton", 0.73318326), ("with", 0.763344)],
&[("get", 0.085246466), ("names", 0.47978503), ("node", 0.14584725), ("selfloops", 0.86153746), ("singleton", 0.73318326), ("with", 0.763344)],
&[("density", 6.0519295), ("get", 0.35097212)],
&[("get", 0.15653217), ("nodes", 1.1942074), ("rate", 2.0604784), ("trap", 1.8119793)],
&[("get", 0.15653217), ("ids", 0.661196), ("node", 0.26780915), ("trap", 1.8119793)],
&[("degrees", 1.7756627), ("get", 0.15653217), ("mean", 2.476648), ("node", 0.26780915)],
&[("degrees", 1.2840723), ("get", 0.113196395), ("mean", 1.7909907), ("node", 0.19366646), ("weighted", 0.9297577)],
&[("edges", 1.0852431), ("get", 0.113196395), ("number", 0.81456685), ("of", 0.81456685), ("undirected", 1.4449652)],
&[("edges", 0.81727993), ("get", 0.085246466), ("number", 0.6134378), ("of", 0.6134378), ("undirected", 1.0881811), ("unique", 0.9867929)],
&[("edges", 1.5007144), ("get", 0.15653217), ("number", 1.1264132), ("of", 1.1264132)],
&[("edges", 1.0852431), ("get", 0.113196395), ("number", 0.81456685), ("of", 0.81456685), ("unique", 1.3103347)],
&[("degrees", 1.7756627), ("get", 0.15653217), ("median", 2.476648), ("node", 0.26780915)],
&[("degrees", 1.2840723), ("get", 0.113196395), ("median", 1.7909907), ("node", 0.19366646), ("weighted", 0.9297577)],
&[("degree", 1.4651399), ("get", 0.15653217), ("maximum", 1.8951929), ("node", 0.26780915)],
&[("central", 1.1617486), ("get", 0.085246466), ("id", 0.412462), ("most", 1.2093469), ("node", 0.14584725), ("unchecked", 0.5054528)],
&[("central", 1.5426534), ("get", 0.113196395), ("id", 0.5476967), ("most", 1.6058578), ("node", 0.19366646)],
&[("degree", 1.4651399), ("get", 0.15653217), ("minimum", 1.9981514), ("node", 0.26780915)],
&[("degrees", 1.7756627), ("get", 0.15653217), ("mode", 2.6991367), ("node", 0.26780915)],
&[("get", 0.15653217), ("nodes", 1.1942074), ("rate", 2.0604784), ("selfloop", 2.1332383)],
&[("get", 0.35097212), ("name", 2.3638268)],
&[("get", 0.113196395), ("nodes", 0.8635923), ("number", 0.81456685), ("of", 0.81456685), ("trap", 1.3103347)],
&[("get", 0.06632211), ("nodes", 0.5059813), ("number", 0.47725716), ("of", 0.47725716), ("selfloops", 0.67027974), ("trap", 0.76772904), ("with", 0.5938848)],
&[("get", 0.15653217), ("ids", 0.661196), ("node", 0.26780915), ("source", 1.7756627)],
&[("directed", 0.95530945), ("get", 0.113196395), ("ids", 0.4781446), ("node", 0.19366646), ("source", 1.2840723)],
&[("get", 0.22761041), ("names", 1.2810392), ("source", 2.5819569)],
&[("destination", 1.9436368), ("get", 0.15653217), ("ids", 0.661196), ("node", 0.26780915)],
&[("destination", 1.405543), ("directed", 0.95530945), ("get", 0.113196395), ("ids", 0.4781446), ("node", 0.19366646)],
&[("destination", 2.8262048), ("get", 0.22761041), ("names", 1.2810392)],
&[("get", 0.22761041), ("names", 1.2810392), ("node", 0.38941613)],
&[("get", 0.22761041), ("node", 0.38941613), ("urls", 3.9247627)],
&[("get", 0.22761041), ("node", 0.38941613), ("ontologies", 3.1019008)],
&[("from", 0.24942788), ("get", 0.085246466), ("name", 0.57414216), ("node", 0.14584725), ("ontology", 1.2093469), ("unchecked", 0.5054528)],
&[("from", 0.24942788), ("get", 0.085246466), ("id", 0.412462), ("node", 0.14584725), ("ontology", 1.2093469), ("unchecked", 0.5054528)],
&[("from", 0.3312083), ("get", 0.113196395), ("name", 0.7623873), ("node", 0.19366646), ("ontology", 1.6058578)],
&[("from", 0.3312083), ("get", 0.113196395), ("id", 0.5476967), ("node", 0.19366646), ("ontology", 1.6058578)],
&[("get", 0.22761041), ("ids", 0.9614324), ("node", 0.38941613)],
&[("directed", 0.95530945), ("edge", 0.39319196), ("get", 0.113196395), ("ids", 0.4781446), ("type", 0.5220186)],
&[("edge", 0.29610685), ("get", 0.085246466), ("ids", 0.36008334), ("triangular", 0.87402433), ("type", 0.3931242), ("upper", 1.0321105)],
&[("edge", 0.29610685), ("get", 0.085246466), ("ids", 0.36008334), ("lower", 1.0321105), ("triangular", 0.87402433), ("type", 0.3931242)],
&[("directed", 0.7194289), ("edge", 0.29610685), ("get", 0.085246466), ("ids", 0.36008334), ("imputed", 1.2689577), ("type", 0.3931242)],
&[("edge", 0.23037235), ("get", 0.06632211), ("ids", 0.28014633), ("imputed", 0.9872544), ("triangular", 0.6799946), ("type", 0.30585226), ("upper", 0.80298626)],
&[("edge", 0.23037235), ("get", 0.06632211), ("ids", 0.28014633), ("imputed", 0.9872544), ("lower", 0.80298626), ("triangular", 0.6799946), ("type", 0.30585226)],
&[("directed", 0.7194289), ("edge", 0.29610685), ("get", 0.085246466), ("ids", 0.36008334), ("known", 0.771524), ("type", 0.3931242)],
&[("edge", 0.23037235), ("get", 0.06632211), ("ids", 0.28014633), ("known", 0.6002489), ("triangular", 0.6799946), ("type", 0.30585226), ("upper", 0.80298626)],
&[("edge", 0.23037235), ("get", 0.06632211), ("ids", 0.28014633), ("known", 0.6002489), ("lower", 0.80298626), ("triangular", 0.6799946), ("type", 0.30585226)],
&[("directed", 0.4470988), ("edge", 0.18401958), ("get", 0.052977566), ("known", 0.47947398), ("nodes", 0.40417382), ("source", 0.6009646), ("types", 0.30434394), ("with", 0.4743904)],
&[("destination", 0.6578146), ("directed", 0.4470988), ("edge", 0.18401958), ("get", 0.052977566), ("known", 0.47947398), ("nodes", 0.40417382), ("types", 0.30434394), ("with", 0.4743904)],
&[("edge", 0.39319196), ("get", 0.113196395), ("ids", 0.4781446), ("type", 0.5220186), ("unique", 1.3103347)],
&[("directed", 0.95530945), ("edge", 0.39319196), ("get", 0.113196395), ("names", 0.6370931), ("type", 0.5220186)],
&[("edge", 0.29610685), ("get", 0.085246466), ("names", 0.47978503), ("triangular", 0.87402433), ("type", 0.3931242), ("upper", 1.0321105)],
&[("edge", 0.29610685), ("get", 0.085246466), ("lower", 1.0321105), ("names", 0.47978503), ("triangular", 0.87402433), ("type", 0.3931242)],
&[("edge", 0.39319196), ("get", 0.113196395), ("names", 0.6370931), ("type", 0.5220186), ("unique", 1.3103347)],
&[("directed", 1.3210373), ("edge", 0.5437204), ("get", 0.15653217), ("weights", 1.6291134)],
&[("edge", 0.5437204), ("get", 0.15653217), ("undirected", 1.9981514), ("weights", 1.6291134)],
&[("get", 0.15653217), ("indegrees", 2.476648), ("node", 0.26780915), ("weighted", 1.2857033)],
&[("get", 0.15653217), ("ids", 0.661196), ("node", 0.26780915), ("type", 0.7218666)],
&[("get", 0.113196395), ("known", 1.0244851), ("mask", 1.3103347), ("node", 0.19366646), ("types", 0.65028733)],
&[("get", 0.113196395), ("mask", 1.3103347), ("node", 0.19366646), ("types", 0.65028733), ("unknown", 1.1282598)],
&[("edge", 0.39319196), ("get", 0.113196395), ("known", 1.0244851), ("mask", 1.3103347), ("types", 0.65028733)],
&[("edge", 0.39319196), ("get", 0.113196395), ("mask", 1.3103347), ("types", 0.65028733), ("unknown", 1.1282598)],
&[("encoded", 1.2093469), ("get", 0.085246466), ("hot", 1.2093469), ("node", 0.14584725), ("one", 1.2093469), ("types", 0.4897214)],
&[("encoded", 0.9408769), ("get", 0.06632211), ("hot", 0.9408769), ("known", 0.6002489), ("node", 0.113469765), ("one", 0.9408769), ("types", 0.3810053)],
&[("edge", 0.29610685), ("encoded", 1.2093469), ("get", 0.085246466), ("hot", 1.2093469), ("one", 1.2093469), ("types", 0.4897214)],
&[("edge", 0.23037235), ("encoded", 0.9408769), ("get", 0.06632211), ("hot", 0.9408769), ("known", 0.6002489), ("one", 0.9408769), ("types", 0.3810053)],
&[("get", 0.15653217), ("names", 0.8809959), ("node", 0.26780915), ("type", 0.7218666)],
&[("get", 0.113196395), ("ids", 0.4781446), ("node", 0.19366646), ("type", 0.5220186), ("unique", 1.3103347)],
&[("get", 0.113196395), ("names", 0.6370931), ("node", 0.19366646), ("type", 0.5220186), ("unique", 1.3103347)],
&[("directed", 0.7194289), ("edges", 0.81727993), ("get", 0.085246466), ("number", 0.6134378), ("of", 0.6134378), ("unique", 0.9867929)],
&[("get", 0.22761041), ("mapping", 3.388152), ("nodes", 1.736474)],
&[("edge", 0.5437204), ("get", 0.15653217), ("ids", 0.661196), ("node", 0.26780915)],
&[("directed", 0.95530945), ("edge", 0.39319196), ("get", 0.113196395), ("ids", 0.4781446), ("node", 0.19366646)],
&[("directed", 0.95530945), ("edge", 0.39319196), ("get", 0.113196395), ("ids", 0.4781446), ("triples", 1.7909907)],
&[("edge", 0.5437204), ("get", 0.15653217), ("names", 0.8809959), ("node", 0.26780915)],
&[("directed", 0.95530945), ("edge", 0.39319196), ("get", 0.113196395), ("names", 0.6370931), ("node", 0.19366646)],
&[("directed", 0.95530945), ("edge", 0.39319196), ("get", 0.113196395), ("names", 0.6370931), ("triples", 1.7909907)],
&[("get", 0.085246466), ("node", 0.14584725), ("number", 0.6134378), ("of", 0.6134378), ("types", 0.4897214), ("unknown", 0.8496751)],
&[("get", 0.085246466), ("known", 0.771524), ("node", 0.14584725), ("number", 0.6134378), ("of", 0.6134378), ("types", 0.4897214)],
&[("get", 0.113196395), ("node", 0.19366646), ("rate", 1.4900371), ("types", 0.65028733), ("unknown", 1.1282598)],
&[("get", 0.113196395), ("known", 1.0244851), ("node", 0.19366646), ("rate", 1.4900371), ("types", 0.65028733)],
&[("get", 0.085246466), ("minimum", 1.0881811), ("node", 0.14584725), ("number", 0.6134378), ("of", 0.6134378), ("types", 0.4897214)],
&[("get", 0.085246466), ("maximum", 1.0321105), ("node", 0.14584725), ("number", 0.6134378), ("of", 0.6134378), ("types", 0.4897214)],
&[("count", 1.9981514), ("get", 0.15653217), ("maximum", 1.8951929), ("multilabel", 2.476648)],
&[("get", 0.085246466), ("node", 0.14584725), ("number", 0.6134378), ("of", 0.6134378), ("singleton", 0.73318326), ("types", 0.4897214)],
&[("get", 0.085246466), ("homogeneous", 1.0083711), ("node", 0.14584725), ("number", 0.6134378), ("of", 0.6134378), ("types", 0.4897214)],
&[("get", 0.113196395), ("homogeneous", 1.3389878), ("ids", 0.4781446), ("node", 0.19366646), ("type", 0.5220186)],
&[("get", 0.113196395), ("homogeneous", 1.3389878), ("names", 0.6370931), ("node", 0.19366646), ("type", 0.5220186)],
&[("get", 0.113196395), ("ids", 0.4781446), ("node", 0.19366646), ("singleton", 0.97357357), ("type", 0.5220186)],
&[("get", 0.113196395), ("names", 0.6370931), ("node", 0.19366646), ("singleton", 0.97357357), ("type", 0.5220186)],
&[("edge", 0.29610685), ("get", 0.085246466), ("number", 0.6134378), ("of", 0.6134378), ("types", 0.4897214), ("unknown", 0.8496751)],
&[("directed", 0.4470988), ("edge", 0.34754658), ("get", 0.052977566), ("ids", 0.22377864), ("types", 0.30434394), ("unknown", 0.5280421), ("with", 0.4743904)],
&[("edge", 0.28662342), ("get", 0.043243896), ("ids", 0.18266337), ("triangular", 0.44337574), ("types", 0.24842626), ("unknown", 0.43102387), ("upper", 0.5235698), ("with", 0.38722974)],
&[("edge", 0.28662342), ("get", 0.043243896), ("ids", 0.18266337), ("lower", 0.5235698), ("triangular", 0.44337574), ("types", 0.24842626), ("unknown", 0.43102387), ("with", 0.38722974)],
&[("directed", 0.4470988), ("edge", 0.34754658), ("get", 0.052977566), ("ids", 0.22377864), ("known", 0.47947398), ("types", 0.30434394), ("with", 0.4743904)],
&[("edge", 0.28662342), ("get", 0.043243896), ("ids", 0.18266337), ("known", 0.3913793), ("triangular", 0.44337574), ("types", 0.24842626), ("upper", 0.5235698), ("with", 0.38722974)],
&[("edge", 0.28662342), ("get", 0.043243896), ("ids", 0.18266337), ("known", 0.3913793), ("lower", 0.5235698), ("triangular", 0.44337574), ("types", 0.24842626), ("with", 0.38722974)],
&[("edge", 0.34754658), ("get", 0.052977566), ("ids", 0.22377864), ("known", 0.47947398), ("node", 0.090638734), ("types", 0.30434394), ("with", 0.4743904)],
&[("edge", 0.34754658), ("get", 0.052977566), ("known", 0.47947398), ("names", 0.29816887), ("node", 0.090638734), ("types", 0.30434394), ("with", 0.4743904)],
&[("edge", 0.23037235), ("edges", 0.6358472), ("get", 0.06632211), ("mask", 0.76772904), ("types", 0.3810053), ("unknown", 0.6610508), ("with", 0.5938848)],
&[("directed", 0.4470988), ("edge", 0.18401958), ("edges", 0.50790966), ("get", 0.052977566), ("known", 0.47947398), ("mask", 0.61325574), ("types", 0.30434394), ("with", 0.4743904)],
&[("edge", 0.23037235), ("get", 0.06632211), ("known", 0.6002489), ("mask", 0.76772904), ("triangular", 0.6799946), ("types", 0.3810053), ("upper", 0.80298626)],
&[("edge", 0.23037235), ("get", 0.06632211), ("known", 0.6002489), ("lower", 0.80298626), ("mask", 0.76772904), ("triangular", 0.6799946), ("types", 0.3810053)],
&[("get", 0.06632211), ("ids", 0.28014633), ("node", 0.21133932), ("types", 0.3810053), ("unknown", 0.6610508), ("with", 0.5938848)],
&[("get", 0.06632211), ("ids", 0.28014633), ("known", 0.6002489), ("node", 0.21133932), ("types", 0.3810053), ("with", 0.5938848)],
&[("get", 0.06632211), ("names", 0.37327477), ("node", 0.21133932), ("types", 0.3810053), ("unknown", 0.6610508), ("with", 0.5938848)],
&[("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("ids", 0.28014633), ("node", 0.21133932), ("type", 0.30585226)],
&[("from", 0.19405593), ("get", 0.06632211), ("ids", 0.5217772), ("node", 0.21133932), ("type", 0.30585226)],
&[("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("names", 0.37327477), ("node", 0.21133932), ("type", 0.30585226)],
&[("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("names", 0.37327477), ("node", 0.21133932), ("type", 0.30585226)],
&[("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("name", 0.446685), ("node", 0.21133932), ("type", 0.30585226)],
&[("from", 0.19405593), ("get", 0.06632211), ("name", 0.446685), ("names", 0.37327477), ("node", 0.21133932), ("type", 0.30585226)],
&[("get", 0.06632211), ("known", 0.6002489), ("names", 0.37327477), ("node", 0.21133932), ("types", 0.3810053), ("with", 0.5938848)],
&[("get", 0.06632211), ("mask", 0.76772904), ("node", 0.113469765), ("nodes", 0.5059813), ("types", 0.3810053), ("unknown", 0.6610508), ("with", 0.5938848)],
&[("get", 0.06632211), ("known", 0.6002489), ("mask", 0.76772904), ("node", 0.113469765), ("nodes", 0.5059813), ("types", 0.3810053), ("with", 0.5938848)],
&[("edge", 0.29610685), ("get", 0.085246466), ("known", 0.771524), ("number", 0.6134378), ("of", 0.6134378), ("types", 0.4897214)],
&[("edge", 0.39319196), ("get", 0.113196395), ("rate", 1.4900371), ("types", 0.65028733), ("unknown", 1.1282598)],
&[("edge", 0.39319196), ("get", 0.113196395), ("known", 1.0244851), ("rate", 1.4900371), ("types", 0.65028733)],
&[("edge", 0.29610685), ("get", 0.085246466), ("minimum", 1.0881811), ("number", 0.6134378), ("of", 0.6134378), ("types", 0.4897214)],
&[("edge", 0.29610685), ("get", 0.085246466), ("maximum", 1.0321105), ("number", 0.6134378), ("of", 0.6134378), ("types", 0.4897214)],
&[("edge", 0.29610685), ("get", 0.085246466), ("number", 0.6134378), ("of", 0.6134378), ("singleton", 0.73318326), ("types", 0.4897214)],
&[("edge", 0.39319196), ("get", 0.113196395), ("ids", 0.4781446), ("singleton", 0.97357357), ("type", 0.5220186)],
&[("edge", 0.39319196), ("get", 0.113196395), ("names", 0.6370931), ("singleton", 0.97357357), ("type", 0.5220186)],
&[("get", 0.15653217), ("nodes", 1.1942074), ("number", 1.1264132), ("of", 1.1264132)],
&[("component", 1.9518834), ("connected", 1.3103347), ("get", 0.113196395), ("ids", 0.4781446), ("node", 0.19366646)],
&[("directed", 0.95530945), ("edges", 1.0852431), ("get", 0.113196395), ("number", 0.81456685), ("of", 0.81456685)],
&[("edge", 0.39319196), ("get", 0.113196395), ("number", 0.81456685), ("of", 0.81456685), ("types", 0.65028733)],
&[("get", 0.113196395), ("node", 0.19366646), ("number", 0.81456685), ("of", 0.81456685), ("types", 0.65028733)],
&[("degrees", 2.5819569), ("get", 0.22761041), ("node", 0.38941613)],
&[("get", 0.22761041), ("indegrees", 3.6012464), ("node", 0.38941613)],
&[("degrees", 1.7756627), ("get", 0.15653217), ("node", 0.26780915), ("weighted", 1.2857033)],
&[("get", 0.113196395), ("ids", 0.4781446), ("node", 0.19366646), ("not", 1.4900371), ("singletons", 1.9518834)],
&[("dense", 2.6991367), ("get", 0.15653217), ("mapping", 2.3300989), ("nodes", 1.1942074)],
&[("edges", 1.0852431), ("get", 0.113196395), ("number", 0.81456685), ("of", 0.81456685), ("parallel", 1.5426534)],
&[("cumulative", 2.6991367), ("degrees", 1.7756627), ("get", 0.15653217), ("node", 0.26780915)],
&[("degrees", 1.7756627), ("get", 0.15653217), ("reciprocal", 2.1332383), ("sqrt", 2.1332383)],
&[("get", 0.085246466), ("nodes", 0.65035814), ("number", 0.6134378), ("of", 0.6134378), ("source", 0.96701515), ("unique", 0.9867929)],
&[("counts", 1.1221241), ("edge", 0.29610685), ("get", 0.085246466), ("hashmap", 1.1221241), ("id", 0.412462), ("type", 0.3931242)],
&[("counts", 1.1221241), ("edge", 0.29610685), ("get", 0.085246466), ("hashmap", 1.1221241), ("names", 0.47978503), ("type", 0.3931242)],
&[("counts", 1.1221241), ("get", 0.085246466), ("hashmap", 1.1221241), ("id", 0.412462), ("node", 0.14584725), ("type", 0.3931242)],
&[("counts", 1.1221241), ("get", 0.085246466), ("hashmap", 1.1221241), ("names", 0.47978503), ("node", 0.14584725), ("type", 0.3931242)],
&[("get", 0.085246466), ("ids", 0.36008334), ("label", 1.0083711), ("node", 0.14584725), ("single", 1.3487675), ("type", 0.3931242)],
&[("get", 0.06632211), ("ids", 0.28014633), ("known", 0.6002489), ("label", 0.78451693), ("node", 0.113469765), ("single", 1.0493468), ("type", 0.30585226)],
&[("boolean", 1.7909907), ("get", 0.113196395), ("ids", 0.4781446), ("node", 0.19366646), ("type", 0.5220186)],
&[("boolean", 1.3487675), ("get", 0.085246466), ("ids", 0.36008334), ("known", 0.771524), ("node", 0.14584725), ("type", 0.3931242)],
&[("get", 0.15653217), ("ids", 0.661196), ("node", 0.26780915), ("root", 2.476648)],
&[("get", 0.15653217), ("names", 0.8809959), ("node", 0.26780915), ("root", 2.476648)],
&[("directed", 1.9208949), ("inplace", 2.1304317), ("to", 2.5332162)],
&[("directed", 2.9619932), ("to", 3.9061842)],
&[("to", 2.5332162), ("triangular", 2.333669), ("upper", 2.7557635)],
&[("lower", 2.7557635), ("to", 2.5332162), ("triangular", 2.333669)],
&[("diagonal", 3.6012464), ("main", 3.9247627), ("to", 2.5332162)],
&[("anti", 3.9247627), ("diagonal", 3.6012464), ("to", 2.5332162)],
&[("bidiagonal", 6.0519295), ("to", 3.9061842)],
&[("arrowhead", 6.0519295), ("to", 3.9061842)],
&[("to", 3.9061842), ("transposed", 6.0519295)],
&[("to", 3.9061842), ("undirected", 4.4802)],
&[("complementary", 6.0519295), ("to", 3.9061842)],
&[("graph", 0.9831187), ("multi", 1.9518834), ("similarity", 1.9518834), ("structural", 1.7909907), ("to", 1.2598323)],
&[("approximated", 2.5332162), ("cliques", 3.6012464), ("get", 0.22761041)],
&[("clique", 2.9054735), ("get", 0.22761041), ("max", 3.9247627)],
&[("approximated", 1.2598323), ("cliques", 1.7909907), ("get", 0.113196395), ("number", 0.81456685), ("of", 0.81456685)],
&[("report", 7.7620554)],
&[("overlap", 3.9247627), ("report", 3.1019008), ("textual", 3.6012464)],
&[("from", 0.24942788), ("get", 0.085246466), ("id", 0.412462), ("node", 0.2664172), ("report", 1.1617486)],
&[("from", 0.24942788), ("get", 0.085246466), ("name", 0.57414216), ("node", 0.2664172), ("report", 1.1617486)],
&[("report", 4.783088), ("textual", 5.553072)],
&[("get", 0.15653217), ("isomorphic", 1.3731048), ("mask", 1.8119793), ("nodes", 1.1942074)],
&[("get", 0.15653217), ("ids", 0.661196), ("isomorphic", 1.3731048), ("node", 0.26780915)],
&[("flat", 1.4699334), ("get", 0.085246466), ("ids", 0.36008334), ("isomorphic", 0.74778455), ("node", 0.14584725), ("repeated", 1.4699334)],
&[("get", 0.15653217), ("hashes", 2.3300989), ("isomorphic", 1.3731048), ("node", 0.26780915)],
&[("get", 0.15653217), ("isomorphic", 1.3731048), ("names", 0.8809959), ("node", 0.26780915)],
&[("edge", 0.39319196), ("get", 0.113196395), ("ids", 0.4781446), ("isomorphic", 0.9929622), ("node", 0.19366646)],
&[("edge", 0.5437204), ("get", 0.15653217), ("hashes", 2.3300989), ("isomorphic", 1.3731048)],
&[("edge", 0.39319196), ("get", 0.113196395), ("isomorphic", 0.9929622), ("names", 0.6370931), ("node", 0.19366646)],
&[("get", 0.113196395), ("ids", 0.4781446), ("isomorphic", 0.9929622), ("node", 0.19366646), ("tuple", 1.5426534)],
&[("get", 0.15653217), ("hashes", 2.3300989), ("isomorphic", 1.3731048), ("tuple", 2.1332383)],
&[("get", 0.113196395), ("isomorphic", 0.9929622), ("names", 0.6370931), ("node", 0.19366646), ("tuple", 1.5426534)],
&[("connected", 1.8119793), ("generate", 1.8119793), ("graph", 1.3594929), ("random", 1.5601994)],
&[("generate", 1.8119793), ("random", 1.5601994), ("spanning", 2.2206397), ("tree", 2.476648)],
&[("generate", 2.6347642), ("graph", 1.9768125), ("star", 3.388152)],
&[("generate", 2.6347642), ("graph", 1.9768125), ("wheel", 3.9247627)],
&[("circle", 3.9247627), ("generate", 2.6347642), ("graph", 1.9768125)],
&[("chain", 3.9247627), ("generate", 2.6347642), ("graph", 1.9768125)],
&[("complete", 3.9247627), ("generate", 2.6347642), ("graph", 1.9768125)],
&[("barbell", 3.9247627), ("generate", 2.6347642), ("graph", 1.9768125)],
&[("generate", 2.6347642), ("graph", 1.9768125), ("lollipop", 3.9247627)],
&[("generate", 1.8119793), ("graph", 1.3594929), ("lattice", 2.6991367), ("squared", 2.6991367)],
&[("filter", 3.6012464), ("from", 0.6659793), ("ids", 0.9614324)],
&[("filter", 3.6012464), ("from", 0.6659793), ("names", 1.2810392)],
&[("node", 0.26780915), ("remove", 1.2971658), ("types", 0.8992413), ("unknown", 1.5601994)],
&[("edge", 0.5437204), ("remove", 1.2971658), ("types", 0.8992413), ("unknown", 1.5601994)],
&[("nodes", 1.736474), ("remove", 1.8861839), ("singleton", 1.9576195)],
&[("remove", 2.9084692), ("tendrils", 5.553072)],
&[("dendritic", 3.6012464), ("remove", 1.8861839), ("trees", 3.6012464)],
&[("isomorphic", 1.9966053), ("nodes", 1.736474), ("remove", 1.8861839)],
&[("nodes", 0.8635923), ("remove", 0.93804675), ("selfloops", 1.1440115), ("singleton", 0.97357357), ("with", 1.0136231)],
&[("disconnected", 3.2289894), ("nodes", 1.736474), ("remove", 1.8861839)],
&[("remove", 2.9084692), ("selfloops", 3.547075)],
&[("edges", 2.18216), ("parallel", 3.1019008), ("remove", 1.8861839)],
&[("arborescence", 2.476648), ("kruskal", 2.476648), ("random", 1.5601994), ("spanning", 2.2206397)],
&[("arborescence", 3.6012464), ("kruskal", 3.6012464), ("spanning", 3.2289894)],
&[("get", 0.15653217), ("random", 1.5601994), ("spanning", 2.2206397), ("tree", 2.476648)],
&[("components", 3.2289894), ("connected", 2.6347642), ("get", 0.22761041)],
&[("enable", 9.821147)],
&[("all", 3.8363996), ("disable", 6.0519295)],
&[("approximated", 1.7421427), ("distances", 1.9981514), ("get", 0.15653217), ("total", 1.7421427)],
&[("approximated", 1.7421427), ("centrality", 1.5601994), ("closeness", 2.1332383), ("get", 0.15653217)],
&[("approximated", 1.7421427), ("centrality", 1.5601994), ("get", 0.15653217), ("harmonic", 2.1332383)],
&[("approximated", 2.5332162), ("diameter", 3.388152), ("get", 0.22761041)],
&[("compatible", 2.2206397), ("has", 1.0888427), ("node", 0.26780915), ("vocabularies", 2.3300989)],
&[("compatible", 1.6058578), ("has", 0.7873977), ("node", 0.19366646), ("types", 0.65028733), ("vocabularies", 1.6850134)],
&[("compatible", 1.6058578), ("edge", 0.39319196), ("has", 0.7873977), ("types", 0.65028733), ("vocabularies", 1.6850134)],
&[("compatible", 4.979057), ("is", 3.5984852)],
&[("adjacency", 2.6991367), ("has", 1.0888427), ("matrix", 1.7756627), ("same", 2.6991367)],
&[("cover", 3.9247627), ("get", 0.22761041), ("vertex", 3.9247627)],
&[("get", 0.15653217), ("node", 0.26780915), ("random", 1.5601994), ("type", 0.7218666)],
&[("edge", 0.5437204), ("get", 0.15653217), ("random", 1.5601994), ("type", 0.7218666)],
&[("edge", 0.23037235), ("free", 0.8730172), ("get", 0.06632211), ("random", 0.6610508), ("scale", 0.8730172), ("type", 0.30585226), ("unchecked", 0.39324442)],
&[("edge", 0.29610685), ("free", 1.1221241), ("get", 0.085246466), ("random", 0.8496751), ("scale", 1.1221241), ("type", 0.3931242)],
&[("edge", 0.23037235), ("free", 0.8730172), ("get", 0.06632211), ("random", 0.6610508), ("scale", 0.8730172), ("unchecked", 0.39324442), ("weight", 0.7381395)],
&[("edge", 0.29610685), ("free", 1.1221241), ("get", 0.085246466), ("random", 0.8496751), ("scale", 1.1221241), ("weight", 0.94876033)],
&[("get", 0.22761041), ("node", 0.38941613), ("random", 2.268656)],
&[("edge", 0.5437204), ("get", 0.15653217), ("id", 0.7573753), ("random", 1.5601994)],
&[("free", 1.1221241), ("get", 0.085246466), ("node", 0.14584725), ("outbounds", 1.4699334), ("random", 0.8496751), ("scale", 1.1221241)],
&[("free", 1.1221241), ("get", 0.085246466), ("inbounds", 1.4699334), ("node", 0.14584725), ("random", 0.8496751), ("scale", 1.1221241)],
&[("get", 0.113196395), ("nodes", 0.8635923), ("random", 1.1282598), ("sorted", 1.6058578), ("unique", 1.3103347)],
&[("breadth", 1.0321105), ("first", 1.0321105), ("get", 0.085246466), ("nodes", 0.65035814), ("random", 0.8496751), ("search", 1.0321105)],
&[("get", 0.085246466), ("nodes", 0.65035814), ("random", 1.5520903), ("uniform", 1.4699334), ("walk", 1.4699334)],
&[("get", 0.15653217), ("methods", 2.3300989), ("node", 0.26780915), ("sampling", 2.6991367)],
&[("get", 0.22761041), ("nodes", 1.736474), ("subsampled", 3.9247627)],
&[("bm25", 1.3487675), ("feature", 1.4699334), ("get", 0.085246466), ("node", 0.14584725), ("okapi", 1.3487675), ("propagation", 1.3487675)],
&[("bm25", 1.3487675), ("get", 0.085246466), ("label", 1.0083711), ("node", 0.14584725), ("okapi", 1.3487675), ("propagation", 1.3487675)],
&[("default", 2.6991367), ("graph", 1.3594929), ("has", 1.0888427), ("name", 1.0542574)],
&[("has", 2.441373), ("nodes", 2.677619)],
&[("edges", 3.3648603), ("has", 2.441373)],
&[("has", 1.5832652), ("nodes", 1.736474), ("trap", 2.6347642)],
&[("has", 0.7873977), ("nodes", 0.8635923), ("selfloops", 1.1440115), ("trap", 1.3103347), ("with", 1.0136231)],
&[("directed", 2.9619932), ("is", 3.5984852)],
&[("acyclic", 3.6012464), ("directed", 1.9208949), ("is", 2.333669)],
&[("edge", 0.79061335), ("has", 1.5832652), ("weights", 2.3688624)],
&[("edge", 0.39319196), ("has", 0.7873977), ("probabilities", 1.9518834), ("representing", 1.9518834), ("weights", 1.178095)],
&[("has", 1.0888427), ("nodes", 1.1942074), ("singleton", 1.3462936), ("weighted", 1.2857033)],
&[("constant", 2.6991367), ("edge", 0.5437204), ("has", 1.0888427), ("weights", 1.6291134)],
&[("edge", 0.5437204), ("has", 1.0888427), ("negative", 2.476648), ("weights", 1.6291134)],
&[("edge", 0.79061335), ("has", 1.5832652), ("types", 1.3075695)],
&[("has", 2.441373), ("selfloops", 3.547075)],
&[("disconnected", 3.2289894), ("has", 1.5832652), ("nodes", 1.736474)],
&[("has", 1.5832652), ("nodes", 1.736474), ("singleton", 1.9576195)],
&[("has", 0.7873977), ("nodes", 0.8635923), ("selfloops", 1.1440115), ("singleton", 0.97357357), ("with", 1.0136231)],
&[("connected", 4.06277), ("is", 3.5984852)],
&[("has", 1.5832652), ("node", 0.38941613), ("types", 1.3075695)],
&[("has", 1.0888427), ("multilabel", 2.476648), ("node", 0.26780915), ("types", 0.8992413)],
&[("has", 1.0888427), ("node", 0.26780915), ("types", 0.8992413), ("unknown", 1.5601994)],
&[("has", 1.0888427), ("known", 1.416696), ("node", 0.26780915), ("types", 0.8992413)],
&[("edge", 0.5437204), ("has", 1.0888427), ("types", 0.8992413), ("unknown", 1.5601994)],
&[("edge", 0.5437204), ("has", 1.0888427), ("known", 1.416696), ("types", 0.8992413)],
&[("has", 1.0888427), ("homogeneous", 1.8516018), ("node", 0.26780915), ("types", 0.8992413)],
&[("exclusively", 1.6058578), ("has", 0.7873977), ("homogeneous", 1.3389878), ("node", 0.19366646), ("types", 0.65028733)],
&[("has", 1.0888427), ("homogeneous", 1.8516018), ("node", 0.26780915), ("ontologies", 2.1332383)],
&[("edge", 0.5437204), ("has", 1.0888427), ("homogeneous", 1.8516018), ("types", 0.8992413)],
&[("edge", 0.39319196), ("exclusively", 1.6058578), ("has", 0.7873977), ("homogeneous", 1.3389878), ("types", 0.65028733)],
&[("has", 1.0888427), ("node", 0.26780915), ("singleton", 1.3462936), ("types", 0.8992413)],
&[("exclusively", 1.6058578), ("has", 0.7873977), ("node", 0.19366646), ("singleton", 0.97357357), ("types", 0.65028733)],
&[("has", 1.5832652), ("node", 0.38941613), ("oddities", 3.388152)],
&[("has", 1.0888427), ("node", 0.26780915), ("oddities", 2.3300989), ("types", 0.8992413)],
&[("edge", 0.5437204), ("has", 1.0888427), ("singleton", 1.3462936), ("types", 0.8992413)],
&[("edge", 0.39319196), ("exclusively", 1.6058578), ("has", 0.7873977), ("singleton", 0.97357357), ("types", 0.65028733)],
&[("edge", 0.5437204), ("has", 1.0888427), ("oddities", 2.3300989), ("types", 0.8992413)],
&[("is", 3.5984852), ("multigraph", 4.783088)],
&[("has", 1.5832652), ("node", 0.38941613), ("ontologies", 3.1019008)],
&[("has", 1.0888427), ("node", 0.26780915), ("ontologies", 2.1332383), ("unknown", 1.5601994)],
&[("by", 0.6762648), ("decreasing", 0.83820975), ("degree", 0.4958696), ("has", 0.3685136), ("node", 0.090638734), ("nodes", 0.40417382), ("outbound", 0.7515649), ("sorted", 0.7515649)],
&[("by", 1.0881811), ("has", 0.5929771), ("lexicographic", 1.3487675), ("nodes", 0.65035814), ("order", 1.3487675), ("sorted", 1.2093469)],
&[("contains", 3.6012464), ("identity", 3.6012464), ("matrix", 2.5819569)],
&[("by", 0.6762648), ("degree", 0.4958696), ("has", 0.3685136), ("increasing", 0.83820975), ("node", 0.090638734), ("nodes", 0.40417382), ("outbound", 0.7515649), ("sorted", 0.7515649)],
&[("enabled", 2.476648), ("has", 1.0888427), ("sources", 2.6991367), ("tradeoff", 2.476648)],
&[("degrees", 0.96701515), ("enabled", 1.3487675), ("has", 0.5929771), ("reciprocal", 1.1617486), ("sqrt", 1.1617486), ("tradeoff", 1.3487675)],
&[("dendritic", 3.6012464), ("get", 0.22761041), ("trees", 3.6012464)],
&[("closure", 3.9247627), ("get", 0.22761041), ("transitive", 3.9247627)],
&[("all", 1.711019), ("get", 0.15653217), ("paths", 2.476648), ("shortest", 1.6547412)],
&[("all", 1.2373252), ("get", 0.113196395), ("paths", 1.7909907), ("shortest", 1.1966277), ("weighted", 0.9297577)],
&[("edge", 0.42907235), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("unchecked", 0.39324442), ("weight", 0.7381395)],
&[("edge", 0.23037235), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("node", 0.113469765), ("unchecked", 0.39324442), ("weight", 0.7381395)],
&[("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("name", 0.446685), ("node", 0.21133932), ("unchecked", 0.39324442)],
&[("edge", 0.28662342), ("from", 0.12652998), ("get", 0.043243896), ("id", 0.20923404), ("name", 0.2912513), ("type", 0.3805336), ("unchecked", 0.25640652)],
&[("edge", 0.28662342), ("from", 0.12652998), ("get", 0.043243896), ("id", 0.20923404), ("name", 0.2912513), ("type", 0.3805336), ("unchecked", 0.25640652)],
&[("count", 0.6762648), ("edge", 0.34754658), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("type", 0.24431232), ("unchecked", 0.31412047)],
&[("count", 0.6762648), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("node", 0.17118385), ("type", 0.24431232), ("unchecked", 0.31412047)],
&[("and", 0.32059008), ("edge", 0.20380214), ("from", 0.08873444), ("get", 0.030326592), ("id", 0.28388616), ("ids", 0.12810032), ("node", 0.05188543), ("type", 0.13985467), ("unchecked", 0.1798158)],
&[("edge", 0.18401958), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.4226371), ("minmax", 0.7515649), ("node", 0.090638734), ("unchecked", 0.31412047)],
&[("edge", 0.23037235), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("ids", 0.28014633), ("node", 0.113469765), ("unchecked", 0.39324442)],
&[("edge", 0.23037235), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("names", 0.37327477), ("node", 0.113469765), ("unchecked", 0.39324442)],
&[("edge", 0.18401958), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.48411497), ("node", 0.090638734), ("source", 0.6009646), ("unchecked", 0.31412047)],
&[("destination", 0.6578146), ("edge", 0.18401958), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.48411497), ("node", 0.090638734), ("unchecked", 0.31412047)],
&[("edge", 0.23037235), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.5976763), ("node", 0.113469765), ("source", 0.7523418)],
&[("destination", 0.82351184), ("edge", 0.23037235), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.5976763), ("node", 0.113469765)],
&[("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("node", 0.090638734), ("number", 0.3812292), ("of", 0.3812292), ("selfloops", 0.53541404), ("unchecked", 0.31412047)],
&[("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("node", 0.113469765), ("number", 0.47725716), ("of", 0.47725716), ("selfloops", 0.67027974)],
&[("from", 0.19405593), ("get", 0.06632211), ("name", 0.446685), ("node", 0.113469765), ("number", 0.47725716), ("of", 0.47725716), ("selfloops", 0.67027974)],
&[("edge", 0.18401958), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("name", 0.35680836), ("node", 0.090638734), ("source", 0.6009646), ("unchecked", 0.31412047)],
&[("destination", 0.6578146), ("edge", 0.18401958), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("name", 0.35680836), ("node", 0.090638734), ("unchecked", 0.31412047)],
&[("edge", 0.23037235), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("name", 0.446685), ("node", 0.113469765), ("source", 0.7523418)],
&[("destination", 0.82351184), ("edge", 0.23037235), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("name", 0.446685), ("node", 0.113469765)],
&[("edge", 0.29610685), ("from", 0.24942788), ("get", 0.085246466), ("id", 0.412462), ("names", 0.47978503), ("node", 0.14584725)],
&[("edge", 0.29610685), ("from", 0.24942788), ("get", 0.085246466), ("id", 0.412462), ("ids", 0.36008334), ("node", 0.14584725)],
&[("edge", 0.23037235), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("ids", 0.28014633), ("node", 0.113469765), ("unchecked", 0.39324442)],
&[("edge", 0.29610685), ("from", 0.24942788), ("get", 0.085246466), ("id", 0.412462), ("ids", 0.36008334), ("node", 0.14584725)],
&[("get", 0.085246466), ("id", 0.412462), ("node", 0.14584725), ("source", 0.96701515), ("unchecked", 0.5054528), ("unique", 0.9867929)],
&[("and", 0.32059008), ("edge", 0.20380214), ("from", 0.08873444), ("get", 0.030326592), ("id", 0.28388616), ("ids", 0.12810032), ("node", 0.05188543), ("type", 0.13985467), ("unchecked", 0.1798158)],
&[("and", 0.3799311), ("edge", 0.24007486), ("from", 0.105159126), ("get", 0.035940025), ("id", 0.33441225), ("ids", 0.15181161), ("node", 0.061489392), ("type", 0.16574168)],
&[("and", 0.40469912), ("edge", 0.19530523), ("from", 0.057226434), ("get", 0.019558163), ("id", 0.18523084), ("ids", 0.0826142), ("node", 0.033461846), ("type", 0.09019479), ("unchecked", 0.11596644), ("weight", 0.21767482)],
&[("and", 0.46223167), ("edge", 0.22241054), ("from", 0.065564714), ("get", 0.022407921), ("id", 0.2115635), ("ids", 0.094651654), ("node", 0.038337465), ("type", 0.10333678), ("weight", 0.24939153)],
&[("central", 1.1617486), ("get", 0.085246466), ("ids", 0.36008334), ("k", 1.0881811), ("node", 0.14584725), ("top", 1.2689577)],
&[("central", 0.9038453), ("get", 0.06632211), ("ids", 0.28014633), ("k", 0.8466095), ("node", 0.113469765), ("top", 0.9872544), ("weighted", 0.5447478)],
&[("degree", 0.6207744), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("node", 0.21133932), ("unchecked", 0.39324442)],
&[("degree", 0.40476254), ("excluded", 0.745669), ("from", 0.12652998), ("get", 0.043243896), ("id", 0.20923404), ("node", 0.1411762), ("selfloop", 0.58933276), ("unchecked", 0.25640652)],
&[("adjusted", 0.83820975), ("degree", 0.4958696), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("node", 0.17118385), ("selfloop", 0.7219843)],
&[("adjusted", 0.83820975), ("degree", 0.4958696), ("from", 0.15501031), ("get", 0.052977566), ("name", 0.35680836), ("node", 0.17118385), ("selfloop", 0.7219843)],
&[("degree", 0.4958696), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("node", 0.17118385), ("unchecked", 0.31412047), ("weighted", 0.43514016)],
&[("degree", 0.7979063), ("from", 0.24942788), ("get", 0.085246466), ("id", 0.412462), ("node", 0.2664172)],
&[("comulative", 0.83820975), ("degree", 0.4958696), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("node", 0.17118385), ("unchecked", 0.31412047)],
&[("comulative", 1.0493468), ("degree", 0.6207744), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("node", 0.21133932)],
&[("degree", 0.4958696), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("node", 0.090638734), ("reciprocal", 0.7219843), ("sqrt", 0.7219843), ("unchecked", 0.31412047)],
&[("degree", 0.6207744), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("node", 0.113469765), ("reciprocal", 0.9038453), ("sqrt", 0.9038453)],
&[("degrees", 0.6009646), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("node", 0.090638734), ("reciprocal", 0.7219843), ("sqrt", 0.7219843), ("unchecked", 0.31412047)],
&[("degree", 0.6207744), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("node", 0.21133932), ("weighted", 0.5447478)],
&[("degree", 0.7979063), ("from", 0.24942788), ("get", 0.085246466), ("name", 0.57414216), ("node", 0.2664172)],
&[("central", 1.1617486), ("get", 0.085246466), ("k", 1.0881811), ("names", 0.47978503), ("node", 0.14584725), ("top", 1.2689577)],
&[("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("ids", 0.22377864), ("node", 0.17118385), ("type", 0.24431232), ("unchecked", 0.31412047)],
&[("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("ids", 0.28014633), ("node", 0.21133932), ("type", 0.30585226)],
&[("edge", 0.34754658), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.48411497), ("type", 0.24431232), ("unchecked", 0.31412047)],
&[("edge", 0.34754658), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("name", 0.35680836), ("type", 0.24431232), ("unchecked", 0.31412047)],
&[("edge", 0.42907235), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.5976763), ("type", 0.30585226)],
&[("edge", 0.34754658), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("ids", 0.22377864), ("node", 0.090638734), ("type", 0.24431232)],
&[("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("names", 0.29816887), ("node", 0.17118385), ("type", 0.24431232), ("unchecked", 0.31412047)],
&[("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("names", 0.37327477), ("node", 0.21133932), ("type", 0.30585226)],
&[("from", 0.19405593), ("get", 0.06632211), ("name", 0.446685), ("names", 0.37327477), ("node", 0.21133932), ("type", 0.30585226)],
&[("edge", 0.42907235), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("name", 0.446685), ("type", 0.30585226)],
&[("edge", 0.34754658), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("name", 0.35680836), ("type", 0.4614178)],
&[("edge", 0.54089445), ("from", 0.24942788), ("get", 0.085246466), ("id", 0.412462), ("weight", 0.94876033)],
&[("edge", 0.29610685), ("from", 0.24942788), ("get", 0.085246466), ("ids", 0.36008334), ("node", 0.14584725), ("weight", 0.94876033)],
&[("and", 0.3799311), ("edge", 0.24007486), ("from", 0.105159126), ("get", 0.035940025), ("id", 0.17389452), ("ids", 0.15181161), ("node", 0.061489392), ("type", 0.16574168), ("weight", 0.3999986)],
&[("and", 0.3799311), ("edge", 0.24007486), ("from", 0.105159126), ("get", 0.035940025), ("name", 0.2420591), ("names", 0.202278), ("node", 0.061489392), ("type", 0.16574168), ("weight", 0.3999986)],
&[("edge", 0.29610685), ("from", 0.24942788), ("get", 0.085246466), ("names", 0.47978503), ("node", 0.14584725), ("weight", 0.94876033)],
&[("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("name", 0.446685), ("node", 0.21133932), ("unchecked", 0.39324442)],
&[("from", 0.24942788), ("get", 0.085246466), ("id", 0.412462), ("name", 0.57414216), ("node", 0.2664172)],
&[("from", 0.24942788), ("get", 0.085246466), ("id", 0.412462), ("name", 0.57414216), ("node", 0.2664172)],
&[("from", 0.24942788), ("get", 0.085246466), ("ids", 0.36008334), ("names", 0.47978503), ("node", 0.2664172)],
&[("from", 0.24942788), ("get", 0.085246466), ("ids", 0.36008334), ("names", 0.47978503), ("node", 0.2664172)],
&[("edge", 0.34754658), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("names", 0.29816887), ("node", 0.17118385)],
&[("edge", 0.34754658), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("names", 0.29816887), ("node", 0.17118385)],
&[("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("name", 0.446685), ("node", 0.21133932), ("type", 0.30585226)],
&[("from", 0.19405593), ("get", 0.06632211), ("name", 0.8319583), ("node", 0.21133932), ("type", 0.30585226)],
&[("count", 0.8466095), ("edge", 0.42907235), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("type", 0.30585226)],
&[("edge", 0.34754658), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("name", 0.35680836), ("type", 0.4614178)],
&[("count", 0.8466095), ("edge", 0.42907235), ("from", 0.19405593), ("get", 0.06632211), ("name", 0.446685), ("type", 0.30585226)],
&[("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("name", 0.35680836), ("node", 0.17118385), ("type", 0.4614178)],
&[("count", 0.8466095), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("node", 0.21133932), ("type", 0.30585226)],
&[("count", 0.8466095), ("from", 0.19405593), ("get", 0.06632211), ("name", 0.446685), ("node", 0.21133932), ("type", 0.30585226)],
&[("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("ids", 0.28014633), ("neighbour", 0.9872544), ("node", 0.21133932)],
&[("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("name", 0.446685), ("neighbour", 0.9872544), ("node", 0.21133932)],
&[("from", 0.19405593), ("get", 0.06632211), ("name", 0.446685), ("names", 0.37327477), ("neighbour", 0.9872544), ("node", 0.21133932)],
&[("edge", 0.23037235), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.5217772), ("minmax", 0.9408769), ("node", 0.113469765)],
&[("and", 0.3799311), ("edge", 0.24007486), ("from", 0.105159126), ("get", 0.035940025), ("id", 0.33441225), ("ids", 0.15181161), ("node", 0.061489392), ("type", 0.16574168)],
&[("edge", 0.29610685), ("from", 0.24942788), ("get", 0.085246466), ("id", 0.412462), ("names", 0.47978503), ("node", 0.14584725)],
&[("and", 0.3799311), ("edge", 0.24007486), ("from", 0.105159126), ("get", 0.035940025), ("id", 0.17389452), ("name", 0.2420591), ("names", 0.202278), ("node", 0.061489392), ("type", 0.16574168)],
&[("edge", 0.34754658), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("names", 0.29816887), ("type", 0.4614178)],
&[("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("names", 0.29816887), ("node", 0.17118385), ("type", 0.4614178)],
&[("from", 0.12652998), ("get", 0.043243896), ("ids", 0.18266337), ("multiple", 0.745669), ("names", 0.24338573), ("node", 0.1411762), ("type", 0.3805336)],
&[("edge", 0.15020931), ("from", 0.12652998), ("get", 0.043243896), ("id", 0.20923404), ("ids", 0.18266337), ("minmax", 0.6134784), ("node", 0.0739855), ("source", 0.4905482), ("unchecked", 0.25640652)],
&[("edge", 0.18401958), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("ids", 0.22377864), ("minmax", 0.7515649), ("node", 0.090638734), ("source", 0.6009646)],
&[("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("name", 0.35680836), ("node", 0.17118385), ("type", 0.4614178)],
&[("from", 0.12652998), ("get", 0.043243896), ("ids", 0.18266337), ("names", 0.24338573), ("node", 0.1411762), ("type", 0.3805336), ("unchecked", 0.25640652)],
&[("from", 0.12652998), ("get", 0.043243896), ("id", 0.20923404), ("node", 0.0739855), ("nodes", 0.32991418), ("number", 0.3111852), ("of", 0.3111852), ("type", 0.19942436), ("unchecked", 0.25640652)],
&[("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("node", 0.090638734), ("nodes", 0.40417382), ("number", 0.3812292), ("of", 0.3812292), ("type", 0.24431232)],
&[("from", 0.15501031), ("get", 0.052977566), ("name", 0.35680836), ("node", 0.090638734), ("nodes", 0.40417382), ("number", 0.3812292), ("of", 0.3812292), ("type", 0.24431232)],
&[("edge", 0.15020931), ("edges", 0.41459042), ("from", 0.12652998), ("get", 0.043243896), ("id", 0.20923404), ("number", 0.3111852), ("of", 0.3111852), ("type", 0.19942436), ("unchecked", 0.25640652)],
&[("edge", 0.18401958), ("edges", 0.50790966), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("number", 0.3812292), ("of", 0.3812292), ("type", 0.24431232)],
&[("edge", 0.18401958), ("edges", 0.50790966), ("from", 0.15501031), ("get", 0.052977566), ("name", 0.35680836), ("number", 0.3812292), ("of", 0.3812292), ("type", 0.24431232)],
&[("counts", 0.47308898), ("from", 0.105159126), ("get", 0.035940025), ("hashmap", 0.47308898), ("id", 0.17389452), ("ids", 0.15181161), ("node", 0.11824872), ("type", 0.16574168), ("unchecked", 0.21309958)],
&[("counts", 0.47308898), ("edge", 0.12483904), ("from", 0.105159126), ("get", 0.035940025), ("hashmap", 0.47308898), ("id", 0.17389452), ("ids", 0.15181161), ("node", 0.061489392), ("type", 0.16574168), ("unchecked", 0.21309958)],
&[("edge", 0.34754658), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("ids", 0.22377864), ("node", 0.090638734), ("type", 0.24431232)],
&[("directed", 0.36495247), ("edge", 0.28662342), ("from", 0.12652998), ("get", 0.043243896), ("id", 0.20923404), ("ids", 0.18266337), ("node", 0.0739855), ("type", 0.19942436)],
&[("directed", 0.36495247), ("edge", 0.28662342), ("from", 0.12652998), ("get", 0.043243896), ("id", 0.20923404), ("names", 0.24338573), ("node", 0.0739855), ("type", 0.19942436)],
&[("directed", 0.36495247), ("edge", 0.28662342), ("from", 0.12652998), ("get", 0.043243896), ("name", 0.2912513), ("names", 0.24338573), ("node", 0.0739855), ("type", 0.19942436)],
&[("directed", 0.4470988), ("edge", 0.34754658), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("ids", 0.22377864), ("type", 0.24431232)],
&[("edge", 0.34754658), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("name", 0.35680836), ("node", 0.090638734), ("type", 0.24431232)],
&[("directed", 0.36495247), ("edge", 0.28662342), ("from", 0.12652998), ("get", 0.043243896), ("ids", 0.18266337), ("name", 0.2912513), ("node", 0.0739855), ("type", 0.19942436)],
&[("directed", 0.4470988), ("edge", 0.34754658), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("name", 0.35680836), ("type", 0.24431232)],
&[("curie", 0.5520134), ("directed", 0.36495247), ("edge", 0.15020931), ("from", 0.12652998), ("get", 0.043243896), ("names", 0.24338573), ("node", 0.1411762), ("prefixes", 0.46466494)],
&[("curie", 0.5520134), ("directed", 0.36495247), ("edge", 0.15020931), ("from", 0.12652998), ("get", 0.043243896), ("ids", 0.18266337), ("node", 0.1411762), ("prefixes", 0.46466494)],
&[("curie", 0.6762648), ("directed", 0.4470988), ("edge", 0.18401958), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("node", 0.090638734), ("prefixes", 0.5692553)],
&[("curie", 0.5520134), ("directed", 0.36495247), ("edges", 0.41459042), ("from", 0.12652998), ("get", 0.043243896), ("node", 0.0739855), ("number", 0.3111852), ("of", 0.3111852), ("prefixes", 0.46466494)],
&[("curie", 0.8466095), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("node", 0.21133932), ("prefixes", 0.7126453)],
&[("curie", 0.8466095), ("from", 0.19405593), ("get", 0.06632211), ("names", 0.37327477), ("node", 0.21133932), ("prefixes", 0.7126453)],
&[("curie", 0.6762648), ("from", 0.15501031), ("get", 0.052977566), ("node", 0.090638734), ("nodes", 0.40417382), ("number", 0.3812292), ("of", 0.3812292), ("prefixes", 0.5692553)],
&[("get", 0.15653217), ("names", 0.8809959), ("node", 0.26780915), ("prefixes", 1.6819717)],
&[("from", 0.24942788), ("get", 0.085246466), ("graph", 0.7403716), ("ids", 0.36008334), ("mapping", 1.2689577), ("node", 0.14584725)],
&[("degrees", 0.96701515), ("get", 0.085246466), ("node", 0.14584725), ("non", 1.4699334), ("subgraph", 1.3487675), ("zero", 1.4699334)],
&[("edge", 0.23037235), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.5217772), ("multigraph", 0.9038453), ("node", 0.113469765)],
&[("edges", 0.50790966), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("multigraph", 0.7219843), ("node", 0.090638734), ("number", 0.3812292), ("of", 0.3812292)],
&[("ancestors", 1.1221241), ("from", 0.24942788), ("get", 0.085246466), ("ids", 0.36008334), ("jaccard", 1.0083711), ("node", 0.14584725)],
&[("ancestors", 1.1221241), ("from", 0.24942788), ("get", 0.085246466), ("jaccard", 1.0083711), ("names", 0.47978503), ("node", 0.14584725)],
&[("edge", 0.18401958), ("from", 0.15501031), ("get", 0.052977566), ("graphlet", 0.7886109), ("heterogeneous", 0.7886109), ("ids", 0.4226371), ("node", 0.090638734)],
&[("edge", 0.18401958), ("from", 0.15501031), ("get", 0.052977566), ("graphlet", 0.7886109), ("heterogeneous", 0.7886109), ("ids", 0.22377864), ("names", 0.29816887), ("node", 0.090638734)],
&[("edge", 0.18401958), ("from", 0.15501031), ("get", 0.052977566), ("graphlet", 0.7886109), ("heterogeneous", 0.7886109), ("names", 0.5631334), ("node", 0.090638734)],
&[("get", 0.35097212), ("tendrils", 5.553072)],
&[("degree", 0.7979063), ("distribution", 1.4699334), ("geometric", 1.4699334), ("get", 0.085246466), ("node", 0.14584725), ("threshold", 1.4699334)],
&[("edge", 0.39319196), ("get", 0.113196395), ("methods", 1.6850134), ("sparse", 1.9518834), ("weighting", 1.7909907)],
&[("edge", 0.5437204), ("get", 0.15653217), ("methods", 2.3300989), ("weighting", 2.476648)],
&[("add", 4.4802), ("selfloops", 3.547075)],
&[("centrality", 2.268656), ("degree", 2.1304317), ("get", 0.22761041)],
&[("centrality", 1.5601994), ("degree", 1.4651399), ("get", 0.15653217), ("weighted", 1.2857033)],
&[("centrality", 0.6610508), ("closeness", 0.9038453), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("node", 0.113469765), ("unchecked", 0.39324442)],
&[("centrality", 0.5280421), ("closeness", 0.7219843), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("node", 0.090638734), ("unchecked", 0.31412047), ("weighted", 0.43514016)],
&[("centrality", 2.268656), ("closeness", 3.1019008), ("get", 0.22761041)],
&[("centrality", 1.5601994), ("closeness", 2.1332383), ("get", 0.15653217), ("weighted", 1.2857033)],
&[("centrality", 0.6610508), ("from", 0.19405593), ("get", 0.06632211), ("harmonic", 0.9038453), ("id", 0.32089716), ("node", 0.113469765), ("unchecked", 0.39324442)],
&[("centrality", 0.5280421), ("from", 0.15501031), ("get", 0.052977566), ("harmonic", 0.7219843), ("id", 0.25633007), ("node", 0.090638734), ("unchecked", 0.31412047), ("weighted", 0.43514016)],
&[("centrality", 2.268656), ("get", 0.22761041), ("harmonic", 3.1019008)],
&[("centrality", 1.5601994), ("get", 0.15653217), ("harmonic", 2.1332383), ("weighted", 1.2857033)],
&[("centrality", 2.268656), ("get", 0.22761041), ("stress", 3.9247627)],
&[("betweenness", 3.1019008), ("centrality", 2.268656), ("get", 0.22761041)],
&[("approximated", 0.7381395), ("betweenness", 0.9038453), ("centrality", 0.6610508), ("from", 0.19405593), ("get", 0.06632211), ("id", 0.32089716), ("node", 0.113469765)],
&[("approximated", 0.7381395), ("betweenness", 0.9038453), ("centrality", 0.6610508), ("from", 0.19405593), ("get", 0.06632211), ("name", 0.446685), ("node", 0.113469765)],
&[("approximated", 0.5896199), ("betweenness", 0.7219843), ("centrality", 0.5280421), ("from", 0.15501031), ("get", 0.052977566), ("id", 0.25633007), ("node", 0.090638734), ("weighted", 0.43514016)],
&[("approximated", 0.5896199), ("betweenness", 0.7219843), ("centrality", 0.5280421), ("from", 0.15501031), ("get", 0.052977566), ("name", 0.35680836), ("node", 0.090638734), ("weighted", 0.43514016)],
&[("centrality", 2.268656), ("eigenvector", 3.6012464), ("get", 0.22761041)],
&[("centrality", 1.5601994), ("eigenvector", 2.476648), ("get", 0.15653217), ("weighted", 1.2857033)],
&[("dot", 6.0519295), ("to", 3.9061842)],
&[("16", 0.9872544), ("base", 0.76772904), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("node", 0.113469765), ("tricodes", 0.82351184)],
&[("13", 0.9872544), ("base", 0.76772904), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("node", 0.113469765), ("tricodes", 0.82351184)],
&[("30", 0.9872544), ("base", 0.76772904), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("node", 0.113469765), ("tricodes", 0.82351184)],
&[("64", 1.0493468), ("base", 0.76772904), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("node", 0.113469765), ("tricodes", 0.82351184)],
&[("16", 0.9872544), ("base", 0.76772904), ("from", 0.19405593), ("get", 0.06632211), ("names", 0.37327477), ("node", 0.113469765), ("tricodes", 0.82351184)],
&[("13", 0.9872544), ("base", 0.76772904), ("from", 0.19405593), ("get", 0.06632211), ("names", 0.37327477), ("node", 0.113469765), ("tricodes", 0.82351184)],
&[("30", 0.9872544), ("base", 0.76772904), ("from", 0.19405593), ("get", 0.06632211), ("names", 0.37327477), ("node", 0.113469765), ("tricodes", 0.82351184)],
&[("64", 1.0493468), ("base", 0.76772904), ("from", 0.19405593), ("get", 0.06632211), ("names", 0.37327477), ("node", 0.113469765), ("tricodes", 0.82351184)],
&[("16", 1.6850134), ("base", 1.3103347), ("census", 1.6850134), ("get", 0.113196395), ("triad", 1.6850134)],
&[("13", 1.6850134), ("base", 1.3103347), ("census", 1.6850134), ("get", 0.113196395), ("triad", 1.6850134)],
&[("30", 1.6850134), ("base", 1.3103347), ("census", 1.6850134), ("get", 0.113196395), ("triad", 1.6850134)],
&[("get", 0.35097212), ("stars", 6.0519295)],
&[("community", 1.6850134), ("detection", 1.9518834), ("get", 0.113196395), ("louvain", 1.9518834), ("undirected", 1.4449652)],
&[("community", 0.9872544), ("directed", 0.55971867), ("from", 0.19405593), ("get", 0.06632211), ("memberships", 1.0493468), ("modularity", 1.0493468), ("node", 0.113469765)],
&[("community", 0.9872544), ("from", 0.19405593), ("get", 0.06632211), ("memberships", 1.0493468), ("modularity", 1.0493468), ("node", 0.113469765), ("undirected", 0.8466095)],
&[("distance", 1.1436143), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("node", 0.113469765), ("structural", 1.0493468), ("unchecked", 0.39324442)],
&[("attachment", 1.3103347), ("get", 0.113196395), ("minimum", 1.4449652), ("preferential", 1.3103347), ("unchecked", 0.6711767)],
&[("attachment", 1.3103347), ("get", 0.113196395), ("maximum", 1.3705107), ("preferential", 1.3103347), ("unchecked", 0.6711767)],
&[("attachment", 0.9867929), ("get", 0.085246466), ("minimum", 1.0881811), ("preferential", 0.9867929), ("unchecked", 0.5054528), ("weighted", 0.70018625)],
&[("attachment", 0.9867929), ("get", 0.085246466), ("maximum", 1.0321105), ("preferential", 0.9867929), ("unchecked", 0.5054528), ("weighted", 0.70018625)],
&[("attachment", 0.76772904), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("node", 0.113469765), ("preferential", 0.76772904), ("unchecked", 0.39324442)],
&[("attachment", 0.9867929), ("from", 0.24942788), ("get", 0.085246466), ("ids", 0.36008334), ("node", 0.14584725), ("preferential", 0.9867929)],
&[("attachment", 0.9867929), ("from", 0.24942788), ("get", 0.085246466), ("names", 0.47978503), ("node", 0.14584725), ("preferential", 0.9867929)],
&[("attachment", 0.61325574), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("node", 0.090638734), ("preferential", 0.61325574), ("unchecked", 0.31412047), ("weighted", 0.43514016)],
&[("attachment", 0.76772904), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("node", 0.113469765), ("preferential", 0.76772904), ("weighted", 0.5447478)],
&[("attachment", 0.76772904), ("from", 0.19405593), ("get", 0.06632211), ("names", 0.37327477), ("node", 0.113469765), ("preferential", 0.76772904), ("weighted", 0.5447478)],
&[("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("intersection", 0.7886109), ("neighbours", 0.7886109), ("node", 0.090638734), ("size", 0.7219843), ("unchecked", 0.31412047)],
&[("coefficient", 0.8466095), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("jaccard", 0.78451693), ("node", 0.113469765), ("unchecked", 0.39324442)],
&[("coefficient", 1.0881811), ("from", 0.24942788), ("get", 0.085246466), ("ids", 0.36008334), ("jaccard", 1.0083711), ("node", 0.14584725)],
&[("coefficient", 1.0881811), ("from", 0.24942788), ("get", 0.085246466), ("jaccard", 1.0083711), ("names", 0.47978503), ("node", 0.14584725)],
&[("adamic", 0.6973591), ("adar", 0.6973591), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("index", 0.62666583), ("node", 0.090638734), ("unchecked", 0.31412047)],
&[("adamic", 0.8730172), ("adar", 0.8730172), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("index", 0.78451693), ("node", 0.113469765)],
&[("adamic", 0.8730172), ("adar", 0.8730172), ("from", 0.19405593), ("get", 0.06632211), ("index", 0.78451693), ("names", 0.37327477), ("node", 0.113469765)],
&[("allocation", 0.6762648), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("index", 0.62666583), ("node", 0.090638734), ("resource", 0.6762648), ("unchecked", 0.31412047)],
&[("allocation", 0.5520134), ("from", 0.12652998), ("get", 0.043243896), ("ids", 0.18266337), ("index", 0.5115273), ("node", 0.0739855), ("resource", 0.5520134), ("unchecked", 0.25640652), ("weighted", 0.35519102)],
&[("allocation", 0.8466095), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("index", 0.78451693), ("node", 0.113469765), ("resource", 0.8466095)],
&[("allocation", 0.8466095), ("from", 0.19405593), ("get", 0.06632211), ("index", 0.78451693), ("names", 0.37327477), ("node", 0.113469765), ("resource", 0.8466095)],
&[("allocation", 0.6762648), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("index", 0.62666583), ("node", 0.090638734), ("resource", 0.6762648), ("weighted", 0.43514016)],
&[("allocation", 0.6762648), ("from", 0.15501031), ("get", 0.052977566), ("index", 0.62666583), ("names", 0.29816887), ("node", 0.090638734), ("resource", 0.6762648), ("weighted", 0.43514016)],
&[("available", 1.3487675), ("edge", 0.29610685), ("get", 0.085246466), ("metrics", 1.0321105), ("number", 0.6134378), ("of", 0.6134378)],
&[("available", 1.7909907), ("edge", 0.39319196), ("get", 0.113196395), ("metrics", 1.3705107), ("names", 0.6370931)],
&[("all", 0.4726896), ("edge", 0.15020931), ("from", 0.12652998), ("get", 0.043243896), ("ids", 0.18266337), ("metrics", 0.5235698), ("node", 0.0739855), ("tuple", 0.58933276), ("unchecked", 0.25640652)],
&[("all", 0.57908624), ("edge", 0.18401958), ("from", 0.15501031), ("get", 0.052977566), ("ids", 0.22377864), ("metrics", 0.641419), ("node", 0.090638734), ("tuple", 0.7219843)],
&[("all", 0.7249525), ("edge", 0.23037235), ("from", 0.19405593), ("get", 0.06632211), ("ids", 0.28014633), ("metrics", 0.80298626), ("node", 0.113469765)],
&[("attachment", 1.8119793), ("get", 0.15653217), ("preferential", 1.8119793), ("scores", 2.2206397)],
&[("allocation", 1.4449652), ("get", 0.113196395), ("index", 1.3389878), ("resource", 1.4449652), ("scores", 1.6058578)],
&[("coefficient", 1.9981514), ("get", 0.15653217), ("jaccard", 1.8516018), ("scores", 2.2206397)],
&[("adamic", 2.0604784), ("adar", 2.0604784), ("get", 0.15653217), ("scores", 2.2206397)],
&[("all", 1.711019), ("edge", 0.5437204), ("get", 0.15653217), ("metrics", 1.8951929)],
&[("all", 1.2373252), ("directed", 0.95530945), ("edge", 0.39319196), ("get", 0.113196395), ("metrics", 1.3705107)],
&[("all", 0.93181056), ("edge", 0.29610685), ("get", 0.085246466), ("metrics", 1.0321105), ("triangular", 0.87402433), ("upper", 1.0321105)],
&[("all", 0.93181056), ("edge", 0.29610685), ("get", 0.085246466), ("lower", 1.0321105), ("metrics", 1.0321105), ("triangular", 0.87402433)],
&[("get", 0.085246466), ("groups", 1.0321105), ("ids", 0.36008334), ("isomorphic", 0.74778455), ("node", 0.14584725), ("type", 0.3931242)],
&[("get", 0.085246466), ("groups", 1.0321105), ("isomorphic", 0.74778455), ("names", 0.47978503), ("node", 0.14584725), ("type", 0.3931242)],
&[("get", 0.06632211), ("groups", 0.80298626), ("isomorphic", 0.5817795), ("node", 0.113469765), ("number", 0.47725716), ("of", 0.47725716), ("type", 0.30585226)],
&[("approximated", 0.7381395), ("get", 0.06632211), ("groups", 0.80298626), ("ids", 0.28014633), ("isomorphic", 0.5817795), ("node", 0.113469765), ("type", 0.30585226)],
&[("approximated", 0.7381395), ("get", 0.06632211), ("groups", 0.80298626), ("isomorphic", 0.5817795), ("names", 0.37327477), ("node", 0.113469765), ("type", 0.30585226)],
&[("approximated", 0.5896199), ("get", 0.052977566), ("groups", 0.641419), ("isomorphic", 0.4647208), ("node", 0.090638734), ("number", 0.3812292), ("of", 0.3812292), ("type", 0.24431232)],
&[("edge", 0.29610685), ("get", 0.085246466), ("groups", 1.0321105), ("ids", 0.36008334), ("isomorphic", 0.74778455), ("type", 0.3931242)],
&[("edge", 0.29610685), ("get", 0.085246466), ("groups", 1.0321105), ("isomorphic", 0.74778455), ("names", 0.47978503), ("type", 0.3931242)],
&[("edge", 0.23037235), ("get", 0.06632211), ("groups", 0.80298626), ("isomorphic", 0.5817795), ("number", 0.47725716), ("of", 0.47725716), ("type", 0.30585226)],
&[("has", 1.5832652), ("isomorphic", 1.9966053), ("nodes", 1.736474)],
&[("from", 0.15501031), ("has", 0.3685136), ("ids", 0.22377864), ("isomorphic", 0.4647208), ("node", 0.17118385), ("types", 0.30434394), ("unchecked", 0.31412047)],
&[("from", 0.19405593), ("has", 0.46133867), ("ids", 0.28014633), ("isomorphic", 0.5817795), ("node", 0.21133932), ("types", 0.3810053)],
&[("csv", 6.0519295), ("from", 1.0269308)],
];
...
impl GraphBuilder {
    ...
    /// 
            pub fn add_edge(& mut self, src: String, dst: String, edge_type: Option<String>, weight: Option<WeightT>)-> PyResult<()>{
            Ok(pe!(self.inner.add_edge(src.into(), dst.into(), edge_type, weight))?)
            }
    ...
    ///     The weight of the edge, if present
    /// 
            pub fn remove_edge(& mut self, src: String, dst: String, edge_type: Option<String>, weight: Option<WeightT>)-> PyResult<()>{
            Ok(pe!(self.inner.remove_edge(src.into(), dst.into(), edge_type, weight))?)
            }
...
&[("default", 0.63361573), ("set", 0.3506282), ("weight", 0.63361573)],
...
pub const GRAPHCSVBUILDER_METHODS_NAMES: &[&str] = &[
    "new",
    "add_edge",
    "add_node",
    "finish",
...
pub const GRAPHCSVBUILDER_TERMS: &[&str] = &[
    "new",
    "add",
    "edge",
    "node",
    ...
    fn __getattr__(&self, name: String) -> PyResult<()> {
        ...
        Err(PyAttributeError::new_err(format!(
            ...
            doc_scores
                .iter()
                .map(|(method_id, _)| { 
                    format!("* `{}`", GRAPHCSVBUILDER_METHODS_NAMES[*method_id].to_string()) 
                })
                .take(10)
                .collect::<Vec<String>>()
                .join("\n"),
...
&[("get", 0.1049044), ("id", 0.35410967), ("node", 0.1049044), ("root", 0.20386682)],
&[("get", 0.1049044), ("name", 0.35410967), ("node", 0.1049044), ("root", 0.20386682)],
&[("len", 1.7199612)],
&[("get", 0.16212498), ("ids", 0.5472604), ("node", 0.16212498)],
];
...
impl ShortestPathsDjkstra {
    ...
    /// 
            pub fn get_point_at_given_distance_on_shortest_path(&self, dst_node_id: NodeT, distance: f32)-> PyResult<NodeT>{
            Ok(pe!(self.inner.get_point_at_given_distance_on_shortest_path(dst_node_id.clone(), distance.clone()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_number_of_shortest_paths_from_node_id(node_id.clone()))?.into())
            }
    ...
    ///     If the given node ID does not exist in the graph.
    /// 
            pub fn get_successors_from_node_id(&self, source_node_id: NodeT)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_successors_from_node_id(source_node_id.clone()))?, NodeT)})
            }
...
&[("has", 0.61376506), ("id", 0.244485), ("node", 0.19700517), ("path", 0.46857908), ("to", 0.61376506)],
&[("distance", 0.3015193), ("from", 0.3015193), ("get", 0.034845833), ("id", 0.244485), ("node", 0.19700517)],
&[("from", 0.3015193), ("get", 0.034845833), ("id", 0.244485), ("node", 0.19700517), ("parent", 0.61376506)],
&[("at", 0.2818008), ("distance", 0.13843796), ("get", 0.01599893), ("given", 0.2818008), ("on", 0.2818008), ("path", 0.2151409), ("point", 0.2151409), ("shortest", 0.1712331)],
&[("get", 0.07200755), ("median", 1.2683215), ("point", 0.96830034)],
&[("eccentricity", 2.0014732), ("get", 0.11363142)],
&[("distance", 0.62307787), ("get", 0.07200755), ("total", 0.96830034)],
&[("distance", 0.42168552), ("get", 0.04873314), ("log", 0.8583724), ("total", 0.6553246)],
&[("distant", 0.8583724), ("get", 0.04873314), ("most", 0.8583724), ("node", 0.27551875)],
&[("get", 0.034845833), ("number", 0.46857908), ("of", 0.46857908), ("paths", 0.46857908), ("shortest", 0.37294748)],
&[("from", 0.13843796), ("get", 0.01599893), ("id", 0.11225154), ("node", 0.090451896), ("number", 0.2151409), ("of", 0.2151409), ("paths", 0.2151409), ("shortest", 0.1712331)],
&[("from", 0.3015193), ("get", 0.034845833), ("id", 0.244485), ("node", 0.19700517), ("successors", 0.61376506)],
];
    ...
    fn __getattr__(&self, name: String) -> PyResult<()> {
        ...
        Err(PyAttributeError::new_err(format!(
            ...
            doc_scores
                .iter()
                .map(|(method_id, _)| { 
                    format!("* `{}`", SHORTESTPATHSDJKSTRA_METHODS_NAMES[*method_id].to_string()) 
                })
                .take(10)
                .collect::<Vec<String>>()
                .join("\n"),
...
impl ShortestPathsResultBFS {
    ...
    ///     If the predecessors vector was not requested.
    /// 
            pub unsafe fn get_unchecked_kth_point_on_shortest_path(&self, dst_node_id: NodeT, k: NodeT)-> PyResult<NodeT>{
            Ok(pe!(self.inner.get_unchecked_kth_point_on_shortest_path(dst_node_id.clone(), k.clone()))?.into())
            }
    ...
    /// 
            ...
            Ok(pe!(self.inner.get_kth_point_on_shortest_path(dst_node_id.clone(), k.clone()))?.into())
            }
...
to_ndarray_1d!(gil, pe!(self.inner.get_successors_from_node_id(source_node_id.clone()))?, NodeT)})
    ...
    ///     If the given node ID does not exist in the graph.
    /// 
            pub fn get_predecessors_from_node_id(&self, source_node_id: NodeT)-> PyResult<Py<PyArray1<NodeT>>>{
            Ok({let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, pe!(self.inner.get_predecessors_from_node_id(source_node_id.clone()))?, NodeT)})
            }
    ...
    /// 
            pub fn get_shared_ancestors_size(&self, first_node_id: NodeT, second_node_id: NodeT)-> PyResult<f32>{
            Ok(pe!(self.inner.get_shared_ancestors_size(first_node_id.clone(), second_node_id.clone()))?.into())
            }
    ...
    ///     If the given node IDs do not exist in the graph.
    /// 
            pub fn get_ancestors_jaccard_index(&self, first_node_id: NodeT, second_node_id: NodeT)-> PyResult<f32>{
            Ok(pe!(self.inner.get_ancestors_jaccard_index(first_node_id.clone(), second_node_id.clone()))?.into())
            }
...
&[("has", 0.6958796), ("id", 0.2852428), ("node", 0.21011747), ("path", 0.4586001), ("to", 0.55282664)],
&[("distance", 0.6958796), ("from", 0.33202505), ("get", 0.024366887), ("id", 0.2852428), ("node", 0.21011747)],
&[("from", 0.33202505), ("get", 0.024366887), ("id", 0.2852428), ("node", 0.21011747), ("parent", 0.6958796)],
&[("get", 0.014045565), ("kth", 0.31866044), ("on", 0.31866044), ("path", 0.26434636), ("point", 0.22377864), ("shortest", 0.22377864), ("unchecked", 0.40111902)],
&[("get", 0.01818011), ("kth", 0.4124634), ("on", 0.4124634), ("path", 0.34216106), ("point", 0.28965157), ("shortest", 0.28965157)],
&[("get", 0.05054337), ("median", 1.1467087), ("point", 0.8052739)],
&[("distant", 0.31866044), ("get", 0.014045565), ("median", 0.31866044), ("most", 0.31866044), ("node", 0.12111595), ("point", 0.22377864), ("to", 0.31866044)],
&[("eccentricity", 2.2853043), ("get", 0.08002211)],
&[("distant", 0.7743416), ("get", 0.03413058), ("most", 0.7743416), ("node", 0.2943105)],
&[("get", 0.024366887), ("number", 0.55282664), ("of", 0.55282664), ("paths", 0.55282664), ("shortest", 0.38822138)],
&[("from", 0.15205239), ("get", 0.011158927), ("id", 0.13062824), ("node", 0.096224256), ("number", 0.25316948), ("of", 0.25316948), ("paths", 0.25316948), ("shortest", 0.17778775)],
&[("from", 0.33202505), ("get", 0.024366887), ("id", 0.2852428), ("node", 0.21011747), ("successors", 0.6958796)],
&[("from", 0.33202505), ("get", 0.024366887), ("id", 0.2852428), ("node", 0.21011747), ("predecessors", 0.55282664)],
&[("ancestors", 0.7743416), ("get", 0.03413058), ("shared", 0.9747151), ("size", 0.9747151)],
&[("ancestors", 0.7743416), ("get", 0.03413058), ("index", 0.9747151), ("jaccard", 0.9747151)],
    ...
    fn __getattr__(&self, name: String) -> PyResult<()> {
        ...
        Err(PyAttributeError::new_err(format!(
            ...
            doc_scores
                .iter()
                .map(|(method_id, _)| { 
                    format!("* `{}`", SHORTESTPATHSRESULTBFS_METHODS_NAMES[*method_id].to_string()) 
                })
                .take(10)
                .collect::<Vec<String>>()
                .join("\n"),
...
to_ndarray_1d!(gil, self.inner.get_first_k_star_node_ids(k.clone()), NodeT)
    ...
    /// 
            ...
            self.inner.get_first_k_star_node_names(k.clone()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
            ...
            self.inner.get_star_node_names().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
...
&[("get", 0.07583805), ("name", 0.611402), ("node", 0.07583805), ("root", 0.42482838)],
&[("len", 2.5416396)],
&[("get", 0.07583805), ("ids", 0.42482838), ("node", 0.07583805), ("star", 0.21014561)],
&[("first", 0.22323874), ("get", 0.039851367), ("ids", 0.22323874), ("k", 0.22323874), ("node", 0.039851367), ("star", 0.110427275)],
&[("first", 0.22323874), ("get", 0.039851367), ("k", 0.22323874), ("names", 0.22323874), ("node", 0.039851367), ("star", 0.110427275)],
&[("get", 0.07583805), ("names", 0.42482838), ("node", 0.07583805), ("star", 0.21014561)],
];
...
to_ndarray_1d!(gil, self.inner.get_tendril_node_ids(), NodeT)
    ...
    /// 
            ...
            let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.inner.get_first_k_tendril_node_ids(k.clone()), NodeT)
            }
    ...
    /// 
            ...
            self.inner.get_first_k_tendril_node_names(k.clone()).into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
            ...
            self.inner.get_tendril_node_names().into_iter().map(|x| x.into()).collect::<Vec<_>>()
            }
...
&[("get", 0.07583805), ("name", 0.611402), ("node", 0.07583805), ("root", 0.42482838)],
&[("len", 2.5416396)],
&[("get", 0.07583805), ("ids", 0.42482838), ("node", 0.07583805), ("tendril", 0.21014561)],
&[("first", 0.22323874), ("get", 0.039851367), ("ids", 0.22323874), ("k", 0.22323874), ("node", 0.039851367), ("tendril", 0.110427275)],
&[("first", 0.22323874), ("get", 0.039851367), ("k", 0.22323874), ("names", 0.22323874), ("node", 0.039851367), ("tendril", 0.110427275)],
&[("get", 0.07583805), ("names", 0.42482838), ("node", 0.07583805), ("tendril", 0.21014561)],
];
...
pub fn register_edge_list_utils(_py: Python, _m:&PyModule) -> PyResult<()> {
    ...
    /// 
            pub fn convert_edge_list_to_numeric(original_edge_path: &str, target_edge_path: &str, directed: bool, original_node_path: Option<String>, original_node_list_separator: Option<char>, original_node_list_header: Option<bool>, original_node_list_support_balanced_quotes: Option<bool>, node_list_rows_to_skip: Option<usize>, node_list_is_correct: Option<bool>, node_list_max_rows_number: Option<usize>, node_list_comment_symbol: Option<String>, original_nodes_column_number: Option<usize>, original_nodes_column: Option<String>, number_of_nodes: Option<NodeT>, original_minimum_node_id: Option<NodeT>, original_numeric_node_ids: Option<bool>, original_load_node_list_in_parallel: Option<bool>, original_edge_type_path: Option<String>, original_edge_types_column_number: Option<usize>, original_edge_types_column: Option<String>, number_of_edge_types: Option<EdgeTypeT>, original_numeric_edge_type_ids: Option<bool>, original_minimum_edge_type_id: Option<EdgeTypeT>, original_edge_type_list_separator: Option<char>, original_edge_type_list_header: Option<bool>, original_edge_type_list_support_balanced_quotes: Option<bool>, edge_type_list_rows_to_skip: Option<usize>, edge_type_list_is_correct: Option<bool>, edge_type_list_max_rows_number: Option<usize>, edge_type_list_comment_symbol: Option<String>, load_edge_type_list_in_parallel: Option<bool>, original_edge_list_separator: Option<char>, original_edge_list_header: Option<bool>, original_edge_list_support_balanced_quotes: Option<bool>, original_sources_column_number: Option<usize>, original_sources_column: Option<String>, original_destinations_column_number: Option<usize>, original_destinations_column: Option<String>, original_edge_list_edge_types_column: Option<String>, original_edge_list_edge_types_column_number: Option<usize>, original_weights_column: Option<String>, original_weights_column_number: Option<usize>, target_edge_list_separator: Option<char>, target_edge_list_header: Option<bool>, target_sources_column: Option<String>, target_sources_column_number: Option<usize>, target_destinations_column: Option<String>, target_destinations_column_number: Option<usize>, target_edge_list_edge_types_column: Option<String>, target_edge_list_edge_types_column_number: Option<usize>, target_weights_column: Option<String>, target_weights_column_number: Option<usize>, target_node_path: Option<&str>, target_node_list_separator: Option<char>, target_node_list_header: Option<bool>, target_nodes_column: Option<String>, target_nodes_column_number: Option<usize>, target_edge_type_list_path: Option<String>, target_edge_type_list_separator: Option<char>, target_edge_type_list_header: Option<bool>, target_edge_type_list_edge_types_column: Option<String>, target_edge_type_list_edge_types_column_number: Option<usize>, remove_chevrons: Option<bool>, remove_spaces: Option<bool>, comment_symbol: Option<String>, default_edge_type: Option<String>, default_weight: Option<WeightT>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, number_of_edges: Option<usize>, skip_edge_types_if_unavailable: Option<bool>, skip_weights_if_unavailable: Option<bool>, numeric_rows_are_surely_smaller_than_original: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<(NodeT, Option<EdgeTypeT>)>{
            Ok({let (subresult_0, subresult_1) = pe!(graph::convert_edge_list_to_numeric(original_edge_path, target_edge_path, directed.clone(), original_node_path, original_node_list_separator, original_node_list_header, original_node_list_support_balanced_quotes, node_list_rows_to_skip, node_list_is_correct, node_list_max_rows_number, node_list_comment_symbol, original_nodes_column_number, original_nodes_column, number_of_nodes, original_minimum_node_id, original_numeric_node_ids, original_load_node_list_in_parallel, original_edge_type_path, original_edge_types_column_number, original_edge_types_column, number_of_edge_types, original_numeric_edge_type_ids, original_minimum_edge_type_id, original_edge_type_list_separator, original_edge_type_list_header, original_edge_type_list_support_balanced_quotes, edge_type_list_rows_to_skip, edge_type_list_is_correct, edge_type_list_max_rows_number, edge_type_list_comment_symbol, load_edge_type_list_in_parallel, original_edge_list_separator, original_edge_list_header, original_edge_list_support_balanced_quotes, original_sources_column_number, original_sources_column, original_destinations_column_number, original_destinations_column, original_edge_list_edge_types_column, original_edge_list_edge_types_column_number, original_weights_column, original_weights_column_number, target_edge_list_separator, target_edge_list_header, target_sources_column, target_sources_column_number, target_destinations_column, target_destinations_column_number, target_edge_list_edge_types_column, target_edge_list_edge_types_column_number, target_weights_column, target_weights_column_number, target_node_path, target_node_list_separator, target_node_list_header, target_nodes_column, target_nodes_column_number, target_edge_type_list_path, target_edge_type_list_separator, target_edge_type_list_header, target_edge_type_list_edge_types_column, target_edge_type_list_edge_types_column_number, remove_chevrons, remove_spaces, comment_symbol, default_edge_type, default_weight, max_rows_number, rows_to_skip, number_of_edges, skip_edge_types_if_unavailable, skip_weights_if_unavailable, numeric_rows_are_surely_smaller_than_original, verbose, name))?.into();
(subresult_0.into(), subresult_1.map(|x| x.into()))})
    ...
    /// 
            pub fn densify_sparse_numeric_edge_list(original_edge_path: &str, target_edge_path: &str, directed: bool, maximum_node_id: Option<EdgeT>, original_edge_list_separator: Option<char>, original_edge_list_header: Option<bool>, original_sources_column: Option<String>, original_sources_column_number: Option<usize>, original_destinations_column: Option<String>, original_destinations_column_number: Option<usize>, original_edge_list_edge_types_column: Option<String>, original_edge_list_edge_types_column_number: Option<usize>, original_weights_column: Option<String>, original_weights_column_number: Option<usize>, original_edge_list_support_balanced_quotes: Option<bool>, original_edge_type_path: Option<String>, original_edge_types_column_number: Option<usize>, original_edge_types_column: Option<String>, number_of_edge_types: Option<EdgeTypeT>, original_numeric_edge_type_ids: Option<bool>, original_minimum_edge_type_id: Option<EdgeTypeT>, original_edge_type_list_separator: Option<char>, original_edge_type_list_header: Option<bool>, original_edge_type_list_support_balanced_quotes: Option<bool>, edge_type_list_rows_to_skip: Option<usize>, edge_type_list_is_correct: Option<bool>, edge_type_list_max_rows_number: Option<usize>, edge_type_list_comment_symbol: Option<String>, load_edge_type_list_in_parallel: Option<bool>, target_edge_list_separator: Option<char>, target_edge_list_header: Option<bool>, target_sources_column: Option<String>, target_sources_column_number: Option<usize>, target_destinations_column: Option<String>, target_destinations_column_number: Option<usize>, target_edge_list_edge_types_column: Option<String>, target_edge_list_edge_types_column_number: Option<usize>, target_weights_column: Option<String>, target_weights_column_number: Option<usize>, target_node_path: Option<&str>, target_node_list_separator: Option<char>, target_node_list_header: Option<bool>, target_nodes_column: Option<String>, target_nodes_column_number: Option<usize>, target_edge_type_list_path: Option<String>, target_edge_type_list_separator: Option<char>, target_edge_type_list_header: Option<bool>, target_edge_type_list_edge_types_column: Option<String>, target_edge_type_list_edge_types_column_number: Option<usize>, comment_symbol: Option<String>, default_edge_type: Option<String>, default_weight: Option<WeightT>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, number_of_edges: Option<usize>, skip_edge_types_if_unavailable: Option<bool>, skip_weights_if_unavailable: Option<bool>, numeric_rows_are_surely_smaller_than_original: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<(NodeT, Option<EdgeTypeT>)>{
            Ok({let (subresult_0, subresult_1) = pe!(graph::densify_sparse_numeric_edge_list(original_edge_path, target_edge_path, directed.clone(), maximum_node_id, original_edge_list_separator, original_edge_list_header, original_sources_column, original_sources_column_number, original_destinations_column, original_destinations_column_number, original_edge_list_edge_types_column, original_edge_list_edge_types_column_number, original_weights_column, original_weights_column_number, original_edge_list_support_balanced_quotes, original_edge_type_path, original_edge_types_column_number, original_edge_types_column, number_of_edge_types, original_numeric_edge_type_ids, original_minimum_edge_type_id, original_edge_type_list_separator, original_edge_type_list_header, original_edge_type_list_support_balanced_quotes, edge_type_list_rows_to_skip, edge_type_list_is_correct, edge_type_list_max_rows_number, edge_type_list_comment_symbol, load_edge_type_list_in_parallel, target_edge_list_separator, target_edge_list_header, target_sources_column, target_sources_column_number, target_destinations_column, target_destinations_column_number, target_edge_list_edge_types_column, target_edge_list_edge_types_column_number, target_weights_column, target_weights_column_number, target_node_path, target_node_list_separator, target_node_list_header, target_nodes_column, target_nodes_column_number, target_edge_type_list_path, target_edge_type_list_separator, target_edge_type_list_header, target_edge_type_list_edge_types_column, target_edge_type_list_edge_types_column_number, comment_symbol, default_edge_type, default_weight, max_rows_number, rows_to_skip, number_of_edges, skip_edge_types_if_unavailable, skip_weights_if_unavailable, numeric_rows_are_surely_smaller_than_original, verbose, name))?.into();
(subresult_0.into(), subresult_1.map(|x| x.into()))})
            }
            ...
            #[pyfunction]
            #[automatically_generated_binding]
            #[pyo3(text_signature = "(path, separator, header, sources_column, sources_column_number, destinations_column, destinations_column_number, comment_symbol, support_balanced_quotes, max_rows_number, rows_to_skip, number_of_edges, load_edge_list_in_parallel, verbose, name)")]
    ...
    ///     The name of the graph to display in the loading bar.
    /// 
            pub fn are_there_selfloops_in_edge_list(path: &str, separator: Option<char>, header: Option<bool>, sources_column: Option<String>, sources_column_number: Option<usize>, destinations_column: Option<String>, destinations_column_number: Option<usize>, comment_symbol: Option<String>, support_balanced_quotes: Option<bool>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, number_of_edges: Option<EdgeT>, load_edge_list_in_parallel: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<bool>{
            Ok(pe!(graph::are_there_selfloops_in_edge_list(path, separator, header, sources_column, sources_column_number, destinations_column, destinations_column_number, comment_symbol, support_balanced_quotes, max_rows_number, rows_to_skip, number_of_edges, load_edge_list_in_parallel, verbose, name))?.into())
            }
    ...
    ///     If the original and target paths are identical.
    /// 
            pub fn convert_directed_edge_list_to_undirected(original_edge_path: &str, target_edge_path: &str, original_edge_list_separator: Option<char>, original_edge_list_header: Option<bool>, original_edge_list_support_balanced_quotes: Option<bool>, original_sources_column: Option<String>, original_sources_column_number: Option<usize>, original_destinations_column: Option<String>, original_destinations_column_number: Option<usize>, original_edge_list_edge_type_column: Option<String>, original_edge_list_edge_type_column_number: Option<usize>, original_weights_column: Option<String>, original_weights_column_number: Option<usize>, target_edge_list_separator: Option<char>, target_edge_list_header: Option<bool>, target_sources_column_number: Option<usize>, target_sources_column: Option<String>, target_destinations_column_number: Option<usize>, target_destinations_column: Option<String>, target_edge_list_edge_type_column: Option<String>, target_edge_list_edge_type_column_number: Option<usize>, target_weights_column: Option<String>, target_weights_column_number: Option<usize>, comment_symbol: Option<String>, default_edge_type: Option<String>, default_weight: Option<WeightT>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, number_of_edges: Option<usize>, skip_edge_types_if_unavailable: Option<bool>, skip_weights_if_unavailable: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<EdgeT>{
            Ok(pe!(graph::convert_directed_edge_list_to_undirected(original_edge_path, target_edge_path, original_edge_list_separator, original_edge_list_header, original_edge_list_support_balanced_quotes, original_sources_column, original_sources_column_number, original_destinations_column, original_destinations_column_number, original_edge_list_edge_type_column, original_edge_list_edge_type_column_number, original_weights_column, original_weights_column_number, target_edge_list_separator, target_edge_list_header, target_sources_column_number, target_sources_column, target_destinations_column_number, target_destinations_column, target_edge_list_edge_type_column, target_edge_list_edge_type_column_number, target_weights_column, target_weights_column_number, comment_symbol, default_edge_type, default_weight, max_rows_number, rows_to_skip, number_of_edges, skip_edge_types_if_unavailable, skip_weights_if_unavailable, verbose, name))?.into())
            }
            ...
            #[pyfunction]
            #[automatically_generated_binding]
            #[pyo3(text_signature = "(original_csv_path, target_csv_path, original_csv_separator, original_csv_header, target_csv_separator, target_csv_header, target_csv_ids_column, target_csv_ids_column_number, comment_symbol, support_balanced_quotes, max_rows_number, rows_to_skip, lines_number, verbose)")]
    ...
    ///     If the original and target paths are identical.
    /// 
            pub fn add_numeric_id_to_csv(original_csv_path: &str, target_csv_path: &str, original_csv_separator: Option<char>, original_csv_header: Option<bool>, target_csv_separator: Option<char>, target_csv_header: Option<bool>, target_csv_ids_column: Option<String>, target_csv_ids_column_number: Option<usize>, comment_symbol: Option<String>, support_balanced_quotes: Option<bool>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, lines_number: Option<usize>, verbose: Option<bool>)-> PyResult<usize>{
            Ok(pe!(graph::add_numeric_id_to_csv(original_csv_path, target_csv_path, original_csv_separator, original_csv_header, target_csv_separator, target_csv_header, target_csv_ids_column, target_csv_ids_column_number, comment_symbol, support_balanced_quotes, max_rows_number, rows_to_skip, lines_number, verbose))?.into())
            }
            ...
            pub fn build_optimal_lists_files(original_edge_path: String, target_edge_path: String, directed: bool, original_node_type_path: Option<String>, original_node_type_list_separator: Option<char>, original_node_types_column_number: Option<usize>, original_node_types_column: Option<String>, original_numeric_node_type_ids: Option<bool>, original_minimum_node_type_id: Option<NodeTypeT>, original_node_type_list_header: Option<bool>, original_node_type_list_support_balanced_quotes: Option<bool>, original_node_type_list_rows_to_skip: Option<usize>, original_node_type_list_max_rows_number: Option<usize>, original_node_type_list_comment_symbol: Option<String>, original_load_node_type_list_in_parallel: Option<bool>, original_node_type_list_is_correct: Option<bool>, number_of_node_types: Option<NodeTypeT>, target_node_type_list_path: Option<String>, target_node_type_list_separator: Option<char>, target_node_type_list_node_types_column_number: Option<usize>, target_node_type_list_node_types_column: Option<String>, target_node_type_list_header: Option<bool>, original_node_path: Option<String>, original_node_list_separator: Option<char>, original_node_list_header: Option<bool>, original_node_list_support_balanced_quotes: Option<bool>, node_list_rows_to_skip: Option<usize>, node_list_is_correct: Option<bool>, node_list_max_rows_number: Option<usize>, node_list_comment_symbol: Option<String>, default_node_type: Option<String>, original_nodes_column_number: Option<usize>, original_nodes_column: Option<String>, original_node_types_separator: Option<char>, original_node_list_node_types_column_number: Option<usize>, original_node_list_node_types_column: Option<String>, number_of_nodes: Option<NodeT>, original_minimum_node_id: Option<NodeT>, original_numeric_node_ids: Option<bool>, original_node_list_numeric_node_type_ids: Option<bool>, original_skip_node_types_if_unavailable: Option<bool>, original_load_node_list_in_parallel: Option<bool>, maximum_node_id: Option<EdgeT>, target_node_path: Option<String>, target_node_list_separator: Option<char>, target_node_list_header: Option<bool>, target_nodes_column: Option<String>, target_nodes_column_number: Option<usize>, target_node_types_separator: Option<char>, target_node_list_node_types_column: Option<String>, target_node_list_node_types_column_number: Option<usize>, original_edge_type_path: Option<String>, original_edge_type_list_separator: Option<char>, original_edge_types_column_number: Option<usize>, original_edge_types_column: Option<String>, original_numeric_edge_type_ids: Option<bool>, original_minimum_edge_type_id: Option<EdgeTypeT>, original_edge_type_list_header: Option<bool>, original_edge_type_list_support_balanced_quotes: Option<bool>, edge_type_list_rows_to_skip: Option<usize>, edge_type_list_max_rows_number: Option<usize>, edge_type_list_comment_symbol: Option<String>, load_edge_type_list_in_parallel: Option<bool>, edge_type_list_is_correct: Option<bool>, number_of_edge_types: Option<EdgeTypeT>, target_edge_type_list_path: Option<String>, target_edge_type_list_separator: Option<char>, target_edge_type_list_edge_types_column_number: Option<usize>, target_edge_type_list_edge_types_column: Option<String>, target_edge_type_list_header: Option<bool>, original_edge_list_separator: Option<char>, original_edge_list_header: Option<bool>, original_edge_list_support_balanced_quotes: Option<bool>, original_sources_column_number: Option<usize>, original_sources_column: Option<String>, original_destinations_column_number: Option<usize>, original_destinations_column: Option<String>, original_edge_list_edge_types_column_number: Option<usize>, original_edge_list_edge_types_column: Option<String>, default_edge_type: Option<String>, original_weights_column_number: Option<usize>, original_weights_column: Option<String>, default_weight: Option<WeightT>, original_edge_list_numeric_node_ids: Option<bool>, skip_weights_if_unavailable: Option<bool>, skip_edge_types_if_unavailable: Option<bool>, edge_list_comment_symbol: Option<String>, edge_list_max_rows_number: Option<usize>, edge_list_rows_to_skip: Option<usize>, load_edge_list_in_parallel: Option<bool>, number_of_edges: Option<EdgeT>, target_edge_list_separator: Option<char>, remove_chevrons: Option<bool>, remove_spaces: Option<bool>, numeric_rows_are_surely_smaller_than_original: Option<bool>, sort_temporary_directory: Option<String>, verbose: Option<bool>, name: Option<String>)-> PyResult<(Option<NodeTypeT>, NodeT, Option<EdgeTypeT>, EdgeT)>{
            Ok({let (subresult_0, subresult_1, subresult_2, subresult_3) = pe!(graph::build_optimal_lists_files(original_edge_path.into(), target_edge_path.into(), directed.clone(), original_node_type_path, original_node_type_list_separator, original_node_types_column_number, original_node_types_column, original_numeric_node_type_ids, original_minimum_node_type_id, original_node_type_list_header, original_node_type_list_support_balanced_quotes, original_node_type_list_rows_to_skip, original_node_type_list_max_rows_number, original_node_type_list_comment_symbol, original_load_node_type_list_in_parallel, original_node_type_list_is_correct, number_of_node_types, target_node_type_list_path, target_node_type_list_separator, target_node_type_list_node_types_column_number, target_node_type_list_node_types_column, target_node_type_list_header, original_node_path, original_node_list_separator, original_node_list_header, original_node_list_support_balanced_quotes, node_list_rows_to_skip, node_list_is_correct, node_list_max_rows_number, node_list_comment_symbol, default_node_type, original_nodes_column_number, original_nodes_column, original_node_types_separator, original_node_list_node_types_column_number, original_node_list_node_types_column, number_of_nodes, original_minimum_node_id, original_numeric_node_ids, original_node_list_numeric_node_type_ids, original_skip_node_types_if_unavailable, original_load_node_list_in_parallel, maximum_node_id, target_node_path, target_node_list_separator, target_node_list_header, target_nodes_column, target_nodes_column_number, target_node_types_separator, target_node_list_node_types_column, target_node_list_node_types_column_number, original_edge_type_path, original_edge_type_list_separator, original_edge_types_column_number, original_edge_types_column, original_numeric_edge_type_ids, original_minimum_edge_type_id, original_edge_type_list_header, original_edge_type_list_support_balanced_quotes, edge_type_list_rows_to_skip, edge_type_list_max_rows_number, edge_type_list_comment_symbol, load_edge_type_list_in_parallel, edge_type_list_is_correct, number_of_edge_types, target_edge_type_list_path, target_edge_type_list_separator, target_edge_type_list_edge_types_column_number, target_edge_type_list_edge_types_column, target_edge_type_list_header, original_edge_list_separator, original_edge_list_header, original_edge_list_support_balanced_quotes, original_sources_column_number, original_sources_column, original_destinations_column_number, original_destinations_column, original_edge_list_edge_types_column_number, original_edge_list_edge_types_column, default_edge_type, original_weights_column_number, original_weights_column, default_weight, original_edge_list_numeric_node_ids, skip_weights_if_unavailable, skip_edge_types_if_unavailable, edge_list_comment_symbol, edge_list_max_rows_number, edge_list_rows_to_skip, load_edge_list_in_parallel, number_of_edges, target_edge_list_separator, remove_chevrons, remove_spaces, numeric_rows_are_surely_smaller_than_original, sort_temporary_directory, verbose, name))?.into();
(subresult_0.map(|x| x.into()), subresult_1.into(), subresult_2.map(|x| x.into()), subresult_3.into())})
            }
    ...
    ///     The name of the graph to display in the loading bar.
    /// 
            pub fn filter_duplicates_from_edge_list(original_edge_path: &str, target_edge_path: &str, original_edge_list_separator: Option<char>, original_edge_list_header: Option<bool>, original_edge_list_support_balanced_quotes: Option<bool>, original_edge_list_sources_column: Option<String>, original_edge_list_sources_column_number: Option<usize>, original_edge_list_destinations_column: Option<String>, original_edge_list_destinations_column_number: Option<usize>, original_edge_list_edge_type_column: Option<String>, original_edge_list_edge_type_column_number: Option<usize>, original_edge_list_weights_column: Option<String>, original_edge_list_weights_column_number: Option<usize>, target_edge_list_separator: Option<char>, target_edge_list_header: Option<bool>, target_edge_list_sources_column_number: Option<usize>, target_edge_list_sources_column: Option<String>, target_edge_list_destinations_column_number: Option<usize>, target_edge_list_destinations_column: Option<String>, target_edge_list_edge_type_column: Option<String>, target_edge_list_edge_type_column_number: Option<usize>, target_edge_list_weights_column: Option<String>, target_edge_list_weights_column_number: Option<usize>, comment_symbol: Option<String>, default_edge_type: Option<String>, default_weight: Option<WeightT>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, number_of_edges: Option<usize>, skip_edge_types_if_unavailable: Option<bool>, skip_weights_if_unavailable: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<()>{
            Ok(pe!(graph::filter_duplicates_from_edge_list(original_edge_path, target_edge_path, original_edge_list_separator, original_edge_list_header, original_edge_list_support_balanced_quotes, original_edge_list_sources_column, original_edge_list_sources_column_number, original_edge_list_destinations_column, original_edge_list_destinations_column_number, original_edge_list_edge_type_column, original_edge_list_edge_type_column_number, original_edge_list_weights_column, original_edge_list_weights_column_number, target_edge_list_separator, target_edge_list_header, target_edge_list_sources_column_number, target_edge_list_sources_column, target_edge_list_destinations_column_number, target_edge_list_destinations_column, target_edge_list_edge_type_column, target_edge_list_edge_type_column_number, target_edge_list_weights_column, target_edge_list_weights_column_number, comment_symbol, default_edge_type, default_weight, max_rows_number, rows_to_skip, number_of_edges, skip_edge_types_if_unavailable, skip_weights_if_unavailable, verbose, name))?)
            }
    ...
    ///     The name of the graph to display in the loading bar.
    /// 
            pub fn convert_undirected_edge_list_to_directed(original_edge_path: &str, target_edge_path: &str, original_edge_list_separator: Option<char>, original_edge_list_header: Option<bool>, original_edge_list_support_balanced_quotes: Option<bool>, original_sources_column: Option<String>, original_sources_column_number: Option<usize>, original_destinations_column: Option<String>, original_destinations_column_number: Option<usize>, original_edge_list_edge_type_column: Option<String>, original_edge_list_edge_type_column_number: Option<usize>, original_weights_column: Option<String>, original_weights_column_number: Option<usize>, target_edge_list_separator: Option<char>, target_edge_list_header: Option<bool>, target_sources_column: Option<String>, target_sources_column_number: Option<usize>, target_destinations_column: Option<String>, target_destinations_column_number: Option<usize>, target_edge_list_edge_type_column: Option<String>, target_edge_list_edge_type_column_number: Option<usize>, target_weights_column: Option<String>, target_weights_column_number: Option<usize>, comment_symbol: Option<String>, default_edge_type: Option<String>, default_weight: Option<WeightT>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, number_of_edges: Option<usize>, skip_edge_types_if_unavailable: Option<bool>, skip_weights_if_unavailable: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<EdgeT>{
            Ok(pe!(graph::convert_undirected_edge_list_to_directed(original_edge_path, target_edge_path, original_edge_list_separator, original_edge_list_header, original_edge_list_support_balanced_quotes, original_sources_column, original_sources_column_number, original_destinations_column, original_destinations_column_number, original_edge_list_edge_type_column, original_edge_list_edge_type_column_number, original_weights_column, original_weights_column_number, target_edge_list_separator, target_edge_list_header, target_sources_column, target_sources_column_number, target_destinations_column, target_destinations_column_number, target_edge_list_edge_type_column, target_edge_list_edge_type_column_number, target_weights_column, target_weights_column_number, comment_symbol, default_edge_type, default_weight, max_rows_number, rows_to_skip, number_of_edges, skip_edge_types_if_unavailable, skip_weights_if_unavailable, verbose, name))?.into())
            }
            ...
            #[pyfunction]
            #[automatically_generated_binding]
            #[pyo3(text_signature = "(path, separator, header, support_balanced_quotes, sources_column, sources_column_number, destinations_column, destinations_column_number, comment_symbol, max_rows_number, rows_to_skip, number_of_edges, load_edge_list_in_parallel, remove_chevrons, remove_spaces, verbose, name)")]
    ...
    /// 
            pub fn get_minmax_node_from_numeric_edge_list(path: &str, separator: Option<char>, header: Option<bool>, support_balanced_quotes: Option<bool>, sources_column: Option<String>, sources_column_number: Option<usize>, destinations_column: Option<String>, destinations_column_number: Option<usize>, comment_symbol: Option<String>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, number_of_edges: Option<EdgeT>, load_edge_list_in_parallel: Option<bool>, remove_chevrons: Option<bool>, remove_spaces: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<(EdgeT, EdgeT, EdgeT)>{
            Ok({let (subresult_0, subresult_1, subresult_2) = pe!(graph::get_minmax_node_from_numeric_edge_list(path, separator, header, support_balanced_quotes, sources_column, sources_column_number, destinations_column, destinations_column_number, comment_symbol, max_rows_number, rows_to_skip, number_of_edges, load_edge_list_in_parallel, remove_chevrons, remove_spaces, verbose, name))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.into())})
            }
            ...
            #[pyfunction]
            #[automatically_generated_binding]
            #[pyo3(text_signature = "(source_path, edge_path, node_path, node_type_path, edge_type_path, node_list_separator, node_type_list_separator, edge_type_list_separator, node_types_separator, nodes_column, node_types_column, node_list_node_types_column, edge_types_column, node_descriptions_column, edge_list_separator, directed, sort_temporary_directory, compute_node_description, keep_nodes_without_descriptions, keep_nodes_without_categories, keep_interwikipedia_nodes, keep_external_nodes, verbose)")]
                /// TODO: write the docstrin
            pub fn parse_wikipedia_graph(source_path: &str, edge_path: &str, node_path: &str, node_type_path: &str, edge_type_path: &str, node_list_separator: char, node_type_list_separator: char, edge_type_list_separator: char, node_types_separator: &str, nodes_column: &str, node_types_column: &str, node_list_node_types_column: &str, edge_types_column: &str, node_descriptions_column: &str, edge_list_separator: char, directed: bool, sort_temporary_directory: Option<String>, compute_node_description: Option<bool>, keep_nodes_without_descriptions: Option<bool>, keep_nodes_without_categories: Option<bool>, keep_interwikipedia_nodes: Option<bool>, keep_external_nodes: Option<bool>, verbose: Option<bool>)-> PyResult<(NodeTypeT, NodeT, EdgeT)>{
            Ok({let (subresult_0, subresult_1, subresult_2) = pe!(graph::parse_wikipedia_graph(source_path, edge_path, node_path, node_type_path, edge_type_path, node_list_separator.clone(), node_type_list_separator.clone(), edge_type_list_separator.clone(), node_types_separator, nodes_column, node_types_column, node_list_node_types_column, edge_types_column, node_descriptions_column, edge_list_separator.clone(), directed.clone(), sort_temporary_directory, compute_node_description, keep_nodes_without_descriptions, keep_nodes_without_categories, keep_interwikipedia_nodes, keep_external_nodes, verbose))?.into();
(subresult_0.into(), subresult_1.into(), subresult_2.into())})
            }
    ...
    ///     The name of the graph to display in the loading bar.
    /// 
            pub fn is_numeric_edge_list(path: &str, separator: Option<char>, header: Option<bool>, support_balanced_quotes: Option<bool>, sources_column: Option<String>, sources_column_number: Option<usize>, destinations_column: Option<String>, destinations_column_number: Option<usize>, comment_symbol: Option<String>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, number_of_edges: Option<EdgeT>, load_edge_list_in_parallel: Option<bool>, remove_chevrons: Option<bool>, remove_spaces: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<bool>{
            Ok(pe!(graph::is_numeric_edge_list(path, separator, header, support_balanced_quotes, sources_column, sources_column_number, destinations_column, destinations_column_number, comment_symbol, max_rows_number, rows_to_skip, number_of_edges, load_edge_list_in_parallel, remove_chevrons, remove_spaces, verbose, name))?.into())
            }
    ...
    /// 
            pub fn convert_node_list_node_types_to_numeric(original_node_path: String, target_node_path: String, original_node_type_path: Option<String>, original_node_type_list_separator: Option<char>, original_node_types_column_number: Option<usize>, original_node_types_column: Option<String>, number_of_node_types: Option<NodeTypeT>, original_numeric_node_type_ids: Option<bool>, original_minimum_node_type_id: Option<NodeTypeT>, original_node_type_list_header: Option<bool>, original_node_type_list_support_balanced_quotes: Option<bool>, original_node_type_list_rows_to_skip: Option<usize>, original_node_type_list_is_correct: Option<bool>, original_node_type_list_max_rows_number: Option<usize>, original_node_type_list_comment_symbol: Option<String>, original_load_node_type_list_in_parallel: Option<bool>, target_node_type_list_path: Option<String>, target_node_type_list_separator: Option<char>, target_node_type_list_header: Option<bool>, target_node_type_list_node_types_column: Option<String>, target_node_type_list_node_types_column_number: Option<usize>, original_node_list_separator: Option<char>, original_node_list_header: Option<bool>, original_node_list_support_balanced_quotes: Option<bool>, node_list_rows_to_skip: Option<usize>, node_list_max_rows_number: Option<usize>, node_list_comment_symbol: Option<String>, default_node_type: Option<String>, original_nodes_column_number: Option<usize>, original_nodes_column: Option<String>, original_node_types_separator: Option<char>, original_node_list_node_types_column_number: Option<usize>, original_node_list_node_types_column: Option<String>, original_minimum_node_id: Option<NodeT>, original_numeric_node_ids: Option<bool>, original_node_list_numeric_node_type_ids: Option<bool>, original_skip_node_types_if_unavailable: Option<bool>, remove_chevrons: Option<bool>, remove_spaces: Option<bool>, target_node_list_separator: Option<char>, target_node_list_header: Option<bool>, target_nodes_column_number: Option<usize>, target_nodes_column: Option<String>, target_node_types_separator: Option<char>, target_node_list_node_types_column_number: Option<usize>, target_node_list_node_types_column: Option<String>, number_of_nodes: Option<NodeT>)-> PyResult<(NodeT, Option<NodeTypeT>)>{
            Ok({let (subresult_0, subresult_1) = pe!(graph::convert_node_list_node_types_to_numeric(original_node_path.into(), target_node_path.into(), original_node_type_path, original_node_type_list_separator, original_node_types_column_number, original_node_types_column, number_of_node_types, original_numeric_node_type_ids, original_minimum_node_type_id, original_node_type_list_header, original_node_type_list_support_balanced_quotes, original_node_type_list_rows_to_skip, original_node_type_list_is_correct, original_node_type_list_max_rows_number, original_node_type_list_comment_symbol, original_load_node_type_list_in_parallel, target_node_type_list_path, target_node_type_list_separator, target_node_type_list_header, target_node_type_list_node_types_column, target_node_type_list_node_types_column_number, original_node_list_separator, original_node_list_header, original_node_list_support_balanced_quotes, node_list_rows_to_skip, node_list_max_rows_number, node_list_comment_symbol, default_node_type, original_nodes_column_number, original_nodes_column, original_node_types_separator, original_node_list_node_types_column_number, original_node_list_node_types_column, original_minimum_node_id, original_numeric_node_ids, original_node_list_numeric_node_type_ids, original_skip_node_types_if_unavailable, remove_chevrons, remove_spaces, target_node_list_separator, target_node_list_header, target_nodes_column_number, target_nodes_column, target_node_types_separator, target_node_list_node_types_column_number, target_node_list_node_types_column, number_of_nodes))?.into();
(subresult_0.into(), subresult_1.map(|x| x.into()))})
            }
    ...
    ///     The name of the graph to display in the loading bar.
    /// 
            pub fn has_duplicated_edges_in_edge_list(edge_path: &str, edge_list_separator: Option<char>, edge_list_header: Option<bool>, edge_list_support_balanced_quotes: Option<bool>, edge_list_sources_column: Option<String>, edge_list_sources_column_number: Option<usize>, edge_list_destinations_column: Option<String>, edge_list_destinations_column_number: Option<usize>, edge_list_edge_type_column: Option<String>, edge_list_edge_type_column_number: Option<usize>, edge_list_weights_column: Option<String>, edge_list_weights_column_number: Option<usize>, comment_symbol: Option<String>, default_edge_type: Option<String>, default_weight: Option<WeightT>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, number_of_edges: Option<usize>, skip_edge_types_if_unavailable: Option<bool>, skip_weights_if_unavailable: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<bool>{
            Ok(pe!(graph::has_duplicated_edges_in_edge_list(edge_path, edge_list_separator, edge_list_header, edge_list_support_balanced_quotes, edge_list_sources_column, edge_list_sources_column_number, edge_list_destinations_column, edge_list_destinations_column_number, edge_list_edge_type_column, edge_list_edge_type_column_number, edge_list_weights_column, edge_list_weights_column_number, comment_symbol, default_edge_type, default_weight, max_rows_number, rows_to_skip, number_of_edges, skip_edge_types_if_unavailable, skip_weights_if_unavailable, verbose, name))?.into())
            }
    ...
    /// 
            pub fn sort_numeric_edge_list(path: &str, target_path: &str, separator: Option<char>, header: Option<bool>, sources_column: Option<String>, sources_column_number: Option<usize>, destinations_column: Option<String>, destinations_column_number: Option<usize>, edge_types_column: Option<String>, edge_types_column_number: Option<usize>, rows_to_skip: Option<usize>, skip_edge_types_if_unavailable: Option<bool>, sort_temporary_directory: Option<String>)-> PyResult<()>{
            Ok(pe!(graph::sort_numeric_edge_list(path, target_path, separator, header, sources_column, sources_column_number, destinations_column, destinations_column_number, edge_types_column, edge_types_column_number, rows_to_skip, skip_edge_types_if_unavailable, sort_temporary_directory))?)
            }
    ...
    ///     Where to store the temporary files that are created during parallel sorting.
    /// 
            pub fn sort_numeric_edge_list_inplace(path: &str, separator: Option<char>, header: Option<bool>, sources_column: Option<String>, sources_column_number: Option<usize>, destinations_column: Option<String>, destinations_column_number: Option<usize>, edge_types_column: Option<String>, edge_types_column_number: Option<usize>, rows_to_skip: Option<usize>, skip_edge_types_if_unavailable: Option<bool>, sort_temporary_directory: Option<String>)-> PyResult<()>{
            Ok(pe!(graph::sort_numeric_edge_list_inplace(path, separator, header, sources_column, sources_column_number, destinations_column, destinations_column_number, edge_types_column, edge_types_column_number, rows_to_skip, skip_edge_types_if_unavailable, sort_temporary_directory))?)
            }
            ...
            #[pyfunction]
            #[automatically_generated_binding]
            #[pyo3(text_signature = "(path, separator, header, support_balanced_quotes, sources_column, sources_column_number, destinations_column, destinations_column_number, comment_symbol, max_rows_number, rows_to_skip, number_of_edges, load_edge_list_in_parallel, verbose, name)")]
    ...
    ///     The name of the graph to display in the loading bar.
    /// 
            pub fn get_number_of_selfloops_from_edge_list(path: &str, separator: Option<char>, header: Option<bool>, support_balanced_quotes: Option<bool>, sources_column: Option<String>, sources_column_number: Option<usize>, destinations_column: Option<String>, destinations_column_number: Option<usize>, comment_symbol: Option<String>, max_rows_number: Option<usize>, rows_to_skip: Option<usize>, number_of_edges: Option<EdgeT>, load_edge_list_in_parallel: Option<bool>, verbose: Option<bool>, name: Option<String>)-> PyResult<EdgeT>{
            Ok(pe!(graph::get_number_of_selfloops_from_edge_list(path, separator, header, support_balanced_quotes, sources_column, sources_column_number, destinations_column, destinations_column_number, comment_symbol, max_rows_number, rows_to_skip, number_of_edges, load_edge_list_in_parallel, verbose, name))?.into())
            }
