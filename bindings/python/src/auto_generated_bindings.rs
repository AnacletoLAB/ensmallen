...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("walk", 0.8147559),
        ("laplacian", 0.7250969),
        ("transformed", 0.7250969),
        ("normalized", 0.7634316),
    ],
    &[
        ("get", 0.07660739),
        ("transformed", 0.94108135),
        ("normalized", 0.99083483),
        ("graph", 0.70943916),
        ("symmetric", 1.0574471),
        ("laplacian", 0.94108135),
    ],
    &[
        ("normalized", 1.3328642),
        ("graph", 0.95433265),
        ("symmetric", 1.4224706),
        ("transformed", 1.2659361),
        ("get", 0.10305173),
    ],
    &[
        ("unchecked", 0.5369749),
    ...
    &[
        ...
        ("is", 0.70943916),
        ("from", 0.22268268),
        ("disconnected", 0.94108135),
        ("unchecked", 0.39918053),
    ],
    &[
        ("from", 0.2995512),
        ("singleton", 0.74771774),
        ("is", 0.95433265),
        ("node_id", 0.5968801),
        ("unchecked", 0.5369749),
    ],
    ...
    &[
        ("with", 0.48653328),
        ("selfloops", 0.5692576),
        ("unchecked", 0.30756593),
        ("node_id", 0.34187815),
        ("is", 0.5466181),
        ("from", 0.17157552),
        ("singleton", 0.42827424),
    ],
    &[
        ("is", 0.70943916),
        ("selfloops", 0.7388222),
    ...
    &[("has", 2.225024), ("node_name", 2.7763855)],
    &[("has", 2.225024), ("node_type_id", 3.587371)],
    &[("has", 2.225024), ("node_type_name", 3.497755)],
    &[("has", 2.225024), ("edge_type_id", 2.8986773)],
    &[("has", 2.225024), ("edge_type_name", 3.341636)],
    &[
        ("has", 0.9316537),
        ("edge", 0.86114824),
        ("from", 0.4217212),
    ...
    &[
        ...
        ("has", 0.9316537),
        ("node_name", 1.1625177),
        ("node_type_name", 1.4645667),
    ],
    &[
        ("from", 0.4217212),
        ("edge", 0.86114824),
        ("node_names", 0.9493004),
        ("has", 0.9316537),
    ],
    &[
        ("node_names", 0.5012619),
        ("from", 0.22268268),
        ("has", 0.49194384),
        ("edge", 0.45471463),
        ("edge_type_name", 0.7388222),
        ("and", 0.70943916),
    ],
    &[
        ("components", 2.6589048),
        ("strongly", 3.27341),
        ("connected", 2.1849718),
    ],
    &[
        ...
        ("node", 0.44017798),
        ("by", 0.8399518),
        ("increasing", 1.0574471),
    ],
    &[
        ("sort", 0.94108135),
        ("decreasing", 1.0574471),
        ("outbound", 0.94108135),
        ("by", 0.8399518),
        ("degree", 0.62245655),
        ("node", 0.44017798),
    ...
    &[("components", 4.2564383), ("remove", 2.8560307)],
    &[("overlaps", 8.945586)],
    &[("contains", 8.164746)],
    &[
        ("get", 0.21644437),
    ...
    &[("edge", 2.0566392), ("encode", 5.240153)],
    &[("edge", 2.0566392), ("decode", 5.240153)],
    &[
        ("encodable", 1.5585093),
        ("max", 1.5585093),
        ("number", 0.7012854),
    ...
    &[("node_id", 2.006881), ("validate", 3.6869643)],
    &[("validate", 3.6869643), ("node_ids", 1.7313172)],
    &[("validate", 3.6869643), ("edge_id", 2.6036565)],
    &[("validate", 3.6869643), ("edge_ids", 3.587371)],
    &[
        ("unknown", 0.88945323),
        ("not", 1.1680068),
        ("contain", 1.2659361),
        ("node_types", 0.6942768),
        ("must", 1.016064),
    ],
    &[
        ("not", 1.1680068),
        ("edge_types", 0.73132414),
        ("must", 1.016064),
        ("contain", 1.2659361),
        ("unknown", 0.88945323),
    ],
    &[("node_type_id", 3.587371), ("validate", 3.6869643)],
    &[("validate", 3.6869643), ("node_type_ids", 3.341636)],
    &[("edge_type_id", 2.8986773), ("validate", 3.6869643)],
    &[("edge_type_ids", 3.927172), ("validate", 3.6869643)],
    &[
        ("undirected", 2.5466604),
        ("must", 2.1340868),
        ("be", 2.6589048),
    ],
    &[
    ...
    &[
        ("set", 1.7070034),
        ("inplace", 1.3185467),
        ("edge_types", 1.0295899),
        ("all", 1.5437918),
    ],
    &[
        ("all", 2.3031666),
        ("edge_types", 1.5360342),
        ("set", 2.5466604),
    ],
    &[
        ("set", 1.7070034),
    ...
    &[
        ("inplace", 1.3185467),
        ("remove", 1.1958663),
        ("homogeneous", 1.5907185),
        ("node_types", 0.977433),
    ],
    &[
        ("edge_type_ids", 2.4532192),
        ("remove", 1.7841004),
        ("inplace", 1.9671258),
    ],
    &[
    ...
    &[
        ("remove", 1.7841004),
        ("node_type_name", 2.1849718),
        ("inplace", 1.9671258),
    ],
    &[("remove", 2.8560307), ("node_type_id", 3.587371)],
    &[
        ("node_types", 1.458222),
        ("remove", 1.7841004),
        ("singleton", 1.5704665),
    ...
    &[
        ("homogeneous", 2.373176),
        ("remove", 1.7841004),
        ("node_types", 1.458222),
    ],
    &[("node_type_name", 3.497755), ("remove", 2.8560307)],
    &[
        ("remove", 1.7841004),
        ("edge_type_name", 2.0874476),
        ("inplace", 1.9671258),
    ],
    &[("remove", 2.8560307), ("edge_type_id", 2.8986773)],
    &[
        ("edge_types", 1.5360342),
        ("remove", 1.7841004),
        ("singleton", 1.5704665),
    ],
    &[("edge_type_name", 3.341636), ("remove", 2.8560307)],
    &[
        ("remove", 1.7841004),
        ("inplace", 1.9671258),
        ("node_types", 1.458222),
    ],
    &[("node_types", 2.3343568), ("remove", 2.8560307)],
    &[
        ("remove", 1.7841004),
        ("inplace", 1.9671258),
        ("edge_types", 1.5360342),
    ],
    &[("remove", 2.8560307), ("edge_types", 2.4589205)],
    &[
        ("edge", 0.86114824),
        ("inplace", 1.3185467),
        ("weights", 1.3435509),
    ...
    &[("get", 0.34648934), ("circles", 5.240153)],
    &[
        ("stats", 3.27341),
        ("memory", 2.0874476),
        ("get", 0.21644437),
    ...
    &[
        ...
        ("weights", 0.70943916),
        ("get", 0.07660739),
        ("requirements", 0.86828184),
    ],
    &[
        ("memory", 0.4513277),
        ("readable", 0.55061424),
        ("total", 0.4513277),
        ("requirements", 0.5304113),
        ("weights", 0.43337834),
        ("get", 0.04679751),
        ("human", 0.55061424),
        ("edge", 0.27777362),
    ...
    &[
        ...
        ("get", 0.10305173),
        ("total", 0.9938586),
        ("requirements", 1.1680068),
        ("memory", 0.9938586),
    ],
    &[
        ("node_types", 0.39766458),
        ("memory", 0.5692576),
        ("readable", 0.6944873),
        ("get", 0.059025485),
        ("human", 0.6944873),
        ("total", 0.5692576),
        ("requirements", 0.66900533),
    ],
    &[
        ("memory", 0.9938586),
        ("requirements", 1.1680068),
    ...
    &[("transitivity", 5.240153), ("get", 0.34648934)],
    &[
        ("per", 1.0574471),
        ("node", 0.44017798),
        ("of", 1.0574471),
    ...
    &[
        ...
        ("node", 0.5921244),
        ("per", 1.4224706),
        ("coefficient", 1.1680068),
        ("clustering", 1.3328642),
    ],
    &[
        ("coefficient", 2.4532192),
        ("get", 0.21644437),
        ("clustering", 2.7994769),
    ],
    &[
        ("average", 2.194137),
        ("clustering", 1.876464),
        ("get", 0.1450807),
        ("coefficient", 1.6443706),
    ],
    &[
        ("remappable", 3.27341),
        ("are", 3.27341),
    ...
    &[("negatives", 5.240153), ("sample", 5.240153)],
    &[("holdout", 3.6869643), ("connected", 3.497755)],
    &[("holdout", 3.6869643), ("random", 3.341636)],
    &[
        ("holdout", 1.096565),
        ("label", 1.0669442),
        ("indices", 1.5585093),
    ...
    &[("chains", 5.240153), ("get", 0.34648934)],
    &[
        ("predecessors", 0.57429713),
        ("node_id", 0.21994512),
        ("first", 0.3931597),
        ("get", 0.03797367),
        ("parallel", 0.44679394),
        ("unchecked", 0.19787058),
        ("from", 0.11038201),
        ("breadth", 0.3931597),
        ("search", 0.3931597),
    ],
    ...
    &[
        ...
        ("node_id", 0.5968801),
        ("from", 0.2995512),
        ("eccentricity", 1.1680068),
    ],
    &[
        ("eccentricity", 1.6443706),
        ("get", 0.1450807),
        ("from", 0.4217212),
        ("node_name", 1.1625177),
    ],
    ...
    &[("get", 0.34648934), ("diameter", 4.4814696)],
    &[
        ("get", 0.1450807),
        ("naive", 2.0026157),
        ("diameter", 1.876464),
    ...
    &[
        ("node_names", 0.67429405),
        ("selfloops", 0.9938586),
        ("get", 0.10305173),
        ("with", 0.8494314),
        ("singleton", 0.74771774),
    ],
    &[("get", 0.34648934), ("density", 5.240153)],
    &[
        ("nodes", 1.007849),
        ("trap", 1.6443706),
        ("rate", 1.6443706),
    ...
    &[
        ("edges", 1.2730454),
        ("get", 0.1450807),
        ("undirected", 1.7070034),
        ("number", 0.9873001),
    ],
    &[
        ("number", 0.7012854),
        ("get", 0.10305173),
        ("undirected", 1.2124952),
        ("unique", 1.040291),
        ("edges", 0.9042522),
    ],
    &[
    ...
    &[("get", 0.34648934), ("source_names", 5.240153)],
    &[
        ("destination", 2.4532192),
        ("get", 0.21644437),
        ("node_ids", 1.0815163),
    ],
    &[
        ...
        ("node_ids", 0.7249306),
        ("directed", 1.4645667),
        ("destination", 1.6443706),
    ],
    &[("get", 0.34648934), ("destination_names", 5.240153)],
    &[("get", 0.34648934), ("node_names", 2.267169)],
    &[("urls", 3.27341), ("get", 0.21644437), ("node", 1.2436665)],
    &[
        ("get", 0.21644437),
        ("node", 1.2436665),
        ("ontologies", 3.27341),
    ],
    &[("node_ids", 1.7313172), ("get", 0.34648934)],
    &[("get", 0.34648934), ("edge_type_ids", 3.927172)],
    &[
        ("get", 0.21644437),
        ("unique", 2.1849718),
        ("edge_type_ids", 2.4532192),
    ],
    &[("edge_type_names", 4.0767546), ("get", 0.34648934)],
    &[
        ("edge_type_names", 2.5466604),
        ("unique", 2.1849718),
        ("get", 0.21644437),
    ],
    &[
    ...
    &[("node_type_ids", 3.341636), ("get", 0.34648934)],
    &[
        ("node_types", 0.977433),
        ("get", 0.1450807),
        ("known", 1.2951062),
    ...
    &[
        ("known", 0.68385875),
        ("edge_types", 0.54365736),
        ("hot", 0.94108135),
        ("one", 0.94108135),
        ("encoded", 0.94108135),
        ("get", 0.07660739),
    ],
    &[("get", 0.34648934), ("node_type_names", 3.4162972)],
    &[
        ("unique", 2.1849718),
        ("get", 0.21644437),
        ("node_type_ids", 2.0874476),
    ...
    &[("to", 3.4162972), ("directed", 3.497755)],
    &[
        ("to", 2.1340868),
        ("upper", 3.27341),
        ("triangular", 2.9876814),
    ],
    &[
        ("triangular", 2.9876814),
        ("lower", 3.27341),
    ...
    &[("to", 3.4162972), ("bidiagonal", 5.240153)],
    &[("to", 3.4162972), ("arrowhead", 5.240153)],
    &[("to", 3.4162972), ("transposed", 5.240153)],
    &[("complementary", 5.240153), ("to", 3.4162972)],
    &[("report", 6.9595222)],
    &[
        ("textual", 2.9876814),
        ("report", 2.5466604),
    ...
    &[("report", 4.0767546), ("textual", 4.782752)],
    &[
        ("random", 1.3991972),
        ("generate", 1.4304591),
        ("connected", 1.4645667),
    ...
    &[("replace", 8.945586)],
    &[("filter", 4.782752), ("from_ids", 5.240153)],
    &[("filter", 4.782752), ("from_names", 5.240153)],
    &[
        ("drop", 2.373176),
        ("unknown", 1.8681602),
        ("node_types", 1.458222),
    ...
    &[
        ("nodes", 1.5035993),
        ("drop", 2.373176),
        ("disconnected", 2.6589048),
    ],
    &[("drop", 3.7990372), ("selfloops", 3.341636)],
    &[
        ("parallel", 2.5466604),
        ("drop", 2.373176),
        ("edges", 1.8992431),
    ...
    &[("enable", 8.945586)],
    &[("all", 3.6869643), ("disable", 5.240153)],
    &[("is", 3.2087386), ("compatible", 5.240153)],
    &[
        ("same", 2.194137),
        ("matrix", 1.6443706),
        ("has", 0.9316537),
    ...
    &[("has", 2.225024), ("nodes", 2.4069977)],
    &[("edges", 3.0403538), ("has", 2.225024)],
    &[
        ("has", 1.3899243),
        ("nodes", 1.5035993),
        ("trap", 2.4532192),
    ],
    &[("directed", 3.497755), ("is", 3.2087386)],
    &[
        ("edge", 1.284738),
        ("weights", 2.0044293),
        ("has", 1.3899243),
    ...
    &[
        ("has", 0.66175944),
        ("probabilities", 1.5585093),
        ("edge", 0.61167896),
        ("weights", 0.95433265),
        ("representing", 1.5585093),
    ],
    &[
        ("has", 0.9316537),
        ("nodes", 1.007849),
    ...
    &[("edge_types", 2.4589205), ("has", 2.225024)],
    &[("has", 2.225024), ("selfloops", 3.341636)],
    &[
        ("nodes", 1.5035993),
        ("has", 1.3899243),
        ("disconnected", 2.6589048),
    ...
    &[("connected", 3.497755), ("is", 3.2087386)],
    &[("has", 2.225024), ("node_types", 2.3343568)],
    &[
        ("multilabel", 2.9876814),
        ("node_types", 1.458222),
        ("has", 1.3899243),
    ],
    &[
    ...
    &[("multigraph", 4.4814696), ("is", 3.2087386)],
    &[
        ("node", 0.26889354),
        ("outbound", 0.5748827),
        ("decreasing", 0.64596754),
        ("nodes", 0.32509372),
        ("degree", 0.38024288),
        ("has", 0.30051598),
        ("by", 0.5131052),
    ...
    &[
        ("unchecked", 0.5369749),
        ("edge_type_name", 0.9938586),
        ("from", 0.2995512),
        ("get", 0.10305173),
        ("edge_type_id", 0.86211526),
    ],
    &[
        ("from", 0.2995512),
        ("edge_type_id", 0.86211526),
    ...
    &[
        ("and", 0.56344634),
        ("unchecked", 0.16366401),
        ("from", 0.0912999),
        ("edge_id", 0.23601976),
        ("edge_type_id", 0.2627632),
        ("edge", 0.18643299),
        ("weight", 0.3096851),
        ("get", 0.03140903),
        ("node_ids", 0.15694277),
    ...
    &[
        ...
        ("get", 0.07660739),
        ("degree", 0.62245655),
        ("comulative", 1.0574471),
    ],
    &[
        ("reciprocal", 0.7250969),
        ("from", 0.17157552),
        ("sqrt", 0.7250969),
        ("get", 0.059025485),
        ("unchecked", 0.30756593),
    ...
    &[
        ("from", 0.2995512),
        ("unchecked", 0.5369749),
        ("node_type_ids", 0.9938586),
        ("node_id", 0.5968801),
        ("get", 0.10305173),
    ],
    &[
        ("get", 0.1450807),
        ("node_type_ids", 1.3991972),
        ("node_id", 0.8403137),
        ("from", 0.4217212),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.10305173),
        ("node", 0.5921244),
        ("node_type_id", 1.0669442),
        ("count", 1.1680068),
    ],
    &[
        ("node", 0.5921244),
        ("count", 1.1680068),
        ("node_type_name", 1.040291),
        ("from", 0.2995512),
        ("get", 0.10305173),
    ],
    &[
    ...
    &[("add", 5.240153), ("selfloops", 3.341636)],
    &[
        ("get", 0.21644437),
        ("degree", 1.7586712),
        ("centrality", 1.8681602),
    ],
    &[
        ("degree", 1.1788214),
        ("weighted", 0.9584455),
        ("centrality", 1.2522109),
        ("get", 0.1450807),
    ],
    &[
        ("closeness", 0.94108135),
        ("centrality", 0.6612086),
        ("node_id", 0.4437133),
        ("unchecked", 0.39918053),
        ("get", 0.07660739),
        ("from", 0.22268268),
    ...
    &[
        ("get", 0.21644437),
        ("centrality", 1.8681602),
        ("betweenness", 2.5466604),
    ],
    &[
        ("from", 0.22268268),
        ("betweenness", 0.901354),
        ("centrality", 0.6612086),
        ("node_id", 0.4437133),
        ("get", 0.07660739),
        ("approximated", 0.901354),
    ],
    &[
        ("centrality", 0.6612086),
        ("node_name", 0.6138477),
    ...
    &[
        ("centrality", 0.5094568),
        ("weighted", 0.38993958),
        ("approximated", 0.6944873),
        ("betweenness", 0.6944873),
        ("get", 0.059025485),
        ("node_id", 0.34187815),
        ("from", 0.17157552),
    ],
    ...
    &[
        ("get", 0.21644437),
        ("centrality", 1.8681602),
        ("eigenvector", 2.9876814),
    ],
    &[
        ("centrality", 1.2522109),
        ("eigenvector", 2.0026157),
        ("get", 0.1450807),
        ("weighted", 0.9584455),
    ],
    &[("to", 3.4162972), ("dot", 5.240153)],
    &[("get", 0.34648934), ("stars", 5.240153)],
    &[
        ("community", 1.3328642),
        ("louvain", 1.5585093),
        ("detection", 1.5585093),
    ...
    &[
        ...
        ("node", 0.3391542),
        ("get", 0.059025485),
        ("modularity", 0.8147559),
        ("from", 0.17157552),
        ("memberships", 0.8147559),
    ],
    &[
        ("memberships", 0.8147559),
        ("get", 0.059025485),
        ...
        ("node", 0.3391542),
        ("from", 0.17157552),
        ("undirected", 0.6944873),
    ],
    &[
        ("minimum", 1.1298974),
        ("attachment", 1.040291),
        ("preferential", 1.040291),
        ("unchecked", 0.5369749),
        ("get", 0.10305173),
    ],
    &[
    ...
    &[
        ("attachment", 0.7733395),
        ("unchecked", 0.39918053),
        ("minimum", 0.8399518),
        ("weighted", 0.50609076),
        ("preferential", 0.7733395),
        ("get", 0.07660739),
    ],
    &[
        ("weighted", 0.50609076),
    ...
    &[
        ("unchecked", 0.30756593),
        ("preferential", 0.5958529),
        ("get", 0.059025485),
        ("from", 0.17157552),
        ("weighted", 0.38993958),
        ("node_ids", 0.29493502),
        ("attachment", 0.5958529),
    ],
    &[
        ("attachment", 0.7733395),
        ("weighted", 0.50609076),
    ...
    &[
        ("nodes", 1.5035993),
        ("has", 1.3899243),
        ("isomorphic", 2.7994769),
    ],
    &[("csv", 5.240153), ("from", 1.0071766)],
];
