        ...
        Ok({
            ...
            (
                subresult_0
                    ...
                    .map(|x| {
                        let gil = pyo3::Python::acquire_gil();
                        to_ndarray_2d!(gil, x, NodeT)
                    })
                    .collect::<Vec<_>>(),
                {
                    let gil = pyo3::Python::acquire_gil();
                    to_ndarray_2d!(gil, subresult_1, NodeT)
                },
                {
                    let gil = pyo3::Python::acquire_gil();
                    to_ndarray_2d!(gil, subresult_2, NodeT)
                },
            )
        })
    }
...
pub const GRAPH_METHODS_NAMES: &[&str] = &[
    ...
    "get_exact_edge_sketching_from_graph",
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    &[
        ("connected", 0.98791695),
        ("from", 0.24835646),
        ("id", 0.41330606),
        ("is", 0.8750933),
        ("node", 0.14596666),
        ("unchecked", 0.50634223),
    ],
    &[
        ("connected", 1.3117774),
        ("from", 0.32977304),
    ...
    &[
        ("disconnected", 0.9418627),
        ("from", 0.1932279),
        ("id", 0.32156307),
        ("is", 0.68084574),
        ("node", 0.21151094),
        ("unchecked", 0.39394766),
    ],
    &[
        ("from", 0.24835646),
        ("id", 0.41330606),
    ...
    &[
        ...
        ("node", 0.09071757),
        ("selfloops", 0.5361019),
        ("singleton", 0.45629153),
        ("unchecked", 0.31468925),
        ("with", 0.4750454),
    ],
    &[
        ("from", 0.1932279),
    ...
    &[
        ...
        ("node", 0.061544865),
        ("type", 0.16610742),
        ("unchecked", 0.21349235),
    ],
    &[
        ("components", 3.2317564),
        ("connected", 2.6373382),
        ("strongly", 3.9277558),
    ],
    &[
    ...
    &[
        ("coo", 1.0332566),
        ("get", 0.08501042),
        ("intersection", 1.2702191),
        ("matrix", 0.9681295),
        ("neighbours", 1.2702191),
        ("size", 1.1629578),
    ],
    &[
        ("get", 0.11287866),
        ("graph", 0.9748647),
        ("intersection", 1.6866242),
        ("neighbours", 1.6866242),
        ("size", 1.5442003),
    ],
    &[
        ("ancestors", 1.1233139),
    ...
    &[
        ("get", 0.22694339),
        ("histograms", 3.9277558),
        ("predictions", 3.6041346),
    ],
    &[
        ("filtered", 3.9277558),
        ("get", 0.22694339),
    ...
    &[("components", 4.982814), ("remove", 2.9117646)],
    &[("overlaps", 9.826331)],
    &[("contains", 9.0167055)],
    &[
        ("bipartite", 2.9987931),
    ...
    &[("circles", 6.055926), ("get", 0.34990776)],
    &[
        ("get", 0.22694339),
        ("memory", 2.5845137),
        ("stats", 3.9277558),
    ...
    &[("get", 0.34990776), ("transitivity", 6.055926)],
    &[
        ("get", 0.08501042),
        ("node", 0.14596666),
        ("number", 0.61437976),
    ...
    &[
        ("clustering", 1.6866242),
        ("coefficient", 1.4464681),
        ("get", 0.11287866),
        ("node", 0.19381768),
        ("per", 1.6866242),
    ],
    &[
        ("clustering", 3.3909705),
        ("coefficient", 2.908135),
        ("get", 0.22694339),
    ],
    &[
        ("average", 2.7013905),
        ("clustering", 2.3322058),
        ("coefficient", 2.0001264),
        ("get", 0.15608472),
    ],
    &[
        ("are", 3.2317564),
        ("nodes", 1.7387555),
        ("remappable", 3.9277558),
    ],
    &[
        ("from", 0.32977304),
        ("ids", 0.4772682),
    ...
    &[("connected", 4.066323), ("holdout", 4.483845)],
    &[("holdout", 4.483845), ("random", 3.501663)],
    &[
        ("get", 0.11287866),
        ("holdout", 1.4464681),
        ("indices", 1.9536142),
    ...
    &[("chains", 6.055926), ("get", 0.34990776)],
    &[
        ("breadth", 0.43565863),
        ("first", 0.43565863),
        ("from", 0.10471614),
        ...
        ("node", 0.061544865),
        ("parallel", 0.4903454),
        ("predecessors", 0.62035066),
        ("search", 0.43565863),
        ("unchecked", 0.21349235),
    ],
    &[
        ("breadth", 0.43565863),
        ("distances", 0.45931152),
        ("first", 0.43565863),
        ("from", 0.10471614),
        ("get", 0.03584349),
        ("ids", 0.15155174),
    ...
    &[
        ("and", 0.32100567),
        ("distant", 0.48033497),
        ("eccentricity", 0.3996591),
        ("from", 0.088361695),
        ("get", 0.030245498),
        ("id", 0.28448883),
        ("most", 0.4307069),
        ("node", 0.10047248),
        ("unchecked", 0.18014938),
    ],
    &[
        ("eccentricity", 0.8739679),
        ("from", 0.1932279),
        ("get", 0.06614035),
        ("id", 0.32156307),
        ("node", 0.11356593),
    ...
    &[("diameter", 5.2282944), ("get", 0.34990776)],
    &[
        ("breadth", 0.80390096),
        ("first", 0.80390096),
        ("from", 0.1932279),
    ...
    &[("density", 6.055926), ("get", 0.34990776)],
    &[
        ("get", 0.15608472),
        ("nodes", 1.1958629),
        ("rate", 2.062478),
    ...
    &[
        ("destination", 1.9455903),
        ("get", 0.15608472),
        ("ids", 0.65995),
        ("node", 0.2680044),
    ],
    &[
        ("destination", 1.4070283),
        ("directed", 0.95659256),
        ("get", 0.11287866),
        ("ids", 0.4772682),
        ("node", 0.19381768),
    ...
    &[("directed", 2.9653006), ("to", 3.9097018)],
    &[
        ("to", 2.5357568),
        ("triangular", 2.3361447),
        ("upper", 2.7583766),
    ],
    &[
        ("lower", 2.7583766),
    ...
    &[("bidiagonal", 6.055926), ("to", 3.9097018)],
    &[("arrowhead", 6.055926), ("to", 3.9097018)],
    &[("to", 3.9097018), ("transposed", 6.055926)],
    &[("to", 3.9097018), ("undirected", 4.483845)],
    &[("complementary", 6.055926), ("to", 3.9097018)],
    &[
        ("graph", 0.9748647),
        ("multi", 1.9536142),
        ("similarity", 1.9536142),
        ("structural", 1.7926491),
        ("to", 1.2612522),
    ],
    &[
        ("approximated", 2.5357568),
        ("cliques", 3.6041346),
        ("get", 0.22694339),
    ],
    &[
    ...
    &[("report", 4.786801), ("textual", 5.5569572)],
    &[
        ("get", 0.15608472),
        ("isomorphic", 1.3748314),
        ("mask", 1.8138804),
    ...
    &[("remove", 2.9117646), ("tendrils", 5.5569572)],
    &[
        ("dendritic", 3.6041346),
        ("remove", 1.888514),
        ("trees", 3.6041346),
    ...
    &[
        ("disconnected", 3.2317564),
        ("nodes", 1.7387555),
        ("remove", 1.888514),
    ],
    &[("remove", 2.9117646), ("selfloops", 3.5505123)],
    &[
        ("edges", 2.1845865),
        ("parallel", 3.1046262),
        ("remove", 1.888514),
    ...
    &[
        ("arborescence", 2.4788136),
        ("kruskal", 2.4788136),
        ("random", 1.5620005),
        ("spanning", 2.2227032),
    ],
    &[
        ("arborescence", 3.6041346),
        ("kruskal", 3.6041346),
        ("spanning", 3.2317564),
    ],
    &[
    ...
    &[("enable", 9.826331)],
    &[("all", 3.8399014), ("disable", 6.055926)],
    &[
        ("approximated", 1.744016),
        ("distances", 2.0001264),
        ("get", 0.15608472),
        ("total", 1.744016),
    ],
    ...
    &[
        ("compatible", 2.2227032),
        ("has", 1.0904564),
        ("node", 0.2680044),
        ("vocabularies", 2.3322058),
    ],
    &[
        ("compatible", 1.6074332),
        ("has", 0.78860533),
        ("node", 0.19381768),
        ("types", 0.65143335),
        ("vocabularies", 1.6866242),
    ],
    &[
        ("compatible", 1.6074332),
        ("edge", 0.39125678),
    ...
    &[("compatible", 4.982814), ("is", 3.6019342)],
    &[
        ("adjacency", 2.7013905),
        ("has", 1.0904564),
        ("matrix", 1.7775495),
    ...
    &[("has", 2.4445643), ("nodes", 2.6808627)],
    &[("edges", 3.3682575), ("has", 2.4445643)],
    &[
        ("has", 1.5854969),
        ("nodes", 1.7387555),
        ("trap", 2.6373382),
    ...
    &[("directed", 2.9653006), ("is", 3.6019342)],
    &[
        ("acyclic", 3.6041346),
        ("directed", 1.9232364),
        ("is", 2.3361447),
    ...
    &[
        ("edge", 0.39125678),
        ("has", 0.78860533),
        ("probabilities", 1.9536142),
        ("representing", 1.9536142),
        ("weights", 1.1794782),
    ],
    &[
        ("has", 1.0904564),
    ...
    &[("has", 2.4445643), ("selfloops", 3.5505123)],
    &[
        ("disconnected", 3.2317564),
        ("has", 1.5854969),
        ("nodes", 1.7387555),
    ...
    &[("connected", 4.066323), ("is", 3.6019342)],
    &[
        ("has", 1.5854969),
        ("node", 0.38967186),
        ("types", 1.3097117),
    ...
    &[("is", 3.6019342), ("multigraph", 4.786801)],
    &[
        ("has", 1.5854969),
        ("node", 0.38967186),
        ("ontologies", 3.1046262),
    ...
    &[("get", 0.34990776), ("tendrils", 5.5569572)],
    &[
        ("degree", 0.7989382),
        ("distribution", 1.4712929),
        ("geometric", 1.4712929),
        ("get", 0.08501042),
        ("node", 0.14596666),
        ("threshold", 1.4712929),
    ...
    &[("add", 4.483845), ("selfloops", 3.5505123)],
    &[
        ("centrality", 2.2711108),
        ("degree", 2.1328413),
        ("get", 0.22694339),
    ],
    &[
    ...
    &[
        ("betweenness", 3.1046262),
        ("centrality", 2.2711108),
        ("get", 0.22694339),
    ],
    &[
        ("approximated", 0.7390207),
        ("betweenness", 0.9048119),
        ("centrality", 0.66189224),
        ("from", 0.1932279),
        ("get", 0.06614035),
        ("id", 0.32156307),
    ...
    &[
        ("approximated", 0.5903369),
        ("betweenness", 0.7227726),
        ("centrality", 0.528726),
        ("from", 0.15435234),
        ("get", 0.05283356),
        ("id", 0.2568677),
    ...
    &[
        ("centrality", 2.2711108),
        ("eigenvector", 3.6041346),
        ("get", 0.22694339),
    ],
    &[
        ("centrality", 1.5620005),
        ("eigenvector", 2.4788136),
        ("get", 0.15608472),
        ("weighted", 1.2873952),
    ],
    &[("dot", 6.055926), ("to", 3.9097018)],
    &[
        ("16", 0.988264),
        ("base", 0.7686255),
        ("from", 0.1932279),
    ...
    &[
        ...
        ("from", 0.1932279),
        ("get", 0.06614035),
        ("memberships", 1.0503886),
        ("modularity", 1.0503886),
        ("node", 0.11356593),
    ],
    &[
        ("community", 0.988264),
    ...
    &[
        ...
        ("ids", 0.27965152),
        ("node", 0.11356593),
        ("structural", 1.0503886),
        ("unchecked", 0.39394766),
    ],
    &[
        ("attachment", 1.3117774),
        ("get", 0.11287866),
        ("minimum", 1.4464681),
        ("preferential", 1.3117774),
        ("unchecked", 0.6723321),
    ],
    &[
        ("attachment", 1.3117774),
    ...
    &[
        ("attachment", 0.98791695),
        ("get", 0.08501042),
        ("minimum", 1.0893544),
        ("preferential", 0.98791695),
        ("unchecked", 0.50634223),
        ("weighted", 0.70117056),
    ],
    &[
    ...
    &[
        ("attachment", 0.7686255),
        ("from", 0.1932279),
        ("get", 0.06614035),
        ("ids", 0.27965152),
        ("node", 0.11356593),
        ("preferential", 0.7686255),
        ("unchecked", 0.39394766),
    ],
    &[
        ("attachment", 0.98791695),
    ...
    &[
        ("attachment", 0.61398554),
        ("from", 0.15435234),
        ("get", 0.05283356),
        ("ids", 0.22338836),
        ("node", 0.09071757),
        ("preferential", 0.61398554),
        ("unchecked", 0.31468925),
        ("weighted", 0.43577406),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.05283356),
        ("ids", 0.22338836),
        ("intersection", 0.78943497),
        ("neighbours", 0.78943497),
        ("node", 0.09071757),
        ("size", 0.7227726),
        ("unchecked", 0.31468925),
    ],
    &[
        ("coefficient", 0.8475465),
        ("from", 0.1932279),
        ("get", 0.06614035),
        ("ids", 0.27965152),
        ("jaccard", 0.785422),
    ...
    &[
        ("attachment", 1.8138804),
        ("get", 0.15608472),
        ("preferential", 1.8138804),
        ("scores", 2.2227032),
    ],
    &[
        ("allocation", 1.4464681),
        ("get", 0.11287866),
        ("index", 1.3404431),
        ("resource", 1.4464681),
        ("scores", 1.6074332),
