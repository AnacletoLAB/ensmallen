...
impl Graph {
    ...
    #[automatically_generated_binding]
    #[text_signature = "($self, node_centralities, number_of_nodes_to_sample_per_feature, reduce_method, maximum_number_of_features, validate_node_centralities, maximal_depth, central_node_name, central_node_id, use_edge_weights, use_edge_weights_as_probabilities, random_state)"]
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[("edge", 1.9836709258073177), ("encode", 5.207901635891034)],
    ...
    &[("get", 0.34467250540080974), ("density", 5.207901635891034)],
    &[
        ("get", 0.1445395004049744),
    ...
    &[("has", 2.2068588775281244), ("nodes", 2.4204102301076023)],
    &[("edges", 3.003151879330042), ("has", 2.2068588775281244)],
    &[
        ("has", 1.3798362793371484),
        ("nodes", 1.5133590463754891),
