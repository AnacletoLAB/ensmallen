...
impl Graph {
    ...
    pub fn get_random_scale_free_node(&self, random_state: u64) -> NodeT {
        self.inner
            .get_random_scale_free_node(random_state.into())
            .into()
    }
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    &[
        ("connected", 0.95432866),
        ("from", 0.2489721),
        ("id", 0.3985066),
        ("is", 0.88419956),
        ("node", 0.14232004),
        ("unchecked", 0.49424818),
    ],
    &[
        ("connected", 1.2681638),
        ("from", 0.33084768),
    ...
    &[
        ("disconnected", 0.91346425),
        ("from", 0.19359298),
        ("id", 0.30986637),
        ("is", 0.6875261),
        ("node", 0.20625538),
        ("unchecked", 0.38431203),
    ],
    &[
        ("from", 0.2489721),
        ("id", 0.3985066),
    ...
    &[
        ...
        ("is", 0.6875261),
        ("node", 0.110663645),
        ("selfloops", 0.72682375),
        ("singleton", 0.55797535),
        ("with", 0.6114997),
    ],
    &[
        ("from", 0.2489721),
    ...
    &[("has", 1.521828), ("name", 1.490873), ("node", 0.38120186)],
    &[
        ("has", 1.045112),
        ("id", 0.73302996),
        ("node", 0.2617895),
    ...
    &[
        ("coo", 0.93473864),
        ("get", 0.09203056),
        ("intersection", 1.2338144),
        ("matrix", 0.88419956),
        ("neighbours", 1.2338144),
        ("size", 1.1276231),
    ],
    &[
        ("get", 0.12229522),
        ("graph", 0.91624933),
        ("intersection", 1.6395596),
        ("neighbours", 1.6395596),
        ("size", 1.498447),
    ],
    &[
        ("ancestors", 1.1747694),
    ...
    &[
        ("coo", 1.7193978),
        ("cooccurrence", 2.0020025),
        ("get", 0.16928491),
        ("matrix", 1.6264341),
    ],
    &[
        ("cooccurrence", 2.9151936),
        ("get", 0.24650234),
        ("graph", 1.8468227),
    ],
    &[
        ("coo", 1.2421316),
        ("cooccurrence", 1.4462916),
        ("get", 0.12229522),
        ("matrix", 1.1749724),
        ("normalized", 1.2965659),
    ],
    &[
        ("cooccurrence", 2.0020025),
        ("get", 0.16928491),
        ("graph", 1.2683014),
        ("normalized", 1.7947475),
    ],
    &[
        ("coo", 0.93473864),
        ("cooccurrence", 1.0883747),
        ("get", 0.09203056),
        ("log", 1.3128664),
        ("matrix", 0.88419956),
        ("normalized", 0.9757019),
    ],
    &[
        ("cooccurrence", 1.4462916),
        ("get", 0.12229522),
    ...
    &[("components", 4.861741), ("remove", 2.8001935)],
    &[("overlaps", 9.648199)],
    &[("contains", 8.840084)],
    &[
        ("bipartite", 2.9151936),
    ...
    &[("edge", 1.240525), ("encode", 5.92993)],
    &[("decode", 5.92993), ("edge", 1.240525)],
    &[
        ("edge", 0.39833066),
        ("encodable", 1.9040914),
        ("get", 0.12229522),
    ...
    &[
        ...
        ("must", 1.6861379),
        ("node", 0.2617895),
        ("ontologies", 2.0741975),
    ],
    &[
        ("be", 3.1466005),
        ("must", 2.4552507),
        ("undirected", 3.0203197),
    ],
    &[
        ("have", 1.5610976),
        ("must", 1.2181039),
    ...
    &[
        ("be", 3.1466005),
        ("multigraph", 3.0203197),
        ("must", 2.4552507),
    ],
    &[
        ("be", 2.1609206),
        ("multigraph", 2.0741975),
        ("must", 1.6861379),
        ("not", 2.0020025),
    ],
    &[
    ...
    &[("get", 0.3808652), ("transitivity", 5.92993)],
    &[
        ("get", 0.09203056),
        ("node", 0.14232004),
        ("number", 0.60669935),
    ...
    &[
        ("clustering", 1.6395596),
        ("coefficient", 1.4016145),
        ("get", 0.12229522),
        ("node", 0.18912262),
        ("per", 1.7446083),
    ],
    &[
        ("clustering", 3.3047512),
        ("coefficient", 2.8251412),
        ("get", 0.24650234),
    ],
    &[
        ("average", 2.6357036),
        ("clustering", 2.2695303),
        ("coefficient", 1.9401592),
        ("get", 0.16928491),
    ],
    &[
        ("are", 3.83795),
    ...
    &[("connected", 3.9494548), ("holdout", 4.243365)],
    &[("holdout", 4.243365), ("random", 3.5412278)],
    &[
        ("get", 0.12229522),
        ("holdout", 1.3625379),
        ("indices", 1.9040914),
    ...
    &[
        ("and", 0.3087563),
        ("distant", 0.46618834),
        ("eccentricity", 0.38647315),
        ("from", 0.088408),
        ("get", 0.032679316),
        ("id", 0.27387366),
        ("most", 0.4171512),
        ("node", 0.09780944),
        ("unchecked", 0.17550357),
    ],
    &[
        ("eccentricity", 0.84628636),
        ("from", 0.19359298),
        ("get", 0.07156011),
        ("id", 0.30986637),
        ("node", 0.110663645),
    ...
    &[("diameter", 5.4332504), ("get", 0.3808652)],
    &[
        ("breadth", 0.7769593),
        ("first", 0.7769593),
        ("from", 0.19359298),
    ...
    &[
        ("destination", 1.886068),
        ("get", 0.16928491),
        ("ids", 0.68944144),
        ("node", 0.2617895),
    ],
    &[
        ("destination", 1.3625379),
        ("directed", 1.032034),
        ("get", 0.12229522),
        ("ids", 0.49806798),
        ("node", 0.18912262),
    ...
    &[("get", 0.24650234), ("node", 0.38120186), ("urls", 3.83795)],
    &[
        ("get", 0.24650234),
        ("node", 0.38120186),
        ("ontologies", 3.0203197),
    ],
    &[
        ("from", 0.2489721),
        ("get", 0.09203056),
    ...
    &[("directed", 3.2140737), ("to", 3.8683822)],
    &[
        ("to", 2.503682),
        ("triangular", 3.5164907),
        ("upper", 3.83795),
    ],
    &[
        ("lower", 3.83795),
    ...
    &[("diagonal", 3.5164907), ("main", 3.83795), ("to", 2.503682)],
    &[("anti", 3.83795), ("diagonal", 3.5164907), ("to", 2.503682)],
    &[("bidiagonal", 5.92993), ("to", 3.8683822)],
    &[("arrowhead", 5.92993), ("to", 3.8683822)],
    &[("to", 3.8683822), ("transposed", 5.92993)],
    &[("complementary", 5.92993), ("to", 3.8683822)],
    &[
        ("graph", 0.91624933),
        ("multi", 1.9040914),
        ("similarity", 1.9040914),
        ("structural", 1.7446083),
        ("to", 1.2421316),
    ],
    &[
        ("approximated", 2.6134014),
        ("cliques", 3.5164907),
        ("get", 0.24650234),
    ],
    &[
    ...
    &[("report", 4.666628), ("textual", 5.4332504)],
    &[
        ("connected", 1.7554325),
        ("generate", 1.7554325),
        ("graph", 1.2683014),
    ...
    &[("remove", 2.8001935), ("tendrils", 5.4332504)],
    &[
        ("dendritic", 3.5164907),
        ("remove", 1.8123323),
        ("trees", 3.5164907),
    ...
    &[
        ("disconnected", 3.1466005),
        ("nodes", 1.7046297),
        ("remove", 1.8123323),
    ],
    &[("remove", 2.8001935), ("selfloops", 3.8683822)],
    &[
        ("edges", 2.1064265),
        ("parallel", 3.0203197),
        ("remove", 1.8123323),
    ...
    &[
        ("arborescence", 2.414942),
        ("kruskal", 2.414942),
        ("random", 1.5739859),
        ("spanning", 2.2695303),
    ],
    &[
        ("arborescence", 3.5164907),
        ("kruskal", 3.5164907),
        ("spanning", 3.3047512),
    ],
    &[
    ...
    &[("enable", 9.648199)],
    &[("all", 3.9494548), ("disable", 5.92993)],
    &[
        ("compatible", 2.1609206),
        ("has", 1.045112),
        ("node", 0.2617895),
        ("vocabularies", 2.2695303),
    ],
    &[
        ("compatible", 1.5610976),
        ("has", 0.75501233),
        ("node", 0.18912262),
        ("types", 0.6381947),
        ("vocabularies", 1.6395596),
    ],
    &[
        ("compatible", 1.5610976),
        ("edge", 0.39833066),
    ...
    &[("compatible", 4.861741), ("is", 3.659228)],
    &[
        ("adjacency", 2.6357036),
        ("has", 1.045112),
        ("matrix", 1.6264341),
    ...
    &[("has", 2.3513422), ("nodes", 2.6337848)],
    &[("edges", 3.2545922), ("has", 2.3513422)],
    &[("has", 1.521828), ("nodes", 1.7046297), ("trap", 2.9151936)],
    &[("directed", 3.2140737), ("is", 3.659228)],
    &[("edge", 0.8028886), ("has", 1.521828), ("weights", 2.32897)],
    &[
        ("edge", 0.39833066),
        ("has", 0.75501233),
        ("probabilities", 1.9040914),
        ("representing", 1.9040914),
        ("weights", 1.1554532),
    ],
    &[
        ("has", 1.045112),
    ...
    &[("edge", 0.8028886), ("has", 1.521828), ("types", 1.2863665)],
    &[("has", 2.3513422), ("selfloops", 3.8683822)],
    &[
        ("disconnected", 3.1466005),
        ("has", 1.521828),
        ("nodes", 1.7046297),
    ...
    &[("connected", 3.9494548), ("is", 3.659228)],
    &[
        ("has", 1.521828),
        ("node", 0.38120186),
        ("types", 1.2863665),
    ...
    &[("is", 3.659228), ("multigraph", 4.666628)],
    &[
        ("has", 1.521828),
        ("node", 0.38120186),
        ("ontologies", 3.0203197),
    ...
    &[
        ...
        ("get", 0.057136767),
        ("ids", 0.23269914),
        ("multigraph", 0.7000798),
        ("node", 0.08835877),
        ("number", 0.37666664),
        ("of", 0.38870347),
    ],
    &[("get", 0.3808652), ("tendrils", 5.4332504)],
    &[
        ("degree", 0.7966417),
        ("distribution", 1.4328818),
        ("geometric", 1.4328818),
        ("get", 0.09203056),
        ("node", 0.14232004),
        ("threshold", 1.4328818),
    ...
    &[("add", 4.3650618), ("selfloops", 3.8683822)],
    &[
        ("centrality", 2.2569723),
        ("degree", 2.1337914),
        ("get", 0.24650234),
    ],
    &[
        ("centrality", 1.5499705),
        ("degree", 1.4653765),
        ("get", 0.16928491),
        ("weighted", 1.2332416),
    ],
    &[
        ("centrality", 0.65520346),
        ("closeness", 0.91346425),
        ("from", 0.19359298),
        ("get", 0.07156011),
        ("id", 0.30986637),
        ("node", 0.110663645),
    ...
    &[
        ("centrality", 0.52314353),
        ("closeness", 0.72935045),
        ("from", 0.15457323),
        ("get", 0.057136767),
        ("id", 0.24741107),
        ("node", 0.08835877),
    ...
    &[
        ("betweenness", 3.0203197),
        ("centrality", 2.2569723),
        ("get", 0.24650234),
    ],
    &[
        ("approximated", 0.7586756),
        ("betweenness", 0.8768047),
        ("centrality", 0.65520346),
        ("from", 0.19359298),
        ("get", 0.07156011),
        ("id", 0.30986637),
    ...
    &[
        ("approximated", 0.6057603),
        ("betweenness", 0.7000798),
        ("centrality", 0.52314353),
        ("from", 0.15457323),
        ("get", 0.057136767),
        ("id", 0.24741107),
    ...
    &[
        ("centrality", 2.2569723),
        ("eigenvector", 3.5164907),
        ("get", 0.24650234),
    ],
    &[
        ("centrality", 1.5499705),
        ("eigenvector", 2.414942),
        ("get", 0.16928491),
        ("weighted", 1.2332416),
    ],
    &[("dot", 5.92993), ("to", 3.8683822)],
    &[("get", 0.3808652), ("stars", 5.92993)],
    &[
        ("community", 1.6395596),
        ("detection", 1.9040914),
        ("get", 0.12229522),
    ...
    &[
        ("community", 0.95937574),
        ("directed", 0.6038868),
        ("from", 0.19359298),
        ("get", 0.07156011),
        ("memberships", 1.0208441),
        ("modularity", 1.0208441),
        ("node", 0.110663645),
    ],
    &[
        ("community", 0.95937574),
    ...
    &[
        ...
        ("ids", 0.29144064),
        ("node", 0.110663645),
        ("structural", 1.0208441),
        ("unchecked", 0.38431203),
    ],
    &[
        ("attachment", 1.2681638),
        ("get", 0.12229522),
        ("minimum", 1.4016145),
        ("preferential", 1.2681638),
        ("unchecked", 0.6567839),
    ],
    &[
        ("attachment", 1.2681638),
    ...
    &[
        ("attachment", 0.95432866),
        ("get", 0.09203056),
        ("minimum", 1.054754),
        ("preferential", 0.95432866),
        ("unchecked", 0.49424818),
        ("weighted", 0.6704432),
    ],
    &[
    ...
    &[
        ("attachment", 0.7420563),
        ("from", 0.19359298),
        ("get", 0.07156011),
        ("ids", 0.29144064),
        ("node", 0.110663645),
        ("preferential", 0.7420563),
        ("unchecked", 0.38431203),
    ],
    &[
        ("attachment", 0.95432866),
    ...
    &[
        ("attachment", 0.59249073),
        ("from", 0.15457323),
        ("get", 0.057136767),
        ("ids", 0.23269914),
        ("node", 0.08835877),
        ("preferential", 0.59249073),
        ("unchecked", 0.3068518),
        ("weighted", 0.41624168),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.057136767),
        ("ids", 0.23269914),
        ("intersection", 0.76600814),
        ("neighbours", 0.76600814),
        ("node", 0.08835877),
        ("size", 0.7000798),
        ("unchecked", 0.3068518),
    ],
    &[
        ("coefficient", 0.820144),
        ("from", 0.19359298),
        ("get", 0.07156011),
        ("ids", 0.29144064),
        ("jaccard", 0.7972786),
    ...
    &[
        ("attachment", 1.7554325),
        ("get", 0.16928491),
        ("preferential", 1.7554325),
        ("scores", 2.1609206),
    ],
    &[
        ("allocation", 1.4016145),
        ("get", 0.12229522),
        ("index", 1.2965659),
        ("resource", 1.4016145),
        ("scores", 1.5610976),
