...
fn url_utilities(_py: Python, m: &PyModule) -> PyResult<()> {
    m.add_wrapped(wrap_pyfunction!(is_valid_jackson_lab_reference_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_uberon_core_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_gene_ontology_relations_node_name))?;
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_kegg_homo_sapiens_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_dublin_core_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_human_phenotype_ontology_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_ncbi_gene_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_drugcentral_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_mmrrc_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_xsd_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_kegg_ko_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_swiss_protein_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_ncbi_books_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_monarch_initiative_data_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_protein_ontology_pro_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_human_disease_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_dublin_core_terms_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_zebrafish_anatomy_and_development_ontology_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_chembl_compound_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_rat_genome_database_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_pathway_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_protein_modification_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_wikidata_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_sequence_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_feature_annotation_location_description_ontology_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_rbrc_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_dictybase_gene_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_omim_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_monarch_initiative_archive_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_edam_data_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_cord_pubmed_central_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_ncimr_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_ecogene_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_environment_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_gene_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(get_node_source_url_from_node_name))?;
    m.add_wrapped(wrap_pyfunction!(get_node_repository_from_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(get_node_source_html_url_from_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_basic_formal_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_ensembl_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_dictybase_genes_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_cell_line_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_animal_genome_horse_qtl_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_wormbase_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_animal_qtl_traits_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_neuro_behavior_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_fungal_gross_anatomy_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_friend_of_a_friend_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_omim_phenotypic_series_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_gene_ontology_obo_in_owl_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_arabidopsis_tair_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_unified_medical_language_system_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_zfin_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_zebrafish_phenotype_ontology_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_gene_ontology_reference_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_dublin_core_types_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_confidence_information_ontology_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_gdc_project_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_ncbi_gene_expression_omnibus_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_complex_portal_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_ucsc_golden_path_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_yeast_genome_reference_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_xenbase_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_chembl_target_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_mouse_genome_informatics_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_jax_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_coriell_collection_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_gdc_annotation_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_genotype_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_coriell_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_plant_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_animal_genome_pig_qtl_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_ncbi_mesh_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_livestock_product_trait_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_ontology_for_biomedical_investigations_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_c_elegans_phenotype_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_biological_spatial_ontology_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_pubmed_ncbi_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_chebi_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_variation_representation_specification_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_semantic_science_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_animal_genome_sheep_qtl_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_intact_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_flybase_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_game_ontology_project_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_apergillus_genome_data_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_ncbi_dbgap_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_animal_genome_pubblications_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_reactome_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_monarch_initiative_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_snp_individual_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_ncbi_protein_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_drosophila_development_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_orpha_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_mental_disease_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_human_developmental_anatomy_abstract_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_wormbase_vocabulary_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_kegg_path_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_yeast_genome_locus_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_schema_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_provenance_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_evidence_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_ncbi_taxonomy_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_mammalian_phenotype_ontology_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_uniprotkb_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_foodon_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_vertebrate_trait_ontology_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_exposure_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_population_and_community_ontology_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_kegg_disease_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_clinical_measurement_ontology_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_database_snp_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_mondo_disease_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_unified_medical_language_system_semantic_group_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_cell_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_mugen_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_common_anatomy_reference_ontology_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_world_geodetic_system_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_biolink_from_object))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_chromosome_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_pharmgkb_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_rdfs_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_the_arabidopsis_information_resource_locus_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_owl_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_gazetteer_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_relation_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_void_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_rdf_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_ontology_for_parasite_lifecycle_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_ncbi_clinvar_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_rgd_reference_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
        is_valid_mouse_phenome_database_assay_node_name
    ))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_drugbank_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_coriell_family_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_pombase_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
    ...
    m.add_wrapped(wrap_pyfunction!(is_valid_emotion_ontology_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_interpro_node_name))?;
    m.add_wrapped(wrap_pyfunction!(is_valid_panther_database_node_name))?;
    m.add_wrapped(wrap_pyfunction!(
...
pub fn is_valid_jackson_lab_reference_node_name(node_name: &str) -> bool {
    graph::is_valid_jackson_lab_reference_node_name(node_name)
}
...
pub fn is_valid_uberon_core_node_name(node_name: &str) -> bool {
    graph::is_valid_uberon_core_node_name(node_name)
}
...
pub fn is_valid_gene_ontology_relations_node_name(node_name: &str) -> bool {
    graph::is_valid_gene_ontology_relations_node_name(node_name)
}
...
pub fn is_valid_human_developmental_stages_node_name(node_name: &str) -> bool {
    graph::is_valid_human_developmental_stages_node_name(node_name)
}
...
pub fn is_valid_mouse_pathology_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_mouse_pathology_ontology_node_name(node_name)
}
...
pub fn is_valid_unified_phenotype_ontology_upheno_node_name(node_name: &str) -> bool {
    graph::is_valid_unified_phenotype_ontology_upheno_node_name(node_name)
}
...
pub fn is_valid_quantity_unit_dimension_and_type_node_name(node_name: &str) -> bool {
    graph::is_valid_quantity_unit_dimension_and_type_node_name(node_name)
}
...
pub fn is_valid_open_biomedical_association_node_name(node_name: &str) -> bool {
    graph::is_valid_open_biomedical_association_node_name(node_name)
}
...
pub fn is_valid_kegg_homo_sapiens_node_name(node_name: &str) -> bool {
    graph::is_valid_kegg_homo_sapiens_node_name(node_name)
}
...
pub fn is_valid_dublin_core_node_name(node_name: &str) -> bool {
    graph::is_valid_dublin_core_node_name(node_name)
}
...
pub fn is_valid_human_phenotype_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_human_phenotype_ontology_node_name(node_name)
}
...
pub fn is_valid_xsd_node_name(node_name: &str) -> bool {
    graph::is_valid_xsd_node_name(node_name)
}
...
pub fn is_valid_kegg_ko_node_name(node_name: &str) -> bool {
    graph::is_valid_kegg_ko_node_name(node_name)
}
...
pub fn is_valid_swiss_protein_node_name(node_name: &str) -> bool {
    graph::is_valid_swiss_protein_node_name(node_name)
}
...
pub fn is_valid_ncbi_books_node_name(node_name: &str) -> bool {
    graph::is_valid_ncbi_books_node_name(node_name)
}
...
pub fn is_valid_monarch_initiative_data_node_name(node_name: &str) -> bool {
    graph::is_valid_monarch_initiative_data_node_name(node_name)
}
...
pub fn is_valid_protein_ontology_pro_node_name(node_name: &str) -> bool {
    graph::is_valid_protein_ontology_pro_node_name(node_name)
}
...
pub fn is_valid_human_disease_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_human_disease_ontology_node_name(node_name)
}
...
pub fn is_valid_dublin_core_terms_node_name(node_name: &str) -> bool {
    graph::is_valid_dublin_core_terms_node_name(node_name)
}
...
pub fn is_valid_zebrafish_anatomy_and_development_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_zebrafish_anatomy_and_development_ontology_node_name(node_name)
}
...
pub fn is_valid_chembl_compound_node_name(node_name: &str) -> bool {
    graph::is_valid_chembl_compound_node_name(node_name)
}
...
pub fn is_valid_hugo_gene_name_consortium_node_name(node_name: &str) -> bool {
    graph::is_valid_hugo_gene_name_consortium_node_name(node_name)
}
...
pub fn is_valid_an_ontology_of_core_ecological_entities_node_name(node_name: &str) -> bool {
    graph::is_valid_an_ontology_of_core_ecological_entities_node_name(node_name)
}
...
pub fn is_valid_pathway_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_pathway_ontology_node_name(node_name)
}
...
pub fn is_valid_protein_modification_node_name(node_name: &str) -> bool {
    graph::is_valid_protein_modification_node_name(node_name)
}
...
pub fn is_valid_provenance_authoring_and_versioning_node_name(node_name: &str) -> bool {
    graph::is_valid_provenance_authoring_and_versioning_node_name(node_name)
}
...
pub fn is_valid_ascomycete_phenotype_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_ascomycete_phenotype_ontology_node_name(node_name)
}
...
pub fn is_valid_feature_annotation_location_description_ontology_node_name(
    ...
    graph::is_valid_feature_annotation_location_description_ontology_node_name(node_name)
}
...
pub fn is_valid_rbrc_node_name(node_name: &str) -> bool {
    graph::is_valid_rbrc_node_name(node_name)
}
...
pub fn is_valid_dictybase_gene_node_name(node_name: &str) -> bool {
    graph::is_valid_dictybase_gene_node_name(node_name)
}
...
pub fn is_valid_monarch_initiative_archive_node_name(node_name: &str) -> bool {
    graph::is_valid_monarch_initiative_archive_node_name(node_name)
}
...
pub fn is_valid_edam_data_node_name(node_name: &str) -> bool {
    graph::is_valid_edam_data_node_name(node_name)
}
...
pub fn is_valid_cord_pubmed_central_node_name(node_name: &str) -> bool {
    graph::is_valid_cord_pubmed_central_node_name(node_name)
}
...
pub fn is_valid_ncimr_node_name(node_name: &str) -> bool {
    graph::is_valid_ncimr_node_name(node_name)
}
...
pub fn is_valid_ecogene_node_name(node_name: &str) -> bool {
    graph::is_valid_ecogene_node_name(node_name)
}
...
pub fn is_valid_environment_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_environment_ontology_node_name(node_name)
}
...
pub fn is_valid_aspergillus_genomic_data_reference_node_name(node_name: &str) -> bool {
    graph::is_valid_aspergillus_genomic_data_reference_node_name(node_name)
}
...
pub fn is_valid_nci_thesaurus_obo_edition_node_name(node_name: &str) -> bool {
    graph::is_valid_nci_thesaurus_obo_edition_node_name(node_name)
}
...
pub fn is_valid_european_mouse_mutant_archive_node_name(node_name: &str) -> bool {
    graph::is_valid_european_mouse_mutant_archive_node_name(node_name)
}
...
pub fn is_valid_translation_of_embl_nucleotide_sequence_database_node_name(
    ...
    graph::is_valid_translation_of_embl_nucleotide_sequence_database_node_name(node_name)
}
...
pub fn is_valid_mouse_adult_gross_anatomy_node_name(node_name: &str) -> bool {
    graph::is_valid_mouse_adult_gross_anatomy_node_name(node_name)
}
...
pub fn is_valid_mouse_phenome_database_strain_node_name(node_name: &str) -> bool {
    graph::is_valid_mouse_phenome_database_strain_node_name(node_name)
}
...
pub fn is_valid_basic_formal_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_basic_formal_ontology_node_name(node_name)
}
...
pub fn is_valid_dictybase_genes_node_name(node_name: &str) -> bool {
    graph::is_valid_dictybase_genes_node_name(node_name)
}
...
pub fn is_valid_cell_line_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_cell_line_ontology_node_name(node_name)
}
...
pub fn is_valid_animal_genome_horse_qtl_node_name(node_name: &str) -> bool {
    graph::is_valid_animal_genome_horse_qtl_node_name(node_name)
}
...
pub fn is_valid_animal_qtl_traits_node_name(node_name: &str) -> bool {
    graph::is_valid_animal_qtl_traits_node_name(node_name)
}
...
pub fn is_valid_neuro_behavior_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_neuro_behavior_ontology_node_name(node_name)
}
...
pub fn is_valid_chemical_methods_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_chemical_methods_ontology_node_name(node_name)
}
...
pub fn is_valid_flybase_controlled_vocabulary_node_name(node_name: &str) -> bool {
    graph::is_valid_flybase_controlled_vocabulary_node_name(node_name)
}
...
pub fn is_valid_zebrafish_developmental_stages_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_zebrafish_developmental_stages_ontology_node_name(node_name)
}
...
pub fn is_valid_fungal_gross_anatomy_node_name(node_name: &str) -> bool {
    graph::is_valid_fungal_gross_anatomy_node_name(node_name)
}
...
pub fn is_valid_friend_of_a_friend_node_name(node_name: &str) -> bool {
    graph::is_valid_friend_of_a_friend_node_name(node_name)
}
...
pub fn is_valid_omim_phenotypic_series_node_name(node_name: &str) -> bool {
    graph::is_valid_omim_phenotypic_series_node_name(node_name)
}
...
pub fn is_valid_gene_ontology_obo_in_owl_node_name(node_name: &str) -> bool {
    graph::is_valid_gene_ontology_obo_in_owl_node_name(node_name)
}
...
pub fn is_valid_arabidopsis_tair_node_name(node_name: &str) -> bool {
    graph::is_valid_arabidopsis_tair_node_name(node_name)
}
...
pub fn is_valid_unified_medical_language_system_node_name(node_name: &str) -> bool {
    graph::is_valid_unified_medical_language_system_node_name(node_name)
}
...
pub fn is_valid_zebrafish_phenotype_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_zebrafish_phenotype_ontology_node_name(node_name)
}
...
pub fn is_valid_gene_ontology_reference_node_name(node_name: &str) -> bool {
    graph::is_valid_gene_ontology_reference_node_name(node_name)
}
...
pub fn is_valid_ontology_of_biological_attributes_node_name(node_name: &str) -> bool {
    graph::is_valid_ontology_of_biological_attributes_node_name(node_name)
}
...
pub fn is_valid_ncbi_clinical_variants_submitters_node_name(node_name: &str) -> bool {
    graph::is_valid_ncbi_clinical_variants_submitters_node_name(node_name)
}
...
pub fn is_valid_dublin_core_types_node_name(node_name: &str) -> bool {
    graph::is_valid_dublin_core_types_node_name(node_name)
}
...
pub fn is_valid_confidence_information_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_confidence_information_ontology_node_name(node_name)
}
...
pub fn is_valid_gdc_project_node_name(node_name: &str) -> bool {
    graph::is_valid_gdc_project_node_name(node_name)
}
...
pub fn is_valid_ncbi_gene_expression_omnibus_node_name(node_name: &str) -> bool {
    graph::is_valid_ncbi_gene_expression_omnibus_node_name(node_name)
}
...
pub fn is_valid_complex_portal_node_name(node_name: &str) -> bool {
    graph::is_valid_complex_portal_node_name(node_name)
}
...
pub fn is_valid_ucsc_golden_path_node_name(node_name: &str) -> bool {
    graph::is_valid_ucsc_golden_path_node_name(node_name)
}
...
pub fn is_valid_yeast_genome_reference_node_name(node_name: &str) -> bool {
    graph::is_valid_yeast_genome_reference_node_name(node_name)
}
...
pub fn is_valid_xenbase_node_name(node_name: &str) -> bool {
    graph::is_valid_xenbase_node_name(node_name)
}
...
pub fn is_valid_chembl_target_node_name(node_name: &str) -> bool {
    graph::is_valid_chembl_target_node_name(node_name)
}
...
pub fn is_valid_coriell_collection_node_name(node_name: &str) -> bool {
    graph::is_valid_coriell_collection_node_name(node_name)
}
...
pub fn is_valid_gdc_annotation_node_name(node_name: &str) -> bool {
    graph::is_valid_gdc_annotation_node_name(node_name)
}
...
pub fn is_valid_genotype_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_genotype_ontology_node_name(node_name)
}
...
pub fn is_valid_ontology_of_adverse_events_node_name(node_name: &str) -> bool {
    graph::is_valid_ontology_of_adverse_events_node_name(node_name)
}
...
pub fn is_valid_animal_genome_chicken_qtl_node_name(node_name: &str) -> bool {
    graph::is_valid_animal_genome_chicken_qtl_node_name(node_name)
}
...
pub fn is_valid_experimental_condition_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_experimental_condition_ontology_node_name(node_name)
}
...
pub fn is_valid_semantic_medline_database_node_name(node_name: &str) -> bool {
    graph::is_valid_semantic_medline_database_node_name(node_name)
}
...
pub fn is_valid_animal_genome_rainbow_trout_qtl_node_name(node_name: &str) -> bool {
    graph::is_valid_animal_genome_rainbow_trout_qtl_node_name(node_name)
}
...
pub fn is_valid_plant_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_plant_ontology_node_name(node_name)
}
...
pub fn is_valid_animal_genome_pig_qtl_node_name(node_name: &str) -> bool {
    graph::is_valid_animal_genome_pig_qtl_node_name(node_name)
}
...
pub fn is_valid_environmental_conditions_treatments_and_exposures_ontology_node_name(
    ...
    graph::is_valid_environmental_conditions_treatments_and_exposures_ontology_node_name(node_name)
}
...
pub fn is_valid_units_of_measurement_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_units_of_measurement_ontology_node_name(node_name)
}
...
pub fn is_valid_livestock_product_trait_node_name(node_name: &str) -> bool {
    graph::is_valid_livestock_product_trait_node_name(node_name)
}
...
pub fn is_valid_ontology_for_biomedical_investigations_node_name(node_name: &str) -> bool {
    graph::is_valid_ontology_for_biomedical_investigations_node_name(node_name)
}
...
pub fn is_valid_c_elegans_phenotype_node_name(node_name: &str) -> bool {
    graph::is_valid_c_elegans_phenotype_node_name(node_name)
}
...
pub fn is_valid_biological_spatial_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_biological_spatial_ontology_node_name(node_name)
}
...
pub fn is_valid_variation_representation_specification_node_name(node_name: &str) -> bool {
    graph::is_valid_variation_representation_specification_node_name(node_name)
}
...
pub fn is_valid_semantic_science_node_name(node_name: &str) -> bool {
    graph::is_valid_semantic_science_node_name(node_name)
}
...
pub fn is_valid_experimental_factor_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_experimental_factor_ontology_node_name(node_name)
}
...
pub fn is_valid_unified_medical_language_system_semantic_type_node_name(node_name: &str) -> bool {
    graph::is_valid_unified_medical_language_system_semantic_type_node_name(node_name)
}
...
pub fn is_valid_scientific_evidence_and_provenance_information_ontology_node_name(
    ...
    graph::is_valid_scientific_evidence_and_provenance_information_ontology_node_name(node_name)
}
...
pub fn is_valid_drosophila_gross_anatomy_node_name(node_name: &str) -> bool {
    graph::is_valid_drosophila_gross_anatomy_node_name(node_name)
}
...
pub fn is_valid_animal_genome_sheep_qtl_node_name(node_name: &str) -> bool {
    graph::is_valid_animal_genome_sheep_qtl_node_name(node_name)
}
...
pub fn is_valid_open_biomedical_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_open_biomedical_ontology_node_name(node_name)
}
...
pub fn is_valid_the_statistical_methods_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_the_statistical_methods_ontology_node_name(node_name)
}
...
pub fn is_valid_intact_node_name(node_name: &str) -> bool {
    graph::is_valid_intact_node_name(node_name)
}
...
pub fn is_valid_game_ontology_project_node_name(node_name: &str) -> bool {
    graph::is_valid_game_ontology_project_node_name(node_name)
}
...
pub fn is_valid_apergillus_genome_data_node_name(node_name: &str) -> bool {
    graph::is_valid_apergillus_genome_data_node_name(node_name)
}
...
pub fn is_valid_ncbi_dbgap_node_name(node_name: &str) -> bool {
    graph::is_valid_ncbi_dbgap_node_name(node_name)
}
...
pub fn is_valid_animal_genome_pubblications_node_name(node_name: &str) -> bool {
    graph::is_valid_animal_genome_pubblications_node_name(node_name)
}
...
pub fn is_valid_monarch_initiative_node_name(node_name: &str) -> bool {
    graph::is_valid_monarch_initiative_node_name(node_name)
}
...
pub fn is_valid_snp_individual_node_name(node_name: &str) -> bool {
    graph::is_valid_snp_individual_node_name(node_name)
}
...
pub fn is_valid_infectious_disease_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_infectious_disease_ontology_node_name(node_name)
}
...
pub fn is_valid_foundational_model_of_anatomy_ontology_subset_node_name(node_name: &str) -> bool {
    graph::is_valid_foundational_model_of_anatomy_ontology_subset_node_name(node_name)
}
...
pub fn is_valid_ncbi_protein_node_name(node_name: &str) -> bool {
    graph::is_valid_ncbi_protein_node_name(node_name)
}
...
pub fn is_valid_drosophila_development_node_name(node_name: &str) -> bool {
    graph::is_valid_drosophila_development_node_name(node_name)
}
...
pub fn is_valid_orpha_node_name(node_name: &str) -> bool {
    graph::is_valid_orpha_node_name(node_name)
}
...
pub fn is_valid_mental_disease_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_mental_disease_ontology_node_name(node_name)
}
...
pub fn is_valid_human_developmental_anatomy_abstract_node_name(node_name: &str) -> bool {
    graph::is_valid_human_developmental_anatomy_abstract_node_name(node_name)
}
...
pub fn is_valid_wormbase_vocabulary_node_name(node_name: &str) -> bool {
    graph::is_valid_wormbase_vocabulary_node_name(node_name)
}
...
pub fn is_valid_kegg_path_node_name(node_name: &str) -> bool {
    graph::is_valid_kegg_path_node_name(node_name)
}
...
pub fn is_valid_c_elegans_gross_anatomy_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_c_elegans_gross_anatomy_ontology_node_name(node_name)
}
...
pub fn is_valid_phenotype_and_trait_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_phenotype_and_trait_ontology_node_name(node_name)
}
...
pub fn is_valid_vertebrate_gene_names_consortium_node_name(node_name: &str) -> bool {
    graph::is_valid_vertebrate_gene_names_consortium_node_name(node_name)
}
...
pub fn is_valid_yeast_genome_locus_node_name(node_name: &str) -> bool {
    graph::is_valid_yeast_genome_locus_node_name(node_name)
}
...
pub fn is_valid_schema_node_name(node_name: &str) -> bool {
    graph::is_valid_schema_node_name(node_name)
}
...
pub fn is_valid_provenance_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_provenance_ontology_node_name(node_name)
}
...
pub fn is_valid_evidence_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_evidence_ontology_node_name(node_name)
}
...
pub fn is_valid_information_artifact_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_information_artifact_ontology_node_name(node_name)
}
...
pub fn is_valid_brenda_tissue_enzyme_source_node_name(node_name: &str) -> bool {
    graph::is_valid_brenda_tissue_enzyme_source_node_name(node_name)
}
...
pub fn is_valid_mouse_developmental_anatomy_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_mouse_developmental_anatomy_ontology_node_name(node_name)
}
...
pub fn is_valid_mammalian_phenotype_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_mammalian_phenotype_ontology_node_name(node_name)
}
...
pub fn is_valid_foodon_node_name(node_name: &str) -> bool {
    graph::is_valid_foodon_node_name(node_name)
}
...
pub fn is_valid_vertebrate_trait_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_vertebrate_trait_ontology_node_name(node_name)
}
...
pub fn is_valid_exposure_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_exposure_ontology_node_name(node_name)
}
...
pub fn is_valid_population_and_community_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_population_and_community_ontology_node_name(node_name)
}
...
pub fn is_valid_kegg_disease_node_name(node_name: &str) -> bool {
    graph::is_valid_kegg_disease_node_name(node_name)
}
...
pub fn is_valid_clinical_measurement_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_clinical_measurement_ontology_node_name(node_name)
}
...
pub fn is_valid_database_snp_node_name(node_name: &str) -> bool {
    graph::is_valid_database_snp_node_name(node_name)
}
...
pub fn is_valid_mondo_disease_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_mondo_disease_ontology_node_name(node_name)
}
...
pub fn is_valid_unified_medical_language_system_semantic_group_node_name(node_name: &str) -> bool {
    graph::is_valid_unified_medical_language_system_semantic_group_node_name(node_name)
}
...
pub fn is_valid_cell_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_cell_ontology_node_name(node_name)
}
...
pub fn is_valid_ontology_for_general_medical_science_node_name(node_name: &str) -> bool {
    graph::is_valid_ontology_for_general_medical_science_node_name(node_name)
}
...
pub fn is_valid_unified_medical_language_system_semantic_code_node_name(node_name: &str) -> bool {
    graph::is_valid_unified_medical_language_system_semantic_code_node_name(node_name)
}
...
pub fn is_valid_mugen_node_name(node_name: &str) -> bool {
    graph::is_valid_mugen_node_name(node_name)
}
...
pub fn is_valid_common_anatomy_reference_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_common_anatomy_reference_ontology_node_name(node_name)
}
...
pub fn is_valid_world_geodetic_system_node_name(node_name: &str) -> bool {
    graph::is_valid_world_geodetic_system_node_name(node_name)
}
...
pub fn is_valid_chromosome_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_chromosome_ontology_node_name(node_name)
}
...
pub fn is_valid_pharmgkb_node_name(node_name: &str) -> bool {
    graph::is_valid_pharmgkb_node_name(node_name)
}
...
pub fn is_valid_rdfs_node_name(node_name: &str) -> bool {
    graph::is_valid_rdfs_node_name(node_name)
}
...
pub fn is_valid_the_arabidopsis_information_resource_locus_node_name(node_name: &str) -> bool {
    graph::is_valid_the_arabidopsis_information_resource_locus_node_name(node_name)
}
...
pub fn is_valid_owl_node_name(node_name: &str) -> bool {
    graph::is_valid_owl_node_name(node_name)
}
...
pub fn is_valid_gazetteer_node_name(node_name: &str) -> bool {
    graph::is_valid_gazetteer_node_name(node_name)
}
...
pub fn is_valid_uberon_multispecies_anatomy_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_uberon_multispecies_anatomy_ontology_node_name(node_name)
}
...
pub fn is_valid_mental_functioning_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_mental_functioning_ontology_node_name(node_name)
}
...
pub fn is_valid_relation_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_relation_ontology_node_name(node_name)
}
...
pub fn is_valid_void_node_name(node_name: &str) -> bool {
    graph::is_valid_void_node_name(node_name)
}
...
pub fn is_valid_rdf_node_name(node_name: &str) -> bool {
    graph::is_valid_rdf_node_name(node_name)
}
...
pub fn is_valid_ontology_for_parasite_lifecycle_node_name(node_name: &str) -> bool {
    graph::is_valid_ontology_for_parasite_lifecycle_node_name(node_name)
}
...
pub fn is_valid_rgd_reference_node_name(node_name: &str) -> bool {
    graph::is_valid_rgd_reference_node_name(node_name)
}
...
pub fn is_valid_mouse_phenome_database_assay_node_name(node_name: &str) -> bool {
    graph::is_valid_mouse_phenome_database_assay_node_name(node_name)
}
...
pub fn is_valid_drugbank_node_name(node_name: &str) -> bool {
    graph::is_valid_drugbank_node_name(node_name)
}
...
pub fn is_valid_coriell_family_node_name(node_name: &str) -> bool {
    graph::is_valid_coriell_family_node_name(node_name)
}
...
pub fn is_valid_pombase_node_name(node_name: &str) -> bool {
    graph::is_valid_pombase_node_name(node_name)
}
...
pub fn is_valid_online_mendelian_inheritance_in_animals_node_name(node_name: &str) -> bool {
    graph::is_valid_online_mendelian_inheritance_in_animals_node_name(node_name)
}
...
pub fn is_valid_dictyostelium_discoideum_anatomy_node_name(node_name: &str) -> bool {
    graph::is_valid_dictyostelium_discoideum_anatomy_node_name(node_name)
}
...
pub fn is_valid_emotion_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_emotion_ontology_node_name(node_name)
}
...
pub fn is_valid_interpro_node_name(node_name: &str) -> bool {
    graph::is_valid_interpro_node_name(node_name)
}
...
pub fn is_valid_panther_database_node_name(node_name: &str) -> bool {
    graph::is_valid_panther_database_node_name(node_name)
}
...
pub fn is_valid_eaglei_resource_ontology_node_name(node_name: &str) -> bool {
    graph::is_valid_eaglei_resource_ontology_node_name(node_name)
}
...
/// original_edge_ids_column: Optional[str],
///     The column name to use for the edge ids in the original edges list.
/// original_edge_ids_column_number: Optional[int],
///     The column number to use for the edge ids in the original edges list.
...
pub fn convert_edge_list_to_numeric(
    ...
    pe!(graph::convert_edge_list_to_numeric(
        ...
        original_edge_ids_column,
        original_edge_ids_column_number,
        target_edge_list_path,
        target_edge_list_separator,
        ...
        target_edge_ids_column,
        target_edge_ids_column_number,
        target_node_list_path,
...
#[pyfunction]
#[automatically_generated_binding]
#[text_signature = "(original_node_type_path, original_node_type_list_separator, original_node_types_column_number, original_node_types_column, original_node_types_ids_column_number, original_node_types_ids_column, node_types_number, original_numeric_node_type_ids, original_minimum_node_type_id, original_node_type_list_header, original_node_type_list_rows_to_skip, original_node_type_list_is_correct, original_node_type_list_max_rows_number, original_node_type_list_comment_symbol, original_load_node_type_list_in_parallel, target_node_type_list_path, target_node_type_list_separator, target_node_type_list_header, target_node_type_list_node_types_column, target_node_type_list_node_types_column_number, target_node_types_ids_column, target_node_types_ids_column_number, original_node_path, original_node_list_separator, original_node_list_header, node_list_rows_to_skip, node_list_is_correct, node_list_max_rows_number, node_list_comment_symbol, default_node_type, original_nodes_column_number, original_nodes_column, original_node_types_separator, original_node_list_node_types_column_number, original_node_list_node_types_column, original_node_ids_column, original_node_ids_column_number, original_minimum_node_id, original_numeric_node_ids, original_node_list_numeric_node_type_ids, original_skip_node_types_if_unavailable, original_load_node_list_in_parallel, target_node_path, target_node_list_separator, target_node_list_header, target_nodes_column_number, target_nodes_column, target_node_types_separator, target_node_list_node_types_column_number, target_node_list_node_types_column, target_node_ids_column, target_node_ids_column_number, nodes_number)"]
///
...
#[pyfunction]
#[automatically_generated_binding]
#[text_signature = "(original_node_type_path, original_node_type_list_separator, original_node_types_column_number, original_node_types_column, original_node_types_ids_column_number, original_node_types_ids_column, original_numeric_node_type_ids, original_minimum_node_type_id, original_node_type_list_header, original_node_type_list_rows_to_skip, original_node_type_list_max_rows_number, original_node_type_list_comment_symbol, original_load_node_type_list_in_parallel, original_node_type_list_is_correct, node_types_number, target_node_type_list_path, target_node_type_list_separator, target_node_type_list_node_types_column_number, target_node_type_list_node_types_column, target_node_types_ids_column_number, target_node_types_ids_column, target_node_type_list_header, original_node_path, original_node_list_separator, original_node_list_header, node_list_rows_to_skip, node_list_is_correct, node_list_max_rows_number, node_list_comment_symbol, default_node_type, original_nodes_column_number, original_nodes_column, original_node_types_separator, original_node_list_node_types_column_number, original_node_list_node_types_column, original_node_ids_column, original_node_ids_column_number, nodes_number, original_minimum_node_id, original_numeric_node_ids, original_node_list_numeric_node_type_ids, original_skip_node_types_if_unavailable, original_load_node_list_in_parallel, maximum_node_id, target_node_list_path, target_node_list_separator, target_node_list_header, target_nodes_column, target_nodes_column_number, target_node_types_separator, target_node_list_node_types_column, target_node_list_node_types_column_number, target_node_ids_column, target_node_ids_column_number, original_edge_type_path, original_edge_type_list_separator, original_edge_types_column_number, original_edge_types_column, original_edge_types_ids_column_number, original_edge_types_ids_column, original_numeric_edge_type_ids, original_minimum_edge_type_id, original_edge_type_list_header, edge_type_list_rows_to_skip, edge_type_list_max_rows_number, edge_type_list_comment_symbol, load_edge_type_list_in_parallel, edge_type_list_is_correct, edge_types_number, target_edge_type_list_path, target_edge_type_list_separator, target_edge_type_list_edge_types_column_number, target_edge_type_list_edge_types_column, target_edge_types_ids_column_number, target_edge_types_ids_column, target_edge_type_list_header, original_edge_list_path, original_edge_list_separator, original_edge_list_header, original_sources_column_number, original_sources_column, original_destinations_column_number, original_destinations_column, original_edge_list_edge_types_column_number, original_edge_list_edge_types_column, default_edge_type, original_weights_column_number, original_weights_column, default_weight, original_edge_list_numeric_node_ids, skip_weights_if_unavailable, skip_edge_types_if_unavailable, edge_list_comment_symbol, edge_list_max_rows_number, edge_list_rows_to_skip, load_edge_list_in_parallel, edges_number, target_edge_list_path, target_edge_list_separator, verbose, name)"]
///
pub fn build_optimal_undirected_lists_files(
    original_node_type_path: Option<String>,
    original_node_type_list_separator: Option<String>,
    original_node_types_column_number: Option<usize>,
    original_node_types_column: Option<String>,
    ...
    target_edge_types_ids_column: Option<String>,
    target_edge_type_list_header: Option<bool>,
    original_edge_list_path: String,
    original_edge_list_separator: Option<String>,
    original_edge_list_header: Option<bool>,
    original_sources_column_number: Option<usize>,
    original_sources_column: Option<String>,
    ...
    pe!(graph::build_optimal_undirected_lists_files(
        original_node_type_path,
        original_node_type_list_separator,
        original_node_types_column_number,
        original_node_types_column,
