...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("graph", 0.83933735),
        ("laplacian", 1.1256492),
        ("normalized", 1.1838288),
        ("symmetric", 1.2617224),
        ("transformed", 1.1256492),
    ],
    &[
        ("get", 0.11587939),
        ("graph", 1.1166203),
        ("normalized", 1.5749177),
        ("symmetric", 1.6785442),
        ("transformed", 1.497518),
    ],
    &[
        ("connected", 0.90843886),
        ("from", 0.24440278),
        ("id", 0.37842733),
        ("is", 0.83933735),
        ("node", 0.13883425),
    ...
    &[
        ("disconnected", 0.874522),
        ("from", 0.18987763),
        ("id", 0.2940019),
        ("is", 0.652085),
        ("node", 0.20124409),
        ("unchecked", 0.36495656),
    ],
    &[
        ("from", 0.24440278),
        ("id", 0.37842733),
    ...
    &[("components", 4.695628), ("remove", 2.7010117)],
    &[("overlaps", 9.404016)],
    &[("contains", 8.598143)],
    &[
        ("bipartite", 3.3959439),
    ...
    &[("edge", 1.2622175), ("encode", 5.7565618)],
    &[("decode", 5.7565618), ("edge", 1.2622175)],
    &[
        ("edge", 0.40254322),
        ("encodable", 1.8358681),
        ("get", 0.11587939),
    ...
    &[
        ("inplace", 1.0621293),
        ("isomorphic", 1.0305138),
        ("node", 0.18469945),
        ("remove", 0.86139977),
        ("types", 0.62094617),
    ],
    &[
        ("isomorphic", 1.4286764),
        ("node", 0.2560623),
        ("remove", 1.1942214),
        ("types", 0.860863),
    ],
    ...
    &[("circles", 5.7565618), ("get", 0.36335227)],
    &[
        ("get", 0.23444118),
        ("memory", 2.3931217),
        ("stats", 3.7142334),
    ...
    &[("get", 0.36335227), ("transitivity", 5.7565618)],
    &[
        ("get", 0.08710383),
        ("node", 0.13883425),
        ("number", 0.5659037),
    ...
    &[
        ("clustering", 1.5749177),
        ("coefficient", 1.3842663),
        ("get", 0.11587939),
        ("node", 0.18469945),
        ("per", 1.6785442),
    ],
    &[
        ("clustering", 3.186292),
        ("coefficient", 2.800576),
        ("get", 0.23444118),
    ],
    &[
        ("average", 2.5451977),
        ("clustering", 2.1834233),
        ("coefficient", 1.9191092),
        ("get", 0.16065204),
    ],
    &[
        ("are", 3.7142334),
        ("nodes", 1.6606356),
        ("remappable", 3.7142334),
    ],
    &[
        ("from", 0.3251435),
        ("ids", 0.4980646),
    ...
    &[("negatives", 5.7565618), ("sample", 5.7565618)],
    &[("connected", 3.7895386), ("holdout", 4.081452)],
    &[("holdout", 4.081452), ("random", 3.7090166)],
    &[
        ("get", 0.11587939),
        ("holdout", 1.3016464),
        ("indices", 1.8358681),
    ...
    &[("chains", 5.7565618), ("get", 0.36335227)],
    &[
        ("breadth", 0.4000029),
        ("first", 0.4000029),
        ("from", 0.10261895),
        ...
        ("node", 0.058293223),
        ("parallel", 0.45312792),
        ("predecessors", 0.5794206),
        ("search", 0.4000029),
        ("unchecked", 0.19723997),
    ],
    &[
        ("breadth", 0.4000029),
        ("distances", 0.49706173),
        ("first", 0.4000029),
        ("from", 0.10261895),
        ("get", 0.036572836),
        ("ids", 0.1571948),
    ...
    &[("diameter", 5.2632556), ("get", 0.36335227)],
    &[
        ("breadth", 0.74013233),
        ("first", 0.74013233),
        ("from", 0.18987763),
    ...
    &[("density", 5.7565618), ("get", 0.36335227)],
    &[
        ("get", 0.16065204),
        ("nodes", 1.1379592),
        ("rate", 1.9191092),
    ...
    &[
        ...
        ("get", 0.16065204),
        ("number", 1.0437381),
        ("undirected", 1.9904369),
    ],
    &[
        ("edges", 0.98845136),
        ("get", 0.11587939),
        ("number", 0.7528553),
        ("undirected", 1.4357154),
        ("unique", 1.2365675),
    ],
    &[
        ("edges", 1.9997836),
    ...
    &[
        ("destination", 1.8580086),
        ("get", 0.16065204),
        ("ids", 0.6905033),
        ("node", 0.2560623),
    ],
    &[
        ("destination", 1.340194),
        ("directed", 1.0305138),
        ("get", 0.11587939),
        ("ids", 0.4980646),
        ("node", 0.18469945),
    ...
    &[("directed", 3.2312868), ("to", 3.7895386)],
    &[
        ("to", 2.445076),
        ("triangular", 3.3959439),
        ("upper", 3.7142334),
    ],
    &[
        ("lower", 3.7142334),
    ...
    &[("bidiagonal", 5.7565618), ("to", 3.7895386)],
    &[("arrowhead", 5.7565618), ("to", 3.7895386)],
    &[("to", 3.7895386), ("transposed", 5.7565618)],
    &[("complementary", 5.7565618), ("to", 3.7895386)],
    &[
        ("approximated", 2.5017593),
        ("cliques", 3.3959439),
        ("get", 0.23444118),
    ],
    &[
    ...
    &[("report", 4.50184), ("textual", 5.2632556)],
    &[
        ("connected", 1.6755011),
        ("generate", 1.6755011),
        ("graph", 1.5480521),
    ...
    &[("remove", 2.7010117), ("tendrils", 5.2632556)],
    &[
        ("dendritic", 3.3959439),
        ("remove", 1.7427394),
        ("trees", 3.3959439),
    ...
    &[
        ("disconnected", 3.0297008),
        ("nodes", 1.6606356),
        ("remove", 1.7427394),
    ],
    &[("remove", 2.7010117), ("selfloops", 3.7090166)],
    &[
        ("edges", 1.9997836),
        ("parallel", 2.904665),
        ("remove", 1.7427394),
    ...
    &[
        ("arborescence", 2.327088),
        ("kruskal", 2.327088),
        ("random", 1.6398993),
        ("spanning", 2.1834233),
    ],
    &[
        ("arborescence", 3.3959439),
        ("kruskal", 3.3959439),
        ("spanning", 3.186292),
    ],
    &[
    ...
    &[("enable", 9.404016)],
    &[("all", 4.081452), ("disable", 5.7565618)],
    &[("compatible", 5.7565618), ("is", 3.501283)],
    &[
        ("adjacency", 2.1834233),
        ("has", 1.060992),
        ("matrix", 1.9191092),
    ...
    &[("has", 2.3996823), ("nodes", 2.5737617)],
    &[("edges", 3.0993955), ("has", 2.3996823)],
    &[("has", 1.5483166), ("nodes", 1.6606356), ("trap", 2.800576)],
    &[("directed", 3.2312868), ("is", 3.501283)],
    &[
        ("edge", 0.8144046),
        ("has", 1.5483166),
        ("weights", 2.2201326),
    ...
    &[
        ("edge", 0.40254322),
        ("has", 0.7653006),
        ("probabilities", 1.8358681),
        ("representing", 1.8358681),
        ("weights", 1.0973653),
    ],
    &[
        ("has", 1.060992),
    ...
    &[("has", 2.3996823), ("selfloops", 3.7090166)],
    &[
        ("disconnected", 3.0297008),
        ("has", 1.5483166),
        ("nodes", 1.6606356),
    ...
    &[("connected", 3.7895386), ("is", 3.501283)],
    &[
        ("has", 1.5483166),
        ("node", 0.37367436),
        ("types", 1.2562661),
    ...
    &[("is", 3.501283), ("multigraph", 4.9383235)],
    &[
        ("has", 1.5483166),
        ("node", 0.37367436),
        ("ontologies", 2.904665),
    ...
    &[("get", 0.36335227), ("tendrils", 5.2632556)],
    &[
        ("degree", 0.75306267),
        ("distribution", 1.3799791),
        ("geometric", 1.3799791),
        ("get", 0.08710383),
        ("node", 0.13883425),
        ("threshold", 1.3799791),
    ...
    &[("add", 5.7565618), ("selfloops", 3.7090166)],
    &[
        ("centrality", 2.148845),
        ("degree", 2.0268786),
        ("get", 0.23444118),
    ...
    &[
        ("centrality", 1.4725071),
        ("degree", 1.3889292),
        ("get", 0.16065204),
        ("weighted", 1.1486342),
    ],
    &[
        ("centrality", 0.6202633),
        ("closeness", 0.874522),
        ("from", 0.18987763),
        ("get", 0.06767136),
        ("id", 0.2940019),
    ...
    &[
        ("centrality", 0.49491698),
        ("closeness", 0.69779366),
        ("from", 0.15150608),
        ("get", 0.053995952),
        ("id", 0.23458835),
        ("node", 0.08606382),
    ...
    &[
        ("betweenness", 2.904665),
        ("centrality", 2.148845),
        ("get", 0.23444118),
    ],
    &[
        ("approximated", 0.7221319),
        ("betweenness", 0.8384305),
        ("centrality", 0.6202633),
        ("from", 0.18987763),
        ("get", 0.06767136),
        ("id", 0.2940019),
    ...
    &[
        ("approximated", 0.5761994),
        ("betweenness", 0.66899574),
        ("centrality", 0.49491698),
        ("from", 0.15150608),
        ("get", 0.053995952),
        ("id", 0.23458835),
    ...
    &[
        ("centrality", 2.148845),
        ("eigenvector", 3.3959439),
        ("get", 0.23444118),
    ],
    &[
        ("centrality", 1.4725071),
        ("eigenvector", 2.327088),
        ("get", 0.16065204),
        ("weighted", 1.1486342),
    ],
    &[("dot", 5.7565618), ("to", 3.7895386)],
    &[("get", 0.36335227), ("stars", 5.7565618)],
    &[
        ("community", 1.5749177),
        ("detection", 1.8358681),
        ("get", 0.11587939),
    ...
    &[
        ...
        ("from", 0.18987763),
        ("get", 0.06767136),
        ("memberships", 0.9802379),
        ("modularity", 0.9802379),
        ("node", 0.10786097),
    ],
    &[
        ("community", 0.919722),
        ...
        ("modularity", 0.9802379),
        ("node", 0.10786097),
        ("undirected", 0.8384305),
    ],
    &[
        ("attachment", 1.2365675),
        ("get", 0.11587939),
        ("minimum", 1.340194),
        ("preferential", 1.2365675),
        ("unchecked", 0.62494594),
    ],
    &[
        ("attachment", 1.2365675),
    ...
    &[
        ("attachment", 0.9294989),
        ("get", 0.08710383),
        ("minimum", 1.0073925),
        ("preferential", 0.9294989),
        ("unchecked", 0.4697573),
        ("weighted", 0.6227772),
    ],
    &[
    ...
    &[
        ("attachment", 0.7221319),
        ("from", 0.18987763),
        ("get", 0.06767136),
        ("ids", 0.29086027),
        ("node", 0.10786097),
        ("preferential", 0.7221319),
        ("unchecked", 0.36495656),
    ],
    &[
        ("attachment", 0.9294989),
    ...
    &[
        ("attachment", 0.5761994),
        ("from", 0.15150608),
        ("get", 0.053995952),
        ("ids", 0.23208158),
        ("node", 0.08606382),
        ("preferential", 0.5761994),
        ("unchecked", 0.2912041),
        ("weighted", 0.38606167),
    ],
    &[
