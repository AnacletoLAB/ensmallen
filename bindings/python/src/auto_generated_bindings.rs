...
impl Graph {
    ...
    pub fn get_isomorphic_node_groups(
        ...
        to_ndarray_2d!(
            gil,
            self.inner
                .get_isomorphic_node_groups(minimum_node_degree.into()),
            NodeT
        )
    }
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    &[
        ("laplacian", 1.781183),
        ("transformed", 1.781183),
        ("get", 0.14539328),
        ("graph", 1.3425772),
    ],
    &[
        ("coo", 1.1579361),
        ("laplacian", 0.94048977),
        ("number", 0.5261797),
        ("matrix", 0.86770666),
        ("get", 0.07676971),
        ("edges", 0.6716789),
    ...
    &[
        ...
        ("walk", 0.814271),
        ("get", 0.0591499),
        ("laplacian", 0.72463316),
        ("transformed", 0.72463316),
        ("normalized", 0.7629587),
        ("graph", 0.5461965),
    ],
    &[
        ("symmetric", 1.0568293),
        ("graph", 0.70889974),
        ("transformed", 0.94048977),
        ("get", 0.07676971),
        ("laplacian", 0.94048977),
        ("normalized", 0.99023193),
    ],
    &[
        ("get", 0.10327161),
        ("graph", 0.95362115),
        ("symmetric", 1.4216605),
        ("transformed", 1.2651591),
        ("normalized", 1.332073),
    ],
    &[
        ("is", 0.95362115),
    ...
    &[
        ("singleton", 0.4278806),
        ("selfloops", 0.56883067),
        ("with", 0.4861259),
        ("unchecked", 0.30720085),
        ("is", 0.5461965),
        ("from", 0.17124252),
        ("node_id", 0.3415049),
    ],
    ...
    &[("node_name", 2.774354), ("has", 2.223055)],
    &[("node_type_id", 3.5852475), ("has", 2.223055)],
    &[("node_type_name", 3.4956415), ("has", 2.223055)],
    &[("edge_type_id", 2.8966317), ("has", 2.223055)],
    &[("has", 2.223055), ("edge_type_name", 3.3395405)],
    &[
        ("from", 0.4209223),
        ("edge", 0.860266),
        ("has", 0.93075806),
    ...
    &[
        ("node_type_name", 1.46357),
        ("node_name", 1.1615783),
        ("has", 0.93075806),
        ("and", 1.3425772),
    ],
    &[
        ("node_names", 0.9484016),
        ("has", 0.93075806),
        ("edge", 0.860266),
        ("from", 0.4209223),
    ],
    &[
        ("from", 0.22225292),
        ("edge_type_name", 0.73827624),
        ("and", 0.70889974),
        ("node_names", 0.50076944),
        ("has", 0.4914534),
        ("edge", 0.4542326),
    ],
    &[
        ("components", 2.6574092),
        ("connected", 2.1835513),
        ("strongly", 3.2718165),
    ],
    &[
        ...
        ("sort", 0.94048977),
        ("node", 0.44323376),
        ("increasing", 1.0568293),
    ],
    &[
        ("degree", 0.6219367),
        ("outbound", 0.94048977),
        ("decreasing", 1.0568293),
        ("sort", 0.94048977),
        ("by", 0.839383),
        ("node", 0.44323376),
    ],
    ...
    &[("remove", 2.8539898), ("components", 4.254239)],
    &[("overlaps", 8.942223)],
    &[("contains", 8.16142)],
    &[
        ("bipartite", 2.9861333),
    ...
    &[("encode", 5.237842), ("edge", 2.0546892)],
    &[("edge", 2.0546892), ("decode", 5.237842)],
    &[
        ("encodable", 1.5576707),
        ("get", 0.10327161),
        ("number", 0.70782375),
    ...
    &[("node_id", 2.0049367), ("validate", 3.6848295)],
    &[("validate", 3.6848295), ("node_ids", 1.7294041)],
    &[("edge_id", 2.6016448), ("validate", 3.6848295)],
    &[("edge_ids", 3.5852475), ("validate", 3.6848295)],
    &[
        ("contain", 1.2651591),
        ("must", 1.0153396),
        ("unknown", 0.88875544),
        ("not", 1.1672504),
        ("node_types", 0.6936201),
    ],
    &[
        ("unknown", 0.88875544),
        ("edge_types", 0.7306596),
        ("must", 1.0153396),
        ("contain", 1.2651591),
        ("not", 1.1672504),
    ],
    &[("node_type_id", 3.5852475), ("validate", 3.6848295)],
    &[("validate", 3.6848295), ("node_type_ids", 3.3395405)],
    &[("validate", 3.6848295), ("edge_type_id", 2.8966317)],
    &[("edge_type_ids", 3.9250097), ("validate", 3.6848295)],
    &[
        ("be", 2.6574092),
        ("must", 2.1326747),
        ("undirected", 2.5451827),
    ],
    &[
        ("have", 1.332073),
        ("must", 1.0153396),
    ...
    &[
        ("all", 1.5427802),
        ("set", 1.7059608),
        ("edge_types", 1.0286757),
        ("inplace", 1.3175776),
    ],
    &[
        ("edge_types", 1.5347173),
        ("set", 2.5451827),
        ("all", 2.3017278),
    ],
    &[
        ...
        ("all", 1.5427802),
        ("set", 1.7059608),
        ("node_types", 0.97652876),
    ],
    &[
        ("node_types", 1.4569174),
        ("set", 2.5451827),
        ("all", 2.3017278),
    ],
    &[
        ("node_type_ids", 2.086043),
        ("inplace", 1.9657402),
        ("remove", 1.7827439),
    ],
    &[
    ...
    &[
        ("remove", 1.7827439),
        ("inplace", 1.9657402),
        ("node_type_name", 2.1835513),
    ],
    &[("node_type_id", 3.5852475), ("remove", 2.8539898)],
    &[
        ("node_types", 1.4569174),
        ("singleton", 1.5691441),
        ("remove", 1.7827439),
    ...
    &[
        ("node_types", 1.4569174),
        ("remove", 1.7827439),
        ("homogeneous", 2.371726),
    ],
    &[("node_type_name", 3.4956415), ("remove", 2.8539898)],
    &[
        ("edge_type_name", 2.086043),
        ("inplace", 1.9657402),
        ("remove", 1.7827439),
    ],
    &[("remove", 2.8539898), ("edge_type_id", 2.8966317)],
    &[
        ("remove", 1.7827439),
        ("singleton", 1.5691441),
        ("edge_types", 1.5347173),
    ],
    &[("edge_type_name", 3.3395405), ("remove", 2.8539898)],
    &[
        ("inplace", 1.9657402),
        ("remove", 1.7827439),
        ("node_types", 1.4569174),
    ],
    &[("node_types", 2.332375), ("remove", 2.8539898)],
    &[
        ("edge_types", 1.5347173),
        ("remove", 1.7827439),
        ("inplace", 1.9657402),
    ],
    &[("edge_types", 2.4569247), ("remove", 2.8539898)],
    &[
        ("edge", 0.860266),
        ("inplace", 1.3175776),
        ("remove", 1.1949207),
    ...
    &[("get", 0.34726235), ("circles", 5.237842)],
    &[
        ("get", 0.21691734),
        ("memory", 2.086043),
        ("stats", 3.2718165),
    ...
    &[
        ...
        ("get", 0.0591499),
        ("memory", 0.56883067),
        ("node_types", 0.3972782),
        ("total", 0.56883067),
        ("requirements", 0.66855484),
    ],
    &[
        ("requirements", 1.1672504),
        ("edge_types", 0.7306596),
    ...
    &[("transitivity", 5.237842), ("get", 0.34726235)],
    &[
        ("per", 1.0568293),
        ("of", 1.0568293),
        ("triangles", 1.0568293),
    ...
    &[
        ("get", 0.10327161),
        ("clustering", 1.332073),
        ("coefficient", 1.1672504),
        ("per", 1.4216605),
        ("node", 0.59624386),
    ],
    &[
        ("get", 0.21691734),
        ("clustering", 2.7979586),
        ("coefficient", 2.4517562),
    ],
    &[
        ("average", 2.193002),
        ("get", 0.14539328),
        ("coefficient", 1.6433399),
        ("clustering", 1.8753891),
    ],
    &[
        ("are", 3.2718165),
        ("nodes", 1.5022875),
        ("remappable", 3.2718165),
    ],
    &[
        ("unchecked", 0.75511444),
        ("node_ids", 0.72407424),
        ("from", 0.4209223),
        ("remap", 1.781183),
    ],
    ...
    &[("negatives", 5.237842), ("sample", 5.237842)],
    &[("holdout", 3.6848295), ("connected", 3.4956415)],
    &[("holdout", 3.6848295), ("random", 3.3395405)],
    &[
        ("indices", 1.5576707),
        ("label", 1.0662092),
        ("node", 0.59624386),
    ...
    &[("get", 0.34726235), ("chains", 5.237842)],
    &[
        ("breadth", 0.39287278),
        ("first", 0.39287278),
        ("predecessors", 0.5739647),
        ("unchecked", 0.19763274),
        ("search", 0.39287278),
        ("parallel", 0.44649354),
        ("node_id", 0.2197017),
        ("from", 0.110166125),
    ...
    &[
        ...
        ("from", 0.22225292),
        ("get", 0.07676971),
        ("node_names", 0.92806304),
    ],
    &[
        ("get", 0.046895757),
        ("from", 0.13576604),
        ("path", 0.43304044),
        ("unchecked", 0.24355775),
        ("k", 0.5127478),
        ("shortest", 0.41741785),
        ("node_ids", 0.44554412),
    ],
    ...
    &[
        ...
        ("get", 0.0591499),
        ("from", 0.17124252),
        ("node_names", 0.72730476),
    ],
    &[
        ("eccentricity", 0.43010405),
        ("most", 0.46618113),
        ("from", 0.110166125),
        ("unchecked", 0.19763274),
        ("distant", 0.5238482),
    ...
    &[
        ("unchecked", 0.3987111),
        ("weighted", 0.5055972),
        ("eccentricity", 0.86770666),
        ("from", 0.22225292),
        ("node_id", 0.44323376),
        ("get", 0.07676971),
    ],
    &[
        ("eccentricity", 0.5300497),
        ("get", 0.046895757),
        ("from", 0.13576604),
        ("node_id", 0.5165292),
        ("most", 0.57451016),
    ...
    &[("get", 0.34726235), ("diameter", 4.479244)],
    &[
        ("diameter", 1.8753891),
        ("weighted", 0.9575448),
        ("get", 0.14539328),
    ...
    &[
        ...
        ("with", 0.848742),
        ("get", 0.10327161),
        ("selfloops", 0.99313885),
        ("singleton", 0.7470498),
    ],
    &[
        ("node_names", 0.67364156),
        ("singleton", 0.7470498),
        ("get", 0.10327161),
        ("with", 0.848742),
        ("selfloops", 0.99313885),
    ],
    &[("get", 0.34726235), ("density", 5.237842)],
    &[
        ("rate", 1.6433399),
        ("get", 0.14539328),
        ("trap", 1.6433399),
    ...
    &[("source_names", 5.237842), ("get", 0.34726235)],
    &[
        ("get", 0.21691734),
        ("node_ids", 1.0802717),
        ("destination", 2.4517562),
    ],
    &[
        ("node_ids", 0.72407424),
        ("destination", 1.6433399),
        ("directed", 1.46357),
        ("get", 0.14539328),
    ],
    &[("get", 0.34726235), ("destination_names", 5.237842)],
    &[("get", 0.34726235), ("node_names", 2.2651951)],
    &[
        ("get", 0.21691734),
        ("node", 1.2523831),
        ("urls", 3.2718165),
    ...
    &[
        ("get", 0.21691734),
        ("node", 1.2523831),
        ("ontologies", 3.2718165),
    ],
    &[("node_ids", 1.7294041), ("get", 0.34726235)],
    &[("edge_type_ids", 3.9250097), ("get", 0.34726235)],
    &[
        ("get", 0.21691734),
        ("edge_type_ids", 2.4517562),
        ("unique", 2.1835513),
    ],
    &[("get", 0.34726235), ("edge_type_names", 4.074576)],
    &[
        ("get", 0.21691734),
        ("unique", 2.1835513),
        ("edge_type_names", 2.5451827),
    ],
    &[
        ("get", 0.21691734),
        ("weights", 2.003038),
    ...
    &[("get", 0.34726235), ("node_type_ids", 3.3395405)],
    &[
        ("known", 1.2941417),
        ("node_types", 0.97652876),
        ("mask", 1.6433399),
    ...
    &[
        ...
        ("one", 0.94048977),
        ("encoded", 0.94048977),
        ("edge_types", 0.5431553),
        ("get", 0.07676971),
        ("known", 0.6833251),
    ],
    &[("get", 0.34726235), ("node_type_names", 3.414193)],
    &[
        ("unique", 2.1835513),
        ("node_type_ids", 2.086043),
        ("get", 0.21691734),
    ...
    &[("directed", 3.4956415), ("to", 3.414193)],
    &[
        ("triangular", 2.9861333),
        ("upper", 3.2718165),
        ("to", 2.1326747),
    ],
    &[
    ...
    &[("to", 3.414193), ("bidiagonal", 5.237842)],
    &[("to", 3.414193), ("arrowhead", 5.237842)],
    &[("to", 3.414193), ("transposed", 5.237842)],
    &[("complementary", 5.237842), ("to", 3.414193)],
    &[("report", 6.9562545)],
    &[
        ("overlap", 3.2718165),
        ("textual", 2.9861333),
    ...
    &[("report", 4.074576), ("textual", 4.780493)],
    &[
        ("connected", 1.46357),
        ("random", 1.398213),
        ("graph", 1.3425772),
    ...
    &[("replace", 8.942223)],
    &[("from_ids", 5.237842), ("filter", 4.780493)],
    &[("filter", 4.780493), ("from_names", 5.237842)],
    &[
        ("node_types", 1.4569174),
        ("unknown", 1.8667904),
        ("drop", 2.371726),
    ...
    &[
        ("drop", 2.371726),
        ("disconnected", 2.6574092),
        ("nodes", 1.5022875),
    ],
    &[("selfloops", 3.3395405), ("drop", 3.7968898)],
    &[
        ("drop", 2.371726),
        ("edges", 1.8978683),
        ("parallel", 2.5451827),
    ...
    &[
        ("spanning", 1.8753891),
        ("random", 1.398213),
        ("arborescence", 2.001517),
        ("kruskal", 2.001517),
    ],
    &[
        ("spanning", 2.7979586),
        ("arborescence", 2.9861333),
        ("kruskal", 2.9861333),
    ],
    &[
        ("get", 0.21691734),
    ...
    &[("enable", 8.942223)],
    &[("all", 3.6848295), ("disable", 5.237842)],
    &[("compatible", 5.237842), ("is", 3.206658)],
    &[
        ("has", 0.93075806),
        ("adjacency", 1.8753891),
        ("matrix", 1.6433399),
    ...
    &[
        ("graph_name", 3.2718165),
        ("has", 1.3886306),
        ("default", 3.2718165),
    ],
    &[("has", 2.223055), ("nodes", 2.4050078)],
    &[("edges", 3.038292), ("has", 2.223055)],
    &[
        ("nodes", 1.5022875),
        ("has", 1.3886306),
        ("trap", 2.4517562),
    ],
    &[("directed", 3.4956415), ("is", 3.206658)],
    &[
        ("weights", 2.003038),
        ("edge", 1.283461),
        ("has", 1.3886306),
    ...
    &[
        ("probabilities", 1.5576707),
        ("weights", 0.95362115),
        ("representing", 1.5576707),
        ("edge", 0.61103964),
        ("has", 0.66110957),
    ],
    &[
    ...
    &[("has", 2.223055), ("edge_types", 2.4569247)],
    &[("has", 2.223055), ("selfloops", 3.3395405)],
    &[
        ("disconnected", 2.6574092),
        ("has", 1.3886306),
        ("nodes", 1.5022875),
    ...
    &[("connected", 3.4956415), ("is", 3.206658)],
    &[("has", 2.223055), ("node_types", 2.332375)],
    &[
        ("has", 1.3886306),
        ("node_types", 1.4569174),
        ("multilabel", 2.9861333),
    ],
    &[
        ("has", 1.3886306),
        ("unknown", 1.8667904),
    ...
    &[("is", 3.206658), ("multigraph", 4.479244)],
    &[
        ("has", 0.3002106),
        ("outbound", 0.57451016),
        ("node", 0.270755),
        ...
        ("nodes", 0.3247823),
        ("by", 0.5127478),
        ("decreasing", 0.64557767),
        ("sorted", 0.60489583),
    ],
    &[
        ("order", 1.0568293),
        ("by", 0.839383),
        ("lexicographic", 1.0568293),
        ("nodes", 0.531678),
        ("sorted", 0.99023193),
        ("has", 0.4914534),
    ],
    ...
    &[
        ("get", 0.10327161),
        ("edge_type_id", 0.8614232),
        ("from", 0.29897755),
        ("edge_type_name", 0.99313885),
        ("unchecked", 0.5363514),
    ],
    &[
        ("from", 0.29897755),
    ...
    &[
        ("weight", 0.30945003),
        ("unchecked", 0.16346644),
        ("edge_type_id", 0.2625402),
        ("get", 0.031474598),
        ("edge", 0.18622956),
        ("and", 0.56300485),
        ("node_ids", 0.1567469),
    ...
    &[
        ("from", 0.29897755),
        ("node_type_ids", 0.99313885),
        ("get", 0.10327161),
        ("unchecked", 0.5363514),
        ("node_id", 0.59624386),
    ],
    &[
        ("node_type_ids", 1.398213),
        ("node_id", 0.8394354),
        ("get", 0.14539328),
        ("from", 0.4209223),
    ],
    ...
    &[("add", 5.237842), ("selfloops", 3.3395405)],
    &[
        ("get", 0.21691734),
        ("centrality", 1.8667904),
        ("degree", 1.7573187),
    ],
    &[
        ("centrality", 1.2512544),
        ("degree", 1.1778789),
        ("get", 0.14539328),
        ("weighted", 0.9575448),
    ],
    &[
        ...
        ("get", 0.07676971),
        ("node_id", 0.44323376),
        ("centrality", 0.66068006),
        ("unchecked", 0.3987111),
        ("closeness", 0.94048977),
    ],
    &[
        ("weighted", 0.38955498),
        ("from", 0.17124252),
    ...
    &[
        ...
        ("from", 0.22225292),
        ("get", 0.07676971),
        ("betweenness", 0.9007714),
        ("node_id", 0.44323376),
        ("approximated", 0.9007714),
    ],
    &[
        ("get", 0.07676971),
        ("betweenness", 0.9007714),
    ...
    &[
        ...
        ("node_id", 0.3415049),
        ("from", 0.17124252),
        ("betweenness", 0.69403076),
        ("weighted", 0.38955498),
        ("approximated", 0.69403076),
    ],
    &[
        ("from", 0.17124252),
        ("node_name", 0.47256133),
        ("weighted", 0.38955498),
        ("approximated", 0.69403076),
        ("get", 0.0591499),
        ("betweenness", 0.69403076),
    ...
    &[
        ("eigenvector", 2.9861333),
        ("get", 0.21691734),
        ("centrality", 1.8667904),
    ],
    &[
        ("centrality", 1.2512544),
        ("eigenvector", 2.001517),
        ("weighted", 0.9575448),
        ("get", 0.14539328),
    ],
    &[("to", 3.414193), ("dot", 5.237842)],
    &[("stars", 5.237842), ("get", 0.34726235)],
    &[
        ("community", 1.332073),
        ("undirected", 1.2117294),
        ("detection", 1.5576707),
    ...
    &[
        ("get", 0.10327161),
        ("preferential", 1.0395614),
        ("unchecked", 0.5363514),
        ("attachment", 1.0395614),
        ("minimum", 1.129149),
    ],
    &[
        ("unchecked", 0.5363514),
    ...
    &[
        ("preferential", 0.77278566),
        ("minimum", 0.839383),
        ("attachment", 0.77278566),
        ("weighted", 0.5055972),
        ("unchecked", 0.3987111),
        ("get", 0.07676971),
    ],
    ...
    &[
        ("attachment", 0.5954197),
        ("unchecked", 0.30720085),
        ("from", 0.17124252),
        ("get", 0.0591499),
        ("node_ids", 0.2945729),
        ("weighted", 0.38955498),
        ("preferential", 0.5954197),
    ],
    &[
        ("preferential", 0.77278566),
        ("weighted", 0.5055972),
    ...
    &[
        ...
        ("unchecked", 0.30720085),
        ("index", 0.6106825),
        ("allocation", 0.66855484),
    ],
    &[
        ("resource", 0.5300497),
        ("get", 0.046895757),
        ("allocation", 0.5300497),
        ("from", 0.13576604),
        ("node_ids", 0.23354593),
        ("unchecked", 0.24355775),
        ("index", 0.4841668),
    ...
    &[
        ("isomorphic", 2.9861333),
        ("nodes", 1.5022875),
        ("has", 1.3886306),
    ],
    &[("from", 1.0053455), ("csv", 5.237842)],
];
