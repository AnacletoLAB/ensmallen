...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("disconnected", 0.9058915),
        ("from", 0.19313261),
        ("id", 0.30693835),
        ("is", 0.6816919),
        ("node", 0.20562185),
        ("unchecked", 0.38081113),
    ],
    &[
        ("from", 0.24848549),
        ("id", 0.39490858),
    ...
    &[
        ...
        ("is", 0.6816919),
        ("node", 0.11026592),
        ("selfloops", 0.72068715),
        ("singleton", 0.55313814),
        ("with", 0.60625064),
    ],
    &[
        ("from", 0.24848549),
    ...
    &[
        ...
        ("node", 0.059641626),
        ("type", 0.16209698),
        ("unchecked", 0.20597656),
    ],
    &[
        ("components", 3.1293597),
        ("connected", 2.5417955),
        ("strongly", 3.817334),
    ],
    &[
    ...
    &[
        ("coo", 0.9272401),
        ("get", 0.091697246),
        ("intersection", 1.2241403),
        ("matrix", 0.8770686),
        ("neighbours", 1.2241403),
        ("size", 1.1187216),
    ],
    &[
        ("get", 0.121920735),
        ("graph", 0.9091657),
        ("intersection", 1.627618),
        ("neighbours", 1.627618),
        ("size", 1.4874531),
    ],
    &[
    ...
    &[
        ("coo", 1.7078714),
        ("cooccurrence", 1.9887935),
        ("get", 0.16889596),
        ("matrix", 1.6154612),
    ],
    &[
        ("cooccurrence", 2.8990827),
        ("get", 0.2462012),
        ("graph", 1.835928),
    ],
    &[
        ("coo", 1.2328591),
        ("cooccurrence", 1.4356481),
        ("get", 0.121920735),
        ("matrix", 1.1661512),
        ("normalized", 1.2869278),
    ],
    &[
        ("cooccurrence", 1.9887935),
        ("get", 0.16889596),
        ("graph", 1.259461),
        ("normalized", 1.7827724),
    ],
    &[
        ("coo", 0.9272401),
        ("cooccurrence", 1.0797586),
        ("get", 0.091697246),
        ("log", 1.3026174),
        ("matrix", 0.8770686),
        ("normalized", 0.9679054),
    ],
    &[
        ("cooccurrence", 1.4356481),
        ("get", 0.121920735),
    ...
    &[("components", 4.8425097), ("remove", 2.787885)],
    &[("overlaps", 9.630258)],
    &[("contains", 8.823249)],
    &[
        ("bipartite", 2.8990827),
    ...
    &[("edges", 2.1214957), ("get", 0.2462012), ("star", 3.286738)],
    &[
        ("edge", 0.5491202),
        ("get", 0.16889596),
        ("names", 0.8972004),
    ...
    &[("edge", 1.2386636), ("encode", 5.9071116)],
    &[("decode", 5.9071116), ("edge", 1.2386636)],
    &[
        ("edge", 0.39639276),
        ("encodable", 1.8903731),
        ("get", 0.121920735),
    ...
    &[
        ...
        ("must", 1.6748096),
        ("node", 0.2613062),
        ("ontologies", 2.0605588),
    ],
    &[
        ("be", 3.1293597),
        ("must", 2.4413853),
        ("undirected", 3.0036955),
    ],
    &[
        ("have", 1.549683),
        ("must", 1.2089928),
    ...
    &[
        ("inplace", 1.0117667),
        ("isomorphic", 1.0794492),
        ("node", 0.18862881),
        ("remove", 0.8921692),
        ("types", 0.63297856),
    ],
    &[
        ("isomorphic", 1.4953537),
        ("node", 0.2613062),
        ("remove", 1.2359159),
        ("types", 0.87686086),
    ],
    ...
    &[("circles", 5.9071116), ("get", 0.38098267)],
    &[("get", 0.2462012), ("memory", 2.48958), ("stats", 3.817334)],
    &[
        ("get", 0.16889596),
        ("memory", 1.7078714),
        ("total", 1.7078714),
    ...
    &[("get", 0.38098267), ("transitivity", 5.9071116)],
    &[
        ("get", 0.091697246),
        ("node", 0.14186874),
        ("number", 0.6062518),
    ...
    &[("connected", 3.933287), ("holdout", 4.22621)],
    &[("holdout", 4.22621), ("random", 3.5264308)],
    &[
        ("get", 0.121920735),
        ("holdout", 1.3524569),
        ("indices", 1.8903731),
    ...
    &[("chains", 5.9071116), ("get", 0.38098267)],
    &[
        ("breadth", 0.4167209),
        ("first", 0.4167209),
        ("from", 0.10446331),
    ...
    &[("diameter", 5.4121), ("get", 0.38098267)],
    &[
        ("breadth", 0.77043694),
        ("first", 0.77043694),
        ("from", 0.19313261),
    ...
    &[("density", 5.9071116), ("get", 0.38098267)],
    &[
        ("get", 0.16889596),
        ("nodes", 1.1623918),
        ("rate", 1.9887935),
    ...
    &[
        ...
        ("get", 0.16889596),
        ("number", 1.1166474),
        ("undirected", 2.0605588),
    ],
    &[
        ("edges", 1.050581),
        ("get", 0.121920735),
        ("number", 0.8060729),
        ("undirected", 1.4874531),
        ("unique", 1.2587167),
    ],
    &[
        ("edges", 2.1214957),
    ...
    &[
        ("destination", 1.8735493),
        ("get", 0.16889596),
        ("ids", 0.6904361),
        ("node", 0.2613062),
    ],
    &[
        ("destination", 1.3524569),
        ("directed", 1.0241728),
        ("get", 0.121920735),
        ("ids", 0.49840432),
        ("node", 0.18862881),
    ...
    &[("get", 0.2462012), ("node", 0.38090846), ("urls", 3.817334)],
    &[
        ("get", 0.2462012),
        ("node", 0.38090846),
        ("ontologies", 3.0036955),
    ],
    &[
        ("from", 0.24848549),
        ("get", 0.091697246),
    ...
    &[("get", 0.2462012), ("ids", 1.0064551), ("node", 0.38090846)],
    &[
        ("edge", 0.5491202),
        ("get", 0.16889596),
        ("ids", 0.6904361),
    ...
    &[("directed", 3.200375), ("to", 3.8524864)],
    &[
        ("to", 2.48958),
        ("triangular", 3.4974442),
        ("upper", 3.817334),
    ],
    &[
        ("lower", 3.817334),
    ...
    &[("diagonal", 3.4974442), ("main", 3.817334), ("to", 2.48958)],
    &[("anti", 3.817334), ("diagonal", 3.4974442), ("to", 2.48958)],
    &[("bidiagonal", 5.9071116), ("to", 3.8524864)],
    &[("arrowhead", 5.9071116), ("to", 3.8524864)],
    &[("to", 3.8524864), ("transposed", 5.9071116)],
    &[("complementary", 5.9071116), ("to", 3.8524864)],
    &[
        ("graph", 0.9091657),
        ("multi", 1.8903731),
        ("similarity", 1.8903731),
        ("structural", 1.7319613),
        ("to", 1.2328591),
    ],
    &[
        ("approximated", 2.5987637),
        ("cliques", 3.4974442),
        ("get", 0.2462012),
    ],
    &[("clique", 2.80947), ("get", 0.2462012), ("max", 3.4974442)],
    &[
        ("approximated", 1.7827724),
        ("cliques", 2.399274),
        ("get", 0.16889596),
        ("number", 1.1166474),
    ],
    ...
    &[("report", 4.6480517), ("textual", 5.4121)],
    &[
        ("connected", 1.7436917),
        ("generate", 1.7436917),
        ("graph", 1.259461),
    ...
    &[("remove", 2.787885), ("tendrils", 5.4121)],
    &[
        ("dendritic", 3.4974442),
        ("remove", 1.8016059),
        ("trees", 3.4974442),
    ...
    &[
        ("disconnected", 3.1293597),
        ("nodes", 1.6944293),
        ("remove", 1.8016059),
    ],
    &[("remove", 2.787885), ("selfloops", 3.8524864)],
    &[
        ("edges", 2.1214957),
        ("parallel", 3.0036955),
        ("remove", 1.8016059),
    ...
    &[
        ("arborescence", 2.399274),
        ("kruskal", 2.399274),
        ("random", 1.5633255),
        ("spanning", 2.254728),
    ],
    &[
        ("arborescence", 3.4974442),
        ("kruskal", 3.4974442),
        ("spanning", 3.286738),
    ],
    &[
    ...
    &[("enable", 9.630258)],
    &[("all", 3.933287), ("disable", 5.9071116)],
    &[
        ("compatible", 2.1467655),
        ("has", 1.0376006),
        ("node", 0.2613062),
        ("vocabularies", 2.254728),
    ],
    &[
        ("compatible", 1.549683),
        ("has", 0.7490116),
    ...
    &[("compatible", 4.8425097), ("is", 3.6440346)],
    &[
        ("adjacency", 2.618721),
        ("has", 1.0376006),
        ("matrix", 1.6154612),
    ...
    &[("has", 2.3405406), ("nodes", 2.622035)],
    &[("edges", 3.2828965), ("has", 2.3405406)],
    &[
        ("has", 1.5125201),
        ("nodes", 1.6944293),
        ("trap", 2.8990827),
    ],
    &[("directed", 3.200375), ("is", 3.6440346)],
    &[
        ("edge", 0.8004576),
        ("has", 1.5125201),
        ("weights", 2.3157213),
    ...
    &[
        ("edge", 0.39639276),
        ("has", 0.7490116),
        ("probabilities", 1.8903731),
        ("representing", 1.8903731),
        ("weights", 1.146763),
    ],
    &[
        ("has", 1.0376006),
    ...
    &[("has", 2.3405406), ("selfloops", 3.8524864)],
    &[
        ("disconnected", 3.1293597),
        ("has", 1.5125201),
        ("nodes", 1.6944293),
    ...
    &[("connected", 3.933287), ("is", 3.6440346)],
    &[
        ("has", 1.5125201),
        ("node", 0.38090846),
        ("types", 1.2782081),
    ...
    &[("is", 3.6440346), ("multigraph", 5.086044)],
    &[
        ("has", 1.5125201),
        ("node", 0.38090846),
        ("ontologies", 3.0036955),
    ...
    &[("get", 0.38098267), ("tendrils", 5.4121)],
    &[
        ("degree", 0.79014766),
        ("distribution", 1.4217598),
        ("geometric", 1.4217598),
        ("get", 0.091697246),
        ("node", 0.14186874),
        ("threshold", 1.4217598),
    ...
    &[("add", 4.3474984), ("selfloops", 3.8524864)],
    &[
        ("centrality", 2.244075),
        ("degree", 2.1214957),
        ("get", 0.2462012),
    ...
    &[
        ("centrality", 0.51851285),
        ("closeness", 0.72306544),
        ("from", 0.1541548),
        ("get", 0.056886904),
        ("id", 0.24499239),
        ("node", 0.088012174),
    ...
    &[
        ("betweenness", 3.0036955),
        ("centrality", 2.244075),
        ("get", 0.2462012),
    ],
    &[
        ("approximated", 0.7522938),
        ("betweenness", 0.869514),
        ("centrality", 0.649618),
        ("from", 0.19313261),
        ("get", 0.071270674),
        ("id", 0.30693835),
    ...
    &[
        ("approximated", 0.6004667),
        ("betweenness", 0.6940297),
        ("centrality", 0.51851285),
        ("from", 0.1541548),
        ("get", 0.056886904),
        ("id", 0.24499239),
    ...
    &[
        ("centrality", 2.244075),
        ("eigenvector", 3.4974442),
        ("get", 0.2462012),
    ],
    &[
        ("centrality", 1.5394531),
        ("eigenvector", 2.399274),
        ("get", 0.16889596),
        ("weighted", 1.2246101),
    ],
    &[("dot", 5.9071116), ("to", 3.8524864)],
    &[("get", 0.38098267), ("stars", 5.9071116)],
    &[
        ("community", 1.627618),
        ("detection", 1.8903731),
        ("get", 0.121920735),
    ...
    &[
        ...
        ("from", 0.19313261),
        ("get", 0.071270674),
        ("memberships", 1.0124451),
        ("modularity", 1.0124451),
        ("node", 0.11026592),
    ],
    &[
        ("community", 0.9514496),
    ...
    &[
        ...
        ("ids", 0.29135007),
        ("node", 0.11026592),
        ("structural", 1.0124451),
        ("unchecked", 0.38081113),
    ],
    &[
        ("attachment", 1.2587167),
        ("get", 0.121920735),
        ("minimum", 1.3912711),
        ("preferential", 1.2587167),
        ("unchecked", 0.6514428),
    ],
    &[
        ("attachment", 1.2587167),
    ...
    &[
        ("attachment", 0.94668764),
        ("get", 0.091697246),
        ("minimum", 1.0463825),
        ("preferential", 0.94668764),
        ("unchecked", 0.4899537),
        ("weighted", 0.6648671),
    ],
    &[
    ...
    &[
        ("attachment", 0.73580253),
        ("from", 0.19313261),
        ("get", 0.071270674),
        ("ids", 0.29135007),
        ("node", 0.11026592),
        ("preferential", 0.73580253),
        ("unchecked", 0.38081113),
    ],
    &[
        ("attachment", 0.94668764),
    ...
    &[
        ("attachment", 0.5873037),
        ("from", 0.1541548),
        ("get", 0.056886904),
        ("ids", 0.23255011),
        ("node", 0.088012174),
        ("preferential", 0.5873037),
        ("unchecked", 0.30395624),
        ("weighted", 0.41246858),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.056886904),
        ("ids", 0.23255011),
        ("intersection", 0.75942904),
        ("neighbours", 0.75942904),
        ("node", 0.088012174),
        ("size", 0.6940297),
        ("unchecked", 0.30395624),
    ],
    &[
        ("coefficient", 0.81328934),
        ("from", 0.19313261),
        ("get", 0.071270674),
        ("ids", 0.29135007),
        ("jaccard", 0.7905998),
    ...
    &[
        ("attachment", 1.7436917),
        ("get", 0.16889596),
        ("preferential", 1.7436917),
        ("scores", 2.1467655),
    ],
    &[
        ("allocation", 1.3912711),
        ("get", 0.121920735),
        ("index", 1.2869278),
        ("resource", 1.3912711),
        ("scores", 1.549683),
