...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[("edge", 1.996114462153489), ("encode", 5.223051764941072)],
    ...
    &[("directed", 3.4752665788802153), ("to", 3.3935571914376483)],
    &[
    ...
    &[("has", 2.2194897698472507), ("nodes", 2.433220388919968)],
    &[("edges", 3.0164512228310505), ("has", 2.2194897698472507)],
    &[
