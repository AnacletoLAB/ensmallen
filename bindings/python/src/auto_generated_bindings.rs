...
impl Graph {
    ...
    pub fn get_root_nodes(&self) -> Py<PyArray1<NodeT>> {
        let gil = pyo3::Python::acquire_gil();
        to_ndarray_1d!(gil, self.inner.get_root_nodes(), NodeT)
    }
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("disconnected", 0.91366243),
        ("from", 0.19513299),
        ("id", 0.31118965),
        ("is", 0.6767452),
        ("node", 0.20850912),
        ("unchecked", 0.38549656),
    ],
    &[
        ("from", 0.25097847),
        ("id", 0.40024963),
    ...
    &[
        ...
        ("is", 0.6767452),
        ("node", 0.11185866),
        ("selfloops", 0.72736984),
        ("singleton", 0.55883616),
        ("with", 0.6122608),
    ],
    &[
        ("from", 0.25097847),
    ...
    &[
        ...
        ("node", 0.06054007),
        ("type", 0.16370279),
        ("unchecked", 0.20863819),
    ],
    &[
        ("components", 3.1494398),
        ("connected", 2.5596895),
        ("strongly", 3.8399737),
    ],
    &[
    ...
    &[
        ("get", 0.12123083),
        ("graph", 0.9180091),
        ("intersection", 1.6401435),
        ("neighbours", 1.6401435),
        ("size", 1.4992603),
    ],
    &[
        ("ancestors", 1.1751453),
    ...
    &[
        ("cooccurrence", 2.918306),
        ("get", 0.24446599),
        ("graph", 1.8511958),
    ],
    &[
        ("coo", 1.2433617),
        ("cooccurrence", 1.4471897),
        ("get", 0.12123083),
        ("matrix", 1.1763116),
        ("normalized", 1.2977073),
    ],
    &[
        ("cooccurrence", 2.0036175),
        ("get", 0.1678427),
        ("graph", 1.2709731),
        ("normalized", 1.7966609),
    ],
    &[
        ("coo", 0.9355372),
        ("cooccurrence", 1.0889027),
        ("get", 0.09121719),
        ("log", 1.312999),
        ("matrix", 0.8850871),
        ("normalized", 0.9764283),
    ],
    &[
        ("cooccurrence", 1.4471897),
        ("get", 0.12123083),
    ...
    &[("components", 4.8679276), ("remove", 2.808051)],
    &[("overlaps", 9.661502)],
    &[("contains", 8.853654)],
    &[
        ("bipartite", 2.918306),
    ...
    &[("edge", 1.2392839), ("encode", 5.9352503)],
    &[("decode", 5.9352503), ("edge", 1.2392839)],
    &[
        ("edge", 0.39760762),
        ("encodable", 1.9042454),
        ("get", 0.12123083),
    ...
    &[
        ...
        ("must", 1.6573702),
        ("node", 0.26472878),
        ("ontologies", 2.0757086),
    ],
    &[
        ("be", 3.023308),
        ("must", 2.4139903),
        ("undirected", 2.8283598),
    ],
    &[
        ("acyclic", 2.4159622),
        ("be", 2.0757086),
    ...
    &[("circles", 5.9352503), ("get", 0.37785852)],
    &[
        ("get", 0.24446599),
        ("memory", 2.5072799),
        ("stats", 3.8399737),
    ...
    &[("get", 0.37785852), ("transitivity", 5.9352503)],
    &[
        ("get", 0.09121719),
        ("node", 0.14387171),
        ("number", 0.6080757),
    ...
    &[
        ("clustering", 1.6401435),
        ("coefficient", 1.4025854),
        ("get", 0.12123083),
        ("node", 0.19121052),
        ("per", 1.7450216),
    ],
    &[
        ("clustering", 3.3074036),
        ("coefficient", 2.8283598),
        ("get", 0.24446599),
    ],
    &[
        ("average", 2.6364057),
        ("clustering", 2.2707598),
        ("coefficient", 1.9418634),
        ("get", 0.1678427),
    ],
    &[
        ("are", 3.8399737),
        ("nodes", 1.6952022),
        ("remappable", 3.8399737),
    ],
    &[
        ("from", 0.33355916),
        ("ids", 0.4959405),
    ...
    &[("connected", 3.9563806), ("holdout", 4.2500525)],
    &[("holdout", 4.2500525), ("random", 3.4944975)],
    &[
        ("get", 0.12123083),
        ("holdout", 1.3635722),
        ("indices", 1.9042454),
    ...
    &[("chains", 5.9352503), ("get", 0.37785852)],
    &[
        ("breadth", 0.42075038),
        ("first", 0.42075038),
        ("from", 0.10560974),
    ...
    &[
        ("and", 0.30897537),
        ("distant", 0.4660766),
        ("eccentricity", 0.3865289),
        ("from", 0.08909009),
        ("get", 0.03237946),
        ("id", 0.2749965),
        ("most", 0.41714254),
        ("node", 0.09884884),
        ("unchecked", 0.17600265),
    ],
    &[
        ("eccentricity", 0.8466098),
        ("from", 0.19513299),
        ("get", 0.070920356),
        ("id", 0.31118965),
        ("node", 0.11185866),
    ...
    &[("diameter", 5.4389734), ("get", 0.37785852)],
    &[
        ("breadth", 0.77741194),
        ("first", 0.77741194),
        ("from", 0.19513299),
    ...
    &[("density", 5.9352503), ("get", 0.37785852)],
    &[
        ("get", 0.1678427),
        ("nodes", 1.1638727),
        ("rate", 2.0036175),
    ...
    &[("directed", 3.0746715), ("to", 3.8753738)],
    &[
        ("to", 2.5072799),
        ("triangular", 3.5188937),
        ("upper", 3.8399737),
    ],
    &[
        ("lower", 3.8399737),
    ...
    &[("bidiagonal", 5.9352503), ("to", 3.8753738)],
    &[("arrowhead", 5.9352503), ("to", 3.8753738)],
    &[("to", 3.8753738), ("transposed", 5.9352503)],
    &[("complementary", 5.9352503), ("to", 3.8753738)],
    &[
        ("graph", 0.9180091),
        ("multi", 1.9042454),
        ("similarity", 1.9042454),
        ("structural", 1.7450216),
        ("to", 1.2433617),
    ],
    &[
        ("approximated", 2.6168697),
        ("cliques", 3.5188937),
        ("get", 0.24446599),
    ],
    &[
    ...
    &[("report", 4.672972), ("textual", 5.4389734)],
    &[
        ("connected", 1.7574028),
        ("generate", 1.7574028),
        ("graph", 1.2709731),
    ...
    &[("remove", 2.808051), ("tendrils", 5.4389734)],
    &[
        ("dendritic", 3.5188937),
        ("remove", 1.8167461),
        ("trees", 3.5188937),
    ...
    &[
        ("disconnected", 3.1494398),
        ("nodes", 1.6952022),
        ("remove", 1.8167461),
    ],
    &[("remove", 2.808051), ("selfloops", 3.8753738)],
    &[
        ("edges", 2.1104934),
        ("parallel", 3.023308),
        ("remove", 1.8167461),
    ...
    &[
        ("arborescence", 2.4159622),
        ("kruskal", 2.4159622),
        ("random", 1.5522367),
        ("spanning", 2.2707598),
    ],
    &[
        ("arborescence", 3.5188937),
        ("kruskal", 3.5188937),
        ("spanning", 3.3074036),
    ],
    &[
    ...
    &[("enable", 9.661502)],
    &[("all", 3.9563806), ("disable", 5.9352503)],
    &[
        ("compatible", 2.1623068),
        ("has", 1.0554197),
        ("node", 0.26472878),
        ("vocabularies", 2.2707598),
    ],
    &[
        ("compatible", 1.5618092),
        ("has", 0.7623174),
        ("node", 0.19121052),
        ("types", 0.64040655),
        ("vocabularies", 1.6401435),
    ],
    &[
        ("compatible", 1.5618092),
        ("edge", 0.39760762),
    ...
    &[("compatible", 4.8679276), ("is", 3.6056492)],
    &[
        ("adjacency", 2.6364057),
        ("has", 1.0554197),
        ("matrix", 1.62859),
    ...
    &[("has", 2.3760302), ("nodes", 2.620187)],
    &[("edges", 3.2620811), ("has", 2.3760302)],
    &[
        ("has", 1.5372384),
        ("nodes", 1.6952022),
        ("trap", 2.8283598),
    ],
    &[("directed", 3.0746715), ("is", 3.6056492)],
    &[
        ("acyclic", 3.5188937),
        ("directed", 1.9892436),
        ("is", 2.3327742),
    ...
    &[
        ("edge", 0.39760762),
        ("has", 0.7623174),
        ("probabilities", 1.9042454),
        ("representing", 1.9042454),
        ("weights", 1.1384836),
    ],
    &[
        ("has", 1.0554197),
    ...
    &[("has", 2.3760302), ("selfloops", 3.8753738)],
    &[
        ("disconnected", 3.1494398),
        ("has", 1.5372384),
        ("nodes", 1.6952022),
    ...
    &[("connected", 3.9563806), ("is", 3.6056492)],
    &[
        ("has", 1.5372384),
        ("node", 0.38558236),
        ("types", 1.2914009),
    ...
    &[("is", 3.6056492), ("multigraph", 4.672972)],
    &[
        ("has", 1.5372384),
        ("node", 0.38558236),
        ("ontologies", 3.023308),
    ...
    &[
        ...
        ("get", 0.05662144),
        ("ids", 0.23163138),
        ("multigraph", 0.7002367),
        ("node", 0.08930579),
        ("number", 0.3774521),
        ("of", 0.38946554),
    ],
    &[("get", 0.37785852), ("tendrils", 5.4389734)],
    &[
        ("degree", 0.7976835),
        ("distribution", 1.432803),
        ("geometric", 1.432803),
        ("get", 0.09121719),
        ("node", 0.14387171),
        ("threshold", 1.432803),
    ...
    &[("add", 4.3716507), ("selfloops", 3.8753738)],
    &[
        ("centrality", 2.2608614),
        ("degree", 2.137826),
        ("get", 0.24446599),
    ],
    &[
        ("centrality", 1.5522367),
        ("degree", 1.4677645),
        ("get", 0.1678427),
        ("weighted", 1.235964),
    ],
    &[
        ("centrality", 0.6558831),
        ("closeness", 0.91366243),
        ("from", 0.19513299),
        ("get", 0.070920356),
        ("id", 0.31118965),
        ("node", 0.11185866),
    ...
    &[
        ("betweenness", 3.023308),
        ("centrality", 2.2608614),
        ("get", 0.24446599),
    ],
    &[
        ("approximated", 0.7591622),
        ("betweenness", 0.8770712),
        ("centrality", 0.6558831),
        ("from", 0.19513299),
        ("get", 0.070920356),
        ("id", 0.31118965),
    ...
    &[
        ("approximated", 0.6061004),
        ("betweenness", 0.7002367),
        ("centrality", 0.5236443),
        ("from", 0.1557904),
        ("get", 0.05662144),
        ("id", 0.2484478),
    ...
    &[
        ("centrality", 2.2608614),
        ("eigenvector", 3.5188937),
        ("get", 0.24446599),
    ],
    &[
        ("centrality", 1.5522367),
        ("eigenvector", 2.4159622),
        ("get", 0.1678427),
        ("weighted", 1.235964),
    ],
    &[("dot", 5.9352503), ("to", 3.8753738)],
    &[("get", 0.37785852), ("stars", 5.9352503)],
    &[
        ("community", 1.6401435),
        ("detection", 1.9042454),
        ("get", 0.12123083),
    ...
    &[
        ...
        ("from", 0.19513299),
        ("get", 0.070920356),
        ("memberships", 1.0208422),
        ("modularity", 1.0208422),
        ("node", 0.11185866),
    ],
    &[
        ("community", 0.9594883),
    ...
    &[
        ...
        ("ids", 0.2901265),
        ("node", 0.11185866),
        ("structural", 1.0208422),
        ("unchecked", 0.38549656),
    ],
    &[
        ("attachment", 1.2693516),
        ("get", 0.12123083),
        ("minimum", 1.4025854),
        ("preferential", 1.2693516),
        ("unchecked", 0.6589655),
    ],
    &[
        ("attachment", 1.2693516),
    ...
    &[
        ("attachment", 0.9550927),
        ("get", 0.09121719),
        ("minimum", 1.0553412),
        ("preferential", 0.9550927),
        ("unchecked", 0.49582258),
        ("weighted", 0.6717073),
    ],
    &[
    ...
    &[
        ("attachment", 0.74257404),
        ("from", 0.19513299),
        ("get", 0.070920356),
        ("ids", 0.2901265),
        ("node", 0.11185866),
        ("preferential", 0.74257404),
        ("unchecked", 0.38549656),
    ],
    &[
        ("attachment", 0.9550927),
    ...
    &[
        ("attachment", 0.59285676),
        ("from", 0.1557904),
        ("get", 0.05662144),
        ("ids", 0.23163138),
        ("node", 0.08930579),
        ("preferential", 0.59285676),
        ("unchecked", 0.307773),
        ("weighted", 0.41695026),
    ],
    &[
    ...
    &[
        ...
        ("get", 0.05662144),
        ("ids", 0.23163138),
        ("intersection", 0.76603687),
        ("neighbours", 0.76603687),
        ("node", 0.08930579),
        ("size", 0.7002367),
        ("unchecked", 0.307773),
    ],
    &[
        ("coefficient", 0.82051617),
        ("from", 0.19513299),
        ("get", 0.070920356),
        ("ids", 0.2901265),
        ("jaccard", 0.7976933),
    ...
    &[
        ("attachment", 1.7574028),
        ("get", 0.1678427),
        ("preferential", 1.7574028),
        ("scores", 2.1623068),
    ],
    &[
        ("allocation", 1.4025854),
        ("get", 0.12123083),
        ("index", 1.2977073),
        ("resource", 1.4025854),
        ("scores", 1.5618092),
