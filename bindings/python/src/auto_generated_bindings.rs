...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("get", 0.06927878),
        ("graph", 0.63915825),
        ("laplacian", 0.88370746),
        ("normalized", 0.9289601),
        ("random", 0.6291522),
        ("transformed", 0.88370746),
        ("walk", 0.98954666),
    ],
    &[
        ("get", 0.089167185),
        ...
        ("normalized", 1.195644),
        ("symmetric", 1.2736237),
        ("transformed", 1.1374004),
    ],
    &[
        ("get", 0.11861441),
        ("graph", 1.0943234),
        ("normalized", 1.5905024),
        ("symmetric", 1.6942346),
        ("transformed", 1.5130239),
    ],
    &[
        ("connected", 0.9199503),
        ("from", 0.25177372),
    ...
    &[
        ("disconnected", 0.88370746),
        ("from", 0.19561653),
        ("id", 0.29627368),
        ("is", 0.66101104),
        ("node", 0.2043108),
        ("unchecked", 0.36662132),
    ],
    &[
        ("from", 0.25177372),
        ("id", 0.3813273),
    ...
    &[
        ...
        ("node", 0.059193272),
        ("type", 0.16437195),
        ("unchecked", 0.19816346),
    ],
    &[
        ("components", 3.0602252),
        ("connected", 2.4751663),
        ("strongly", 3.7452655),
    ],
    &[
    ...
    &[("components", 4.7418423), ("remove", 2.6932507)],
    &[("overlaps", 9.477532)],
    &[("contains", 8.671492)],
    &[
        ("bipartite", 3.42674),
    ...
    &[("edge", 1.2300483), ("encode", 5.8033175)],
    &[("decode", 5.8033175), ("edge", 1.2300483)],
    &[
        ("edge", 0.392483),
        ("encodable", 1.8517188),
        ("get", 0.11861441),
    ...
    &[
        ("be", 3.0602252),
        ("multigraph", 3.2169323),
        ("must", 2.4231737),
    ],
    &[
        ("be", 2.0973747),
        ("multigraph", 2.2047765),
        ("must", 1.6607612),
        ("not", 1.9402236),
    ],
    &[
    ...
    &[("circles", 5.8033175), ("get", 0.37173957)],
    &[
        ("get", 0.23990819),
        ("memory", 2.4231737),
        ("stats", 3.7452655),
    ...
    &[("get", 0.37173957), ("transitivity", 5.8033175)],
    &[
        ("get", 0.089167185),
        ("node", 0.14095204),
        ("number", 0.5770375),
    ...
    &[
        ("clustering", 1.5905024),
        ("coefficient", 1.3996568),
        ("get", 0.11861441),
        ("node", 0.18750107),
        ("per", 1.6942346),
    ],
    &[
        ("clustering", 3.2169323),
        ("coefficient", 2.83093),
        ("get", 0.23990819),
    ],
    &[
        ("average", 2.5668783),
        ("clustering", 2.2047765),
        ("coefficient", 1.9402236),
        ("get", 0.16442494),
    ],
    &[
        ("are", 3.7452655),
        ("nodes", 1.6314138),
        ("remappable", 3.7452655),
    ],
    &[
        ("from", 0.33492133),
        ("ids", 0.5020563),
    ...
    &[("connected", 3.835289), ("holdout", 4.1273518)],
    &[("holdout", 4.1273518), ("random", 3.3759365)],
    &[
        ("get", 0.11861441),
        ("holdout", 1.3169527),
        ("indices", 1.8517188),
    ...
    &[("chains", 5.8033175), ("get", 0.37173957)],
    &[
        ("breadth", 0.40493098),
        ("first", 0.40493098),
        ("from", 0.10573321),
    ...
    &[("diameter", 5.3097596), ("get", 0.37173957)],
    &[
        ("breadth", 0.74916095),
        ("first", 0.74916095),
        ("from", 0.19561653),
    ...
    &[("density", 5.8033175), ("get", 0.37173957)],
    &[
        ("get", 0.16442494),
        ("nodes", 1.1181158),
        ("rate", 1.9402236),
    ...
    &[
        ("destination", 1.8255781),
        ("get", 0.16442494),
        ("ids", 0.69595736),
        ("node", 0.2599166),
    ],
    &[
        ("destination", 1.3169527),
        ("directed", 0.9905913),
        ("get", 0.11861441),
        ("ids", 0.5020563),
        ("node", 0.18750107),
    ...
    &[("directed", 3.1045296), ("to", 3.835289)],
    &[
        ("to", 2.4751663),
        ("triangular", 3.42674),
        ("upper", 3.7452655),
    ...
    &[("bidiagonal", 5.8033175), ("to", 3.835289)],
    &[("arrowhead", 5.8033175), ("to", 3.835289)],
    &[("to", 3.835289), ("transposed", 5.8033175)],
    &[("complementary", 5.8033175), ("to", 3.835289)],
    &[
        ("approximated", 2.5318918),
        ("cliques", 3.42674),
        ("get", 0.23990819),
    ],
    &[("clique", 3.2169323), ("get", 0.23990819), ("max", 3.42674)],
    &[
        ("approximated", 1.7352729),
        ("cliques", 2.3485715),
        ("get", 0.16442494),
        ("number", 1.0640614),
    ],
    ...
    &[("report", 4.5479546), ("textual", 5.3097596)],
    &[
        ("connected", 1.6963953),
        ("generate", 1.6963953),
        ("graph", 1.5169662),
    ...
    &[("remove", 2.6932507), ("tendrils", 5.3097596)],
    &[
        ("dendritic", 3.42674),
        ("remove", 1.7381333),
        ("trees", 3.42674),
    ...
    &[
        ("disconnected", 3.0602252),
        ("nodes", 1.6314138),
        ("remove", 1.7381333),
    ],
    &[("remove", 2.6932507), ("selfloops", 3.754726)],
    &[
        ("edges", 2.0295439),
        ("parallel", 2.9350967),
        ("remove", 1.7381333),
    ...
    &[
        ("arborescence", 2.3485715),
        ("kruskal", 2.3485715),
        ("random", 1.493218),
        ("spanning", 2.2047765),
    ],
    &[
        ("arborescence", 3.42674),
        ("kruskal", 3.42674),
        ("spanning", 3.2169323),
    ],
    &[
    ...
    &[("enable", 9.477532)],
    &[("all", 4.1273518), ("disable", 5.8033175)],
    &[
        ("compatible", 2.0973747),
        ("has", 1.008585),
        ("node", 0.2599166),
        ("vocabularies", 2.2047765),
    ],
    &[
        ("compatible", 1.5130239),
        ("has", 0.7275826),
        ("node", 0.18750107),
        ("types", 0.62004423),
        ("vocabularies", 1.5905024),
    ],
    &[
        ("compatible", 1.5130239),
        ("edge", 0.392483),
    ...
    &[("compatible", 4.7418423), ("is", 3.5468862)],
    &[
        ("adjacency", 2.2047765),
        ("has", 1.008585),
        ("matrix", 1.9402236),
    ...
    &[("has", 2.2802558), ("nodes", 2.527888)],
    &[("edges", 3.1447937), ("has", 2.2802558)],
    &[("has", 1.4716003), ("nodes", 1.6314138), ("trap", 2.83093)],
    &[("directed", 3.1045296), ("is", 3.5468862)],
    &[
        ("edge", 0.7938317),
        ("has", 1.4716003),
        ("weights", 2.2500563),
    ...
    &[
        ("edge", 0.392483),
        ("has", 0.7275826),
        ("probabilities", 1.8517188),
        ("representing", 1.8517188),
        ("weights", 1.1124635),
    ],
    &[
        ("has", 1.008585),
    ...
    &[("has", 2.2802558), ("selfloops", 3.754726)],
    &[
        ("disconnected", 3.0602252),
        ("has", 1.4716003),
        ("nodes", 1.6314138),
    ...
    &[("connected", 3.835289), ("is", 3.5468862)],
    &[
        ("has", 1.4716003),
        ("node", 0.37923756),
        ("types", 1.2540946),
    ...
    &[("is", 3.5468862), ("multigraph", 4.984661)],
    &[
        ("has", 1.4716003),
        ("node", 0.37923756),
        ("ontologies", 2.9350967),
    ...
    &[("get", 0.37173957), ("tendrils", 5.3097596)],
    &[
        ("degree", 0.76440275),
        ("distribution", 1.3920108),
        ("geometric", 1.3920108),
        ("get", 0.089167185),
        ("node", 0.14095204),
        ("threshold", 1.3920108),
    ...
    &[("add", 5.8033175), ("selfloops", 3.754726)],
    &[
        ("centrality", 2.1787157),
        ("degree", 2.056659),
        ("get", 0.23990819),
    ],
    &[
    ...
    &[
        ("centrality", 0.6291522),
        ("closeness", 0.88370746),
        ("from", 0.19561653),
        ("get", 0.06927878),
        ("id", 0.29627368),
        ("node", 0.10951321),
    ...
    &[
        ("betweenness", 2.9350967),
        ("centrality", 2.1787157),
        ("get", 0.23990819),
    ],
    &[
        ("approximated", 0.73113954),
        ("betweenness", 0.8475739),
        ("centrality", 0.6291522),
        ("from", 0.19561653),
        ("get", 0.06927878),
        ("id", 0.29627368),
    ...
    &[
        ("approximated", 0.58341545),
        ("betweenness", 0.67632467),
        ("centrality", 0.50203425),
        ("from", 0.15609291),
        ("get", 0.05528125),
        ("id", 0.23641266),
    ...
    &[
        ("centrality", 1.493218),
        ("eigenvector", 2.3485715),
        ("get", 0.16442494),
        ("weighted", 1.1690521),
    ],
    &[("dot", 5.8033175), ("to", 3.835289)],
    &[("get", 0.37173957), ("stars", 5.8033175)],
    &[
        ("community", 1.5905024),
        ("detection", 1.8517188),
        ("get", 0.11861441),
    ...
    &[
        ...
        ("from", 0.19561653),
        ("get", 0.06927878),
        ("memberships", 0.98954666),
        ("modularity", 0.98954666),
        ("node", 0.10951321),
    ],
    &[
        ("community", 0.9289601),
        ...
        ("modularity", 0.98954666),
        ("node", 0.10951321),
        ("undirected", 0.8475739),
    ],
    &[
        ("attachment", 1.2518076),
        ("get", 0.11861441),
        ("minimum", 1.3555398),
        ("preferential", 1.2518076),
        ("unchecked", 0.62770414),
    ],
    &[
        ("attachment", 1.2518076),
    ...
    &[
        ("attachment", 0.9410336),
        ("get", 0.089167185),
        ("minimum", 1.0190133),
        ("preferential", 0.9410336),
        ("unchecked", 0.4718702),
        ("weighted", 0.63397366),
    ],
    &[
    ...
    &[
        ("attachment", 0.73113954),
        ("from", 0.19561653),
        ("get", 0.06927878),
        ("ids", 0.29323456),
        ("node", 0.10951321),
        ("preferential", 0.73113954),
        ("unchecked", 0.36662132),
    ],
    &[
        ("attachment", 0.9410336),
    ...
    &[
        ("attachment", 0.58341545),
        ("from", 0.15609291),
        ("get", 0.05528125),
        ("ids", 0.23398758),
        ("node", 0.08738646),
        ("preferential", 0.58341545),
        ("unchecked", 0.2925468),
        ("weighted", 0.3930466),
    ],
    &[
