...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ("laplacian", 0.85748696),
        ("walk", 0.9626437),
        ("get", 0.066943884),
        ("normalized", 0.9024479),
        ("random", 0.6747107),
        ("transformed", 0.85748696),
        ("graph", 0.63622665),
    ],
    &[
        ("get", 0.086192235),
        ("laplacian", 1.1040398),
        ("transformed", 1.1040398),
        ("symmetric", 1.2394322),
        ("graph", 0.8191606),
        ("normalized", 1.1619283),
    ],
    &[
        ("transformed", 1.4693292),
        ("symmetric", 1.6495184),
        ("get", 0.11471033),
        ("normalized", 1.5463711),
        ("graph", 1.0901932),
    ],
    &[
        ("from", 0.25115627),
        ("node", 0.14328912),
        ("unchecked", 0.45753202),
        ("id", 0.37522),
        ("connected", 0.908871),
        ("is", 0.83452255),
    ],
    ...
    &[
        ...
        ("node", 0.14328912),
        ("from", 0.25115627),
        ("singleton", 0.65581363),
        ("is", 0.83452255),
    ],
    &[
        ("id", 0.49936765),
        ("node", 0.19069864),
        ("singleton", 0.87280023),
        ("from", 0.3342554),
        ("is", 1.1106378),
    ],
    &[
        ("from", 0.15561312),
        ("with", 0.46084222),
        ("unchecked", 0.28348082),
        ("singleton", 0.40633354),
        ("id", 0.23248139),
        ("node", 0.08878005),
        ("is", 0.5170592),
        ("selfloops", 0.53824127),
    ],
    &[
        ("id", 0.29142633),
        ("singleton", 0.50935817),
        ("selfloops", 0.6747107),
        ("from", 0.19506836),
        ("is", 0.64815795),
        ("with", 0.5776873),
    ...
    &[
        ...
        ("outbound", 1.1040398),
        ("degree", 0.7333176),
        ("increasing", 1.2394322),
        ("node", 0.14328912),
    ],
    &[
        ("node", 0.14328912),
        ("by", 0.986375),
        ("decreasing", 1.2394322),
        ("degree", 0.7333176),
        ("sort", 1.1040398),
        ("outbound", 1.1040398),
    ],
    ...
    &[("remove", 3.111058), ("components", 4.617882)],
    &[("overlaps", 9.285751)],
    &[("contains", 8.480645)],
    &[
        ("bipartite", 3.341419),
    ...
    &[("edge", 1.2956666), ("encode", 5.6763477)],
    &[("edge", 1.2956666), ("decode", 5.6763477)],
    &[
        ("number", 0.7600723),
        ("get", 0.11471033),
        ("max", 1.8061147),
    ...
    &[("circles", 5.6763477), ("get", 0.36051738)],
    &[
        ("stats", 3.6586351),
        ("get", 0.23236799),
        ("memory", 2.3419788),
    ...
    &[
        ("get", 0.11471033),
        ("memory", 1.1561368),
        ("requirement", 1.4693292),
        ("total", 1.1561368),
        ("nodes", 0.80342275),
    ],
    &[
        ("memory", 0.6747107),
        ("requirement", 0.85748696),
        ("get", 0.066943884),
        ("total", 0.6747107),
        ("human", 0.8215865),
        ("readable", 0.8215865),
    ...
    &[("transitivity", 5.6763477), ("get", 0.36051738)],
    &[
        ("node", 0.14328912),
        ("number", 0.57111096),
        ("get", 0.086192235),
    ...
    &[
        ("clustering", 1.5463711),
        ("coefficient", 1.3566014),
        ("get", 0.11471033),
        ("node", 0.19069864),
        ("per", 1.6495184),
    ],
    &[
        ("coefficient", 2.7480588),
        ("clustering", 3.1324742),
        ("get", 0.23236799),
    ],
    &[
        ("get", 0.15911424),
        ("average", 2.5052545),
        ("coefficient", 1.8817365),
        ("clustering", 2.1449652),
    ],
    &[
        ("are", 3.6586351),
        ("nodes", 1.6274884),
        ("remappable", 3.6586351),
    ],
    &[
        ("from", 0.3342554),
        ("ids", 0.49085167),
    ...
    &[("negatives", 5.6763477), ("sample", 5.6763477)],
    &[("connected", 3.8015463), ("holdout", 4.0051336)],
    &[("random", 3.6335645), ("holdout", 4.0051336)],
    &[
        ("holdout", 1.2743635),
        ("get", 0.11471033),
        ("indices", 1.8061147),
    ...
    &[("chains", 5.6763477), ("get", 0.36051738)],
    &[
        ("breadth", 0.3909676),
        ("from", 0.10536688),
        ("parallel", 0.44378293),
        ("first", 0.3909676),
        ("predecessors", 0.5693391),
        ("id", 0.15741499),
        ("search", 0.3909676),
        ("node", 0.060113676),
        ("get", 0.03615998),
    ...
    &[
        ("and", 0.2952135),
        ("unchecked", 0.16185258),
        ("from", 0.08884688),
        ("node", 0.09817748),
        ("id", 0.2570897),
        ("distant", 0.43845084),
        ("most", 0.3905556),
        ("eccentricity", 0.36059192),
        ("get", 0.03049062),
    ],
    &[
        ("id", 0.29142633),
    ...
    &[("diameter", 4.8600125), ("get", 0.36051738)],
    &[
        ("weighted", 1.1037935),
        ("get", 0.15911424),
        ("diameter", 2.1449652),
    ...
    &[("get", 0.36051738), ("density", 5.6763477)],
    &[
        ("trap", 1.8817365),
        ("rate", 1.8817365),
        ("get", 0.15911424),
    ...
    &[
        ("get", 0.15911424),
        ("undirected", 1.9527715),
        ("number", 1.0542933),
        ("edges", 1.3933172),
    ],
    &[
        ("undirected", 1.4078127),
        ("number", 0.7600723),
        ("edges", 1.004485),
        ("get", 0.11471033),
        ("unique", 1.2095857),
    ...
    &[
        ("ids", 0.68085843),
        ("get", 0.15911424),
        ("destination", 1.820887),
        ("node", 0.26451734),
    ],
    &[
        ("destination", 1.312733),
        ("directed", 1.2095857),
        ("get", 0.11471033),
        ("node", 0.19069864),
        ("ids", 0.49085167),
    ...
    &[("to", 3.7138991), ("directed", 3.8015463)],
    &[
        ("upper", 3.6586351),
        ("triangular", 3.341419),
        ("to", 2.3937578),
    ...
    &[("to", 3.7138991), ("bidiagonal", 5.6763477)],
    &[("arrowhead", 5.6763477), ("to", 3.7138991)],
    &[("to", 3.7138991), ("transposed", 5.6763477)],
    &[("to", 3.7138991), ("complementary", 5.6763477)],
    &[("report", 7.237967)],
    &[
        ("textual", 3.341419),
        ("report", 2.8517973),
    ...
    &[("textual", 5.184189), ("report", 4.4245443)],
    &[
        ("connected", 1.6778115),
        ("generate", 1.6391284),
        ("graph", 1.5122026),
    ...
    &[("tendrils", 5.184189), ("drop", 3.8015463)],
    &[
        ("drop", 2.45025),
        ("dendritic", 3.341419),
        ("trees", 3.341419),
    ...
    &[
        ("drop", 2.45025),
        ("disconnected", 2.9764109),
        ("nodes", 1.6274884),
    ],
    &[("drop", 3.8015463), ("selfloops", 3.6335645)],
    &[
        ("edges", 2.0347788),
        ("parallel", 2.8517973),
        ("drop", 2.45025),
    ...
    &[("enable", 9.285751)],
    &[("compatible", 5.6763477), ("is", 3.4905682)],
    &[
        ("matrix", 1.8817365),
        ("same", 2.5052545),
        ("adjacency", 2.1449652),
    ...
    &[("has", 2.3887932), ("nodes", 2.5250373)],
    &[("edges", 3.1569457), ("has", 2.3887932)],
    &[
        ("has", 1.5396737),
        ("nodes", 1.6274884),
        ("trap", 2.7480588),
    ],
    &[("is", 3.4905682), ("directed", 3.8015463)],
    &[
        ("has", 1.5396737),
        ("weights", 2.249812),
        ("edge", 0.8351094),
    ...
    &[
        ("edge", 0.41225848),
        ("representing", 1.8061147),
        ("has", 0.7600723),
        ("probabilities", 1.8061147),
        ("weights", 1.1106378),
    ],
    &[
        ("nodes", 1.1144246),
    ...
    &[("has", 2.3887932), ("selfloops", 3.6335645)],
    &[
        ("nodes", 1.6274884),
        ("disconnected", 2.9764109),
        ("has", 1.5396737),
    ...
    &[("connected", 3.8015463), ("is", 3.4905682)],
    &[
        ("node", 0.38629702),
        ("types", 1.2418649),
        ("has", 1.5396737),
    ...
    &[("multigraph", 4.8600125), ("is", 3.4905682)],
    &[
        ("node", 0.08878005),
        ("by", 0.61114496),
        ("sorted", 0.7199155),
    ...
    &[
        ...
        ("from", 0.19506836),
        ("degree", 0.569554),
        ("comulative", 0.9626437),
        ("id", 0.29142633),
    ],
    &[
        ("id", 0.23248139),
        ("get", 0.053403575),
        ("reciprocal", 0.68404853),
        ("sqrt", 0.68404853),
        ("unchecked", 0.28348082),
        ("from", 0.15561312),
        ("node", 0.08878005),
    ...
    &[("tendrils", 5.184189), ("get", 0.36051738)],
    &[
        ("degree", 0.7333176),
        ("distribution", 1.3570971),
        ("geometric", 1.3570971),
        ("threshold", 1.3570971),
        ("get", 0.086192235),
        ("node", 0.14328912),
    ...
    &[("selfloops", 3.6335645), ("add", 5.6763477)],
    &[
        ("degree", 1.9769709),
        ("get", 0.23236799),
        ("centrality", 2.0985258),
    ],
    &[
        ("weighted", 1.1037935),
        ("centrality", 1.4369678),
        ("degree", 1.3537331),
        ("get", 0.15911424),
    ],
    &[
        ("node", 0.11128996),
        ("from", 0.19506836),
        ("centrality", 0.60457325),
        ("unchecked", 0.3553565),
        ("get", 0.066943884),
        ("id", 0.29142633),
        ("closeness", 0.85748696),
    ],
    &[
        ("id", 0.23248139),
        ("unchecked", 0.28348082),
        ("node", 0.08878005),
        ("weighted", 0.37046662),
        ("closeness", 0.68404853),
        ("centrality", 0.48229006),
        ("from", 0.15561312),
        ("get", 0.053403575),
    ],
    &[
    ...
    &[
        ...
        ("centrality", 0.60457325),
        ("id", 0.29142633),
        ("approximated", 0.8215865),
        ("betweenness", 0.8215865),
        ("node", 0.11128996),
    ],
    &[
        ("name", 0.43587524),
    ...
    &[
        ...
        ("node", 0.08878005),
        ("id", 0.23248139),
        ("approximated", 0.65540946),
        ("betweenness", 0.65540946),
        ("centrality", 0.48229006),
    ],
    &[
        ("approximated", 0.65540946),
    ...
    &[
        ...
        ("weighted", 1.1037935),
        ("centrality", 1.4369678),
        ("eigenvector", 2.2880404),
    ],
    &[("to", 3.7138991), ("dot", 5.6763477)],
    &[("stars", 5.6763477), ("get", 0.36051738)],
    &[
        ("detection", 1.8061147),
        ("louvain", 1.8061147),
        ("get", 0.11471033),
    ...
    &[
        ("community", 0.9024479),
        ("memberships", 0.9626437),
        ("modularity", 0.9626437),
        ("get", 0.066943884),
        ("node", 0.11128996),
        ("directed", 0.705903),
        ("from", 0.19506836),
    ...
    &[
        ("unchecked", 0.6089139),
        ("preferential", 1.2095857),
        ("minimum", 1.312733),
        ("get", 0.11471033),
        ("attachment", 1.2095857),
    ],
    &[
        ("unchecked", 0.6089139),
        ("get", 0.11471033),
    ...
    &[
        ...
        ("ids", 0.22851676),
        ("node", 0.08878005),
        ("preferential", 0.56312454),
        ("attachment", 0.56312454),
        ("unchecked", 0.28348082),
    ],
    &[
        ("preferential", 0.705903),
    ...
    &[
        ("node", 0.20771556),
        ("has", 0.44357115),
        ("isomorphic", 0.66094214),
        ("types", 0.35777417),
        ("ids", 0.2864565),
        ("from", 0.19506836),
    ],
    &[("csv", 5.6763477), ("from", 1.0505146)],
];
