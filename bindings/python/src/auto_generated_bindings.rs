...
fn ensmallen(_py: Python, _m: &PyModule) -> PyResult<()> {
    ...
    _m.add_class::<Star>()?;
    _m.add_class::<Circle>()?;
    _m.add_wrapped(wrap_pyfunction!(get_tokenized_csv))?;
...
#[text_signature = "(path, columns, separator, header, pretrained_model_name_or_path)"]
...
///     The columns to be read. If none are given, all the columns will be used.
...
pub const GRAPH_TFIDF_FREQUENCIES: &[&[(&str, f64)]] = &[
    ...
    &[
        ...
        ("number", 0.5290186),
        ("get", 0.076638356),
        ("laplacian", 0.93964815),
        ("edges", 0.669642),
    ],
    &[
        ("get", 0.059061486),
        ("normalized", 0.76264584),
        ("graph", 0.54487264),
        ("walk", 0.8141975),
        ("laplacian", 0.72414154),
        ("random", 0.56761235),
        ("transformed", 0.72414154),
    ],
    &[
        ("transformed", 0.93964815),
        ("laplacian", 0.93964815),
        ("get", 0.076638356),
        ("graph", 0.7070283),
        ("symmetric", 1.056505),
        ("normalized", 0.9896115),
    ],
    &[
        ("transformed", 1.2636571),
        ("graph", 0.9508254),
        ("get", 0.103064746),
        ("normalized", 1.3308487),
        ("symmetric", 1.4208084),
    ],
    &[
        ("from", 0.29984832),
    ...
    &[
        ("node_id", 0.44018105),
        ("disconnected", 0.93964815),
        ("is", 0.7070283),
        ("from", 0.2229655),
        ("node", 0.44379583),
        ("unchecked", 0.39546037),
    ],
    &[
        ("node_id", 0.591964),
        ("unchecked", 0.5318228),
        ("singleton", 0.74339616),
        ("is", 0.9508254),
        ("from", 0.29984832),
    ],
    &[
    ...
    &[
        ("singleton", 0.42600486),
        ("with", 0.4845218),
        ("is", 0.54487264),
        ("from", 0.17182876),
        ("node_id", 0.3392263),
        ("unchecked", 0.30476224),
        ("selfloops", 0.56761235),
    ],
    &[
        ("from", 0.2229655),
        ("node_id", 0.44018105),
        ("selfloops", 0.73653543),
        ("with", 0.6287169),
        ("is", 0.7070283),
        ("singleton", 0.55278516),
    ],
    &[
        ("from", 0.29984832),
        ("node_name", 0.8217296),
    ...
    &[("node_name", 2.757867), ("has", 2.2262073)],
    &[("has", 2.2262073), ("node_type_id", 3.6703732)],
    &[("has", 2.2262073), ("node_type_name", 3.6703732)],
    &[("has", 2.2262073), ("edge_type_id", 2.8804178)],
    &[("has", 2.2262073), ("edge_type_name", 3.3243139)],
    &[
        ("from", 0.42197487),
        ("has", 0.93348235),
        ("edge", 0.85397613),
    ...
    &[
        ("and", 1.3380913),
        ("has", 0.93348235),
        ("node_type_name", 1.539043),
        ("node_name", 1.1564153),
    ],
    &[
        ("node_names", 0.9610256),
        ("has", 0.93348235),
        ("from", 0.42197487),
        ("edge", 0.85397613),
    ],
    &[
        ("node_names", 0.50779223),
        ("from", 0.2229655),
        ("has", 0.49323875),
        ("edge", 0.4512288),
        ("edge_type_name", 0.73653543),
        ("and", 0.7070283),
    ],
    &[
        ("connected", 2.176225),
        ("components", 2.6515694),
        ("strongly", 3.267904),
    ],
    &[
        ("outbound", 0.93964815),
    ...
    &[
        ...
        ("from", 0.2229655),
        ("bfs", 0.9896115),
        ("topological", 0.9896115),
    ],
    &[
        ("topological", 0.76264584),
        ("reversed", 0.8924621),
        ("bfs", 0.76264584),
        ("from", 0.17182876),
        ("sorting", 0.76264584),
    ...
    &[("components", 4.2410526), ("remove", 2.9252927)],
    &[("overlaps", 8.912064)],
    &[("contains", 8.130519)],
    &[
        ("edges", 1.8896458),
    ...
    &[("encode", 5.226849), ("edge", 2.0365975)],
    &[("decode", 5.226849), ("edge", 2.0365975)],
    &[
        ("number", 0.7114344),
        ("max", 1.5573834),
        ("get", 0.103064746),
    ...
    &[("node_id", 1.986734), ("validate", 3.6703732)],
    &[("node_ids", 1.7346773), ("validate", 3.6703732)],
    &[("edge_id", 2.5847726), ("validate", 3.6703732)],
    &[("validate", 3.6703732), ("edge_ids", 3.570569)],
    &[
        ("not", 1.1653417),
        ("must", 1.0128001),
        ("contain", 1.2636571),
        ("unknown", 0.88569033),
        ("node_types", 0.7114344),
    ],
    &[
        ("must", 1.0128001),
        ("edge_types", 0.72693795),
        ("unknown", 0.88569033),
        ("not", 1.1653417),
        ("contain", 1.2636571),
    ],
    &[("validate", 3.6703732), ("node_type_id", 3.6703732)],
    &[("validate", 3.6703732), ("node_type_ids", 3.480763)],
    &[("edge_type_id", 2.8804178), ("validate", 3.6703732)],
    &[("validate", 3.6703732), ("edge_type_ids", 3.9110892)],
    &[
        ("must", 2.1251886),
        ("be", 2.6515694),
        ("undirected", 2.5389907),
    ],
    &[
        ("trap", 1.1653417),
        ("not", 1.1653417),
    ...
    &[
        ("set", 2.5389907),
        ("edge_types", 1.5253556),
        ("all", 2.36499),
    ],
    &[
        ("node_types", 1.0011977),
        ("inplace", 1.3380913),
        ("set", 1.7028339),
        ("all", 1.5861363),
    ],
    &[
        ("set", 2.5389907),
        ("all", 2.36499),
        ("node_types", 1.4928241),
    ],
    &[
        ("node_type_ids", 2.176225),
        ("remove", 1.8289366),
        ("inplace", 1.9951453),
    ],
    &[
    ...
    &[
        ("remove", 1.8289366),
        ("inplace", 1.9951453),
        ("node_type_name", 2.2947721),
    ],
    &[("remove", 2.9252927), ("node_type_id", 3.6703732)],
    &[
        ("remove", 1.8289366),
        ("singleton", 1.5598904),
        ("node_types", 1.4928241),
    ],
    &[("remove", 2.9252927), ("node_type_name", 3.6703732)],
    &[
        ("inplace", 1.9951453),
        ("edge_type_name", 2.0784106),
        ("remove", 1.8289366),
    ],
    &[("remove", 2.9252927), ("edge_type_id", 2.8804178)],
    &[
        ("singleton", 1.5598904),
        ("edge_types", 1.5253556),
        ("remove", 1.8289366),
    ],
    &[("edge_type_name", 3.3243139), ("remove", 2.9252927)],
    &[
        ("node_types", 1.4928241),
        ("inplace", 1.9951453),
        ("remove", 1.8289366),
    ],
    &[("remove", 2.9252927), ("node_types", 2.3876975)],
    &[
        ("inplace", 1.9951453),
        ("edge_types", 1.5253556),
        ("remove", 1.8289366),
    ],
    &[("edge_types", 2.4397302), ("remove", 2.9252927)],
    &[
        ("edge", 0.85397613),
        ("weights", 1.3380913),
        ("remove", 1.2266195),
    ...
    &[("circles", 5.226849), ("get", 0.3459032)],
    &[
        ("stats", 3.267904),
        ("memory", 2.0784106),
        ("get", 0.21626383),
    ...
    &[
        ...
        ("weights", 0.43206242),
        ("get", 0.046833422),
        ("requirements", 0.5295403),
        ("edge", 0.2757443),
    ],
    &[
        ("requirements", 1.1653417),
        ("get", 0.103064746),
        ("total", 0.9905071),
        ("node_types", 0.7114344),
        ("memory", 0.9905071),
    ...
    &[
        ("node_types", 0.40768912),
        ("memory", 0.56761235),
        ("requirements", 0.6678017),
        ("human", 0.6933964),
        ("get", 0.059061486),
        ("total", 0.56761235),
        ("readable", 0.6933964),
    ...
    &[("get", 0.3459032), ("transitivity", 5.226849)],
    &[
        ("per", 1.056505),
        ("number", 0.5290186),
        ("triangles", 1.056505),
    ...
    &[
        ("node", 0.59682524),
        ("coefficient", 1.1653417),
        ("per", 1.4208084),
        ("clustering", 1.3308487),
        ("get", 0.103064746),
    ],
    &[
        ("coefficient", 2.4452713),
        ("clustering", 2.7925596),
        ("get", 0.21626383),
    ],
    &[
        ("coefficient", 1.6399788),
        ("get", 0.14504243),
        ("average", 2.191697),
        ("clustering", 1.872896),
    ],
    ...
    &[("sample", 5.226849), ("negatives", 5.226849)],
    &[("holdout", 3.6703732), ("connected", 3.480763)],
    &[("holdout", 3.6703732), ("random", 3.3243139)],
    &[
        ("indices", 1.5573834),
        ("holdout", 1.0936184),
        ("get", 0.103064746),
    ...
    &[("chains", 5.226849), ("get", 0.3459032)],
    &[
        ("node_id", 0.21830042),
        ("unchecked", 0.19612196),
        ("search", 0.3923307),
        ("first", 0.3923307),
        ("from", 0.11057601),
        ("breadth", 0.3923307),
        ("parallel", 0.44621754),
        ("predecessors", 0.57432115),
        ("get", 0.03800751),
    ],
    &[
        ("parallel", 0.44621754),
    ...
    &[
        ...
        ("most", 0.5742156),
        ("distant", 0.64562637),
        ("eccentricity", 0.5295403),
    ],
    &[
        ("get", 0.103064746),
        ("weighted", 0.67620444),
        ("eccentricity", 1.1653417),
        ("from", 0.29984832),
        ("node_id", 0.591964),
    ],
    &[
        ("from", 0.42197487),
        ("eccentricity", 1.6399788),
        ("get", 0.14504243),
        ("node_name", 1.1564153),
    ],
    &[
    ...
    &[("get", 0.3459032), ("diameter", 4.4665594)],
    &[
        ("diameter", 1.872896),
        ("get", 0.14504243),
        ("naive", 1.9994956),
    ...
    &[
        ...
        ("get", 0.103064746),
        ("selfloops", 0.9905071),
        ("node_names", 0.68288887),
        ("with", 0.84551066),
    ],
    &[("density", 5.226849), ("get", 0.3459032)],
    &[
        ("nodes", 1.0119486),
        ("trap", 1.6399788),
        ("rate", 1.6399788),
    ...
    &[
        ("undirected", 1.7028339),
        ("number", 1.0011977),
        ("edges", 1.2673354),
        ("get", 0.14504243),
    ],
    &[
        ("undirected", 1.2100055),
        ("unique", 1.0371224),
        ("number", 0.7114344),
        ("get", 0.103064746),
        ("edges", 0.90054756),
    ...
    &[("source_names", 5.226849), ("get", 0.3459032)],
    &[
        ("get", 0.21626383),
        ("node_ids", 1.0845461),
        ("destination", 2.4452713),
    ],
    &[
        ("destination", 1.6399788),
        ("directed", 1.4595366),
        ("node_ids", 0.7273764),
        ("get", 0.14504243),
    ],
    &[("get", 0.3459032), ("destination_names", 5.226849)],
    &[("get", 0.3459032), ("node_names", 2.2918935)],
    &[("get", 0.21626383), ("urls", 3.267904), ("node", 1.2523363)],
    &[
        ("get", 0.21626383),
        ("ontologies", 3.267904),
        ("node", 1.2523363),
    ],
    &[("get", 0.3459032), ("node_ids", 1.7346773)],
    &[("edge_type_ids", 3.9110892), ("get", 0.3459032)],
    &[
        ("get", 0.21626383),
        ("unique", 2.176225),
        ("edge_type_ids", 2.4452713),
    ],
    &[("get", 0.3459032), ("edge_type_names", 4.060989)],
    &[
        ("unique", 2.176225),
        ("get", 0.21626383),
        ("edge_type_names", 2.5389907),
    ],
    &[
        ("weights", 1.9951453),
        ("edge", 1.2733111),
    ...
    &[("get", 0.3459032), ("node_type_ids", 3.480763)],
    &[
        ("node_types", 1.0011977),
        ("known", 1.2894745),
        ("mask", 1.6399788),
    ...
    &[("node_type_names", 3.480763), ("get", 0.3459032)],
    &[
        ("unique", 2.176225),
        ("get", 0.21626383),
        ("node_type_ids", 2.176225),
    ...
    &[
        ...
        ("counts", 1.7783375),
        ("get", 0.14504243),
        ("edge_type_id", 1.2078027),
    ],
    &[
        ("edge_type_names", 1.7028339),
        ("counts", 1.7783375),
        ("hashmap", 1.7783375),
        ("get", 0.14504243),
    ],
    &[
        ...
        ("get", 0.14504243),
        ("counts", 1.7783375),
        ("node_type_id", 1.539043),
    ],
    &[
        ("get", 0.14504243),
        ("counts", 1.7783375),
        ("node_type_names", 1.4595366),
        ("hashmap", 1.7783375),
    ],
    &[
        ("inplace", 1.9951453),
    ...
    &[("to", 3.3991332), ("directed", 3.480763)],
    &[
        ("upper", 3.267904),
        ("to", 2.1251886),
        ("triangular", 2.9813247),
    ],
    &[
        ("to", 2.1251886),
        ("triangular", 2.9813247),
    ...
    &[("bidiagonal", 5.226849), ("to", 3.3991332)],
    &[("to", 3.3991332), ("arrowhead", 5.226849)],
    &[("transposed", 5.226849), ("to", 3.3991332)],
    &[("complementary", 5.226849), ("to", 3.3991332)],
    &[("report", 6.9242077)],
    &[
        ("report", 2.5389907),
        ("textual", 2.9813247),
    ...
    &[("textual", 4.76848), ("report", 4.060989)],
    &[
        ("generate", 1.4253079),
        ("random", 1.3939351),
        ("connected", 1.4595366),
    ...
    &[("replace", 8.912064)],
    &[("from_ids", 5.226849), ("filter", 4.76848)],
    &[("filter", 4.76848), ("from_names", 5.226849)],
    &[
        ("unknown", 1.8584704),
        ("node_types", 1.4928241),
        ("drop", 2.36499),
    ...
    &[
        ("drop", 2.36499),
        ("disconnected", 2.6515694),
        ("nodes", 1.508854),
    ],
    &[("drop", 3.7826834), ("selfloops", 3.3243139)],
    &[
        ("parallel", 2.5389907),
        ("edges", 1.8896458),
        ("drop", 2.36499),
    ...
    &[
        ("arborescence", 1.9994956),
        ("spanning", 1.872896),
        ("kruskal", 1.9994956),
        ("random", 1.3939351),
    ],
    &[
        ("arborescence", 2.9813247),
        ("spanning", 2.7925596),
        ("kruskal", 2.9813247),
    ],
    &[
    ...
    &[("enable", 8.912064)],
    &[("compatible", 5.226849), ("is", 3.1911352)],
    &[
        ("matrix", 1.6399788),
        ("adjacency", 1.872896),
        ("has", 0.93348235),
    ...
    &[("nodes", 2.4133368), ("has", 2.2262073)],
    &[("has", 2.2262073), ("edges", 3.022394)],
    &[("trap", 2.4452713), ("has", 1.391858), ("nodes", 1.508854)],
    &[("directed", 3.480763), ("is", 3.1911352)],
    &[
        ("weights", 1.9951453),
        ("has", 1.391858),
        ("edge", 1.2733111),
    ...
    &[
        ("edge", 0.60682124),
        ("probabilities", 1.5573834),
        ("representing", 1.5573834),
        ("has", 0.663317),
        ("weights", 0.9508254),
    ],
    &[
    ...
    &[("has", 2.2262073), ("edge_types", 2.4397302)],
    &[("has", 2.2262073), ("selfloops", 3.3243139)],
    &[
        ("nodes", 1.508854),
        ("disconnected", 2.6515694),
        ("has", 1.391858),
    ...
    &[("connected", 3.480763), ("is", 3.1911352)],
    &[("has", 2.2262073), ("node_types", 2.3876975)],
    &[
        ("node_types", 1.4928241),
        ("has", 1.391858),
        ("multilabel", 2.9813247),
    ],
    &[
        ("has", 1.391858),
        ("node_types", 1.4928241),
    ...
    &[("multigraph", 4.4665594), ("is", 3.1911352)],
    &[
        ("by", 0.5121549),
        ("outbound", 0.5742156),
        ("degree", 0.37868336),
        ...
        ("has", 0.30141643),
        ("sorted", 0.60474795),
        ("decreasing", 0.64562637),
        ("nodes", 0.32675272),
    ],
    &[
        ("lexicographic", 1.056505),
        ("sorted", 0.9896115),
        ("order", 1.056505),
        ("nodes", 0.5346992),
        ("by", 0.8380918),
    ...
    &[
        ("from", 0.29984832),
        ("get", 0.103064746),
        ("edge_type_name", 0.9905071),
        ("unchecked", 0.5318228),
        ("edge_type_id", 0.85824454),
    ],
    &[
        ("edge_type_id", 0.85824454),
        ("from", 0.29984832),
    ...
    &[
        ("and", 0.561776),
        ("unchecked", 0.16223383),
        ("from", 0.09146946),
        ("edge_type_id", 0.2618096),
        ("get", 0.03144015),
        ("node_ids", 0.15766989),
        ("weight", 0.30895713),
        ("edge_id", 0.23493753),
    ...
    &[
        ...
        ("get", 0.103064746),
        ("from", 0.29984832),
        ("node_type_id", 1.0936184),
        ("unchecked", 0.5318228),
    ],
    &[
        ("from", 0.42197487),
        ("get", 0.14504243),
        ("node_type_ids", 1.4595366),
        ("node_id", 0.8330676),
    ],
    &[
        ("edge_id", 0.7701546),
    ...
    &[("selfloops", 3.3243139), ("add", 5.226849)],
    &[
        ("degree", 1.7486553),
        ("get", 0.21626383),
        ("centrality", 1.8584704),
    ],
    &[
        ("centrality", 1.2464269),
        ("weighted", 0.95161873),
        ("get", 0.14504243),
        ("degree", 1.1727769),
    ],
    &[
        ("centrality", 0.65859425),
        ("unchecked", 0.39546037),
        ("closeness", 0.93964815),
        ("from", 0.2229655),
        ("node_id", 0.44018105),
        ("get", 0.076638356),
    ],
    &[
        ("node_id", 0.3392263),
        ("weighted", 0.3875005),
        ("closeness", 0.72414154),
        ("get", 0.059061486),
        ("centrality", 0.50754684),
        ("unchecked", 0.30476224),
        ("from", 0.17182876),
    ],
    &[
    ...
    &[
        ("get", 0.21626383),
        ("betweenness", 2.5389907),
        ("centrality", 1.8584704),
    ],
    &[
        ("get", 0.076638356),
        ("from", 0.2229655),
        ("betweenness", 0.89975315),
        ("approximated", 0.89975315),
        ("centrality", 0.65859425),
        ("node_id", 0.44018105),
    ],
    &[
    ...
    &[
        ...
        ("weighted", 0.3875005),
        ("from", 0.17182876),
        ("betweenness", 0.6933964),
        ("approximated", 0.6933964),
        ("node_id", 0.3392263),
    ],
    &[
        ("betweenness", 0.6933964),
        ...
        ("weighted", 0.3875005),
        ("centrality", 0.50754684),
        ("node_name", 0.47089398),
    ],
    &[
        ("centrality", 1.8584704),
        ("eigenvector", 2.9813247),
        ("get", 0.21626383),
    ],
    &[
        ("get", 0.14504243),
        ("weighted", 0.95161873),
        ("centrality", 1.2464269),
        ("eigenvector", 1.9994956),
    ],
    &[("dot", 5.226849), ("to", 3.3991332)],
    &[("stars", 5.226849), ("get", 0.3459032)],
    &[
        ("get", 0.103064746),
        ("louvain", 1.5573834),
        ("community", 1.3308487),
    ...
    &[
        ...
        ("from", 0.17182876),
        ("get", 0.059061486),
        ("modularity", 0.8141975),
        ("directed", 0.59432536),
        ("memberships", 0.8141975),
        ("community", 0.76264584),
    ],
    &[
        ("community", 0.76264584),
        ("memberships", 0.8141975),
        ("modularity", 0.8141975),
        ("undirected", 0.6933964),
        ("from", 0.17182876),
        ("node", 0.34201205),
        ("get", 0.059061486),
    ],
    &[
        ("get", 0.103064746),
        ("preferential", 1.0371224),
        ("unchecked", 0.5318228),
        ("minimum", 1.1270821),
        ("attachment", 1.0371224),
    ],
    &[
        ("get", 0.103064746),
        ("maximum", 1.0936184),
    ...
    &[
        ("unchecked", 0.39546037),
        ("minimum", 0.8380918),
        ("preferential", 0.7711983),
        ("weighted", 0.50282174),
        ("attachment", 0.7711983),
        ("get", 0.076638356),
    ],
    &[
        ("get", 0.076638356),
    ...
    &[
        ("weighted", 0.3875005),
        ("attachment", 0.59432536),
        ("node_ids", 0.2961887),
        ("preferential", 0.59432536),
        ("unchecked", 0.30476224),
        ("get", 0.059061486),
        ("from", 0.17182876),
    ],
