...
impl Graph {
    #[args(py_kwargs = "**")]
    #[pyo3(text_signature = "($self, path, *, verbose, separator, header, sources_column_number, sources_column, destinations_column_number, destinations_column, weights_column_number, weights_column, edge_types_column_number, edge_type_column, numeric_node_ids, directed)")]
