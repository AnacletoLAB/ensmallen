...
impl Graph {
    #[args(py_kwargs = "**")]
    #[pyo3(text_signature = "($self, walk_length, quantity, *, return_weight, explore_weight, change_edge_type_weight, change_node_type_weight, random_state, iterations, dense_node_mapping, max_neighbours, normalize_by_degree)")]
    ...
    #[args(py_kwargs = "**")]
    #[pyo3(text_signature = "($self, *, walk_length, return_weight, explore_weight, change_edge_type_weight, change_node_type_weight, random_state, iterations, dense_node_mapping, max_neighbours, normalize_by_degree)")]
