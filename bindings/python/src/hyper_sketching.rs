...
#[derive(Clone)]
#[pyo3(
    text_signature = "(*, unbiased=False, exact=False, number_of_hops=2, precision=6, bits=5, include_node_types=False, include_edge_types=False, include_edge_ids=False, include_node_ids=True, include_selfloops=True, include_typed_graphlets=False, normalize=False, dtype=str)"
)]
