...
/// Arguments
/// ------------
/// * `matrix`: np.ndarray - 2D Matrix containing the feaures.
/// * `sources`: np.ndarray - Indices of the source features.
/// * `destinations`: np.ndarray - Indices of the destination features.
///
