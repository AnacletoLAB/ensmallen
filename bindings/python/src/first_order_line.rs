...
pub struct FirstOrderLINE {
    pub inner: cpu_models::FirstOrderLINE,
}

impl From<cpu_models::FirstOrderLINE> for FirstOrderLINE {
    fn from(val: cpu_models::FirstOrderLINE) -> FirstOrderLINE {
        FirstOrderLINE { inner: val }
    }
}

impl From<FirstOrderLINE> for cpu_models::FirstOrderLINE {
    fn from(val: FirstOrderLINE) -> cpu_models::FirstOrderLINE {
        val.inner
    }
}
...
impl FirstOrderLINE {
    #[new]
    #[args(py_kwargs = "**")]
    /// Return a new instance of the first-order LINE model.
    ///
    /// Parameters
    /// ------------------------
    ...
    pub fn new(py_kwargs: Option<&PyDict>) -> PyResult<FirstOrderLINE> {
        ...
        Ok(Self {
            inner: pe!(cpu_models::FirstOrderLINE::new(
