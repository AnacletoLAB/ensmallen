...
#[derive(Arbitrary, Debug, Clone)]
pub struct Get_filtered_neighbours_range_Params {
	pub src : NodeT,
	pub node_names : Option<Vec<String>>,
	pub node_types : Option<Vec<Option<String>>>,
	pub edge_types : Option<Vec<Option<String>>>,
...
#[derive(Arbitrary, Debug, Clone)]
pub struct Get_unchecked_edge_type_Params {
	pub edge_id : EdgeT,
}


#[derive(Arbitrary, Debug, Clone)]
pub struct Get_unchecked_edge_weight_Params {
	pub edge_id : EdgeT,
}


#[derive(Arbitrary, Debug, Clone)]
pub struct Get_unchecked_node_type_Params {
	pub node_id : NodeT,
}
...
#[derive(Arbitrary, Debug, Clone)]
pub struct Get_unchecked_edge_count_by_edge_type_Params {
...
#[derive(Arbitrary, Debug, Clone)]
pub struct Get_unchecked_node_count_by_node_type_Params {
...
#[derive(Arbitrary, Debug, Clone)]
pub struct Get_destinations_range_Params {
	pub min_edge_id : EdgeT,
	pub max_edge_id : EdgeT,
}


#[derive(Arbitrary, Debug, Clone)]
pub struct Get_neighbours_iter_Params {
	pub src : NodeT,
}


#[derive(Arbitrary, Debug, Clone)]
pub struct Get_unchecked_edge_id_Params {
	pub src : NodeT,
	pub dst : NodeT,
	pub edge_type : Option<EdgeTypeT>,
}
...
#[derive(Arbitrary, Debug, Clone)]
pub struct Get_unchecked_edge_ids_range_Params {
	pub src : NodeT,
	pub dst : NodeT,
}
...
#[derive(Arbitrary, Debug, Clone)]
pub struct Get_unchecked_destinations_range_Params {
	pub src : NodeT,
}
...
pub struct TheUltimateFuzzer {
	...
	pub get_filtered_neighbours_range : Get_filtered_neighbours_range_Params,
	...
	pub get_unchecked_edge_type : Get_unchecked_edge_type_Params,
	pub get_unchecked_edge_weight : Get_unchecked_edge_weight_Params,
	pub get_unchecked_node_type : Get_unchecked_node_type_Params,
	...
	pub get_unchecked_edge_count_by_edge_type : Get_unchecked_edge_count_by_edge_type_Params,
	pub get_edge_count_by_edge_type : Get_edge_count_by_edge_type_Params,
	pub get_unchecked_node_count_by_node_type : Get_unchecked_node_count_by_node_type_Params,
	pub get_node_count_by_node_type : Get_node_count_by_node_type_Params,
	pub get_destination : Get_destination_Params,
	pub get_destinations_range : Get_destinations_range_Params,
	pub get_neighbours_iter : Get_neighbours_iter_Params,
	pub get_unchecked_edge_id : Get_unchecked_edge_id_Params,
	pub get_edge_id : Get_edge_id_Params,
	...
	pub get_unchecked_edge_ids_range : Get_unchecked_edge_ids_range_Params,
	pub get_unchecked_destinations_range : Get_unchecked_destinations_range_Params,
...
pub fn mega_test(data: TheUltimateFuzzer) -> Result<(), String> {
	...
	graph.get_unchecked_edge_count_by_edge_type(data.get_unchecked_edge_count_by_edge_type.edge_type);
