...
pub struct MetaParams {
    ...
    pub getunweightedpreferentialattachmentfromnodeids:
        GetUnweightedPreferentialAttachmentFromNodeIds,
    ...
    pub getunweightedresourceallocationindexfromnodeids:
        GetUnweightedResourceAllocationIndexFromNodeIds,
    pub getweightedresourceallocationindexfromnodeids:
        GetWeightedResourceAllocationIndexFromNodeIds,
    pub enable: Enable,
    ...
    pub iteredgenodenamesandedgetypenamefromedgetypeid:
        IterEdgeNodeNamesAndEdgeTypeNameFromEdgeTypeId,
    ...
    pub getnodeidsandedgetypeidandedgeweightfromedgeid:
        GetNodeIdsAndEdgeTypeIdAndEdgeWeightFromEdgeId,
    ...
    pub pariteredgenodenamesandedgetypenameandedgeweight:
        ParIterEdgeNodeNamesAndEdgeTypeNameAndEdgeWeight,
    pub iteredgenodenamesandedgetypenameandedgeweight:
        IterEdgeNodeNamesAndEdgeTypeNameAndEdgeWeight,
    ...
    pub getunweightedrandomwalknormalizedlaplaciantransformedgraph:
        GetUnweightedRandomWalkNormalizedLaplacianTransformedGraph,
    pub getunweightedsymmetricnormalizedlaplaciantransformedgraph:
        GetUnweightedSymmetricNormalizedLaplacianTransformedGraph,
    pub getunweightedsymmetricnormalizedtransformedgraph:
    ...
    pub getweightedsymmetricnormalizedlaplaciantransformedgraph:
        GetWeightedSymmetricNormalizedLaplacianTransformedGraph,
    pub getweightedsymmetricnormalizedtransformedgraph:
        GetWeightedSymmetricNormalizedTransformedGraph,
    pub getweightedrandomwalknormalizedlaplaciantransformedgraph:
        GetWeightedRandomWalkNormalizedLaplacianTransformedGraph,
...
pub fn meta_test_harness_with_panic_handling(data: MetaParams) -> Result<(), String> {
    ...
    for _ in 0..10 {
        ...
        match rng.next() % 391 {
            0 => {
                trace.push(format!(
                    "spanning_arborescence_kruskal(verbose: {:?})",
                    &data.spanningarborescencekruskal.verbose
                ));
                ...
                std::panic::set_hook(Box::new(move |info| {
                    handle_panics_meta_test_once_loaded(
                        Some(info),
                        data_for_panic_handler.clone(),
                        g_copy.clone(),
                        Some(trace2.clone()),
                    );
                }));
                let _ = graph.spanning_arborescence_kruskal(
                    data.spanningarborescencekruskal.verbose.clone(),
                );
            }
            ...
            1 => {
                trace.push(format!(
                    ...
                    &data.spanningarborescence.verbose
                ));
            ...
            2 => {
                trace.push(format!(
                    "connected_components(verbose: {:?})",
                    &data.connectedcomponents.verbose
                ));
            ...
            3 => {
                ...
                let _ = graph.get_node_label_prediction_tuple_from_node_ids(
                    data.getnodelabelpredictiontuplefromnodeids.node_ids.clone(),
                    data.getnodelabelpredictiontuplefromnodeids
                        .random_state
                        .clone(),
                    data.getnodelabelpredictiontuplefromnodeids
                    ...
                    data.getnodelabelpredictiontuplefromnodeids
                        .return_edge_weights
                        .clone(),
                    data.getnodelabelpredictiontuplefromnodeids.offset.clone(),
                    data.getnodelabelpredictiontuplefromnodeids
                        .max_neighbours
                        .clone(),
                );
            ...
            4 => {
                trace.push(format!(
                    ...
                    &data.pariteredgepredictionmetrics.normalize,
                    &data.pariteredgepredictionmetrics.verbose
                ));
                ...
                let _ = graph
                    .par_iter_edge_prediction_metrics(
                        data.pariteredgepredictionmetrics.normalize.clone(),
                        data.pariteredgepredictionmetrics.verbose.clone(),
                    )
                    .collect::<Vec<_>>();
            }
            ...
            5 => {
                ...
                let _ = graph.get_okapi_bm25_node_feature_propagation(
                    data.getokapibm25nodefeaturepropagation.features.clone(),
                    data.getokapibm25nodefeaturepropagation
                        .iterations
                        .map(|x| x as usize)
                        .clone(),
                    data.getokapibm25nodefeaturepropagation
                        .maximal_distance
                        .clone(),
                    data.getokapibm25nodefeaturepropagation.k1.clone(),
                    data.getokapibm25nodefeaturepropagation.b.clone(),
                    data.getokapibm25nodefeaturepropagation
                        .include_central_node
                        .clone(),
                    data.getokapibm25nodefeaturepropagation.verbose.clone(),
                );
            }
            ...
            6 => {
                ...
                let _ = graph.get_okapi_bm25_node_label_propagation(
                    data.getokapibm25nodelabelpropagation
                        .iterations
                        .map(|x| x as usize)
                        .clone(),
                    data.getokapibm25nodelabelpropagation
                        .maximal_distance
                        .clone(),
                    data.getokapibm25nodelabelpropagation.k1.clone(),
                    data.getokapibm25nodelabelpropagation.b.clone(),
                    data.getokapibm25nodelabelpropagation.verbose.clone(),
                );
            }

            7 => {
                trace.push(format!(
                    "sort_by_increasing_outbound_node_degree(verbose: {:?})",
                    &data.sortbyincreasingoutboundnodedegree.verbose
                ));
                ...
                graph = graph.sort_by_increasing_outbound_node_degree(
                    data.sortbyincreasingoutboundnodedegree.verbose.clone(),
                );
            }

            8 => {
                trace.push(format!(
                    "sort_by_decreasing_outbound_node_degree(verbose: {:?})",
                    &data.sortbydecreasingoutboundnodedegree.verbose
                ));
                ...
                graph = graph.sort_by_decreasing_outbound_node_degree(
                    data.sortbydecreasingoutboundnodedegree.verbose.clone(),
                );
            }

            9 => {
                trace.push(format!(
                    "to_dot(use_node_names: {:?})",
                    &data.todot.use_node_names
                ));
            ...
            10 => {
                trace.push(format!(
                    "remap_from_node_ids(node_ids: {:?}, verbose: {:?})",
                    &data.remapfromnodeids.node_ids, &data.remapfromnodeids.verbose
                ));
                ...
                if let Ok(res) = graph.remap_from_node_ids(
                    data.remapfromnodeids.node_ids.clone(),
                    data.remapfromnodeids.verbose.clone(),
                ) {
                    graph = res;
                }
            }
            ...
            11 => {
                trace.push(format!(
                    "is_singleton_from_node_id(node_id: {:?})",
                    &data.issingletonfromnodeid.node_id
                ));
            ...
            12 => {
                trace.push(format!(
                    ...
                    &data.issingletonwithselfloopsfromnodeid.node_id
                ));
                ...
                let _ = graph.is_singleton_with_selfloops_from_node_id(
                    data.issingletonwithselfloopsfromnodeid.node_id.clone(),
                );
            }

            13 => {
                trace.push(format!(
                    "has_node_type_id(node_type_id: {:?})",
                    &data.hasnodetypeid.node_type_id
                ));
            ...
            14 => {
                trace.push(format!(
                    "has_edge_type_id(edge_type_id: {:?})",
                    &data.hasedgetypeid.edge_type_id
                ));
            ...
            15 => {
                trace.push(format!(
                    ...
                    &data.hasedgefromnodeids.src, &data.hasedgefromnodeids.dst
                ));
                ...
                let _ = graph.has_edge_from_node_ids(
                    data.hasedgefromnodeids.src.clone(),
                    data.hasedgefromnodeids.dst.clone(),
                );
            }

            16 => {
                trace.push(format!(
                    "has_selfloop_from_node_id(node_id: {:?})",
                    &data.hasselfloopfromnodeid.node_id
                ));
            ...
            17 => {
                ...
                let _ = graph.has_edge_from_node_ids_and_edge_type_id(
                    data.hasedgefromnodeidsandedgetypeid.src.clone(),
                    data.hasedgefromnodeidsandedgetypeid.dst.clone(),
                    data.hasedgefromnodeidsandedgetypeid.edge_type.clone(),
                );
            }

            18 => {
                trace.push(format!(
                    "is_trap_node_from_node_id(node_id: {:?})",
                    &data.istrapnodefromnodeid.node_id
                ));
            ...
            20 => {
                ...
                let _ = graph.get_weighted_preferential_attachment_from_node_ids(
                    data.getweightedpreferentialattachmentfromnodeids
                        .source_node_id
                        .clone(),
                    data.getweightedpreferentialattachmentfromnodeids
                        .destination_node_id
            ...
            21 => {
                ...
                let _ = graph.get_jaccard_coefficient_from_node_ids(
                    data.getjaccardcoefficientfromnodeids.source_node_id.clone(),
                    data.getjaccardcoefficientfromnodeids
                        .destination_node_id
                        .clone(),
                );
            }
            ...
            22 => {
                ...
                let _ = graph.get_adamic_adar_index_from_node_ids(
                    data.getadamicadarindexfromnodeids.source_node_id.clone(),
                    data.getadamicadarindexfromnodeids
                        .destination_node_id
                        .clone(),
                );
            }
            ...
            24 => {
                ...
                let _ = graph.get_weighted_resource_allocation_index_from_node_ids(
                    data.getweightedresourceallocationindexfromnodeids
                        .source_node_id
                        .clone(),
                    data.getweightedresourceallocationindexfromnodeids
                        .destination_node_id
            ...
            25 => {
                ...
                let _ = graph.enable(
                    data.enable.vector_sources.clone(),
                    data.enable.vector_destinations.clone(),
                    data.enable.vector_cumulative_node_degrees.clone(),
                );
            }
            ...
            31 => {
                ...
                let _ = graph.get_unweighted_number_of_triangles_per_node(
                    ...
                    data.getunweightednumberoftrianglespernode
                        .low_centrality
                        .clone(),
                    data.getunweightednumberoftrianglespernode.verbose.clone(),
                );
            }

            32 => {
                trace.push(format!(
                    "iter_clustering_coefficient_per_node(low_centrality: {:?}, verbose: {:?})",
                    &data.iterclusteringcoefficientpernode.low_centrality,
                    &data.iterclusteringcoefficientpernode.verbose
                ));
                ...
                let _ = graph
                    .iter_clustering_coefficient_per_node(
                        data.iterclusteringcoefficientpernode.low_centrality.clone(),
                        data.iterclusteringcoefficientpernode.verbose.clone(),
                    )
                    .collect::<Vec<_>>();
            }
            ...
            33 => {
                trace.push(format!(
                    ...
                    &data.getclusteringcoefficientpernode.low_centrality,
                    &data.getclusteringcoefficientpernode.verbose
                ));
                ...
                let _ = graph.get_clustering_coefficient_per_node(
                    data.getclusteringcoefficientpernode.low_centrality.clone(),
                    data.getclusteringcoefficientpernode.verbose.clone(),
                );
            }
            ...
            34 => {
                trace.push(format!(
                    ...
                    &data.getclusteringcoefficient.low_centrality,
                    &data.getclusteringcoefficient.verbose
                ));
                ...
                let _ = graph.get_clustering_coefficient(
                    data.getclusteringcoefficient.low_centrality.clone(),
                    data.getclusteringcoefficient.verbose.clone(),
                );
            }
            ...
            35 => {
                trace.push(format!(
                    ...
                    &data.getaverageclusteringcoefficient.low_centrality,
                    &data.getaverageclusteringcoefficient.verbose
                ));
                ...
                let _ = graph.get_average_clustering_coefficient(
                    data.getaverageclusteringcoefficient.low_centrality.clone(),
                    data.getaverageclusteringcoefficient.verbose.clone(),
                );
            }
            ...
            37 => {
                ...
                let _ = graph.get_unweighted_k_shortest_path_node_ids_from_node_ids(
                    ...
                    data.getunweightedkshortestpathnodeidsfromnodeids
                        .dst_node_id
                        .clone(),
                    (data.getunweightedkshortestpathnodeidsfromnodeids.k as usize).clone(),
                );
            }
            ...
            39 => {
                ...
                let _ = graph.get_weighted_eccentricity_from_node_id(
                    data.getweightedeccentricityfromnodeid.node_id.clone(),
                    data.getweightedeccentricityfromnodeid
            ...
            40 => {
                ...
                let _ = graph.get_weighted_minimum_path_node_ids_from_node_ids(
                    data.getweightedminimumpathnodeidsfromnodeids
                        .src_node_id
                        .clone(),
                    data.getweightedminimumpathnodeidsfromnodeids
            ...
            41 => {
                ...
                let _ = graph.get_breath_first_search_from_node_ids(
                    data.getbreathfirstsearchfromnodeids.src_node_id.clone(),
                    data.getbreathfirstsearchfromnodeids
                        .maybe_dst_node_id
                        .clone(),
                    data.getbreathfirstsearchfromnodeids
                        .maybe_dst_node_ids
                    ...
                    data.getbreathfirstsearchfromnodeids
                        ...
                        .clone(),
                    data.getbreathfirstsearchfromnodeids.compute_visited.clone(),
                    data.getbreathfirstsearchfromnodeids.maximal_depth.clone(),
                );
            }
            ...
            42 => {
                ...
                let _ = graph.get_dijkstra_from_node_ids(
                    data.getdijkstrafromnodeids.src_node_id.clone(),
                    data.getdijkstrafromnodeids.maybe_dst_node_id.clone(),
                    data.getdijkstrafromnodeids.maybe_dst_node_ids.clone(),
                    data.getdijkstrafromnodeids.compute_predecessors.clone(),
                    data.getdijkstrafromnodeids.maximal_depth.clone(),
                    data.getdijkstrafromnodeids
                        .use_edge_weights_as_probabilities
                        .clone(),
                );
            }
            ...
            44 => {
                ...
                let _ = graph.get_weighted_diameter(
                    data.getweighteddiameter.ignore_infinity.clone(),
                    data.getweighteddiameter
                        .use_edge_weights_as_probabilities
                        .clone(),
                    data.getweighteddiameter.verbose.clone(),
                );
            }

            45 => {
                trace.push(format!(
                    "iter_edge_ids_from_node_ids(src: {:?}, dst: {:?})",
                    &data.iteredgeidsfromnodeids.src, &data.iteredgeidsfromnodeids.dst
                ));
                ...
                let _ = graph
                    .iter_edge_ids_from_node_ids(
                        data.iteredgeidsfromnodeids.src.clone(),
                        data.iteredgeidsfromnodeids.dst.clone(),
                    )
            ...
            46 => {
                ...
                let _ = graph
                    .iter_edge_node_ids_and_edge_type_id_from_edge_type_id(
                        data.iteredgenodeidsandedgetypeidfromedgetypeid
                            .edge_type_id
                            .clone(),
                        data.iteredgenodeidsandedgetypeidfromedgetypeid
                            .directed
            ...
            47 => {
                trace.push(format!(
                    "iter_node_ids_and_node_type_ids_from_node_type_id(node_type_id: {:?})",
                    &data.iternodeidsandnodetypeidsfromnodetypeid.node_type_id
                ));
                ...
                let _ = graph
                    .iter_node_ids_and_node_type_ids_from_node_type_id(
                        data.iternodeidsandnodetypeidsfromnodetypeid
                            .node_type_id
                            .clone(),
                    )
                    .map(|x| x.collect::<Vec<_>>());
            ...
            48 => {
                trace.push(format!(
                    "iter_node_names_and_node_type_names_from_node_type_id(node_type_id: {:?})",
                    &data
                        .iternodenamesandnodetypenamesfromnodetypeid
                        .node_type_id
                ));
                ...
                let _ = graph.iter_node_names_and_node_type_names_from_node_type_id(
                    data.iternodenamesandnodetypenamesfromnodetypeid
                        .node_type_id
                        .clone(),
                );
            }
            ...
            49 => {
                ...
                let _ = graph.iter_edge_node_names_and_edge_type_name_from_edge_type_id(
                    data.iteredgenodenamesandedgetypenamefromedgetypeid
                        .edge_type_id
                        .clone(),
                    data.iteredgenodenamesandedgetypenamefromedgetypeid
                        .directed
            ...
            50 => {
                trace.push(format!(
                    ...
                    &data.gettransitiveclosure.iterations.map(|x| x as NodeT),
                    &data.gettransitiveclosure.verbose
                ));
                ...
                graph = graph.get_transitive_closure(
                    data.gettransitiveclosure
                        .iterations
                        .map(|x| x as NodeT)
                        .clone(),
                    data.gettransitiveclosure.verbose.clone(),
                );
            }
            ...
            51 => {
                trace.push(format!(
                    ...
                    &data
                        ...
                        .iterations
                        .map(|x| x as NodeT),
                    &data.getunweightedallshortestpaths.verbose
                ));
                ...
                graph = graph.get_unweighted_all_shortest_paths(
                    data.getunweightedallshortestpaths
                        ...
                        .map(|x| x as NodeT)
                        .clone(),
                    data.getunweightedallshortestpaths.verbose.clone(),
                );
            }
            ...
            52 => {
                ...
                if let Ok(res) = graph.get_weighted_all_shortest_paths(
                    data.getweightedallshortestpaths
                        .iterations
                        .map(|x| x as NodeT)
                        .clone(),
                    data.getweightedallshortestpaths
                        .use_edge_weights_as_probabilities
                        .clone(),
                    data.getweightedallshortestpaths.verbose.clone(),
                ) {
                    graph = res;
                }
            }
            ...
            54 => {
                trace.push(format!(
                    "get_source_node_id_from_edge_id(edge_id: {:?})",
                    &data.getsourcenodeidfromedgeid.edge_id
                ));
                ...
                let _ = graph.get_source_node_id_from_edge_id(
                    data.getsourcenodeidfromedgeid.edge_id.clone(),
                );
            }
            ...
            55 => {
                trace.push(format!(
                    ...
                    &data.getdestinationnodeidfromedgeid.edge_id
                ));
                ...
                let _ = graph.get_destination_node_id_from_edge_id(
                    data.getdestinationnodeidfromedgeid.edge_id.clone(),
                );
            }
            ...
            56 => {
                trace.push(format!(
                    ...
                    &data.getsourcenodenamefromedgeid.edge_id
                ));
                ...
                let _ = graph.get_source_node_name_from_edge_id(
                    data.getsourcenodenamefromedgeid.edge_id.clone(),
                );
            }
            ...
            57 => {
                trace.push(format!(
                    ...
                    &data.getdestinationnodenamefromedgeid.edge_id
                ));
                ...
                let _ = graph.get_destination_node_name_from_edge_id(
                    data.getdestinationnodenamefromedgeid.edge_id.clone(),
                );
            }

            58 => {
                trace.push(format!(
                    "get_node_names_from_edge_id(edge_id: {:?})",
                    &data.getnodenamesfromedgeid.edge_id
                ));
                ...
                let _ =
                    graph.get_node_names_from_edge_id(data.getnodenamesfromedgeid.edge_id.clone());
            }

            59 => {
                trace.push(format!(
                    "get_node_ids_from_edge_id(edge_id: {:?})",
                    &data.getnodeidsfromedgeid.edge_id
                ));
            ...
            60 => {
                trace.push(format!(
                    ...
                    &data.getedgeidfromnodeids.src, &data.getedgeidfromnodeids.dst
                ));
                ...
                let _ = graph.get_edge_id_from_node_ids(
                    data.getedgeidfromnodeids.src.clone(),
                    data.getedgeidfromnodeids.dst.clone(),
                );
            }
            ...
            61 => {
                trace.push(format!(
                    ...
                    &data.getnodeidsandedgetypeidfromedgeid.edge_id
                ));
                ...
                let _ = graph.get_node_ids_and_edge_type_id_from_edge_id(
                    data.getnodeidsandedgetypeidfromedgeid.edge_id.clone(),
                );
            }
            ...
            62 => {
                trace.push(format!(
                    ...
                    &data.getnodeidsandedgetypeidandedgeweightfromedgeid.edge_id
                ));
                ...
                let _ = graph.get_node_ids_and_edge_type_id_and_edge_weight_from_edge_id(
                    data.getnodeidsandedgetypeidandedgeweightfromedgeid
                        .edge_id
                        .clone(),
                );
            }
            ...
            64 => {
                trace.push(format!(
                    "get_weighted_top_k_central_node_ids(k: {:?})",
                    &data.getweightedtopkcentralnodeids.k
                ));
                ...
                let _ = graph.get_weighted_top_k_central_node_ids(
                    data.getweightedtopkcentralnodeids.k.clone(),
                );
            }
            ...
            66 => {
                trace.push(format!(
                    ...
                    &data.getweightednodedegreefromnodeid.node_id
                ));
                ...
                let _ = graph.get_weighted_node_degree_from_node_id(
                    data.getweightednodedegreefromnodeid.node_id.clone(),
                );
            }

            67 => {
                trace.push(format!(
                    "get_top_k_central_node_names(k: {:?})",
                    &data.gettopkcentralnodenames.k
                ));
            ...
            68 => {
                trace.push(format!(
                    ...
                    &data.getnodetypeidfromnodeid.node_id
                ));
                ...
                let _ = graph
                    .get_node_type_id_from_node_id(data.getnodetypeidfromnodeid.node_id.clone());
            }

            69 => {
                trace.push(format!(
                    "get_edge_type_id_from_edge_id(edge_id: {:?})",
                    &data.getedgetypeidfromedgeid.edge_id
                ));
                ...
                let _ = graph
                    .get_edge_type_id_from_edge_id(data.getedgetypeidfromedgeid.edge_id.clone());
            }

            70 => {
                trace.push(format!(
                    "get_node_type_names_from_node_id(node_id: {:?})",
                    &data.getnodetypenamesfromnodeid.node_id
                ));
                ...
                let _ = graph.get_node_type_names_from_node_id(
                    data.getnodetypenamesfromnodeid.node_id.clone(),
                );
            }

            71 => {
                trace.push(format!(
                    "get_edge_type_name_from_edge_id(edge_id: {:?})",
                    &data.getedgetypenamefromedgeid.edge_id
                ));
                ...
                let _ = graph.get_edge_type_name_from_edge_id(
                    data.getedgetypenamefromedgeid.edge_id.clone(),
                );
            }
            ...
            72 => {
                trace.push(format!(
                    ...
                    &data.getedgetypenamefromedgetypeid.edge_type_id
                ));
                ...
                let _ = graph.get_edge_type_name_from_edge_type_id(
                    data.getedgetypenamefromedgetypeid.edge_type_id.clone(),
                );
            }

            73 => {
                trace.push(format!(
                    "get_edge_weight_from_edge_id(edge_id: {:?})",
                    &data.getedgeweightfromedgeid.edge_id
                ));
                ...
                let _ = graph
                    .get_edge_weight_from_edge_id(data.getedgeweightfromedgeid.edge_id.clone());
            }

            74 => {
                trace.push(format!(
                    "get_edge_weight_from_node_ids(src: {:?}, dst: {:?})",
                    &data.getedgeweightfromnodeids.src, &data.getedgeweightfromnodeids.dst
                ));
                ...
                let _ = graph.get_edge_weight_from_node_ids(
                    data.getedgeweightfromnodeids.src.clone(),
                    data.getedgeweightfromnodeids.dst.clone(),
                );
            }
            ...
            75 => {
                ...
                let _ = graph.get_edge_weight_from_node_ids_and_edge_type_id(
                    data.getedgeweightfromnodeidsandedgetypeid.src.clone(),
                    data.getedgeweightfromnodeidsandedgetypeid.dst.clone(),
                    data.getedgeweightfromnodeidsandedgetypeid.edge_type.clone(),
                );
            }
            ...
            76 => {
                trace.push(format!(
                    ...
                    &data.getnodenamefromnodeid.node_id
                ));
                ...
                let _ =
                    graph.get_node_name_from_node_id(data.getnodenamefromnodeid.node_id.clone());
            }

            77 => {
                trace.push(format!(
                    "get_edge_node_names_from_edge_node_ids(edge_node_ids: {:?})",
                    &data.getedgenodenamesfromedgenodeids.edge_node_ids
                ));
                ...
                let _ = graph.get_edge_node_names_from_edge_node_ids(
                    data.getedgenodenamesfromedgenodeids.edge_node_ids.clone(),
                );
            }

            78 => {
                trace.push(format!(
                    "get_edge_count_from_edge_type_id(edge_type_id: {:?})",
                    &data.getedgecountfromedgetypeid.edge_type_id
                ));
                ...
                let _ = graph.get_edge_count_from_edge_type_id(
                    data.getedgecountfromedgetypeid.edge_type_id.clone(),
                );
            }

            79 => {
                trace.push(format!(
                    "get_node_count_from_node_type_id(node_type_id: {:?})",
                    &data.getnodecountfromnodetypeid.node_type_id
                ));
                ...
                let _ = graph.get_node_count_from_node_type_id(
                    data.getnodecountfromnodetypeid.node_type_id.clone(),
                );
            }
            ...
            80 => {
                trace.push(format!(
                    ...
                    &data.getneighbournodeidsfromnodeid.node_id
                ));
                ...
                let _ = graph.get_neighbour_node_ids_from_node_id(
                    data.getneighbournodeidsfromnodeid.node_id.clone(),
                );
            }
            ...
            81 => {
                trace.push(format!(
                    ...
                    &data.getminmaxedgeidsfromnodeids.src, &data.getminmaxedgeidsfromnodeids.dst
                ));
                ...
                let _ = graph.get_minmax_edge_ids_from_node_ids(
                    data.getminmaxedgeidsfromnodeids.src.clone(),
                    data.getminmaxedgeidsfromnodeids.dst.clone(),
                );
            }
            ...
            82 => {
                ...
                let _ = graph.get_edge_id_from_node_ids_and_edge_type_id(
                    data.getedgeidfromnodeidsandedgetypeid.src.clone(),
                    data.getedgeidfromnodeidsandedgetypeid.dst.clone(),
                    data.getedgeidfromnodeidsandedgetypeid.edge_type.clone(),
                );
            }
            ...
            83 => {
                trace.push(format!(
                    ...
                    &data.getminmaxedgeidsfromsourcenodeid.src
                ));
                ...
                let _ = graph.get_minmax_edge_ids_from_source_node_id(
                    data.getminmaxedgeidsfromsourcenodeid.src.clone(),
                );
            }
            ...
            84 => {
                trace.push(format!(
                    ...
                    &data.getnodetypenamefromnodetypeid.node_type_id
                ));
                ...
                let _ = graph.get_node_type_name_from_node_type_id(
                    data.getnodetypenamefromnodetypeid.node_type_id.clone(),
                );
            }
            ...
            85 => {
                ...
                if let Ok(res) = graph.filter_from_ids(
                    data.filterfromids.node_ids_to_keep.clone(),
                    data.filterfromids.node_ids_to_filter.clone(),
                    data.filterfromids.node_type_ids_to_keep.clone(),
                    data.filterfromids.node_type_ids_to_filter.clone(),
                    data.filterfromids.node_type_id_to_keep.clone(),
                    data.filterfromids.node_type_id_to_filter.clone(),
                    data.filterfromids.edge_ids_to_keep.clone(),
                    data.filterfromids.edge_ids_to_filter.clone(),
                    data.filterfromids.edge_node_ids_to_keep.clone(),
                    data.filterfromids.edge_node_ids_to_filter.clone(),
                    data.filterfromids.edge_type_ids_to_keep.clone(),
                    data.filterfromids.edge_type_ids_to_filter.clone(),
                    data.filterfromids.min_edge_weight.clone(),
                    data.filterfromids.max_edge_weight.clone(),
                    data.filterfromids.filter_singleton_nodes.clone(),
                    data.filterfromids
                        .filter_singleton_nodes_with_selfloop
                        .clone(),
                    data.filterfromids.filter_selfloops.clone(),
                    data.filterfromids.filter_parallel_edges.clone(),
                    data.filterfromids.verbose.clone(),
                ) {
                    graph = res;
                }
            }
            ...
            86 => {
                trace.push(format!(
                    "drop_unknown_node_types(verbose: {:?})",
                    &data.dropunknownnodetypes.verbose
                ));
            ...
            87 => {
                trace.push(format!(
                    "drop_unknown_edge_types(verbose: {:?})",
                    &data.dropunknownedgetypes.verbose
                ));
            ...
            88 => {
                trace.push(format!(
                    "drop_singleton_nodes(verbose: {:?})",
                    &data.dropsingletonnodes.verbose
                ));
            ...
            89 => {
                trace.push(format!(
                    "drop_singleton_nodes_with_selfloops(verbose: {:?})",
                    &data.dropsingletonnodeswithselfloops.verbose
                ));
                ...
                graph = graph.drop_singleton_nodes_with_selfloops(
                    data.dropsingletonnodeswithselfloops.verbose.clone(),
                );
            }

            90 => {
                trace.push(format!(
                    "drop_disconnected_nodes(verbose: {:?})",
                    &data.dropdisconnectednodes.verbose
                ));
            ...
            91 => {
                trace.push(format!(
                    "drop_selfloops(verbose: {:?})",
                    &data.dropselfloops.verbose
                ));
            ...
            92 => {
                trace.push(format!(
                    "drop_parallel_edges(verbose: {:?})",
                    &data.dropparalleledges.verbose
                ));
            ...
            96 => {
                trace.push(format!(
                    "validate_edge_ids(edge_ids: {:?})",
                    &data.validateedgeids.edge_ids
                ));
            ...
            99 => {
                trace.push(format!(
                    "validate_node_type_id(node_type_id: {:?})",
                    &data.validatenodetypeid.node_type_id
                ));
            ...
            100 => {
                trace.push(format!(
                    "validate_node_type_ids(node_type_ids: {:?})",
                    &data.validatenodetypeids.node_type_ids
                ));
                ...
                let _ =
                    graph.validate_node_type_ids(data.validatenodetypeids.node_type_ids.clone());
            }

            101 => {
                trace.push(format!(
                    "validate_edge_type_id(edge_type_id: {:?})",
                    &data.validateedgetypeid.edge_type_id
                ));
            ...
            102 => {
                trace.push(format!(
                    "validate_edge_type_ids(edge_type_ids: {:?})",
                    &data.validateedgetypeids.edge_type_ids
                ));
                ...
                let _ =
                    graph.validate_edge_type_ids(data.validateedgetypeids.edge_type_ids.clone());
            }
            ...
            109 => {
                trace.push(format!(
                    "must_have_edge_weights_representing_probabilities()",
                ));
            ...
            119 => {
                ...
                let _ = graph
                    .par_iter_weighted_closeness_centrality(
                        data.pariterweightedclosenesscentrality
                            .use_edge_weights_as_probabilities
                            .clone(),
                        data.pariterweightedclosenesscentrality.verbose.clone(),
                    )
                    .map(|x| x.collect::<Vec<_>>());
            }
            ...
            121 => {
                ...
                let _ = graph.get_weighted_closeness_centrality(
                    data.getweightedclosenesscentrality
                        .use_edge_weights_as_probabilities
                        .clone(),
                    data.getweightedclosenesscentrality.verbose.clone(),
                );
            }
            ...
            123 => {
                ...
                let _ = graph
                    .par_iter_weighted_harmonic_centrality(
                        data.pariterweightedharmoniccentrality
                            .use_edge_weights_as_probabilities
                            .clone(),
                        data.pariterweightedharmoniccentrality.verbose.clone(),
                    )
                    .map(|x| x.collect::<Vec<_>>());
            }
            ...
            125 => {
                ...
                let _ = graph.get_weighted_harmonic_centrality(
                    data.getweightedharmoniccentrality
                        .use_edge_weights_as_probabilities
                        .clone(),
                    data.getweightedharmoniccentrality.verbose.clone(),
                );
            }

            126 => {
                trace.push(format!(
                    "get_stress_centrality(normalize: {:?}, verbose: {:?})",
                    &data.getstresscentrality.normalize, &data.getstresscentrality.verbose
                ));
                ...
                let _ = graph.get_stress_centrality(
                    data.getstresscentrality.normalize.clone(),
                    data.getstresscentrality.verbose.clone(),
                );
            }

            127 => {
                trace.push(format!(
                    "get_betweenness_centrality(normalize: {:?}, verbose: {:?})",
                    &data.getbetweennesscentrality.normalize,
                    &data.getbetweennesscentrality.verbose
                ));
                ...
                let _ = graph.get_betweenness_centrality(
                    data.getbetweennesscentrality.normalize.clone(),
                    data.getbetweennesscentrality.verbose.clone(),
                );
            }
            ...
            128 => {
                ...
                let _ = graph.get_unweighted_eigenvector_centrality(
                    data.getunweightedeigenvectorcentrality
                        ...
                        .map(|x| x as usize)
                        .clone(),
                    data.getunweightedeigenvectorcentrality.tollerance.clone(),
                );
            }
            ...
            129 => {
                ...
                let _ = graph.get_weighted_eigenvector_centrality(
                    data.getweightedeigenvectorcentrality
                        .maximum_iterations_number
                        .map(|x| x as usize)
                        .clone(),
                    data.getweightedeigenvectorcentrality.tollerance.clone(),
                );
            }
            ...
            130 => {
                trace.push(format!(
                    ...
                    &data.removeinplacenodetypeids.node_type_ids_to_remove
                ));
                ...
                let _ = graph.remove_inplace_node_type_ids(
                    data.removeinplacenodetypeids
            ...
            132 => {
                trace.push(format!(
                    ...
                    &data.removeinplaceedgetypeids.edge_type_ids_to_remove
                ));
                ...
                let _ = graph.remove_inplace_edge_type_ids(
                    data.removeinplaceedgetypeids
            ...
            134 => {
                trace.push(format!(
                    "remove_node_type_id(node_type_id: {:?})",
                    &data.removenodetypeid.node_type_id
                ));
                ...
                if let Ok(res) =
                    graph.remove_node_type_id(data.removenodetypeid.node_type_id.clone())
                {
                    graph = res;
                }
            }
            ...
            136 => {
                trace.push(format!(
                    "remove_edge_type_id(edge_type_id: {:?})",
                    &data.removeedgetypeid.edge_type_id
                ));
                ...
                if let Ok(res) =
                    graph.remove_edge_type_id(data.removeedgetypeid.edge_type_id.clone())
                {
                    graph = res;
                }
            }
            ...
            141 => {
                trace.push(format!(
                    "remove_edge_types(verbose: {:?})",
                    &data.removeedgetypes.verbose
                ));
            ...
            144 => {
                trace.push(format!(
                    "encode_edge(src: {:?}, dst: {:?})",
                    &data.encodeedge.src, &data.encodeedge.dst
                ));
            ...
            150 => {
                trace.push(format!(
                    "get_node_report_from_node_id(node_id: {:?})",
                    &data.getnodereportfromnodeid.node_id
                ));
                ...
                let _ = graph
                    .get_node_report_from_node_id(data.getnodereportfromnodeid.node_id.clone());
            }
            ...
            152 => {
                trace.push(format!(
                    ...
                    &data.getconnectedcomponentsnumber.verbose
                ));
                ...
                let _ = graph.get_connected_components_number(
                    data.getconnectedcomponentsnumber.verbose.clone(),
                );
            }
            ...
            184 => {
                trace.push(format!(
                    "get_source_node_ids(directed: {:?})",
                    &data.getsourcenodeids.directed
                ));
            ...
            186 => {
                trace.push(format!(
                    "get_destination_node_ids(directed: {:?})",
                    &data.getdestinationnodeids.directed
                ));
            ...
            187 => {
                trace.push(format!(
                    ...
                    &data.getdestinationnames.directed
                ));
            ...
            208 => {
                trace.push(format!(
                    "get_edge_node_ids(directed: {:?})",
                    &data.getedgenodeids.directed
                ));
            ...
            209 => {
                trace.push(format!(
                    ...
                    &data.getedgenodenames.directed
                ));
            ...
            223 => {
                trace.push(format!(
                    ...
                    &data.getedgenodeidswithunknownedgetypes.directed
                ));
                ...
                let _ = graph.get_edge_node_ids_with_unknown_edge_types(
                    data.getedgenodeidswithunknownedgetypes.directed.clone(),
                );
            }
            ...
            224 => {
                trace.push(format!(
                    ...
                    &data.getedgenodeidswithknownedgetypes.directed
                ));
                ...
                let _ = graph.get_edge_node_ids_with_known_edge_types(
                    data.getedgenodeidswithknownedgetypes.directed.clone(),
                );
            }
            ...
            225 => {
                trace.push(format!(
                    ...
                    &data.getedgenodenameswithunknownedgetypes.directed
                ));
                ...
                let _ = graph.get_edge_node_names_with_unknown_edge_types(
                    data.getedgenodenameswithunknownedgetypes.directed.clone(),
                );
            }
            ...
            226 => {
                trace.push(format!(
                    ...
                    &data.getedgenodenameswithknownedgetypes.directed
                ));
                ...
                let _ = graph.get_edge_node_names_with_known_edge_types(
                    data.getedgenodenameswithknownedgetypes.directed.clone(),
                );
            }
            ...
            243 => {
                trace.push(format!(
                    "get_node_connected_component_ids(verbose: {:?})",
                    &data.getnodeconnectedcomponentids.verbose
                ));
                ...
                let _ = graph.get_node_connected_component_ids(
                    data.getnodeconnectedcomponentids.verbose.clone(),
                );
            }
            ...
            259 => {
                trace.push(format!(
                    "get_dense_weighted_adjacency_matrix(weight: {:?})",
                    &data.getdenseweightedadjacencymatrix.weight
                ));
                ...
                let _ = graph.get_dense_weighted_adjacency_matrix(
                    data.getdenseweightedadjacencymatrix.weight.clone(),
                );
            }
            ...
            287 => {
                trace.push(format!(
                    "iter_source_node_ids(directed: {:?})",
                    &data.itersourcenodeids.directed
                ));
                ...
                let _ = graph
                    .iter_source_node_ids(data.itersourcenodeids.directed.clone())
                    .collect::<Vec<_>>();
            }
            ...
            290 => {
                trace.push(format!(
                    "par_iter_source_node_ids(directed: {:?})",
                    &data.paritersourcenodeids.directed
                ));
                ...
                let _ = graph
                    .par_iter_source_node_ids(data.paritersourcenodeids.directed.clone())
                    .collect::<Vec<_>>();
            }

            291 => {
                trace.push(format!(
                    "iter_destination_node_ids(directed: {:?})",
                    &data.iterdestinationnodeids.directed
                ));
                ...
                let _ = graph
                    .iter_destination_node_ids(data.iterdestinationnodeids.directed.clone())
                    .collect::<Vec<_>>();
            }

            292 => {
                trace.push(format!(
                    "par_iter_destination_node_ids(directed: {:?})",
                    &data.pariterdestinationnodeids.directed
                ));
                ...
                let _ = graph
                    .par_iter_destination_node_ids(data.pariterdestinationnodeids.directed.clone())
                    .collect::<Vec<_>>();
            }
            ...
            298 => {
                trace.push(format!(
                    "iter_edge_node_ids(directed: {:?})",
                    &data.iteredgenodeids.directed
                ));
                ...
                let _ = graph
                    .iter_edge_node_ids(data.iteredgenodeids.directed.clone())
                    .collect::<Vec<_>>();
            }
            ...
            299 => {
                ...
                let _ = graph
                    .iter_edges(data.iteredges.directed.clone())
                    .collect::<Vec<_>>();
            }

            300 => {
                trace.push(format!(
                    "par_iter_edge_node_ids(directed: {:?})",
                    &data.pariteredgenodeids.directed
                ));
                ...
                let _ = graph
                    .par_iter_edge_node_ids(data.pariteredgenodeids.directed.clone())
                    .collect::<Vec<_>>();
            }
            ...
            302 => {
                trace.push(format!(
                    "par_iter_edges(directed: {:?})",
                    &data.pariteredges.directed
                ));
                ...
                let _ = graph
                    .par_iter_edges(data.pariteredges.directed.clone())
                    .collect::<Vec<_>>();
            }
            ...
            305 => {
                trace.push(format!(
                    ...
                    &data.iteredgenodeidsandedgetypeid.directed
                ));
                ...
                let _ = graph
                    .iter_edge_node_ids_and_edge_type_id(
                        data.iteredgenodeidsandedgetypeid.directed.clone(),
                    )
                    .collect::<Vec<_>>();
            }
            ...
            308 => {
                trace.push(format!(
                    "iter_edge_node_names_and_edge_type_name(directed: {:?})",
                    &data.iteredgenodenamesandedgetypename.directed
                ));
                ...
                let _ = graph.iter_edge_node_names_and_edge_type_name(
                    data.iteredgenodenamesandedgetypename.directed.clone(),
                );
            }

            309 => {
                trace.push(format!(
                    "par_iter_edge_node_names_and_edge_type_name(directed: {:?})",
                    &data.pariteredgenodenamesandedgetypename.directed
                ));
                ...
                let _ = graph.par_iter_edge_node_names_and_edge_type_name(
                    data.pariteredgenodenamesandedgetypename.directed.clone(),
                );
            }
            ...
            310 => {
                trace.push(format!(
                    ...
                    &data.pariteredgenodeidsandedgetypeid.directed
                ));
                ...
                let _ = graph
                    .par_iter_edge_node_ids_and_edge_type_id(
                        data.pariteredgenodeidsandedgetypeid.directed.clone(),
                    )
                    .collect::<Vec<_>>();
            }
            ...
            311 => {
                trace.push(format!(
                    "par_iter_edge_node_names_and_edge_type_name_and_edge_weight(directed: {:?})",
                    &data
                        .pariteredgenodenamesandedgetypenameandedgeweight
                        .directed
                ));
                ...
                let _ = graph.par_iter_edge_node_names_and_edge_type_name_and_edge_weight(
                    data.pariteredgenodenamesandedgetypenameandedgeweight
                        .directed
                        .clone(),
                );
            }
            ...
            312 => {
                trace.push(format!(
                    "iter_edge_node_names_and_edge_type_name_and_edge_weight(directed: {:?})",
                    &data.iteredgenodenamesandedgetypenameandedgeweight.directed
                ));
                ...
                let _ = graph.iter_edge_node_names_and_edge_type_name_and_edge_weight(
                    data.iteredgenodenamesandedgetypenameandedgeweight
                        .directed
                        .clone(),
                );
            }
            ...
            313 => {
                trace.push(format!(
                    "par_iter_edge_node_ids_and_edge_type_id_and_edge_weight(directed: {:?})",
                    &data.pariteredgenodeidsandedgetypeidandedgeweight.directed
                ));
                ...
                let _ = graph
                    .par_iter_edge_node_ids_and_edge_type_id_and_edge_weight(
                        data.pariteredgenodeidsandedgetypeidandedgeweight
                            .directed
                            .clone(),
                    )
                    .collect::<Vec<_>>();
            ...
            314 => {
                trace.push(format!(
                    ...
                    &data.iteredgenodeidsandedgetypeidandedgeweight.directed
                ));
                ...
                let _ = graph
                    .iter_edge_node_ids_and_edge_type_id_and_edge_weight(
                        data.iteredgenodeidsandedgetypeidandedgeweight
                            .directed
                            .clone(),
                    )
                    .collect::<Vec<_>>();
            ...
            315 => {
                trace.push(format!(
                    "iter_unique_edge_node_ids(directed: {:?})",
                    &data.iteruniqueedgenodeids.directed
                ));
                ...
                let _ = graph
                    .iter_unique_edge_node_ids(data.iteruniqueedgenodeids.directed.clone())
                    .collect::<Vec<_>>();
            }
            ...
            319 => {
                trace.push(format!(
                    "iter_edge_node_ids_with_unknown_edge_types(directed: {:?})",
                    &data.iteredgenodeidswithunknownedgetypes.directed
                ));
                ...
                let _ = graph
                    .iter_edge_node_ids_with_unknown_edge_types(
                        data.iteredgenodeidswithunknownedgetypes.directed.clone(),
                    )
                    .map(|x| x.collect::<Vec<_>>());
            }
            ...
            320 => {
                trace.push(format!(
                    "iter_edge_node_ids_with_known_edge_types(directed: {:?})",
                    &data.iteredgenodeidswithknownedgetypes.directed
                ));
                ...
                let _ = graph
                    .iter_edge_node_ids_with_known_edge_types(
                        data.iteredgenodeidswithknownedgetypes.directed.clone(),
                    )
                    .map(|x| x.collect::<Vec<_>>());
            }
            ...
            323 => {
                trace.push(format!(
                    "iter_edge_node_names_with_unknown_edge_types(directed: {:?})",
                    &data.iteredgenodenameswithunknownedgetypes.directed
                ));
                ...
                let _ = graph
                    .iter_edge_node_names_with_unknown_edge_types(
                        data.iteredgenodenameswithunknownedgetypes.directed.clone(),
                    )
                    .map(|x| x.collect::<Vec<_>>());
            }
            ...
            324 => {
                trace.push(format!(
                    "iter_edge_node_names_with_known_edge_types(directed: {:?})",
                    &data.iteredgenodenameswithknownedgetypes.directed
                ));
                ...
                let _ = graph
                    .iter_edge_node_names_with_known_edge_types(
                        data.iteredgenodenameswithknownedgetypes.directed.clone(),
                    )
                    .map(|x| x.collect::<Vec<_>>());
            }
            ...
            329 => {
                trace.push(format!(
                    "par_iter_edge_node_ids_with_unknown_edge_types(directed: {:?})",
                    &data.pariteredgenodeidswithunknownedgetypes.directed
                ));
                ...
                let _ = graph
                    .par_iter_edge_node_ids_with_unknown_edge_types(
                        data.pariteredgenodeidswithunknownedgetypes.directed.clone(),
                    )
                    .map(|x| x.collect::<Vec<_>>());
            }
            ...
            330 => {
                trace.push(format!(
                    "par_iter_edge_node_ids_with_known_edge_types(directed: {:?})",
                    &data.pariteredgenodeidswithknownedgetypes.directed
                ));
                ...
                let _ = graph
                    .par_iter_edge_node_ids_with_known_edge_types(
                        data.pariteredgenodeidswithknownedgetypes.directed.clone(),
                    )
                    .map(|x| x.collect::<Vec<_>>());
            }
            ...
            333 => {
                trace.push(format!(
                    "par_iter_edge_node_names_with_unknown_edge_types(directed: {:?})",
                    &data.pariteredgenodenameswithunknownedgetypes.directed
                ));
                ...
                let _ = graph
                    .par_iter_edge_node_names_with_unknown_edge_types(
                        data.pariteredgenodenameswithunknownedgetypes
                            .directed
                            .clone(),
                    )
                    .map(|x| x.collect::<Vec<_>>());
            ...
            334 => {
                trace.push(format!(
                    "par_iter_edge_node_names_with_known_edge_types(directed: {:?})",
                    &data.pariteredgenodenameswithknownedgetypes.directed
                ));
                ...
                let _ = graph
                    .par_iter_edge_node_names_with_known_edge_types(
                        data.pariteredgenodenameswithknownedgetypes.directed.clone(),
                    )
                    .map(|x| x.collect::<Vec<_>>());
            }
            ...
            341 => {
                trace.push(format!(
                    "get_weighted_laplacian_transformed_graph(verbose: {:?})",
                    &data.getweightedlaplaciantransformedgraph.verbose
                ));
                ...
                if let Ok(res) = graph.get_weighted_laplacian_transformed_graph(
                    data.getweightedlaplaciantransformedgraph.verbose.clone(),
                ) {
                    graph = res;
                }
            }
            ...
            342 => {
                ...
                if let Ok(res) = graph
                    .get_weighted_symmetric_normalized_laplacian_transformed_graph(
                        data.getweightedsymmetricnormalizedlaplaciantransformedgraph
                            .verbose
                            .clone(),
                    )
                {
            ...
            343 => {
                trace.push(format!(
                    ...
                    &data.getweightedsymmetricnormalizedtransformedgraph.verbose
                ));
                ...
                if let Ok(res) = graph.get_weighted_symmetric_normalized_transformed_graph(
                    data.getweightedsymmetricnormalizedtransformedgraph
                        .verbose
                        .clone(),
                ) {
                    graph = res;
            ...
            344 => {
                ...
                if let Ok(res) = graph
                    .get_weighted_random_walk_normalized_laplacian_transformed_graph(
                        data.getweightedrandomwalknormalizedlaplaciantransformedgraph
                            .verbose
                            .clone(),
                    )
                {
            ...
            360 => {
                trace.push(format!(
                    "is_connected(verbose: {:?})",
                    &data.isconnected.verbose
                ));
            ...
            380 => {
                trace.push(format!(
                    "to_upper_triangular(verbose: {:?})",
                    &data.touppertriangular.verbose
                ));
            ...
            381 => {
                trace.push(format!(
                    "to_lower_triangular(verbose: {:?})",
                    &data.tolowertriangular.verbose
                ));
            ...
            382 => {
                trace.push(format!(
                    "to_main_diagonal(verbose: {:?})",
                    &data.tomaindiagonal.verbose
                ));
            ...
            383 => {
                trace.push(format!(
                    "to_anti_diagonal(verbose: {:?})",
                    &data.toantidiagonal.verbose
                ));
            ...
            384 => {
                trace.push(format!(
                    "to_bidiagonal(verbose: {:?})",
                    &data.tobidiagonal.verbose
                ));
            ...
            385 => {
                trace.push(format!(
                    "to_arrowhead(verbose: {:?})",
                    &data.toarrowhead.verbose
                ));
            ...
            386 => {
                trace.push(format!(
                    "to_transposed(verbose: {:?})",
                    &data.totransposed.verbose
                ));
            ...
            387 => {
                trace.push(format!(
                    "to_complementary(verbose: {:?})",
                    &data.tocomplementary.verbose
                ));
            ...
            388 => {
                ...
                if let Ok((res1, res2)) = graph.node_label_holdout(
                    data.nodelabelholdout.train_size.clone(),
                    data.nodelabelholdout.use_stratification.clone(),
                    data.nodelabelholdout.random_state.clone(),
                ) {
                    if rng.next() % 2 == 0 {
                        graph = res1;
                    } else {
            ...
            389 => {
                ...
                if let Ok((res1, res2)) = graph.edge_label_holdout(
                    data.edgelabelholdout.train_size.clone(),
                    data.edgelabelholdout.use_stratification.clone(),
                    data.edgelabelholdout.random_state.clone(),
                ) {
                    if rng.next() % 2 == 0 {
                        graph = res1;
                    } else {
            ...
            390 => {
                trace.push(format!(
                    ...
                    &data.randomsubgraph.nodes_number,
                    &data.randomsubgraph.random_state,
                    &data.randomsubgraph.verbose
                ));
                ...
                if let Ok(res) = graph.random_subgraph(
                    data.randomsubgraph.nodes_number.clone(),
                    data.randomsubgraph.random_state.clone(),
                    data.randomsubgraph.verbose.clone(),
                ) {
                    graph = res;
                }
            }
