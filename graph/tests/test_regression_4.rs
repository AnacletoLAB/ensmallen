...
/// specifically (at the time) line 174 and column 55.
///
fn test_regression_4() -> Result<(), String> {
    let edges_reader = EdgeFileReader::new("tests/data/regression/4.edges", "RegressionTest".to_owned())?
