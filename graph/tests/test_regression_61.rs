...
/// specifically (at the time) line 333 and column 13.
///
fn test_regression_61() -> Result<(), String> {
    let edges_reader = EdgeFileReader::new("tests/data/regression/61.edges")?
    ...
    .get_weighted_all_shortest_paths(Some(23456786), Some(true), Some(true))?;
