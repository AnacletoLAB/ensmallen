...
fn test_regression_243() -> Result<(), String> {
    let edges_reader = EdgeFileReader::new("tests/data/regression/242.edges")?
    ...
    let nodes_reader = Some(NodeFileReader::new("tests/data/regression/242.nodes")?
        .set_rows_to_skip(Some(0))
        ...
        let mut graph = Graph::from_unsorted_csv(
            ...
            "Nomedelgrafo" // Name of the graph
        )?;
