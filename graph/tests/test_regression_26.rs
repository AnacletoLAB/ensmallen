...
/// The provided message was: 'When the smallest component is one the graph must have singletons!'
///
fn test_regression_26() -> Result<(), String> {
    let edges_reader = EdgeFileReader::new("tests/data/regression/26.edges")?
