...
/// The provided message was: 'assertion failed: `(left == right)` left: `6`, right: `5`: We expected the connected components to be a dense set.'
///
fn test_regression_25() -> Result<(), String> {
    let edges_reader = EdgeFileReader::new("tests/data/regression/25.edges")?
