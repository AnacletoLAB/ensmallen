                ...
                neighbours
                    ...
                    .map(|&neighbour_node_id| {
                            ...
                            || !vertex_cover_set.contains(&neighbour_node_id)
                        {
                            ...
                            let mut in_vertex_cover = 0;
                            let mut not_in_vertex_cover = 0;
                            ...
                            let intersection_length = intersection.len();
        ...
        vertex_cover_set
            ...
            .for_each(|&node_id| {
                ...
                neighbours.iter().for_each(|&neighbour_node_id| {
                    ...
                    // or is not present in the vertex cover
                    // we return 0 new triangles.
                    if node_id != neighbour_node_id && vertex_cover_set.contains(&neighbour_node_id)
                    {
                        // We compute the intersection of the neighbours.
                        iter_set::intersection(
                            neighbours.iter().cloned(),
