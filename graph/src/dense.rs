...
impl Graph {
    ...
    pub fn get_dense_weighted_adjacency_matrix(&self, weight: Option<WeightT>) -> Result<Vec<Vec<WeightT>>, String> {
        ...
        // We iterate on the edges and populate the matrix.
        self.par_iter_edge_node_ids_and_edge_weight()?.for_each(|(_, src, dst, weight)| unsafe {
