...
impl Graph {
    ...
    /// TODO: add doc
    pub(crate) fn get_unchecked_edge_type_id_by_edge_type_name(&self, edge_type_name: Option<&str>) -> Option<EdgeTypeT> {
    ...
    /// TODO: add doc
    pub(crate) fn get_unchecked_edge_type_name_by_edge_type_id(&self, edge_type_id: Option<EdgeTypeT>) -> Option<String> {
    ...
    ///
    pub(crate) fn get_unchecked_edge_count_by_edge_type_id(&self, edge_type: Option<EdgeTypeT>) -> EdgeT {
    ...
    ///
    pub(crate) fn get_unchecked_node_count_by_node_type_id(&self, node_type: Option<NodeTypeT>) -> NodeT {
    ...
    /// * dst: NodeT - Destination node.
    ///
    pub(crate) fn get_unchecked_edge_degreee_by_node_ids(
        &self,
        src: NodeT,
        dst: NodeT,
    ) -> EdgeT {
