...
/// assert!(is_valid_angular_link_node_name(this_library_node_name));
/// assert!(!is_valid_angular_link_node_name(not_this_library_node_name1));
/// assert!(!is_valid_angular_link_node_name(not_this_library_node_name2));
/// ```
pub fn is_valid_angular_link_node_name(node_name: &str) -> bool {
    node_name.starts_with("<")
        && node_name.ends_with(">")
        && is_valid_website_node_name(format_angular_link_url_from_node_name(node_name).as_str())
}
...
///
pub(crate) fn format_angular_link_url_from_node_name(node_name: &str) -> String {
