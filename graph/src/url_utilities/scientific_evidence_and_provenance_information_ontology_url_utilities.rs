...
/// ```
pub fn is_valid_scientific_evidence_and_provenance_information_ontology_node_name(node_name: &str) -> bool {
...
///
pub(crate) unsafe fn format_scientific_evidence_and_provenance_information_ontology_url_from_node_name(node_name: &str) -> String {
