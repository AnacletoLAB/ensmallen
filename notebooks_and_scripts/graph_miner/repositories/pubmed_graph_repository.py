"""Sub-module handling the retrieval and building of graphs from PubMedGraphRepository."""
...
class PubMedGraphRepository(GraphRepository):

    def __init__(self):
        """Create new PubMed Graph Repository object."""
        super().__init__()
        self._data = compress_json.local_load("pubmed.json")
    ...
    def get_graph_references(self, graph_name: str, version: str) -> List[str]:
        ...
        Returns
        -----------------------
        Citations relative to the WikiData and PubMed graphs.
        """
        return []
