"""Sub-module handling the retrieval and building of graphs from HetionetGraphRepository."""
from typing import List
import compress_json
from .graph_repository import GraphRepository


class HetionetGraphRepository(GraphRepository):
    """Hetionet Graph Repository class."""

    def __init__(self):
        """Create new Hetionet Graph Repository object."""
        super().__init__()
        self._data = compress_json.local_load("hetionet.json")
