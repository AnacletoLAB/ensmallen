"""Sub-module handling the retrieval and building of graphs from CTD."""
...
class CTDGraphRepository(GraphRepository):

    def __init__(self):
        """Create new CTD Graph Repository object."""
        super().__init__()
        self._data = compress_json.local_load("ctd.json")
