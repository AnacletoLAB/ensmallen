def {graph_method_name}(
    ...
    return RetrievedGraph(
        "{graph_method_name}", version, "{repository_package_name}", directed, preprocess, bioregistry, load_nodes,
        load_node_types, load_edge_types, load_edge_weights, auto_enable_tradeoffs, sort_tmp_dir,
        verbose, ring_bell, cache, cache_path, cache_sys_var, kwargs{callbacks_data}
    )()
