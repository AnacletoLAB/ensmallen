"""Sub-module handling the retrieval and building of graphs from FreebaseGraphRepository."""
...
class ClinicalKnowledgeGraph(GraphRepository):

    def __init__(self):
        """Create new CKG Graph Repository object."""
        super().__init__()
        self._data = compress_json.local_load("ckg.json")
