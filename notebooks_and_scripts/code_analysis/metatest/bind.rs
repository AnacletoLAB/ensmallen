    ...
    /// 
    pub fn get_okapi_bm25_node_feature_propagation(&self, features: Vec<Vec<f64>>, iterations: Option<usize>, maximal_distance: Option<usize>, k1: Option<f64>, b: Option<f64>, include_central_node: Option<bool>, verbose: Option<bool>) -> PyResult<Py<PyArray1<f64>>> {
...
Ok(to_ndarray_2d!(gil, pe!(self.graph.get_okapi_bm25_node_feature_propagation(features, iterations, maximal_distance, k1, b, include_central_node, verbose))?, f64))
    ...
    ///     If the graph does not have node types.
    /// 
    pub fn get_okapi_bm25_node_label_propagation(&self, iterations: Option<usize>, maximal_distance: Option<usize>, k1: Option<f64>, b: Option<f64>, verbose: Option<bool>) -> PyResult<Py<PyArray1<f64>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_2d!(gil, pe!(self.graph.get_okapi_bm25_node_label_propagation(iterations, maximal_distance, k1, b, verbose))?, f64))
    ...
    pub fn get_number_of_triangles_per_node(&self, normalize: Option<bool>) -> Py<PyArray1<NodeT>> {
        let gil = pyo3::Python::acquire_gil();
to_ndarray_1d!(gil, self.graph.get_number_of_triangles_per_node(normalize), NodeT)
    }
...
to_ndarray_1d!(gil, self.graph.get_clustering_coefficient_per_node(), f64)
    ...
    /// 
    pub unsafe fn get_unchecked_breath_first_search(&self, src_node_id: NodeT, maybe_dst_node_id: Option<NodeT>, maybe_dst_node_ids: Option<Vec<NodeT>>, compute_distances: Option<bool>, compute_predecessors: Option<bool>) -> ShortestPathsResultBFS {
        self.graph.get_unchecked_breath_first_search(src_node_id, maybe_dst_node_id, maybe_dst_node_ids, compute_distances, compute_predecessors)
    }
    ...
    /// 
    pub unsafe fn get_unchecked_unweighted_k_shortest_path(&self, src_node_id: NodeT, dst_node_id: NodeT, k: usize) -> Vec<Vec<NodeT>> {
        self.graph.get_unchecked_unweighted_k_shortest_path(src_node_id, dst_node_id, k)
    }
    ...
    pub unsafe fn get_unchecked_weighted_eccentricity_from_node_id(&self, node_id: NodeT) -> f64 {
        self.graph.get_unchecked_weighted_eccentricity_from_node_id(node_id)
    }
    ...
    ///     Node for which to compute the eccentricity.
    /// 
    pub fn get_weighted_eccentricity_from_node_id(&self, node_id: NodeT) -> PyResult<f64> {
        pe!(self.graph.get_weighted_eccentricity_from_node_id(node_id))
    }
    ...
    ///     Node for which to compute the eccentricity.
    /// 
    pub fn get_weighted_eccentricity_from_node_name(&self, node_name: &str) -> PyResult<f64> {
        pe!(self.graph.get_weighted_eccentricity_from_node_name(node_name))
    }
    ...
    ///     Whether to compute the vector of predecessors.
    /// 
    pub unsafe fn get_unchecked_dijkstra_from_node_ids(&self, src_node_id: NodeT, maybe_dst_node_id: Option<NodeT>, maybe_dst_node_ids: Option<Vec<NodeT>>, compute_predecessors: Option<bool>) -> ShortestPathsDjkstra {
        self.graph.get_unchecked_dijkstra_from_node_ids(src_node_id, maybe_dst_node_id, maybe_dst_node_ids, compute_predecessors)
    }
    ...
    /// 
    pub fn get_breath_first_search_from_node_ids(&self, src_node_id: NodeT, maybe_dst_node_id: Option<NodeT>, maybe_dst_node_ids: Option<Vec<NodeT>>, compute_distances: Option<bool>, compute_predecessors: Option<bool>) -> PyResult<ShortestPathsResultBFS> {
        pe!(self.graph.get_breath_first_search_from_node_ids(src_node_id, maybe_dst_node_id, maybe_dst_node_ids, compute_distances, compute_predecessors))
    }
    ...
    ///     If the given optional destination node ID does not exist in the current graph.
    /// 
    pub fn get_dijkstra_from_node_ids(&self, src_node_id: NodeT, maybe_dst_node_id: Option<NodeT>, maybe_dst_node_ids: Option<Vec<NodeT>>, compute_predecessors: Option<bool>) -> PyResult<ShortestPathsDjkstra> {
        pe!(self.graph.get_dijkstra_from_node_ids(src_node_id, maybe_dst_node_id, maybe_dst_node_ids, compute_predecessors))
    }
    ...
    ///     If the graph does not have weights and weights have been requested.
    /// 
    pub fn get_weighted_diameter(&self, ignore_infinity: Option<bool>, verbose: Option<bool>) -> PyResult<f64> {
    ...
    /// 
    pub fn get_breath_first_search_from_node_names(&self, src_node_name: &str, maybe_dst_node_name: Option<&str>, maybe_dst_node_names: Option<Vec<&str>>, compute_distances: Option<bool>, compute_predecessors: Option<bool>) -> PyResult<ShortestPathsResultBFS> {
        pe!(self.graph.get_breath_first_search_from_node_names(src_node_name, maybe_dst_node_name, maybe_dst_node_names, compute_distances, compute_predecessors))
    }
    ...
    ///     If the given optional destination node name does not exist in the current graph.
    /// 
    pub fn get_dijkstra_from_node_names(&self, src_node_name: &str, maybe_dst_node_name: Option<&str>, maybe_dst_node_names: Option<Vec<&str>>, compute_predecessors: Option<bool>) -> PyResult<ShortestPathsDjkstra> {
        pe!(self.graph.get_dijkstra_from_node_names(src_node_name, maybe_dst_node_name, maybe_dst_node_names, compute_predecessors))
    }
...
to_ndarray_1d!(gil, self.graph.get_top_k_central_node_ids(k), NodeT)
    ...
    ///     Integer ID of the node.
    /// 
    pub fn get_weighted_node_degree_from_node_id(&self, node_id: NodeT) -> PyResult<WeightT> {
...
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_degree_centrality())?, f64))
    ...
    pub unsafe fn get_unchecked_weighted_closeness_centrality_from_node_id(&self, node_id: NodeT) -> f64 {
        self.graph.get_unchecked_weighted_closeness_centrality_from_node_id(node_id)
    }
...
to_ndarray_1d!(gil, self.graph.get_unweighted_closeness_centrality(verbose), f64)
    ...
    ///     Whether to show an indicative progress bar.
    /// 
    pub fn get_weighted_closeness_centrality(&self, verbose: Option<bool>) -> PyResult<Py<PyArray1<f64>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_weighted_closeness_centrality(verbose))?, f64))
    }
    ...
    pub unsafe fn get_unchecked_weighted_harmonic_centrality_from_node_id(&self, node_id: NodeT) -> f64 {
        self.graph.get_unchecked_weighted_harmonic_centrality_from_node_id(node_id)
    }
...
to_ndarray_1d!(gil, self.graph.get_unweighted_harmonic_centrality(verbose), f64)
    ...
    ///     Whether to show an indicative progress bar.
    /// 
    pub fn get_weighted_harmonic_centrality(&self, verbose: Option<bool>) -> PyResult<Py<PyArray1<f64>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_1d!(gil, pe!(self.graph.get_weighted_harmonic_centrality(verbose))?, f64))
    }
...
Ok(())
    ...
    /// 
    pub fn get_bipartite_edges(&self, removed_existing_edges: Option<bool>, first_nodes_set: Option<HashSet<String>>, second_nodes_set: Option<HashSet<String>>, first_node_types_set: Option<HashSet<String>>, second_node_types_set: Option<HashSet<String>>) -> PyResult<Py<PyArray1<NodeT>>> {
        let gil = pyo3::Python::acquire_gil();
Ok(to_ndarray_2d!(gil, pe!(self.graph.get_bipartite_edges(removed_existing_edges, first_nodes_set, second_nodes_set, first_node_types_set, second_node_types_set))?, NodeT))
    ...
    /// 
    pub fn get_star_edges(&self, central_node: String, removed_existing_edges: Option<bool>, star_points_nodes_set: Option<HashSet<String>>, star_points_node_types_set: Option<HashSet<String>>) -> PyResult<Py<PyArray1<NodeT>>> {
        let gil = pyo3::Python::acquire_gil();
